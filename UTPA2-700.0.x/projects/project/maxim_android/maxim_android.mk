...
public_includes := \
    ...
    $(LOCAL_PATH)/mxlib/utopia_core   \
    $(LOCAL_PATH)/project/maxim_android
...
define _install_bsp
   ...
   $(shell sed -i -e 's/#define UFO_PUBLIC_HEADER.*/#define UFO_PUBLIC_HEADER_700/g' $(LOCAL_PATH)/mxlib/include/UFO/UFO_maxim.h)
   ...
   $(shell cp $(LOCAL_PATH)/mxlib/include_backup/UFO/UFO_maxim.h $(LOCAL_PATH)/mxlib/include/UFO.h)
   $(shell cp $(LOCAL_PATH)/mxlib/include_backup/UFO/UFO_maxim.h $(LOCAL_PATH)/mxlib/include_backup/UFO.h)
   $(shell cp $(LOCAL_PATH)/project/maxim_android/MsVersion.h $(LOCAL_PATH)/mxlib/include/MsVersion.h)
