...
source_dir := \
    ...
    ./mxlib/hal/$(TARGET_BOARD_PLATFORM)/sys_closeSRC                  \
...
public_includes := \
    ...
    $(LOCAL_PATH)/mxlib/utopia_core   \
    $(LOCAL_PATH)/project/curry_android
...
cflags += -DCONFIG_XC_USE_KERNEL_MENULOAD
cflags += -DCONFIG_MSTAR_DVFS_ENABLE
cflags += -DCONFIG_MSTAR_DVFS_KERNEL_SUPPORT
cflags += -DCONFIG_MSTAR_MONITOR_DAC_POWER
...
source_dir += \
    ./mxlib/drv/ca2 \
    ./mxlib/hal/$(TARGET_BOARD_PLATFORM)/ca2
chip_includes += \
    $(LOCAL_PATH)/mxlib/hal/$(TARGET_BOARD_PLATFORM)/ca2
lib_includes += \
    $(LOCAL_PATH)/mxlib/drv/ca2
...
define _install_bsp
   $(shell sed -i -e 's/#define UFO_PUBLIC_HEADER.*/#define UFO_PUBLIC_HEADER_500_3/g' $(LOCAL_PATH)/mxlib/include/UFO/UFO_curry.h)
   ...
   $(shell cp $(LOCAL_PATH)/mxlib/include/UFO/UFO_curry.h $(LOCAL_PATH)/mxlib/include/UFO.h)
endef
