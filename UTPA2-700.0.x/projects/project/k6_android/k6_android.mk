...
define _install_bsp
   $(shell sed -i -e 's/#define DLL_PACKED.*/#define DLL_PACKED/g' $(LOCAL_PATH)/mxlib/include/MsTypes.h)
   $(shell sed -i -e 's/#define UFO_PUBLIC_HEADER.*/#define UFO_PUBLIC_HEADER_700/g' $(LOCAL_PATH)/mxlib/include/UFO/UFO_k6.h)
   ...
   $(shell cp $(LOCAL_PATH)/mxlib/include/UFO/UFO_k6.h $(LOCAL_PATH)/mxlib/include/UFO.h)
endef
