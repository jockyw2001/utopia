...
# Public Header files
public_includes := \
    $(LOCAL_PATH)/mxlib/include_backup       \
    $(LOCAL_PATH)/mxlib/utopia_core   \
    $(LOCAL_PATH)/project/maserati_android
...
define _install_bsp
   ...
   $(shell sed -i -e 's/#define UFO_PUBLIC_HEADER.*/#define UFO_PUBLIC_HEADER_700/g' $(LOCAL_PATH)/mxlib/include/UFO/UFO_maserati.h)
   $(shell sh $(LOCAL_PATH)/build/MXlibBk.sh $(LOCAL_PATH) "BACKUP_INC") 
   ...
   $(shell sh $(LOCAL_PATH)/build/Reduced.sh $(LOCAL_PATH)/build/api_with_header_file.csv $(LOCAL_PATH) $$Version)
   $(shell sh $(LOCAL_PATH)/build/CPBackup2mxlib.sh $(LOCAL_PATH))
   $(shell cp $(LOCAL_PATH)/mxlib/include_backup/UFO/UFO_maserati.h $(LOCAL_PATH)/mxlib/include/UFO.h)
   $(shell cp $(LOCAL_PATH)/mxlib/include_backup/UFO/UFO_maserati.h $(LOCAL_PATH)/mxlib/include_backup/UFO.h)
   $(shell cp $(LOCAL_PATH)/project/maserati_android/MsVersion.h $(LOCAL_PATH)/mxlib/include/MsVersion.h)
