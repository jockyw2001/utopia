...
typedef enum
{
    ...
    AUDIO_I2S_RX_JUSTIFIED_MODE,         ///< I2S RX Justified Mode
    AUDIO_I2S_RX_CLOCK,                  ///< I2S RX Clock
    AUDIO_I2S_RX_WORD_WIDTH,             ///< I2S RX word width
} AUDIO_I2S_MODE_TYPE;
...
typedef enum
{
    ...
    I2S_SAMPLE_RATE_16K                  = 0x4,
    I2S_SAMPLE_RATE_32K                  = 0x5,
    I2S_SAMPLE_RATE_48K                  = 0x6,
