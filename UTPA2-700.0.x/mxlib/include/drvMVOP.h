...
typedef enum
{
    ...
    E_MVOP_CMD_SET_MFDEC_INFO,                      ///<0x12D Set MVOP MFDEC  by MCU mode
...
typedef struct DLL_PACKED
{
    MS_U32 u32MCUMFD_Version;   ///<Version of current structure. Please always set to "MVOP_DMS_DIPS_A_VERSION" as input
    MS_U16 u16MCUMFD_Length;    ///<Length of this structure, u16PanelInfoEX_Length=sizeof(MVOP_DMSCropINFO)
