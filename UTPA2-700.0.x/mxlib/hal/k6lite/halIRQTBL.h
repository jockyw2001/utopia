...
static void HAL_InitIrqTable(void)
{
    ...
    HAL_UpdateIrqTable(E_IRQ_43, E_INT_IRQ_FIQ_NONE);           //Reserved
    ...
    HAL_UpdateIrqTable(E_IRQ_84, E_INT_IRQ_USB2);               //usb20_p2 interrupt
    HAL_UpdateIrqTable(E_IRQ_85, E_INT_IRQ_UHC2);      //usb20_p2 interrupt (UHCI)
    ...
    HAL_UpdateIrqTable(E_FIQ_36, E_INT_FIQ_8051_TO_BEON);       //reg_hst0to3_int
    HAL_UpdateIrqTable(E_FIQ_37, E_INT_FIQ_8051_TO_AEON);  //reg_hst0to2_int
    HAL_UpdateIrqTable(E_FIQ_38, E_INT_FIQ_8051_TO_SECURER2);       //reg_hst0to1_int
    HAL_UpdateIrqTable(E_FIQ_39, E_INT_FIQ_8051_TO_SECURE51);              //ext_gpio_int[0]
    HAL_UpdateIrqTable(E_FIQ_40, E_INT_FIQ_SECURER2_TO_BEON);       //reg_hst1to3_int
    HAL_UpdateIrqTable(E_FIQ_41, E_INT_FIQ_SECURER2_TO_AEON);           //ca9_SCUEVABORT_INTR
    HAL_UpdateIrqTable(E_FIQ_42, E_INT_FIQ_SECURER2_TO_8051);       //reg_hst1to0_int
    HAL_UpdateIrqTable(E_FIQ_43, E_INT_FIQ_SECURER2_TO_SECURE51);              //ext_gpio_int[1]
    HAL_UpdateIrqTable(E_FIQ_44, E_INT_FIQ_AEON_TO_BEON);  //reg_hst2to3_int
    HAL_UpdateIrqTable(E_FIQ_45, E_INT_FIQ_AEON_TO_SECURER2);           //N/A
    HAL_UpdateIrqTable(E_FIQ_46, E_INT_FIQ_AEON_TO_8051);  //reg_hst2to0_int
    HAL_UpdateIrqTable(E_FIQ_47, E_INT_IRQ_FIQ_NONE);              //ext_gpio_int[2]

    HAL_UpdateIrqTable(E_FIQ_48, E_INT_FIQ_BEON_TO_AEON);  //reg_hst3to2_int
    HAL_UpdateIrqTable(E_FIQ_49, E_INT_FIQ_BEON_TO_SECURER2);       //reg_hst3to1_int
    HAL_UpdateIrqTable(E_FIQ_50, E_INT_FIQ_BEON_TO_8051);       //reg_hst3to0_int
    HAL_UpdateIrqTable(E_FIQ_51, E_INT_FIQ_BEON_TO_SECURE51);           //### usb_int1 //E_INT_FIQ_AU_SPDIF_TX_CS0 //AU_SPDIF_TX_CS_INT[0]
    ...
    HAL_UpdateIrqTable(E_FIQ_57, E_INT_FIQ_SECURE51_TO_BEON);          //ext_gpio_int[5]
    HAL_UpdateIrqTable(E_FIQ_58, E_INT_IRQ_FIQ_NONE);          //ext_gpio_int[6]
    HAL_UpdateIrqTable(E_FIQ_59, E_INT_FIQ_SECURE51_TO_SECURER2);   //ve_sw_wr2buf_int serration_pulse
    HAL_UpdateIrqTable(E_FIQ_60, E_INT_FIQ_SECURE51_TO_8051);       //pwm_fp_l_int
    ...
    HAL_UpdateIrqTable(E_FIQ_68, E_INT_FIQ_TS0_VLD);            //TS interrupt
    HAL_UpdateIrqTable(E_FIQ_69, E_INT_FIQ_TS1_VLD);            //TS interrupt
    HAL_UpdateIrqTable(E_FIQ_70, E_INT_FIQ_TS2_VLD);            //TS interrupt
    HAL_UpdateIrqTable(E_FIQ_71, E_INT_FIQ_TS3_VLD);            //TS interrupt
    HAL_UpdateIrqTable(E_FIQ_72, E_INT_FIQ_TS4_VLD);            //TS interrupt
    HAL_UpdateIrqTable(E_FIQ_73, E_INT_FIQ_TS5_VLD);            //TS interrupt
    ...
    HAL_UpdateIrqTable(E_FIQ_82, E_INT_FIQ_TS3_CLK);            //TS interrupt
    HAL_UpdateIrqTable(E_FIQ_83, E_INT_FIQ_TS4_CLK);            //TS interrupt
    ...
    HAL_UpdateIrqTable(E_FIQ_86, E_INT_FIQ_TS5_CLK);             //TS interrupt
    HAL_UpdateIrqTable(E_FIQ_87, E_INT_FIQ_TS6_CLK);             //TS interrupt
