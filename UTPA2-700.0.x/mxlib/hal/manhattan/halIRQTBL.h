...
static void HAL_InitIrqTable(void)
{
    ...
    HAL_UpdateIrqTable(E_IRQ_07, E_FRCINT_IRQ_MC2D_MEDONE_INT3);
    HAL_UpdateIrqTable(E_IRQ_08, E_FRCINT_IRQ_MC2D_MEDONE_INT2);
    ...
    HAL_UpdateIrqTable(E_IRQ_18, E_INT_IRQ_CIMAX2MCU);              //cimax2mcu_int
    ...
    HAL_UpdateIrqTable(E_IRQ_25, E_INT_IRQ_UHC3);                   //uhc_int3
    ...
    HAL_UpdateIrqTable(E_IRQ_54, E_INT_IRQ_FRC_INT_FIQ2HST0);       //irq_fiq2mips //(alex_Tung_frc###)
    HAL_UpdateIrqTable(E_IRQ_55, E_INT_IRQ_FIQ_NONE);               //non
    ...
    HAL_UpdateIrqTable(E_IRQ_59, E_INT_IRQ_SDIO_OSP_INT);           //sdio_int       //(frcr2_integration###)
    HAL_UpdateIrqTable(E_IRQ_60, E_INT_FIQEXPH_CMDQ);               //cmdq_int       //(frcr2_integration###)
    HAL_UpdateIrqTable(E_IRQ_61, E_INT_IRQ_MIIC_INT1);              //miic1_int
    HAL_UpdateIrqTable(E_IRQ_62, E_INT_IRQ_USB3);                   //usb_int3
    HAL_UpdateIrqTable(E_IRQ_63, E_INT_IRQ_MIIC_INT0);              //miic0_int
    HAL_UpdateIrqTable(E_IRQ_64, E_INT_IRQ_FIQ_NONE);               //non
    ...
    HAL_UpdateIrqTable(E_IRQ_75, E_INT_IRQ_FIQ_NONE);               //non
    HAL_UpdateIrqTable(E_IRQ_76, E_INT_IRQ_FIQ_NONE);               //non
    ...
    HAL_UpdateIrqTable(E_IRQ_84, E_INT_IRQ_FIQ_NONE);               //non
    ...
    HAL_UpdateIrqTable(E_IRQ_88, E_INT_IRQ_MIU_TLB_INT);            //miu_tlb_int
    ...
    HAL_UpdateIrqTable(E_FIQ_03, E_INT_IRQ_USB3);                   //usb_int3
    ...
    HAL_UpdateIrqTable(E_FIQ_10, E_INT_IRQ_UHC3);                   //uhc_int3
