...
static void HAL_InitIrqTable(void)
{
    ...
    HAL_UpdateIrqTable(E_IRQ_01, E_INT_IRQ_MIIC_INT1);        //pm_sleep_int
    HAL_UpdateIrqTable(E_IRQ_02, E_INT_IRQ_MVD2MIPS);           //uhc30_int
    HAL_UpdateIrqTable(E_IRQ_03, E_INT_IRQ_MVD);            //mvd_int
    HAL_UpdateIrqTable(E_IRQ_04, E_INT_IRQ_FIQ_NONE);             //ps_int
    HAL_UpdateIrqTable(E_IRQ_05, E_INT_IRQ_CA_NSK_INT);           //nfie_int
    HAL_UpdateIrqTable(E_IRQ_06, E_INT_IRQ_USB);            //usb_int
    HAL_UpdateIrqTable(E_IRQ_07, E_INT_IRQ_UHC);            //uhc_int
    HAL_UpdateIrqTable(E_IRQ_08, E_INT_IRQ_ZDEC);       //### MIIC5 //E_INT_IRQ_AU_DMA
    HAL_UpdateIrqTable(E_IRQ_09, E_INT_IRQ_EMAC);           //emac_int
    HAL_UpdateIrqTable(E_IRQ_10, E_INT_IRQ_DISP);           //SC_int
    HAL_UpdateIrqTable(E_IRQ_11, E_INT_IRQ_DHC);          //mspi_int
    HAL_UpdateIrqTable(E_IRQ_12, E_INT_IRQ_MSPI0);  //miic3_int
    HAL_UpdateIrqTable(E_IRQ_13, E_INT_IRQ_EVD);      		 //E_INT_IRQ_EVD
    HAL_UpdateIrqTable(E_IRQ_14, E_INT_IRQ_EVD_LITE);           //comb_int
    HAL_UpdateIrqTable(E_IRQ_15, E_INT_IRQ_FIQ_NONE);       //ldm_dma_done_int0
    ...
    HAL_UpdateIrqTable(E_IRQ_22, E_INT_IRQ_MIIC_INT0);       //ldm_dma_done_int1
    HAL_UpdateIrqTable(E_IRQ_23, E_INT_IRQ_RTC);          //smart_int
    ...
    HAL_UpdateIrqTable(E_IRQ_27, E_INT_FIQ_UP_IRQ_EMM_ECM);            //scm_int
    HAL_UpdateIrqTable(E_IRQ_28, E_INT_IRQ_UP_IRQ_UART_CA);            //vbi_int
    ...
    HAL_UpdateIrqTable(E_IRQ_32, E_INT_IRQ_TSP_TSO0);        //hvd_int
    ...
    HAL_UpdateIrqTable(E_IRQ_41, E_INT_IRQ_FIQ_NONE);          //mspi1_int
    HAL_UpdateIrqTable(E_IRQ_42, E_INT_IRQ_FIQ_NONE);   //miu_security_int
    HAL_UpdateIrqTable(E_IRQ_43, E_INT_IRQ_EMMC_OSP_INT);           //E_INT_IRQ_DIPW
    ...
    HAL_UpdateIrqTable(E_IRQ_60, E_INT_IRQ_FIQ_NONE);       //### cmdq_int
    HAL_UpdateIrqTable(E_IRQ_61, E_INT_IRQ_RASP);      //master_iic_int1
    ...
    HAL_UpdateIrqTable(E_IRQ_64, E_INT_IRQ_MIIC_INT2);               //non
    HAL_UpdateIrqTable(E_IRQ_65, E_INT_IRQ_MIIC_INT3);       //irq_vd_evd_r22hi
    HAL_UpdateIrqTable(E_IRQ_66, E_INT_IRQ_MIIC_INT4);            //mhl_cbus_pm_int
    HAL_UpdateIrqTable(E_IRQ_67, E_INT_IRQ_MIIC_INT5);                     //ge_int
    HAL_UpdateIrqTable(E_IRQ_68, E_INT_IRQ_FIQ_NONE);                    //cec_int_pm
    HAL_UpdateIrqTable(E_IRQ_69, E_INT_IRQ_GE);            //disp_fe_int
    ...
    HAL_UpdateIrqTable(E_IRQ_82, E_INT_IRQ_USB30_HS1_USB_INT);           //emmc_osp_init
    HAL_UpdateIrqTable(E_IRQ_83, E_INT_IRQ_USB30_HS1_UHC_INT);          //mhl_ecbus_int
    HAL_UpdateIrqTable(E_IRQ_84, E_INT_IRQ_USB30_HS_USB_INT);               //non
    HAL_UpdateIrqTable(E_IRQ_85, E_INT_IRQ_USB30_HS_UHC_INT);      //cfktks_int_nonsec
    HAL_UpdateIrqTable(E_IRQ_86, E_INT_IRQ_USB2);             //cfktks_int
    HAL_UpdateIrqTable(E_IRQ_87, E_INT_IRQ_UHC2);             //cfdone_int
    HAL_UpdateIrqTable(E_IRQ_88, E_INT_IRQ_MIU);            //miu_tlb_int
    HAL_UpdateIrqTable(E_IRQ_89, E_INT_IRQ_PCIE);    //PAS_PTS_INTRL_COMBINE
    HAL_UpdateIrqTable(E_IRQ_90, E_INT_IRQ_FIQ_NONE);           //aesdma_s_int
    HAL_UpdateIrqTable(E_IRQ_91, E_INT_IRQ_SDIO_OSP_INT);                  //mspi0_int
    HAL_UpdateIrqTable(E_IRQ_92, E_INT_IRQ_MIU_TLB_INT);                  //mspi0_int
    HAL_UpdateIrqTable(E_IRQ_93, E_INT_IRQ_DIPW);                  //mspi0_int
    HAL_UpdateIrqTable(E_IRQ_94, E_INT_IRQ_SECEMAC);                  //mspi0_int
    ...
    HAL_UpdateIrqTable(E_FIQ_03, E_INT_IRQ_FIQ_NONE);       //## usb_int3 //E_INT_RESERVED //Reserved
    HAL_UpdateIrqTable(E_FIQ_04, E_INT_IRQ_FIQ_NONE);   //MB_auR2toMCU_INT[0]
    ...
    HAL_UpdateIrqTable(E_FIQ_09, E_INT_FIQ_UP_IRQ_UART_CA);            //### uhc_int
    ...
    HAL_UpdateIrqTable(E_FIQ_64, E_INT_IRQ_FIQ_NONE);            //MB_auR2toMCU_INT[2]
