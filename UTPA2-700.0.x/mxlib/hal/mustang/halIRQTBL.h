...
static MS_U16 IntEnum2HWIdx[E_INT_IRQ_MAX];
static MS_U16 HWIdx2IntEnum[E_IRQ_FIQ_ALL];

static void HAL_UpdateIrqTable(MS_U16 byHardwareIndex, MS_U16 bySoftwareIndex)
{
...
static void HAL_InitIrqTable(void)
{
    ...
    HAL_UpdateIrqTable(E_IRQ_00, E_INT_RESERVED);           //RESERVED
    HAL_UpdateIrqTable(E_IRQ_01, E_INT_IRQ_PMSLEEP);        //pm_sleep_int
    HAL_UpdateIrqTable(E_IRQ_02, E_INT_IRQ_AEON2HI);        //aeon2hi
    ...
    HAL_UpdateIrqTable(E_IRQ_06, E_INT_IRQ_MIIC_INT5);      //miic5_int
    HAL_UpdateIrqTable(E_IRQ_07, E_INT_IRQ_MIIC_INT4);      //miic4_int
    HAL_UpdateIrqTable(E_IRQ_08, E_INT_IRQ_SMART);          //smart_int
    HAL_UpdateIrqTable(E_IRQ_09, E_INT_IRQ_EMAC);           //emac_int
    HAL_UpdateIrqTable(E_IRQ_10, E_INT_IRQ_DISP);           //disp_int
    HAL_UpdateIrqTable(E_IRQ_11, E_INT_IRQ_MVD2MIPS);       //mvd2mips_int
    HAL_UpdateIrqTable(E_IRQ_12, E_INT_IRQ_SVD_HVD);        //hvd_int
    HAL_UpdateIrqTable(E_IRQ_13, E_INT_IRQ_EVD);            //evd_int
    HAL_UpdateIrqTable(E_IRQ_14, E_INT_IRQ_COMB);           //comb_int
    HAL_UpdateIrqTable(E_IRQ_15, E_INT_IRQ_ADCDVI2RIU);     //adcdvi2riu_int

    HAL_UpdateIrqTable(E_IRQ_16, E_INT_IRQ_TSP2HK);         //tsp2hk_int
    HAL_UpdateIrqTable(E_IRQ_17, E_INT_IRQ_VE);             //ve_int
    HAL_UpdateIrqTable(E_IRQ_18, E_INT_IRQ_G3D2MCU);        //g3d2mcu_int
    ...
    HAL_UpdateIrqTable(E_IRQ_22, E_INT_IRQ_AU_DMA);         //miic0_int
    HAL_UpdateIrqTable(E_IRQ_23, E_INT_IRQ_MFE);            //mfe_int
    HAL_UpdateIrqTable(E_IRQ_24, E_INT_IRQ_ERROR_RESP);     //error_resp_int
    HAL_UpdateIrqTable(E_IRQ_25, E_INT_IRQEXPL_TSO);        //tso_int
    HAL_UpdateIrqTable(E_IRQ_26, E_INT_IRQ_DDC2BI);         //d2b_int
    HAL_UpdateIrqTable(E_IRQ_27, E_INT_IRQ_SCM);            //scm_int
    HAL_UpdateIrqTable(E_IRQ_28, E_INT_IRQ_VBI);            //vbi_int
    HAL_UpdateIrqTable(E_IRQ_29, E_INT_IRQ_USB);            //usb_int
    HAL_UpdateIrqTable(E_IRQ_30, E_INT_IRQ_UHC);            //uhc_int
    HAL_UpdateIrqTable(E_IRQ_31, E_INT_IRQ_USB1);           //usb_int1

    HAL_UpdateIrqTable(E_IRQ_32, E_INT_IRQ_UHC1);           //uhc_int1
    HAL_UpdateIrqTable(E_IRQ_33, E_INT_IRQ_USB2);           //usb_int2
    HAL_UpdateIrqTable(E_IRQ_34, E_INT_IRQ_UHC2);           //uhc_int2
    HAL_UpdateIrqTable(E_IRQ_35, E_INT_IRQ_USB3);           //usb_int3
    HAL_UpdateIrqTable(E_IRQ_36, E_INT_IRQ_UHC3);           //uhc_int3
    HAL_UpdateIrqTable(E_IRQ_37, E_INT_IRQ_MIU);            //miu_int
    HAL_UpdateIrqTable(E_IRQ_38, E_INT_IRQ_UART0);          //int_uart0
    HAL_UpdateIrqTable(E_IRQ_39, E_INT_IRQ_UART1);          //int_uart1
    HAL_UpdateIrqTable(E_IRQ_40, E_INT_IRQ_UART2);          //int_uart2
    HAL_UpdateIrqTable(E_IRQ_41, E_INT_IRQ_UART3);          //int_uart3
    HAL_UpdateIrqTable(E_IRQ_42, E_INT_IRQ_UART4);          //int_uart4
    HAL_UpdateIrqTable(E_IRQ_43, E_INT_IRQ_UART5);          //int_uart5
    HAL_UpdateIrqTable(E_IRQ_44, E_INT_IRQ_GE);             //int_ge
    HAL_UpdateIrqTable(E_IRQ_45, E_INT_IRQ_MIU_SECURITY);   //security_int
    HAL_UpdateIrqTable(E_IRQ_46, E_INT_IRQ_MSPI1);          //mspi1_int
    HAL_UpdateIrqTable(E_IRQ_47, E_INT_IRQ_MSPI0);          //mspi0_int
    ...
    HAL_UpdateIrqTable(E_IRQ_53, E_INT_IRQ_MHL_CBUS_PM);    //mhl_cbus_pm_int
    HAL_UpdateIrqTable(E_IRQ_54, E_INT_IRQ_CEC);            //cec_int_pm
    HAL_UpdateIrqTable(E_IRQ_55, E_INT_IRQ_HDCP_IIC);       //hdcp_iic_int
    HAL_UpdateIrqTable(E_IRQ_56, E_INT_IRQ_HDCP_X74);       //hdcp_x74_int
    HAL_UpdateIrqTable(E_IRQ_57, E_INT_IRQ_WADR_ERR);       //wadr_err_int
    HAL_UpdateIrqTable(E_IRQ_58, E_INT_IRQ_MIIC_DMA_INT0);  //miic_dma_int0
    HAL_UpdateIrqTable(E_IRQ_59, E_INT_IRQ_MIIC_DMA_INT1);  //miic_dma_int1
    HAL_UpdateIrqTable(E_IRQ_60, E_INT_IRQ_MIIC_DMA_INT2);  //miic_dma_int2
    HAL_UpdateIrqTable(E_IRQ_61, E_INT_IRQ_MIIC_DMA_INT3);  //miic_dma_int3
    HAL_UpdateIrqTable(E_IRQ_62, E_INT_IRQ_JPD);            //jpd_int
    HAL_UpdateIrqTable(E_IRQ_63, E_INT_IRQ_EXT_GPIO_MERGE); //ext_gpio_int[7]

    HAL_UpdateIrqTable(E_IRQ_64, E_INT_IRQ_DIMOND_L3_BRIDGE_INT);  //miic_dma_int3
    HAL_UpdateIrqTable(E_IRQ_65,E_INT_IRQ_PAS_PTS_INTRL_COMBINE);            //jpd_int
    HAL_UpdateIrqTable(E_IRQ_90, E_INT_IRQ_AESDMA_S_INT);      //ext_gpio_int[7]
    ...
    HAL_UpdateIrqTable(E_FIQ_10, E_INT_RESERVED);           //gpio_pm_[7]
    ...
    HAL_UpdateIrqTable(E_FIQ_13, E_INT_FIQ_EMAC);           //emac_int
    ...
    HAL_UpdateIrqTable(E_FIQ_25, E_INT_RESERVED);           //Reserved
    HAL_UpdateIrqTable(E_FIQ_26, E_INT_RESERVED);           //Reserved
    HAL_UpdateIrqTable(E_FIQ_27, E_INT_FIQ_IR);             //ir_int
    HAL_UpdateIrqTable(E_FIQ_28, E_INT_FIQ_AFEC_VSYNC);     //AFEC_VSYNC
    HAL_UpdateIrqTable(E_FIQ_29, E_INT_FIQ_USB2);           //usb_int2
    HAL_UpdateIrqTable(E_FIQ_30, E_INT_FIQ_UHC2);           //uhc_int2
    ...
    HAL_UpdateIrqTable(E_FIQ_34, E_INT_FIQ_IR_IN);          //ir_in
    HAL_UpdateIrqTable(E_FIQ_35, E_INT_FIQ_EXTIMER2);       //gpio_pm_[11]
    HAL_UpdateIrqTable(E_FIQ_36, E_INT_FIQ_8051_TO_MIPS_VPE1);   //reg_hst0to3_int
    HAL_UpdateIrqTable(E_FIQ_37, E_INT_FIQ_8051_TO_MIPS_VPE0 );    //reg_hst0to2_int
    HAL_UpdateIrqTable(E_FIQ_38, E_INT_FIQ_8051_TO_AEON);   //reg_hst0to1_int
    HAL_UpdateIrqTable(E_FIQ_39, E_INT_RESERVED);           //Reserved
    HAL_UpdateIrqTable(E_FIQ_40, E_INT_FIQ_AEON_TO_MIPS_VPE1 );  //reg_hst1to3_int
    HAL_UpdateIrqTable(E_FIQ_41, E_INT_FIQ_AEON_TO_BEON );   //reg_hst1to2_int
    HAL_UpdateIrqTable(E_FIQ_42, E_INT_FIQ_AEON_TO_8051 );   //reg_hst1to0_int
    HAL_UpdateIrqTable(E_FIQ_43, E_INT_RESERVED);           //Reserved
    HAL_UpdateIrqTable(E_FIQ_44, E_INT_FIQ_MIPS_VPE0_TO_MIPS_VPE1);  //reg_hst2to3_int
    HAL_UpdateIrqTable(E_FIQ_45, E_INT_FIQ_BEON_TO_AEON);   //reg_hst2to1_int
    HAL_UpdateIrqTable(E_FIQ_46, E_INT_FIQ_MIPS_VPE0_TO_8051);   //reg_hst2to0_int
    HAL_UpdateIrqTable(E_FIQ_47, E_INT_RESERVED);           //Reserved

    HAL_UpdateIrqTable(E_FIQ_48, E_INT_FIQ_MIPS_VPE1_TO_MIPS_VPE0 ); //reg_hst3to2_int
    HAL_UpdateIrqTable(E_FIQ_49, E_INT_FIQ_MIPS_VPE1_TO_AEON); //reg_hst3to1_int
    HAL_UpdateIrqTable(E_FIQ_50, E_INT_FIQ_MIPS_VPE1_TO_8051); //reg_hst3to0_int
    HAL_UpdateIrqTable(E_FIQ_51, E_INT_FIQ_USB1);           //usb_int1
    HAL_UpdateIrqTable(E_FIQ_52, E_INT_FIQ_UHC1);           //uhc_int1
    HAL_UpdateIrqTable(E_FIQ_53, E_INT_FIQ_LDM_DMA1);       //ldm_dma_done_int1
    HAL_UpdateIrqTable(E_FIQ_54, E_INT_FIQ_LDM_DMA0);       //ldm_dma_done_int0
    HAL_UpdateIrqTable(E_FIQ_55, E_INT_FIQ_AU_SPDIF_TX_CS0);//AU_SPDIF_TX_CS_INT[0]
    HAL_UpdateIrqTable(E_FIQ_56, E_INT_FIQ_AU_SPDIF_TX_CS1);//AU_SPDIF_TX_CS_INT[1]
    HAL_UpdateIrqTable(E_FIQ_57, E_INT_FIQ_USB3);          //usb_int3
    HAL_UpdateIrqTable(E_FIQ_58, E_INT_FIQ_UHC3);          //uhc_int3
    ...
    HAL_UpdateIrqTable(E_FIQ_63, E_INT_FIQ_SPI2FCIE);       //spi2fcie_int
