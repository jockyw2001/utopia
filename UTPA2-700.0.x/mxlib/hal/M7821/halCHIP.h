...
#else
#ifdef CONFIG_MIU_64BIT_DOMAIN_SEL
#define HAL_MIU1_BASE               0x80000000UL // 1512MB
#define HAL_MIU2_BASE               0x100000000UL //
#else
#define HAL_MIU1_BASE               0x80000000UL // 1512MB
#define HAL_MIU2_BASE               0xC0000000UL //
#define HAL_MIU2_BASE2              0x100000000UL //
#endif
#endif

#ifdef CONFIG_MIU_64BIT_DOMAIN_SEL
#define HAL_MIU0_BUS_BASE           0x20000000UL  // MIU0 Low 256MB
#define HAL_MIU1_BUS_BASE           0x200000000UL // MIU1 Low 256MB MUJI: 0xA0000000UL
#define HAL_MIU2_BUS_BASE           0x300000000UL // 64 bit mapping
#else
#define HAL_MIU0_BUS_BASE           0x20000000UL
#define HAL_MIU1_BUS_BASE           0xA0000000UL
#define HAL_MIU2_BUS_BASE           0x300000000UL
#endif
...
#define _miu_offset_to_phy(MiuSel, Offset, PhysAddr) if (MiuSel == E_CHIP_MIU_0) \
                                                        {PhysAddr = Offset;} \
                                                         ...
                                                         {PhysAddr = Offset + HAL_MIU2_BASE;}
#else
#define _phy_to_miu_offset(MiuSel, Offset, PhysAddr) if (PhysAddr >= HAL_MIU2_BASE2 && PhysAddr < 0x200000000UL) { \
                                                        {MiuSel = E_CHIP_MIU_2; Offset = PhysAddr - HAL_MIU2_BASE2;}} else { \
                                                     if (PhysAddr < HAL_MIU1_BASE) \
                                                        {MiuSel = E_CHIP_MIU_0; Offset = PhysAddr;} \
                                                     else if ((PhysAddr >= HAL_MIU1_BASE) && (PhysAddr < HAL_MIU2_BASE)) \
                                                         {MiuSel = E_CHIP_MIU_1; Offset = PhysAddr - HAL_MIU1_BASE;} \
                                                     else \
