...
#define HVD_REG_ESB_RPTR_L_BS2                  (REG_HVD_BASE + ((0x0036) << 1))
...
#define REG_TOP_VPU             (CLKGEN0_REG_BASE+(0x0030<<1))
    ...
    #define TOP_CKG_VPU_216MHZ                BITS(4:2, 0)
    #define TOP_CKG_VPU_192MHZ                BITS(4:2, 1)
    #define TOP_CKG_VPU_160MHZ                BITS(4:2, 2)
    #define TOP_CKG_VPU_144MHZ                BITS(4:2, 3)
    #define TOP_CKG_VPU_320MHZ                BITS(4:2, 4)
    #define TOP_CKG_VPU_288MHZ                BITS(4:2, 5)

#define REG_TOP_HVD_IDB             (CLKGEN0_REG_BASE+(0x0030<<1))
    #define TOP_CKG_HVD_IDB_MASK                    BMASK(10:8)
    #define TOP_CKG_HVD_IDB_DIS                     BIT(8)
    #define TOP_CKG_HVD_IDB_INV                     BIT(9)
    #define TOP_CKG_HVD_IDB_CLK_HVD_MIU            BIT(10) //0:HVD, 1:MIU
...
#define REG_TOP_HVD             (CLKGEN0_REG_BASE+(0x0031<<1))
    ...
    #define TOP_CKG_HVD_345MHZ                  BITS(4:2,0)
    #define TOP_CKG_HVD_320MHZ                  BITS(4:2,1)
    #define TOP_CKG_HVD_288MHZ                  BITS(4:2,2)
    #define TOP_CKG_HVD_240MHZ                  BITS(4:2,3)
    #define TOP_CKG_HVD_216MHZ                  BITS(4:2,4)
    #define TOP_CKG_HVD_172MHZ                  BITS(4:2,5)
    #define TOP_CKG_HVD_144MHZ                  BITS(4:2,6)

    #define TOP_CKG_VP8_MASK                  BMASK(11:8)
    #define TOP_CKG_VP8_DIS                   BIT(8)
    #define TOP_CKG_VP8_INV                   BIT(9)
    #define TOP_CKG_VP8_216MHZ                BITS(11:10, 0)
    #define TOP_CKG_VP8_172MHZ                BITS(11:10, 1)
    #define TOP_CKG_VP8_144MHZ                BITS(11:10, 2)
    #define TOP_CKG_VP8_240MHZ                BITS(11:10, 3)


#define REG_TOP_VP6             (CLKGEN0_REG_BASE+(0x0032<<1))
    #define TOP_CKG_VP6_MASK                    BMASK(3:0)
    #define TOP_CKG_VP6_DIS                   BIT(0)
    #define TOP_CKG_VP6_INV                   BIT(1)
    #define TOP_CKG_VP6_CLK_MASK                BMASK(3:2)
    #define TOP_CKG_VP6_192MHZ                  BITS(3:2,0)
    #define TOP_CKG_VP6_172MHZ                  BITS(3:2,1)
    #define TOP_CKG_VP6_160MHZ                  BITS(3:2,2)
    #define TOP_CKG_VP6_144MHZ                  BITS(3:2,3)
...
#define REG_TOP_CKG_EVD_PPU             (CLKGEN0_REG_BASE+(0x0033<<1))
    ...
    #define TOP_CKG_EVD_PPU_345MHZ                   BITS(12:10, 0)
    #define TOP_CKG_EVD_PPU_320MHZ                   BITS(12:10, 1)
    #define TOP_CKG_EVD_PPU_288MHZ                   BITS(12:10, 2)
    #define TOP_CKG_EVD_PPU_240MHZ                   BITS(12:10, 3)
    #define TOP_CKG_EVD_PPU_216MHZ                   BITS(12:10, 4)
    #define TOP_CKG_EVD_PPU_192MHZ                   BITS(12:10, 5)
    #define TOP_CKG_EVD_PPU_160MHZ                   BITS(12:10, 6)
...
#define REG_TOP_CKG_EVD             (CLKGEN0_REG_BASE+(0x0034<<1))
    ...
    #define TOP_CKG_EVD_345MHZ                   BITS(12:10, 0)
    #define TOP_CKG_EVD_320MHZ                   BITS(12:10, 1)
    #define TOP_CKG_EVD_288MHZ                   BITS(12:10, 2)
    #define TOP_CKG_EVD_240MHZ                   BITS(12:10, 3)
    #define TOP_CKG_EVD_216MHZ                   BITS(12:10, 4)
    #define TOP_CKG_EVD_192MHZ                   BITS(12:10, 5)
    #define TOP_CKG_EVD_160MHZ                   BITS(12:10, 6)
