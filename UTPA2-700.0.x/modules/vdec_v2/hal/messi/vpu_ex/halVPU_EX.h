...
#define VPU_CLOCK_216MHZ                BITS(4:2,0)
#define VPU_CLOCK_192MHZ               BITS(4:2,1)
#define VPU_CLOCK_160MHZ                BITS(4:2,2)
#define VPU_CLOCK_144MHZ                BITS(4:2,3)
...
typedef enum
{
    ...
    E_VPU_EX_CLOCK_160MHZ   = VPU_CLOCK_160MHZ,
    E_VPU_EX_CLOCK_144MHZ   = VPU_CLOCK_144MHZ,
