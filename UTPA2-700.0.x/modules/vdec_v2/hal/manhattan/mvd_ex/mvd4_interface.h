...
#define INTERFACE_VERSION        0x00000344 //ver.344 dd CMD_AUTO_REDUCE_ES_DATA (sync from x14)
...
typedef struct _FW_FRAME_INFO
{
    ...
    unsigned char           framebufferresource;        //236    // default: 0, ok: 1, fail : 2
...
#define OFFSET_FRAME_BUFFER_RESOURCE        236
