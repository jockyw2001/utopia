...
//  Hardware Capability
//-------------------------------------------------------------------------------------------------
#define HVD_FW_VERSION 0x00001374
#define HVD_FW_IF_VERSION 0x00790164
...
typedef struct
{
    ...
    MS_U32 u32MVDDebugOutput;           //0x0B24
    MS_U32 u32MVDParser1Reg;            //0x0B28
    MS_U32 u32MVDParser2Reg;            //0x0B2C
    MS_U64 u64SeamlessTargetPTS;        //0x0B30
    MS_U32 u32SeamlessTargetPOC;        //0x0B38
    MS_U32 u32FBMemUsage;               //0x0B3C
    MS_U8  reserved8_8[0xFC0-0xB40];    //0x0B40
...
typedef enum
{
    ...
    /*0x20117*/E_HVD_CMD_FORCE_PROGRESSIVE,         // Arg: 0; Diable. Arg: 1; enable force progressive mode
    ...
    /*0x20316*/E_HVD_CMD_STOP_MVD_PARSER,           // Arg: 0:disable stop, 1:stop
    ...
    /*0x20325*/E_HVD_CMD_MVD_DEBUG_MUX_SEL,         // Arg, 0:NM, 1:PAS1, 2:VLD, 3:IQ, 4:IDCT, 5:REF, 6:MC, 7:DMA, 8:IAP, 9:SMDB, 10:MVGEN, 11:JSC, 12:PAS2
...
typedef enum
{
    ...
    E_HVD_ERR_UNSUPPORT_RES,        // unsupported resolution
...
typedef enum {
    ...
    E_PVR_SEAMLESS_TIMESHIFT_PAUSE_DECODE,
    E_PVR_SEAMLESS_TIMESHIFT_RESET_AND_FINE_TARGET,
    E_PVR_SEAMLESS_TIMESHIFT_SEEK_TO_I
} HVD_Seamless_Mode;
