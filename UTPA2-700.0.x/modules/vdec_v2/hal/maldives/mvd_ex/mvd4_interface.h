...
#if defined(SUPPORT_EVD) && (1==SUPPORT_EVD)
#define OFFSET_BASE              0x000b0000
#else
#define OFFSET_BASE              0x000a0000
#endif
#else
#define OFFSET_BASE              0x000e0000
#endif
#define VSYNC_BRIGE_SHM_OFFSET   0x1FA00
...
#define VSYNC_BRIGE_SHM_START    (VSYNC_BRIGE_SHM_OFFSET+OFFSET_BASE)
...
Share Memory layout
  ...
  | FW_VOL_INFO | DEBUG_BUF | FW_FRAME_INFO | FW_DIVX_INFO | USERDATABUF | SLQBUF | PTSTBL | DSADDR | SCALER_INFO | DEC_FRMAE_INFO |
  0            500        1000            2000           3000          B000     B200     13200    14200         14300            14400    (+OFFSET_BASE)

*/

// VC1_SEQ_INFO put on 65K
#define FW_VERSION               0x08043655
#define INTERFACE_VERSION        0x00000347 //ver.347 add PVR target information
...
//    D[0] vol_rvlc_enable;
    ...
    unsigned char        reserved1;                    //34
    unsigned char        reserved2;                    //35
...
typedef struct
{
    union
    {
        struct
        {
            ...
            unsigned int mvdcmd_handshake_reserved : 18;    // reserved for extend
        };
        unsigned int value;
    };
...
typedef struct _FW_FRAME_INFO
{
    ...
    unsigned int            pvr_seamless_status;         //232
    
    unsigned int            drop_frame_count;            //236
    unsigned int            disp_stc;                    //240

    unsigned int            u32PVRSeamlessTargetPTS;     //244
    unsigned char           u8PVRSeamlessTargetPTSHigh; //248
    unsigned char           u8PVRSeamlessTargetFrameType; //249
    unsigned char           reserved[2];                  //250
...
#define OFFSET_PVR_SEAMLESS_STATUS         232
#define OFFSET_DROP_FRAME_COUNT            236
#define OFFSET_DISP_STC                    240
#define OFFSET_PVRSEAMLESSTARGETPTS        244
#define OFFSET_PVRSEAMLESSTARGETPTSHIGH    248
#define OFFSET_PVRSEAMLESSTARGETFRAMETYPE  249
