...
#define REG_CKG_MVD             (REG_CHIPTOP_BASE + 0x39*2)
    ...
    #define CKG_MVD_MASK            (BIT4 | BIT3 | BIT2)
     #define CKG_MVD_172MHZ          (7 << 2)
    #define CKG_MVD_160MHZ          (0 << 2)
    #define CKG_MVD_144MHZ          (6 << 2)
    #define CKG_MVD_CLK_MIU         (4 << 2)    //clk_miu_p
    #define CKG_MVD_123MHZ          (1 << 2)
    #define CKG_MVD_XTAL_CLK        (2 << 2)    //XTAL clock
...
#define REG_CKG_MVD2            (REG_CHIPTOP_BASE + 0x39*2 +1)
    ...
    #define CKG_MVD2_172MHZ           (0<< 2)
    #define CKG_MVD2_160MHZ           (2<< 2)
    #define CKG_MVD2_144MHZ           (1 << 2)
    #define CKG_MVD2_123MHZ           (4 << 2)
    #define CKG_MVD2_XTAL_CLK         (3 << 2)    //XTAL clock
