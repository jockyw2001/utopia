...
void HAL_COPRO_Enable(MS_U32 u32_ADR)
{
    ...
    //(2) Set R2 Clock
    // [1:0] = 2'b00
    // [3:2] =  2'b000: 288MHz  2'b001: 240MHz,  2'b010: 216HMz,
    //          2'b011: Xtal clock, 2'b100: 192MHz
    //          2'b101: 320MHz, 2'b110: 384MHz, 2'b111: 432MHz
    // Set to 216 MHz
    HAL_CPU_NPM_RegWriteByte(NPM_REG_CLKGEN1_SECR2, 0x04UL);
