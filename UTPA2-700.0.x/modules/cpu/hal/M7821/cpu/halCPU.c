...
void HAL_FRCR2_Enable(MS_U32 u32_ADR)
{
    ...
    //(1) Enable R2 -> Start
    HAL_CPU_PM_RegWrite2Byte(FRC_R2_REG_STOP, 0x24UL); // miu_sw_rst and sdram_boot = 1
    HAL_CPU_PM_RegWrite2Byte(FRC_R2_REG_STOP, 0x27UL); // sdram_boot and (miu/r2/r2_rst) =1
#else
