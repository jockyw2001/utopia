...
static MS_U32 _gFUART_Status =0;
//-------------------------------------------------------------------------------------------------
//  Local Variables
//-------------------------------------------------------------------------------------------------
...
static void HAL_UART_PIU_ForceRX_Enable(ms_uart_dev_t u, MS_BOOL bFlag)
{
    switch (u->regbase)
    {
    case UART0_PIU_ADDR:
        _HAL_REG_WriteByteMask(0x1EC4, (bFlag==0?BIT4:0), BIT4);
        break;

    case UART1_PIU_ADDR:
        _HAL_REG_WriteByteMask(0x1EC4, (bFlag==0?BIT5:0), BIT5);
        break;
		
    case UART2_PIU_ADDR:
        _HAL_REG_WriteByteMask(0x1EC4, (bFlag==0?BIT6:0), BIT6);
        break; 

    case FUART_PIU_ADDR:
        _HAL_REG_WriteByteMask(0x1EC4, (bFlag==0?BIT7:0), BIT7);
        break;
    ...
    if ((uart_pad>=E_UART_PAD_1_0) && (uart_pad<=E_UART_PAD_1_3))
    {
        switch (uart_pad)
        {
            case E_UART_PAD_1_0:
                ...
                _HAL_REG_WriteByteMask(CHIP_REG_SecondUART_MUX, u8Value, CHIP_SecondUART_PAD_MASK2);
                break;
            case E_UART_PAD_1_1:
                u8Value = CHIP_SecondUART_PAD_1;
                _HAL_REG_WriteByteMask(CHIP_REG_SecondUART, u8Value, CHIP_SecondUART_PAD_MASK);
                _HAL_REG_WriteByteMask(CHIP_REG_SecondUART_MUX, 0, CHIP_SecondUART_PAD_MASK2);
                break;
            case E_UART_PAD_1_2:
            ...
            case E_UART_PAD_1_3:
                ...
                break;
            case E_UART_PAD_1_4:
                u8Value = CHIP_SecondUART_PAD_4;
                _HAL_REG_WriteByteMask(CHIP_REG_SecondUART, 0, CHIP_SecondUART_PAD_MASK);
                _HAL_REG_WriteByteMask(CHIP_REG_SecondUART_MUX, CHIP_SecondUART_PAD_4, CHIP_SecondUART_PAD_MASK2);
                break;
            default:
                return FALSE;
        }
    ...
    else if ((uart_pad>=E_UART_PAD_2_0) && (uart_pad<=E_UART_PAD_2_3))
    {
        switch (uart_pad)
        {
            case E_UART_PAD_2_0:
                ...
                _HAL_REG_WriteByteMask(CHIP_REG_ThirdUART_MUX, u8Value, CHIP_ThirdUART_PAD_MASK2);
                u8Value = 0;
                break;
            case E_UART_PAD_2_1:
                u8Value = CHIP_ThirdUART_PAD_1;
				_HAL_REG_WriteByteMask(CHIP_REG_ThirdUART, u8Value, CHIP_ThirdUART_PAD_MASK);
				_HAL_REG_WriteByteMask(CHIP_REG_ThirdUART_MUX, 0, CHIP_ThirdUART_PAD_MASK2);
                break;
            case E_UART_PAD_2_2:
            ...
            case E_UART_PAD_2_3:
				...
				break;
            case E_UART_PAD_2_4:
                u8Value = CHIP_ThirdUART_PAD_4;
				_HAL_REG_WriteByteMask(CHIP_REG_ThirdUART, 0, CHIP_ThirdUART_PAD_MASK);
				_HAL_REG_WriteByteMask(CHIP_REG_ThirdUART_MUX, u8Value, CHIP_ThirdUART_PAD_MASK2);
                break;
            default:
                return FALSE;
    ...
    else if ((uart_pad>=E_UART_PAD_4_0) && (uart_pad<=E_UART_PAD_4_3))
    {
        switch (uart_pad)
        {
            case E_UART_PAD_4_0:
				...
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART_MUX, u8Value, CHIP_FastUART_PAD_MASK2);
                break;
            case E_UART_PAD_4_1:
                u8Value = CHIP_FastUART_PAD_1;
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART, u8Value, CHIP_FastUART_PAD_MASK);
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART_MUX, 0, CHIP_FastUART_PAD_MASK2);
                break;
            case E_UART_PAD_4_2:
            ...
            case E_UART_PAD_4_3:
                ...
                break;
            case E_UART_PAD_4_4:
                u8Value = CHIP_FastUART_PAD_4;
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART, 0, CHIP_FastUART_PAD_MASK);
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART_MUX, u8Value, CHIP_FastUART_PAD_MASK2);
                break;
            case E_UART_PAD_4_5:
                u8Value = CHIP_FastUART_PAD_5;
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART, 0, CHIP_FastUART_PAD_MASK);
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART_MUX, u8Value, CHIP_FastUART_PAD_MASK2);
                break;
            case E_UART_PAD_4_6:
                u8Value = CHIP_FastUART_PAD_6;
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART, 0, CHIP_FastUART_PAD_MASK);
				_HAL_REG_WriteByteMask(CHIP_REG_FastUART_MUX, u8Value, CHIP_FastUART_PAD_MASK2);
                break;
            default:
...
int HAL_UART_Aeon_Set_Baudrate(ms_uart_dev_t u, MS_U32 baudrate)
{
    ...
    switch((_HAL_REG_ReadByte(0x3360)>>2)&0x3)
    {
        case 0x0:
            Fre = 216000000;
            break;
...
int HAL_UART_PIU_Set_Baudrate(ms_uart_dev_t u, MS_U32 baudrate)
{
    ...
    //UART_REG8(UART_MCR) &= ~0x10;
    HAL_UART_PIU_ForceRX_Enable(u, 1);
    return 0;
}
...
static void _HAL_UART_PIU_Isr(UART_DEVICE_TYPE uart_dev)//ISR Body
{
    ...
    if (!(iir & UART_IIR_NO_INT))
    {
       ...
       {
             if( uart_dev == E_UART_PIU_FUART0)
             {
                   _gFUART_Status = UART_IIR_TOI;
             }
             else if( uart_dev == E_UART_PIU_UART0 )
             {
...
void HAL_FUART_PIU_Isr(MS_U32 *pHalReg, MS_U32 u32Data)
{
       ...
       _HAL_UART_PIU_Isr(E_UART_PIU_FUART0);

       if (_gFUART_Status != UART_IIR_TOI )
       {
...
//#define IRQ_UART0   (MDRV_IRQ_BEGIN + 0)
    if (rx_cb)
    {
        ...
        if (u->regbase == FUART_PIU_ADDR)
        {
            MsOS_AttachInterrupt(E_INT_IRQ_UART2MCU, (InterruptCb)HAL_FUART_PIU_Isr);
            MsOS_EnableInterrupt(E_INT_IRQ_UART2MCU);
        }
        else if( u->regbase == UART1_PIU_ADDR )
        {
    ...
    else
    {
        if (u->regbase == FUART_PIU_ADDR)
        {
            MsOS_DisableInterrupt(E_INT_IRQ_UART2MCU);
            UART_REG8(UART_IER) &= ~UART_IER_RDI;
            MsOS_DetachInterrupt(E_INT_IRQ_UART2MCU);
        }
        else if( u->regbase == UART1_PIU_ADDR )
        {
...
void _HAL_UART_PIU_Isr_HalReg(UART_DEVICE_TYPE uart_dev, MS_U32 *pHalReg, MS_U32 u32Data)
{
    ...
    //u = UART_DEVICE(u32Data);
    u =(ms_uart_dev_t) &_uart_dev[uart_dev];
...
void HAL_FUART_PIU_Isr_HalReg(MS_U32 *pHalReg, MS_U32 u32Data)
{
    _HAL_UART_PIU_Isr_HalReg(E_UART_PIU_FUART0, pHalReg, u32Data);
    MsOS_EnableInterrupt(E_INT_IRQ_UART2MCU);
}
...
//#define IRQ_UART0   (MDRV_IRQ_BEGIN + 0)
    if (rx_cb)
    {
        ...
        if (u->regbase == FUART_PIU_ADDR)
        {
            MsOS_AttachInterrupt(E_INT_IRQ_UART2MCU, (InterruptCb)HAL_FUART_PIU_Isr_HalReg);
            MsOS_EnableInterrupt(E_INT_IRQ_UART2MCU);
        }
        else if( u->regbase == UART1_PIU_ADDR )
        {
