...
#define CHIP_REG_BASE_MUX 0x51E00
#define CHIP_REG_FastUART_MUX              (CHIP_REG_BASE_MUX+ (0x11*2) + 1)
    #define CHIP_FastUART_PAD_4            (BIT0)
    #define CHIP_FastUART_PAD_5            (BIT1)
    #define CHIP_FastUART_PAD_6            (BIT0|BIT1)
    #define CHIP_FastUART_PAD_MASK2        (BIT0|BIT1)
#define CHIP_REG_SecondUART_MUX            (CHIP_REG_BASE_MUX+ (0x11*2))
    #define CHIP_SecondUART_PAD_4          (BIT0)
    #define CHIP_SecondUART_PAD_MASK2      (BIT0)
#define CHIP_REG_ThirdUART_MUX             (CHIP_REG_BASE_MUX+ (0x11*2))
    #define CHIP_ThirdUART_PAD_4           (BIT4)
    #define CHIP_ThirdUART_PAD_MASK2       (BIT4)
//-------------------------------------------------------------------------------------------------
//  Type and Structure
//-------------------------------------------------------------------------------------------------
