...
#define VE_NTSC_FRAME_SIZE  ((MS_U32)(720ul * 480ul)*16/VE_MIU_DATA_LENGTH) // 720*480*16bits/128bits
#define VE_PAL_FRAME_SIZE   ((MS_U32)(720ul * 576ul)*16/VE_MIU_DATA_LENGTH) // 720*576*16bits/128bits
