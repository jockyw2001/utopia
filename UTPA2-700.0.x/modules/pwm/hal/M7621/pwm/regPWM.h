...
#define REG_PWM0_MOD_DBG_SEL_0			(0x26)  //bit0~1
#define REG_PWM1_MOD_DBG_SEL_1			(0x26)  //bit2~3
#define REG_PWM2_MOD_DBG_SEL_2			(0x26)  //bit4~5
#define REG_PWM3_MOD_DBG_SEL_3			(0x26)  //bit6~7
#define REG_PWM4_MOD_DBG_SEL_4			(0x26)  //bit8~9
#define REG_PWM5_MOD_DBG_SEL_5			(0x26)  //bit10~11
#define REG_PWM_MOD_EN							(0x26)  //bit12
...
#define REG_DIM0_3_RST_P_SEL_0			(0x71)  //bit8~9
#define REG_DIM4_7_RST_P_SEL_1			(0x71)  //bit10~11
#define REG_DIM8_11_RST_P_SEL_2			(0x71)  //bit12~13
