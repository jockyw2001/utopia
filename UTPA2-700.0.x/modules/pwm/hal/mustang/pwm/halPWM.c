	...
	if(_gPWM_VDBen)
	{
		...
		switch(index)
        {
        	...
        	case E_PWM_CH4:
            	...
            	break;
        	case E_PWM_CH5:
				HAL_PWM_WriteRegBit(REG_PWM5_VDBEN_SW, BITS(14:14, bSwitch), BMASK(14:14));
            	break;
...
/// @param <GLOBAL>   \b None :
////////////////////////////////////////////////////////////////////////////////
void HAL_PWM_SetIOMapBase(MS_U32 u32Base,MS_U32 u32Base1)
{
...
/// @param <GLOBAL>   \b None :
////////////////////////////////////////////////////////////////////////////////
void HAL_PWM_SetChipTopIOMapBase(MS_U32 u32Base)
{
...
/// @param <GLOBAL>   \b None :
////////////////////////////////////////////////////////////////////////////////
MS_U32 HAL_PWM_GetIOMapBase(void)
{
...
MS_BOOL HAL_PWM_Init(void)
{
	...
	_gPWM_Status = HAL_TOP_Read2Byte(REG_PWM5_MODE);
	if(_gPWM_Status & PAD_PWM5_OUT)
	{
		printf("Init PWM5\n");
	}
...
MS_BOOL HAL_PWM_Oen(PWM_ChNum index, MS_BOOL letch)
{
    ...
    switch(index)
    {
        case E_PWM_CH0:
            ...
            HAL_TOP_WriteRegBit(REG_PWM0_MODE, BITS(1:0, 1), BMASK(1:0));
            break;
        case E_PWM_CH1:
            HAL_TOP_WriteRegBit(REG_PWM_OEN, BITS(1:1, letch), BMASK(1:1));
            HAL_TOP_WriteRegBit(REG_PWM1_MODE, BITS(5:4, 1), BMASK(5:4));
            break;
        case E_PWM_CH2:
            HAL_TOP_WriteRegBit(REG_PWM_OEN, BITS(2:2, letch), BMASK(2:2));
            HAL_TOP_WriteRegBit(REG_PWM2_MODE, BITS(2:2, 1), BMASK(2:2));
            break;
        case E_PWM_CH3:
           HAL_TOP_WriteRegBit(REG_PWM_OEN, BITS(3:3, letch), BMASK(3:3));
           HAL_TOP_WriteRegBit(REG_PWM3_MODE, BITS(3:3, 1), BMASK(3:3));
            break;
        case E_PWM_CH4:
           HAL_TOP_WriteRegBit(REG_PWM_OEN, BITS(4:4, letch), BMASK(4:4));
           HAL_TOP_WriteRegBit(REG_PWM4_MODE, BITS(4:4, 1), BMASK(4:4));
            break;
        case E_PWM_CH5:
           HAL_TOP_WriteRegBit(REG_PWM_OEN, BITS(5:5, letch), BMASK(4:4));
           HAL_TOP_WriteRegBit(REG_PWM5_MODE, BITS(1:0, 1), BMASK(1:0));
            break;
...
void HAL_PWM_Period(PWM_ChNum index, MS_U32 u32PeriodPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH5:
            ...
            HAL_PWM_WriteRegBit(REG_PWM5_PERIOD_EXT, BITS(11:10, Period_H), BMASK(11:10));
            break;
...
MS_U32 HAL_PWM_GetPeriod(PWM_ChNum index)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            Period_L = HAL_PWM_Read2Byte(REG_PWM5_PERIOD);
            Period_H = (HAL_PWM_Read2Byte(REG_PWM5_PERIOD_EXT) & BMASK(11:10)) >> 8;
            break;
        case E_PWM_CH6:
        case E_PWM_CH7:
        case E_PWM_CH8:
...
void HAL_PWM_DutyCycle(PWM_ChNum index, MS_U32 u32DutyPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH5:
            ...
            HAL_PWM_WriteRegBit(REG_PWM5_DUTY_EXT, BITS(11:10, Duty_H), BMASK(11:10));
            break;
...
MS_U32 HAL_PWM_GetDutyCycle(PWM_ChNum index)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            Duty_L = HAL_PWM_Read2Byte(REG_PWM5_DUTY);
            Duty_H = (HAL_PWM_Read2Byte(REG_PWM5_DUTY_EXT) & BMASK(11:10)) >> 8;
            break;
        case E_PWM_CH6:
        case E_PWM_CH7:
        case E_PWM_CH8:
...
void HAL_PWM_Div(PWM_ChNum index, MS_U16 u16DivPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            HAL_PWM_WriteByte(REG_PWM5_DIV, u8DivPWM[0]);
            HAL_PWM_WriteRegBit(REG_PWM5_DIV_EXT, u16DivPWM, BMASK(15:8));
            break;
...
void HAL_PWM_Polarity(PWM_ChNum index, MS_BOOL bPolPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            HAL_PWM_WriteRegBit(REG_PWM5_PORARITY,BITS(8:8, bPolPWM), BMASK(8:8));
            break;
        case E_PWM_CH6:
        case E_PWM_CH7:
        case E_PWM_CH8:
...
void HAL_PWM_VDBen(PWM_ChNum index, MS_BOOL bVdbenPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            HAL_PWM_WriteRegBit(REG_PWM5_VDBEN, BITS(9:9, bVdbenPWM), BMASK(9:9));
            break;
...
void HAL_PWM_Vrest(PWM_ChNum index, MS_BOOL bRstPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            HAL_PWM_WriteRegBit(REG_PWM5_RESET_EN, BITS(10:10, bRstPWM), BMASK(10:10));
            break;
...
void HAL_PWM_DBen(PWM_ChNum index, MS_BOOL bdbenPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            HAL_PWM_WriteRegBit(REG_PWM5_DBEN, BITS(11:11, bdbenPWM), BMASK(11:11));
            break;
...
void HAL_PWM_RstMux(PWM_ChNum index, MS_BOOL bMuxPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            HAL_PWM_WriteRegBit(REG_RST_MUX5,BITS(7:7, bMuxPWM), BMASK(7:7));
            break;
...
void HAL_PWM_RstCnt(PWM_ChNum index, MS_U8 u8RstCntPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            HAL_PWM_WriteRegBit(REG_HS_RST_CNT5, BITS(3:0, u8RstCntPWM), BMASK(3:0));
            break;
...
MS_BOOL HAL_PWM_Shift(PWM_ChNum index, MS_U32 u32ShiftPWM)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            break;
        case E_PWM_CH5:
            HAL_PWM_Write2Byte(REG_PWM5_SHIFT_L, Shift_L);
            HAL_PWM_Write2Byte(REG_PWM5_SHIFT_H, Shift_H);
            break;
...
void HAL_PWM_Nvsync(PWM_ChNum index, MS_BOOL bNvsPWM)
    {
        ...
        switch(index)
        {
            ...
            case E_PWM_CH4:
                ...
                break;
            case E_PWM_CH5:
                HAL_PWM_WriteRegBit(REG_PWM5_NVS, BITS(5:5, bNvsPWM), BMASK(5:5));
                break;
...
void HAL_PWM_Align(PWM_ChNum index, MS_BOOL bAliPWM)
    {
        ...
        switch(index)
        {
            ...
            case E_PWM_CH4:
                ...
                break;
            case E_PWM_CH5:
                HAL_PWM_WriteRegBit(REG_PWM5_Align, BITS(5:5, bAliPWM), BMASK(5:5));
                break;
