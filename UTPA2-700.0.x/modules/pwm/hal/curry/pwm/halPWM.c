...
MS_BOOL HAL_PWM_Oen(PWM_ChNum index, MS_BOOL letch)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM OEN Setting\n");
#endif
    return ret;
}
////////////////////////////////////////////////////////////////////////////////
...
void HAL_PWM_Period(PWM_ChNum index, MS_U32 u32PeriodPWM)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM Period Setting\n");
#endif
}
...
MS_U32 HAL_PWM_GetPeriod(PWM_ChNum index)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM GetPeriod Setting\n");
#endif
...
void HAL_PWM_DutyCycle(PWM_ChNum index, MS_U32 u32DutyPWM)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM DutyCycle Setting\n");
#endif
}
...
MS_U32 HAL_PWM_GetDutyCycle(PWM_ChNum index)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM GetDutyCycle\n");
#endif
...
void HAL_PWM_Div(PWM_ChNum index, MS_U16 u16DivPWM)
{
    ...
    HAL_SUBBANK0;
#else
     printf("[Utopia] k7 is not support NONPM_PWM DIV Setting\n");
#endif
}
////////////////////////////////////////////////////////////////////////////////
...
void HAL_PWM_Polarity(PWM_ChNum index, MS_BOOL bPolPWM)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM Polarity Setting\n");
#endif
}
////////////////////////////////////////////////////////////////////////////////
...
void HAL_PWM_VDBen(PWM_ChNum index, MS_BOOL bVdbenPWM)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM VDBen Setting\n");
#endif
}
////////////////////////////////////////////////////////////////////////////////
...
void HAL_PWM_Vrest(PWM_ChNum index, MS_BOOL bRstPWM)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM Vsync rest Setting\n");
#endif
}
////////////////////////////////////////////////////////////////////////////////
...
void HAL_PWM_DBen(PWM_ChNum index, MS_BOOL bdbenPWM)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM DBEN Setting\n");
#endif
}
////////////////////////////////////////////////////////////////////////////////
...
void HAL_PWM_RstMux(PWM_ChNum index, MS_BOOL bMuxPWM)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM RstMux Setting\n");
#endif
}
...
void HAL_PWM_RstCnt(PWM_ChNum index, MS_U8 u8RstCntPWM)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM RstCnt Setting\n");
#endif
}
...
#else
    MS_BOOL Ret = FALSE;
    printf("[Utopia] k7 is not support NONPM_PWM Shift Setting\n");
#endif
    return Ret;
}
////////////////////////////////////////////////////////////////////////////////
...
{
     printf("[Utopia] k7 is not support PWM_Nvsync\n");
}

void HAL_PWM_Align(PWM_ChNum index, MS_BOOL bAliPWM)
{
     printf("[Utopia] k7 is not support PWM_Align\n");
}
...
void HAL_PWM_SetMultiDiff(MS_BOOL bEnable)
{
    ...
    HAL_SUBBANK0;
#else
    printf("[Utopia] k7 is not support NONPM_PWM SetMultiDiff\n");
#endif
}
...
#else
     printf("[Utopia] k7 is not support NONPM_PWM Set3D\n");
#endif
    return bReturn;
}
