...
#define HWI2C_HAL_FUNC()              {ULOGI("HWIIC", "%s\n",  __FUNCTION__);}
#define HWI2C_HAL_INFO(x, args...)    {ULOGE("HWIIC", x, ##args);}
#define HWI2C_HAL_ERR(x, args...)     {ULOGE("HWIIC", x, ##args);}
#ifndef UNUSED
#define UNUSED(x) ((x)=(x))
#endif
...
MS_BOOL HAL_HWI2C_DMA_WriteBytes(MS_U32 u32PortOffset, MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData)
{
    ...
    //##################
    //  Trigger to WRITE 
    if(HAL_HWI2C_DMA_WaitDone(u32PortOffset,HWI2C_DMA_WRITE)==FALSE)
    {
...
MS_BOOL HAL_HWI2C_DMA_ReadBytes(MS_U32 u32PortOffset, MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData)
{
    ...
    //##################
    //  Trigger to READ 
    if(HAL_HWI2C_DMA_WaitDone(u32PortOffset,HWI2C_DMA_READ)==FALSE)
    {
