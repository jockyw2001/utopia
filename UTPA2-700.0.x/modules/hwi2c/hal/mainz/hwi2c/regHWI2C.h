...
#define CHIP2_REG_BASE                  (0x51E00)

//for port 0
#define CHIP_REG_HWI2C_MIIC0            (CHIP2_REG_BASE+ (0x14*2)) //0x1EDC
    #define CHIP_MIIC0_PAD_0            (0)
    #define CHIP_MIIC0_PAD_1            (__BIT0) //PAD_GPIO28/PAD_GPIO29
    #define CHIP_MIIC0_PAD_MSK          (__BIT0)

//for port 1 
#define CHIP_REG_HWI2C_MIIC1            (CHIP2_REG_BASE+ (0x14*2)) //0x1EDC
    #define CHIP_MIIC1_PAD_0            (0)
    #define CHIP_MIIC1_PAD_1            (__BIT4)
    #define CHIP_MIIC1_PAD_MSK          (__BIT4)

//for port 2
#define CHIP_REG_HWI2C_MIIC2            (CHIP2_REG_BASE+ ((0x14*2)+1)) //0x1EDC
    #define CHIP_MIIC2_PAD_0            (__BIT0)
    #define CHIP_MIIC2_PAD_1            (__BIT1)
    #define CHIP_MIIC2_PAD_MSK          (__BIT1|__BIT0)
...
//############################
//Standard mode
#define HWI2C_REG_BASE                  (0x11800) //0x1(11800) + offset ==> default set to port 0
