...
//Host 0: PM51
//Host 1: Secure R2
//Host 2: Cortex-A7 Core 0
//Host 3: Cortex-A7 Core 1
...
#define REG_AEON_C_FIQ_MASK                     (RIUBASE_IRQ + (0x24 << 1))
#define REG_AEON_C_FIQ_CLR                      (RIUBASE_IRQ + (0x2C << 1))
#define REG_AEON_FIQ_FINAL_STATUS               (RIUBASE_IRQ + (0x2C << 1))

#define REG_AEON_C_IRQ_MASK                     (RIUBASE_IRQ + (0x34 << 1))
#define REG_AEON_IRQ_FINAL_STATUS               (RIUBASE_IRQ + (0x3C << 1))

#define REG_AEON_C_FIQ_EXP_MASK                 (RIUBASE_IRQ_EXP + (0x26 << 1))
#define REG_AEON_C_FIQ_EXP_CLR                  (RIUBASE_IRQ_EXP + (0x2e << 1))
#define REG_AEON_C_FIQ_EXP_FINAL_STATUS         (RIUBASE_IRQ_EXP + (0x2e << 1))

#define REG_AEON_C_FIQ_HYP_MASK                 (RIUBASE_IRQ_HYP + (0x24 << 1)) //NOT EXIST NOW
#define REG_AEON_C_FIQ_HYP_CLR                  (RIUBASE_IRQ_HYP + (0x2C << 1)) //NOT EXIST NOW
#define REG_AEON_C_FIQ_HYP_FINAL_STATUS         (RIUBASE_IRQ_HYP + (0x2C << 1)) //NOT EXIST NOW
#define REG_AEON_C_IRQ_EXP_MASK                 (RIUBASE_IRQ_EXP + (0x36 << 1))
#define REG_AEON_C_IRQ_EXP_FINAL_STATUS         (RIUBASE_IRQ_EXP + (0x3e << 1))

#define REG_AEON_C_IRQ_HYP_MASK                 (RIUBASE_IRQ_HYP + (0x34 << 1)) //NOT EXIST NOW
#define REG_AEON_C_IRQ_HYP_FINAL_STATUS         (RIUBASE_IRQ_HYP + (0x3C << 1)) //NOT EXIST NOW

#define REG_MIPS_C_FIQ_MASK                     (RIUBASE_IRQ + (0x44 << 1))
#define REG_MIPS_C_FIQ_CLR                      (RIUBASE_IRQ + (0x4c << 1))
#define REG_MIPS_FIQ_FINAL_STATUS               (RIUBASE_IRQ + (0x4c << 1))

#define REG_MIPS_C_IRQ_MASK                     (RIUBASE_IRQ + (0x54 << 1))
#define REG_MIPS_IRQ_FINAL_STATUS               (RIUBASE_IRQ + (0x5c << 1))

#define REG_MIPS_C_FIQ_EXP_MASK                 (RIUBASE_IRQ_EXP + (0x46 << 1))
#define REG_MIPS_C_FIQ_EXP_CLR                  (RIUBASE_IRQ_EXP + (0x4e << 1))
#define REG_MIPS_C_FIQ_EXP_FINAL_STATUS         (RIUBASE_IRQ_EXP + (0x4e << 1))

#define REG_MIPS_C_FIQ_HYP_MASK                 (RIUBASE_IRQ_HYP + (0x44 << 1))
#define REG_MIPS_C_FIQ_HYP_CLR                  (RIUBASE_IRQ_HYP + (0x4C << 1))
#define REG_MIPS_C_FIQ_HYP_FINAL_STATUS         (RIUBASE_IRQ_HYP + (0x4C << 1))
#define REG_MIPS_C_IRQ_EXP_MASK                 (RIUBASE_IRQ_EXP + (0x56 << 1))
#define REG_MIPS_C_IRQ_EXP_FINAL_STATUS         (RIUBASE_IRQ_EXP + (0x5e << 1))

#define REG_MIPS_C_IRQ_HYP_MASK                 (RIUBASE_IRQ_HYP + (0x54 << 1))
#define REG_MIPS_C_IRQ_HYP_FINAL_STATUS         (RIUBASE_IRQ_HYP + (0x5C << 1))
#ifdef MCU_AEON
