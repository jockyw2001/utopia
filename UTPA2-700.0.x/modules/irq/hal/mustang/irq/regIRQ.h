...
// Host 2 : SEC-R2
//
#define REG_AEON_C_FIQ_MASK                     (RIUBASE_IRQ + (0x24*2))
#define REG_AEON_C_FIQ_CLR                      (RIUBASE_IRQ + (0x2C*2))
#define REG_AEON_FIQ_FINAL_STATUS               (RIUBASE_IRQ + (0x2C*2))

#define REG_AEON_C_IRQ_MASK                     (RIUBASE_IRQ + (0x34*2))
#define REG_AEON_IRQ_FINAL_STATUS               (RIUBASE_IRQ + (0x3C*2))

#define REG_AEON_C_FIQ_EXP_MASK                 (RIUBASE_IRQ_EXP + (0x26*2)) //NOT EXIST NOW
#define REG_AEON_C_FIQ_EXP_CLR                  (RIUBASE_IRQ_EXP + (0x2E*2)) //NOT EXIST NOW
#define REG_AEON_C_FIQ_EXP_FINAL_STATUS         (RIUBASE_IRQ_EXP + (0x2E*2)) //NOT EXIST NOW

#define REG_AEON_C_IRQ_EXP_MASK                 (RIUBASE_IRQ_EXP + (0x36*2)) //NOT EXIST NOW
#define REG_AEON_C_IRQ_EXP_FINAL_STATUS         (RIUBASE_IRQ_EXP + (0x3E*2)) //NOT EXIST NOW

//##########################
//
// For PM+ARM Core0 in NonPM
// Host 0 : PM
// Host 1 : ARM CA9 Core 0
//
#define REG_MIPS_C_FIQ_MASK                     (RIUBASE_IRQ + 0x44*2)
#define REG_MIPS_C_FIQ_CLR                      (RIUBASE_IRQ + 0x4C*2)
#define REG_MIPS_FIQ_FINAL_STATUS               (RIUBASE_IRQ + 0x4C*2)

#define REG_MIPS_C_IRQ_MASK                     (RIUBASE_IRQ + 0x54*2)
#define REG_MIPS_IRQ_FINAL_STATUS               (RIUBASE_IRQ + 0x5C*2)

#define REG_MIPS_C_FIQ_EXP_MASK                 (RIUBASE_IRQ_EXP + 0x46*2)
#define REG_MIPS_C_FIQ_EXP_CLR                  (RIUBASE_IRQ_EXP + 0x4E*2)
#define REG_MIPS_C_FIQ_EXP_FINAL_STATUS         (RIUBASE_IRQ_EXP + 0x4E*2)

#define REG_MIPS_C_IRQ_EXP_MASK                 (RIUBASE_IRQ_EXP + 0x56*2)
#define REG_MIPS_C_IRQ_EXP_FINAL_STATUS         (RIUBASE_IRQ_EXP + 0x5E*2)
