...
MBX_Result _MHAL_MBXINT_SetHostCPU(MBX_CPU_ID eHostCPUID)
{
    switch(eHostCPUID)
    {
        ...
        case E_MBX_CPU_AEON:
            ...
            MsOS_AttachInterrupt(E_INT_FIQ_BEON_TO_SECURER2, (InterruptCb)_MHAL_MBXINT_INTHandler);
            //MsOS_EnableInterrupt(E_INT_FIQ_8051_TO_AEON);
            MsOS_EnableInterrupt(E_INT_FIQ_BEON_TO_SECURER2);
            break;
        case E_MBX_CPU_MIPS:
...
void MHAL_MBXINT_DeInit (MBX_CPU_ID eHostCPU)
{
    switch(eHostCPU)
    {
        ...
        case E_MBX_CPU_AEON:
            ...
            MsOS_DisableInterrupt(E_INT_FIQ_BEON_TO_SECURER2);
            //MsOS_DetachInterrupt(E_INT_FIQ_8051_TO_AEON);
            MsOS_DetachInterrupt(E_INT_FIQ_BEON_TO_SECURER2);
            break;
        case E_MBX_CPU_MIPS:
    ...
    switch(srcCPUID)
    {
        case E_MBX_CPU_PM:
            ...
            {   // PM 2 MIPS
                ...
                CPU_INT_REG(REG_INT_PMFIRE) |= INT_PM_H3;
                CPU_INT_REG(REG_INT_PMFIRE) &= ~(INT_PM_H3);
                MBXINT_PRINT("FIA [32-47]M = 0x%x\n", FIQ_REG(REG_FIQ_H1_32_47));
                MBXINT_PRINT("FIQ [32-47]S = 0x%x\n", FIQ_REG(REG_FIQS_H1_32_47));
            }
        ...
        case E_MBX_CPU_AEON:
            ...
            else
            {
                ...
                CPU_INT_REG(REG_INT_AEONFIRE) |= INT_AEON_H3;
                CPU_INT_REG(REG_INT_AEONFIRE) &= ~(INT_AEON_H3);
                MBXINT_PRINT("FIA [32-47]M = 0x%x\n", FIQ_REG(REG_FIQ_H1_32_47));
                MBXINT_PRINT("FIQ [32-47]S = 0x%x\n", FIQ_REG(REG_FIQS_H1_32_47));
            }
