...
//#define MBXHAL_DEBUG
#ifdef MBXHAL_DEBUG
    #define MBXHAL_ERROR(fmt, args...)           ULOGE(TAG_MBX, "[MBX HAL Driver USER ERR][%06d]     " fmt, __LINE__, ## args)
    #define MBXHAL_WARN(fmt, args...)            ULOGW(TAG_MBX, "[MBX HAL Driver WARN][%06d]    " fmt, __LINE__, ## args)
    #define MBXHAL_PRINT(fmt, args...)           ULOGD(TAG_MBX, "[MBX HAL Driver][%06d]     " fmt, __LINE__, ## args)
