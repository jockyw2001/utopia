...
#ifdef CONFIG_PURE_SN
#define CONFIG_DVFS_CPU_POWER_DEFAULT           105
#else
#define CONFIG_DVFS_CPU_POWER_DEFAULT           105
#endif

#define CONFIG_DVFS_CPU_POWER_MAX               105
#define CONFIG_DVFS_CPU_POWER_MIN               90

#define CONFIG_DVFS_CORE_POWER_MAX              95
...
#define CONFIG_DVFS_POWER_SWI2C_BUS1            0x00
#define CONFIG_DVFS_POWER_SWI2C_BUS2            0x02
#define CONFIG_DVFS_POWER_SWI2C_BUS_NUM         2

#if (CONFIG_DVFS_CPU_POWER_I2C_ENABLE)
#define CONFIG_DVFS_POWER_SWI2C_CPU_ID          0x80    //0x80
#define CONFIG_DVFS_POWER_SWI2C_ADDR_CPU(x)     (x?((CONFIG_DVFS_POWER_SWI2C_BUS2 << 8) | CONFIG_DVFS_POWER_SWI2C_CPU_ID):\
                                                   ((CONFIG_DVFS_POWER_SWI2C_BUS1 << 8) | CONFIG_DVFS_POWER_SWI2C_CPU_ID))
#endif
#if (CONFIG_DVFS_CORE_POWER_I2C_ENABLE)
#define CONFIG_DVFS_POWER_SWI2C_CORE_ID         0x82    //0x82
#define CONFIG_DVFS_POWER_SWI2C_ADDR_CORE(x)    (x?((CONFIG_DVFS_POWER_SWI2C_BUS2 << 8) | CONFIG_DVFS_POWER_SWI2C_CORE_ID):\
                                                   ((CONFIG_DVFS_POWER_SWI2C_BUS1 << 8) | CONFIG_DVFS_POWER_SWI2C_CORE_ID))
#endif
