...
void SysDvfsCpuPowerAdjustment(MS_U32 dwCpuPowerVoltage)
{
    ...
    else
    {
        ...
        dwCpuPowerShiftValue = *(volatile MS_U16 *)(u32hal_sys_baseaddr + (0x10050a << 1));
...
void SysDvfsCorePowerAdjustment(MS_U32 dwCorePowerVoltage)
{
    ...
    *(volatile MS_U16 *)(u32hal_sys_baseaddr + (0x110cb2 << 1)) = dwRegisterValue;
...
#endif
#if CONFIG_DVFS_CORE_POWER_GPIO_ENABLE
    *(volatile MS_U16 *)(u32hal_sys_baseaddr + (0x110cb2 << 1)) = 0x1310;
