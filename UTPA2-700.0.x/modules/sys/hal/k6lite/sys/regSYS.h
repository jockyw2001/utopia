...
#define REG_CLKGEN_OFFSET        0x100b00
...
#define REG_TS_OUT_MODE_SHIFT     13
#define REG_TS_OUT_MODE_MASK      0x7
#define REG_TS_OUT_MODE_TSO      0x1
#define REG_TS_OUT_MODE_S2P      0x2
#define REG_TS_OUT_MODE_S2P1     0x3
#define REG_TS_OUT_MODE_DEMOD_0  0x4
#define REG_TS_OUT_MODE_DEMOD_1  0x5
...
#define REG_TSO0_OUT_PH_TUN_NUM_OFFSET    (REG_CLKGEN_OFFSET+(0x2e*2))    //reg_ckg_tso0_out_divnum
#define REG_TSO0_OUT_PH_TUNE_NUM_SHIFT     0x0
#define REG_TSO0_OUT_PH_TUNE_NUM_MASK      0x1f
#define REG_PH_TUN_EN_SHIFT        0x5
