...
MS_BOOL HAL_SYS_Query(E_SYS_QUERY id)
{
    ...
    switch (id)
    {
        case E_SYS_QUERY_TTS_SUPPORTED:
        {
                //=============================
                // vmmm-xxxx-xxxx-xxxx
                //   Valid0 : reg_efuse_outb[31]
                //   Mode0 : reg_efuse_outb[30~28]
                // xxxx-xxxx-xxxx-vmmm
                //   Valid1 : reg_efuse_outb[35]
                //   Mode1 : reg_efuse_outb[34~32]
                //=============================
                ...
                //get Set0 & Set1
                bTTSValid0 = (((u16EfuseOutb31_16>>12) & 0x08)!=0) ? TRUE : FALSE;
                u8TTSMode0 = (u16EfuseOutb31_16>>12) & 0x07;
                bTTSValid1 = (((u16EfuseOutb47_32>>0) & 0x08)!=0) ? TRUE : FALSE;
                u8TTSMode1 = (u16EfuseOutb47_32>>0) & 0x07;
