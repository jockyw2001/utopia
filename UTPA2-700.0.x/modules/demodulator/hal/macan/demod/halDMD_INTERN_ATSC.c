...
void _HAL_INTERN_ATSC_InitClk(MS_BOOL bRFAGCTristateEnable)
{
    ...
    HAL_DMD_RIU_WriteByte(0x111f76, 0x04);
    // reg_ckg_adc1x_eq1x
    HAL_DMD_RIU_WriteByte(0x111f49, 0x04);
...
#elif (DMD_ATSC_CHIP_VERSION == DMD_ATSC_CHIP_MACAN)
static void _HAL_INTERN_ATSC_InitClk(MS_BOOL bRFAGCTristateEnable)
{
    MS_U8 u8Val = 0;
    ...
    HAL_DMD_RIU_WriteByte(0x103315, 0x00);
    HAL_DMD_RIU_WriteByte(0x103314, 0x08);
    
    HAL_DMD_RIU_WriteByte(0x103302, 0x01);
    HAL_DMD_RIU_WriteByte(0x103302, 0x00);    
    
    HAL_DMD_RIU_WriteByte(0x152928, 0x00);
    
    HAL_DMD_RIU_WriteByte(0x152903, 0x00);
    HAL_DMD_RIU_WriteByte(0x152902, 0x00);
    
    HAL_DMD_RIU_WriteByte(0x152905, 0x00);
    HAL_DMD_RIU_WriteByte(0x152904, 0x00);
    
    HAL_DMD_RIU_WriteByte(0x152907, 0x00);                                                                  
    ...
    HAL_DMD_RIU_WriteByte(0x111f23, 0x10);
    HAL_DMD_RIU_WriteByte(0x111f22, 0x44);
    
    HAL_DMD_RIU_WriteByte(0x111f3b, 0x08);  
    HAL_DMD_RIU_WriteByte(0x111f3a, 0x08);
    ...
    HAL_DMD_RIU_WriteByte(0x111f78, 0x18);
    
    HAL_DMD_RIU_WriteByte(0x152991, 0x88);
    HAL_DMD_RIU_WriteByte(0x152990, 0x88);
    
    HAL_DMD_RIU_WriteByte(0x111f69, 0x44);
    HAL_DMD_RIU_WriteByte(0x111f68, 0x00);
    
    HAL_DMD_RIU_WriteByte(0x111f75, 0x81);
    HAL_DMD_RIU_WriteByte(0x111f74, 0x11);
    
    HAL_DMD_RIU_WriteByte(0x111f77, 0x81);
    HAL_DMD_RIU_WriteByte(0x111f76, 0x88);
    
    HAL_DMD_RIU_WriteByte(0x15298f, 0x11);
    HAL_DMD_RIU_WriteByte(0x15298e, 0x88);
    
    HAL_DMD_RIU_WriteByte(0x152923, 0x00);
    HAL_DMD_RIU_WriteByte(0x152922, 0x00);
    
    HAL_DMD_RIU_WriteByte(0x111f25, 0x10);
    HAL_DMD_RIU_WriteByte(0x111f24, 0x11);
                                
    HAL_DMD_RIU_WriteByte(0x152971, 0x1c);
    HAL_DMD_RIU_WriteByte(0x152970, 0xc1);
                                
    HAL_DMD_RIU_WriteByte(0x152977, 0x04);
    HAL_DMD_RIU_WriteByte(0x152976, 0x04);
                                 
    HAL_DMD_RIU_WriteByte(0x111f6f, 0x11);
    HAL_DMD_RIU_WriteByte(0x111f6e, 0x00);
                                 
    HAL_DMD_RIU_WriteByte(0x111feb, 0x18);
                                 
    HAL_DMD_RIU_WriteByte(0x111f7f, 0x10);
    HAL_DMD_RIU_WriteByte(0x111f7e, 0x11);
                                 
    HAL_DMD_RIU_WriteByte(0x111f31, 0x14);
    ...
    HAL_DMD_RIU_WriteByte(0x152979, 0x11);
    HAL_DMD_RIU_WriteByte(0x152978, 0x14);
    
    HAL_DMD_RIU_WriteByte(0x15298d, 0x81);
    HAL_DMD_RIU_WriteByte(0x15298c, 0x44);
