...
#define INNC_REG_BASE 0x2600
#define EQE_REG_BASE  0x2c00
...
// wriu 0x111f2a 0x01
		HAL_DMD_RIU_WriteByte(0x111f2a,0x01);	
...
// wriu 0x111f49 0x00
 ...
 HAL_DMD_RIU_WriteByte(0x111f4b,0x00);	// Eiffel for power4CFO open clock
 HAL_DMD_RIU_WriteByte(0x111f4a,0x00);	// Eiffel for power4CFO open clock
    // enable sram clock
