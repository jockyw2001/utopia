...
MS_BOOL INTERN_DVBT2_SoftReset ( void )
{
    ...
    MS_U8 u8Data = 0, fdp_fifo_done, tdi_fifo_done;
    MS_U8 u8_timeout = 0;
...
//#ifdef INTERN_DVBT2_LOAD_FW_FROM_CODE_MEMORY
    ...
    else
    {
        ...
        else
        {
            ...
            memcpy((void*)u32VA_DramCodeAddr, &INTERN_DVBT2_table[0x8000], sizeof(INTERN_DVBT2_table) - 0x8000);
...
//    HAL_DMD_RIU_WriteByte(DMDMcuBase+0x0C, (MS_U8)(u32DMD_DVBT2_DRAM_START_ADDR >> 24));
    ...
    DBG_INTERN_DVBT2(printf(">>> DVBT2_EQ_START_ADDR=0x%lx \n", u32DMD_DVBT2_EQ_START_ADDR));
    DBG_INTERN_DVBT2(printf(">>> DVBT2_TDI_START_ADDR=0x%lx \n", u32DMD_DVBT2_TDI_START_ADDR));
    DBG_INTERN_DVBT2(printf(">>> DVBT2_DJB_START_ADDR=0x%lx \n", u32DMD_DVBT2_DJB_START_ADDR));
    DBG_INTERN_DVBT2(printf(">>> DVBT2_FW_START_ADDR=0x%lx \n", u32DMD_DVBT2_FW_START_ADDR));
...
*/
    ...
    status &= MDrv_SYS_DMD_VD_MBX_ReadReg(DVBTM_REG_BASE + (0x78*2), &demodState);
