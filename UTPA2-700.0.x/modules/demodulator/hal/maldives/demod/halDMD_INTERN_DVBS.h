...
MS_BOOL INTERN_DVBS_GetPostViterbiBer(float *postber);
...
MS_BOOL INTERN_DVBS_GetSignalStrength(MS_U16 *strength, const DMD_DVBS_InitData *sDMD_DVBS_InitData, MS_U8 u8SarValue, float fRFPowerDbm);
...
MS_BOOL INTERN_DVBS_GetSNR(float *f_snr);
