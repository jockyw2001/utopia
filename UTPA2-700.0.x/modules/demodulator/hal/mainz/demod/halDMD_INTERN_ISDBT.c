...
#elif defined(CHIP_MARLON)
 #define DMD_ISDBT_CHIP_VERSION     DMD_ISDBT_CHIP_MARLON  
#elif defined(CHIP_K5TN)
 #define DMD_ISDBT_CHIP_VERSION     DMD_ISDBT_CHIP_KENTUCKY
#elif defined(CHIP_MAINZ)
 #define DMD_ISDBT_CHIP_VERSION     DMD_ISDBT_CHIP_MAINZ
#else
 #define DMD_ISDBT_CHIP_VERSION     DMD_ISDBT_CHIP_EULER
#endif
...
#if (DMD_ISDBT_CHIP_VERSION >= DMD_ISDBT_CHIP_MULAN) && (DMD_ISDBT_CHIP_VERSION != DMD_ISDBT_CHIP_MESSI) && (DMD_ISDBT_CHIP_VERSION != DMD_ISDBT_CHIP_MAINZ) && (DMD_ISDBT_CHIP_VERSION != DMD_ISDBT_CHIP_KIWI)
...
#elif (DMD_ISDBT_CHIP_VERSION == DMD_ISDBT_CHIP_MESSI) || (DMD_ISDBT_CHIP_VERSION == DMD_ISDBT_CHIP_MAINZ)
static void _HAL_INTERN_ISDBT_InitClk(void)
{
    #if (DMD_ISDBT_CHIP_VERSION == DMD_ISDBT_CHIP_MESSI)
    HAL_INTERN_ISDBT_DBINFO(printf("--------------DMD_ISDBT_CHIP_MESSI--------------\n"));
    #elif (DMD_ISDBT_CHIP_VERSION == DMD_ISDBT_CHIP_MAINZ)
    HAL_INTERN_ISDBT_DBINFO(printf("--------------DMD_ISDBT_CHIP_MAINZ--------------\n"));
    #endif
...
#elif (DMD_ISDBT_CHIP_VERSION == DMD_ISDBT_CHIP_MARLON)
static void _HAL_INTERN_ISDBT_InitClk(void)
{    
    printf("--------------DMD_ISDBT_CHIP_MARLON--------------\n");
    ...
    _HAL_DMD_RIU_WriteByte(0x10331f, 0x00);
    _HAL_DMD_RIU_WriteByte(0x10331e, 0x10);
    _HAL_DMD_RIU_WriteByte(0x103301, 0x26); //ts clock = 7.2M 
    ...
    //_HAL_DMD_RIU_WriteByte(0x103321, 0x00); //Add in MAXIM
    //_HAL_DMD_RIU_WriteByte(0x103320, 0x00); //Add in MAXIM
...
#elif (DMD_ISDBT_CHIP_VERSION == DMD_ISDBT_CHIP_KENTUCKY)
static void _HAL_INTERN_ISDBT_InitClk(void)
{
    HAL_INTERN_ISDBT_DBINFO(printf("--------------DMD_ISDBT_CHIP_KENTUCKY--------------\n"));

    // SRAM End Address
    _HAL_DMD_RIU_WriteByte(0x163407,0xff);
    _HAL_DMD_RIU_WriteByte(0x163406,0xff);

    // DRAM Disable
    _HAL_DMD_RIU_WriteByte(0x163418,_HAL_DMD_RIU_ReadByte(0x163418)&(~0x04));  

    _HAL_DMD_RIU_WriteByteMask(0x101e39, 0x00, 0x03);

    _HAL_DMD_RIU_WriteByte(0x10331f, 0x00);
    _HAL_DMD_RIU_WriteByte(0x10331e, 0x10);
    _HAL_DMD_RIU_WriteByte(0x103301, 0x30); //ts clock = 7.2M
    _HAL_DMD_RIU_WriteByte(0x103300, 0x0b);
    _HAL_DMD_RIU_WriteByte(0x103309, 0x00);
    _HAL_DMD_RIU_WriteByte(0x103308, 0x00);
    _HAL_DMD_RIU_WriteByte(0x103315, 0x00);
    ...
    _HAL_DMD_RIU_WriteByte(0x111f70, 0x44);
    _HAL_DMD_RIU_WriteByte(0x111f73, 0x00);
    _HAL_DMD_RIU_WriteByte(0x111f72, 0x44);
    _HAL_DMD_RIU_WriteByte(0x111f75, 0x44);
    _HAL_DMD_RIU_WriteByte(0x111f74, 0x44);
    _HAL_DMD_RIU_WriteByte(0x111f77, 0x44);
    _HAL_DMD_RIU_WriteByte(0x111f76, 0x44);
