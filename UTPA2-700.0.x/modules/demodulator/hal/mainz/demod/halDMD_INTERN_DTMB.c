...
#define DMD_DTMB_CHIP_MAINZ         0x08
...
#elif (DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MESSI || DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MAINZ)
static void _HAL_INTERN_DTMB_InitClk(void)
{
   MS_U8 u8Val = 0;
   
   printf("--------------DMD_DTMB_CHIP_MESSI/MAINZ--------------\n");
 ...
 //  HAL_DMD_RIU_WriteByte(0x111f7B, 0x00);  //monet add
   ...
   u8Val = HAL_DMD_RIU_ReadByte(0x112758);  //Get efuse value
   HAL_DMD_RIU_WriteByte(0x11261A, u8Val);  //Write efuse value to mailbox reg for fw
