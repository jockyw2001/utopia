...
MS_BOOL INTERN_DVBC_GetLock(DMD_DVBC_GETLOCK_TYPE eType, MS_U32 u32CurrRFPowerDbm, MS_U32 u32NoChannelRFPowerDbm, MS_U32 u32TimeInterval)
{
    ...
    if (u32CurrRFPowerDbm < 1000)
    {
        if (eType == DMD_DVBC_GETLOCK_NO_CHANNEL)
        {
            ...
            {
                if ((u32CurrRFPowerDbm<u32NoChannelRFPowerDbm) && (u32DMD_DVBC_NoChannelTimeAccWithRFPower<10000*10))
                {
                    u32DMD_DVBC_NoChannelTimeAccWithRFPower+=u32TimeInterval*10;
                }
                if (u32DMD_DVBC_NoChannelTimeAccWithRFPower>1500*10)
                {
...
/*
    ...
    printf("[Mstar_6][3]0x%x,[4]0x%x,[5]0x%x,[6]0x%x,[7]0x%x\n",aci_e2,aci_e3,fb_i_1,fb_q_1,era_th);
*/
    return;
