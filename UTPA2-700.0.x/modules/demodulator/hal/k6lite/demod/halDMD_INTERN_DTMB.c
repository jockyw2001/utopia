...
static MS_BOOL _HAL_INTERN_DTMB_Download(void)
{
    ...
    //pRes->sDMD_DTMB_InitData.u16IF_KHZ=5000; //for temp solution wayne@20151004
    //pRes->sDMD_DTMB_InitData.bIQSwap=1;
    //pRes->sDMD_DTMB_InitData.u32TdiStartAddr=0x01598000;
