...
#define MIU_MAX_DEVICE           (2) //[MIU][HAL][001] The numbers of MIU devices
//Max MIU Group number
#define MIU_MAX_GROUP            (8) //[MIU][HAL][002] The numbers of MIU groups
#define MIU_MAX_GP_CLIENT        (16) //[MIU][HAL][003] The numbers of MIU clients in a group
...
#define MIU_MAX_PROTECT_ID       (16) //[MIU][HAL][004] The numbers of MIU protect ID
