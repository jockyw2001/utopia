...
#if (defined CONFIG_MLOG)
#define NJPD_DEBUG_HAL_MSG(format, args...)  do{if(_u8NJPDHalDbgLevel & E_NJPD_DEBUG_HAL_MSG) ULOGI("NJPD", format, ##args);}while(0)
#define NJPD_DEBUG_HAL_ERR(format, args...)  do{if(_u8NJPDHalDbgLevel & E_NJPD_DEBUG_HAL_ERR) ULOGE("NJPD", format, ##args);}while(0)
