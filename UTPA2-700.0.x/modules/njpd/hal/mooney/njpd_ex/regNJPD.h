...
// mooney: h0033	h0033	15	0	reg_rq1_mask, bit 5, 6
#define NJPD_MIU0_RQ1_MASK              (NJPD_MIU0_BASE+NJPD_OFFSET(0x33))
#define NJPD_MIU1_RQ1_MASK              (NJPD_MIU1_BASE+NJPD_OFFSET(0x33))
#define NJPD0_MIU0_CLIENT_NJPD          NJPD_BIT(5) //bit5 of the first byte (bit 5)
#define NJPD0_MIU1_CLIENT_NJPD          NJPD_BIT(5) //bit5 of the first byte (bit 5)
#define NJPD1_MIU0_CLIENT_NJPD          NJPD_BIT(6) //bit6 of the first byte (bit 6)
#define NJPD1_MIU1_CLIENT_NJPD          NJPD_BIT(6) //bit6 of the first byte (bit 6)
// h0079	h0079	15	0	reg_miu_sel1
#define NJPD0_MIU0_MIU_SEL1             (NJPD_MIU0_BASE+NJPD_OFFSET(0x79))
#define NJPD0_MIU1_MIU_SEL1             (NJPD_MIU1_BASE+NJPD_OFFSET(0x79))
#define NJPD1_MIU0_MIU_SEL1             (NJPD_MIU0_BASE+NJPD_OFFSET(0x79))
#define NJPD1_MIU1_MIU_SEL1             (NJPD_MIU1_BASE+NJPD_OFFSET(0x79))


#define NJPD_1608_BASE                  0x60800
#define NJPD_160F_BASE                  0x60F00
#define NJPD_1615_BASE                  0x61500
#define NJPD_1620_BASE                  0x62000
...
#define BK_1620_GENERAL(x)          (NJPD_1620_BASE+NJPD_OFFSET(x))
...
// CHIPTOP
// mooney: h0021	h0021	15	0	reg_miu_group1_i64
#define NJPD_CHIPTOP_BASE               0x1E00
#define NJPD_MIU_GROUP1_I64             (NJPD_CHIPTOP_BASE + NJPD_OFFSET(0x21))
#define NJPD_MIU0_CLIENT_NJPD_CS5       NJPD_BIT(5) //bit5 of the first byte (bit 5)
//#define NJPD_MIU0_CLIENT_NJPD_CS6       NJPD_BIT(6) //bit6 of the first byte (bit 6)
