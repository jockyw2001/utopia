...
#if USE_FW_HVD
//#include "../../../vdec_v2/hal/monet/hvd_ex/fwHVD_if.h"
...
static void _HAL_NJPD_SetMIUProtectMask(MS_BOOL bEnable)
{
    ...
    {
        __HAL_NJPD_WriteBit(NJPD_MIU0_RQ1_MASK, bEnable, NJPD0_MIU0_CLIENT_NJPD);
        __HAL_NJPD_WriteBit(NJPD_MIU1_RQ1_MASK, bEnable, NJPD0_MIU1_CLIENT_NJPD);
    ...
    {
        __HAL_NJPD_WriteBit(NJPD_MIU0_RQ1_MASK, bEnable, NJPD1_MIU0_CLIENT_NJPD);
        __HAL_NJPD_WriteBit(NJPD_MIU1_RQ1_MASK, bEnable, NJPD1_MIU1_CLIENT_NJPD);
...
void HAL_NJPD_SetMIU(MS_U8 u8Idx)
{
    ...
    if(eNJPDNum == E_NJPD_NJPD1)
    {
        ...
        __HAL_NJPD_WriteBit(NJPD0_MIU1_MIU_SEL1, 1, NJPD0_MIU1_CLIENT_NJPD);
    ...
    else
    {
        ...
        __HAL_NJPD_WriteBit(NJPD1_MIU1_MIU_SEL1, 1, NJPD1_MIU1_CLIENT_NJPD);
    ...
    {
        NJPD_DEBUG_HAL_MSG("NJPD0, ");
        __HAL_NJPD_WriteBit(NJPD0_MIU1_MIU_SEL1, 0, NJPD0_MIU1_CLIENT_NJPD);
        if(u8Idx)
        {
            NJPD_DEBUG_HAL_MSG("MIU 1\n");
            __HAL_NJPD_WriteBit(NJPD0_MIU0_MIU_SEL1, 1, NJPD0_MIU0_CLIENT_NJPD);
        }
        else
        {
            NJPD_DEBUG_HAL_MSG("MIU 0\n");
            __HAL_NJPD_WriteBit(NJPD0_MIU0_MIU_SEL1, 0, NJPD0_MIU0_CLIENT_NJPD);
        }
    }
    else
    {
        NJPD_DEBUG_HAL_MSG("NJPD1, ");
        __HAL_NJPD_WriteBit(NJPD1_MIU1_MIU_SEL1, 0, NJPD1_MIU1_CLIENT_NJPD);
        if(u8Idx)
        {
            NJPD_DEBUG_HAL_MSG("MIU 1\n");
            __HAL_NJPD_WriteBit(NJPD1_MIU0_MIU_SEL1, 1, NJPD1_MIU0_CLIENT_NJPD);
        }
        else
        {
            NJPD_DEBUG_HAL_MSG("MIU 0\n");
            __HAL_NJPD_WriteBit(NJPD1_MIU0_MIU_SEL1, 0, NJPD1_MIU0_CLIENT_NJPD);
        }
    }
#endif
}
...
void HAL_NJPD_JPDSelect(MS_BOOL bNJPD)
{
    if(bNJPD)
    {
        __HAL_NJPD_WriteBit(NJPD_MIU_GROUP1_I64, 0, NJPD_MIU0_CLIENT_NJPD_CS5);
        //__HAL_NJPD_WriteBit(NJPD_MIU_GROUP1_I64, 0, NJPD_MIU0_CLIENT_NJPD_CS6);
    ...
    {
        __HAL_NJPD_WriteBit(NJPD_MIU_GROUP1_I64, 1, NJPD_MIU0_CLIENT_NJPD_CS5);
        //__HAL_NJPD_WriteBit(NJPD_MIU_GROUP1_I64, 1, NJPD_MIU0_CLIENT_NJPD_CS6);
...
void HAL_NJPD_PowerOn()
{
    ...
    u16reg_val |= 0x0000;  // set NJPD disable [8] : 0, [11:10] : 00 288MHz
...
void HAL_NJPD_PowerOff(void)
{
    ...
    u16reg_val = HAL_NJPD_GetClock();
    u16reg_val = u16reg_val & 0xF2FF;
    u16reg_val |= 0x0100;  // set NJPD disable [8] : 1, [11:10] : 00 288MHz
    NJPD_DEBUG_HAL_MSG("%s : SetClock : 0x%04x\n", __FUNCTION__ , u16reg_val);
    HAL_NJPD_SetClock(u16reg_val);
    NJPD_DEBUG_HAL_MSG("%s : GetClock : 0x%04x\n", __FUNCTION__ , HAL_NJPD_GetClock());
}
...
void HAL_NJPD_Debug(void)
{
    ...
    else
    {
        ...
        NJPD_DEBUG_HAL_MSG("=======================================================\n");
        NJPD_DEBUG_HAL_MSG("1620  | 00/08 01/09 02/0A 03/0B 04/0C 05/0D 06/0E 07/0F\n");
        NJPD_DEBUG_HAL_MSG("=======================================================\n");
        for(u8i=0; u8i<0x80; u8i+=8)
        {
            NJPD_DEBUG_HAL_MSG("%02x    | %04x  %04x  %04x  %04x  %04x  %04x  %04x  %04x \n",u8i,
            __HAL_NJPD_Read2Byte(BK_1620_GENERAL(u8i)),
            __HAL_NJPD_Read2Byte(BK_1620_GENERAL(u8i+1)),
            __HAL_NJPD_Read2Byte(BK_1620_GENERAL(u8i+2)),
            __HAL_NJPD_Read2Byte(BK_1620_GENERAL(u8i+3)),
            __HAL_NJPD_Read2Byte(BK_1620_GENERAL(u8i+4)),
            __HAL_NJPD_Read2Byte(BK_1620_GENERAL(u8i+5)),
            __HAL_NJPD_Read2Byte(BK_1620_GENERAL(u8i+6)),
            __HAL_NJPD_Read2Byte(BK_1620_GENERAL(u8i+7))
            );
        }
        NJPD_DEBUG_HAL_MSG("=======================================================\n");
