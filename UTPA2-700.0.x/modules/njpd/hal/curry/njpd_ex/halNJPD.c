...
void HAL_NJPD_SetMIU(MS_U8 u8Idx)
{
    ...
    {
        // Note: there is no NJPD1 in curry
...
//    __HAL_NJPD_Write2Byte(BK_MCM_GENERAL(0x09), 0x0000);
//    printf("MCM 0x%lx\n", 0x00);
//    __HAL_NJPD_Write2Byte(BK_MCM_GENERAL(0x09), 0xf200);
//    printf("MCM 0x%lx\n", 0xf2);

//    __HAL_NJPD_Write2Byte(BK_MCM_GENERAL(0x09), 0xf000);
//    printf("MCM 0x%lx\n", 0xf0);

    __HAL_NJPD_Write2Byte(BK_MCM_GENERAL(0x09), 0x1200);
    printf("MCM 0x%lx\n", 0x12);
#endif
