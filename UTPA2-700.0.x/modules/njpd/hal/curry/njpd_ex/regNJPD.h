...
// CLKGEN2
// For Curry we use bank 0x0A,offset 0x11 bit(0:3) to set reg_ckg_njpd
#define NJPD_CLOCK                                  (NJPD_CLKGEN2_BASE+NJPD_OFFSET(0x11))     // Curry
...
// CHIPTOP
//Curry:  h0042	h0042	15	0	reg_miu_group2_i64
