...
#if USE_FW_HVD
#include "../../../vdec_v2/hal/maserati/hvd_ex/fwHVD_if.h"
...
void HAL_NJPD_JPDSelect(MS_BOOL bNJPD)
{
    if(bNJPD)
    {
// Ethan@20150429, I64 : 被tie值1'b0了 應該沒法用register下值
//        __HAL_NJPD_WriteBit(NJPD_MIU_GROUP1_I64, 0, NJPD_MIU0_CLIENT_NJPD_CS3);
    ...
    {
// Ethan@20150429, I64 : 被tie值1'b0了 應該沒法用register下值
//        __HAL_NJPD_WriteBit(NJPD_MIU_GROUP1_I64, 1, NJPD_MIU0_CLIENT_NJPD_CS3);
...
void HAL_NJPD_PowerOn()
{
    ...
    HAL_NJPD_Set_GlobalSetting02(HAL_NJPD_Get_GlobalSetting02() & ~NJPD_SRAM_SD_EN);
    MsOS_DelayTask(1);
#endif
