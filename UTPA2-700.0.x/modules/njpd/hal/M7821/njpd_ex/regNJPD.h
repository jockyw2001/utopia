...
// h0033	h0033	15	0	reg_rq1_mask
#define NJPD_MIU0_RQ1_MASK              (NJPD_MIU0_BASE+NJPD_OFFSET(0x33))
#define NJPD_MIU1_RQ1_MASK              (NJPD_MIU1_BASE+NJPD_OFFSET(0x33))
#define NJPD0_MIU0_CLIENT_NJPD          NJPD_BIT(3) //bit3 of the first byte (bit 3)
#define NJPD0_MIU1_CLIENT_NJPD          NJPD_BIT(3) //bit3 of the first byte (bit 3)
#define NJPD1_MIU0_CLIENT_NJPD          NJPD_BIT(3) //bit3 of the first byte (bit 3)
#define NJPD1_MIU1_CLIENT_NJPD          NJPD_BIT(3) //bit3 of the first byte (bit 3)
...
#define NJPD_MIU0_CLIENT_NJPD_CS3       NJPD_BIT(3) // bit3 of the first byte (bit 3)
