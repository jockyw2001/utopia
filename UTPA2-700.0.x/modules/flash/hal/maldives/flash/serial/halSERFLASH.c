...
static hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
    ...
    { FLASH_IC_SST25VF032B, MID_SST,    0x25,   0x4A,   _pstWriteProtectTable_SST25VF032B,  NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(2:0, 0x07),    ISP_DEV_SST,    ISP_SPI_ENDIAN_LITTLE, TRUE, NULL},
    ...
    { FLASH_IC_MX25L12805D, MID_MXIC,   0x20,   0x18,   _pstWriteProtectTable_MX25L12805D,  NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_MX25L3206E,  MID_MXIC,   0x20,   0x15,   _pstWriteProtectTable_MX25L3206E,   NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL},
    { FLASH_IC_MX25L8005,   MID_MXIC,   0x20,   0x14,   _pstWriteProtectTable_MX25L8005,    NULL,                       0x100000,   16,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_MX25L6406E,  MID_MXIC,   0x20,   0x17,   _pstWriteProtectTable_MX25L6406E,   NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL},
    ...
    { FLASH_IC_W25Q80,      MID_WB,     0x40,   0x14,   _pstWriteProtectTable_W25Q80,       NULL,                       0x100000,   16,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL},
    ...
    { FLASH_IC_AT25DF321A,  MID_ATMEL,  0x47,   0x01,   _pstWriteProtectTable_AT25DF321,    NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ATMEL,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    ...
    { FLASH_IC_EN25Q32A,    MID_EON,    0x30,   0x16,   _pstWriteProtectTable_EN25Q32A,     NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_EN25Q64,      MID_EON,    0x30,   0x17,   _pstWriteProtectTable_EN25Q64,     NULL,                       0x800000,   128,     SIZE_64KB,  256,    50,    BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_EN25Q128,    MID_EON,    0x30,   0x18,   _pstWriteProtectTable_EN25Q128,     NULL,                       0x1000000,   256,   SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    ...
    { FLASH_IC_S25FL032P,   MID_SPAN,   0x02,   0x15,   NULL,                               NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(4:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_S25FL064P,   MID_SPAN,   0x02,   0x16,   NULL,                               NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(4:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_S25FL032K,   MID_SPAN,   0x40,   0x16,   _pstWriteProtectTable_S25FL032K_CMP0, NULL,                     0x400000,   64,     SIZE_64KB,  256,    50,     BITS(6:2, 0x1F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    ...
    { FLASH_IC_PM25LQ032C,  MID_PMC,    0x46,   0x15,   _pstWriteProtectTable_PM25LQ032C,  NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x1F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_GD25Q32,     MID_GD,     0x40,   0x16,   _pstWriteProtectTable_GD25Q32_CMP0, NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(6:2, 0x1F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL},
    ...
    { FLASH_IC_ESMT_F25L016PA, MID_ESMT, 0x21,   0x15,  _pstWriteProtectTable_F25L016PA,    NULL,                       0x200000,   32,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_PMC,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    ...
    { FLASH_IC_ESMT_F25L064QA, MID_ESMT, 0x41,   0x17,  _pstWriteProtectTable_F25L064QA,    NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_PMC,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_EN25Q32,     MID_EON,    0x30,   0x16,    _pstWriteProtectTable_EN25Q32,      NULL,                      0x400000,   32,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_EN25Q16,     MID_EON,    0x30,   0x15,    _pstWriteProtectTable_EN25Q16,      NULL,                      0x200000,   32,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_MICRON_M25P16,   MID_MICRON, 0x20,   0x15,   _pstWriteProtectTable_M25P16,   NULL,                       0x200000,    32,    SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_PMC,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_MICRON_N25Q32,   MID_MICRON, 0xBA,   0x16,   _pstWriteProtectTable_N25Q32,   NULL,                       0x400000,    64,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_MICRON_N25Q64,   MID_MICRON, 0xBA,   0x17,   _pstWriteProtectTable_N25Q64,   NULL,                       0x800000,    128,   SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
    { FLASH_IC_MICRON_N25Q128,  MID_MICRON, 0xBA,   0x18,   _pstWriteProtectTable_N25Q128,   NULL,                       0x1000000,   256,   SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL},
};
...
static void _HAL_FSP_SetCommand(MS_U8 u8FLASHCmd)
{
    HAL_WriteByte((REG_FSP_WRITE_BUFF + REG8_FSP_COMMAND),u8FLASHCmd);
}

static void _HAL_FSP_SetCommand1(MS_U8 u8FLASHCmd)
{
    HAL_WriteByte((REG_FSP_WRITE_BUFF + REG8_FSP_COMMAND1),u8FLASHCmd);
}
...
static void _HAL_FSP_GetRData(MS_U8 *pu8Data, MS_U8 u8DataSize)
{
    MS_U8 u8Index = 0;
    for (u8Index = 0; u8Index < u8DataSize; u8Index++)
    {
        pu8Data[u8Index] = HAL_ReadByte((REG_FSP_READ_BUFF + u8Index));
    }
}


static MS_BOOL _HAL_FSP_ChkWaitDone(void)
{
//consider as it spend very long time to check if FSP done, so it may implment timeout method to improve
    ...
    {
        u8DoneFlag = HAL_ReadByte(REG_FSP_DONE);
    ...
    printf("FSP Check done flag Error\n");
    return FALSE;
}

static MS_BOOL _HAL_FSP_CheckRDSR(MS_U8 CHECK_BITMAP)
{
    MS_U16 Flash_Status = 0;
    MS_U16 u16TyrCnt = 0;

    //FSP init config
    HAL_Write2Byte(REG_FSP_CTRL, (ENABLE_FSP|RESET_FSP|INT_FSP));

    //FSP WREN Command , same as SPI Flash
    _HAL_FSP_SetCommand(ISP_SPI_CMD_RDSR);

    //FSP Set Write length for writing 'WREN' command , so Write length is setted as 1 bytes and Read length is setted as 0 bytes
    HAL_Write2Byte(REG_FSP_WRITE_SIZE, 1);
    HAL_Write2Byte(REG_FSP_READ_SIZE, 1);

    //FSP Trigger
    HAL_WriteByte(REG_FSP_TRIGGER, TRIGGER_FSP);
    ...
    HAL_WriteByte(REG_FSP_CLEAR_DONE, CLEAR_DONE_FSP);



    while(u16TyrCnt < 2000)
    {
        Flash_Status = HAL_ReadByte(REG_FSP_READ_BUFF);

        switch (CHECK_BITMAP)
        {
        case FLASH_BUSY_BIT_EREASE:
        case FLASH_BUSY_BIT:
            if(!(Flash_Status & FLASH_BUSY_BIT))
                return TRUE;
            break;
        case FLASH_WRITE_ENANLE:
            if((Flash_Status & FLASH_WRITE_ENANLE))
                return TRUE;
            break;
        }
        HAL_WriteByte(REG_FSP_TRIGGER, TRIGGER_FSP);
...
static MS_BOOL _HAL_FSP_WREN(void)
{
    //FSP init config
    HAL_Write2Byte(REG_FSP_CTRL, (ENABLE_FSP|RESET_FSP|INT_FSP));

    //FSP WREN Command , same as SPI Flash
    _HAL_FSP_SetCommand(ISP_SPI_CMD_WREN);

    //FSP Set Write length for writing 'WREN' command , so Write length is setted as 1 bytes and Read length is setted as 0 bytes
    HAL_Write2Byte(REG_FSP_WRITE_SIZE,1);
    HAL_Write2Byte(REG_FSP_READ_SIZE,0);
    //FSP Trigger
    HAL_WriteByte(REG_FSP_TRIGGER, TRIGGER_FSP);
    ...
    //clear FSP done flag
    HAL_WriteByte(REG_FSP_CLEAR_DONE, CLEAR_DONE_FSP);
    _HAL_FSP_CheckRDSR(FLASH_WRITE_ENANLE);

    return TRUE;
}

static MS_BOOL _HAL_FSP_PROGRAM_SPSR(MS_BOOL Enable)
{
    MS_U16 RDSR = 0;
    //FSP init config
    HAL_Write2Byte(REG_FSP_CTRL, (ENCMD2_3|ENABLE_FSP|RESET_FSP|INT_FSP));

    //FSP WREN Command , same as SPI Flash
    _HAL_FSP_SetCommand(ISP_SPI_CMD_WREN);

    //Set FSP Write Status register command
    _HAL_FSP_SetCommand1(ISP_SPI_CMD_WDSR);

    //Set status register content
    if(Enable)
        HAL_WriteByte((REG_FSP_WRITE_BUFF + 2),WRITE_PROTECT_ENABLE);
    else
        HAL_WriteByte((REG_FSP_WRITE_BUFF + 2),WRITE_PROTECT_DISABLE);

    // read Status Register
    HAL_WriteByte((REG_FSP_WRITE_BUFF + 3),ISP_SPI_CMD_RDSR);

    //Set Write & Read Length
    HAL_Write2Byte(REG_FSP_WRITE_SIZE,0x121);  //command + status register length
    HAL_Write2Byte(REG_FSP_READ_SIZE,0x100);
    ...
    if (_HAL_FSP_ChkWaitDone() == FALSE)
        return FALSE;
    RDSR = HAL_Read2Byte(REG_FSP_READ_BUFF);
    printf("RDSR = %x\n",RDSR);

    _HAL_FSP_CheckRDSR(FLASH_BUSY_BIT);
    return TRUE;
...
void HAL_FSP_Entry(void)
{
    ...
    u8Mode = (HAL_Read2Byte(REG_ISP_SPI_MODE) & 0x000F);
    HAL_Write2Byte(REG_ISP_SPI_MODE, 0x0000);
}

void HAL_FSP_Exit(void)
{
    HAL_Write2Byte(REG_ISP_SPI_MODE, u8Mode);
    MsOS_ReleaseMutex(_s32SERFLASH_Mutex);
}

MS_BOOL _HAL_FSP_BlockErase(MS_U32 u32FlashAddr, EN_FLASH_ERASE eSize)
{

    //write enable and disable write protect
    _HAL_FSP_PROGRAM_SPSR(FALSE);

    printf("u32FlashAddr = %lx eSize = %x\n",u32FlashAddr, eSize);
    ...
    //send WREN Command to FSP

    //Set FSP Block Earse Command
    _HAL_FSP_SetCommand(ISP_SPI_CMD_64BE);

    //Set Block Earse Address
    // write low byte address
    HAL_WriteByte((REG_FSP_WRITE_BUFF + 3),(MS_U8)(u32FlashAddr & 0xFF));
    u32FlashAddr >>= 8;
    // write mid byte address
    HAL_WriteByte((REG_FSP_WRITE_BUFF + 2),(MS_U8)(u32FlashAddr & 0xFF));
    u32FlashAddr >>= 8;
    // write high byte address
    HAL_WriteByte((REG_FSP_WRITE_BUFF + 1),(MS_U8)(u32FlashAddr & 0xFF));

    // read Status Register Command
    HAL_WriteByte((REG_FSP_WRITE_BUFF + 4),ISP_SPI_CMD_RDSR);
    // read Status Register Command
    HAL_WriteByte((REG_FSP_WRITE_BUFF + 5),ISP_SPI_CMD_RDSR);
    //Set Write & Read Length
    HAL_Write2Byte(REG_FSP_WRITE_SIZE,0x114);  //command + address ==> 4 bytes
    ...
    _HAL_FSP_CheckRDSR(FLASH_BUSY_BIT_EREASE);

    _HAL_FSP_PROGRAM_SPSR(TRUE);
...
MS_BOOL HAL_FSP_Write(MS_U32 u32Addr, MS_U32 u32DataSize, MS_U8 *pu8Data)
{
    MS_U8 u8Index = 0;
    MS_U16 j = 0;
    MS_U8 *pu8WData = pu8Data;
    MS_U32 u32RealLength = 0;
    MS_U32 u32WriteAddr = u32DataSize;
    //write enable and disable write protect
    _HAL_FSP_PROGRAM_SPSR(FALSE);
    ...
    _HAL_FSP_SetCommand1(ISP_SPI_CMD_PP);

    // read Status Register
    HAL_WriteByte((REG_FSP_WRITE_BUFF + 9),ISP_SPI_CMD_RDSR);

    //Set Write & Read Length
    HAL_Write2Byte(REG_FSP_WRITE_SIZE,0x181); //add 4 because it is included of command and Address setting lengthL_FSP_SetAddr
    HAL_Write2Byte(REG_FSP_READ_SIZE,0x100);

    //Set Write Data
    //_HAL_FSP_SetWData(pu8Data, u8DataSize);

    for(j= 0; j < u32DataSize; j+=SINGLE_WRITE_LENGTH)
    {
        u32RealLength = u32DataSize - j;
        u32WriteAddr = u32Addr;
        // write low byte address
        HAL_WriteByte((REG_FSP_WRITE_BUFF + REG8_FSP_WADDR_L),(MS_U8)(u32WriteAddr & 0xFF));
        u32WriteAddr >>= 8;
        // write mid byte address
        HAL_WriteByte((REG_FSP_WRITE_BUFF + REG8_FSP_WADDR_M),(MS_U8)(u32WriteAddr & 0xFF));
        u32WriteAddr >>= 8;
        // write high byte address
        HAL_WriteByte((REG_FSP_WRITE_BUFF + REG8_FSP_WADDR_H),(MS_U8)(u32WriteAddr & 0xFF));

        if(u32RealLength >= SINGLE_WRITE_LENGTH)
            u32RealLength = SINGLE_WRITE_LENGTH;

        for (u8Index = 0; u8Index < u32RealLength; u8Index++)
        {
            u32WriteAddr = REG_FSP_WRITE_BUFF + REG8_FSP_WDATA + u8Index;
            HAL_WriteByte(u32WriteAddr, pu8WData[u8Index]);
        }
        //Trigger FSP
        HAL_WriteByte(REG_FSP_TRIGGER, TRIGGER_FSP);
        ...
        //Clear FSP done flag
        HAL_WriteByte(REG_FSP_CLEAR_DONE, CLEAR_DONE_FSP);
        pu8WData += u32RealLength;
        // write low byte address
        u32Addr += u32RealLength;
...
MS_BOOL HAL_FSP_Read(MS_U32 u32Addr, MS_U32 u32DataSize, MS_U8 *pu8Data)
{
    MS_U16 j =0;
    MS_U32 u32RealLength = u32DataSize;
    MS_U32 u32WriteAddr;
    HAL_Write2Byte(REG_FSP_PASSWORD,0x0000);

    //FSP init config
    HAL_Write2Byte(REG_FSP_CTRL, (ENABLE_FSP|RESET_FSP|INT_FSP));

    //Set FSP Read Command
    _HAL_FSP_SetCommand(ISP_SPI_CMD_READ);

    //Set Write & Read Length
    HAL_Write2Byte(REG_FSP_WRITE_SIZE, 4); //add 4 because it is included of command and Address setting length
    HAL_Write2Byte(REG_FSP_READ_SIZE, SINGLE_READ_LENGTH);

    for(j = 0;j < u32DataSize; j +=SINGLE_READ_LENGTH)
    {
        //Set Write Address
        // write low byte address
        u32RealLength = u32DataSize - j;
        u32WriteAddr = u32Addr;
        HAL_WriteByte((REG_FSP_WRITE_BUFF + REG8_FSP_RADDR_L),(MS_U8)(u32WriteAddr & 0xFF));

        u32WriteAddr >>= 8;
        // write mid byte address
        HAL_WriteByte((REG_FSP_WRITE_BUFF + REG8_FSP_RADRR_M),(MS_U8)(u32WriteAddr & 0xFF));

        u32WriteAddr >>= 8;
        // write high byte address
        HAL_WriteByte((REG_FSP_WRITE_BUFF + REG8_FSP_RADDR_H),(MS_U8)(u32WriteAddr & 0xFF));
        ...
        //Get Read Data
        if(u32RealLength >= SINGLE_READ_LENGTH)
            u32RealLength = SINGLE_READ_LENGTH;
            _HAL_FSP_GetRData((pu8Data + j), u32RealLength);
