...
typedef struct
{
    ...
    MS_U32  u32RiuBaseAddr;    // REG_PM_BASE
} hal_isp_t;
...
static ST_WRITE_PROTECT _pstWriteProtectTable_F25L016PA[] =
{
    //  BPX,            Lower Bound                 Upper Bound
...
static ST_WRITE_PROTECT _pstWriteProtectTable_F25L064QA[] =
{
    //  BPX,            Lower Bound                 Upper Bound
...
static hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
    ...
    { FLASH_IC_SST25VF032B, MID_SST,    0x25,   0x4A,   _pstWriteProtectTable_SST25VF032B,  NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(2:0, 0x07),    ISP_DEV_SST,    ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_MX25L3205D,  MID_MXIC,   0x20,   0x16,   _pstWriteProtectTable_MX25L3205D,   NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_MX25L6405D,  MID_MXIC,   0x20,   0x17,   _pstWriteProtectTable_MX25L6405D,   NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_MX25L1606E,  MID_MXIC,   0x20,   0x15,   _pstWriteProtectTable_MX25L1606E,   NULL,                       0x200000,   32,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_MX25L12805D, MID_MXIC,   0x20,   0x18,   _pstWriteProtectTable_MX25L12805D,  NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_MX25L3206E,  MID_MXIC,   0x20,   0x15,   _pstWriteProtectTable_MX25L3206E,   NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_MX25L8005,   MID_MXIC,   0x20,   0x14,   _pstWriteProtectTable_MX25L8005,    NULL,                       0x100000,   16,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_MX25L6406E,  MID_MXIC,   0x20,   0x17,   _pstWriteProtectTable_MX25L6406E,   NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_W25Q16,	    MID_WB, 	0x40,	0x15,	NULL,                             	NULL,						0x200000,	32, 	SIZE_64KB,	256,	50, 	BITS(4:2, 0x07),	ISP_DEV_ST,	    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,2},
    { FLASH_IC_W25X32,      MID_WB,     0x30,   0x16,   _pstWriteProtectTable_W25X32,       NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,2},
    { FLASH_IC_W25Q32,      MID_WB,     0x40,   0x16,   _pstWriteProtectTable_W25X32,       NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,2},
    { FLASH_IC_W25X64,      MID_WB,     0x30,   0x17,   _pstWriteProtectTable_W25X64,       NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,2},
    { FLASH_IC_W25Q64,      MID_WB,     0x40,   0x17,   _pstWriteProtectTable_W25X64,       NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,2},
    { FLASH_IC_W25X80,		MID_WB, 	0x30,	0x14,	_pstWriteProtectTable_W25X80,		NULL,						0x100000,	16, 	SIZE_64KB,	256,	50, 	BITS(5:2, 0x0F),	ISP_DEV_ST,	    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_W25Q80,      MID_WB,     0x40,   0x14,   _pstWriteProtectTable_W25Q80,       NULL,                       0x100000,   16,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,2},
    { FLASH_IC_W25Q128,     MID_WB,     0x40,   0x18,   _pstWriteProtectTable_W25Q128,      NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_AT25DF321A,  MID_ATMEL,  0x47,   0x01,   _pstWriteProtectTable_AT25DF321,    NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ATMEL,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_AT26DF321,   MID_ATMEL,  0x47,   0x00,   _pstWriteProtectTable_AT26DF321,    NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ATMEL,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_STM25P32,    MID_ST,     0x20,   0x16,   NULL,                               NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25B32B,    MID_EON,    0x20,   0x16,   NULL,                               &_stSpecialBlocks_EN25B32B, 0x400000,   68,     SIZE_64KB,  256,    384,    BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25B64B,    MID_EON,    0x20,   0x17,   NULL,                               &_stSpecialBlocks_EN25B64B, 0x800000,   132,    SIZE_64KB,  256,    384,    BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25Q32A,    MID_EON,    0x30,   0x16,   _pstWriteProtectTable_EN25Q32A,     NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25Q64,      MID_EON,    0x30,   0x17,   _pstWriteProtectTable_EN25Q64,     NULL,                       0x800000,   128,     SIZE_64KB,  256,    50,    BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25Q128,    MID_EON,    0x30,   0x18,   _pstWriteProtectTable_EN25Q128,     NULL,                       0x1000000,   256,   SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25F10,     MID_EON,    0x31,   0x11,   NULL,                               &_stSpecialBlocks_EN25F10,  0x20000,    4,      SIZE_32KB,  256,    384,    BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25F16,     MID_EON,    0x31,   0x15,   _pstWriteProtectTable_EN25F16,      NULL,  						0x200000,   32,     SIZE_64KB,  256,    384,    BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25F32,     MID_EON,    0x31,   0x16,   _pstWriteProtectTable_EN25F32,      NULL,                       0x400000,   64,     SIZE_64KB,  256,    384,    BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25F80,     MID_EON,    0x31,   0x14,   _pstWriteProtectTable_EN25F80,      NULL,                       0x100000,   16,     SIZE_64KB,  256,    384,    BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25P16,     MID_EON,    0x20,   0x15,    _pstWriteProtectTable_EN25P16,      NULL,                      0x200000,   32,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25QH16,    MID_EON,    0x70,   0x15,    _pstWriteProtectTable_EN25Q16,      NULL,                      0x200000,   32,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_S25FL032P,   MID_SPAN,   0x02,   0x15,   NULL,                               NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(4:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_S25FL064P,   MID_SPAN,   0x02,   0x16,   NULL,                               NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(4:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_S25FL032K,   MID_SPAN,   0x40,   0x16,   _pstWriteProtectTable_S25FL032K_CMP0, NULL,                     0x400000,   64,     SIZE_64KB,  256,    50,     BITS(6:2, 0x1F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_S25FL128P,   MID_SPAN,   0x20,   0x18,   _pstWriteProtectTable_S25FL128P,    NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_S25FL127S,   MID_SPAN,   0x20,   0x18,   _pstWriteProtectTable_S25FL127S,      NULL,                          0x1000000,  286,    SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE,  _stHybridBlocks_S25FL127S_bot,1},
    { FLASH_IC_S25FL008A,   MID_SPAN,   0x20,   0x13,   _pstWriteProtectTable_S25FL008A,    NULL,                       0x100000,   16,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_PM25LQ032C,  MID_PMC,    0x46,   0x15,   _pstWriteProtectTable_PM25LQ032C,  NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x1F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_GD25Q32,     MID_GD,     0x40,   0x16,   _pstWriteProtectTable_GD25Q32_CMP0, NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(6:2, 0x1F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_GD25Q16,     MID_GD,     0x40,   0x15,   _pstWriteProtectTable_GD25Q16,      NULL,                       0x200000,   32,     SIZE_64KB,  256,    50,     BITS(6:2, 0x1F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,1},
    { FLASH_IC_GD25Q80B,     MID_GD,     0x40,   0x14,   _pstWriteProtectTable_GD25Q80B_CMP0, NULL,                       0x100000,   16,     SIZE_64KB,  256,    50,     BITS(6:2, 0x1F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, TRUE, NULL,2},
    { FLASH_IC_ESMT_F25L016PA, MID_ESMT, 0x21,   0x15,  _pstWriteProtectTable_F25L016PA,    NULL,                       0x200000,   32,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_PMC,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_ESMT_F25L032QA, MID_ESMT, 0x41,   0x16,  _pstWriteProtectTable_F25L032QA,    NULL,                       SIZE_4MB,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_ESMT_F25L032PA, MID_ESMT, 0x20,   0x16,  _pstWriteProtectTable_F25L032PA,    NULL,                       SIZE_4MB,   64,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_ESMT_F25L064QA, MID_ESMT, 0x41,   0x17,  _pstWriteProtectTable_F25L064QA,    NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_PMC,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25Q32,     MID_EON,    0x30,   0x16,    _pstWriteProtectTable_EN25Q32,      NULL,                      0x400000,   32,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_EN25Q16,     MID_EON,    0x30,   0x15,    _pstWriteProtectTable_EN25Q16,      NULL,                      0x200000,   32,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_MICRON_M25P16,   MID_MICRON, 0x20,   0x15,   _pstWriteProtectTable_M25P16,   NULL,                       0x200000,    32,    SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_PMC,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_MICRON_N25Q32,   MID_MICRON, 0xBA,   0x16,   _pstWriteProtectTable_N25Q32,   NULL,                       0x400000,    64,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_MICRON_N25Q64,   MID_MICRON, 0xBA,   0x17,   _pstWriteProtectTable_N25Q64,   NULL,                       0x800000,    128,   SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
    { FLASH_IC_MICRON_N25Q128,  MID_MICRON, 0xBA,   0x18,   _pstWriteProtectTable_N25Q128,   NULL,                       0x1000000,   256,   SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE, NULL,1},
};
...
MS_BOOL (*_HAL_FSP_PageWrite_Callback_Func)(MS_U32 u32Addr_tmp,
                                         MS_U32 u32Size_tmp,
                                         MS_U8 *pu8Data_tmp,
                                         MS_U32 u32PageIdx_tmp,
                                         MS_U32 u32Remain_tmp
                                         );
void HAL_FSP_Write_Engine(MS_U32 u32Write_Addr, MS_U32 u32Size, MS_U8 *pu8Data);
//-------------------------------------------------------------------------------------------------
//  Debug Functions
//-------------------------------------------------------------------------------------------------
...
MS_BOOL HAL_SERFLASH_BlockErase(MS_U32 u32StartBlock, MS_U32 u32EndBlock, MS_BOOL bWait)
{
    ...
    DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG,printf("HAL_SERFLASH_BlockErase u32StartBlock = %ld u32EndBlock = %ld\r\n",u32StartBlock,u32EndBlock));
...
#else
   HAL_FSP_Entry();
   bRet=HAL_FSP_BlockErase(u32StartBlock, u32EndBlock, bWait);
   HAL_FSP_Exit();
#endif
   return bRet;
}
...
MS_U32 HAL_SERFLASH_WriteProtect_Area_Boundary(void)
{
        ...
        )
    {
        ...
        {
            k = i;
            DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG,printf("u32UpperBound = %lx\n",_hal_SERFLASH.pWriteProtectTable[k].u32UpperBound));
...
static MS_BOOL _HAL_FSP_WaitDone(void)
{
    MS_BOOL bRet = FALSE;
    MS_U32 u32Timer;
    SER_FLASH_TIME(u32Timer, 1000 * 30);
    do{
...
void HAL_FSP_Write_Engine(MS_U32 u32Write_Addr, MS_U32 u32Size, MS_U8 *pu8Data)
{
	  ...
	  HAL_FSP_WriteBufs(5,0x3F);
	  HAL_FSP_WriteBufs(6,0x58);
	  HAL_FSP_WriteBufs(7,0x00);
	  HAL_FSP_WriteBufs(8,0x00);
...
MS_BOOL HAL_FSP_Write(MS_U32 u32Addr, MS_U32 u32Size, MS_U8 *pu8Data)
{
    ...
    //_HAL_FSP_Write_Callback_Func=HAL_FSP_Write_Burst;
...
MS_BOOL HAL_FSP_WriteStatusReg(MS_U16 u16StatusReg)
{
    ...
    if(_hal_SERFLASH. u8SRSDatByte == 2)
    {
