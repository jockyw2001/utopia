...
#define FLASH_IC_S25FL208K      0x0809      // 1M
#define FLASH_IC_S25FL512S      0x080A      // 64M
...
#define FLASH_IC_ESMT_F25L016PA 0x0A00      // 2M
#define FLASH_IC_ESMT_F25L032QA 0x0A01      // 4M
#define FLASH_IC_ESMT_F25L032PA 0x0A02      // 4M
#define FLASH_IC_ESMT_F25L064QA 0x0A03      // 8M
...
extern MS_BOOL HAL_SERFLASH_DYB_WRITE(MS_U32 u32Addr, MS_U8 u8Data);
extern MS_BOOL HAL_FSP_BlockErase(MS_U32 u32StartBlock, MS_U32 u32EndBlock, MS_BOOL bWait);
...
extern MS_BOOL HAL_FSP_SectorErase(MS_U32 u32SectorAddress,MS_U8 u8cmd);
