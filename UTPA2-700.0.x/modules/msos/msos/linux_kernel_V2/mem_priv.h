...
struct Cyg_Mempool_Implementation_s{
    ...
    MS_VIRT
    (*roundup)(Cyg_Mempool_Implementation* pThis, MS_VIRT size);
...
inline MS_VIRT
Cyg_Mempool_Implementation__roundup( Cyg_Mempool_Implementation* pThis, MS_VIRT size )
{
