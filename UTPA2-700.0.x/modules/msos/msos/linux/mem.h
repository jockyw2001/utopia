...
#define cyg_handle_t            MS_VIRT//MS_U32
...
externC void cyg_mempool_var_create(
    ...
    MS_VIRT             *handle,            /* returned handle of memory pool */
    cyg_mempool_var *var                /* space to put pool structure in */
    ) __THROW;

/* Delete variable size memory pool */
externC void cyg_mempool_var_delete(MS_VIRT varpool) __THROW;
...
externC void cyg_mempool_var_free(MS_VIRT varpool, void *p) __THROW;
