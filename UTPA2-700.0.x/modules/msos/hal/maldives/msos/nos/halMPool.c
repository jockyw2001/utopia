...
//for mboot
#if (defined(MBOOT))
    //===========================================
    // MIU0 (low 512MB) (VA) 0x2000:0000 ~ 0x3fff:ffff -> (PA) 0x0000:0000 ~ 0x1fff:ffff (cached)
    ...
    //===========================================
    // MIU0 (low 512MB) (VA) 0x4000:0000 ~ 0x5fff:ffff -> (PA) 0x0000:0000 ~ 0x1fff:ffff (uncached)
    if (((HAL_MIU0_BUS_BASE + 0x20000000) <= u32Virt) && ((HAL_MIU0_BUS_BASE + 0x3fffffff) >= u32Virt))
    {
        return (u32Virt & 0x1fffffff);
    }
...
//for arm
    ...
    {
        return ((u32Phys & 0x1fffffff) + HAL_MIU0_BUS_BASE);
    }
...
//for arm
    ...
    if ((0x00000000 <= u32Phys) && (0x1fffffff >= u32Phys))
    {
        return ((u32Phys & 0x1fffffff) + HAL_MIU0_BUS_BASE + 0x20000000);
    }
