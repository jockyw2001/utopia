...
//for mboot
    ...
    if (((HAL_MIU0_BUS_BASE + 0x40000000UL) <= u32Virt) && ((HAL_MIU0_BUS_BASE + 0x7fffffffUL) >= u32Virt))
    {
        return (MS_U32)(u32Virt - (HAL_MIU0_BUS_BASE+0x40000000UL));
    }
    ...
    {
        return (MS_U32)((u32Virt & 0x1fffffffUL) + HAL_MIU1_BASE);
    }

    //===========================================
    // MIU1 (0 ~ 1024MB) (VA) 0xc000:0000 ~ 0xffff:ffff -> (PA) 0x8000:0000 ~ 0xbfff:ffff (uncached)
    if (((HAL_MIU1_BUS_BASE + 0x20000000UL) <= u32Virt) && ((HAL_MIU1_BUS_BASE + 0x5fffffff) >= u32Virt))
    {
        return (MS_U32)((u32Virt & 0x3fffffffUL) + HAL_MIU1_BASE);
    }
...
//for arm
    ...
    if ((0x00000000UL <= u32Phys) && (0x3fffffffUL >= u32Phys))
    {
        return (MS_U32)((u32Phys & 0x3fffffffUL) + HAL_MIU0_BUS_BASE);
    }
...
//for arm
    ...
    if ((0x00000000UL <= u32Phys) && (0x3fffffffUL >= u32Phys))
    {
        return (MS_U32)((u32Phys & 0x3fffffffUL) + HAL_MIU0_BUS_BASE + 0x40000000UL);
    }

    //===========================================
    // MIU1 (0~1024MB) - (PA) 0x8000:0000 ~ 0xBfff:ffff -> (VA) 0xc000:0000 ~ 0xFfff:ffff (uncached)
    if ((HAL_MIU1_BASE <= u32Phys) && ((HAL_MIU1_BASE + 0x3fffffffUL) >= u32Phys))
    {
