...
#define MALLOC_IOC_MPOOL_DLMALLOC_CREATE_POOL	_IOWR(MALLOC_IOC_MAGIC, 0x20, DevMalloc_MPool_Dlmalloc_Info_t)
#define MALLOC_IOC_MPOOL_DLMALLOC_DELETE_POOL	_IOWR(MALLOC_IOC_MAGIC, 0x21, DevMalloc_MPool_Dlmalloc_Delete_Info_t)
#define MALLOC_IOC_MPOOL_DLMALLOC_ALLOC_POOL_MEMORY	_IOWR(MALLOC_IOC_MAGIC, 0x22, DevMalloc_MPool_Dlmalloc_Alloc_Free_Info_t)
#define MALLOC_IOC_MPOOL_DLMALLOC_FREE_POOL_MEMORY	_IOWR(MALLOC_IOC_MAGIC, 0x23, DevMalloc_MPool_Dlmalloc_Alloc_Free_Info_t)
#define MALLOC_IOC_MPOOL_DLMALLOC_REALLOC_POOL_MEMORY	_IOWR(MALLOC_IOC_MAGIC, 0x24, DevMalloc_MPool_Dlmalloc_Alloc_Free_Info_t)
#endif
...
typedef struct
{
	MS_U64 pool_bus_addr;	// pool start ba addr						, output
	MS_U64 bus_addr;		// buffer start ba addr						, input
	...
	int locked;
} DevMalloc_MPool_Dlmalloc_Info_t;

typedef struct
{
	MS_U64 pool_bus_addr;	// pool start ba addr						, input
} DevMalloc_MPool_Dlmalloc_Delete_Info_t;

typedef struct
{
	MS_U64 pool_bus_addr;	// pool start ba addr						, input
	MS_U64 alloc_addr;		// alloc return ba addr / re-alloc ori ba addr / free ba addr
	MS_U64 new_alloc_addr;	// re-alloc return ba addr
	size_t alloc_size;		// alloc or re-alloc size					, input
} DevMalloc_MPool_Dlmalloc_Alloc_Free_Info_t;
#endif
#endif
