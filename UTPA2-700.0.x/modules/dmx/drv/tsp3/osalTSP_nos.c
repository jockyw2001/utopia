...
#define TSP_NOS_EVT_NUM         0x10UL

extern MS_U32 _u32IntNum;

MS_S32 u32EventId[TSP_NOS_EVT_NUM];
MS_U32 u32EventFree = 0xFFFFFFFFUL;
...
{
    if (0x87650000UL != (0xFFFF0000UL & s32TspEventId))
    {
        return FALSE;
    }
    else
    {
        s32TspEventId &= 0x0000FFFFUL;
    }
    u32EventFree |= (1UL<< s32TspEventId);
    u32EventId[s32TspEventId] = 0x0UL;
    return TRUE;
}
...
inline MS_BOOL OSAL_TSP_EventSet(MS_S32 s32EventGroupId, MS_U32 u32EventFlag)
{
    ...
    if (0x87650000UL != (0xFFFF0000UL & s32EventGroupId))
    {
        return FALSE;
    }

    u32Id = s32EventGroupId & 0x0000FFFFUL;
...
inline MS_BOOL OSAL_TSP_EventGet(MS_S32 s32TspEventId, MS_U32 u32EventGroup, MS_U32* pu32RetrievedEventFlag, MS_U32 u32Opt, MS_U32 u32Timeout)
{
    ...
    u32Id = s32TspEventId & 0x0000FFFFUL;
