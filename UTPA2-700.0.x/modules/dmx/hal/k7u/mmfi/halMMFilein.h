...
void    HAL_MMFI_Get_APid_Status(MS_U8 u8Eng, MS_U16 *pu16pid, MS_BOOL *pbchanged);     // @NOTE: need to delete
void    HAL_MMFI_Get_APidB_Status(MS_U8 u8Eng, MS_U16 *pu16pid, MS_BOOL *pbchanged);    // @NOTE: need to delete
void    HAL_MMFI_Get_APidC_Status(MS_U8 u8Eng, MS_U16 *pu16pid, MS_BOOL *pbchanged);    // @NOTE: need to delete
void    HAL_MMFI_Get_APidD_Status(MS_U8 u8Eng, MS_U16 *pu16pid, MS_BOOL *pbchanged);    // @NOTE: need to delete
void    HAL_MMFI_Get_VPid_Status(MS_U8 u8Eng, MS_U16 *pu16pid, MS_BOOL *pbchanged);     // @NOTE: need to delete
void    HAL_MMFI_Get_VPid3D_Status(MS_U8 u8Eng, MS_U16 *pu16pid, MS_BOOL *pbchanged);   // @NOTE: need to delete
void    HAL_MMFI_Get_VPid3_Status(MS_U8 u8Eng, MS_U16 *pu16pid, MS_BOOL *pbchanged);    // @NOTE: need to delete
void    HAL_MMFI_Get_VPid4_Status(MS_U8 u8Eng, MS_U16 *pu16pid, MS_BOOL *pbchanged);    // @NOTE: need to delete
