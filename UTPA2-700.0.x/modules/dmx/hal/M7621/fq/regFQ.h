...
//-------------------------------------------------------------------------------------------------
// Software
#define FQ_REG_CTRL_BASE           (0x60A80UL * 2UL)
...
typedef struct _REG_FIQ
{
    ...
    #define FIQ_CFG0_FIQ2MI_DSWAP                       0x0008
    #define FIQ_CFG0_FIQ2MI_BITORD_BIG                  0x0010
    ...
    REG32_FQ        str2mi_head;                                    //0x41
    REG32_FQ        str2mi_tail;                                    //0x43
    REG32_FQ        str2mi_mid;                                     //0x45
    REG32_FQ        rush_addr;                                      //0x47
    REG32_FQ        cur_pkt_start_wadr_offset;                      //0x49

    REG16_FQ        Reg_fiq_config11;                               //0x4b
    #define FIQ_CFG11_FIQ_BYPASS                        0x0001      //FIQ_bypass
    #define FIQ_CFG11_BURST_LEVEL_MASK                  0x0006      
    #define FIQ_CFG11_BURST_LEVEL_25                    0x0000
    #define FIQ_CFG11_BURST_LEVEL_50                    0x0002
    #define FIQ_CFG11_BURST_LEVEL_75                    0x0004
    #define FIQ_CFG11_BURST_LEVEL_100                   0x0006
    #define FIQ_CFG11_SKIP_RUSH_DATA_PATH_MASK          0x13F8
    ...
    #define FIQ_CFG11_LPCR1_WLD                         0x0400      
    #define FIQ_CFG11_LPCR1_LOAD                        0x0800
    #define FIQ_CFG11_SKIP_PCR1_RUSH_DATA               0x1000
    #define FIQ_CFG11_TIMESTAMP_SRC_SEL                 0x2000
    #define FIQ_CFG11_C27M_EN_FIQ                       0x4000

    #define FIQ_CFG11_SKIP_RUSH_DATA_PATH1_MASK         0x0238
    #define FIQ_CFG11_SKIP_RUSH_DATA_PATH1_NON          0x0000
    #define FIQ_CFG11_SKIP_APES_C_RUSH_DATA             0x0008
    #define FIQ_CFG11_SKIP_APES_D_RUSH_DATA             0x0010
    #define FIQ_CFG11_SKIP_V3DPES_RUSH_DATA             0x0020
    #define FIQ_CFG11_SKIP_PVR2_RUSH_DATA               0x0200
    #define FIQ_CFG11_SKIP_PVR3_RUSH_DATA               0x0000  

    REG32_FQ        pkt_addr_offset;                                //0x4c
    REG16_FQ        REG_FIQ0_CFG2;                                  //0x4e
    REG16_FQ        REG_FIQ0_CFG3;                                  //0x4f

    REG16_FQ        Reg_fiq_config16;                               //0x50
    #define FIQ_CFG16_INT_ENABLE_MASK                   0x00FF
    #define FIQ_CFG16_INT_ENABLE_RUSH_DONE              0x0001
    #define FIQ_CFG16_INT_ENABLE_PVR_MEET_BUFTAIL       0x0002
    #define FIQ_CFG16_INT_ENABLE_PVR_MEET_BUFMID        0x0004
    #define FIQ_CFG16_INT_STATUS_MASK                   0xFF00
    #define FIQ_CFG16_INT_STATUS_RUSH_DONE              0x0100

    REG32_FQ        str2mi2_wadr_r;                                 //0x51
    REG32_FQ        Fiq2mi2_radr_r;                                 //0x53
    REG16_FQ        Fiq_status;                                     //0x55
    #define FIQ_STATUS_PVRFIFO_EMPTY                    0x0001
    #define FIQ_STATUS_PVRFIFO_FULL                     0x0002
    #define FIQ_STATUS_PVRFIFO_WLEVEL_MASK              0x000C
    #define FIQ_STATUS_PVRFIFO_EVEN_OVF                 0x0010
    REG32_FQ        lpcr1;                                          //0x56

    REG32_FQ        REG18_1F_RESERVED[4];                           //0x58~0x5F
