...
void   HAL_MMFI_AU_Cfg_Enable(MS_U32 u32CfglItem, MS_BOOL benable);
...
void   HAL_MMFI_VD3DAudPidFlt_Reset(MS_U8 u8Idx);
...
void   HAL_MMFI_V3D_Cfg_Enable(MS_U32 u32CfglItem, MS_BOOL benable);
