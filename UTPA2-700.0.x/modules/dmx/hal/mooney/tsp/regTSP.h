...
#define TSP_TS_PAD_NUM                  3UL  // TS0 is null
...
#define TSP_MUX_TS1                         1UL       //not support
...
typedef struct _REG_Ctrl
{
    ...
    #define TSP_DUP_PKT_SKIP_AD                     0x10000000UL
    ...
    #define TSP_DISCONTI_AUDB_CLR                   0x00400000UL
...
typedef struct _REG_Ctrl2
{
    ...
    #define DISCONTI_CNT_AUDIOB_MASK                0x00F0UL
    #define DISCONTI_CNT_AUDIOB_SHFT                4UL
    ...
    #define DROP_CNT_AUDIOB_MASK                    0x00F0UL
    #define DROP_CNT_AUDIOB_SHFT                    4UL
    ...
    #define MASK_SCR_AUDB_EN                        0x0020UL
...
typedef struct _REG_Ctrl3
{
    ...
    REG16                           Hw_Semaphore0;                       // 0xbf8C1480   0x20
    REG16                           Hw_Semaphore1;                       // 0xbf8C1484   0x21
    REG16                           Hw_Semaphore2;                       // 0xbf8C1488   0x22

    REG16                           Hw_Eco0;                             // 0xbf8C148C   0x23
    #define TSP_FIXED_MIU_FLUSH                     0x0800
    REG16                           Hw_Eco1;                             // 0xbf8C1490   0x24
    REG16                           Hw_Eco2;                             // 0xbf8C1494   0x25
    #define TSP_VQ0_FORCEFIRE_CNT_1K_EXT_MASK       0x0003
    #define TSP_VQ1_FORCEFIRE_CNT_1K_EXT_MASK       0x000C
