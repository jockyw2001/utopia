...
typedef enum
{
    E_TSP_HAL_RESET_CTRL_PKT_CONVERTER0 = 0,
    ...
    E_TSP_HAL_RESET_CTRL_VQ_TX0 = 16,
    ...
    E_TSP_HAL_RESET_CTRL_FILTER_NULL_PKT0 = 48,
    ...
    E_TSP_HAL_RESET_CTRL_SRC_ID_PARSER0 = 64,
...
#define TSP_PIDFLT_OUT_MASK             0x00DFFF00
...
//enable LUT
#define TSP_PIDFLT_OUT_LUT              0x00400000
