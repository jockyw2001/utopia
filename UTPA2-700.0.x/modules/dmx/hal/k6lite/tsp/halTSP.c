...
void HAL_TSP_HwPatch(void)
{
    ...
    REG16_SET(&_RegCtrl6->CFG6_2A, PVR_WRITE_POINTER_TO_NEXT_ADDRESS_EN);
}
...
MS_BOOL HAL_TSP_TSIF_SelPad(MS_U32 tsIf, TSP_TS_PAD eTSPad) // @FIXME modify this parameter to enum plz
{
    ...
    switch (eTSPad)
    {
        ...
        case E_TSP_TS_PAD_INTER0:
            clk_src = REG_CLKGEN0_TS_SRC_DMD0;
            pad_src = REG_TOP_TS_SRC_DMD0;
            break;
        case E_TSP_TS_PAD_INTER1:
            clk_src = REG_CLKGEN0_TS_SRC_DMD1;
            pad_src = REG_TOP_TS_SRC_DMD1;
            break;
    }
    ...
    switch (tsIf)
    {
        ...
        case 1:
            TSP_TOP_REG(REG_TOP_TS1_MUX) = (TSP_TOP_REG(REG_TOP_TS1_MUX) & ~(REG_TOP_TS_SRC_MASK<<REG_TOP_TS1_SHIFT)) | (pad_src<<REG_TOP_TS1_SHIFT);
        #ifdef CONFIG_MSTAR_CLKM
            ...
            break;
        case 2:
            TSP_TOP_REG(REG_TOP_TS2_MUX) = (TSP_TOP_REG(REG_TOP_TS2_MUX) & ~(REG_TOP_TS_SRC_MASK<<REG_TOP_TS2_SHIFT)) | (pad_src<<REG_TOP_TS2_SHIFT);
        #ifdef CONFIG_MSTAR_CLKM
            ...
            break;
        case 3:
            TSP_TOP_REG(REG_TOP_TS3_MUX) = (TSP_TOP_REG(REG_TOP_TS3_MUX) & ~(REG_TOP_TS_SRC_MASK<<REG_TOP_TS3_SHIFT)) | (pad_src<<REG_TOP_TS3_SHIFT);
        #ifdef CONFIG_MSTAR_CLKM
...
static void _HAL_TSO_SetPad1OutMux(MS_BOOL bSet)
{
    ...
    {
        TSP_TOP_REG(REG_TOP_TS_PADMUX_MODE) = ((TSP_TOP_REG(REG_TOP_TS_PADMUX_MODE) & ~(REG_TOP_TS1MODE_MASK << REG_TOP_TS1MODE_SHIFT)) | (REG_TOP_TS1MODE_INPUT << REG_TOP_TS1MODE_SHIFT));
    }
}
        ...
        case E_TSP_TS_PAD_EXT1: // TS_pad #1
            ...
            switch(eOutPadMode) // set pad output mode
            {
                case E_TSP_TS_PAD_MUX_TSO:
                    // input from TSO
                    TSP_TOP_REG(REG_TOP_TS_OUTPUT_MODE) = (TSP_TOP_REG(REG_TOP_TS_OUTPUT_MODE) & ~(REG_TOP_TS_OUT_MODE_MASK << REG_TOP_TS_OUT_MODE_SHIFT)) | (REG_TOP_TS_OUT_MODE_TSO << REG_TOP_TS_OUT_MODE_SHIFT);
                    break;
                case E_TSP_TS_PAD_MUX_S2P:
                    // input from S2P
                    TSP_TOP_REG(REG_TOP_TS_OUTPUT_MODE) = (TSP_TOP_REG(REG_TOP_TS_OUTPUT_MODE) & ~(REG_TOP_TS_OUT_MODE_MASK << REG_TOP_TS_OUT_MODE_SHIFT)) | (REG_TOP_TS_OUT_MODE_S2P << REG_TOP_TS_OUT_MODE_SHIFT);
...
void HAL_PVR_SetStr2Miu_StartAddr(MS_U32 u32PVREng , MS_U32 u32StartAddr0, MS_U32 u32StartAddr1)
{
    ...
    switch(u32PVREng)
    {
        ...
        case 2:
            //head1
            REG32_W(&(_RegCtrl2->CFG_17_18), (u32StartAddr0>>MIU_BUS) & CFG_17_18_PVR3_STR2MI_HEAD);

            //head2
            REG32_W(&(_RegCtrl2->CFG_1D_1E), (u32StartAddr1>>MIU_BUS) & CFG_1D_1E_PVR3_STR2MI_HEAD2);
            break;
        case 3:
            //head1
            REG32_W(&(_RegCtrl2->CFG_24_25), (u32StartAddr0>>MIU_BUS) & CFG_24_25_PVR4_STR2MI_HEAD);

            //head2
            REG32_W(&(_RegCtrl2->CFG_2A_2B), (u32StartAddr1>>MIU_BUS) & CFG_2A_2B_PVR4_STR2MI_HEAD2);
            break;
        default:
            break;
    }
...
void HAL_PVR_SetStr2Miu_MidAddr(MS_U32 u32PVREng , MS_U32 u32MidAddr0, MS_U32 u32MidAddr1)
{
    switch(u32PVREng)
    {
        ...
        case 2:
            //mid1
            REG32_W(&(_RegCtrl2->CFG_19_1A), (u32MidAddr0>>4) & CFG_19_1A_PVR3_STR2MI_MID);

            //mid2
            REG32_W(&(_RegCtrl2->CFG_1F_20), (u32MidAddr1>>4) & CFG_1F_20_PVR3_STR2MI_MID2);
            break;
        case 3:
            //mid1
            REG32_W(&(_RegCtrl2->CFG_26_27), (u32MidAddr0>>4) & CFG_26_27_PVR4_STR2MI_MID);

            //mid2
            REG32_W(&(_RegCtrl2->CFG_2C_2D), (u32MidAddr1>>4) & CFG_2C_2D_PVR4_STR2MI_MID2);
            break;
        default:
            break;
    }
...
MS_U32 HAL_PVR_GetWritePtr(MS_U32 u32PVREng)
{
    switch(u32PVREng)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            return (REG32_R(&(_RegCtrl2->CFG_66_67)) << MIU_BUS);
            break;
        case 3:
            return (REG32_R(&(_RegCtrl2->CFG_68_69)) << MIU_BUS);
            break;
        default:
            break;
    }
...
void HAL_TSP_INT_Disable(MS_U32 u32Mask)
{
    ...
    REG16_W(&_RegCtrl->HwInt_Stat,
        (REG16_R(&_RegCtrl->HwInt_Stat) & ~(TSP_HWINT_EN_MASK & (u32Mask))) | TSP_HWINT_STATUS_MASK);

    REG16_W(&_RegCtrl->HwInt2_Stat,
        (REG16_R(&_RegCtrl->HwInt2_Stat) & ~(TSP_HWINT2_EN_MASK & (u32Mask >> 8))) | TSP_HWINT2_STATUS_MASK);

    REG16_W(&_RegCtrl->HwInt3_Stat,
        (REG16_R(&_RegCtrl->HwInt3_Stat) & ~(TSP_HWINT3_EN_MASK & (u32Mask >> 16))) | TSP_HWINT3_STATUS_MASK);
}
...
void HAL_TSP_FltNullPkt_En(MS_BOOL bEn)
{
    if(bEn == TRUE)
    {
...
void HAL_TSP_PVR_Address_Protect(MS_U32 u32PVREng,MS_PHY u32UpBoundAddr, MS_PHY u32LowBoundAddr)
{
    ...
    if (u8MiuSel >= E_CHIP_MIU_0){
        MS_U32  u32LBnd = (MS_U32)((phyMiuOffsetLB >> MIU_BUS) & TSP_PVR_MASK);
        MS_U32  u32UBnd = (MS_U32)((phyMiuOffsetUB >> MIU_BUS) & TSP_PVR_MASK);
...
void HAL_TSP_FILEIN_Address_Protect(FILEENG_SEQ eFileEng,MS_PHY u32UpBoundAddr, MS_PHY u32LowBoundAddr)
{
    ...
    if (u8MiuSel >= E_CHIP_MIU_0){
        MS_U32  u32LBnd = (MS_U32)((phyMiuOffsetLB >> MIU_BUS) & TSP_FILEIN_DMAR_BND_MASK);
        MS_U32  u32UBnd = (MS_U32)((phyMiuOffsetUB >> MIU_BUS) & TSP_FILEIN_DMAR_BND_MASK);
...
void HAL_TSP_MMFI_Address_Protect(MS_U32 u32MMFIEng,MS_PHY u32UpBoundAddr, MS_PHY u32LowBoundAddr)
{
    ...
    if (u8MiuSel >= E_CHIP_MIU_0){
        MS_U32  u32LBnd = (MS_U32)((phyMiuOffsetLB >> MIU_BUS) & TSP_MMFI_DMAR_BND_MASK);
        MS_U32  u32UBnd = (MS_U32)((phyMiuOffsetUB >> MIU_BUS) & TSP_MMFI_DMAR_BND_MASK);
