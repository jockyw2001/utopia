...
#define HAL_TSOIN_MUX_TSDEMOD0                  0x000E
#define HAL_TSOIN_MUX_TSDEMOD1                  0x000F  //not supported
...
#define HAL_TSO_CLKIN_TS2                       0x0002  //not supported
#define HAL_TSO_CLKIN_TS3                       0x0003  //not supported
#define HAL_TSO_CLKIN_TSCB                      0xFFFF  //not supported
#define HAL_TSO_CLKIN_TSDEMOD0                  0x000E
#define HAL_TSO_CLKIN_TSDEMOD1                  0x000F  //not supported
...
#define HAL_TSO_OUT_SEL_TSO_OUT_FROM_DEMOD      0x000E
