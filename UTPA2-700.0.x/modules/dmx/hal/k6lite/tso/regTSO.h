...
typedef struct _REG_Ctrl_TSO2
{
    ...
    REG16_TSO                             REG_TSO2_CFG57_5F[9];                //57~5F
    REG16_TSO                             REG_TSO2_PKT_TIME_THRESHOLD_CFG60;   //60
    REG16_TSO                             REG_TSO2_DATA_TRACING_CONFIG_CFG61;  //61
    #define TSO2_REG_DATA_TRACING_ST_CLR                            0x0001     // 1: data rate trace status clear
    #define TSO2_REG_DATA_TRACING_ST_LD                             0x0002     // 1: load latest info  0: keep old info
    #define TSO2_REG_MAX_MIN_EVER_CURRENT                           0x0004     // 1: max/min ever,     0: max/min in current sample period
    #define TSO2_REG_DATA_RATE_SRC_SEL_MASK                         0x00F0
    #define TSO2_REG_DATA_RATE_SRC_SEL_SHIFT                        4
    #define TSO2_REG_DATA_TRACING_SHIFT_VAL_MASK                    0x0F00
    #define TSO2_REG_DATA_TRACING_SHIFT_VAL_SHIFT                   8
    REG16_TSO                             REG_TSO2_REG_AVG_PKT_TIME_CFG62;     //62
    REG16_TSO                             REG_TSO2_MIN_PKT_TIME_CFG63;         //63
    REG16_TSO                             REG_TSO2_MAX_PKT_TIME_CFG64;         //64
