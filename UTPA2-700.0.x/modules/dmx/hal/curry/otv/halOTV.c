...
static REG_OTV*    _OTVReg[OTV_ENG_NUM]                  = {NULL , NULL};
static MS_VIRT       _u32OTV_PidfltBase[OTV_ENG_NUM]      = {NULL , NULL};
static MS_VIRT       _u32OTV_EventMaskBase[OTV_ENG_NUM]   = {NULL , NULL};
