...
#define TSP_PIDFLT_REC_NUM              (TSP_PIDFLT_NUM - TSP_PCRFLT_NUM - TSP_CA_RESERVED_FLT_NUM)     // 96 -2 = 94                      // 0~189 (0 for CA)
                                                                                                    // 193 for Err
                                                                                                    // 192 for REC
                                                                                                    // 191 for PCR1
                                                                                                    // 190 for PCR0
...
#define TSP_SECFLT_END_ID               (TSP_SECFLT_START_ID + TSP_SECFLT_NUM - TSP_CA_RESERVED_FLT_NUM - TSP_PCRFLT_NUM)  // 1 + 64 - 1 - 2 = 62
#define TSP_SECBUF_END_ID               (TSP_SECBUF_START_ID + TSP_SECBUF_NUM - TSP_CA_RESERVED_FLT_NUM - TSP_PCRFLT_NUM)

// PID
#define TSP_PIDFLT_START_ID             TSP_CAFLT_END_ID // 1
#define TSP_PIDFLT_END_ID               (TSP_PIDFLT_START_ID + TSP_PIDFLT_NUM - TSP_CA_RESERVED_FLT_NUM - TSP_PCRFLT_NUM) // 1 + 96 - 1 - 2 = 94

// PCR
#define TSP_PCRFLT_START_ID             TSP_PIDFLT_END_ID  // 94
#define HAL_TSP_PCRFLT_GET_ID(NUM)      (TSP_PCRFLT_START_ID + (NUM))
#define TSP_PCRFLT_END_ID               (TSP_PCRFLT_START_ID + TSP_PCRFLT_NUM)  // 96

// REC
#define TSP_RECFLT_IDX                  TSP_PCRFLT_END_ID  // 96
...
typedef enum _PVRENG_SEQ
{
    ...
    E_TSP_PVR_RASPENG_START         = E_TSP_PVR_PVRENG_END,
    E_TSP_PVR_RASPENG_0             = E_TSP_PVR_RASPENG_START,
    E_TSP_PVR_RASPENG_1,
    E_TSP_PVR_RASPENG_END,
    E_TSP_PVR_CBPVRENG_START        = E_TSP_PVR_RASPENG_END,
...
typedef enum _TSP_DST_SEQ
{
    ...
    E_TSP_DST_FIFO_VIDEO3,        //Not support
    E_TSP_DST_FIFO_VIDEO4,        //Not support
...
typedef enum _HAL_TS_PAD
{
    ...
    E_TSP_TS_PAD_EXT0_3WIRE,
    E_TSP_TS_PAD_EXT1_3WIRE,
    E_TSP_TS_PAD_EXT2_3WIRE,
    E_TSP_TS_PAD_EXT3_3WIRE,
...
{
    E_TSP_TS_PAD_MUX_PARALLEL,
    E_TSP_TS_PAD_MUX_3WIRED_SERIAL,
    E_TSP_TS_PAD_MUX_4WIRED_SERIAL,
...
typedef enum _HAL_DMX_FLOW_DST
{
    E_TSP_DMX_FLOW_PLAYBACK,
    E_TSP_DMX_FLOW_PLAYBACK1,
    E_TSP_DMX_FLOW_PLAYBACK2,
    E_TSP_DMX_FLOW_PLAYBACK3,
}_HAL_DMX_FLOW_DST;
...
typedef enum _CLR_SRC
{
    E_TSP_CLR_SRC_TSIF0,
    E_TSP_CLR_SRC_TSIF1,
    E_TSP_CLR_SRC_TSIF2,         //not support
    E_TSP_CLR_SRC_TSIF3,         //not support
    E_TSP_CLR_SRC_MMFI0,
    E_TSP_CLR_SRC_MMFI1,
    E_TSP_CLR_SRC_INVALID,
} TSP_CLR_SRC;
...
typedef enum
{
    E_TSP_HAL_CAP_VAL_PIDFLT_NUM                    = (TSP_PIDFLT_END_ID - TSP_PIDFLT_START_ID), // 94-1 = 93
    E_TSP_HAL_CAP_VAL_SECFLT_NUM                    = (TSP_SECFLT_END_ID - TSP_SECFLT_START_ID), // 62-1 = 61
    E_TSP_HAL_CAP_VAL_SECBUF_NUM                    = (TSP_SECBUF_END_ID - TSP_SECBUF_START_ID), // 62-1 = 61

    E_TSP_HAL_CAP_VAL_RECENG_NUM                    = 2,
    E_TSP_HAL_CAP_VAL_RECFLT_NUM                    = TSP_PIDFLT_REC_NUM, // 96-2 = 94
    E_TSP_HAL_CAP_VAL_RECFLT_IDX                    = TSP_RECFLT_IDX,  // 96
    E_TSP_HAL_CAP_VAL_PCRFLT_START_IDX              = TSP_PCRFLT_START_ID, // 94
    ...
    E_TSP_HAL_CAP_VAL_DEMOD_NUM                     = 1, //internal demod
    E_TSP_HAL_CAP_VAL_TSPAD_NUM                     = 2,
    E_TSP_HAL_CAP_VAL_VQ_NUM                        = 3,

    E_TSP_HAL_CAP_VAL_CAFLT_NUM                     = 0xDEADBEEF,         //@TODO don't know this value
    ...
    E_TSP_HAL_CAP_VAL_VFIFO_NUM                     = 2,
    E_TSP_HAL_CAP_VAL_AFIFO_NUM                     = 2,
...
typedef enum
{
    ...
    E_TSP_HAL_FLOW_LIVE4,   // not support
    E_TSP_HAL_FLOW_LIVE5,   // not support
    E_TSP_HAL_FLOW_LIVE6,   // not support

    E_TSP_HAL_FLOW_FILE0,
    E_TSP_HAL_FLOW_FILE1,
    E_TSP_HAL_FLOW_FILE2,
    E_TSP_HAL_FLOW_FILE3,
    E_TSP_HAL_FLOW_FILE4,   // not support
    E_TSP_HAL_FLOW_FILE5,   // not support
    E_TSP_HAL_FLOW_FILE6,   // not support
...
#define PSECFLT(_fltid)                (&(((REG_Sec*)(REG_SECFLT_BASE)->Flt[_fltid]))
#define PSECBUF(_bufid)                (&(((REG_Buf*)(REG_SECBUF_BASE)->Buf[_bufid]))
...
// AF/Sec/Video/V3D/Audio/AudioB/AudioC/AudioD/PVR1/PVR2/PVR3/PVR4
#define TSP_PIDFLT_SECFLT_NULL          0x000000FF                          // software usage clean selected section filter
#define TSP_PIDFLT_OUT_MASK             0x001FBF00
...
#define TSP_PIDFLT_OUT_VFIFO3           0x00000000    //Not Support
#define TSP_PIDFLT_OUT_AFIFO3           0x00080000
#define TSP_PIDFLT_OUT_AFIFO4           0x00100000
#define TSP_PIDFLT_OUT_VFIFO4           0x00000000    //Not Support
...
//enable LUT
#define TSP_PIDFLT_OUT_LUT              0x00000000    //Not support
...
void HAL_TSP_Filein_Bypass(FILEENG_SEQ eFileEng, MS_BOOL bEnable);// for PS mode A/V fifo pull back
...
//=========================INT================================
void   HAL_TSP_INT_Enable(MS_U32 u16Mask);
void   HAL_TSP_INT_Disable(MS_U32 u16Mask);
void   HAL_TSP_INT_ClrHW(MS_U32 u16Mask);
