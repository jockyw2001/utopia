...
//@Note :  Compatible for K6 drvtsp2.c HWCL of PCR2,PCR3
#define TSP_HWINT3_PCR2_UPDATE_END_EN                   0x0000
#define TSP_HWINT3_PCR3_UPDATE_END_EN                   0x0000
#define TSP_HWINT3_PCR2_UPDATE_END                      0x0000
#define TSP_HWINT3_PCR3_UPDATE_END                      0x0000
#define TSP_HWINT3_ALL                                  0x0000
...
//    #define REG_CLKGEN0_TS3_SHIFT                   8
    ...
    #define REG_CLKGEN0_PARSER_CLK                  0x39
        ...
        #define REG_CLKGEN0_PARSER_192              0x0400
...
#define TSP_TOP_REG(addr)           (*((volatile MS_U16*)(_u32RegBase + 0x3c00UL + ((addr)<<2))))
    ...
    #define REG_TOP_TS_PADMUX_MODE                  0x02
        #define REG_TOP_TS_MODE_MASK                0x7E
        #define REG_TOP_TS0MODE_SHIFT               5
        ...
        #define REG_TOP_TS_MODE_PAR_IN              0x01
        #define REG_TOP_TS_MODE_DMD_PAR_OUT         0x02
        #define REG_TOP_TS_MODE_SER_IN              0x03
        #define REG_TOP_TS_MODE_TSO_PAR_OUT         0x04
...
typedef struct _REG_Ctrl
{
    ...
    REG16                           _xbf202ab8;                             // 0xbf802ab8   0x2e
    ...
    #define TSP_SERIAL_EXT_SYNC_LT                  0x0400              // Set 1 to detect serial-in sync without 8-cycle mode
    ...
    REG16                           HwInt_Stat;                         // 0xbf802bf8   0x7e
        ...
        */
    #define TSP_INT_EN_MASK                         0x00FF          // Tsp2hk_int enable bits.
    #define TSP_INT_EN_SHIFT                        0
    ...
    #define TSP_HWINT2_SUPPORT_ALL                          (TSP_HWINT2_PCR0_UPDATE_END_EN|TSP_HWINT2_PCR1_UPDATE_END_EN)
    ...
    REG32                           SwInt_Stat1_H;                      // 0xbf802dB4   0x6d

    REG16                           _xbf202dbc;                         // 0xbf802dBC   0x6f
...
typedef struct _REG_Ctrl2                                                               //TSP3 0x1702
{
    ...
    REG16    CFG_07;
        #define    CFG_07_PKT_CHK_SIZE_FILEIN2                                  0x00ff    //(Packet Size ¡V 1) for sync detection in TSIF2
    ...
    REG16    CFG_0C;
        #define    CFG_0C_PKT_CHK_SIZE_FILEIN3                                  0x00ff    //(Packet Size ¡V 1) for sync detection in TSIF3
...
typedef struct _REG_Ctrl3
{
    ...
    REG16   CFG3_16;                                                                                // 0x16
        #define CFG3_16_MMFI1_REQ_MCM_DISABLE                                   0x0080              //reg_mcm_reg_disable_filein_mm1
    ...
    REG16   CFG3_2D;
        ...
        #define CFG3_2D_PKT_DEMUX0_TRACE_MARK_AD                                0x0020              // reg_pkt_demux0_trace_mark_ad_en=>set 1 enable trace mark function in pktdemux0 audio d path
        #define CFG3_2D_PKT_DEMUX1_TRACE_MARK_AD                                0x0040              // reg_pkt_demux1_trace_mark_ad_en=>set 1 enable trace mark function in pktdemux0 audio d path
        #define CFG3_2D_PKT_DEMUX2_TRACE_MARK_AD                                0x0080              // reg_pkt_demux2_trace_mark_ad_en=>set 1 enable trace mark function in pktdemux0 audio d path
        #define CFG3_2D_PKT_DEMUX3_TRACE_MARK_AD                                0x0100              // reg_pkt_demux3_trace_mark_ad_en=>set 1 enable trace mark function in pktdemux0 audio d path
        #define CFG3_2D_FILTER_NULL_PKT                                         0x0800
    REG16   CFG3_2E_30[3];                                                                          //reserved
    REG16   CFG3_31;                                                                                // 0x31
    ...
    REG16   CFG3_36;
        #define HW4_CFG36_PKT130_PSI_EN0                                        0x0001              //rvu setting
        #define HW4_CFG36_PKT130_TEI_EN0                                        0x0002
        #define HW4_CFG36_PKT130_ERR_CLR0                                       0x0004
        #define HW4_CFG36_PKT130_EN0                                            0x0008
        #define HW4_CFG36_PKT130_TIMESTAMP_EN0                                  0x0010
        #define HW4_CFG36_PKT130_PID_12_TIE_0_EN0                               0x0020
        #define HW4_CFG36_PAYLOAD_128_MODE_EN0                                  0x0040
        #define HW4_CFG36_PKT130_PSI_EN1                                        0x0100
        #define HW4_CFG36_PKT130_TEI_EN1                                        0x0200
        #define HW4_CFG36_PKT130_ERR_CLR1                                       0x0400
        #define HW4_CFG36_PKT130_EN1                                            0x0800
        #define HW4_CFG36_PKT130_TIMESTAMP_EN1                                  0x1000
        #define HW4_CFG36_PKT130_PID_12_TIE_0_EN1                               0x2000
        #define HW4_CFG36_PAYLOAD_128_MODE_EN1                                  0x4000
    REG16   CFG3_37;
    ...
    REG16   CFG3_53;
        #define CFG3_53_WB_FSM_REST                                             0x0001
    REG16   CFG3_54_57[4];
    REG16   CFG3_58_5F[8];
    ...
    REG16   CFG3_72;
        #define CFG3_72_PIDFLT_PCR_SCR_ID_MASK                                  0x00ff
        #define CFG3_72_PIDFLT_PCR0_SCR_ID_SHIFT                                0
        #define CFG3_72_PIDFLT_PCR1_SCR_ID_SHIFT                                8
    REG16  CFG3_73;
...
typedef struct _REG_Ctrl5
{
    ...
    REG16   CFG5_7E;
        ...
        #define CFG5_7E_VID_3D_SRC_MASK                                         0x1E00
...
typedef struct _REG_Ctrl6
{
    ...
    REG16   CFG6_2A;
        ...
        #define TSP_FIQ_DMA_FLUSH_EN                                            0x0100
        #define TSP_FIND_LOSS_SYNC_PID_RVU                                      0x0200
        #define FIXED_LPCR_RING_BACK_EN                                         0x0400
        #define TSP_PVR_WRITE_POINT_TO_NEXT                                     0x0800
        #define FIXED_DMA_WADDR_NEXT_OVF                                        0x1000
        #define FIXED_VQ_MIU_REQ_FLUSH                                          0x2000
        #define TSP_DROP_ERR_START_CODE                                         0x4000
        #define TSP_DROP_TEI_ERR_START_CODE                                     0x8000
    REG16   CFG6_2B;
    ...
    REG16   CFG6_60;                                                            // fiq src mux
        #define TSP_FIQ_MUX_MASK                                                0x0007
        #define TSP_FIQ_SRC_PATH0                                               0x0000
        #define TSP_FIQ_SRC_PATH1                                               0x0001
        #define TSP_FIQ_SRC_PATH2                                               0x0002
} REG_Ctrl6;
