...
#define TSO_TSIF_NUM                            (3UL)
#define TSO_FILE_IF_NUM                         (2UL)
...
#define TSO_IN_MUX_TS3                          0x3UL
#define TSO_IN_MUX_TS4                          0x4UL
#define TSO_IN_MUX_TS5                          0x5UL
...
#define TSO_CLKIN_TS3                           0x0CUL
#define TSO_CLKIN_TS4                           0x10UL
#define TSO_CLKIN_TS5                           0x14UL
...
#define TSO_PRE_OUT_TS3IN                       0x0004UL
#define TSO_PRE_OUT_TS4IN                       0x0005UL
#define TSO_PRE_OUT_TS5IN                       0x0006UL
...
typedef struct _REG_Ctrl_TSO
{
    ...
    REG16                             TSO_FILE_CFG[2];                 // 0xbf8275e4~0xbf8275e8   0x79~0x7a
...
{
    REG16                           TSO_CFG_00;                         // 0x00
    #define TSO_PVR_PINGPONG                        0x0001UL
    #define TSO_PVR_ENABLE                          0x0002UL
    #define TSO_PVR_RST_WADR                        0x0004UL
    #define TSO_PVR_PAUSE                           0x0008UL
    #define TSO_RECORD192_EN                        0x0010UL
    
    #define TSO_BURST_LEN_MASK                      0x0060UL            // 00,01:    burst length = 4; 10,11: burst length = 1
    #define TSO_BURST_LEN_4                         0x0020UL

    #define TSO_PVR_LPCR1_WLD                       0x0080UL            // Set 1 to load LPCR1 value
    #define TSP_PVR_ALIGN_EN                        0x0100UL
    #define TSO_PVR_ENDIAN_BIG                      0x0200UL            // 1: record TS to MIU with big endian, 0: record TS to MIU with little endian
    #define TSO_PVRBUF_BYTEORDER_BIG                0x0400UL            // Byte order of 8-byte recoding buffer to MIU.
    #define TSO_PVR_INVERT                          0x0800UL            // Set 1 to enable data payload invert for PVR record
    #define TSO_PVR_BLOCK_DIS                       0x1000UL 
    #define TSO_PVR_PID_BYPASS                      0x2000UL            // Set 1 to bypass PID in record
    #define TSO_PVR_REC_ALL_EN                      0x4000UL 
    #define TSO_PVR_LPCR1_RLD                       0x8000UL            // Set 1 to read LPCR1 value (Default: 1)

    REG32                           TSO_PVR_Head1;                      // 0x01
    REG32                           TSO_PVR_Mid1;                       // 0x03, PVR1 mid address
    REG32                           TSO_PVR_Tail;                       // 0x05

    REG32                           TSO_PVR_Head2;                      // 0x07
    REG32                           TSO_PVR_Mid2;                       // 0x09, PVR1 mid address
    REG32                           TSO_PVR_Tail2;                      // 0x0B

    REG16                           TSO_CFG_0D;                         // 0x0D
    #define TSP_FLUSH_EN                            0x0002UL            //PVR1 dma flush
    #define TSO_CH_BW_WP_LD                         0x0004UL
    #define TSO_CLR_PVR_OVERFLOW                    0x0008UL
    #define TSO_PVR_DMA_FLUSH_EN                    0x0010UL
    #define TSO_PVR_FORCE_SYNC                      0x0020UL
    #define TSO_PVR_DIS_REC_AT_SYNC                 0x0040UL
    #define TSO_MIU_HIGH_PRIO                       0x0080UL
    #define TSO_RECORD_ALL_OLD                      0x0100UL
    #define TSO_PVR_WPTR_NEXT                       0x0200UL
    #define TSO_PVR_DAMW_PROTECT_EN                 0x0400UL
    #define TSO_CLR_NO_HIT_INT                      0x0800UL            // set 1 clear all dma write function not hit interrupt

    REG32                           DMAW_LBND0;                         // 0x0E
    REG32                           DMAW_UBND0;                         // 0x10

    REG32                           PVR1_LPcr1;                         // 0x12
    REG16                           TSO_CFG_14;                         // 0x14
    #define TSO_PVR_SRC_MASK                        0x0003UL
    #define TSO_PVR_SRC_SVQ                         0x0001UL
    #define TSO_PVR_SRC_MMT                         0x0002UL
    #define TSO_PVR_CLK_STAMP_27_EN                 0x0004UL

    REG16                           TSO_RESERVE_15_1F[11];
    REG16                           TSO_CFG_20;                         // 0x20
    #define TSO_MMT_TS_SIN_C0                       0x0001UL            // Reset bit count when data valid signal of TS interface is low.
    #define TSO_MMT_TS_SIN_C1                       0x0002UL            // Reset bit count on the rising sync signal of TS interface.
    #define TSO_FORCE_SYNCBYTE                      0x0004UL
    #define TSO_MMT_PARL                            0x0008UL
    #define TSO_MMT_EXTSYNC                         0x0010UL
    #define TSO_ISYNC_PATCH_EN                      0x0020UL
    #define TSO_SERIAL_EXT_SYNC_LT                  0x0040UL            // Set 1 to detect serial-in sync without 8-cycle mode
    #define TSO_TSIF_OVF_CLR                        0x0080UL
    #define TSO_PACKET_CHK_SIZE_MASK                0xFF00UL
    #define TSO_PACKET_CHK_SIZE_SHFT                8UL

    REG16                           TSO_CFG_21;                         // 0x21
    #define TSO_MMT_EN                              0x0001UL
    #define TSO_3WIRE_EN                            0x0002UL
    #define TSO_MMT_SW_RST                          0x0004UL
    #define TSO_LOCK_PKT_CNT_LOAD                   0x0008UL
    #define TSO_LOCK_PKT_CNT_CLR                    0x0010UL
    REG32                           TSO_PVR_DMAW_WADDR_ERR;             // 0x22
    REG16                           TSO_PVR_MOBF;                       // 0x24

    REG32                           TSO_PVR_WPTR;                       // 0x25
    REG16                           TSO_CFG_27;                         // 0x27
    #define TSO_TSIF_OVF                            0x0001UL
    #define TSO_PVR_FLUSH_STATUS                    0x0002UL
    #define TSO_PVR_FIFO_STATUS                     0x0004UL
