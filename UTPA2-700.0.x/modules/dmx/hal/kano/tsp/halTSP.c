...
#define KANOU03         (MDrv_SYS_GetChipRev() >= 0x2)  // This feature/behavior is supported after Kano U03
    ...
    if(bEnable)
    {
        switch(u32Pad)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                TSP_TOP_REG(REG_TOP_TSP_3WIRE_MODE) = TSP_TOP_REG(REG_TOP_TSP_3WIRE_MODE)| REG_TOP_TSP_TS2_3WIRE_EN;
                break;
            case 3:
                TSP_TOP_REG(REG_TOP_TSP_3WIRE_MODE) = TSP_TOP_REG(REG_TOP_TSP_3WIRE_MODE) | REG_TOP_TSP_TS3_3WIRE_EN;
                break;
...
void HAL_TSP_Filein_PktSize(FILEENG_SEQ eFileEng, MS_U32 u32PktSize)
{
    ...
    switch(eFileEng)
    {
        ...
        case E_FILEENG_TSIF2:
            ...
            break;
        case E_FILEENG_TSIF3:
            REG16_W(&_RegCtrl2->CFG_0C, (REG16_R(&_RegCtrl2->CFG_0C) & ~CFG_0C_PKT_CHK_SIZE_FILEIN3) | (CFG_0C_PKT_CHK_SIZE_FILEIN3 & (u32PktLen-1)));
            break;
        default:
            break;
    }
...
void HAL_TSP_Filein_Addr(FILEENG_SEQ eFileEng, MS_U32 addr)
{
    switch(eFileEng)
    {
        ...
        case E_FILEENG_TSIF2:
            ...
            break;
        case E_FILEENG_TSIF3:
            REG32_W(&_RegCtrl2->CFG_3A_3B, addr);
            break;
        default:
            break;
    }
...
void HAL_PVR_Exit(MS_U32 u32PVREng)
{
    ...
    //reset PVR buffer to non-OverWrite state
...
MS_U32 HAL_TSP_PidFltDstMapping(TSP_PIDFLT_DST eDstType, MS_U32 u32Eng)
{
    ...
    if(eDstType == E_TSP_PIDFLT_DST_PVR)
    {
        switch(u32Eng)
        {
            case 0:
...
MS_BOOL HAL_TSP_FQ_FLT_NULL_PKT(MS_U32 u32FQEng, MS_BOOL bFltNull)
{
    ...
    {
        // not support
        HAL_TSP_DBGMSG(E_HAL_TSP_DBG_LEVEL_ERR, E_HAL_TSP_DBG_MODEL_ALL, printf("[%s][%s][%d] UnSupport feature!\n",__FILE__,__FUNCTION__,__LINE__));
        return FALSE;
    }
}
