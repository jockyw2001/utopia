...
typedef struct _REG_Ctrl_MMFI
{
    ...
    #define MMFI_PIDFLT_VFIFO3_EN                   0x00000000  // not support
    #define MMFI_PIDFLT_VFIFO4_EN                   0x00000000  // not support
	...
	REG16_MM                               APidB_Status;                        // 0xbf803848   0x13
...
typedef struct _REG_Ctrl_MMFI1
{
    ...
    #define MMFI_CFG2_MMFI_WB_FSM_RESET             0x00000080
    ...
    #define MMFI_CFG3_MMFI_PS_VD3_EN                0x00000000  // not support
    #define MMFI_CFG3_MMFI_PS_VD4_EN                0x00000000  // not support
