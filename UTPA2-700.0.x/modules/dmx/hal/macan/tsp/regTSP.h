...
#define TSP_AFIFO_NUM                   2UL
#define TSP_TS_PAD_NUM                  5UL  // 2P + 3S or 3P + 1S
#define TSP_VQ_NUM                      4UL  //VQ0, VQ_file, VQ1, VQ_2
#define TSP_VQ_PITCH                    208UL
#define TSP_CA_ENGINE_NUM               1UL
...
#define TSP_PCRFLT_NUM                  2UL
#define TSP_STC_NUM                     2UL
...
#define DSCMB_FLT_SHAREKEY_START_ID     48UL
...
#define TSP_MUX_TS3                     3UL
#define TSP_MUX_TS4                     4UL
#define TSP_MUX_TS5                     5UL
...
#define TSP_CLK_TS3                     0x0CUL
#define TSP_CLK_TS4                     0x10UL
#define TSP_CLK_TS5                     0x14UL
...
// Software
#define REG_PIDFLT_L_BASE                (0x00210000UL << 1UL)                   // Fit the size of REG32
#define REG_PIDFLT_H_BASE                (0x00210800UL << 1UL)                   // Fit the size of REG32
...
typedef struct _REG_Ctrl
{
    ...
    #define TSP_HW_PVR_BUF_HEAD21_MASK              0x000007FFUL
    ...
    #define TSP_HW_PVR_BUF_MID21_MASK               0x000007FFUL
    ...
    #define TSP_HW_PVR_BUF_TAIL21_MASK              0x000007FFUL
    ...
    #define TSP_PVR2_BURST_LEN_2                    0x00001000UL
    ...
    #define TSP_STR2MI2_ADDR_MASK  0x07FFFFFFUL
    ...
    #define TSP_TSDMA_CTRL_VPES0                    0x00000004UL    //not used
    #define TSP_TSDMA_CTRL_APES0                    0x00000008UL    //not used
    #define TSP_TSDMA_CTRL_A2PES0                   0x00000010UL    //not used
    ...
    #define TSP_SYNC_RISING_DETECT                  0x00000200UL          // Reset bit count on the rising sync signal of TS interface.
    #define TSP_VALID_FALLING_DETECT                0x00000400UL          // Reset bit count when data valid signal of TS interface is low.
    ...
    #define TSP_BD_AUD_EN                           0x00000020UL          // set 1 to enable the BD audio A/B stream recognization ( core /extend audio stream)
    //#define TSP_BD_AUD_EN2                          0x00000040UL          // set 1 to enable the BD audio C/D stream recognization ( core /extend audio stream) No AFIFO C/D
    ...
    #define TSP_CTRL_SRAM_SD_EN                     0x00000200UL        // Set 1 to disable all SRAM power in TSP for low power mode.
    ...
    #define TSP_ONEWAY_REC_DISABLE                  0x00000001UL          // Disable PVR
    #define TSP_ONEWAY_PVR_PORT                     0x00000002UL          // Oneway for PVR buffer
    #define TSP_ONEWAY_LOAD_FW_PORT                 0x00000004UL          // Oneway for f/w load address
    ...
    #define TSP_PVR2_SRC_MASK                       0x00038000UL
    #define TSP_PVR2_SRC_SHIFT                      15UL
    ...
    REG32                           _rbf802d80;                          // 0xbf802d80   0x60
    ...
    #define TSP_WADDR_ERR_SRC_SEL_MASK              0x00000006UL
    #define TSP_WADDR_ERR_SRC_SEL_SHIFT             1UL
    #define TSP_WADDR_ERR_SRC_PVR                   0x00000000UL
    #define TSP_WADDR_ERR_SRC_VQ                    0x00000002UL
    #define TSP_WADDR_ERR_SRC_SEC_CB                0x00000004UL
...
typedef struct _REG_Ctrl2
{
    ...
    #define QMEM_DBG_MODE                           0x0001UL
    #define QMEM_DBG_TSP_SEL_SRAM                   0x0002UL
    #define ARM_SRAM_SEL_IN_TSP_TOP_GROUP           0x0004UL           // If this bit is set 1,arm trustzone will use the 8KB sram in tsp_top_group instead of qmem.

    REG16                           Qmem_Dbg_RAddr;                    // 0xbf803ac4   0x71
    #define QMEM_DBG_RADDR_MASK                     0xFFFFUL

    REG32                           Qmem_Dbg_RD;                       // 0xbf803ac8~0xbf803acc   0x72~0x73
    REG32                           Reserved[2];                       // 0xbf803ad0~0xbf803adc  0x74~0x77

    REG16                           HW_Cfg;                            // 0xbf803ae0   0x78
    #define TSP_UPDATE_MATCH_PID_PUSI               0x0080UL
...
typedef struct _REG_Ctrl3
{
    ...
    #define                        HW_ECO_FIX_SEC_NULLPKT_ERR   0x0020UL
    #define                        HW_ECO_INIT_STAMP_RSTART_EN  0x0400UL
...
typedef struct _REG_Ctrl4
{
    ...
    REG32                               _bf803924[2];                       //0xbf803924~0xbf803930  0x09~0x0c
    ...
    REG16                               dummy2[0x7A-0x73];                  // 0x73~0x79
...
typedef struct _REG_Ctrl5
{
    ...
    REG16                               dummy0;                                     // 0xB // NO FIQ


    REG16                               HwCfg1;                                     // 0xC
    #define TSP_FIXED_TIMESTAMP_RING_BACK_EN            0x0001UL
    #define TSP_FIXED_LPCR_RING_BANK_EN                 0x0002UL
    #define TSP_SECFLT_CTRL_DMA_DIS                     0x0100UL

    REG16                               dummy0_1[0x10-0xD];                         // 0xD~0xF
    ...
    REG16                               dummy1[0x20-0x16];                          // 0x16~0x1F
    ...
    REG16                               dummy2[0x60-0x52];                          // 0x52~0x5F
    ...
    REG16                               dummy3[0x7E - 0x69];                        // 0x69~0x7D

    REG16                               Vq_Idle_Cnt_Cfg;                            // 0x7E
    #define TS_VQ0_FORCEFIRE_CNT_1K_EXTEND              0x0003UL
    #define TS_VQ1_FORCEFIRE_CNT_1K_EXTEND              0x000CUL
    #define TS_VQ2_FORCEFIRE_CNT_1K_EXTEND              0x0030UL
    #define TS_VQ3_FORCEFIRE_CNT_1K_EXTEND              0x00C0UL
    #define TS_VQ_IDLE_COUNTER_DISABLE                  0x0100UL
