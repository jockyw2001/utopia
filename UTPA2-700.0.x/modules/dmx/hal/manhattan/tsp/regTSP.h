...
#define DSCMB_FLT_SHAREKEY1_START_ID    48UL
...
typedef struct _REG_Ctrl
{
    ...
    #define TSP_BD_AUD_EN                           0x00000020UL          // Set 1 to enable the BD audio stream recognization ( core /extend audio stream)
