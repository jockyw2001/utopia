...
#define MMFI_PIDFLT_GROUP0                   (4) // filters reside in upper half of bank MMFI
#define MMFI_PIDFLT_GROUP1                   (2) // filters reside in bottom half of bank MMFI
...
#define REG_CTRL_BASE_MMFI0             (0x3800)                            // 0xBF800000+(1c00/2)*4
#define REG_CTRL_BASE_MMFI1             (0x3880)
#define REG_CTRL2                       (0x3900)                            // MMFI part 2
...
typedef struct _REG_Ctrl_MMFI
{
    ...
    #define MMFI_PIDFLT_EN_MASK                     0x0007E000
    ...
    #define MMFI_TSP2MI_RADDR_MASK                  0x07FFFFFF
} REG_Ctrl_MMFI;
...
typedef struct _REG_Ctrl_MMFI2
{
    ...
    #define MMFI_CFG2_MMFI_27M_EN               0x0001
    #define MMFI_CFG2_MMFI_APIDC_BYPASS         0x0020
    #define MMFI_CFG2_MMFI_APIDD_BYPASS         0x0040
    #define MMFI_CFG2_MMFI_PS_AUDC_EN           0x0080
    #define MMFI_CFG2_MMFI_PS_AUDD_EN           0x0100
    ...
    #define MMFI_ATS_MODE                        0x0001
    #define MMFI_ATS_OFFSET_EN                   0x0002
    #define MMFI_ATS_OFFSET_MASK                 0x1F00
    #define MMFI_ATS_OFFSET_SHIFT                8
} REG_Ctrl_MMFI2;
