...
#define TSO_CLKGEN1_REG(addr)       (*((volatile MS_U16*)(_virtTSORegBase + 0x6600 + ((addr)<<2))))
    #define REG_CLKGEN1_TSO_IN                          0x22
        #define REG_CLKGEN0_TSO_TRACE_MASK                  0x000F
            #define REG_CLKGEN1_TSO_TRACE_DISABLE           0x0001
            #define REG_CLKGEN1_TSO_TRACE_INVERT            0x0002
            #define REG_CLKGEN1_TSO_TRACE_216M              0x0000
        #define REG_CLKGEN1_TSO_TRACE_SAMPLE_MASK           0x00F0
            #define REG_CLKGEN1_TSO_TRACE_SAMPLE_DISABLE    0x0010
            #define REG_CLKGEN1_TSO_TRACE_SAMPLE_INVERT     0x0020
            #define REG_CLKGEN1_TSO_TRACE_SAMPLE_216        0x0000
        #define REG_CLKGEN1_TSO_IN_MASK                     0x1F00
        #define REG_CLKGEN1_TSO_IN_SHIFT                    8
            #define REG_CLKGEN1_TSO_IN_DISABLE              0x0100
            #define REG_CLKGEN1_TSO_IN_INVERT               0x0200
            ...
            //                                      010: Sel TS2 Clk
            //                                      011: Sel Demod Clk
    #define REG_CLKGEN1_TSO1_IN                         0x23
        #define REG_CLKGEN1_TSO1_IN_MASK                    0x1F00
        #define REG_CLKGEN1_TSO1_IN_SHIFT                   8
        #define REG_CLKGEN1_TSO1_IN_DISABLE                 0x0100
        #define REG_CLKGEN1_TSO1_IN_INVERT                  0x0200
        // bit[12:8]  -> 0: disable clock
        //                   1: invert clock
        //                   bit [12:10] -> 000: Sel TS0 Clk
        //                                      001: Sel TS1 Clk
        //                                      010: Sel TS2 Clk
        //                                      011: Sel Demod Clk
    #define REG_CLKGEN1_TSO_OUT_PHASE                   0x24
        #define REG_CLKGEN1_TSO_OUT_DIVNUM_MASK             0x001F
        #define REG_CLKGEN1_TSO_OUT_PH_TUN_NUM_MASK         0x1F00
        #define REG_CLKGEN1_TSO_OUT_PH_TUN_NUM_SHIFT        8
    #define REG_CLKGEN1_TSO_OUT_CLK                     0x25
        #define REG_CLKGEN0_TSO_OUT_DIV_SEL_MASK            0x0001
        // bit[0]    ->  0: CLK_DMPLLDIV5
        //                   1: CLK_DMPLLDIV3
        #define REG_CLKGEN1_TSO_OUT_INV                     0x0002
        #define REG_CLKGEN1_TSO_OUT_PHASE_TUN_ENABLE        0x0004
        #define REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_MASK         0x0070
            #define REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_SHIFT    4
            #define REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_TS0      0x0000
            #define REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_TS1      0x0010
            #define REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_TS2      0x0020

        #define REG_CLKGEN0_TSO_OUT_CLK_MASK                0x1F00
            #define REG_CLKGEN1_TSO_OUT_CLK_DISABLE         0x0100
            #define REG_CLKGEN1_TSO_OUT_CLK_INVERT          0x0200
        // bit[12:8]  ->  0: disable clock
        //                     1: invert clock
...
#define TSP_TOP_REG(addr)           (*((volatile MS_U16*)(_virtTSORegBase + 0x3c00 + ((addr)<<2))))
...
#define TSP_TSP5_REG(addr)          (*((volatile MS_U16*)(_virtTSORegBase + 0xc7600 + ((addr)<<2))))
    #define REG_TSP5_TSOIN_MUX                  0x13
        #define REG_TSP5_TSOIN_MUX_MASK                 0x000F
        #define REG_TSP5_TSOIN0_MUX_SHIFT               0
        #define REG_TSP5_TSOIN1_MUX_SHIFT               4
    #define REG_TSP5_TSOOUT_MUX                 0x15
        #define REG_TSP5_TSOOUT_MUX_MASK                0x000F
        #define REG_TSP5_TSOOUT_MUX_TSO                 0x0000
        #define REG_TSP5_TSOOUT_MUX_S2P0                0x0001
...
#if 0
#define TSO_MIUDIG0_REG(addr)       (*((volatile MS_U16*)(_u32TSORegBase + 0x0C00 + ((addr)<<2))))
#define TSO_MIUDIG1_REG(addr)       (*((volatile MS_U16*)(_u32TSORegBase + 0x2400 + ((addr)<<2))))
...
void HAL_TSO_Recover_TSOutMode(MS_U8 u8Eng)
{
    switch(_stOutPadCtrl.u16OutPad[u8Eng])
    {
        case HAL_TSOOUT_MUX_TS1:
            TSP_TOP_REG(REG_TOP_TSCONFIG) = (TSP_TOP_REG(REG_TOP_TSCONFIG) & ~(REG_TOP_TS_TS1_CFG_MASK<<REG_TOP_TS1CFG_SHIFT)) | _stOutPadCtrl.u16TSCfgOld[u8Eng];
            TSP_TOP_REG(REG_TOP_TS_OUT_MODE) = (TSP_TOP_REG(REG_TOP_TS_OUT_MODE) & ~REG_TOP_TS_OUT_MODE_MASK) | _stOutPadCtrl.u16TSOutModeOld[u8Eng];
            break;
        default:
            return;
    }
...
MS_BOOL HAL_TSO_OutPad(MS_U8 u8Eng, MS_U16* pu16OutPad,MS_BOOL bSet)
{
    if(bSet)
    {
        switch(*pu16OutPad)
        {
            case HAL_TSOOUT_MUX_TS1:
                ...
                _stOutPadCtrl.u16TSCfgOld[u8Eng] = TSP_TOP_REG(REG_TOP_TSCONFIG) & (REG_TOP_TS_TS1_CFG_MASK << REG_TOP_TS1CFG_SHIFT);
                _stOutPadCtrl.u16TSOutModeOld[u8Eng] = TSP_TOP_REG(REG_TOP_TS_OUT_MODE) & REG_TOP_TS_OUT_MODE_MASK;
                ...
                TSP_TSP5_REG(REG_TSP5_TSOOUT_MUX) = (TSP_TSP5_REG(REG_TSP5_TSOOUT_MUX) & ~REG_TSP5_TSOOUT_MUX_MASK) | REG_TSP5_TSOOUT_MUX_TSO;
                TSP_TS_SAMPLE_REG(REG_TSO_OUT_CLK_SEL) = ((TSP_TS_SAMPLE_REG(REG_TSO_OUT_CLK_SEL) & ~REG_TSO_OUT_CLK_SEL_MASK) | REG_TSO_OUT_TSO);  //tso out
                break;
            default:
                return FALSE;
        }
    ...
    {
        *pu16OutPad = HAL_TSOOUT_MUX_TS1;  // only ts1 1p out
    }
...
MS_BOOL HAL_TSO_SelPad(MS_U8 u8Eng, MS_U8 u8TsIf, MS_U16 u16InPadSel, MS_BOOL bParallel)
{
    ...
    {
        case TSO_IN_MUX_TS0:
            u16RegMask = REG_TOP_TS_TS0_CFG_MASK << REG_TOP_TS0CFG_SHIFT;
            if(bParallel)
            {
                u16data = REG_TOP_TS_TS0_PARALL_IN << REG_TOP_TS0CFG_SHIFT;
            }
            else
            {
                u16data = REG_TOP_TS_TS0_SERIAL_IN << REG_TOP_TS0CFG_SHIFT;
            }
            break;
        case TSO_IN_MUX_TS1:
            u16RegMask = REG_TOP_TS_TS1_CFG_MASK << REG_TOP_TS1CFG_SHIFT;
            if(bParallel)
            {
                u16data = REG_TOP_TS_TS1_PARALL_IN << REG_TOP_TS1CFG_SHIFT;
            }
            else
            {
                u16data = REG_TOP_TS_TS1_SERIAL_IN << REG_TOP_TS1CFG_SHIFT;
            }
            break;
        case TSO_IN_MUX_TS2:
            u16RegMask = REG_TOP_TS_TS2_CFG_MASK << REG_TOP_TS2CFG_SHIFT;
            if(bParallel)
            {
                u16data = REG_TOP_TS_TS2_PARALL_IN << REG_TOP_TS2CFG_SHIFT;
            }
            else
            {
                u16data = REG_TOP_TS_TS2_SERIAL_IN << REG_TOP_TS2CFG_SHIFT;
            }
            break;
        case TSO_IN_MUX_TSDEMOD:
    ...
    TSP_TOP_REG(REG_TOP_TSCONFIG) = (TSP_TOP_REG(REG_TOP_TSCONFIG) & ~u16RegMask) | u16data;

    TSP_TSP5_REG(REG_TSP5_TSOIN_MUX) = (TSP_TSP5_REG(REG_TSP5_TSOIN_MUX) & ~(REG_TSP5_TSOIN_MUX_MASK << u16RegShift)) | (u16InPadSel << u16RegShift);

    // ts1_pad & ts3_pad can for output mode
    //TSP_TOP_REG(REG_TOP_TS_CONFIG) &= ~REG_TOP_TS1_CONFIG_MASK;
    //TSP_TOP_REG(REG_TOP_TS_OUT_MODE) = (TSP_TOP_REG(REG_TOP_TS_OUT_MODE) & ~REG_TOP_TS_OUT_MODE_MASK) | REG_TOP_TS_OUT_MODE_TSO;
...
MS_BOOL HAL_TSO_Set_InClk(MS_U8 u8Eng, MS_U8 u8TsIf, MS_U16 u16ClkSel, MS_BOOL bClkInvert, MS_BOOL bEnable)
{
    ...
    if(!bEnable)
    {
        u16value |= (REG_CLKGEN1_TSO_IN_DISABLE << u16RegShift);
    }
    else
    {
        if(u16ClkSel > TSO_CLKIN_DMD)
        {
            return FALSE;
        }
        ...
        if(bClkInvert)
        {
            u16value |= (REG_CLKGEN1_TSO1_IN_INVERT << u16RegShift);
        }
    }
...
MS_BOOL HAL_TSO_GetInputTSIF_Status(MS_U8 u8Eng, MS_U8 u8TsIf, MS_U16* pu16Pad, MS_BOOL* pbClkInvert, MS_BOOL* pbExtSync, MS_BOOL* pbParl)
{
    ...
    switch(u8TsIf)
    {
        case HAL_TSO_TSIF_LIVE1:
            ...
            u16RegMask =  REG_TSP5_TSOIN_MUX_MASK << REG_TSP5_TSOIN0_MUX_SHIFT;
            u16RegShift = REG_TSP5_TSOIN0_MUX_SHIFT;
            break;
        case HAL_TSO_TSIF_LIVE2:
            u16Reg = REG_TSP5_TSOIN_MUX;
            u16RegMask = REG_TSP5_TSOIN_MUX_MASK  << REG_TSP5_TSOIN1_MUX_SHIFT;
            u16RegShift = REG_TSP5_TSOIN1_MUX_SHIFT;
            break;
        default:
            return FALSE;
...
MS_BOOL HAL_TSO_PreTsoOutClk(MS_U8 u8Eng, MS_U16* pu16PreTsoOutSel, MS_BOOL bSet)
{
    if(bSet == TRUE)
    {
        ...
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) =
            (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & ~REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_MASK) | (*pu16PreTsoOutSel << REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_SHIFT);
    }
    else
    {
        *pu16PreTsoOutSel = (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & (REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_MASK)) >> REG_CLKGEN1_TSO_OUT_PRE_OUTCLK_SHIFT;
    }
...
MS_BOOL HAL_TSO_TSOOutDiv(MS_U8 u8Eng, MS_U16* pu16ClkOutDivSrcSel, MS_U16* pu16ClkOutDivNum,MS_BOOL bSet)
{
    ...
    if(bSet == TRUE)
    {
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) =
            (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) & ~REG_CLKGEN0_TSO_TRACE_MASK) | REG_CLKGEN1_TSO_TRACE_216M;

        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) =
            (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & ~REG_CLKGEN0_TSO_OUT_DIV_SEL_MASK) | *pu16ClkOutDivSrcSel;
    ...
    {
        *pu16ClkOutDivSrcSel = TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & REG_CLKGEN0_TSO_OUT_DIV_SEL_MASK;
...
MS_BOOL HAL_TSO_OutClk(MS_U8 u8Eng, MS_U16* pu16ClkOutSel, MS_BOOL* pbClkInvert, MS_BOOL* pbEnable,MS_BOOL bSet)
{
    ...
    MS_U16 u16Clk = TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & ~REG_CLKGEN0_TSO_OUT_CLK_MASK;
    ...
    if(bSet == TRUE)
    {
        ...
        printf("[%s]u16Clk=0x%x\n\n",__FUNCTION__,u16Clk);
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) = u16Clk;
    }
    else
    {
        *pbEnable = TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & REG_CLKGEN1_TSO_OUT_CLK_DISABLE;
        *pbClkInvert = TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & REG_CLKGEN1_TSO_OUT_CLK_INVERT;
        *pu16ClkOutSel = TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & ~(REG_CLKGEN1_TSO_OUT_CLK_INVERT | REG_CLKGEN1_TSO_OUT_CLK_DISABLE);
    }
...
{
    MS_U16 u16ChIf = TSO_CFG1_TSO_TSIF5_EN;
...
{
    MS_U16 u16data = TSO_SW_RSTZ_CMDQ;
