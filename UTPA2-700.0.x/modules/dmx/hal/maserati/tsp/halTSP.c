...
static MS_BOOL      _bTsPadUsed[4] = {FALSE, FALSE, FALSE, FALSE};
static MS_U16       _u16TsPadPE[4] = {0,0,0,0};
...
#define PMTOP_REG(addr)             (*((volatile MS_U16*)(_virtPMRegBase + 0x3c00UL + ((addr)<<2UL))))
    #define REG_PMTOP_CHIPID                            0x66UL
        #define REG_PMTOP_CHIPID_MASK                   0xFFFFUL
    #define REG_PMTOP_CHIPVERSION                       0x67UL
...
#define TSP_CLKGEN0_REG(addr)       (*((volatile MS_U16*)(_virtRegBase + 0x1600UL + ((addr)<<2UL))))
    #define REG_CLKGEN0_DC0_SYTNTH              0x04UL
        ...
        #define REG_CLKGEN0_STC1_CW_SEL         0x0200UL
        #define REG_CLKGEN0_STC1_CW_EN          0x0400UL
    #define REG_CLKGEN0_DC0_STC_CW_L            0x05UL
    #define REG_CLKGEN0_DC0_STC_CW_H            0x06UL
    #define REG_CLKGEN0_DC0_STC1_CW_L           0x07UL
    #define REG_CLKGEN0_DC0_STC1_CW_H           0x08UL
    ...
    #define REG_CLKGEN0_TSN_CLK                 0x28UL
        ...
        //#define TSP_CLK_TS3                        3
        //#define TSP_CLK_TS4                        4
        //#define TSP_CLK_TS5                        5
        ...
        //                                  6: TSOOUT
        //                                  7: Internal Demmod
    #define REG_CLKGEN0_TSN_CLK2                0x29UL
        #define REG_CLKGEN0_TSN_CLK_TS2_SHIFT   0UL
        ...
        //                                  6: TSOOUT
        //                                  7: Internal Demmod
#define TSP_CLKGEN2_REG(addr)       (*((volatile MS_U16*)(_virtRegBase + 0x1400UL + ((addr)<<2UL))))
    #define REG_CLKGEN2_TSN_CLKFI               0x0DUL
        #define REG_CLKGEN2_TSN_CLK_TSFI_SHIFT  8UL
        ...
        //                                     6: TSOOUT
        //                                     7: Internal Demmod
    #define REG_CLKGEN2_TSN_CLKTS3              0x11UL       //Not use
        #define REG_CLKGEN2_TSN_CLKTS3_SHIFT    0
        #define REG_CLKGEN2_TSN_CLKTS3_MASK     0x1FUL
        ...
        //                                      5: TS5
        //                                      6: TSOOUT
    #define REG_CLKGEN2_TSN_TS4TS5              0x18UL      //s2p0, ts4 mux clk
        #define REG_CLKGEN2_TSN_TS4_SHIFT       0UL         //s2p1, ts5 mux clk
        // bit[4:0] ->       0: disable clock
        //                      1: invert clock
        //                      bit [4:2] -> 0: TS0
        //                                      1: TS1
        ...
        //                                      4: TS4
        //                                      5: TS5
        #define REG_CLKGEN2_TSN_TS5_SHIFT       8UL
        ...
        //                                      4: TS4
        //                                      5: TS5
    #define REG_CLKGEN2_DC0_SYNTH               0x30UL
        #define REG_CLKGEN2_STC2_CW_SEL         0x0002UL
        #define REG_CLKGEN2_STC2_CW_EN          0x0004UL
        #define REG_CLKGEN2_STC3_CW_SEL         0x0200UL
        #define REG_CLKGEN2_STC3_CW_EN          0x0400UL
    #define REG_CLKGEN2_DC0_STC2_CW_L           0x31UL
    #define REG_CLKGEN2_DC0_STC2_CW_H           0x32UL
    #define REG_CLKGEN2_DC0_STC3_CW_L           0x33UL
    #define REG_CLKGEN2_DC0_STC3_CW_H           0x34UL

#define TSP_TOP_REG(addr)           (*((volatile MS_U16*)(_virtRegBase + 0x3c00UL + ((addr)<<2UL))))
    #define REG_TOP_TS0_PE                      0x0EUL
        #define REG_TOP_TS0_PE_MASK                         0x07FFUL
    #define REG_TOP_TS1_PE                      0x06UL
        #define REG_TOP_TS1_PE_MASK                         0x07FFUL
    ...
    #define REG_TOP_TS2_PE                      0x36UL
        #define REG_TOP_TS2_PE_MASK                         0x07FFUL
    #define REG_TOP_TS3_PE                      0x37UL
        #define REG_TOP_TS3_PE_MASK                         0x07FFUL

    #define REG_TOP_TS4TS5_CFG                  0x40UL
        #define REG_TOP_TS_OUT_MODE_MASK                    0x0070UL       //1: internal demod out
        ...
        #define REG_TOP_TS4_CFG_MASK                        0x0E00UL
        #define REG_TOP_TS4_CFG_SHIFT                       9UL
        //bit [11:9] -> 0: Disable
        //                    1: serial in ,
        //                    2: parallel in
        //                    3: m card spi
        //                    4: serial in @ PAD_TS2_D4~D7, share with ts2 serial pad
        #define REG_TOP_TS5_CFG_MASK                        0x3000UL
        #define REG_TOP_TS5_CFG_SHIFT                       12UL
        //bit [12] ->     0: Disable
        //                    1: TS4 use I2S & GPIO pads
    #define REG_TOP_TSCONFIG                    0x57UL
        #define REG_TOP_TS0CFG_SHIFT                        8UL
        #define REG_TOP_TS_TS0_CFG_MASK                     0x0700UL
            #define REG_TOP_TS_TS0_PARALL_IN                1UL
            #define REG_TOP_TS_TS0_SERIAL_IN                2UL  //3: mspi, 4: 3wire
            #define REG_TOP_TS_TS0_3WIRE_IN                 4UL  //3: mspi, 4: 3wire
        ...
        #define REG_TOP_TS_TS1_CFG_MASK                     0x3800UL
            ...
            #define REG_TOP_TS_TS1_SERIAL_IN                3UL  //4: 3wire, 5 mspi
            #define REG_TOP_TS_TS1_3WIRE_IN                 4UL
        ...
        //                     4: 3 wire mode
        //                     5: mspi
    #define REG_TOP_TS2CONFIG                    0x5AUL
        #define REG_TOP_TS2CFG_SHIFT                        12UL
        #define REG_TOP_TS_TS2_CFG_MASK                     0x7000UL
            #define REG_TOP_TS_TS2_SERIAL_IN                1UL
            #define REG_TOP_TS_TS2_PARALL_IN                2UL
        // bit[14:12] ->    0: Disable
        //                     1: serial in
        //                     2: parallal
        //                     3: m_card_spi
    ...
    #define REG_TOP_TS_TS3_CFG                  0x67UL
        #define REG_TOP_TS3CFG_MASK                         0xF000UL
        #define REG_TOP_TS3CFG_SHIFT                        12UL
        #define REG_TOP_TS3_OUT_MODE_DMD                    0x5000UL
        #define REG_TOP_TS3_OUT_MODE_Ser2Par                0x7000UL
        #define REG_TOP_TS3_OUT_MODE_Ser2Par1               0x8000UL
        #define REG_TOP_TS_TS3_3WIRE_IN                     6UL
        // bit[15:12] ->  0: Disable
        //                     1: TS3 Serial in
        //                     2: TS3 Parallel In
        //                     3: mspi out
        ...
        //                     7: TS3 s2p Out
        //                     8: TS3 s2p1 Out
        //                     9: serial in @ PAD_TS2_D0/VLD/SYNC/CLK, use ts2 serial pad
#define TSP_TSO0_REG(addr)           (*((volatile MS_U16*)(_virtRegBase + 0x27400UL + ((addr)<<2UL))))
    #define REG_TSO0_CFG0                       0x1CUL
        ...
        #define REG_TSO0_CFG0_S2P1_CFG_SHIFT                8UL

#define TSP_TS_SAMPLE_REG(addr)       (*((volatile MS_U16*)(_virtRegBase + 0x21400 + ((addr)<<2))))
...
#define DSCMB_CIPHERENG_REG(addr)     (*((volatile MS_U16*)(_virtRegBase + 0x27800 + ((addr)<<2))))
    #define REG_CIPHERENG_CTRL                  0x0CUL
        #define REG_CIPHERENG_DIS_PRIBUF_MASK               0xF000UL
...
MS_BOOL HAL_TSP_SecFlt_GetMask(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_U8 *pu8Mask)
{
    MS_U32 i;
    MS_U32 u32Temp;
    MS_U32 j = 0;
    ...
    for (i = 0; i < (TSP_FILTER_DEPTH/sizeof(MS_U32)); i++)
    {
        u32Temp = HAL_REG32_IndR((REG32 *)&pSecFilter->Mask[i]);
...
MS_BOOL HAL_TSP_SecFlt_GetMatch(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_U8 *pu8Match)
{
    MS_U32 i;
    MS_U32 u32Temp;
    MS_U32 j;
    ...
    for (i = 0; i < (TSP_FILTER_DEPTH/sizeof(MS_U32)); i++)
    {
        u32Temp = HAL_REG32_IndR((REG32 *)&pSecFilter->Match[i]);
...
MS_BOOL HAL_TSP_TsOutPadCfg(MS_U32 u32OutPad, MS_U32 u32OutPadMode, MS_U32 u32InPad, MS_BOOL bInParallel)
{
    ...
    if((u32OutPad != TSP_MUX_TS1) && (u32OutPad != TSP_MUX_TS3))
    {
        return FALSE;
    }
    ...
    if((u32OutPadMode == HAL_TSP_OUTPAD_S2P) || (u32OutPadMode == HAL_TSP_OUTPAD_S2P1))
    {
        //fix s2p1 mode with output pad #3
        if(u32OutPad == TSP_MUX_TS3)
        {
            u32OutPadMode = HAL_TSP_OUTPAD_S2P1;
        }

        u16S2pRegShift = ((u32OutPadMode == HAL_TSP_OUTPAD_S2P) ? REG_TSO0_CFG0_S2P0_CFG_SHIFT : REG_TSO0_CFG0_S2P1_CFG_SHIFT);

        if(u32InPad == TSP_MUX_NONE)
        {
            TSP_TSO0_REG(REG_TSO0_CFG0) &= ~(REG_TSO0_CFG0_S2PCFG_S2P_EN << u16S2pRegShift);
            return TRUE;
        }
        ...
        // S2P clk
        TSP_CLKGEN2_REG(REG_CLKGEN2_TSN_TS4TS5) = (TSP_CLKGEN2_REG(REG_CLKGEN2_TSN_TS4TS5) & ~(REG_CLKGEN0_TSN_CLK_MASK << u16S2pRegShift)) | (u16clk << u16S2pRegShift);

        // S2P mux
        u16S2pRegShift = ((u32OutPadMode == HAL_TSP_OUTPAD_S2P) ? TS_MUX_CFG_S2P0_MUX_SHIFT : TS_MUX_CFG_S2P1_MUX_SHIFT);
        _HAL_REG16_W(&(_TspCtrl5[0].TS_MUX_CFG_S2P),
                        (_HAL_REG16_R(&(_TspCtrl5[0].TS_MUX_CFG_S2P)) & ~(TS_MUX_CFG_S2P0_MUX_MASK << u16S2pRegShift)) | (u16Data << u16S2pRegShift));
        TSP_TSO0_REG(REG_TSO0_CFG0) |= u16S2pCfg;

        // TSO out clk
        u16S2pCfg = ((u32OutPadMode == HAL_TSP_OUTPAD_S2P) ? REG_TSO_OUT_S2P0 : REG_TSO_OUT_S2P1);
        u16S2pRegShift = ((u32OutPadMode == HAL_TSP_OUTPAD_S2P) ? 0 : REG_TSO1_OUT_CLK_SEL_SHIFT);
        TSP_TS_SAMPLE_REG(REG_TSO_OUT_CLK_SEL) = ((TSP_TS_SAMPLE_REG(REG_TSO_OUT_CLK_SEL) & ~(REG_TSO_OUT_CLK_SEL_MASK<<u16S2pRegShift)) | (u16S2pCfg<<u16S2pRegShift));  //TSO out (S2P)
    ...
    if(u32OutPad == TSP_MUX_TS1)
    {
        ...
        {
            u16Data = REG_TOP_TS1_OUT_MODE_TSO;
        }
        else if(u32OutPadMode == HAL_TSP_OUTPAD_S2P)
        {
            u16Data = REG_TOP_TS1_OUT_MODE_Ser2Par;
        }
        else if(u32OutPadMode == HAL_TSP_OUTPAD_S2P1)
        {
            u16Data = REG_TOP_TS1_OUT_MODE_Ser2Par1;
        }
        else
        {
            u16Data = 0;
        }
        TSP_TOP_REG(REG_TOP_TS4TS5_CFG) = (TSP_TOP_REG(REG_TOP_TS4TS5_CFG) & ~REG_TOP_TS_OUT_MODE_MASK) | u16Data;
    }
    else if(u32OutPad == TSP_MUX_TS3)
    {
        if(u32InPad == TSP_MUX_TSO)
        { // TSO
        ...
        {
            TSP_TOP_REG(REG_TOP_TSO_MUX) = TSP_TOP_REG(REG_TOP_TSO_MUX) & ~REG_TOP_TSO_EVDMODE_MASK;
        }
        u16Data = 0;
        if(u32InPad == TSP_MUX_INDEMOD)
        {
            u16Data = REG_TOP_TS3_OUT_MODE_DMD;
        }
        else if(u32OutPadMode == HAL_TSP_OUTPAD_S2P)
        {
            u16Data = REG_TOP_TS3_OUT_MODE_Ser2Par;
        }
        else if(u32OutPadMode == HAL_TSP_OUTPAD_S2P1)
        {
            u16Data = REG_TOP_TS3_OUT_MODE_Ser2Par1;
        }
        else
        {
            u16Data = 0;
        }
        TSP_TOP_REG(REG_TOP_TS_TS3_CFG) = (TSP_TOP_REG(REG_TOP_TS_TS3_CFG) & ~REG_TOP_TS3CFG_MASK) | u16Data;
    }
...
void HAL_TSP_SelPad(MS_U32 u32EngId, MS_U32 u32Flow, MS_U32 u32Pad, MS_BOOL bParl)
{
    ...
    {
        _u16TsPadPE[0] = TSP_TOP_REG(REG_TOP_TS0_PE) & REG_TOP_TS0_PE_MASK;
        TSP_TOP_REG(REG_TOP_TS0_PE) = TSP_TOP_REG(REG_TOP_TS0_PE)| REG_TOP_TS0_PE_MASK;
        _bTsPadUsed[0] = TRUE;
    }
    if((u32Pad == TSP_MUX_TS1) && (_bTsPadUsed[1] == FALSE))
    {
        _u16TsPadPE[1] = TSP_TOP_REG(REG_TOP_TS1_PE) & REG_TOP_TS1_PE_MASK;
        TSP_TOP_REG(REG_TOP_TS1_PE) = TSP_TOP_REG(REG_TOP_TS1_PE) | REG_TOP_TS1_PE_MASK;
        _bTsPadUsed[1] = TRUE;
    }
    if((u32Pad == TSP_MUX_TS2) && (_bTsPadUsed[2] == FALSE))
    {
        _u16TsPadPE[2] = TSP_TOP_REG(REG_TOP_TS2_PE) & REG_TOP_TS2_PE_MASK;
        TSP_TOP_REG(REG_TOP_TS2_PE) = TSP_TOP_REG(REG_TOP_TS2_PE)| REG_TOP_TS2_PE_MASK;
        _bTsPadUsed[2] = TRUE;
    }

    if((u32Pad == TSP_MUX_TS3) && (_bTsPadUsed[3] == FALSE))
    {
        _u16TsPadPE[3] = TSP_TOP_REG(REG_TOP_TS3_PE) & REG_TOP_TS3_PE_MASK;
        TSP_TOP_REG(REG_TOP_TS3_PE) = TSP_TOP_REG(REG_TOP_TS3_PE)| REG_TOP_TS3_PE_MASK;
        _bTsPadUsed[3] = TRUE;
    }
    ...
    switch(u16padsel)
    {
        case TSP_MUX_TS0:
            ...
            break;
        case TSP_MUX_TS1:
            TSP_TOP_REG(REG_TOP_TS4TS5_CFG) = TSP_TOP_REG(REG_TOP_TS4TS5_CFG) & ~REG_TOP_TS_OUT_MODE_MASK; //disable ts1 out mode
            u16Reg   = REG_TOP_TSCONFIG;
        ...
        case TSP_MUX_TS2:
            ...
            break;
        case TSP_MUX_TS3:
            TSP_TOP_REG(REG_TOP_TSO_MUX) = TSP_TOP_REG(REG_TOP_TSO_MUX) & ~REG_TOP_TSO_EVDMODE_MASK;  //disable ts3 out mode
            u16Reg   = REG_TOP_TS_TS3_CFG;
            u16Shift = REG_TOP_TS3CFG_SHIFT;
            u16Mask  = REG_TOP_TS3CFG_MASK;
            break;
        case TSP_MUX_TS4:
            u16Reg   = REG_TOP_TS4TS5_CFG;
            u16Shift = REG_TOP_TS4_CFG_SHIFT;
            u16Mask  = REG_TOP_TS4_CFG_MASK;
            break;
        case TSP_MUX_TS5:
            if(bParl == TRUE)
            {
                return; //only serial mode
            }
            u16Reg   = REG_TOP_TS4TS5_CFG;
            u16Shift = REG_TOP_TS5_CFG_SHIFT;
            u16Mask  = REG_TOP_TS5_CFG_MASK;
            break;
        default:
            return;
    }
    ...
    if(bIs3WireMode)
    {
        switch(u16padsel)
        {
            ...
            case TSP_MUX_TS1:
                ...
                break;
            case TSP_MUX_TS3:
                u16data = REG_TOP_TS_TS3_3WIRE_IN;
            case TSP_MUX_TS2:
            case TSP_MUX_TS4:
            case TSP_MUX_TS5:
                u16data = 1;
...
void HAL_TSP_SelPad_ClkInv(MS_U32 u32EngId, MS_U32 u32Flow, MS_BOOL bClkInv)
{
    ...
    switch(u32Flow)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            u32data = TSP_CLKGEN2_REG(REG_CLKGEN2_TSN_CLKFI) & ~(REG_CLKGEN0_TSN_CLK_MASK<< REG_CLKGEN2_TSN_CLK_TSFI_SHIFT);
            u32data |= (u32Clk<< REG_CLKGEN2_TSN_CLK_TSFI_SHIFT);
            TSP_CLKGEN2_REG(REG_CLKGEN2_TSN_CLKFI) = u32data;
            break;
        default:
            return;
    }
...
MS_BOOL HAL_TSP_GetCap(MS_U32 u32Cap, void* pData)
{
    ...
    case HAL_TSP_CAP_CA1_FLT_RANGE:
        ...
        *((MS_U32*)pData + 1) = DSCMB1_FLT_END_ID;
        break;
    case HAL_TSP_CAP_CA2_FLT_RANGE:
        *((MS_U32*)pData) = DSCMB2_FLT_START_ID;
        *((MS_U32*)pData + 1) = DSCMB2_FLT_END_ID;
        break;
    case HAL_TSP_CAP_SHAREKEY_FLT1_RANGE:
        *((MS_U32*)pData) = DSCMB_FLT_SHAREKEY1_START_ID;
        *((MS_U32*)pData + 1) = DSCMB_FLT_SHAREKEY1_END_ID;
        break;
    case HAL_TSP_CAP_SHAREKEY_FLT2_RANGE:
        *((MS_U32*)pData) = DSCMB_FLT_SHAREKEY2_START_ID;
        *((MS_U32*)pData + 1) = DSCMB_FLT_SHAREKEY2_END_ID;
        break;
    ...
    case HAL_TSP_CAP_PCRFLT_START_IDX:
        *((MS_U32*)pData) = TSP_PIDFLT_NUM+TSP_PIDFLT_EXT_NUM;
        break;
    ...
    MS_BOOL                    bDQmem)
{
    ...
    if (bFwDMA)
    {
        ...
        //enable oneway lock for tee
        #ifdef SECURE_PVR_ENABLE
        _HAL_REG32_W(&_TspCtrl[0].REG_ONEWAY, SET_FLAG1(_HAL_REG32_R(&_TspCtrl[0].REG_ONEWAY), TSP_ONEWAY_LOAD_FW_PORT));
        REG16_T(ADDR_MOBF_FILEIN) = 0;
        #endif
...
void HAL_TSP_PidFlt_SetFltRushPass(MS_U32 u32EngId, MS_U32 u32PidFltId, MS_BOOL bEnable)
{
    ...
    if(bEnable)
        HAL_REG32_IndW((REG32 *)pPidFilter,(HAL_REG32_IndR((REG32 *)pPidFilter) | TSP_PIDFLT_RUSH_PASS));
    else
        HAL_REG32_IndW((REG32 *)pPidFilter,(HAL_REG32_IndR((REG32 *)pPidFilter) & ~TSP_PIDFLT_RUSH_PASS));
}
...
void HAL_TSP_HwPatch(void)
{
    ...
    _HAL_REG32_W(&_TspCtrl[0].PVR2_Config, _HAL_REG32_R(&_TspCtrl[0].PVR2_Config)|TSP_PVR2_PVR_ALIGN_EN);
    ...
    //Enable U02 ECO
    if(((PMTOP_REG(REG_PMTOP_CHIPVERSION) & REG_PMTOP_CHIP_REVISION_MASK) >> REG_PMTOP_CHIP_REVISION_SHIFT) > 0)
    {
        DSCMB_CIPHERENG_REG(REG_CIPHERENG_CTRL) |= REG_CIPHERENG_DIS_PRIBUF_MASK;
    }
    else
    {
        //For nagra enable mode, should set pkt size +1
        _HAL_REG32_W(&_TspCtrl[0].Hw_Config0,
                (_HAL_REG32_R(&_TspCtrl[0].Hw_Config0) & ~TSP_HW_CFG0_PACKET_PIDFLT0_SIZE_MASK) | (0xBC << TSP_HW_CFG0_PACKET_PIDFLT0_SIZE_SHIFT));
        _HAL_REG32_W(&_TspCtrl[0].Hw_Config2,
                (_HAL_REG32_R(&_TspCtrl[0].Hw_Config2) & ~TSP_HW_CFG2_PACKET_SIZE1_MASK) | (0xBC << TSP_HW_CFG2_PACKET_SIZE1_SHFT));
        _HAL_REG32_W(&_TspCtrl[0].SyncByte2_ChkSize,
                (_HAL_REG32_R(&_TspCtrl[0].SyncByte2_ChkSize) & ~TSP_PKT_SIZE2_MASK) | (0xBC << TSP_PKT_SIZE2_SHIFT));
        _HAL_REG32_W(&_TspCtrl[0].DMAW_ERR_WADDR_SRC_SEL,
                (_HAL_REG32_R(&_TspCtrl[0].DMAW_ERR_WADDR_SRC_SEL) & ~TSP_PKTSIZE_FI_MASK) | (0xBC << TSP_PKTSIZE_FI_SHIFT));
    }
  
    #ifdef SECURE_PVR_ENABLE
    _HAL_REG32_W(&_TspCtrl[0].REG_ONEWAY, SET_FLAG1(_HAL_REG32_R(&_TspCtrl[0].REG_ONEWAY), TSP_ONEWAY_AV_NOT_TO_SEC));
    #endif
...
void HAL_TSP_TEI_RemoveErrorPkt(MS_U32 u32PktType, MS_BOOL bEnable)
{
    ...
    {
        case TSP_PKTDMX0_LIVE:
            pReg = &_TspCtrl[0].reg15b4;
            u32Flag = TSP_TEI_SKIPE_PKT_PID0;
            break;
        case TSP_PKTDMX0_FILE:
            pReg = &_TspCtrl[0].reg15b4;
            u32Flag = TSP_TEI_SKIPE_PKT_FILE;
            break;
        case TSP_PKTDMX1:
            pReg = &_TspCtrl[0].reg15b4;
            u32Flag = TSP_TEI_SKIPE_PKT_PID1;
            break;
        case TSP_PKTDMX2:
            pReg = &_TspCtrl[0].PVR2_Config;
            u32Flag = TSP_TEI_SKIP_PKT2;
            break;
        default:
            return;
    }
...
MS_BOOL HAL_TSP_GetTSIF_Status(MS_U8 u8TsIfId, MS_U16* pu16Pad, MS_U16* pu16Clk, MS_BOOL* pbExtSync, MS_BOOL* pbParl)
{
    ...
    *pbParl    = FALSE;
    ...
    if(u8TsIfId == 0x80UL)  //TSFI
    {
        ...
        *pu16Clk   = (TSP_CLKGEN2_REG(REG_CLKGEN2_TSN_CLKFI) >> REG_CLKGEN2_TSN_CLK_TSFI_SHIFT) & REG_CLKGEN0_TSN_CLK_MASK;
...
MS_U32 HAL_TSP_GetSTCSynth(MS_U32 u32EngId)
{
    switch (u32EngId)
    {
        ...
        case 2:
            return (TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_STC2_CW_L) | TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_STC2_CW_H));
        case 3:
            return (TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_STC3_CW_L) | TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_STC3_CW_H));
        default:
            return 0;
    }
}
...
void HAL_TSP_SetSTCSynth(MS_U32 u32EngId, MS_U32 u32Sync)
{
    switch (u32EngId)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) &= ~REG_CLKGEN2_STC2_CW_SEL;
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_STC2_CW_L) = (MS_U16)(u32Sync & 0xFFFF);
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_STC2_CW_H) = (MS_U16)((u32Sync >> 16UL) & 0xFFFF);
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) &= ~REG_CLKGEN2_STC2_CW_EN;
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) |= REG_CLKGEN2_STC2_CW_EN;
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) &= ~REG_CLKGEN2_STC2_CW_EN;
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) |= REG_CLKGEN2_STC2_CW_SEL;
            break;
        case 3:
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) &= ~REG_CLKGEN2_STC3_CW_SEL;
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_STC3_CW_L) = (MS_U16)(u32Sync & 0xFFFF);
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_STC3_CW_H) = (MS_U16)((u32Sync >> 16UL) & 0xFFFF);
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) &= ~REG_CLKGEN2_STC3_CW_EN;
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) |= REG_CLKGEN2_STC3_CW_EN;
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) &= ~REG_CLKGEN2_STC3_CW_EN;
            TSP_CLKGEN2_REG(REG_CLKGEN2_DC0_SYNTH) |= REG_CLKGEN2_STC3_CW_SEL;
            break;
...
MS_BOOL HAL_TSP_SetSTCOffset(MS_U32 u32EngId, MS_U32 u32Offset, MS_BOOL bAdd)
{
    ...
    _HAL_REG32_W(&_TspCtrl[0].MCU_Cmd, TSP_MCU_CMD_SET_STC_OFFSET | u32EngId /*| u32opt*/);
...
#define CKG_TSO_SRC        0x169CUL  //0x27
    #define CKG_TSO_TRACE_DISABLE    0x0001UL
    #define CKG_TSO_TRACE_INVERT     0x0002UL
    #define CKG_TSO_TRACE_CLK_MASK   0x000CUL
    #define CKG_TSO0_IN_DIABLE       0x0100UL
    #define CKG_TSO0_IN_INVERT       0x0200UL
    #define CKG_TSO0_IN_CLK_MASK     0x1C00UL
...
#define CKG_TS2_TSGP       0x16A4UL  //0x29
    #define CLK_TS2_DISABLE          0x0001UL
    #define CLK_TS2_INVERT           0x0002UL
    #define CLK_TS2_CLK_MASK         0x001CUL
#define CKG_TSP_STC0       0x16A8UL  //0x2A
    ...
    #define CLK_STC_CLK_MASK         0x1C00UL
    #define CLK_STC_SYC_STC0         0x0000UL   //STC0 select for AV
#define CKG_TSP_STAMP      0x16ACUL  //0x2B
    #define CLK_SYN_STC0_MASK        0x0007UL
    #define CLK_SYN_STC0_432M        0x0001UL
    #define CLK_SYN_STC1_MASK        0x0070UL
    #define CLK_SYN_STC1_432M        0x0010UL
    #define CLK_STAM_DISABLE         0x0100UL
    #define CLK_STAM_INVERT          0x0200UL
    #define CLK_STAM_CLK_MASK        0x0C00UL
#define CKG_TSP_STC1       0x16B0UL  //0x2C
    #define CLK_STC1_DISABLE         0x0001UL
    #define CLK_STC1_INVERT          0x0002UL
    #define CLK_STC1_SYN_STC1        0x0004UL  //STC1 select for AV
    #define CLK_STC1_CLK_MASK        0x001CUL
    #define CLK_SYN_STC2_MASK        0x0700UL
    #define CLK_SYN_STC2_432M        0x0100UL
    #define CLK_SYN_STC3_MASK        0x7000UL
    #define CLK_SYN_STC3_432M        0x1000UL
...
#define CKG_TSP_STC_PVR2_FIQ0   0x16BCUL  //0x2F
    ...
    #define CLK_STC_FIQ0_DISABLE      0x0100UL
    #define CLK_STC_FIQ0_INVERT       0x0200UL
    #define CLK_STC_FIQ0_MASK         0x1C00UL
    #define CLK_STC_FIQ0_27M          0x1C00UL
#define CKG2_TSP_TSFI      0x1434UL  //0x0D    //0x100A bank
    #define CKG2_TSP_TSFI_DISABKE    0x0100UL
    #define CKG2_TSP_TSFI_INVERT     0x0200UL
    #define CKG2_TSP_TSFI_CLK_MASK   0x1C00UL
#define CKG2_TSO1_IN       0x1440    //0x10
    #define CKG2_TSO1_IN_DIABLE      0x0001UL
    #define CKG2_TSO1_IN_INVERT      0x0002UL
    #define CKG2_TSO1_IN_CLK_MASK    0x001CUL
    #define CKG2_TSO2_IN_DIABLE      0x0100UL
    #define CKG2_TSO2_IN_INVERT      0x0200UL
    #define CKG2_TSO2_IN_CLK_MASK    0x1C00UL
#define CKG2_TS4_TS5       0x1460    //0x18
    #define CKG2_TS4_DISABLE         0x0001UL
    #define CKG2_TS4_INVERT          0x0002UL
    #define CKG2_TS4_MASK            0x001CUL
    #define CKG2_TS5_DISABLE         0x0100UL
    #define CKG2_TS5_INVERT          0x0200UL
    #define CKG2_TS5_MASK            0x1C00UL
#define CKG2_TSP_TS_SAMPLE 0x1464UL  //0x19
    ...
    #define CKG2_TSP_TS_MMT_DISABLE          0x0100UL
    #define CKG2_TSP_TS_MMT_INVERT           0x0200UL
    #define CKG2_TSP_TS_MMT_MASK             0x1C00UL
#define CHIP_TSP_BOOT_CLK_SEL   0x3D68UL //0x5A
    #define CHIP_TSP_BOOT_CLK_SEL_MASK  0x0020UL
...
void HAL_TSP_SetPVRTimeStampClk(MS_U8 u8PVRId, MS_U32 u32ClkSrc)
{
    ...
    switch (u8PVRId)
    {
        ...
        case 1:
            ...
            u32RegClkSrc = CKG_TSP_STC_PVR2_FIQ0;
...
void HAL_TSP_PowerCtrl(MS_BOOL bOn)
{
    ...
    if (bOn)
    {
        ...
        // Enable TS2 clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TS2_TSGP),
            RESET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TS2_TSGP)), (CLK_TS2_DISABLE|CLK_TS2_INVERT|CLK_TS2_CLK_MASK)));
        ...
        // Enable TSFI clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG2_TSP_TSFI),
            RESET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG2_TSP_TSFI)), (CKG2_TSP_TSFI_DISABKE|CKG2_TSP_TSFI_INVERT|CKG2_TSP_TSFI_CLK_MASK)));

        // Enable TS4 clock, s2p0 clock
        s32ClkHandle = Drv_Clkm_Get_Handle("g_clk_ts4");
        Drv_Clkm_Set_Clk_Source(s32ClkHandle , "CLK_TS4_PAD0");

        //Enable TS5 clock, s2p1 clock
        s32ClkHandle = Drv_Clkm_Get_Handle("g_clk_ts5");
        Drv_Clkm_Set_Clk_Source(s32ClkHandle , "CLK_TS5_PAD0");

        // Set SYN_STC to be 216MHz
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STAMP),
            ( _HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STAMP)) & ~CLK_SYN_STC0_MASK));
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STAMP),
            ( _HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STAMP)) & ~CLK_SYN_STC1_MASK));
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STC1),
            ( _HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STC1)) & ~CLK_SYN_STC2_MASK));
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STC1),
            ( _HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STC1)) & ~CLK_SYN_STC3_MASK));
        ...
        // Enable STC1 clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STC1),
                (_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STC1)) & ~(CLK_STC1_DISABLE|CLK_STC1_INVERT|CLK_STC1_CLK_MASK)) | CLK_STC1_SYN_STC1);
        ...
        // Enable Sample & MMT clock
        s32ClkHandle = Drv_Clkm_Get_Handle("g_clk_ts_mmt");
        Drv_Clkm_Set_Clk_Source(s32ClkHandle , "CLK_TSMMT_PAD0");
        ...
        // Enable STC_PVR2 & STC_FIQ0 clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STC_PVR2_FIQ0),
                (_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STC_PVR2_FIQ0)) & ~(CLK_STC_PVR2_DISABLE|CLK_STC_PVR2_INVERT|CLK_STC_PVR2_MASK))|CLK_STC_PVR2_27M);
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STC_PVR2_FIQ0),
                (_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STC_PVR2_FIQ0)) & ~(CLK_STC_FIQ0_DISABLE|CLK_STC_FIQ0_INVERT|CLK_STC_FIQ0_MASK))|CLK_STC_FIQ0_27M);
    }
    else
    {
        // Disable TSP clock
        ...
        // Disable TS2 clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TS2_TSGP), SET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TS2_TSGP)), CLK_TS2_DISABLE));

        // Disable TSFI clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG2_TSP_TSFI), SET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG2_TSP_TSFI)), CKG2_TSP_TSFI_DISABKE));
        ...
        // Disable STC1 clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STC1), SET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STC1)), CLK_STC1_DISABLE));
        ...
        // Disable STC_PVR2 & STC_FIQ0 clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STC_PVR2_FIQ0),
            SET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STC_PVR2_FIQ0)), (CLK_STC_PVR2_DISABLE|CLK_STC_FIQ0_DISABLE)));

        //Reset PE Pad
        if(_bTsPadUsed[0] == TRUE)
        {
            TSP_TOP_REG(REG_TOP_TS0_PE) = (TSP_TOP_REG(REG_TOP_TS0_PE) & ~REG_TOP_TS0_PE_MASK) | _u16TsPadPE[0];
            _bTsPadUsed[0] = FALSE;
        }
        if(_bTsPadUsed[1] == TRUE)
        {
            TSP_TOP_REG(REG_TOP_TS1_PE) = (TSP_TOP_REG(REG_TOP_TS1_PE) & ~REG_TOP_TS1_PE_MASK) | _u16TsPadPE[1];
            _bTsPadUsed[1] = FALSE;
        }
        if(_bTsPadUsed[2] == TRUE)
        {
            TSP_TOP_REG(REG_TOP_TS2_PE) = (TSP_TOP_REG(REG_TOP_TS2_PE) & ~REG_TOP_TS2_PE_MASK) | _u16TsPadPE[2];
            _bTsPadUsed[2] = FALSE;
        }
        if(_bTsPadUsed[3] == TRUE)
        {
            TSP_TOP_REG(REG_TOP_TS3_PE) = (TSP_TOP_REG(REG_TOP_TS3_PE) & ~REG_TOP_TS3_PE_MASK) | _u16TsPadPE[3];
            _bTsPadUsed[3] = FALSE;
        }
    }
}
...
void HAL_TSP_PowerCtrl(MS_BOOL bOn)
{
    if (bOn)
    {
        ...
        // Enable CLK_PARSER clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG_TSP_STC0),
                (_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG_TSP_STC0)) & ~(CLK_PAR_DISABLE|CLK_PAR_INVERT|CLK_PAR_CLK_MASK)) | CLK_PAR_CLK_192M); //parser clock 192M
        ...
        // Enable TS4 clock, s2p0 clock
        //_HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG2_TS4_TS5),
        //    RESET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG2_TS4_TS5)), (CKG2_TS4_DISABLE|CKG2_TS4_INVERT|CKG2_TS4_MASK)));

        //Enable TS5 clock, s2p1 clock
        //_HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG2_TS4_TS5),
        //    RESET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG2_TS4_TS5)), (CKG2_TS5_DISABLE|CKG2_TS5_INVERT|CKG2_TS5_MASK)));
        ...
        // Enable Sample & MMT clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG2_TSP_TS_SAMPLE),
            RESET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG2_TSP_TS_SAMPLE)),
            (CKG2_TSP_TS_SAMPLE_DISABLE|CKG2_TSP_TS_SAMPLE_INVERT|CKG2_TSP_TS_SAMPLE_CLK_MASK|CKG2_TSP_TS_MMT_DISABLE|CKG2_TSP_TS_MMT_INVERT|CKG2_TSP_TS_MMT_MASK)));
    ...
    else
    {
        ...
        // Disable TS4 clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG2_TS4_TS5), SET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG2_TS4_TS5)), CKG2_TS4_DISABLE));

        // Disable TS5 clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG2_TS4_TS5), SET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG2_TS4_TS5)), CKG2_TS5_DISABLE));
        ...
        // Disable Sample & MMT clock
        _HAL_REG32L_W((REG32_L *)(_virtRegBase+CKG2_TSP_TS_SAMPLE), SET_FLAG1(_HAL_REG32L_R((REG32_L *)(_virtRegBase+CKG2_TSP_TS_SAMPLE)), (CKG2_TSP_TS_SAMPLE_DISABLE|CKG2_TSP_TS_MMT_DISABLE)));
...
#undef CKG_TSO_SRC
    #undef CKG_TSO_TRACE_DISABLE
    #undef CKG_TSO_TRACE_INVERT
    #undef CKG_TSO_TRACE_CLK_MASK
    #undef CKG_TSO0_IN_DIABLE
    #undef CKG_TSO0_IN_INVERT
    #undef CKG_TSO0_IN_CLK_MASK
#undef CKG_TS0_TS1
...
#undef CKG_TSP_STAMP
    ...
    #undef CLK_SYN_STC1_MASK
    #undef CLK_SYN_STC1_432M
...
#undef CKG_TSP_STC1
    ...
    #undef CLK_SYN_STC2_MASK
    #undef CLK_SYN_STC2_432M
    #undef CLK_SYN_STC3_MASK
    #undef CLK_SYN_STC3_432M
...
#undef CKG_TSP_STC_PVR2_FIQ0
    #undef CLK_STC_PVR2_DISABLE
    #undef CLK_STC_PVR2_INVERT
    #undef CLK_STC_PVR2_MASK
    #undef CLK_STC_PVR2_27M
    #undef CLK_STC_FIQ0_DISABLE
    #undef CLK_STC_FIQ0_INVERT
    #undef CLK_STC_FIQ0_MASK
    #undef CLK_STC_FIQ0_27M
#undef CKG2_TSP_TSFI
    #undef CKG2_TSP_TSFI_DISABKE
    #undef CKG2_TSP_TSFI_INVERT
    #undef CKG2_TSP_TSFI_CLK_MASK
#undef CKG2_TSO1_IN
    #undef CKG2_TSO1_IN_DIABLE
    #undef CKG2_TSO1_IN_INVERT
    #undef CKG2_TSO1_IN_CLK_MASK
    #undef CKG2_TSO2_IN_DIABLE
    #undef CKG2_TSO2_IN_INVERT
    #undef CKG2_TSO2_IN_CLK_MASK
#undef CKG2_TS4_TS5
    #undef CKG2_TS4_DISABLE
    #undef CKG2_TS4_INVERT
    #undef CKG2_TS4_MASK
    #undef CKG2_TS5_DISABLE
    #undef CKG2_TS5_INVERT
    #undef CKG2_TS5_MASK
#undef CKG2_TSP_TS_SAMPLE
    #undef CKG2_TSP_TS_SAMPLE_DISABLE
    #undef CKG2_TSP_TS_SAMPLE_INVERT
    #undef CKG2_TSP_TS_SAMPLE_CLK_MASK
    #undef CKG2_TSP_TS_MMT_DISABLE
    #undef CKG2_TSP_TS_MMT_INVERT
    #undef CKG2_TSP_TS_MMT_MASK
...
MS_BOOL HAL_TSP_CMD_Run(MS_U32 u32Cmd, MS_U32 u32Config0, MS_U32 u32Config1, MS_U32* pData)
{
    ...
    switch (u32Cmd)
    {
        ...
        case HAL_CMD_SET_LIB_MODE:
            ...
            break;
        case HAL_CMD_PVR_PES_MODE:
            bPesMode = (MS_BOOL)(*pData);
            HAL_TSP_PVR_BypassHeader_En(u32Config0, !bPesMode);
            break;
        default:
            return FALSE;
    }
...
MS_BOOL HAL_FQ_SetMuxSwitch(MS_U32 u32FQEng, MS_U32 u32FQSrc)
{
    ...
    {
        case 0:
            u16Src = FIQ_MUX_CFG_TS0;
            break;
        case 1:
            u16Src = FIQ_MUX_CFG_TS1;
            break;
        case 2:
            u16Src = FIQ_MUX_CFG_TS2;
            break;
        case 7:
            u16Src = FIQ_MUX_CFG_FILE;
            break;
        default:
            return FALSE;
    }
    ...
    _HAL_REG16_W(&(_TspCtrl5[0].FIQ_MUX_CFG), (_HAL_REG16_R(&(_TspCtrl5[0].FIQ_MUX_CFG)) & (~FIQ_MUX_CFG_MASK)) | u16Src);
...
MS_U32 HAL_FQ_GetMuxSwitch(MS_U32 u32FQEng)
{
    ...
    u16Src = _HAL_REG16_R(&(_TspCtrl5[0].FIQ_MUX_CFG));

    switch(u16Src)
    {
        case FIQ_MUX_CFG_TS0:
            u32Ret = 0;
            break;
        case FIQ_MUX_CFG_TS1:
            u32Ret = 1;
            break;
        case FIQ_MUX_CFG_TS2:
            u32Ret = 2;
            break;
        case FIQ_MUX_CFG_FILE:
            u32Ret = 7;
            break;
        default:
            u32Ret = 0xFF;
...
MS_BOOL HAL_TSP_SaveRegs(void)
{
    ...
    _u16ChipRegArray[0x05] = TSP_TOP_REG(0x05);
    _u16ChipRegArray[0x06] = TSP_TOP_REG(0x06);
    _u16ChipRegArray[0x0e] = TSP_TOP_REG(0x0e);
    //_u16ChipRegArray[0x10] = TSP_TOP_REG(0x10);
    //_u16ChipRegArray[0x11] = TSP_TOP_REG(0x11);
    //_u16ChipRegArray[0x13] = TSP_TOP_REG(0x13);
    //_u16ChipRegArray[0x14] = TSP_TOP_REG(0x14);
    _u16ChipRegArray[0x36] = TSP_TOP_REG(0x36);
    _u16ChipRegArray[0x37] = TSP_TOP_REG(0x37);
    _u16ChipRegArray[0x40] = TSP_TOP_REG(0x40);
    _u16ChipRegArray[0x57] = TSP_TOP_REG(0x57);
    _u16ChipRegArray[0x5a] = TSP_TOP_REG(0x5a);
    _u16ChipRegArray[0x67] = TSP_TOP_REG(0x67);

    for(u32ii = 0x27; u32ii <= 0x2b; u32ii++)
    {
        _u16ClkgenRegArray[u32ii] = TSP_CLKGEN0_REG(u32ii);
    }
    _u16ClkgenRegArray[0x7c] = TSP_CLKGEN0_REG(0x7c);
    _u16ClkgenRegArray[0x7d] = TSP_CLKGEN0_REG(0x7d);
    _u16ClkgenRegArray[0x7e] = TSP_CLKGEN0_REG(0x7e);

    _u16Clkgen2RegArray[0x0d] = TSP_CLKGEN2_REG(0x0d);
    _u16Clkgen2RegArray[0x10] = TSP_CLKGEN2_REG(0x10);
    _u16Clkgen2RegArray[0x11] = TSP_CLKGEN2_REG(0x11);
    _u16Clkgen2RegArray[0x18] = TSP_CLKGEN2_REG(0x18);
    _u16Clkgen2RegArray[0x19] = TSP_CLKGEN2_REG(0x19);
...
MS_BOOL HAL_TSP_RestoreRegs(void)
{
    ...
    TSP_TOP_REG(0x05) = _u16ChipRegArray[0x05];
    TSP_TOP_REG(0x06) = _u16ChipRegArray[0x06];
    TSP_TOP_REG(0x0e) = _u16ChipRegArray[0x0e];
    //TSP_TOP_REG(0x10) = _u16ChipRegArray[0x10];
    //TSP_TOP_REG(0x11) = _u16ChipRegArray[0x11];
    //TSP_TOP_REG(0x13) = _u16ChipRegArray[0x13];
    //TSP_TOP_REG(0x14) = _u16ChipRegArray[0x14];
    TSP_TOP_REG(0x36) = _u16ChipRegArray[0x36];
    TSP_TOP_REG(0x37) = _u16ChipRegArray[0x37];
    TSP_TOP_REG(0x40) = _u16ChipRegArray[0x40];
    TSP_TOP_REG(0x57) = _u16ChipRegArray[0x57];
    TSP_TOP_REG(0x5a) = _u16ChipRegArray[0x5a];
    TSP_TOP_REG(0x67) = _u16ChipRegArray[0x67];

    for(u32ii = 0x27; u32ii <= 0x2b; u32ii++)
    {
        TSP_CLKGEN0_REG(u32ii) = _u16ClkgenRegArray[u32ii];
    }
    TSP_CLKGEN0_REG(0x7c) = _u16ClkgenRegArray[0x7c];
    TSP_CLKGEN0_REG(0x7d) = _u16ClkgenRegArray[0x7d];
    TSP_CLKGEN0_REG(0x7e) = _u16ClkgenRegArray[0x7e];

    TSP_CLKGEN2_REG(0x0d) = _u16Clkgen2RegArray[0x0d];
    TSP_CLKGEN2_REG(0x10) = _u16Clkgen2RegArray[0x10];
    TSP_CLKGEN2_REG(0x11) = _u16Clkgen2RegArray[0x11];
    TSP_CLKGEN2_REG(0x18) = _u16Clkgen2RegArray[0x18];
    TSP_CLKGEN2_REG(0x19) = _u16Clkgen2RegArray[0x19];
