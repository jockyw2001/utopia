...
#define TSP_PIDFLT_EXT_NUM              16UL
...
#define TSP_TS_PAD_NUM                  6UL  // 4P+2S or 5P
#define TSP_VQ_NUM                      4UL  //VQ0, VQ_file, VQ1, VQ_2
#define TSP_VQ_PITCH                    208UL
#define TSP_CA_ENGINE_NUM               4UL
#define TSP_CA_KEY_NUM                  8UL
#define TSP_CA0_FLT_NUM                 144UL
#define TSP_CA1_FLT_NUM                 144UL
#define TSP_CA_FLT_NUM                  144UL
...
#define DSCMB3_FLT_START_ID             64UL
#define DSCMB3_FLT_END_ID               95UL
#define DSCMB3_FLT_NUM                  16UL

#define DSCMB_FLT_SHAREKEY_START_ID     96UL
#define DSCMB_FLT_SHAREKEY_END_ID       143UL
#define DSCMB_FLT_SHAREKEY_NUM          144UL

#define DSCMB_FLT_SHAREKEY1_START_ID    96UL
#define DSCMB_FLT_SHAREKEY1_END_ID      143UL
#define DSCMB_FLT_SHAREKEY1_NUM         144UL

#define DSCMB_FLT_SHAREKEY2_START_ID    96UL
#define DSCMB_FLT_SHAREKEY2_END_ID      143UL
#define DSCMB_FLT_SHAREKEY2_NUM         144UL
...
#define STC_SYNTH_DEFAULT               0x14000000UL
...
#define TSP_PIDFLT_RUSH_PASS            0x00100000UL
...
typedef struct _REG_Ctrl
{
    ...
    #define TSP_REMOVE_DUP_AV_PKT (TSP_REMOVE_DUP_VIDEO_PKT   | \
                                   ...
                                   TSP_REMOVE_DUP_AUDIOC_PKT  | \
                                   TSP_REMOVE_DUP_AUDIOD_PKT)
    ...
    #define TSP_APES_C_ERR_RM_EN                    0x00000100UL
    #define TSP_APES_D_ERR_RM_EN                    0x00000200UL
    #define TSP_BLK_AF_SCRMB_BIT                    0x00000400UL
    #define TSP_PKTSIZE_FI_MASK                     0x00FF0000UL
    #define TSP_PKTSIZE_FI_SHIFT                    16
    ...
    #define TSP_DISCONTI_AUDC_CLR                   0x00800000UL  //Set 1 to clear videoC discontinuity count
    #define TSP_DISCONTI_AUDD_CLR                   0x01000000UL  //Set 1 to clear videoD discontinuity count
    ...
    #define TSP_CA0_OUTPUT_CA2                      0x00004000UL

    #define TSP_CA1_CTRL_MASK                       0x77308000UL
    #define TSP_CA1_OUTPUT_CA2                      0x00008000UL
    ...
    #define TSP_DMA_FLUSH_EN                        0x00000080UL //PVR1, PVR2 dma flush
    ...
    #define TSP_REC_NULL                            0x00040000UL
...
typedef struct _REG_Ctrl5
{
    ...
    #define TS_MUX_CFG_S2P1_MUX_MASK                    0x00F0UL
    #define TS_MUX_CFG_S2P0_MUX_SHIFT                   0
    #define TS_MUX_CFG_S2P1_MUX_SHIFT                   4
