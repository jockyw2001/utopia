...
#define HVD_HW_MAX_PIXEL            (4096*2304*31000ULL) // 4kx2k@30p
...
#if SUPPORT_EVD
    pHVDHalContext->u32EVDClockType = 480;
#endif
#if SUPPORT_G2VP9 && defined(VDEC3)
...
#endif
{
    ...
    //Chip info
    pShm->u16ChipID = E_MSTAR_CHIP_MASERATI;
...
#else // (!defined(MSOS_TYPE_NUTTX) && !defined(MSOS_TYPE_OPTEE)) || defined(SUPPORT_X_MODEL_FEATURE)
