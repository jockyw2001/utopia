...
#define VSYNC_BRIGE_EXT_SHM_OFFSET  0x20000
#define FW_SHM_OFFSET               0x100000
...
#define VSYNC_BRIGE_EXT_SHM_START   (VSYNC_BRIGE_EXT_SHM_OFFSET+OFFSET_BASE)
...
#define INTERFACE_VERSION        0x00000365 //add information for RealFrameRate.Profile.Level.DispWH
...
typedef struct _FW_FRAME_INFO
{
    ...
    unsigned char           seq_found;                  //268
    unsigned char           reserve_3[3];               //269
    unsigned int            idle_count;                 //272
    unsigned int            u32PVRSeamlessTargetPTS;     //276
    unsigned char           u8PVRSeamlessTargetPTSHigh; //280
    unsigned char           u8PVRSeamlessTargetFrameType; //284
...
#define OFFSET_SEQ_FOUND                   268
#define OFFSET_IDLE_COUNT                  272
#define OFFSET_PVRSEAMLESSTARGETPTS        276
#define OFFSET_PVRSEAMLESSTARGETPTSHIGH    280
#define OFFSET_PVRSEAMLESSTARGETFRAMETYPE  284
...
#define VCOMMANDQ_INFO            (DISP_QUEUE+0x1000)
#define VDISP_COMMANDQ            (VCOMMANDQ_INFO+0x1000)  // 2k bytes
#define VNORMAL_COMMANDQ          (VDISP_COMMANDQ+0x1000)  // 2k bytes
...
#define CMD_AUTO_DROP_FRAME_IN_DECODE  0xBF
#define CMD_DISABLE_PATCH_PBFRAME      0xC0
#define CMD_DYNAMIC_MVOP_CONNECT       0xC1
#define CMD_SLOW_SYNC_REPEAT           0xC2
#define CMD_SLOW_SYNC_SKIP             0xC3
#define CMD_VARIABLE_FRAMERATE         0xC4
#define CMD_DYNAMIC_SCALE_SIZE         0xC5
