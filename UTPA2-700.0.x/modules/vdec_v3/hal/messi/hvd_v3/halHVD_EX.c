...
#define HVD_HVD_RW_ON_MIU0              ((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(2)) == 0)
...
RESET:
    ...
    if (isEVD)
    {
        ...
        // This is for Messi using 256 bits bbu.
...
#endif
{
    ...
    //Chip info
    pShm->u16ChipID = E_MSTAR_CHIP_MESSI;
