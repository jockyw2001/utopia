...
#define _MaskMiu2Req_MVD_RW_0( m )      _HVD_WriteRegBit(MIU2_REG_RQ2_MASK, m, BIT(4))
#define _MaskMiu2Req_MVD_RW_1( m )      _HVD_WriteRegBit(MIU2_REG_RQ4_MASK, m, BIT(6))
#define _MaskMiu2Req_MVD_BBU_R( m )     _HVD_WriteRegBit(MIU2_REG_RQ0_MASK+1, m, BIT(4))
#define _MaskMiu2Req_HVD_RW_MIF0( m )   _HVD_WriteRegBit(MIU2_REG_RQ4_MASK, m, BIT(2))
#define _MaskMiu2Req_HVD_RW_MIF1( m )   _HVD_WriteRegBit(MIU2_REG_RQ4_MASK, m, BIT(3))
#define _MaskMiu2Req_HVD_BBU_R( m )     _HVD_WriteRegBit(MIU2_REG_RQ4_MASK, m, BIT(0))


#define HVD_MVD_RW_0_ON_MIU0            (((_HVD_Read2Byte(MIU0_REG_SEL2) & BIT(4)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL2) & BIT(4)) == 0))
#define HVD_MVD_RW_1_ON_MIU0            (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(6)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(6)) == 0))
#define HVD_MVD_BBU_R_ON_MIU0           (((_HVD_Read2Byte(MIU0_REG_SEL0) & BIT(12)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL0) & BIT(12)) == 0))
#define HVD_HVD_RW_MIF0_ON_MIU0         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(2)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(2)) == 0))
#define HVD_HVD_RW_MIF1_ON_MIU0         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(3)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(3)) == 0))
#define HVD_HVD_BBU_R_ON_MIU0           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(0)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(0)) == 0))

#define HVD_MVD_RW_0_ON_MIU1            (((_HVD_Read2Byte(MIU0_REG_SEL2) & BIT(4)) == BIT(4)) && ((_HVD_Read2Byte(MIU2_REG_SEL2) & BIT(4)) == 0))
#define HVD_MVD_RW_1_ON_MIU1            (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(6)) == BIT(6)) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(6)) == 0))
#define HVD_MVD_BBU_R_ON_MIU1           (((_HVD_Read2Byte(MIU0_REG_SEL0) & BIT(12)) == BIT(12)) && ((_HVD_Read2Byte(MIU2_REG_SEL0) & BIT(12)) == 0))
#define HVD_HVD_RW_MIF0_ON_MIU1         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(2)) == BIT(2)) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(2)) == 0))
#define HVD_HVD_RW_MIF1_ON_MIU1         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(3)) == BIT(3)) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(3)) == 0))
#define HVD_HVD_BBU_R_ON_MIU1           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(0)) == BIT(0)) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(0)) == 0))

#define HVD_MVD_RW_0_ON_MIU2            (((_HVD_Read2Byte(MIU0_REG_SEL2) & BIT(4)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL2) & BIT(4)) == BIT(4)))
#define HVD_MVD_RW_1_ON_MIU2            (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(6)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(6)) == BIT(6)))
#define HVD_MVD_BBU_R_ON_MIU2           (((_HVD_Read2Byte(MIU0_REG_SEL0) & BIT(12)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL0) & BIT(12)) == BIT(12)))
#define HVD_HVD_RW_MIF0_ON_MIU2         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(2)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(2)) == BIT(2)))
#define HVD_HVD_RW_MIF1_ON_MIU2         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(3)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(3)) == BIT(3)))
#define HVD_HVD_BBU_R_ON_MIU2           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(0)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(0)) == BIT(0)))


#if SUPPORT_EVD
#define _MaskMiuReq_EVD_RW( m )         _HVD_WriteRegBit(MIU0_REG_RQ4_MASK, m, BIT(7))
#define _MaskMiuReq_EVD_BBU_R( m )      _HVD_WriteRegBit(MIU0_REG_RQ4_MASK, m, BIT(7))
#define _MaskMiu1Req_EVD_RW( m )         _HVD_WriteRegBit(MIU1_REG_RQ4_MASK, m, BIT(7))
#define _MaskMiu1Req_EVD_BBU_R( m )      _HVD_WriteRegBit(MIU1_REG_RQ4_MASK, m, BIT(7))
#define _MaskMiu2Req_EVD_RW( m )         _HVD_WriteRegBit(MIU2_REG_RQ4_MASK, m, BIT(7))
#define _MaskMiu2Req_EVD_BBU_R( m )      _HVD_WriteRegBit(MIU2_REG_RQ4_MASK, m, BIT(7))




#define HVD_EVD_RW_ON_MIU0              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == 0))
#define HVD_EVD_BBU_R_ON_MIU0           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == 0))
#define HVD_EVD_RW_ON_MIU1              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == BIT(7)) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == 0))
#define HVD_EVD_BBU_R_ON_MIU1           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == BIT(7)) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == 0))
#define HVD_EVD_RW_ON_MIU2              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == BIT(7)))
#define HVD_EVD_BBU_R_ON_MIU2           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == BIT(7)))
#endif
...
static MS_BOOL _HAL_EX_BBU_EVD_InUsed(void)
{
    ...
    for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
    {
        if (pHVDHalContext->_stHVDStream[i].bUsed &&
           ...
           || (pHVDHalContext->_stHVDStream[i].u32CodecType == E_HAL_HVD_HEVC_DV)
#if SUPPORT_MSVP9
...
//    MS_U32 u32TmpStartOffset;
         ...
         (E_HVD_INIT_INPUT_TSP == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_INPUT_MASK))))
    {
        ...
        #endif
        else                        // AVS or AVC or HEVC or HEVC_DV
        {
            ...
            if (u16QNum > (u16UsedFrm + u16ResvFrmNum))
            {
                ...
                if (pHvdFrm->u32Status == E_HVD_DISPQ_STATUS_INIT) // Must Be
                {
                    ...
                    else
                    {
                        ...
                        volatile HVD_Frm_Information *pHvdFrmPrv = (volatile HVD_Frm_Information*)&pShm->DispQueue[u16QPtr - 1]; // must be odd
                        ...
                        if(bDolbyVision)
                        {
                            ...
                            HVD_PRINT("[md5]%02d=%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x %02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x", (unsigned int)pFrmInfoExt->u8CurrentIndex, arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7], arr[8], arr[9], arr[10], arr[11], arr[12], arr[13], arr[14], arr[15], arr[16], arr[17], arr[18], arr[19], arr[20], arr[21], arr[22], arr[23], arr[24], arr[25], arr[26], arr[27], arr[28], arr[29], arr[30], arr[31]);
#endif
                            if(DIFF(pHvdFrmPrv->u32TimeStamp, pHvdFrm->u32TimeStamp) > 1000)
        ...
        while (u16QNum != 0)
        {
            ...
            if (pHvdFrm->u32Status == E_HVD_DISPQ_STATUS_INIT) // Must Be
            {
                if (!first_field) // second get frame, we will check at least one paired in disp queue.
                {
                    ...
                    if(pHvdFrm->u8FieldType == 1 || pHvdFrm->u8FieldType == 9 || pHvdFrm->u8FieldType == 11)
                ...
                else // first get frame, we will check at least one paired in disp queue.
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (pHvdFrm->u8FieldType == 9)
                                pHvdFrm_first->u8FieldType = 12;
                            else if (pHvdFrm->u8FieldType == 10)
                                pHvdFrm_first->u8FieldType = 11;
                            else if (pHvdFrm->u8FieldType == 10)
                                pHvdFrm_first->u8FieldType = 11;
                            else if (pHvdFrm->u8FieldType == 1)
                                pHvdFrm_first->u8FieldType = 2;
                            else if (pHvdFrm->u8FieldType == 2)
                        ...
                        else if (pHvdFrm_first->u8FieldType == 9 || pHvdFrm_first->u8FieldType == 10)
                        {
                            if (pHvdFrm_first->u8FieldType == 9 && pHvdFrm->u8FieldType == 12)
                            {
                                pHvdFrm_first->u32ID_L |= (1 << 16);
                                pHvdFrm->u32ID_L |= (1 << 16);
                            }
                            else if (pHvdFrm_first->u8FieldType == 10 && pHvdFrm->u8FieldType == 11)
                            {
                                pHvdFrm_first->u32ID_L &= (~(1 << 16));
                                pHvdFrm->u32ID_L &= (~(1 << 16));
                            }
                        ...
                        if (pHvdFrm_first->u8FieldType == 1 || pHvdFrm_first->u8FieldType == 9 || pHvdFrm_first->u8FieldType == 11)
...
#endif
{
    ...
    //Chip info
    pShm->u16ChipID = E_MSTAR_CHIP_MACAN;
    ...
    if (pHVDHalContext->pHVDPreCtrl_Hal[_HVD_EX_GetStreamIdx(u32Id)]->bCalFrameRate)
    {
...
void HAL_EVD_EX_PowerCtrl(MS_BOOL bEnable)
{
    ...
    switch (pHVDHalContext->u32EVDClockType)
    {
        case 576:
        {
            ...
            _HVD_WriteWordMask(REG_EVDPLL_LOOP_DIV_SECOND, REG_EVDPLL_LOOP_DIV_SECOND_576MHZ, REG_EVDPLL_LOOP_DIV_SECOND_MASK);
            break;
        }
        case 480:
        {
        ...
        {
            _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU, TOP_CKG_EVD_PPU_480MHZ, TOP_CKG_EVD_PPU_MASK);
            _HVD_WriteWordMask(REG_TOP_CKG_EVD, TOP_CKG_EVD_PPU_480MHZ, TOP_CKG_EVD_MASK);
            break;
        }
    }
