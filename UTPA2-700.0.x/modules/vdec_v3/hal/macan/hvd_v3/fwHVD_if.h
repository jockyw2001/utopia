...
//  Hardware Capability
//-------------------------------------------------------------------------------------------------
#define HVD_FW_VERSION 0x00001500
#define HVD_FW_IF_VERSION 0x00790200
...
// For Git Changes
#define GIT_TIMESTAMP 1482111806
...
typedef enum
{
    ...
    E_HVD_PP_FD_DONE = BIT(0) ,            ///< Field Detector: process done? (0: not done; 1: done)
    E_HVD_PP_FD_NEED_REVERSE = BIT(1) ,    ///< Field Detector: need reverse? (0: no need; 1: need)
...
typedef struct
{
    ...
    MS_U8  bAVCFastFlush;              //0x0E94
    MS_U8  reserved8_8[3];            //0x0E95
    MS_U8  reserved8_9[0xF9C-0x0E98];   //0x0E98
