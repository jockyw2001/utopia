...
#define REG_EVDPLL_LOOP_DIV_SECOND                (REG_EVDPLL_BASE+(0x0043<<1))
    ...
    #define REG_EVDPLL_LOOP_DIV_SECOND_576MHZ     BITS(7:0, 0x18)
...
#define REG_TOP_CKG_EVD_PPU             (CLKGEN0_REG_BASE+(0x0033<<1))
    ...
    #define TOP_CKG_EVD_PPU_MIU128PLL           BITS(13:10, 1) //300 MHz
    #define TOP_CKG_EVD_PPU_MIU256PLL           BITS(13:10, 2) //600 MHz
