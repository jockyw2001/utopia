...
#define REG_TOP_HVD_IDB         (CLKGEN0_REG_BASE+(0x0030<<1))
    ...
    #define TOP_CKG_HVD_IDB_320MHZ            BITS(10:8, 0)  // default use this
    #define TOP_CKG_HVD_IDB_384MHZ            BITS(10:8, 1)
    #define TOP_CKG_HVD_IDB_345MHZ            BITS(10:8, 2)
    #define TOP_CKG_HVD_IDB_480MHZ            BITS(10:8, 3)
    #define TOP_CKG_HVD_IDB_432MHZ            BITS(10:8, 4)
...
#define REG_TOP_HVD             (CLKGEN0_REG_BASE+(0x0031<<1))
    ...
    #define TOP_CKG_HVD_384MHZ                BITS(4:2, 0)
    #define TOP_CKG_HVD_345MHZ                BITS(4:2, 1)
    #define TOP_CKG_HVD_320MHZ                BITS(4:2, 2)
    #define TOP_CKG_HVD_240MHZ                BITS(4:2, 3)  // default use this
    #define TOP_CKG_HVD_216MHZ                BITS(4:2, 4)
    #define TOP_CKG_HVD_288MHZ                BITS(4:2, 5)
    #define TOP_CKG_HVD_172MHZ                BITS(4:2, 6)
    #define TOP_CKG_HVD_432MHZ                BITS(4:2, 7)
...
#define REG_TOP_VP8             (CLKGEN0_REG_BASE+(0x0031<<1))
    ...
    #define TOP_CKG_VP8_240MHZ                BITS(11:10, 1)  // default use this
    #define TOP_CKG_VP8_288MHZ                BITS(11:10, 2)
...
#define REG_TOP_HVD_AEC         (CLKGEN0_REG_BASE+(0x0034<<1))
    ...
    #define TOP_CKG_HVD_AEC_216MHZ                BITS(3:2, 0)
    #define TOP_CKG_HVD_AEC_240MHZ                BITS(3:2, 1) //default use this
    #define TOP_CKG_HVD_AEC_288MHZ                BITS(3:2, 2)
