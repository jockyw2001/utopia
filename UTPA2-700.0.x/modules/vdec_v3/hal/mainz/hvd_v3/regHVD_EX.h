...
#define REG_TOP_HVD_IDB         (CLKGEN0_REG_BASE+(0x0030<<1))
    ...
    #define TOP_CKG_HVD_IDB_432MHZ            BITS(10:8, 0)
    ...
    #define TOP_CKG_HVD_IDB_320MHZ            BITS(10:8, 4)  // Mainz HVD5P, default use this
...
#define REG_TOP_HVD             (CLKGEN0_REG_BASE+(0x0031<<1))
    ...
    #define TOP_CKG_HVD_240MHZ                BITS(4:2, 4)  // Mainz HVD5P, default use this
...
#define REG_TOP_HVD_AEC         (CLKGEN0_REG_BASE+(0x0034<<1))
    ...
    #define TOP_CKG_HVD_AEC_CLK_FROM_HVD_AEC_P  BIT(4)  //no need to set; hw switch automatically
...
#define REG_TOP_MVD             (CLKGEN0_REG_BASE+(0x0039<<1))
    ...
    #define TOP_CKG_MVD_RESV                   BITS(4:2, 2)
...
#define REG_TOP_CKG_EVD_PPU             (CLKGEN0_REG_BASE+(0x0033<<1))
    ...
    #define TOP_CKG_EVD_PPU_PLL_BUF             BITS(13:10, 0)  //576
