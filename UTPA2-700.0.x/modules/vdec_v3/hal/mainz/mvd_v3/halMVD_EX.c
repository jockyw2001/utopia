...
#define MVDCPU_ON_MIU1     ((HAL_MVD_RegReadByte(MIU0_SEL0_L) & BIT5) == BIT5)  // Use EVDR2(d$/dma) MIU Client g05
#define MVDHW_ON_MIU1      ((HAL_MVD_RegReadByte(MIU0_SEL2_L) & BIT4) == BIT4)  // Use MVD           MIU Client g24
...
void HAL_MVD_SetReqMask(MS_BOOL bEnMask)
{
    ...
    if (MVDHW_ON_MIU1)
    {
        HAL_MVD_RegWriteBit(MIU1_RQ2_MASK_L, bEnMask, BIT4);  //MVD R/W     : g24
        HAL_MVD_RegWriteBit(MIU1_RQ0_MASK_H, bEnMask, BIT4);  //MVD bbu R/W : g0c
    }
    else
    {
        HAL_MVD_RegWriteBit(MIU0_RQ2_MASK_L, bEnMask, BIT4);  //MVD R/W     : g24
        HAL_MVD_RegWriteBit(MIU0_RQ0_MASK_H, bEnMask, BIT4);  //MVD bbu R/W : g0c
    }
    HAL_MVD_Delayms(1);
