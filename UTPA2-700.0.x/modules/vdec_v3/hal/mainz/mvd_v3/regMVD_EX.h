...
#define MVD_CRC_Y_START                         (MVD_REG_BASE + 0x28)   //CRC y start address[27:0]
    #define MVD_CRC_Y_START_LEN                 BMASK(27:0)
#define MVD_CRC_UV_START                        (MVD_REG_BASE + 0x2C)   //CRC uv start address[27:0]
    #define MVD_CRC_UV_START_LEN                BMASK(27:0)
...
#define REG_CKG_MVD             (REG_CHIPTOP_BASE + 0x39*2)
    ...
    #define CKG_MVD_160MHZ          (0 << 2)
    #define CKG_MVD_144MHZ          (1 << 2)
    #define CKG_MVD_RESERVED_MHZ    (2 << 2)
    #define CKG_MVD_108MHZ          (3 << 2)
    #define CKG_MVD_RESERVED2_MHZ   (4 << 2)    //clk_miu_p
    #define CKG_MVD_72MHZ           (5 << 2)
    //#define CKG_MVD_RESERVED3_MHZ   (6 << 2)    //mempll_clk_buf_div2
