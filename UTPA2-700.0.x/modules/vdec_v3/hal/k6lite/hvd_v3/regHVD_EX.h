...
#define REG_TOP_VPU             (CLKGEN0_REG_BASE+(0x0030<<1))
    ...
    #define TOP_CKG_VPU_240MHZ                BITS(6:2, 0)
    #define TOP_CKG_VPU_216MHZ                BITS(6:2, 1)
    #define TOP_CKG_VPU_192MHZ                BITS(6:2, 2)
    #define TOP_CKG_VPU_172MHZ                BITS(6:2, 3)
...
#define REG_TOP_HVD             (CLKGEN0_REG_BASE+(0x0034<<1))
    ...
    #define TOP_CKG_HVD_240MHZ                BITS(4:2, 0)  // default use this
    #define TOP_CKG_HVD_216MHZ                BITS(4:2, 1)
    #define TOP_CKG_HVD_192MHZ                BITS(4:2, 2)  // for overclocking
    #define TOP_CKG_HVD_172MHZ                BITS(4:2, 3)  // for overclocking
...
#define REG_TOP_MVD             (CLKGEN0_REG_BASE+(0x0039<<1))
    ...
    #define TOP_CKG_MVD_288MHZ                BITS(4:2, 0)
    #define TOP_CKG_MVD_216MHZ                BITS(4:2, 1)
...
#define REG_TOP_MVD2             (CLKGEN0_REG_BASE+(0x0039<<1))
    ...
    #define TOP_CKG_MVD2_172MHZ                BITS(11:10, 0)
    #define TOP_CKG_MVD2_192MHZ                BITS(11:10, 1)
...
#define REG_TOP_CKG_EVD_PPU         (CLKGEN2_REG_BASE+(0x001c<<1))
    ...
    #define TOP_CKG_EVD_PPU_240MHZ              BITS(4:2, 4)
    #define TOP_CKG_EVD_PPU_216MHZ              BITS(4:2, 5)
    #define TOP_CKG_EVD_PPU_192MHZ              BITS(4:2, 6)
    #define TOP_CKG_EVD_PPU_172MHZ              BITS(4:2, 7)
...
#define REG_TOP_CKG_EVD             (CLKGEN0_REG_BASE+(0x003d<<1))
    ...
    #define TOP_CKG_EVD_240MHZ                  BITS(4:2, 4)
    #define TOP_CKG_EVD_216MHZ                  BITS(4:2, 5)
    #define TOP_CKG_EVD_192MHZ                  BITS(4:2, 6)
    #define TOP_CKG_EVD_172MHZ                  BITS(4:2, 7)
...
#define REG_TOP_HVD_AEC_LITE         (CLKGEN2_REG_BASE+(0x0018<<1))
    ...
    #define TOP_CKG_HVD_AEC_LITE_CLK_MASK       BMASK(4:2)
    #define TOP_CKG_HVD_AEC_LITE_288MHZ         BITS(4:2, 0)  //default use this
    #define TOP_CKG_HVD_AEC_LITE_240MHZ         BITS(4:2, 1)
    #define TOP_CKG_HVD_AEC_LITE_216MHZ         BITS(4:2, 2)
    #define TOP_CKG_HVD_AEC_LITE_172MHZ         BITS(4:2, 3)
    #define TOP_CKG_HVD_AEC_LITE_144MHZ         BITS(4:2, 4)

#define REG_TOP_HVD_IDB              (CLKGEN2_REG_BASE+(0x001a<<1))
    #define TOP_CKG_HVD_IDB_CLK_MASK            BMASK(2:0)
    #define TOP_CKG_HVD_IDB_MIU                 BITS(2:0, 0)
    #define TOP_CKG_HVD_IDB_288MHZ              BITS(2:0, 1)  // default use this
    #define TOP_CKG_HVD_IDB_240MHZ              BITS(2:0, 2)  // for overclocking
    #define TOP_CKG_HVD_IDB_216MHZ              BITS(2:0, 3)  // for overclocking
...
#define REG_TOP_HVD_AEC              (CLKGEN2_REG_BASE+(0x001b<<1))
    ...
    #define TOP_CKG_HVD_AEC_CLK_MASK            BMASK(4:2)
    #define TOP_CKG_HVD_AEC_240MHZ              BITS(4:2, 0)  //default use this
    #define TOP_CKG_HVD_AEC_216MHZ              BITS(4:2, 1)
    #define TOP_CKG_HVD_AEC_192MHZ              BITS(4:2, 2)
    #define TOP_CKG_HVD_AEC_172MHZ              BITS(4:2, 3)  // for overclocking
    #define TOP_CKG_HVD_AEC_CLK                 BITS(4:2, 4)  // for overclocking
...
#define REG_TOP_VP8                  (CLKGEN2_REG_BASE+(0x001d<<1))
    ...
    #define TOP_CKG_VP8_192MHZ                  BITS(3:2, 1)
    #define TOP_CKG_VP8_160MHZ                  BITS(3:2, 2)
    #define TOP_CKG_VP8_144MHZ                  BITS(3:2, 3)  // for overclocking
