...
#define HVD_HW_MAX_PIXEL            (1920*1080*61000ULL) // FHD@60p
#define HEVC_HW_MAX_PIXEL           (2048*1088*61000ULL) // UHD@60p
...
static void _HVD_EX_Context_Init_HAL(void)
{
    ...
    pHVDHalContext->u32VPUClockType = 240;
...
static MS_U16 _HVD_EX_GetBBUReadptr(MS_U32 u32Id)
{
    ...
    else
    {
        ...
        {
            if(!pShm) {
                HVD_PRINT("%s:%d pShm==NULL, return error!!!\n", __FUNCTION__, __LINE__);
                return 0;
            }
...
MS_VIRT HAL_HVD_EX_GetShmAddr(MS_U32 u32Id)
{
    ...
    {
        printk("pCtrl->MemMap.u32CodeBufAddr == 0, chid:%d, return null pointer\n", u32Id);
        return 0;
    }
...
#endif
{
    ...
    //Chip info
    pShm->u16ChipID = E_MSTAR_CHIP_K6LITE;
...
static void HAL_EVD_EX_PowerCtrl(MS_U32 u32Id, MS_BOOL bEnable)
{
    ...
    {
        // 576, 532, 456, 480 can't use for decode(Ask for HW).
        case 576:
        {
