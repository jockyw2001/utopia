...
#define VPU_CLOCK_240MHZ                BITS(6:2,0)
#define VPU_CLOCK_216MHZ                BITS(6:2,1)
#define VPU_CLOCK_192MHZ                BITS(6:2,2)
#define VPU_CLOCK_172MHZ                BITS(6:2,3)
...
typedef enum
{
    ...
    E_VPU_EX_CLOCK_172MHZ   = VPU_CLOCK_172MHZ,
} VPU_EX_ClockSpeed;
