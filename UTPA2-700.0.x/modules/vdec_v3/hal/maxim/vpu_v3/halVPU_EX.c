...
//------------------------------ MIU SETTINGS ----------------------------------
#ifdef EVDR2
#define _MaskMiuReq_VPU_D_RW(m)     _VPU_WriteRegBit(MIU0_REG_RQ3_MASK, m, BIT(1))  // G31
#define _MaskMiuReq_VPU_Q_RW(m)     _VPU_WriteRegBit(MIU0_REG_RQ3_MASK, m, BIT(1))  // G31
#define _MaskMiuReq_VPU_I_R(m)      _VPU_WriteRegBit(MIU0_REG_RQ3_MASK, m, BIT(2))  // G32

#define _MaskMiu1Req_VPU_D_RW(m)    _VPU_WriteRegBit(MIU1_REG_RQ3_MASK, m, BIT(1))  // G31
#define _MaskMiu1Req_VPU_Q_RW(m)    _VPU_WriteRegBit(MIU1_REG_RQ3_MASK, m, BIT(1))  // G31
#define _MaskMiu1Req_VPU_I_R(m)     _VPU_WriteRegBit(MIU1_REG_RQ3_MASK, m, BIT(2))  // G32

#define VPU_D_RW_ON_MIU0            ((_VPU_ReadByte(MIU0_REG_SEL3) & BIT(1)) == 0)
#define VPU_Q_RW_ON_MIU0            ((_VPU_ReadByte(MIU0_REG_SEL3) & BIT(1)) == 0)
#define VPU_I_R_ON_MIU0             ((_VPU_ReadByte(MIU0_REG_SEL3) & BIT(2)) == 0)
