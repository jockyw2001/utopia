...
#define HVD_FW_IF_VERSION 0x00750191
...
#define HVD_DisplayColourVolume_SEI_SIZE  (0x10)
#define HVD_DisplayColourVolume_SEI_NUM   (2)
#define HVD_ContentLightLevel_SEI_SIZE    (0x8)
...
// For Git Changes
#define GIT_TIMESTAMP 1457445222
...
typedef struct
{
    ...
    MS_U8  reserved8_9[0xF9C-0xDEE];    //0x0DEE
