...
#define INTERFACE_VERSION        0x00000356 // Add OFFSET_REPEAT_FRAME_COUNT
...
typedef struct
{
    union
    {
        struct
        {
            ...
            unsigned int mvdcmd_handshake_reserved : 16;    // reserved for extend
        };
        unsigned int value;
    };
...
typedef struct _FW_FRAME_INFO
{
    ...
    unsigned char           reserve8_3[3];              //269
