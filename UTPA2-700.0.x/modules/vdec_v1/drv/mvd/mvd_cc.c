...
void MDrv_CC_CM_SetMVDRB_SWAddr(MS_U32 u32ReadAddress, MS_U8 u8CC608);
MS_U32 MDrv_CC_CM_GetMVDRB_HWAddr(MS_U8 u8CC608);
...
#define MVD_ON_MIU1     (stMemCfg.bFWMiuSel == MIU_SEL_1)
...
///////////////////////////////////////////////////////////////////////////////
void MDrv_CC_CM_SetMVDRB_HWAddr(MS_U32 u32StartAddress, MS_U8 u8CC608)
{
    ...
    if (HAL_MVD_MVDCommand(CMD_SET_CCBUF_STARTHWADDR, &mvdcmd) == TRUE)
    {
        ...
        MDrv_CC_CM_SetMVDRB_SWAddr(u32StartAddress, u8CC608);
    }
    else
    {
...
///   - # FALSE for CC708 parser
///////////////////////////////////////////////////////////////////////////////
void MDrv_CC_CM_SyncMVDRB_SWAddr2HWAddr(MS_U8 u8CC608)
{
    MDrv_CC_CM_SetMVDRB_SWAddr(u32HW_Address[u8CC608], u8CC608);
}
...
///   - # FALSE for CC708 parser
///////////////////////////////////////////////////////////////////////////////
void MDrv_CC_CM_SetParsingType(MS_U8 u8Operation, MS_U16 u16BufferSize, MS_U8 u8CC608)
{
...
///   - # FALSE for CC708 parser
///////////////////////////////////////////////////////////////////////////////
void MDrv_CC_CM_DisableParsing(MS_U8 u8CC608)
{
    MS_U16 u16MVDCC_Temp1 = 0;
    MVD_CmdArg mvdcmd;
    memset((void *)&mvdcmd, 0, sizeof(MVD_CmdArg));
...
////////////////////////////////////////////////////////////////////////////////
MS_U8 MDrv_CC_CM_GetOverflowStatus(MS_U8 u8CC608)
{
    MVD_CmdArg mvdcmd;
    memset((void *)&mvdcmd, 0, sizeof(MVD_CmdArg));
    mvdcmd.Arg3 = (MS_U8)u8CC608;
...
///////////////////////////////////////////////////////////////////////////////
MS_U32 MDrv_CC_PM_GetMVDRB_WriteAddr(MS_U8 u8CC608)
{
    u32HW_Address[u8CC608] = MDrv_CC_CM_GetMVDRB_HWAddr(u8CC608);
...
///////////////////////////////////////////////////////////////////////////////
MS_U32 MDrv_CC_PM_GetMVDRB_ReadAddr(MS_U8 u8CC608)
{
    if(bBufMiu0)
    {
...
///   - # FALSE for CC708 parser
///////////////////////////////////////////////////////////////////////////////
void MDrv_CC_PM_SetMVDRB_ReadAddr(MS_U32 u32EachPacketSize, MS_U8 u8CC608)
{
    MS_U32 u32MVDCC_Temp1 = 0;
    ...
    MDrv_CC_CM_SetMVDRB_SWAddr(u32SW_Address[u8CC608], u8CC608);
}
...
MS_BOOL MDrv_CC_CM_IsMvdRstDone(MS_U8 type)
{
    ...
    {
        if(!MDrv_MVD_IsCmdFinished(MVD_HANDSHAKE_RST_CC608))
        {
            bRet = TRUE;
        }
    }
    ...
    {
        if(!MDrv_MVD_IsCmdFinished(MVD_HANDSHAKE_RST_CC708))
        {
            bRet = TRUE;
        }
    }
