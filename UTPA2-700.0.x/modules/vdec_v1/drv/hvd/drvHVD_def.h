...
typedef enum
{
    E_HVD_INIT_HW_MASK  = BMASK(1:0),    ///< HW Type
        E_HVD_INIT_HW_AVC =  BITS( 1:0,0) ,   ///< HW deflaut: AVC 0X00
        E_HVD_INIT_HW_AVS = BITS( 1:0,1) ,   ///< HW : AVS 0X01
        E_HVD_INIT_HW_RM =BITS( 1:0,2) ,   ///< HW: RM 0X10
    E_HVD_INIT_MAIN_MASK =  BMASK(3:2) ,    ///< main type
        E_HVD_INIT_MAIN_FILE_RAW =  BITS( 3:2,0) ,             ///< main type: default: 0X00
        E_HVD_INIT_MAIN_FILE_TS =  BITS( 3:2,1) ,   ///< main type: 0X01
        E_HVD_INIT_MAIN_LIVE_STREAM  =  BITS( 3:2,2),    ///< main type: 0X10
    E_HVD_INIT_INPUT_MASK  =  BMASK(4:4)  ,  ///< process path for filling BBU table:  file mode. use drive; TSP: use tsp mode
        E_HVD_INIT_INPUT_TSP =   BITS( 4:4,0) ,   ///< tsp input( default)
        E_HVD_INIT_INPUT_DRV =   BITS( 4:4,1)  ,   ///< driver input
    E_HVD_INIT_START_CODE_MASK  =  BMASK(5:5) ,   ///< AVC FILE MODE ONLY: mkv, mp4 container use.
        E_HVD_INIT_START_CODE_REMAINED  =  BITS( 5:5,0) ,   ///< start code remained.(Defualt)
        E_HVD_INIT_START_CODE_REMOVED  =  BITS( 5:5,1)  ,  ///< start code removed.
    E_HVD_INIT_UTOPIA_ENVI =  BIT( 6),        ///< check MIU sel and set it
    E_HVD_INIT_DBG_FW  =  BIT( 7) ,       ///< check FW is debug version or not
