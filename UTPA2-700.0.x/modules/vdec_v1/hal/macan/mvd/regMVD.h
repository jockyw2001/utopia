...
#define REG_MHG_QMEM_DMASK  0x03e8    //QMEM Mask
#define REG_MHG_QMEM_DADDR  0x03ec    //QMEM Addr
#define REG_MHG_SPI_BASE    0x03fe    //SPI base
#define REG_MHG_REG32_BASE  0x03f8
    #define MHG_REG32_BASE_MVD  0x8008
#define REG_MHG_SDR_BASE    0x03f4
#define REG_MHG_INSN_BASE_0 0x03e4
#define REG_MHG_INSN_BASE_1 0x03e5
#define REG_MHG_INSN_BASE_2 0x03e3
#define REG_MHG_INSN_BASE_3 0x03e7
...
#define REG_CKG_VD_AEON        (REG_CHIPTOP_BASE + 0x30*2)
    ...
    #define CKG_VD_AEON_MASK            (BIT3 | BIT2)
