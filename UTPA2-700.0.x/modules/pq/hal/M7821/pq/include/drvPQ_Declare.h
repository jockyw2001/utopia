...
#include "Maserati_Main_HSDRule.h"      // table config parameter
#include "Maserati_Main_VSDRule.h"      // table config parameter
#include "Maserati_Main_HSPRule.h"      // table config parameter
#include "Maserati_Main_VSPRule.h"      // table config parameter
#include "Maserati_Main_CSCRule.h"      // table config parameter
#include "Maserati_Main_GRule.h"        // table config parameter
#include "Maserati_Main_Ex.h"           // table config parameter

#include "Maserati_Sub.h"               // table config parameter
#include "Maserati_Sub_HSDRule.h"       // table config parameter
#include "Maserati_Sub_VSDRule.h"       // table config parameter
#include "Maserati_Sub_HSPRule.h"       // table config parameter
#include "Maserati_Sub_VSPRule.h"       // table config parameter
#include "Maserati_Sub_CSCRule.h"       // table config parameter
#include "Maserati_Sub_GRule.h"         // table config parameter
#include "Maserati_Sub_Ex.h"            // table config parameter

 //for customer Main PQ bin support Grule
#if ENABLE_PQ_CUSTOMER_BIN_MAIN_GRULE
#include "Maserati_Main_Color.h"       // table config parameter
#include "Maserati_Main_Color_GRule.h" // table config parameter
#endif

 //for customer Sub PQ bin support Grule
#if ENABLE_PQ_CUSTOMER_BIN_SUB_GRULE
#if PQ_ENABLE_PIP
#include "Maserati_Sub_Color.h"       // table config parameter
#include "Maserati_Sub_Color_GRule.h" // table config parameter
#endif
#endif

#include "Maserati_UFSC.h"
#include "Maserati_UFSC_GRule.h"
#include "Maserati_UFSC_HSPRule.h"
#include "Maserati_UFSC_VSPRule.h"
