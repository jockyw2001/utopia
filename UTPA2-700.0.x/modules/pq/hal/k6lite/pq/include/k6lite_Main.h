...
// 1920
// k6lite
// 11/27/2017  9:49:37 AM
// 39630.43853
//****************************************************

#ifndef _K6LITE_MAIN_H_
#define _K6LITE_MAIN_H_
...
{
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Main, //0
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Main, //1
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Main, //2
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Main, //3
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Main, //4
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Main, //5
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_4K2K_FS_progressive_Main, //6
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Main, //7
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Main, //8
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Main, //9
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Photo_Main, //10
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_60Hz_Main, //11
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_non_4K2K_Main, //12
    #endif
    QM_INPUTTYPE_NUM_Main, // 13
