...
#ifndef _MOONEY_MAIN_EX_H_
#define _MOONEY_MAIN_EX_H_
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_FHD_I_DS_Main_Ex, //148
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_FHD_P_DS_Main_Ex, //149
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_DS_Main_Ex, //150
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Main_Ex, //151
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Photo_Main_Ex, //152
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_60Hz_Main_Ex, //153
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_non_4K2K_Main_Ex, //154
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Main_Ex, //155
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Main_Ex, //156
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Main_Ex, //157
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Main_Ex, //158
    #endif
    #if PQ_QM_MM_VIDEO
    QM_NetWork_4K2K_DS_Main_Ex, //159
    #endif
    #if PQ_QM_HMDI
    QM_I_Mode_Unlock_Main_Ex, //160
    #endif
    #if PQ_QM_HMDI
    QM_P_Mode_Unlock_Main_Ex, //161
    #endif
    QM_INPUTTYPE_NUM_Main_Ex, // 162
...
PQ_IP_VIP_Peaking_adptive_Main_Ex,  //5
PQ_IP_VIP_Peaking_Pcoring_ad_C_Main_Ex,  //6
PQ_IP_VIP_Peaking_gain_by_Cedge_Main_Ex,  //7
PQ_IP_VIP_ICC_Target_Main_Ex,  //8
PQ_IP_VIP_IBC_weight_Main_Ex,  //9
PQ_IP_VIP_ACK_Main_Ex,  //10
PQ_IP_VIP_Ygain_ColorAdaptive_Main_Ex,  //11
PQ_IP_VIP_Cgain_ColorAdaptive_Main_Ex,  //12
PQ_IP_VIP_Ygain_NonLinear_Main_Ex,  //13
PQ_IP_VIP_Cgain_NonLinear_Main_Ex,  //14
 }   PQ_IPTYPE_Main_Ex;
...
PQ_IP_VIP_Peaking_adptive_COM_Main_Ex,  //5
PQ_IP_VIP_Peaking_Pcoring_ad_C_COM_Main_Ex,  //6
PQ_IP_VIP_Peaking_gain_by_Cedge_COM_Main_Ex,  //7
PQ_IP_VIP_ICC_Target_COM_Main_Ex,  //8
PQ_IP_VIP_IBC_weight_COM_Main_Ex,  //9
PQ_IP_VIP_ACK_COM_Main_Ex,  //10
PQ_IP_VIP_Ygain_ColorAdaptive_COM_Main_Ex,  //11
PQ_IP_VIP_Cgain_ColorAdaptive_COM_Main_Ex,  //12
PQ_IP_VIP_Ygain_NonLinear_COM_Main_Ex,  //13
PQ_IP_VIP_Cgain_NonLinear_COM_Main_Ex,  //14
...
typedef enum
{
PQ_IP_VIP_Ygain_ColorAdaptive_OFF_Main_Ex,
PQ_IP_VIP_Ygain_ColorAdaptive_NUMS_Main_Ex
} PQ_IP_VIP_Ygain_ColorAdaptive_Group_Main_Ex;

typedef enum
{
PQ_IP_VIP_Cgain_ColorAdaptive_OFF_Main_Ex,
PQ_IP_VIP_Cgain_ColorAdaptive_NUMS_Main_Ex
} PQ_IP_VIP_Cgain_ColorAdaptive_Group_Main_Ex;

typedef enum
{
PQ_IP_VIP_Ygain_NonLinear_OFF_Main_Ex,
PQ_IP_VIP_Ygain_NonLinear_NUMS_Main_Ex
} PQ_IP_VIP_Ygain_NonLinear_Group_Main_Ex;

typedef enum
{
PQ_IP_VIP_Cgain_NonLinear_OFF_Main_Ex,
PQ_IP_VIP_Cgain_NonLinear_NUMS_Main_Ex
} PQ_IP_VIP_Cgain_NonLinear_Group_Main_Ex;
