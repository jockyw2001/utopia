...
MS_U8 _gu8AnalogCfd[QM_INPUTTYPE_NUM_Main][6] =
{
    ...
    {7, 2, 0, 2, 2, 2}, // QM_MM_4K2K_Main
    {7, 2, 0, 2, 2, 2}, // QM_MM_4K2K_Photo_Main
    {7, 2, 0, 2, 2, 2}, // QM_MM_4K2K_60Hz_Main
    {7, 2, 0, 2, 2, 2}, // QM_MM_non_4K2K_Main(154)
#endif
#if (PQ_QM_DTV)
    ...
    {7, 2, 0, 2, 2, 2}, // QM_DTV_iFrame_HD_progressive_Main(158)
#endif
};
...
void Hal_PQ_get_sram_icc_crd_table(void *pInstance, MS_U8 u8sramtype, MS_U16 *pBuf)
{
	MS_U16 i;
...
void Hal_PQ_Set2StepScaling(void *pInstance, MS_BOOL bEnable)
{
...
MS_BOOL Hal_PQ_get_cfd_info(void *pInstance, MS_U16 u16PqIndex, MS_U8 *pu8ColorFormat, MS_U8 *pu8ColorDataFormat, MS_BOOL *pbIsFullRange, MS_U8 *pu8ColorPrimaries, MS_U8 *pu8TransferCharacteristics, MS_U8 *pu8MatrixCoefficients)
{
