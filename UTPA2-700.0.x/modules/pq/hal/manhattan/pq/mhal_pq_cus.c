...
MS_U16 Hal_PQ_get_madi_idx(void *pInstance,MS_BOOL bMainWin, MS_MADI_TYPE etype)
{
    ...
    if(bMainWin == FALSE)
    {
        ...
        case MS_MADI_25_2R_880:
            u16ret = PQ_IP_MADi_25_2R_880_Sub;
            break;
        ...
        case MS_MADI_P_MODE8_2BYTE_3D:
            u16ret = PQ_IP_MADi_P_MODE8_2BYTE_3D_Sub;
            break;
        case MS_MADI_P_MODE_MOT10_4Frame:
            u16ret = PQ_IP_MADi_P_MODE_MOT10_4Frame_Sub;
            break;
        case MS_MADI_RFBL_2D:
            u16ret = PQ_IP_MADi_RFBL_2D_Sub;
            break;
        case MS_MADI_RFBL_25D:
            u16ret = PQ_IP_MADi_RFBL_25D_Sub;
            break;
        case MS_MADI_RFBL_3D:
            u16ret = PQ_IP_MADi_RFBL_3D_Sub;
            break;
        ...
        case MS_MADI_25_8F_4R_MC:
            u16ret = PQ_IP_MADi_25_8F_4R_MC_Sub;
            break;
        case MS_MADI_P_MODE_MC_4Frame:
            u16ret = PQ_IP_MADi_P_MODE_MC_4Frame_Sub;
            break;
        case MS_MADI_25_6F_4R_MC_I:
            u16ret = PQ_IP_MADi_25_6F_4R_MC_I_Sub;
            break;
        case MS_MADI_25_6F_4R_MC_P:
            u16ret = PQ_IP_MADi_25_6F_4R_MC_P_Sub;
            break;
        default:
            u16ret = 0xFFFF;
            //MS_ASSERT(0);
