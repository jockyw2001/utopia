...
// 1920
// Manhattan
// 8/12/2015  10:11:03 AM
// 39630.43853
//****************************************************

#ifndef _MANHATTAN_SUB_H_
#define _MANHATTAN_SUB_H_

#define PQ_IP_NUM_Sub 201
...
#define PQ_IP_VIP_IHC_CRD_SRAM_SIZE_Sub 2178
#define PQ_IP_VIP_ICC_CRD_SRAM_SIZE_Sub 2178
#define PQ_IP_XVYCC_DE_GAMMA_SRAM_SIZE_Sub 0
#define PQ_IP_XVYCC_GAMMA_SRAM_SIZE_Sub 0
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vup_Sub, //73
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vdown_Sub, //74
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vno_Sub, //75
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vup_Sub, //76
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vdown_Sub, //77
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vno_Sub, //78
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vup_Sub, //79
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vdown_Sub, //80
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vno_Sub, //81
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vup_Sub, //82
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vdown_Sub, //83
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vno_Sub, //84
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vup_Sub, //85
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vdown_Sub, //86
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vno_Sub, //87
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vup_Sub, //88
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vdown_Sub, //89
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vno_Sub, //90
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vup_Sub, //91
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vdown_Sub, //92
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vno_Sub, //93
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vup_Sub, //94
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vdown_Sub, //95
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vno_Sub, //96
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vup_Sub, //97
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vdown_Sub, //98
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_Sub, //99
    #endif
    #if PQ_QM_DTV
    ...
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Sub, //126
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Sub, //127
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Sub, //128
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Sub, //129
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Sub, //130
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Sub, //131
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Sub, //132
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Sub, //133
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_interlace_Sub, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_Sub, //135
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_24hz_Sub, //136
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_interlace_Sub, //137
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_Sub, //138
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_24hz_Sub, //139
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_4K2K_FS_progressive_Sub, //140
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Sub, //141
    #endif
    ...
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Sub, //143
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Sub, //144
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Sub, //145
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Sub, //146
    #endif
    #if PQ_QM_3D
    QM_3D_Video_interlace_Sub, //147
    #endif
    #if PQ_QM_3D
    QM_3D_Video_progressive_Sub, //148
    #endif
    QM_INPUTTYPE_NUM_Sub, // 149
...
PQ_IP_HDSDD_Sub,  //11
PQ_IP_HSD_Sampling_Sub,  //12
PQ_IP_HSD_Y_Sub,  //13
PQ_IP_HSD_C_Sub,  //14
PQ_IP_444To422_Sub,  //15
PQ_IP_VSD_Sub,  //16
PQ_IP_HVSD_Dither_Sub,  //17
PQ_IP_10to8_Dither_Sub,  //18
PQ_IP_MemFormat_Sub,  //19
PQ_IP_PreSNR_Sub,  //20
PQ_IP_PreSNR_Patch_Sub,  //21
PQ_IP_DNR_Sub,  //22
PQ_IP_DNR_Motion_Sub,  //23
PQ_IP_DNR_Y_Sub,  //24
PQ_IP_DNR_Y_COLOR_DEP_Sub,  //25
PQ_IP_SRAM_COLOR_INDEX_Sub,  //26
PQ_IP_SRAM_COLOR_GAIN_SNR_Sub,  //27
PQ_IP_SRAM_COLOR_GAIN_DNR_Sub,  //28
PQ_IP_DNR_Y_LUMA_ADAPTIVE_Sub,  //29
PQ_IP_DNR_POSTTUNE_Sub,  //30
PQ_IP_DNR_C_Sub,  //31
PQ_IP_DNR_sticky_solver_Sub,  //32
PQ_IP_HISDNR_Sub,  //33
PQ_IP_PNR_Sub,  //34
PQ_IP_PNR_Y_Sub,  //35
PQ_IP_PNR_C_Sub,  //36
PQ_IP_PostCCS_Sub,  //37
PQ_IP_PostCCS_NP_Sub,  //38
PQ_IP_DHD_Sub,  //39
PQ_IP_420CUP_Sub,  //40
PQ_IP_BWS_Sub,  //41
PQ_IP_MADi_Sub,  //42
PQ_IP_MADi_Motion_Sub,  //43
PQ_IP_MADi_ADP3x3_Sub,  //44
PQ_IP_MADi_MORPHO_Sub,  //45
PQ_IP_MADi_DFK_Sub,  //46
PQ_IP_MADi_SST_Sub,  //47
PQ_IP_MADi_EODiW_Sub,  //48
PQ_IP_MADi_Force_Sub,  //49
PQ_IP_EODi_Sub,  //50
PQ_IP_Film_Sub,  //51
PQ_IP_Film32_Sub,  //52
PQ_IP_Film22_Sub,  //53
PQ_IP_Film_any_Sub,  //54
PQ_IP_UCNR_Sub,  //55
PQ_IP_UCDi_Sub,  //56
PQ_IP_UC_CTL_Sub,  //57
PQ_IP_DIPF_Sub,  //58
PQ_IP_VCLPF_Sub,  //59
PQ_IP_Spike_NR_Sub,  //60
PQ_IP_SPF_Sub,  //61
PQ_IP_SPF_DBK_Sub,  //62
PQ_IP_SPF_DBK_BKN_Sub,  //63
PQ_IP_SPF_DBK_MR_Sub,  //64
PQ_IP_SPF_DBK_STAT_Sub,  //65
PQ_IP_SPF_SNR_Sub,  //66
PQ_IP_SPF_SNR_MR_Sub,  //67
PQ_IP_SPF_MR_LPF_Sub,  //68
PQ_IP_SPF_NMR_Y_Sub,  //69
PQ_IP_SPF_NMR_Y_MR_Sub,  //70
PQ_IP_SPF_NMR_C_Sub,  //71
PQ_IP_DMS_Sub,  //72
PQ_IP_DMS_H_Sub,  //73
PQ_IP_VSP_Y_Sub,  //74
PQ_IP_VSP_C_Sub,  //75
PQ_IP_VSP_CoRing_Sub,  //76
PQ_IP_VSP_DeRing_Sub,  //77
PQ_IP_VSP_Dither_Sub,  //78
PQ_IP_VSP_PreVBound_Sub,  //79
PQ_IP_422To444_Sub,  //80
PQ_IP_PreCTI_Sub,  //81
PQ_IP_HSP_Y_Sub,  //82
PQ_IP_HSP_C_Sub,  //83
PQ_IP_HSP_CoRing_Sub,  //84
PQ_IP_HSP_DeRing_Sub,  //85
PQ_IP_HSP_Dither_Sub,  //86
PQ_IP_HnonLinear_Sub,  //87
PQ_IP_SRAM1_Sub,  //88
PQ_IP_SRAM2_Sub,  //89
PQ_IP_SRAM3_Sub,  //90
PQ_IP_SRAM4_Sub,  //91
PQ_IP_C_SRAM1_Sub,  //92
PQ_IP_C_SRAM2_Sub,  //93
PQ_IP_C_SRAM3_Sub,  //94
PQ_IP_C_SRAM4_Sub,  //95
PQ_IP_VIP_Sub,  //96
PQ_IP_VIP_pseudo_Sub,  //97
PQ_IP_VIP_CSC_Sub,  //98
PQ_IP_VIP_CSC_dither_Sub,  //99
PQ_IP_VIP_Post_YC_delay_Sub,  //100
PQ_IP_VIP_HNMR_Y_Sub,  //101
PQ_IP_VIP_HNMR_C_Sub,  //102
PQ_IP_VIP_HNMR_ad_C_Sub,  //103
PQ_IP_VIP_HNMR_ad_C_gain_Sub,  //104
PQ_IP_VIP_HNMR_C_win1_Sub,  //105
PQ_IP_VIP_HNMR_C_win2_Sub,  //106
PQ_IP_VIP_Pre_Yoffset_Sub,  //107
PQ_IP_VIP_Pre_Ygain_Sub,  //108
PQ_IP_VIP_Pre_Ygain_dither_Sub,  //109
PQ_IP_VIP_HLPF_Sub,  //110
PQ_IP_VIP_HLPF_dither_Sub,  //111
PQ_IP_VIP_VNMR_Sub,  //112
PQ_IP_VIP_VNMR_dither_Sub,  //113
PQ_IP_VIP_VLPF_coef1_Sub,  //114
PQ_IP_VIP_VLPF_coef2_Sub,  //115
PQ_IP_VIP_VLPF_dither_Sub,  //116
PQ_IP_VIP_4K2K_Sub,  //117
PQ_IP_VIP_Peaking_Sub,  //118
PQ_IP_VIP_Peaking_band_Sub,  //119
PQ_IP_VIP_Peaking_dering_Sub,  //120
PQ_IP_VIP_Peaking_Pcoring_Sub,  //121
PQ_IP_VIP_Peaking_Pcoring_ad_C_Sub,  //122
PQ_IP_VIP_Peaking_gain_Sub,  //123
PQ_IP_VIP_Peaking_gain_ad_C_Sub,  //124
PQ_IP_VIP_Post_SNR_Sub,  //125
PQ_IP_VIP_Post_CTI_Sub,  //126
PQ_IP_VIP_Post_CTI_coef_Sub,  //127
PQ_IP_VIP_Post_CTI_gray_Sub,  //128
PQ_IP_VIP_FCC_full_range_Sub,  //129
PQ_IP_VIP_FCC_bdry_dist_Sub,  //130
PQ_IP_VIP_FCC_T1_Sub,  //131
PQ_IP_VIP_FCC_T2_Sub,  //132
PQ_IP_VIP_FCC_T3_Sub,  //133
PQ_IP_VIP_FCC_T4_Sub,  //134
PQ_IP_VIP_FCC_T5_Sub,  //135
PQ_IP_VIP_FCC_T6_Sub,  //136
PQ_IP_VIP_FCC_T7_Sub,  //137
PQ_IP_VIP_FCC_T8_Sub,  //138
PQ_IP_VIP_FCC_T9_Sub,  //139
PQ_IP_VIP_IHC_Sub,  //140
PQ_IP_VIP_IHC_Ymode_Sub,  //141
PQ_IP_VIP_IHC_dither_Sub,  //142
PQ_IP_VIP_IHC_CRD_SRAM_Sub,  //143
PQ_IP_VIP_IHC_SETTING_Sub,  //144
PQ_IP_VIP_ICC_Sub,  //145
PQ_IP_VIP_ICC_Ymode_Sub,  //146
PQ_IP_VIP_ICC_dither_Sub,  //147
PQ_IP_VIP_ICC_CRD_SRAM_Sub,  //148
PQ_IP_VIP_ICC_SETTING_Sub,  //149
PQ_IP_VIP_Ymode_Yvalue_ALL_Sub,  //150
PQ_IP_VIP_Ymode_Yvalue_SETTING_Sub,  //151
PQ_IP_VIP_IBC_Sub,  //152
PQ_IP_VIP_IBC_dither_Sub,  //153
PQ_IP_VIP_IBC_SETTING_Sub,  //154
PQ_IP_VIP_DLC_Sub,  //155
PQ_IP_VIP_DLC_dither_Sub,  //156
PQ_IP_VIP_DLC_His_range_Sub,  //157
PQ_IP_VIP_DLC_His_rangeH_Sub,  //158
PQ_IP_VIP_DLC_His_rangeV_Sub,  //159
PQ_IP_VIP_DLC_PC_Sub,  //160
PQ_IP_VIP_BWLE_Sub,  //161
PQ_IP_VIP_BLE_Sub,  //162
PQ_IP_VIP_WLE_Sub,  //163
PQ_IP_VIP_BWLE_dither_Sub,  //164
PQ_IP_VIP_UVC_Sub,  //165
PQ_IP_VIP_Post_Yoffset_Sub,  //166
PQ_IP_VIP_Post_Ygain_Sub,  //167
PQ_IP_VIP_Post_Yoffset_2_Sub,  //168
PQ_IP_VIP_Post_Cgain_Sub,  //169
PQ_IP_VIP_Hcoring_Y_Sub,  //170
PQ_IP_VIP_Hcoring_C_Sub,  //171
PQ_IP_VIP_Hcoring_dither_Sub,  //172
PQ_IP_SwDriver_Sub,  //173
PQ_IP_3x3_Sub,  //174
PQ_IP_RGB_Offset_Sub,  //175
PQ_IP_RGB_Clip_Sub,  //176
PQ_IP_xvYCC_bypass_Sub,  //177
PQ_IP_xvYCC_de_gamma_Sub,  //178
PQ_IP_XVYCC_DE_GAMMA_SRAM_Sub,  //179
PQ_IP_xvYCC_de_gamma_dither_Sub,  //180
PQ_IP_xvYCC_3x3_Sub,  //181
PQ_IP_xvYCC_Comp_Sub,  //182
PQ_IP_xvYCC_Comp_dither_Sub,  //183
PQ_IP_xvYCC_Clip_Sub,  //184
PQ_IP_xvYCC_gamma_Sub,  //185
PQ_IP_XVYCC_GAMMA_SRAM_Sub,  //186
PQ_IP_xvYCC_gamma_dither_Sub,  //187
PQ_IP_rgb_3d_Sub,  //188
PQ_IP_HBC_Sub,  //189
PQ_IP_Pre_CON_BRI_Sub,  //190
PQ_IP_Blue_Stretch_Sub,  //191
PQ_IP_Blue_Stretch_dither_Sub,  //192
PQ_IP_Gamma_Sub,  //193
PQ_IP_Gamma_dither_Sub,  //194
PQ_IP_Post_CON_BRI_Sub,  //195
PQ_IP_Clone_main_no_comm_Sub,  //196
PQ_IP_Clone_sub_no_comm_Sub,  //197
PQ_IP_MWE_diff_no_comm_Sub,  //198
PQ_IP_3DSettingForLBL_no_comm_Sub,  //199
PQ_IP_SettingFor2LineMode_no_comm_Sub,  //200
 }   PQ_IPTYPE_Sub;
...
PQ_IP_HSD_Sampling_COM_Sub,  //12
PQ_IP_HSD_Y_COM_Sub,  //13
PQ_IP_HSD_C_COM_Sub,  //14
PQ_IP_444To422_COM_Sub,  //15
PQ_IP_VSD_COM_Sub,  //16
PQ_IP_HVSD_Dither_COM_Sub,  //17
PQ_IP_10to8_Dither_COM_Sub,  //18
PQ_IP_MemFormat_COM_Sub,  //19
PQ_IP_PreSNR_COM_Sub,  //20
PQ_IP_PreSNR_Patch_COM_Sub,  //21
PQ_IP_DNR_COM_Sub,  //22
PQ_IP_DNR_Motion_COM_Sub,  //23
PQ_IP_DNR_Y_COM_Sub,  //24
PQ_IP_DNR_Y_COLOR_DEP_COM_Sub,  //25
PQ_IP_SRAM_COLOR_INDEX_COM_Sub,  //26
PQ_IP_SRAM_COLOR_GAIN_SNR_COM_Sub,  //27
PQ_IP_SRAM_COLOR_GAIN_DNR_COM_Sub,  //28
PQ_IP_DNR_Y_LUMA_ADAPTIVE_COM_Sub,  //29
PQ_IP_DNR_POSTTUNE_COM_Sub,  //30
PQ_IP_DNR_C_COM_Sub,  //31
PQ_IP_DNR_sticky_solver_COM_Sub,  //32
PQ_IP_HISDNR_COM_Sub,  //33
PQ_IP_PNR_COM_Sub,  //34
PQ_IP_PNR_Y_COM_Sub,  //35
PQ_IP_PNR_C_COM_Sub,  //36
PQ_IP_PostCCS_COM_Sub,  //37
PQ_IP_PostCCS_NP_COM_Sub,  //38
PQ_IP_DHD_COM_Sub,  //39
PQ_IP_420CUP_COM_Sub,  //40
PQ_IP_BWS_COM_Sub,  //41
PQ_IP_MADi_COM_Sub,  //42
PQ_IP_MADi_Motion_COM_Sub,  //43
PQ_IP_MADi_ADP3x3_COM_Sub,  //44
PQ_IP_MADi_MORPHO_COM_Sub,  //45
PQ_IP_MADi_DFK_COM_Sub,  //46
PQ_IP_MADi_SST_COM_Sub,  //47
PQ_IP_MADi_EODiW_COM_Sub,  //48
PQ_IP_MADi_Force_COM_Sub,  //49
PQ_IP_EODi_COM_Sub,  //50
PQ_IP_Film_COM_Sub,  //51
PQ_IP_Film32_COM_Sub,  //52
PQ_IP_Film22_COM_Sub,  //53
PQ_IP_Film_any_COM_Sub,  //54
PQ_IP_UCNR_COM_Sub,  //55
PQ_IP_UCDi_COM_Sub,  //56
PQ_IP_UC_CTL_COM_Sub,  //57
PQ_IP_DIPF_COM_Sub,  //58
PQ_IP_VCLPF_COM_Sub,  //59
PQ_IP_Spike_NR_COM_Sub,  //60
PQ_IP_SPF_COM_Sub,  //61
PQ_IP_SPF_DBK_COM_Sub,  //62
PQ_IP_SPF_DBK_BKN_COM_Sub,  //63
PQ_IP_SPF_DBK_MR_COM_Sub,  //64
PQ_IP_SPF_DBK_STAT_COM_Sub,  //65
PQ_IP_SPF_SNR_COM_Sub,  //66
PQ_IP_SPF_SNR_MR_COM_Sub,  //67
PQ_IP_SPF_MR_LPF_COM_Sub,  //68
PQ_IP_SPF_NMR_Y_COM_Sub,  //69
PQ_IP_SPF_NMR_Y_MR_COM_Sub,  //70
PQ_IP_SPF_NMR_C_COM_Sub,  //71
PQ_IP_DMS_COM_Sub,  //72
PQ_IP_DMS_H_COM_Sub,  //73
PQ_IP_VSP_Y_COM_Sub,  //74
PQ_IP_VSP_C_COM_Sub,  //75
PQ_IP_VSP_CoRing_COM_Sub,  //76
PQ_IP_VSP_DeRing_COM_Sub,  //77
PQ_IP_VSP_Dither_COM_Sub,  //78
PQ_IP_VSP_PreVBound_COM_Sub,  //79
PQ_IP_422To444_COM_Sub,  //80
PQ_IP_PreCTI_COM_Sub,  //81
PQ_IP_HSP_Y_COM_Sub,  //82
PQ_IP_HSP_C_COM_Sub,  //83
PQ_IP_HSP_CoRing_COM_Sub,  //84
PQ_IP_HSP_DeRing_COM_Sub,  //85
PQ_IP_HSP_Dither_COM_Sub,  //86
PQ_IP_HnonLinear_COM_Sub,  //87
PQ_IP_SRAM1_COM_Sub,  //88
PQ_IP_SRAM2_COM_Sub,  //89
PQ_IP_SRAM3_COM_Sub,  //90
PQ_IP_SRAM4_COM_Sub,  //91
PQ_IP_C_SRAM1_COM_Sub,  //92
PQ_IP_C_SRAM2_COM_Sub,  //93
PQ_IP_C_SRAM3_COM_Sub,  //94
PQ_IP_C_SRAM4_COM_Sub,  //95
PQ_IP_VIP_COM_Sub,  //96
PQ_IP_VIP_pseudo_COM_Sub,  //97
PQ_IP_VIP_CSC_COM_Sub,  //98
PQ_IP_VIP_CSC_dither_COM_Sub,  //99
PQ_IP_VIP_Post_YC_delay_COM_Sub,  //100
PQ_IP_VIP_HNMR_Y_COM_Sub,  //101
PQ_IP_VIP_HNMR_C_COM_Sub,  //102
PQ_IP_VIP_HNMR_ad_C_COM_Sub,  //103
PQ_IP_VIP_HNMR_ad_C_gain_COM_Sub,  //104
PQ_IP_VIP_HNMR_C_win1_COM_Sub,  //105
PQ_IP_VIP_HNMR_C_win2_COM_Sub,  //106
PQ_IP_VIP_Pre_Yoffset_COM_Sub,  //107
PQ_IP_VIP_Pre_Ygain_COM_Sub,  //108
PQ_IP_VIP_Pre_Ygain_dither_COM_Sub,  //109
PQ_IP_VIP_HLPF_COM_Sub,  //110
PQ_IP_VIP_HLPF_dither_COM_Sub,  //111
PQ_IP_VIP_VNMR_COM_Sub,  //112
PQ_IP_VIP_VNMR_dither_COM_Sub,  //113
PQ_IP_VIP_VLPF_coef1_COM_Sub,  //114
PQ_IP_VIP_VLPF_coef2_COM_Sub,  //115
PQ_IP_VIP_VLPF_dither_COM_Sub,  //116
PQ_IP_VIP_4K2K_COM_Sub,  //117
PQ_IP_VIP_Peaking_COM_Sub,  //118
PQ_IP_VIP_Peaking_band_COM_Sub,  //119
PQ_IP_VIP_Peaking_dering_COM_Sub,  //120
PQ_IP_VIP_Peaking_Pcoring_COM_Sub,  //121
PQ_IP_VIP_Peaking_Pcoring_ad_C_COM_Sub,  //122
PQ_IP_VIP_Peaking_gain_COM_Sub,  //123
PQ_IP_VIP_Peaking_gain_ad_C_COM_Sub,  //124
PQ_IP_VIP_Post_SNR_COM_Sub,  //125
PQ_IP_VIP_Post_CTI_COM_Sub,  //126
PQ_IP_VIP_Post_CTI_coef_COM_Sub,  //127
PQ_IP_VIP_Post_CTI_gray_COM_Sub,  //128
PQ_IP_VIP_FCC_full_range_COM_Sub,  //129
PQ_IP_VIP_FCC_bdry_dist_COM_Sub,  //130
PQ_IP_VIP_FCC_T1_COM_Sub,  //131
PQ_IP_VIP_FCC_T2_COM_Sub,  //132
PQ_IP_VIP_FCC_T3_COM_Sub,  //133
PQ_IP_VIP_FCC_T4_COM_Sub,  //134
PQ_IP_VIP_FCC_T5_COM_Sub,  //135
PQ_IP_VIP_FCC_T6_COM_Sub,  //136
PQ_IP_VIP_FCC_T7_COM_Sub,  //137
PQ_IP_VIP_FCC_T8_COM_Sub,  //138
PQ_IP_VIP_FCC_T9_COM_Sub,  //139
PQ_IP_VIP_IHC_COM_Sub,  //140
PQ_IP_VIP_IHC_Ymode_COM_Sub,  //141
PQ_IP_VIP_IHC_dither_COM_Sub,  //142
PQ_IP_VIP_IHC_CRD_SRAM_COM_Sub,  //143
PQ_IP_VIP_IHC_SETTING_COM_Sub,  //144
PQ_IP_VIP_ICC_COM_Sub,  //145
PQ_IP_VIP_ICC_Ymode_COM_Sub,  //146
PQ_IP_VIP_ICC_dither_COM_Sub,  //147
PQ_IP_VIP_ICC_CRD_SRAM_COM_Sub,  //148
PQ_IP_VIP_ICC_SETTING_COM_Sub,  //149
PQ_IP_VIP_Ymode_Yvalue_ALL_COM_Sub,  //150
PQ_IP_VIP_Ymode_Yvalue_SETTING_COM_Sub,  //151
PQ_IP_VIP_IBC_COM_Sub,  //152
PQ_IP_VIP_IBC_dither_COM_Sub,  //153
PQ_IP_VIP_IBC_SETTING_COM_Sub,  //154
PQ_IP_VIP_DLC_COM_Sub,  //155
PQ_IP_VIP_DLC_dither_COM_Sub,  //156
PQ_IP_VIP_DLC_His_range_COM_Sub,  //157
PQ_IP_VIP_DLC_His_rangeH_COM_Sub,  //158
PQ_IP_VIP_DLC_His_rangeV_COM_Sub,  //159
PQ_IP_VIP_DLC_PC_COM_Sub,  //160
PQ_IP_VIP_BWLE_COM_Sub,  //161
PQ_IP_VIP_BLE_COM_Sub,  //162
PQ_IP_VIP_WLE_COM_Sub,  //163
PQ_IP_VIP_BWLE_dither_COM_Sub,  //164
PQ_IP_VIP_UVC_COM_Sub,  //165
PQ_IP_VIP_Post_Yoffset_COM_Sub,  //166
PQ_IP_VIP_Post_Ygain_COM_Sub,  //167
PQ_IP_VIP_Post_Yoffset_2_COM_Sub,  //168
PQ_IP_VIP_Post_Cgain_COM_Sub,  //169
PQ_IP_VIP_Hcoring_Y_COM_Sub,  //170
PQ_IP_VIP_Hcoring_C_COM_Sub,  //171
PQ_IP_VIP_Hcoring_dither_COM_Sub,  //172
PQ_IP_SwDriver_COM_Sub,  //173
PQ_IP_3x3_COM_Sub,  //174
PQ_IP_RGB_Offset_COM_Sub,  //175
PQ_IP_RGB_Clip_COM_Sub,  //176
PQ_IP_xvYCC_bypass_COM_Sub,  //177
PQ_IP_xvYCC_de_gamma_COM_Sub,  //178
PQ_IP_XVYCC_DE_GAMMA_SRAM_COM_Sub,  //179
PQ_IP_xvYCC_de_gamma_dither_COM_Sub,  //180
PQ_IP_xvYCC_3x3_COM_Sub,  //181
PQ_IP_xvYCC_Comp_COM_Sub,  //182
PQ_IP_xvYCC_Comp_dither_COM_Sub,  //183
PQ_IP_xvYCC_Clip_COM_Sub,  //184
PQ_IP_xvYCC_gamma_COM_Sub,  //185
PQ_IP_XVYCC_GAMMA_SRAM_COM_Sub,  //186
PQ_IP_xvYCC_gamma_dither_COM_Sub,  //187
PQ_IP_rgb_3d_COM_Sub,  //188
PQ_IP_HBC_COM_Sub,  //189
PQ_IP_Pre_CON_BRI_COM_Sub,  //190
PQ_IP_Blue_Stretch_COM_Sub,  //191
PQ_IP_Blue_Stretch_dither_COM_Sub,  //192
PQ_IP_Gamma_COM_Sub,  //193
PQ_IP_Gamma_dither_COM_Sub,  //194
PQ_IP_Post_CON_BRI_COM_Sub,  //195
PQ_IP_Clone_main_no_comm_COM_Sub,  //196
PQ_IP_Clone_sub_no_comm_COM_Sub,  //197
PQ_IP_MWE_diff_no_comm_COM_Sub,  //198
PQ_IP_3DSettingForLBL_no_comm_COM_Sub,  //199
PQ_IP_SettingFor2LineMode_no_comm_COM_Sub,  //200
PQ_IP_COM_NUMS_Sub
} PQ_IP_COM_Group_Sub;
...
PQ_IP_PreFilter_FIR40_Sub,
PQ_IP_PreFilter_FIR45_Sub,
PQ_IP_PreFilter_FIR50_Sub,
PQ_IP_PreFilter_FIR60_Sub,
PQ_IP_PreFilter_FIR66_Sub,
PQ_IP_PreFilter_FIR75_Sub,
PQ_IP_PreFilter_FIR80_Sub,
PQ_IP_PreFilter_FIR85_Sub,
PQ_IP_PreFilter_FIR90_Sub,
PQ_IP_PreFilter_FIR95_Sub,
...
PQ_IP_HSD_Y_OFF_Sub,
PQ_IP_HSD_Y_CB_Sub,
PQ_IP_HSD_Y_LpfFc40Ap0As40_Sub,
PQ_IP_HSD_Y_LpfFc50Ap0As40_Sub,
PQ_IP_HSD_Y_LpfFc60Ap0As35_Sub,
PQ_IP_HSD_Y_LpfFc70Ap0As35_Sub,
PQ_IP_HSD_Y_LpfFc80Ap0As35_Sub,
PQ_IP_HSD_Y_LpfFc90Ap0As35_Sub,
...
PQ_IP_HSD_C_OFF_Sub,
PQ_IP_HSD_C_CB_Sub,
PQ_IP_HSD_C_LpfFc15Ap0As45_Sub,
PQ_IP_HSD_C_LpfFc15Ap0As55_Sub,
...
PQ_IP_PreSNR_Patch_PSP_1_Sub,
PQ_IP_PreSNR_Patch_PSP_2_Sub,
...
PQ_IP_DNR_Y_COLOR_DEP_DYCD_1_Sub,
...
PQ_IP_DNR_Y_LUMA_ADAPTIVE_DYP_1_Sub,
PQ_IP_DNR_Y_LUMA_ADAPTIVE_DYP_2_Sub,
...
PQ_IP_PostCCS_VD_6R_3_Sub,
PQ_IP_PostCCS_VD_6R_6_Sub,
PQ_IP_PostCCS_HDMI_6R_3_Sub,
PQ_IP_PostCCS_HDMI_6R_6_Sub,
PQ_IP_PostCCS_VD_8R_3_Sub,
PQ_IP_PostCCS_VD_8R_6_Sub,
PQ_IP_PostCCS_VD_8R_7_Sub,
PQ_IP_PostCCS_VD_8R_8_Sub,
PQ_IP_PostCCS_HDMI_8R_3_Sub,
PQ_IP_PostCCS_HDMI_8R_6_Sub,
PQ_IP_PostCCS_HDMI_8R_7_Sub,
PQ_IP_PostCCS_SD_ONLY_REF_YEDGE_Sub,
...
PQ_IP_DHD_VD_6R_6_Sub,
PQ_IP_DHD_VD_6R_7_Sub,
PQ_IP_DHD_VD_8R_3_Sub,
PQ_IP_DHD_VD_8R_6_Sub,
PQ_IP_DHD_VD_8R_7_Sub,
PQ_IP_DHD_HDMI_6R_3_Sub,
PQ_IP_DHD_HDMI_6R_6_Sub,
PQ_IP_DHD_HDMI_8R_3_Sub,
PQ_IP_DHD_HDMI_8R_6_Sub,
PQ_IP_DHD_YPbPr_6R_6_Sub,
PQ_IP_DHD_VD_6R_HD_3_Sub,
PQ_IP_DHD_VD_6R_HD_6_Sub,
PQ_IP_DHD_VD_8R_HD_3_Sub,
PQ_IP_DHD_VD_8R_HD_6_Sub,
PQ_IP_DHD_HDMI_6R_HD_3_Sub,
PQ_IP_DHD_HDMI_6R_HD_6_Sub,
PQ_IP_DHD_HDMI_8R_HD_3_Sub,
PQ_IP_DHD_HDMI_8R_HD_6_Sub,
PQ_IP_DHD_NUMS_Sub
} PQ_IP_DHD_Group_Sub;
...
PQ_IP_SPF_DBK_BKN_T0_Jay_Sub,
PQ_IP_SPF_DBK_BKN_T1_Jay_Sub,
PQ_IP_SPF_DBK_BKN_T2_Jay_Sub,
PQ_IP_SPF_DBK_BKN_AVN1_Sub,
PQ_IP_SPF_DBK_BKN_AVN2_Sub,
PQ_IP_SPF_DBK_BKN_AVP1_Sub,
PQ_IP_SPF_DBK_BKN_AVP2_Sub,
PQ_IP_SPF_DBK_BKN_2xsampling_Sub,
PQ_IP_SPF_DBK_BKN_C0_Sub,
PQ_IP_SPF_DBK_BKN_C1_Sub,
PQ_IP_SPF_DBK_BKN_C2_Sub,
PQ_IP_SPF_DBK_BKN_AVN0_Sub,
PQ_IP_SPF_DBK_BKN_AVP0_Sub,
PQ_IP_SPF_DBK_BKN_D1_Sub,
PQ_IP_SPF_DBK_BKN_A1_Sub,
PQ_IP_SPF_DBK_BKN_C2N_Sub,
...
typedef enum
{
PQ_IP_SPF_DBK_STAT_OFF_Sub,
PQ_IP_SPF_DBK_STAT_SD_Sub,
PQ_IP_SPF_DBK_STAT_HD_Sub,
PQ_IP_SPF_DBK_STAT_SR_Sub,
PQ_IP_SPF_DBK_STAT_NUMS_Sub
} PQ_IP_SPF_DBK_STAT_Group_Sub;
...
PQ_IP_SPF_NMR_C_NewIP_SPF_NMR_C0_Sub,
...
PQ_IP_DMS_H_S2_Sub,
PQ_IP_DMS_H_S3_Sub,
PQ_IP_DMS_H_DTV_S1_Sub,
PQ_IP_DMS_H_DTV_S2_Sub,
PQ_IP_DMS_H_DTV_S3_Sub,
...
PQ_IP_VIP_Pre_Ygain_dither_ON_Sub,
...
PQ_IP_VIP_VLPF_dither_ON_Sub,
PQ_IP_VIP_VLPF_dither_NUMS_Sub
} PQ_IP_VIP_VLPF_dither_Group_Sub;

typedef enum
{
PQ_IP_VIP_4K2K_OFF_Sub,
PQ_IP_VIP_4K2K_4K2K_Sub,
PQ_IP_VIP_4K2K_NUMS_Sub
} PQ_IP_VIP_4K2K_Group_Sub;
...
PQ_IP_VIP_Peaking_dering_W0_R0_Sub,
...
typedef enum
{
PQ_IP_VIP_Peaking_Pcoring_ad_C_OFF_Sub,
PQ_IP_VIP_Peaking_Pcoring_ad_C_T1_Sub,
PQ_IP_VIP_Peaking_Pcoring_ad_C_T2_Sub,
PQ_IP_VIP_Peaking_Pcoring_ad_C_T3_Sub,
PQ_IP_VIP_Peaking_Pcoring_ad_C_T4_Sub,
PQ_IP_VIP_Peaking_Pcoring_ad_C_T5_Sub,
PQ_IP_VIP_Peaking_Pcoring_ad_C_T6_Sub,
PQ_IP_VIP_Peaking_Pcoring_ad_C_NewIP_VIP_Peaking_Pcoring_ad_C0_Sub,
PQ_IP_VIP_Peaking_Pcoring_ad_C_NUMS_Sub
} PQ_IP_VIP_Peaking_Pcoring_ad_C_Group_Sub;
...
PQ_IP_VIP_IHC_CRD_SRAM_15win3_stronggain_Sub,
...
PQ_IP_VIP_IHC_SETTING_HD_1080i_Sub,
PQ_IP_VIP_IHC_SETTING_HDMI_1080_Sub,
PQ_IP_VIP_IHC_SETTING_HDMI_HD_Sub,
PQ_IP_VIP_IHC_SETTING_4K2K_Sub,
...
PQ_IP_VIP_ICC_NewIP_VIP_ICC0_Sub,
...
PQ_IP_VIP_ICC_SETTING_HD_1080_Sub,
PQ_IP_VIP_ICC_SETTING_HDMI_1080_Sub,
...
typedef enum
{
PQ_IP_VIP_BWLE_OFF_Sub,
PQ_IP_VIP_BWLE_ON_Sub,
PQ_IP_VIP_BWLE_NUMS_Sub
} PQ_IP_VIP_BWLE_Group_Sub;
...
PQ_IP_VIP_BLE_NewIP_VIP_BLE0_Sub,
...
typedef enum
{
PQ_IP_XVYCC_DE_GAMMA_SRAM_XVYCC_Sub,
PQ_IP_XVYCC_DE_GAMMA_SRAM_ADOBE_Sub,
PQ_IP_XVYCC_DE_GAMMA_SRAM_SRGB_Sub,
PQ_IP_XVYCC_DE_GAMMA_SRAM_NUMS_Sub
} PQ_IP_XVYCC_DE_GAMMA_SRAM_Group_Sub;
...
typedef enum
{
PQ_IP_XVYCC_GAMMA_SRAM_XVYCC_Sub,
PQ_IP_XVYCC_GAMMA_SRAM_ADOBE_Sub,
PQ_IP_XVYCC_GAMMA_SRAM_SRGB_Sub,
PQ_IP_XVYCC_GAMMA_SRAM_NUMS_Sub
} PQ_IP_XVYCC_GAMMA_SRAM_Group_Sub;
...
PQ_IP_Blue_Stretch_dither_ON_Sub,
...
typedef enum
{
PQ_IP_Clone_sub_no_comm_OFF_Sub,
PQ_IP_Clone_sub_no_comm_NUMS_Sub
} PQ_IP_Clone_sub_no_comm_Group_Sub;
