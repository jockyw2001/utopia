...
#define PQ_GRULE_XVYCC_ENABLE 1
#define PQ_GRULE_GAME_MODE_ENABLE 1
#define PQ_GRULE_DEFINE_AUTO_GEN 1
#if (PQ_GRULE_NR_ENABLE) || (PQ_GRULE_OSD_BW_ENABLE) || (PQ_GRULE_MPEG_NR_ENABLE) || (PQ_GRULE_FILM_MODE_ENABLE) || (PQ_GRULE_DYNAMIC_CONTRAST_ENABLE) || (PQ_GRULE_ULTRAT_CLEAR_ENABLE) || (PQ_GRULE_PTP_ENABLE) || (PQ_GRULE_XVYCC_ENABLE) || (PQ_GRULE_GAME_MODE_ENABLE)
typedef enum
{
...
typedef enum
{
    PQ_GRule_XVYCC_Normal_Main,
    PQ_GRule_XVYCC_On_xvYCC_Main,
    PQ_GRule_XVYCC_On_sRGB_Main,
}
MST_GRule_XVYCC_Index_Main;
#endif
...
typedef enum
{
    PQ_GRule_Lvl_XVYCC_Normal_Main,
    PQ_GRule_Lvl_XVYCC_On_xvYCC_Main,
    PQ_GRule_Lvl_XVYCC_On_sRGB_Main,
}
MST_GRule_XVYCC_LvL_Index_Main;
#endif
...
#define PQ_GRULE_RULE_NUM_Main 9
...
#if PQ_GRULE_XVYCC_ENABLE
#define PQ_GRULE_XVYCC_IP_NUM_Main 5
#define PQ_GRULE_XVYCC_NUM_Main 3
#define PQ_GRULE_XVYCC_LVL_NUM_Main 3
#endif
...
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_XVYCC_IP_Index_Main[PQ_GRULE_XVYCC_IP_NUM_Main];
extern code U8 MST_GRule_XVYCC_Main[QM_INPUTTYPE_NUM_Main][PQ_GRULE_XVYCC_NUM_Main][PQ_GRULE_XVYCC_IP_NUM_Main];
#endif
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_1920_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_1920_PIP_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_1920_POP_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_1366_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_1366_PIP_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_1366_POP_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_4K2K_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
...
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_4K2K_PIP_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_ULTRAT_CLEAR_ENABLE
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_4K2K_PIP_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
...
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_4K2K_POP_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_ULTRAT_CLEAR_ENABLE
...
#endif
#if PQ_GRULE_XVYCC_ENABLE
extern code U8 MST_GRule_4K2K_POP_XVYCC_Main[PQ_GRULE_XVYCC_LVL_NUM_Main];
#endif
#if PQ_GRULE_GAME_MODE_ENABLE
