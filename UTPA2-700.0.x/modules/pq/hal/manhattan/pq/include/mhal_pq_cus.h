...
//because manhattan use SC1 main as "sub" so ,main2 pq map generate sub pq map,
//but main2 has not define PQ_IP_DMS_V_12L_Sub, so define it here to avoid modifying drvPQ.c
#define PQ_IP_DMS_V_12L_Sub 0xFFFF 
