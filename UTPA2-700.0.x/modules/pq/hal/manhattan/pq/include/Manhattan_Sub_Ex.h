...
#ifndef _MANHATTAN_SUB_EX_H_
#define _MANHATTAN_SUB_EX_H_

#define PQ_IP_NUM_Sub_Ex 19
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_FP_720p_Sub_Ex, //63
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080i_50hz_Sub_Ex, //64
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080i_60hz_Sub_Ex, //65
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080p_24hz_Sub_Ex, //66
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080p_60hz_Sub_Ex, //67
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080p_50hz_Sub_Ex, //68
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_FP_1080i_Sub_Ex, //69
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_FP_1080p_Sub_Ex, //70
    #endif
    #if PQ_QM_HMDI
    QM_4K2K_24Hz_Sub_Ex, //71
    #endif
    #if PQ_QM_HMDI
    QM_4K2K_30Hz_Sub_Ex, //72
    #endif
    #if PQ_QM_HMDI
    QM_4K2K_60Hz_Sub_Ex, //73
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vup_Sub_Ex, //74
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vdown_Sub_Ex, //75
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vno_Sub_Ex, //76
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vup_Sub_Ex, //77
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vdown_Sub_Ex, //78
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vno_Sub_Ex, //79
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vup_Sub_Ex, //80
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vdown_Sub_Ex, //81
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vno_Sub_Ex, //82
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vno_4K_Sub_Ex, //83
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vup_Sub_Ex, //84
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vdown_Sub_Ex, //85
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vno_Sub_Ex, //86
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vup_Sub_Ex, //87
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vdown_Sub_Ex, //88
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vno_Sub_Ex, //89
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vup_Sub_Ex, //90
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vdown_Sub_Ex, //91
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vno_Sub_Ex, //92
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vup_Sub_Ex, //93
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vdown_Sub_Ex, //94
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vno_Sub_Ex, //95
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vup_Sub_Ex, //96
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vdown_Sub_Ex, //97
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vno_Sub_Ex, //98
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vup_Sub_Ex, //99
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vdown_Sub_Ex, //100
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_Sub_Ex, //101
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_4K_Sub_Ex, //102
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_MPEG2_Sub_Ex, //103
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_MPEG2_Sub_Ex, //104
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_MPEG2_Sub_Ex, //105
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_MPEG2_Sub_Ex, //106
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_MPEG2_Sub_Ex, //107
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_MPEG2_Sub_Ex, //108
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_MPEG2_Sub_Ex, //109
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_MPEG2_Sub_Ex, //110
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_MPEG2_Sub_Ex, //111
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_MPEG2_Sub_Ex, //112
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_MPEG2_Sub_Ex, //113
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_MPEG2_Sub_Ex, //114
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_MPEG2_Sub_Ex, //115
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_MPEG2_Sub_Ex, //116
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_60Hz_MPEG2_Sub_Ex, //117
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_H264_Sub_Ex, //118
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_H264_Sub_Ex, //119
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_H264_Sub_Ex, //120
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_H264_Sub_Ex, //121
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_H264_Sub_Ex, //122
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_H264_Sub_Ex, //123
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_H264_Sub_Ex, //124
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_H264_Sub_Ex, //125
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_H264_Sub_Ex, //126
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_H264_Sub_Ex, //127
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_H264_Sub_Ex, //128
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_H264_Sub_Ex, //129
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_H264_Sub_Ex, //130
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_H264_Sub_Ex, //131
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_60Hz_H264_Sub_Ex, //132
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Sub_Ex, //133
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Sub_Ex, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Sub_Ex, //135
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Sub_Ex, //136
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Sub_Ex, //137
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Sub_Ex, //138
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Sub_Ex, //139
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Sub_Ex, //140
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_interlace_Sub_Ex, //141
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_Sub_Ex, //142
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_24hz_Sub_Ex, //143
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_interlace_Sub_Ex, //144
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_Sub_Ex, //145
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_24hz_Sub_Ex, //146
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Sub_Ex, //147
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Photo_Sub_Ex, //148
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_60Hz_Sub_Ex, //149
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_non_4K2K_Sub_Ex, //150
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Sub_Ex, //151
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Sub_Ex, //152
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Sub_Ex, //153
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Sub_Ex, //154
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_4K2K_FS_progressive_Sub_Ex, //155
    #endif
    QM_INPUTTYPE_NUM_Sub_Ex, // 156
...
PQ_IP_VIP_LDE_setting_Sub_Ex,  //8
PQ_IP_VIP_LDE_suppress_Sub_Ex,  //9
PQ_IP_VIP_Peaking_alpha_MIN_Sub_Ex,  //10
PQ_IP_VIP_Peaking_gain_by_Cedge_Sub_Ex,  //11
PQ_IP_VIP_Peaking_V_dering_LPF_Sub_Ex,  //12
PQ_IP_VIP_Peaking_V_dering_Adpt_Sub_Ex,  //13
PQ_IP_VIP_Peaking_V_dering_Table_Sub_Ex,  //14
PQ_IP_VIP_Post_SNR_Sub_Ex,  //15
PQ_IP_VIP_ICC_Target_Sub_Ex,  //16
PQ_IP_VIP_IBC_weight_Sub_Ex,  //17
PQ_IP_VIP_ACK_Sub_Ex,  //18
 }   PQ_IPTYPE_Sub_Ex;
...
PQ_IP_VIP_LDE_setting_COM_Sub_Ex,  //8
PQ_IP_VIP_LDE_suppress_COM_Sub_Ex,  //9
PQ_IP_VIP_Peaking_alpha_MIN_COM_Sub_Ex,  //10
PQ_IP_VIP_Peaking_gain_by_Cedge_COM_Sub_Ex,  //11
PQ_IP_VIP_Peaking_V_dering_LPF_COM_Sub_Ex,  //12
PQ_IP_VIP_Peaking_V_dering_Adpt_COM_Sub_Ex,  //13
PQ_IP_VIP_Peaking_V_dering_Table_COM_Sub_Ex,  //14
PQ_IP_VIP_Post_SNR_COM_Sub_Ex,  //15
PQ_IP_VIP_ICC_Target_COM_Sub_Ex,  //16
PQ_IP_VIP_IBC_weight_COM_Sub_Ex,  //17
PQ_IP_VIP_ACK_COM_Sub_Ex,  //18
...
typedef enum
{
PQ_IP_VIP_LDE_setting_S1_Sub_Ex,
PQ_IP_VIP_LDE_setting_NUMS_Sub_Ex
} PQ_IP_VIP_LDE_setting_Group_Sub_Ex;

typedef enum
{
PQ_IP_VIP_LDE_suppress_S1_Sub_Ex,
PQ_IP_VIP_LDE_suppress_NUMS_Sub_Ex
} PQ_IP_VIP_LDE_suppress_Group_Sub_Ex;
