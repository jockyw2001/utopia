...
#ifndef _MUJI_MAIN_COLOR_H_
#define _MUJI_MAIN_COLOR_H_
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vup_Main_Color, //83
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vdown_Main_Color, //84
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vno_Main_Color, //85
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vup_Main_Color, //86
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vdown_Main_Color, //87
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vno_Main_Color, //88
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vup_Main_Color, //89
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vdown_Main_Color, //90
    #endif
    #if PQ_QM_PC
    QM_HDMI_422_PC_Hno_Vno_Main_Color, //91
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vup_Main_Color, //92
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vdown_Main_Color, //93
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vno_Main_Color, //94
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vup_Main_Color, //95
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vdown_Main_Color, //96
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vno_Main_Color, //97
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vup_Main_Color, //98
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vdown_Main_Color, //99
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_Main_Color, //100
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_MPEG2_Main_Color, //101
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_MPEG2_Main_Color, //102
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_MPEG2_Main_Color, //103
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_MPEG2_Main_Color, //104
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_MPEG2_Main_Color, //105
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_MPEG2_Main_Color, //106
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_MPEG2_Main_Color, //107
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_MPEG2_Main_Color, //108
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_MPEG2_Main_Color, //109
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_MPEG2_Main_Color, //110
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_MPEG2_Main_Color, //111
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_MPEG2_Main_Color, //112
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_MPEG2_Main_Color, //113
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_MPEG2_Main_Color, //114
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_60Hz_MPEG2_Main_Color, //115
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_H264_Main_Color, //116
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_H264_Main_Color, //117
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_H264_Main_Color, //118
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_H264_Main_Color, //119
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_H264_Main_Color, //120
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_H264_Main_Color, //121
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_H264_Main_Color, //122
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_H264_Main_Color, //123
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_H264_Main_Color, //124
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_H264_Main_Color, //125
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_H264_Main_Color, //126
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_H264_Main_Color, //127
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_H264_Main_Color, //128
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_H264_Main_Color, //129
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_60Hz_H264_Main_Color, //130
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Main_Color, //131
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Main_Color, //132
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Main_Color, //133
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Main_Color, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Main_Color, //135
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Main_Color, //136
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Main_Color, //137
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Main_Color, //138
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_interlace_Main_Color, //139
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_Main_Color, //140
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_24hz_Main_Color, //141
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_interlace_Main_Color, //142
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_Main_Color, //143
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_24hz_Main_Color, //144
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Main_Color, //145
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_60Hz_Main_Color, //146
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_non_4K2K_Main_Color, //147
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Main_Color, //148
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Main_Color, //149
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Main_Color, //150
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Main_Color, //151
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_4K2K_FS_progressive_Main_Color, //152
    #endif
    QM_INPUTTYPE_NUM_Main_Color, // 153
} SC_QUALITY_MAP_INDEX_e_Main_Color;

typedef enum
{
PQ_IP_VIP_FCC_T1_Main_Color,  //0
PQ_IP_VIP_FCC_T2_Main_Color,  //1
PQ_IP_VIP_FCC_T3_Main_Color,  //2
PQ_IP_VIP_FCC_T4_Main_Color,  //3
PQ_IP_VIP_FCC_T5_Main_Color,  //4
PQ_IP_VIP_FCC_T6_Main_Color,  //5
PQ_IP_VIP_FCC_T7_Main_Color,  //6
PQ_IP_VIP_FCC_T8_Main_Color,  //7
PQ_IP_VIP_FCC_T9_Main_Color,  //8
PQ_IP_VIP_IHC_Main_Color,  //9
PQ_IP_VIP_IHC_Ymode_Main_Color,  //10
PQ_IP_VIP_IHC_SETTING_Main_Color,  //11
PQ_IP_VIP_ICC_Main_Color,  //12
PQ_IP_VIP_ICC_Ymode_Main_Color,  //13
PQ_IP_VIP_ICC_SETTING_Main_Color,  //14
PQ_IP_VIP_Ymode_Yvalue_ALL_Main_Color,  //15
PQ_IP_VIP_Ymode_Yvalue_SETTING_Main_Color,  //16
PQ_IP_VIP_IBC_Main_Color,  //17
PQ_IP_VIP_IBC_SETTING_Main_Color,  //18
PQ_IP_VIP_Post_Cgain_Main_Color,  //19
...
typedef enum
{
PQ_IP_VIP_FCC_T1_COM_Main_Color,  //0
PQ_IP_VIP_FCC_T2_COM_Main_Color,  //1
PQ_IP_VIP_FCC_T3_COM_Main_Color,  //2
PQ_IP_VIP_FCC_T4_COM_Main_Color,  //3
PQ_IP_VIP_FCC_T5_COM_Main_Color,  //4
PQ_IP_VIP_FCC_T6_COM_Main_Color,  //5
PQ_IP_VIP_FCC_T7_COM_Main_Color,  //6
PQ_IP_VIP_FCC_T8_COM_Main_Color,  //7
PQ_IP_VIP_FCC_T9_COM_Main_Color,  //8
PQ_IP_VIP_IHC_COM_Main_Color,  //9
PQ_IP_VIP_IHC_Ymode_COM_Main_Color,  //10
PQ_IP_VIP_IHC_SETTING_COM_Main_Color,  //11
PQ_IP_VIP_ICC_COM_Main_Color,  //12
PQ_IP_VIP_ICC_Ymode_COM_Main_Color,  //13
PQ_IP_VIP_ICC_SETTING_COM_Main_Color,  //14
PQ_IP_VIP_Ymode_Yvalue_ALL_COM_Main_Color,  //15
PQ_IP_VIP_Ymode_Yvalue_SETTING_COM_Main_Color,  //16
PQ_IP_VIP_IBC_COM_Main_Color,  //17
PQ_IP_VIP_IBC_SETTING_COM_Main_Color,  //18
PQ_IP_VIP_Post_Cgain_COM_Main_Color,  //19
...
PQ_IP_VIP_FCC_T1_S1_Main_Color,
PQ_IP_VIP_FCC_T1_S4_Main_Color,
PQ_IP_VIP_FCC_T1_S2_Main_Color,
PQ_IP_VIP_FCC_T1_S8_Main_Color,
...
PQ_IP_VIP_FCC_T1_testa_Main_Color,
PQ_IP_VIP_FCC_T1_testb_Main_Color,
PQ_IP_VIP_FCC_T1_testc_Main_Color,
PQ_IP_VIP_FCC_T1_testd_Main_Color,
PQ_IP_VIP_FCC_T1_teste_Main_Color,
PQ_IP_VIP_FCC_T1_testf_Main_Color,
...
PQ_IP_VIP_FCC_T1_test1a_Main_Color,
PQ_IP_VIP_FCC_T1_test1b_Main_Color,
...
PQ_IP_VIP_ICC_SETTING_Enhance_6Color_Main_Color,
...
PQ_IP_VIP_Peaking_band_HDMI_4K2K_Main_Color,
PQ_IP_VIP_Peaking_band_HDMI_4K2K_4K2K_Main_Color,
...
PQ_IP_VIP_Peaking_band_MM_4K2K_Main_Color,
PQ_IP_VIP_Peaking_band_MM_4K2K_4K2K_Main_Color,
PQ_IP_VIP_Peaking_band_Online_SD_Main_Color,
PQ_IP_VIP_Peaking_band_Online_HD_Main_Color,
PQ_IP_VIP_Peaking_band_NewIP_VIP_Peaking_band0_Main_Color,
PQ_IP_VIP_Peaking_band_NewIP_VIP_Peaking_band1_Main_Color,
PQ_IP_VIP_Peaking_band_NewIP_VIP_Peaking_band2_Main_Color,
PQ_IP_VIP_Peaking_band_NewIP_VIP_Peaking_band3_Main_Color,
...
PQ_IP_VIP_Peaking_Pcoring_SEC1_Main_Color,
PQ_IP_VIP_Peaking_Pcoring_SEC2_Main_Color,
PQ_IP_VIP_Peaking_Pcoring_SEC3_Main_Color,
