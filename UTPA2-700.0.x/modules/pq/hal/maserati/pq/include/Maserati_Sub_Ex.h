...
#ifndef _MASERATI_SUB_EX_H_
#define _MASERATI_SUB_EX_H_

#define PQ_IP_NUM_Sub_Ex 11
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vup_Sub_Ex, //73
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vdown_Sub_Ex, //74
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vno_Sub_Ex, //75
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vup_Sub_Ex, //76
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vdown_Sub_Ex, //77
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vno_Sub_Ex, //78
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vup_Sub_Ex, //79
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vdown_Sub_Ex, //80
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vno_Sub_Ex, //81
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vup_Sub_Ex, //82
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vdown_Sub_Ex, //83
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vno_Sub_Ex, //84
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vup_Sub_Ex, //85
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vdown_Sub_Ex, //86
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vno_Sub_Ex, //87
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vup_Sub_Ex, //88
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vdown_Sub_Ex, //89
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vno_Sub_Ex, //90
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vup_Sub_Ex, //91
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vdown_Sub_Ex, //92
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vno_Sub_Ex, //93
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vup_Sub_Ex, //94
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vdown_Sub_Ex, //95
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vno_Sub_Ex, //96
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vup_Sub_Ex, //97
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vdown_Sub_Ex, //98
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_Sub_Ex, //99
    #endif
    #if PQ_QM_DTV
    ...
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Sub_Ex, //126
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Sub_Ex, //127
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Sub_Ex, //128
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Sub_Ex, //129
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Sub_Ex, //130
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Sub_Ex, //131
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Sub_Ex, //132
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Sub_Ex, //133
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_interlace_Sub_Ex, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_Sub_Ex, //135
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_24hz_Sub_Ex, //136
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_interlace_Sub_Ex, //137
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_Sub_Ex, //138
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_24hz_Sub_Ex, //139
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Sub_Ex, //140
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Sub_Ex, //141
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Sub_Ex, //142
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Sub_Ex, //143
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Sub_Ex, //144
    #endif
    QM_INPUTTYPE_NUM_Sub_Ex, // 145
} SC_QUALITY_MAP_INDEX_e_Sub_Ex;

typedef enum
{
PQ_IP_AFEC_no_comm_Sub_Ex,  //0
PQ_IP_HISDNR_Sub_Ex,  //1
PQ_IP_SPF_DBK_Sub_Ex,  //2
PQ_IP_DMS_Sub_Ex,  //3
PQ_IP_DMS_H_Sub_Ex,  //4
PQ_IP_VIP_Peaking_adptive_Sub_Ex,  //5
PQ_IP_VIP_Peaking_Pcoring_ad_C_Sub_Ex,  //6
PQ_IP_VIP_Peaking_gain_by_Cedge_Sub_Ex,  //7
PQ_IP_VIP_ICC_Target_Sub_Ex,  //8
PQ_IP_VIP_IBC_weight_Sub_Ex,  //9
PQ_IP_VIP_ACK_Sub_Ex,  //10
 }   PQ_IPTYPE_Sub_Ex;

typedef enum
{
PQ_IP_AFEC_no_comm_COM_Sub_Ex,  //0
PQ_IP_HISDNR_COM_Sub_Ex,  //1
PQ_IP_SPF_DBK_COM_Sub_Ex,  //2
PQ_IP_DMS_COM_Sub_Ex,  //3
PQ_IP_DMS_H_COM_Sub_Ex,  //4
PQ_IP_VIP_Peaking_adptive_COM_Sub_Ex,  //5
PQ_IP_VIP_Peaking_Pcoring_ad_C_COM_Sub_Ex,  //6
PQ_IP_VIP_Peaking_gain_by_Cedge_COM_Sub_Ex,  //7
PQ_IP_VIP_ICC_Target_COM_Sub_Ex,  //8
PQ_IP_VIP_IBC_weight_COM_Sub_Ex,  //9
PQ_IP_VIP_ACK_COM_Sub_Ex,  //10
...
typedef enum
{
PQ_IP_HISDNR_OFF_Sub_Ex,
PQ_IP_HISDNR_ON_Sub_Ex,
PQ_IP_HISDNR_NUMS_Sub_Ex
} PQ_IP_HISDNR_Group_Sub_Ex;
...
typedef enum
{
PQ_IP_DMS_H_J0_Sub_Ex,
PQ_IP_DMS_H_J1_Sub_Ex,
...
typedef enum
{
PQ_IP_VIP_IBC_weight_W6_Sub_Ex,
PQ_IP_VIP_IBC_weight_W8_Sub_Ex,
