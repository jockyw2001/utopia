...
#if (PQ_GRULE_NR_ENABLE) || (PQ_GRULE_OSD_BW_ENABLE) || (PQ_GRULE_MPEG_NR_ENABLE) || (PQ_GRULE_FILM_MODE_ENABLE) || (PQ_GRULE_PTP_ENABLE)
typedef enum
{
...
#define PQ_GRULE_RULE_NUM_Sub 5

#if PQ_GRULE_NR_ENABLE
#define PQ_GRULE_NR_IP_NUM_Sub 7
#define PQ_GRULE_NR_NUM_Sub 19
#define PQ_GRULE_NR_LVL_NUM_Sub 13
#endif

#if PQ_GRULE_OSD_BW_ENABLE
#define PQ_GRULE_OSD_BW_IP_NUM_Sub 4
#define PQ_GRULE_OSD_BW_NUM_Sub 9
#define PQ_GRULE_OSD_BW_LVL_NUM_Sub 1
#endif

#if PQ_GRULE_MPEG_NR_ENABLE
#define PQ_GRULE_MPEG_NR_IP_NUM_Sub 2
