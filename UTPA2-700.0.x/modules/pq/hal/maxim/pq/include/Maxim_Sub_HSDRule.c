...
code U8 MST_HSDRule_Array_Sub[PQ_HSDRule_NUM_Sub][PQ_HSDRule_IP_NUM_Sub]=
{
    ...
    {//ScalingDown_04x_YUV, 10
        PQ_IP_HSD_Y_LpfFc40Ap0As40_Sub, PQ_IP_HSD_C_LpfFc15Ap0As45_Sub, 
    },
    {//ScalingDown_04x_RGB, 11
        PQ_IP_HSD_Y_CB_Sub, PQ_IP_HSD_C_CB_Sub, 
    },
    {//ScalingDown_05x_YUV, 12
        PQ_IP_HSD_Y_LpfFc50Ap0As40_Sub, PQ_IP_HSD_C_LpfFc15Ap0As45_Sub, 
    },
    {//ScalingDown_05x_RGB, 13
        PQ_IP_HSD_Y_CB_Sub, PQ_IP_HSD_C_CB_Sub, 
    },
    {//ScalingDown_06x_YUV, 14
        PQ_IP_HSD_Y_LpfFc60Ap0As35_Sub, PQ_IP_HSD_C_LpfFc15Ap0As45_Sub, 
    },
    {//ScalingDown_06x_RGB, 15
        PQ_IP_HSD_Y_CB_Sub, PQ_IP_HSD_C_CB_Sub, 
    },
    {//ScalingDown_07x_YUV, 16
        PQ_IP_HSD_Y_LpfFc70Ap0As35_Sub, PQ_IP_HSD_C_LpfFc15Ap0As45_Sub, 
    },
    {//ScalingDown_07x_RGB, 17
        PQ_IP_HSD_Y_CB_Sub, PQ_IP_HSD_C_CB_Sub, 
    },
    {//ScalingDown_08x_YUV, 18
        PQ_IP_HSD_Y_LpfFc80Ap0As35_Sub, PQ_IP_HSD_C_LpfFc15Ap0As45_Sub, 
    },
    {//ScalingDown_08x_RGB, 19
        PQ_IP_HSD_Y_CB_Sub, PQ_IP_HSD_C_CB_Sub, 
    },
    {//ScalingDown_09x_YUV, 20
        PQ_IP_HSD_Y_LpfFc90Ap0As35_Sub, PQ_IP_HSD_C_LpfFc15Ap0As45_Sub, 
    },
    {//ScalingDown_09x_RGB, 21
        PQ_IP_HSD_Y_CB_Sub, PQ_IP_HSD_C_CB_Sub, 
    },
    {//ScalingDown_10x_YUV, 22
        PQ_IP_HSD_Y_ALLPASS1X_Sub, PQ_IP_HSD_C_ALLPASS1X_Sub, 
    },
