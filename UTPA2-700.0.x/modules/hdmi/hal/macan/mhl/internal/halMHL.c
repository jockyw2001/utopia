...
MS_U8 ucChipIDValue = MHL_CHIP_ID_MANHATTAN;
...
void _mhal_mhl_CbusAndClockSelect(void)
{
    ...
    if(GET_MHL_PATH_SUPPORT_PORTA())
    {
		W2BYTEMSK(REG_PM_MHL_CBUS_21, 0, BIT(11));
...
void _mhal_mhl_ECbusInitialSetting(void)
{
    ...
    W2BYTEMSK(REG_MHL_ECBUS_79, (_mhal_mhl_GetEMSCTwoByteCRC(1, 1) << 3)| (_mhal_mhl_GetEMSCTwoByteCRC(1, 2) << 6), BMASK(8:6)| BMASK(5:3)); // [8:6]:EMSC errsum cmd CRC, [5:3]:EMSC errCRC cmd CRC
...
void mhal_mhl_LoadEDID(MS_U8 *edid)
{
    ...
    {
        // Load EDID
        msg_mhl(printf("** Manhattan Load MHL EDID...\r\n"));
...
void mhal_mhl_ReadEDID(MS_U16 usSize, MS_U8 *edid)
{
    ...
    {
        // Read EDID
        msg_mhl(printf("** Manhattan Read MHL EDID...\r\n"));
...
void mhal_mhl_LoadDeviceCapability(MS_U8 *devcap)
{
    ...
    if(devcap != NULL)
    {
        msg_mhl(printf("** Manhattan Load DevCap...\r\n"));
