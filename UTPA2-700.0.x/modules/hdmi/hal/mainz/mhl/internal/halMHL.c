...
MS_U8 ucIControlValue = MHL_ICONTROL_PD_VALUE;
MS_U8 ucImpedanceValue = MHL_IMPEDANCE_VALUE;
MS_U8 ucChipIDValue = MHL_CHIP_ID_MESSI;
    ...
    switch(ucCbusSelect)
    {
        ...
        case MHL_CBUS_SELECT_PORTA:
            if(GET_MHL_PATH_SUPPORT_PORTA())
            {
                ...
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BMASK(2:0));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BIT(3));// clock R-term
                }
                else if (rctrl == RX_MHL_RTERM)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, BIT(2), BMASK(2:0));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BIT(3));// clock R-term
                }
                else if (rctrl == RX_RTERM_OFF)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, BMASK(2:0), BMASK(2:0));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, BIT(3), BIT(3));// clock R-term
                }
            }
        ...
        case MHL_CBUS_SELECT_PORTB:
            if(GET_MHL_PATH_SUPPORT_PORTB())
            {
                if (rctrl == RX_HDMI_RTERM)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BMASK(6:4));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BIT(7));// clock R-term
                }
                else if (rctrl == RX_MHL_RTERM)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, BIT(6), BMASK(6:4));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BIT(7));// clock R-term
                }
                else if (rctrl == RX_RTERM_OFF)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, BMASK(6:4), BMASK(6:4));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, BIT(7), BIT(7));// clock R-term
                }
            }
        ...
        case MHL_CBUS_SELECT_PORTC:
            if(GET_MHL_PATH_SUPPORT_PORTC())
            {
                if (rctrl == RX_HDMI_RTERM)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BMASK(10:8));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BIT(11));// clock R-term
                }
                else if (rctrl == RX_MHL_RTERM)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, BIT(10), BMASK(10:8));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BIT(11));// clock R-term
                }
                else if (rctrl == RX_RTERM_OFF)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, BMASK(10:8), BMASK(10:8));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, BIT(11), BIT(11));// clock R-term
                }
            }
        ...
        case MHL_CBUS_SELECT_PORTD:
            if(GET_MHL_PATH_SUPPORT_PORTD())
            {
                if (rctrl == RX_HDMI_RTERM)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BMASK(14:12));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BIT(15));// clock R-term
                }
                else if (rctrl == RX_MHL_RTERM)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, BIT(14), BMASK(14:12));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, 0, BIT(15));// clock R-term
                }
                else if (rctrl == RX_RTERM_OFF)
                {
                    W2BYTEMSK(REG_PM_MISC_63_L, BMASK(14:12), BMASK(14:12));// data R-term
                    W2BYTEMSK(REG_PM_MISC_63_L, BIT(15), BIT(15));// clock R-term
                }
            }
...
void _mhal_mhl_RtermHWControl(MS_U8 ucCbusSelect, MS_BOOL bFlag)
{
    switch(ucCbusSelect)
    {
        ...
        case MHL_CBUS_SELECT_PORTA:
            if(GET_MHL_PATH_SUPPORT_PORTA())
            {
                W2BYTEMSK(REG_PM_MISC_61_L, bFlag? BIT(8): 0, BIT(8));
            }
        ...
        case MHL_CBUS_SELECT_PORTB:
            if(GET_MHL_PATH_SUPPORT_PORTB())
            {
                W2BYTEMSK(REG_PM_MISC_61_L, bFlag? BIT(9): 0, BIT(9));
            }
        ...
        case MHL_CBUS_SELECT_PORTC:
            if(GET_MHL_PATH_SUPPORT_PORTC())
            {
                W2BYTEMSK(REG_PM_MISC_61_L, bFlag? BIT(10): 0, BIT(10));
            }
        ...
        case MHL_CBUS_SELECT_PORTD:
            if(GET_MHL_PATH_SUPPORT_PORTD())
            {
                W2BYTEMSK(REG_PM_MISC_61_L, bFlag? BIT(11): 0, BIT(11));
            }
...
void _mhal_mhl_ECbusInitialSetting(void)
{
    ...
    W2BYTEMSK(REG_MHL_ECBUS_PHY_4C, 0x7780, BMASK(15:4)); 
    ...
    W2BYTEMSK(REG_MHL_ECBUS_PHY_4F, 0x0F00, BMASK(15:0)); // [7:4]:reg_ecbss_afe_tx_dri_step
    ...
    if(ulTimeout < 40000000)
    {
        do
        {
            ...
            if(ustemp == MHL_BUFFER_ECBUS_DATA_LENGTH)
            {
                ...
                {
                    MHAL_MHL_MSG_DEBUG(" MHL DDC data = %x\r\n", usECbusCData[usCounnter]);
                }
...
{
    return (R2BYTE(REG_PM_SLEEP_4D_L) &BMASK(2:0));
}
...
{
    MS_BOOL bFlag = FALSE;
    MS_U8 ucScalerMux = R2BYTE(0x102E02) &BMASK(7:0);

    if(((ucScalerMux &BMASK(7:4)) >> 4) == MHL_SCALER_MUX_SELECT_DVI) // Check scaler main window mux
    {
        bFlag = TRUE;
    }
    else if((ucScalerMux &BMASK(3:0)) == MHL_SCALER_MUX_SELECT_DVI) // Check scaler sub window mux
    {
        bFlag = TRUE;
    }
...
void mhal_mhl_LoadEDID(MS_U8 *edid)
{
    ...
    {
        // Load EDID
        MHAL_MHL_MSG_INFO("** Messi Load MHL EDID...\r\n");
...
void mhal_mhl_ReadEDID(MS_U16 usSize, MS_U8 *edid)
{
    ...
    {
        // Read EDID
        MHAL_MHL_MSG_INFO("** Messi Read MHL EDID...\r\n");
...
void mhal_mhl_LoadDeviceCapability(MS_U8 *devcap)
{
    ...
    if(devcap != NULL)
    {
        MHAL_MHL_MSG_INFO("** Messi Load DevCap...\r\n");
...
{
    MS_U8 ucCapability = MHL_CHIP_FUNCTION_CAPABILITY;
    MS_U16 uctemp = 0;
    ...
    if(GET_MHL_PATH_SUPPORT_PORTB()) // Port B not support MHL 3.0
    {
        ucCapability = ucCapability &(~(BIT(2)));
    }
...
{
    if(ucSelect &MHL_CABLE_DETECT_SELECT_PORTB)
    {
        // Do nothing
    }
}
...
void mhal_mhl_CableRemoveProc(MS_U8 ucCbusSelect)
{
    ...
    ucMHL3LinkRate = MHL_AV_LINK_NONE;
}
...
void mhal_mhl_SourceChangeProc(MS_U8 ucCbusSelect)
{
    if(mhal_mhl_CheckInputPort(ucCbusSelect))
    {
        ...
        if(ucMHL3LinkRate != MHL_AV_LINK_NONE)
        {
            mhal_mhl_SetMainLinkRate(ucCbusSelect, ucMHL3LinkRate);
        }
    }
    else
    {
...
void mhal_mhl_SetMainLinkRate(MS_U8 ucCbusSelect, MS_U8 ucLinkRate)
{
    ...
    if(mhal_mhl_CheckInputPort(ucCbusSelect))
    {
        ...
        _mhal_mhl_MHL3MuxSetting0(bLinkRate6GFlag);
    }
...
void mhal_mhl_ECbusEventProc(MS_U8 ucCbusSelect, MS_U8 ucECbusEvent)
{
    ...
    {
        MHAL_MHL_MSG_INFO("** MHL eCbus state %x\r\n", ucECbusTrainState);
