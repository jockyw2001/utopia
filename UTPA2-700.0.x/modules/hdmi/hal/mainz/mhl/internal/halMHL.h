...
#define MHL_TMDS_MULTIPLE_ENGINE        0
...
{
    MHL_DVI_PORT_A = BIT(0),
    MHL_DVI_PORT_B = BIT(1),
    MHL_DVI_PORT_C = BIT(2),
};
...
#define MHL_CBUS_SELECT_PORT_INITIAL    MHL_CBUS_SELECT_PORTB
