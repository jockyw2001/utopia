...
void MHal_HDMITx_InitSeq(void)
{
    ...
    //Curry only, Follow suggestion from Analog RD(Eric Lu) and set this value to 0x10
    ...
    //QD980 CTS compatibility issue. Change SSCP
...
//wilson@kano:TBD
    ...
    //Curry only, RD suggests(Eric Lu) 0x41[15:8] = 0x11 and 0x42[15:0] = 0x1111 if TMDS is less than 300MHz
    if(!bIsHDMI20)
    {
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_41, 0xFF00, 0x1100);
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_42, 0xFFFF, 0x1111);
    }
    else
    {
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_41, 0xFF00, 0x0000);
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_42, 0xFFFF, 0x0000);
    }
