...
#define I2C_CHECK_PIN_DUMMY             5000U//255 /*((I2C_CHECK_PIN_TIME / I2C_CHECK_PIN_CYCLE) * MCU_MICROSECOND_NOP_NUM)*/
...
#endif
static MS_U32 u32DDCDelayCount = 520U;
