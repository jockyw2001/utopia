...
{
    //K6Lite does not implement SSC yet.
    #if 0
...
void MHal_HDMITx_SetVideoInfoByCustomer(MsHDMITX_VIDEO_TIMING idx, stHDMITX_TIMING_INFO_BY_CUSTOMER stTimingInfo)
{
    ...
    HDMITxVideoModeTbl[idx].i_p_mode = stTimingInfo.i_p_mode;
    HDMITxVideoModeTbl[idx].h_polarity = stTimingInfo.h_polarity;
    HDMITxVideoModeTbl[idx].v_polarity = stTimingInfo.v_polarity;
    HDMITxVideoModeTbl[idx].vs_width = stTimingInfo.vs_width;
    HDMITxVideoModeTbl[idx].vs_bporch = stTimingInfo.vs_bporch;
    HDMITxVideoModeTbl[idx].vde_width = stTimingInfo.vde_width;
    HDMITxVideoModeTbl[idx].hs_width = stTimingInfo.hs_width;
    HDMITxVideoModeTbl[idx].hs_bporch = stTimingInfo.hs_bporch;
    HDMITxVideoModeTbl[idx].hde_width = stTimingInfo.hde_width;
    HDMITxVideoModeTbl[idx].vtotal = stTimingInfo.vtotal;
    HDMITxVideoModeTbl[idx].htotal = stTimingInfo.htotal;
    HDMITxVideoModeTbl[idx].vs_delayline = stTimingInfo.vs_delayline;
    HDMITxVideoModeTbl[idx].vs_delaypixel = stTimingInfo.vs_delaypixel;
    HDMITxVideoModeTbl[idx].hs_delay = stTimingInfo.hs_delay;
