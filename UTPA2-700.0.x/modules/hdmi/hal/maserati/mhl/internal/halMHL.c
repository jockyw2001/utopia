...
//  Global Variables
//-------------------------------------------------------------------------------------------------
MS_U8 ucChipIDValue = MHL_CHIP_ID_MASERATI;
...
void mhal_mhl_LoadEDID(MS_U8 *edid)
{
    ...
    {
        // Load EDID
        MHAL_MHL_MSG_INFO("** Masetari Load MHL EDID...\r\n");
...
void mhal_mhl_ReadEDID(MS_U16 usSize, MS_U8 *edid)
{
    ...
    {
        // Read EDID
        MHAL_MHL_MSG_INFO("** Masetari Read MHL EDID...\r\n");
...
void mhal_mhl_LoadDeviceCapability(MS_U8 *devcap)
{
    ...
    if(devcap != NULL)
    {
        MHAL_MHL_MSG_INFO("** Masetari Load DevCap...\r\n");
