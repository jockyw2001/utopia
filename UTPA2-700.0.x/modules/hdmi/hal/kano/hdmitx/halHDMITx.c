...
void MHal_HDMITx_InitSeq(void)
{
    ...
    MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_30, 0x003F, 0x0014); //REG_ICTRL_DRV_MAIN_CLK
    ...
    MHal_HDMITx_Mask_Write(HDMITX_REG_BASE, REG_ACT_HDMI_PKTS_CMD_01, 0x8000, (gu8ChipVerNum > 0x00) ? 0x8000 : 0x0000);
...
//wilson@kano:TBD
    ...
    MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_03, 0x00FF, (MS_U16)((HDMITxVideoAtopSetting[ucCDIdx][idx].SynthSSCSet & 0x00FF0000) >> 16));
...
void MHal_HDMITx_Set_AVI_InfoFrame(MsHDMITX_PACKET_PROCESS packet_process, MsHDMITX_AVI_CONTENT_TYPE content_type, MS_U16 *data)
{
    ...
    {
        MHal_HDMITx_Mask_Write(HDMITX_REG_BASE, REG_PKT_AVI_1_09, 0x0300, 0x0200); // EIA version 2
        switch(content_type)
        {
            case E_HDMITX_AVI_PIXEL_FROMAT:
                MHal_HDMITx_Mask_Write(HDMITX_REG_BASE, REG_PKT_AVI_1_09, 0x00E0, *data);
				break;
            case E_HDMITX_AVI_ASPECT_RATIO:
                ...
                MHal_HDMITx_Mask_Write(HDMITX_REG_BASE, REG_PKT_AVI_7_0F, 0x00FF, *(data+5));
                break;
...
{
    //Kano does not implement SSC yet.
    #if 0
