...
INTERFACED MS_U32 MDrv_HDMITx_GetTMDSStatus(void* pInstance);
...
INTERFACED void MDrv_HDMITx_SetVideoOutputModeByCustomer(void* pInstance, MsHDMITX_VIDEO_TIMING enVidTiming, stHDMITX_TIMING_INFO_BY_CUSTOMER stTimingInfo);
