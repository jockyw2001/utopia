...
#define SEAL_PM_GROUP_NUM           (4UL) //[SEAL][HAL][003] Numbers of PM domain groups
#define SEAL_PM_GROUP_IP_NUM        (16UL) //[SEAL][HAL][004] Numbers of PM domain IPs in a group
#define SEAL_PM_TBL_IP_NUM          (SEAL_PM_GROUP_NUM*SEAL_PM_GROUP_IP_NUM)
#define SEAL_PROCESSOR_GROUP_NUM    (1UL) //[SEAL][HAL][005] Numbers of processor groups
#define SEAL_PROCESSOR_NUM_PERGROUP (9UL) //[SEAL][HAL][006] Numbers of processors in a group
#define SEAL_TBL_PROCESSOR_NUM      (SEAL_PROCESSOR_GROUP_NUM*SEAL_PROCESSOR_NUM_PERGROUP)
#define SEAL_LOCK_GROUP_NUM         (26UL) //[SEAL][HAL][007] Numbers of lock groups
#define SEAL_LOCK_NUM_PERGROUP      (16UL) //[SEAL][HAL][008] Numbers of lock IPs in a group
