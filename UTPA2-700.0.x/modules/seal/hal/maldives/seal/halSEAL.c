...
#define SEAL_NON_PM_GROUP10 \
    ...
    E_SEAL_ALBANY0_PROT_NONPM

#define SEAL_NON_PM_GROUP11 \
    E_SEAL_ALBANY1_PROT_NONPM, \
    E_SEAL_ALBANY2_PROT_NONPM, \
...
MS_U8 HAL_Seal_GetMiuHitClientID(MS_U8 u8MiuDev)
{
    ...
    u32RegLogAddr = (u8MiuDev) ? REG_SECURE0_HITTED_AUXI_STATUS : REG_SECURE1_HITTED_AUXI_STATUS;
