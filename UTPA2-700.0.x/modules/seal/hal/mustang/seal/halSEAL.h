...
#define SEAL_SECURE_RANGE_ALIGN     (0x1000) //4k bytes for secure range alignement
#define SEAL_IMI_RANGE_ALIGN        (0x400) //1k bytes for IMI range alignment
#define SEAL_NONPM_GROUP_NUM        (16)
#define SEAL_NONPM_GROUP_IP_NUM     (16)
#define SEAL_NONPM_TBL_IP_NUM       (SEAL_NONPM_GROUP_NUM*SEAL_NONPM_GROUP_IP_NUM)
#define SEAL_PM_GROUP_NUM           (4)
#define SEAL_PM_GROUP_IP_NUM        (16)
#define SEAL_PM_TBL_IP_NUM          (SEAL_PM_GROUP_NUM*SEAL_PM_GROUP_IP_NUM)
#define SEAL_PROCESSOR_GROUP_NUM    (1)
#define SEAL_PROCESSOR_NUM_PERGROUP (9)
