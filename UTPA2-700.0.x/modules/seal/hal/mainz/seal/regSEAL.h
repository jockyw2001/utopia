...
/* this register is for PC range protection; currently PC range protection is not used, so we use this register as a dummy register */
#define REG_SECURE0_DUMMY0            (SEAL_SECURE0_RANGE0+0x80UL)
...
/* this register is for PC range protection; currently PC range protection is not used, so we use this register as a dummy register */
#define REG_SECURE1_DUMMY0            (SEAL_SECURE1_RANGE0+0x80UL)
