...
)
{
    ...
    MS_U32 u32RegDetEnDummy = 0; // work-around for 0x76 not readable issue
    ...
    if(u8MiuSel == E_CHIP_MIU_0)
    {
        ...
        u32RegDetEnDummy = REG_SECURE0_DUMMY0;
    ...
    else if(u8MiuSel == E_CHIP_MIU_1)
    {
        ...
        u32RegDetEnDummy = REG_SECURE1_DUMMY0;
    ...
    if ( (u32Attribute == 0x0)|| (u64StartOffset == 0 && u64EndOffset == 0) )
    {
        ...
        u8Val = HAL_SEAL_NonPmReadByte(u32RegDetEnDummy);
        u8Val &= ~(1 << u8SecureRangeId);
        HAL_SEAL_NonPmWriteByte(u32RegDetEn, u8Val);
        HAL_SEAL_NonPmWriteByte(u32RegDetEnDummy, u8Val);
...
MS_BOOL HAL_Seal_CheckSecureRange(MS_PHY phyStartAddr, MS_U32 u32Length, eSeal_CheckSecureRangeType eCheckSecureRangeType)
{
    ...
    MS_U32 u32RegDetEnDummy; // work-around for 0x76 not readable issue
    MS_U64 u64StartAddr;
    MS_U64 u64EndAddr;
