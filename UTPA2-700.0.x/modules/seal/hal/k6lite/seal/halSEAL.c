...
#define SEAL_NON_PM_GROUP5 \
    ...
    E_SEAL_ANA_MISC_MIPSPLL1_PROT_NONPM, \
    E_SEAL_ANA_MISC_MIPSPLL2_PROT_NONPM, \
    E_SEAL_DUMMY, \
...
#define SEAL_NON_PM_GROUP7 \
    ...
    E_SEAL_DEMOD_MIU_ARB_PROT_NONPM, \
...
#define SEAL_NON_PM_GROUP18 \
    ...
    E_SEAL_SECURE_HDMITX_NONPM, \
    E_SEAL_VMX_VMARK_SC0_PROT_NONPM

#define SEAL_NON_PM_GROUP19 \
    E_SEAL_VMX_VMARK_SC1_PROT_NONPM, \
    E_SEAL_AEON_I_PROT_NONPM, \
    E_SEAL_VD_R2_SUBSYS_PROT_NONPM, \
    E_SEAL_SECPVR_LUT_PROT_NONPM, \
    E_SEAL_PVR_FSC0_PROT_NONPM, \
    E_SEAL_PVR_FSC1_PROT_NONPM, \
    E_SEAL_PVR_FSC2_PROT_NONPM, \
    E_SEAL_PVR_FSC3_PROT_NONPM, \
...
#define SEAL_NON_PM_GROUP20 \
    ...
    E_SEAL_X32_CFB_0_PROT_NONPM, \
    E_SEAL_X32_CFB_1_PROT_NONPM, \
...
#define SEAL_NON_PM_GROUP22 \
    ...
    E_SEAL_X32_SATA_MAC_01_PROT_NONPM, \
    E_SEAL_X32_SATA_MAC_02_PROT_NONPM, \
    E_SEAL_X32_SATA_MAC_03_PROT_NONPM

#define SEAL_NON_PM_GROUP23 \
    E_SEAL_AEON_D_PROT_NONPM, \
    E_SEAL_DSP_D_PROT_NONPM, \
    E_SEAL_SECU_51_D_PROT_NONPM, \
...
#define SEAL_PM_GROUP1 \
    ...
    E_SEAL_FSP_PROT_PM, \
    E_SEAL_QSPI_PROT_PM, \
    E_SEAL_IR_TX_PROT_PM, \
    E_SEAL_IR_TX_MEM_PROT_PM, \
...
void HAL_SEAL_SetIOMapBase(MS_U32 u32NonPmBaseAddr, MS_U32 u32PmBaseAddr)
{
    ...
    u16Val = HAL_SEAL_GetNonPmIpIdx(E_SEAL_SEC_R2_PROT_NONPM);
    ...
    u16Val = HAL_SEAL_GetNonPmIpIdx(E_SEAL_ARM_D_SECURE_PROT_NONPM);
    u32RegAddr0 = REG_TZPC_MIU0_ID0;
    HAL_SEAL_NonPmWrite2Byte(u32RegAddr0, u16Val);
    ...
    HAL_Seal_SecureMasterSet(E_SEAL_ARM_D_SECURE_PROT_NONPM, 1);
