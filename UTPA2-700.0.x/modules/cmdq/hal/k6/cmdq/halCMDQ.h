...
#define HAL_SCALAR_SC2CMDQ_TRIG_2           0x000B
#define HAL_SCALAR_SC2CMDQ_TRIG_3           0xFFFF // not support
#define HAL_AESDMA_CMDQDMA_FINISHED         0xFFFF // not support
#define HAL_AESDMA_CMDQDMA_FINISHED_2       0xFFFF // not support
#define HAL_VOP_DCM2GOP_VDE                 0xFFFF // not support
#define HAL_VOP_DCS2GOP_VDE                 0xFFFF // not support
#define HAL_XC_DIP_CMDQ_INT                 0x000A
