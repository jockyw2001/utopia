...
void HAL_CMDQ_SetBank(MS_U32 u32BankAddr)
{
...
MS_BOOL HAL_CMDQ_Set_Mode(int ModeSel)
{
    if(ModeSel == 1)
    {
...
//---------------------------------------------------------------------------
void HAL_CMDQ_Write_Dummy_Register_release_polling(int Write_bit)
{
...
void HAL_CMDQ_Write_Pointer(MS_U32 Write_value)
{
