...
// BASEADDR & BK
#define BK_MSP                         0x1300*2
#define BK_MSP1                        0x0C00*2
...
// CLKGEN0
#define MSPI_CLK_CFG                   0x16
    #define  MSPI_CLK_CFG_OFFSET           0x0A
    #define  MSPI_CLK_MASK                 0x1FFF
    #define  MSPI_MAXCLKLEVEL			   0x03
#endif // _REG_MSPI_H_
