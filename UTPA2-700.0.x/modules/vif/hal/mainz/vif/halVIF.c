...
#define VIF_IS_ADC_48MHz   0    // 0:144MHz ; 1:48MHz
...
void msVifAdcInitial(void)
{
    ...
    // Digital setting
    // SRAM Power Control
    RIU_WriteByte(0x12090L, 0x00);   
    RIU_WriteByte(0x12091L, 0x5A);   
    // ADC clock
    ...
    // SRAM share
    RIU_WriteByte(0x11F18L, 0x01);
    RIU_WriteByte(0x11F19L, 0x40);
    RIU_WriteByte(0x11F84L, 0x00);
    RIU_WriteByte(0x11F85L, 0x00);
    RIU_WriteByte(0x11F86L, 0x00);
    RIU_WriteByte(0x11F87L, 0x00);
    RIU_WriteByte(0x11F8EL, 0x10);
    RIU_WriteByte(0x11F8FL, 0x00);
    // FIR share
    RIU_WriteByte(0x11F22L, 0x11);
    RIU_WriteByte(0x11F23L, 0x18);
    
    // Analog setting
    RIU_WriteByteMask(0x12879L, 0x00, 0xF0);  // Enable LDOS
    RIU_WriteRegBit(0x12840L, 0, _BIT4);           // Ref Enable
    ...
    RIU_WriteByte(0x1281EL, 0x80);                   // Calibration buffer
    ...
    RIU_WriteByte(0x12864L, 0x00);                 // MPLL_output_div_second
    RIU_WriteByte(0x12865L, 0x00);
    RIU_WriteByte(0x1287EL, 0x00);                 // SIF CLK select
    RIU_WriteByte(0x1287FL, 0x00);
    RIU_WriteByte(0x12866L, 0x01);                 // loop divider
    RIU_WriteByte(0x12867L, 0x12);
    RIU_WriteByte(0x1286AL, 0x83);                 // PLL power down
    RIU_WriteByte(0x1286BL, 0x00);
    RIU_WriteByte(0x1286AL, 0x03);                 // PLL power up
    RIU_WriteByte(0x1286BL, 0x00);
    RIU_WriteByte(0x1286CL, 0x10);                 // AGC enable
    RIU_WriteByte(0x1286DL, 0x00);
    RIU_WriteByte(0x12818L, 0x02);                 // ADC power down 
...
void msVifInitial(void)
{
    ...
    // version control
    msWriteByte(FIRMWARE_VERSION_L, 0x06);                          // 06(dd)
    msWriteByte(FIRMWARE_VERSION_H, 0xA0);                          // 10/16 (mm/yy)  firmware version control
