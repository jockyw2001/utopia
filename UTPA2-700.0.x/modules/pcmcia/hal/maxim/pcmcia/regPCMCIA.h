...
#define PCM_CLKGEN0_REG(addr)               (*((volatile MS_U16*)(PCMCIA_RIU_MAP + 0x1600UL + ((addr)<<2UL))))
    #define REG_CLKGEN0_PCM_CLK             0x001AUL
        #define REG_CLKGEN0_PCM_CLK_MASK    0x000FUL
        #define REG_CLKGEN0_PCM_CLK_DIS     0x0001UL

#define PCM_TOP_REG(addr)               	(*((volatile MS_U16*)(PCMCIA_RIU_MAP + 0x3C00UL + ((addr)<<2UL))))
	...
	#define REG_TOP_PCM_PE_2             	0x000BUL
		#define REG_TOP_PCM_PE_2_MASK		0x000FUL   //bit0 & bit 1 are card detect PE pins of card A & card B
