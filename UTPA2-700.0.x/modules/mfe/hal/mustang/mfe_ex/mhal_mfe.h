...
#define MIU_SIZE     8
	...
	#define T8_RIU_BASE u32MFERegOSBase // = 0x25000000; G2 RIU base.
	#define REG_BANK_MFE  0x400
	#define __MFE_REG(reg) (*(volatile MFE_U32 *) (void*)( T8_RIU_BASE + (reg)*4 ) )
...
#ifdef _MFE_KAISER_
	#define REG_BANK_MFE    0x11380
#else
    #define REG_BANK_MFE    0x8800
#endif
	#define __MFE_REG(reg)		(*(volatile MFE_U16 *) ( T8_RIU_BASE + (REG_BANK_MFE + reg) * 4 ) )
    #define REG_BANK_MFE1    0x8880
    #define __MFE_REG1(reg)		(*(volatile MFE_U16 *) ( T8_RIU_BASE + (REG_BANK_MFE1 + reg) * 4 ) )
#else //if defined(_WIN32)//defined(_BCB_PLATFORM_)
    #define T8_RIU_BASE 0x0a80 // = 0xBF200000; //CH4
	#define REG_BANK_MFE 0x0a80 //Local FPGA
	#define REG_BANK_MFE1 0x0b80 //Local FPGA
    //#define T8_RIU_BASE 0x0b80 // = 0xBF200000; //CH4
	//#define REG_BANK_MFE 0x0b80 //Local FPGA
	//#define REG_BANK_MFE1 0x01080 //Local FPGA
#endif
