...
#define HAL_L1  (1/*0*/ << 0)
#define HAL_L2  (1/*0*/ << 1)
#define DRV_L0	(1/*0*/ << 15)	//error message
...
#define DRV_L7  (1/*0*/ << 10)	// VT rate control
#if defined(_WIN32)||!defined(_KERNEL_MODE_)
#define ADP_L0  (1/*0*/ << 15) //error message
#define ADP_L1  (1/*0*/ << 16) //check Drop and Skip state
...
//#define DEBUG_LEVEL (ADP_L0|ADP_L1|ADP_L2|ADP_L3|HAL_L1|HAL_L2|DRV_L1|DRV_L2|DRV_L3|DRV_L4|DRV_L5)
