...
#else
    if (is_off) {
        *(MS_U16*)(T8_RIU_BASE + (REG_CKG_MFE * 4)) = 0x1;   // 4'b0001, disable MFE clock
        ms_dprintk(HAL_L1, "Disable clock.\n");
    } else {
        switch (clock_level)
        {
            case MFE_CLK_VERY_SLOW:
                *(MS_U16*)(T8_RIU_BASE + (REG_CKG_MFE * 4)) = 0x0; break;   // 4'b0000
            case MFE_CLK_SLOW:
                *(MS_U16*)(T8_RIU_BASE + (REG_CKG_MFE * 4)) = 0x4; break;   // 4'b0100
            case MFE_CLK_MEDIUM:
                *(MS_U16*)(T8_RIU_BASE + (REG_CKG_MFE * 4)) = 0x8; break;   // 4'b1000
            case MFE_CLK_FAST:
                *(MS_U16*)(T8_RIU_BASE + (REG_CKG_MFE * 4)) = 0xC; break;   // 4'b1100
            default:
                *(MS_U16*)(T8_RIU_BASE + (REG_CKG_MFE * 4)) = 0xC; break;   // 4'b1100
        }
