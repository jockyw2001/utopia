...
#elif defined(WIN32)
#include "pmem_mm.h"
	#define addr_log2phy(log_addr) pmem_mm_va2pa((MFE_U32)log_addr)
	#define addr_phy2log(phy_addr) pmem_mm_pa2va((MFE_U32)phy_addr)
#endif

MFE_BOOL MMAPInit(MFE_U32 buf_base, MFE_U32 buf_size, MFE_U32* ppBufStart);
MFE_BOOL MMAPMalloc(MFE_U32* ppBufStart, MFE_U32 pBufEnd, MFE_U32 size, MEMMAP_t * memmap, int nAlignBytes,const char* msg);
