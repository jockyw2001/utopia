...
// Linux/TV-specific
    ...
    #define _MFE_MUNICH_ //must define _MFE_A3_ and _MFE_AGATE_ and _MFE_EDISON_
    #define _NON_THREAD_
...
// Features
#if defined(_MFE_EINSTEIN_) || defined(_MFE_EINSTEIN3_) || defined(_MFE_MONACO_) || defined(_MFE_MUJI_) || defined(_MFE_MUNICH_)
...
// OBUF
    ...
    #define OBUF_SIZE   (2 * 1024 * 1024)	// 2 MBytes
#elif defined(MFE_SUPPORT_720P)
    #define OBUF_SIZE   (1 * 1024 * 1024)	// 1 MBytes
#endif
