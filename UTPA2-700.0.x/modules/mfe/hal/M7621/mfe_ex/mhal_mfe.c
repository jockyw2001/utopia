...
#define CMU_CLK_170P6M    CMU_MMP_ASIC_CLK_170P6M
    ...
    if (is_off) {
        *(MS_U16*)(T8_RIU_BASE+(0x1980+0x18)*4) = 1;//disable MFE clock
        ...
        //*(MS_U16*)(T8_RIU_BASE+(0x1980+0x18)*4) = 0; // 4'b0000 123
        //*(MS_U16*)(T8_RIU_BASE+(0x1980+0x18)*4) = 4; // 4'b0100 144
        //*(MS_U16*)(T8_RIU_BASE+(0x1980+0x18)*4) = 8; // 4'b1000 172
        //*(MS_U16*)(T8_RIU_BASE+(0x1980+0x18)*4) = 12; // 4'b1100 192
        switch (clock_level)
        {
            case MFE_CLK_VERY_SLOW:
    ...
    // ip10_PWR_CTRL:mfe
    //     Base 0x1111, offset 0x50, bit 0
    //         1: power down
    //         0: power on
    if (is_off) {
        *((volatile MS_U16 *)(MS_VIRT)(T8_RIU_BASE + 0x11100*2 + 0x50*2*2)) |= ((MS_U16)1);
