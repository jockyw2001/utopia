...
// Linux/TV-specific
    ...
    #define _MFE_EINSTEIN3_ //must define _MFE_A3_ and _MFE_AGATE_ and _MFE_EDISON_
    #define _MFE_MANHATTAN_ //must define _MFE_A3_ and _MFE_AGATE_ and _MFE_EDISON_
