...
// Linux/TV-specific
    ...
    #define _MFE_MESSI_ //must define _MFE_A3_ and _MFE_AGATE_ and _MFE_EDISON_
    #define _NON_THREAD_
...
// Features
#if defined(_MFE_MUJI_) || defined(_MFE_MANHATTAN_) || defined(_MFE_KANO_)
    #define MFE_SUPPORT_1080P
#else
    #define MFE_SUPPORT_720P
#endif

#if defined(_MFE_MONET_) || defined(_MFE_MANHATTAN_) || defined(_MFE_KANO_)
    #define MFE_SUPPORT_TLB
#endif

#if defined(_MFE_KANO_)
