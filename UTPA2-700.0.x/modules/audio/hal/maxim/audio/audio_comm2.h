...
*   Version Control
*********************************************************/
#define  system_version_num              0x880D8D
#define  dde_version_num                 0xD2005B
#define  ms10_dde_version_num            0xD800CD
...
*********************************************************/
    ...
    /* DSP Audio Delay Setting */
        ...
        #define AUDIO_DELAY_UPPER_BOUND_SPDIF       ((SPDIF_DLY_DRAM_SIZE/SPDIF_DELAY_STORE_CHANNELS)/DMA16BIT_BYTES_IN_WORDS/AUDIO_DELAY_FS) //unit : ms
...
************************************************/
    ...
    /* SND DSP DM vars */
        ...
        /* common */
            ...
            //#define DSP2DmAddr_pcmCapture3_volume       (DSP2_DM_MAIN_ADDR + 0x084D)

            #define DSP2DmAddr_dec1_signal_energy       (DSP2_DM_MAIN_ADDR + 0x084E)
        ...
        /* basic sound effect */
            ...
            #define DSP2DmAddr_sinetone_StartFreq_Addr  (DSP2_DM_MAIN_ADDR + 0x0880)
            #define DSP2DmAddr_sinetone_EndFreq_Addr    (DSP2_DM_MAIN_ADDR + 0x0881)
            #define DSP2DmAddr_sinetone_SweepStep_Addr  (DSP2_DM_MAIN_ADDR + 0x0882)
            #define DSP2DmAddr_sinetone_Duration_Addr   (DSP2_DM_MAIN_ADDR + 0x0883)

        /* report HDMI PAPB lock */
            #define DSP2DmAddr_hdmi_npcm_lock           (DSP2_DM_MAIN_ADDR + 0x0884)
...
*************************************************/
    ...
    ************************************************/
    ...
    #define M2S_MBOX_ARC_HDMI_SETTING               MB_2D8C
        #define MBOX_ARC_HDMI_MODE_BIT                  MBOX_BIT0       // 0(Spilt Mode):SPDIF+ARC+HDMITX(only PCM),
                                                                        // 1(  Box Mode):SPDIF+ARC(TX)
    ...
    #define M2S_MBOX_SINE_GEN                   MB_2D28         // [15:8] MENUSOUND duration (50 ms/step)
    ...
    //#define M2S_MBOX_CAPTURE3_CTRL              MB_2D4C   //[7:0] PCM_capture3
    ...
    //#define M2S_MBOX_PCM_CAPTURE3_DDR_RdPtr         MB_2D94
    //#define M2S_MBOX_PCM_CAPTURE3_DDR_Size          MB_2D96
    ...
    ************************************************/
    ...
    //#define S2M_MBOX_PCM_CAPTURE3_DDR_WrPtr     MB_2D7E
...
********************************************************************/
    ...
    #define ISR_PMASK_DEC5              IMASK_SP1T_IRQ1     // enable:IMASK_SP1T_IRQ1, Decoder5 isr
    //#define ISR_PMASK_DEC6              -1                  // enable:16, PIO[16] Decoder6 isr
    //#define ISR_PMASK_NPCM4             -1                  // enable: 0, PIO[ 0] NCPM4 Interrupt (Synthesizer)
    //#define ISR_PMASK_NPCM5             -1                  // enable: 1, PIO[ 1] NCPM5 Interrupt (Synthesizer)
