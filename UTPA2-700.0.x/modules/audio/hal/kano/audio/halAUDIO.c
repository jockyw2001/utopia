...
const AUDIO_REG_TYPE  AudioPreInitTbl_Clock[] =
{
    ...
    //-----------------AudioBand----------------------------//Item 21
    {0x112B58, 0xFF, 0x0F}, // DWA fix value
    ...
    {0x112B55, 0xFF, 0x01},
    {0x112B52, 0xFF, 0x00},// DC offset ENABLE, Dither ENABLE
    {0x112B53, 0xFF, 0x00},
    {0x112B55, 0x10, 0x10},// SDM FIX EN
...
{
    //-----------------De-POP_2-----------------------------//Item 26
    {0xFFFFFF, 0x01, 0x20}, // delay 1m sec
    {0x112CEC, 0xFF, 0x00},
    {0x112CED, 0xFF, 0x00},
    {0x112CEE, 0xFF, 0x00},
    {0x112CEF, 0xFF, 0x00},
...
const AUDIO_REG_TYPE  AudioInitTbl_1[]=
{
    ...
    {0x112C58, 0x04, 0x04},       // enable decimation mode
