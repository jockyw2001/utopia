...
MS_U32 HAL_DEC_R2_Get_SHM_INFO(R2_SHM_INFO_TYPE decInfoType, MS_U8 dec_id)
{
    ...
    p_shm = (DEC_R2_SHARE_MEM *)(MS_PA2KSEG1(R2_1_DDR_BASE+DEC_R2_SHM_DDR_OFFSET));
    if (p_shm == NULL)
    {
        AUR2_DEBUG_PRINT(printf("[%s] Error! p_shm should not be NULL!\n", __FUNCTION__));
        return FALSE;
...
MS_BOOL HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_TYPE decParamType, MS_U8 dec_id, MS_U32 param, MS_U32 param2)
{
    ...
    switch( decParamType )
    {
        ...
        case R2_SHM_PARAM_CHUNK_PTS_RD_FLAG:
            ptr = (volatile MS_U32 *) &p_shm_param->chunk_PTS_rd_flag;      *ptr = param;  MsOS_Dcache_Flush((MS_VIRT)ptr,4);     break;
