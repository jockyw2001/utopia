...
*   Version Control
*********************************************************/
#define  system_version_num              0x880D4F
#define  dde_version_num                 0xD20055
#define  ms10_dde_version_num            0xD800C5
#define  palsum_version_num              0x544009
#define  btsc_version_num                0x046C07
#define  srs_puresound_version_num       0x202018
#define  dbx_version_num                 0x1A01AB
...
*********************************************************/
    ...
    /* DSP Audio Delay Setting */
        ...
        #define AUDIO_DELAY_LOWER_BOUND_KTV         0x14            // min KTV audio delay  , 0x14 = 20 ms
...
************************************************/
    /* DSP SRAM Segment */
        ...
        #define DSP2_CM_CODE2_ADDR                  0x1100
        ...
        #define DSP2_DM_SEG1A_SIZE                  0x2B00
        #define DSP2_DM_SEG1B_ADDR                  0x2B00
        #define DSP2_DM_SEG1B_SIZE                  0x0
        #define DSP2_DM_SEG2_ADDR                   0x2B00
        #define DSP2_DM_SEG2_SIZE                   0x400

    /* SND DSP PM vars */
        /* common */
            #define DSP2PmAddr_mainVer              0x2100
            #define DSP2PmAddr_alg1Ver              0x23FF      // decoder 2 version
            #define DSP2PmAddr_alg2Ver              0x20FF

            #define DSP2PmAddr_mainAudioDelay       0x2101
            #define DSP2PmAddr_spdifDelay           0x2102
            #define DSP2PmAddr_hpDelay              0x2103
            #define DSP2PmAddr_hdmiNonPcmSts        0x2104
            #define DSP2PmAddr_btFrameSize          0x2105
            #define DSP2PmAddr_STest_Report         0x2106
            #define DSP2PmAddr_ipSecurity           0x2107
            #define DSP2PmAddr_ch5InputDelay        0x2108
            #define DSP2PmAddr_ch6InputDelay        0x2109

            #define DSP2PmAddr_peq48KCoeffAddr      0x2110
    ...
    /* SND DSP DM vars */
        ...
        /* sys_info */
            #define DSP2DmAddr_IO_Info1             0x3B80
            ...
            #define DSP2DmAddr_IO_Info2             0x3B20
        ...
        /* common */
            #define DSP2DmAddr_Buff1_ptr_base           0x38A0
            #define DSP2DmAddr_Buff2_ptr_base           0x38A3
            ...
            #define DSP2DmAddr_mips_crisis_flag         0x38A6

            #define DSP2DmAddr_hdmi_unstable_protect    0x38A7
            #define DSP2DmAddr_hdmi_unstable_threshold  (DSP2DmAddr_hdmi_unstable_protect+1)

            #define DSP2DmAddr_pcmCapture_overflow      0x38A9
            #define DSP2DmAddr_pcmCapture_underflow     (DSP2DmAddr_pcmCapture_overflow+1)
            #define DSP2DmAddr_pcmCapture_volume        (DSP2DmAddr_pcmCapture_underflow+1)
            #define DSP2DmAddr_pcmCapture2_overflow     0x38AC
            #define DSP2DmAddr_pcmCapture2_underflow    (DSP2DmAddr_pcmCapture2_overflow+1)
            #define DSP2DmAddr_pcmCapture2_volume       (DSP2DmAddr_pcmCapture2_underflow+1)

            #define DSP2DmAddr_dec1_signal_energy       0x38AF

            #define DSP2DmAddr_r2_pcm1_info             0x38B0
            #define DSP2DmAddr_r2_pcm2_info             0x38B8
                #define R2_SHM_INFO_ELAPSED_PCM_CNT         0x0004
                #define R2_SHM_INFO_PCMISR_EMPTY_CNT        0x0006
                #define R2_SHM_INFO_MAX                     0x0007

            #define DSP2DmAddr_swDmaRdr_ctrlBase        0x338C

            #define DSP2DmAddr_dmaWriter1_volume        0x3900
        ...
        /* basic sound effect */
            #define DSP2DmAddr_AvcSOffsetAddr           0x38C0
            #define DSP2DmAddr_KTV_XAGain               0x38C1
            #define DSP2DmAddr_KTV_XBGain               (DSP2DmAddr_KTV_XAGain+1)
            #define DSP2DmAddr_SND_EFFECT_VOL1          0x38C3
            #define DSP2DmAddr_SND_EFFECT_VOL2          0x38C4
            #define DSP2DmAddr_IIS_Num                  0x38C5

            #define DSP2DmAddr_BACKGROUND_VOL1          DSP2DmAddr_SND_EFFECT_VOL1
            #define DSP2DmAddr_BACKGROUND_VOL2          DSP2DmAddr_SND_EFFECT_VOL2

        /* report HDMI PAPB lock */
            #define DSP2DmAddr_hdmi_npcm_lock           0x38C6
        ...
        /* dbx puresound */
            #define DBX_PM_ABS_ADDRESS                 0x2080
            #define DBX_DM_ABS_ADDRESS                 0x2B00
...
********************************************************************/
    /* SIF DSP PM vars */
        /*  for SIF PAL DSP PM vars */
            #define ADDR_gain_base_2                  0x2521
...
*************************************************/
    ...
    /* Surround */
        #define SUR_DRAM_BASEADDR                       0x00B000        // Line Address
        #define SUR_DRAM_ENDADDR                        0x00B800        // Line Address
    ...
    /* KTV */
        #define SUR_DRAM_KTV_BASEADDR                   0x00C000        // Line address, Only in KTV mode, MS surround -> echo
        #define SUR_DARM_KTV_ENDADDR                    0x00E000        // Line address, Overlay with DM prefetch

    /* DSP DM Prefetch */
        #define DSP2_DM_PREFETCH_DRAM_BASE              0x00E000
        #define DSP2_DM_PREFETCH_DRAM_SIZE              0x1000          // 64KB
