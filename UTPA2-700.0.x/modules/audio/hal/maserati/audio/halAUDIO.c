...
static AUDIO_DEC_ID VDDecPriority[AU_DEC_MAX] = {AU_DEC_ID1, AU_DEC_ID3 , AU_DEC_INVALID};
...
static AU_DVB_DECCMD MAD2DecCMD = AU_DVB_DECCMD_STOP;
static AU_DVB_DECCMD MADDec1CMD = AU_DVB_DECCMD_STOP;
static AU_DVB_DECCMD MADDec2CMD = AU_DVB_DECCMD_STOP;
static adec_type MADDec1Type = adec_type_dummy;
static adec_type MADDec2Type = adec_type_dummy;
...
const AUDIO_REG_TYPE  AudioPreInitTbl_Clock[] =
{
    ...
    //-----------------AudioBand----------------------------//Item 21
    {0x112B58, 0xFF, 0xAA}, // DWA fix value
    {0x112B59, 0xFF, 0xAA},
    {0x112B57, 0xC0, 0x40}, // DWA fix value
    {0x112B55, 0xF0, 0xF0}, // DWA fix enable

    {0x112B43, 0xFC, 0xFC}, // Audio Bank Auto recovery enable
    {0x112BCA, 0xFF, 0x88}, // Group B Synth
    {0x112BCB, 0xFF, 0x4C},
    {0x112BC6, 0xFF, 0x88}, // Group B Synth
    {0x112BC7, 0xFF, 0x4C},

    {0x112BCE, 0x80, 0x00}, // Group B Toggle
    {0x112BCE, 0x80, 0x80}, // Group B Toggle
    {0x112BCE, 0x80, 0x00}, // Group B Toggle

    {0x112B40, 0xFF, 0x0E}, // Sram init
    {0x112B41, 0xFF, 0x00},
    {0x112B40, 0xFF, 0x4C}, // Sram init
    {0x112B41, 0xFF, 0x00},
    ...
    {0x112B57, 0xFF, 0x00},
    {0x112C6E, 0xFF, 0x88}, // Enable Grp A/B
    {0x112B50, 0xFF, 0x80}, // DC offset value
    {0x112B51, 0xFF, 0x00},
    ...
    {0x112B55, 0xFF, 0x01},
    {0x112B52, 0xFF, 0x0F},// DC offset DISABLE, Dither DISABLE
    {0x112B53, 0xFF, 0xF0},
    ...
    //-----------------De-POP_1-----------------------------//Item 25
    {0x112CDC, 0xFF, 0xF0},	//wriu -w 0x112cdc 0x3ff0
    {0x112CDD, 0xFF, 0x3F},
    ...
    {0x112CE9, 0xFF, 0x80},
    {0x112CE2, 0xFF, 0x01},	//wriu -w 0x112ce2 0x0001
    {0x112CE3, 0xFF, 0x00},
    {0x112CE0, 0xFF, 0x30},	//wriu -w 0x112ce0 0x1030
    {0x112CE1, 0xFF, 0x10},
    {0x112CEA, 0xFF, 0x08},	//wriu -w 0x112cea 0x0008
    {0x112CEB, 0xFF, 0x00},
    {0x112CEE, 0xFF, 0x00},	//wriu -w 0x112cee 0x0000
    {0x112CEF, 0xFF, 0x00},
    {0x112CEC, 0xFF, 0x00},	//wriu -w 0x112cec 0x0000
    {0x112CED, 0xFF, 0x00},

    {0x112CDE, 0xFF, 0x00},	//wriu -w 0x112cde 0x7800
    {0x112CDF, 0xFF, 0x78},
    {0x112CEA, 0xFF, 0x0C},	//wriu -w 0x112cea 0x000c
    {0x112CEB, 0xFF, 0x00},
    {0x112CEE, 0xFF, 0x81},	//wriu -w 0x112cee 0x1081
    {0x112CEF, 0xFF, 0x10},
    {0x112CEC, 0xFF, 0xC0},	//wriu -w 0x112cec 0x00c0
    {0x112CED, 0xFF, 0x00},
    ...
    {0x112CE0, 0xFF, 0x30},	//wriu -w 0x112ce0 0x1030
    {0x112CE1, 0xFF, 0x10},
    {0x112CE2, 0xFF, 0x00},	//wriu -w 0x112ce2 0x0000
    {0x112CE3, 0xFF, 0x00},
    {0x112CEC, 0xFF, 0x28},	//wriu -w 0x112cec 0x0028
    {0x112CED, 0xFF, 0x00},

    {0xFFFFFF, 0x01, 0x01},  //wait 1  //ms

    {0x112CDC, 0xFF, 0x00},	//wriu -w 0x112cdc 0x0000		//PD DAC=0
    {0x112CDD, 0xFF, 0x00},
    {0x112CE6, 0xFF, 0x00},	//wriu -w 0x112ce6 0x0000		//PD_VI=0
    {0x112CE7, 0xFF, 0x00},
    {0x112CE8, 0xFF, 0x00},	//wriu -w 0x112ce8 0x3000		//PD_VREF=0, EN_VREF_SFTDCH=11
    {0x112CE9, 0xFF, 0x30},
    {0x112CEA, 0xFF, 0x00},	//wriu -w 0x112cea 0x0000		//PD_OPLP_EAR=0, EN_VMID2GND=0
    {0x112CEB, 0xFF, 0x00},
...
{
    //-----------------De-POP_2-----------------------------//Item 26
    {0x112CE0, 0xFF, 0x00},	//wriu -w 0x112ce0 0x0000
    {0x112CE1, 0xFF, 0x00},
    {0x112CE2, 0xFF, 0x07},	//wriu -w 0x112ce2 0x1001, 0x07 due to avoid same in-mux for ADC1
    {0x112CE3, 0xFF, 0x10},

    {0x112CE8, 0xFF, 0x00},	//wriu -w 0x112ce8 0x0000		//PD_VREF=0, EN_VREF_SFTDCH=00
    {0x112CE9, 0xFF, 0x00},

    {0x112CEC, 0xFF, 0x28},	//wriu -w 0x112cec 0x0828		//EN_STG2_LP_EAR=1
    {0x112CED, 0xFF, 0x08},
    {0x112CEE, 0xFF, 0x01},	//wriu -w 0x112cee 0x1001		//MSP=1, EN_MUTE_EAR=0, SEL_DEPOP_EAR[1:0]=01
    {0x112CEF, 0xFF, 0x10},

    {0xFFFFFF, 0x01, 0x01},// delay 1m sec
    {0x112CEE, 0xFF, 0x01},	//wriu -w 0x112cee 0x1301		//MSP=1,EN_EAR=1,EN_MUTE_EAR=0, SEL_DEPOP_EAR[1:0]=01
    {0x112CEF, 0xFF, 0x13},

    {0xFFFFFF, 0x01, 0xFA}, // delay 300m sec , for ADC and DAC fast charge delay
    {0xFFFFFF, 0x01, 0x32},

    {0x112CEE, 0xFF, 0x03},	//wriu -w 0x112cee 0x1303		//MSP=1,EN_EAR=1,EN_MUTE_EAR=0, SEL_DEPOP_EAR[1:0]=11
    {0x112CEF, 0xFF, 0x13},
...
const AUDIO_REG_TYPE  AudioInitTbl_2[]=
{
    ...
    {0x112BCF, 0x01, 0x00},      // DVB1 N.F.  is contolled by DSP/R2
    {0x112BCF, 0x02, 0x00},      // DVB2 N.F.  is contolled by DSP/R2
    {0x112BCF, 0x04, 0x00},      // DVB3 N.F.  is contolled by DSP/R2
    {0x112BCF, 0x08, 0x00},      // DVB4 N.F.  is contolled by DSP/R2
    {0x112C25, 0x20, 0x00},      // DVB5 N.F.  is contolled by DSP/R2
    {0x112C25, 0x02, 0x00},      // DVB6 N.F.  is contolled by DSP/R2
    ...
    {0x112C44, 0xFF, 0x10},// HDMI RX Matrix
    {0x112C45, 0xFF, 0x32},
    {0x112C46, 0x0F, 0x00},// HDMI RX Switch
    {0x112C03, 0x40, 0x40},// AUTO_CLEAR_PC_PD_BAR
    {0x112C48, 0x08, 0x08},// HDMI_RX non_pcm_decoder_new_mode
    {0x112C48, 0x04, 0x00},// HDMI_RX non_pcm_decoder_fast_lock
    {0x112C48, 0x03, 0x00},// HDMI_RX non_pcm_decoder_time_out_sel
    {0x112CA4, 0x08, 0x08},// CLK HDMI RX 256FS/128FS EN
    {0x112CA4, 0x04, 0x04},// CLK HDMI TX 256FS/128FS EN
    {0x112C47, 0x80, 0x00},// disable HDMI non_pcm multi_ch
    ...
    //-----------------Output: I2S--------------------------//Item 10
    {0x163E13, 0x10, 0x10},// I2S out Auto Mode Enable
    {0x163E13, 0x0F, 0x03},// I2S out Auto Mode Select
    {0x112C90, 0x40, 0x00},
    {0x112C90, 0x1E, 0x00},// I2S out OEZ
    {0x112C8D, 0x02, 0x00},
    {0x112C8D, 0x01, 0x00},
    {0x112C8C, 0x70, 0x20},// I2S out MCL Seletc Manual Mode
    {0x112C8C, 0x08, 0x00},// I2S out Format
    {0x112C8C, 0x07, 0x02},// I2S out bit width Manual Mode
    {0x112C8D, 0x80, 0x80},
    {0x112C8D, 0x40, 0x40},// I2S out CNT reset
    {0x112C8D, 0x08, 0x08},// I2S out FIFO status clear
    {0xFFFFFF, 0x01, 0x01},// delay 1m sec
    {0x112C8D, 0x40, 0x00},
    {0x112C8D, 0x08, 0x00},
...
{
    //-----------------Output: DAC--------------------------//Item 12
    {0xFFFFFF, 0x01, 0x0A},// delay 1m sec
    {0x112CEE, 0xFF, 0x03},
    {0x112CEF, 0xFF, 0x13},
    {0x112CEC, 0xFF, 0x00},
    {0x112CED, 0xFF, 0x18},
...
const AUDIO_REG_TYPE  AudioInitTbl_4[]=
{
    ...
    {0x112C97, 0xFF, 0x01},
    {0x112C98, 0xFF, 0x01},  //Enable CH3/7 HW force mute
    {0x112C99, 0xFF, 0x01},
    {0x112C9A, 0xFF, 0x01},  //Enable CH4/8 HW force mute
    {0x112C9B, 0xFF, 0x01},
    ...
    {0x163040, 0x20, 0x00},  // Enable R2_1 write buffer burst mode
    ...
    {0x112F60, 0x04, 0x04},  // DMA Arb limit_en
    {0x112F62, 0xFF, 0x08},  // DMA Arb Burst Length
    {0x112F80, 0xFF, 0x05},  // Cache Arb limit_en
    {0x112F81, 0xFF, 0x80},
    {0x112F82, 0xFF, 0x08},  // Cache Arb Burst Length
    {0x112F83, 0xFF, 0x00},
    {0x163D80, 0x04, 0x04},  // R2 Arb limit_en
    {0x163D82, 0xFF, 0x08},  // R2 Arb Burst Length
    {0x163DA0, 0x04, 0x04},  // R2 Arb limit_en
    {0x163DA2, 0xFF, 0x08},  // R2 Arb Burst Length
    {0x163E20, 0x04, 0x04},  // DMA Arb limit_en
    {0x163E22, 0xFF, 0x08},  // DMA Arb Burst Length

    {0xFFFFFF, 0x00, 0x00},       // end of table
};

const AUDIO_REG_TYPE  AudioInitTbl_5[]=
{
    // ----------------------------------------------------
    ...
    // ----------------------------------------------------
    {0x112B40, 0xFF, 0x4C},    // For Maserati only, dsp control Gain value, default is -1.81db

    // ----------------------------------------------------
    {0x112A80, 0x80, 0x00},    //idma control by mcu

    {0x112E93, 0xFF, 0x00},    // DAP default use downmix channel(0:downmix channel    1:Multi-channel)
    {0x112E98, 0xFF, 0x00},    // Multi-channel default volume = 0dB
    {0x112E99, 0x7F, 0x0C},    // Multi-channel default volume = 0dB
...
void  HAL_AUDIO_WriteInitTable(void)
{
    ...
    // check 0x112CE0 bit 12 to make sure audio has initialized or not
    ...
    if (HAL_AUDIO_CheckBootOnInitState() == FALSE)
    {
       ...
       while( !((AudioInitTbl_0[i].u32Addr == 0xFFFFFF) && (AudioInitTbl_0[i].u8Mask == 0)) )
       {
        ...
        i = 0;
        while( !((AudioInitTbl_4[i].u32Addr == 0xFFFFFF) && (AudioInitTbl_4[i].u8Mask == 0)) )
        {
            if((AudioInitTbl_4[i].u32Addr == 0xFFFFFF))
            {
                if(AudioInitTbl_4[i].u8Mask == 1)
                {
                    if(AudioInitTbl_4[i].u8Value!=0)
                        MsOS_DelayTask((MS_U32)(AudioInitTbl_4[i].u8Value));
                }
            }
            else
            {
                HAL_AUDIO_AbsWriteMaskByte(AudioInitTbl_4[i].u32Addr, AudioInitTbl_4[i].u8Mask, AudioInitTbl_4[i].u8Value);
            }
    ...
    i = 0;
    while( !((AudioInitTbl_5[i].u32Addr == 0xFFFFFF) && (AudioInitTbl_5[i].u8Mask == 0)) )
    {
        if((AudioInitTbl_5[i].u32Addr == 0xFFFFFF))
        {
            if(AudioInitTbl_5[i].u8Mask == 1)
            {
                if(AudioInitTbl_5[i].u8Value!=0)
                    MsOS_DelayTask((MS_U32)(AudioInitTbl_5[i].u8Value));
            }
        }
        else
        {
            HAL_AUDIO_AbsWriteMaskByte(AudioInitTbl_5[i].u32Addr, AudioInitTbl_5[i].u8Mask, AudioInitTbl_5[i].u8Value);
        }
...
void HAL_AUDIO_EnaEarphone_LowPower_Stage(void)
{
    ...
    HAL_AUDIO_WriteMaskByte(0x2CEC, 0xFF, 0x00);  //wriu -w 0x112cec 0x1800		//EN_STG2_AB_EAR=1,EN_STG2_LP_EAR=1,PD_LDO=0,EN_QS_LDO=0
    HAL_AUDIO_WriteMaskByte(0x2CED, 0xFF, 0x18);
    HAL_AUDIO_WriteMaskByte(0x2CEE, 0xFF, 0x03);   //wriu -w 0x112cee 0x0303		//MSP=0,EN_EAR=1,EN_MUTE_EAR=0, SEL_DEPOP_EAR[1:0]=11
...
void _HAL_AUDIO_I2S_SetMode(MS_U8 u8Mode, MS_U8 u8Val)
{
   switch(u8Mode)
   {
     ...
     case AUDIO_I2S_WORD_WIDTH:   //0x163E12[11:8]
       // for backward compatible, set I2S_WORD_WIDTH value for Maserati here
       	if (u8Val == I2S_WORD_WIDTH_16BIT)
       	    HAL_AUDIO_AbsWriteMaskByte(REG_I2S_TX_CLK_CTRL+1,0x0F,0x0);
       	else if (u8Val == I2S_WORD_WIDTH_24BIT)
       	    HAL_AUDIO_AbsWriteMaskByte(REG_I2S_TX_CLK_CTRL+1,0x0F,0x3);
       	else if (u8Val == I2S_WORD_WIDTH_32BIT)
       	    HAL_AUDIO_AbsWriteMaskByte(REG_I2S_TX_CLK_CTRL+1,0x0F,0x4);
        else
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "%s() - I2S_WORD_WIDTH %d not exist\n",__FUNCTION__, u8Val);
       break;
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function \b Name: _HAL_AUDIO_Get_SourceIndex()  @@Ken
/// @brief \b Function \b Description:  Get Source Decoder index
/// @param <IN>        \b \b eAudioSource:     E_AUDIO_INFO_DTV_IN -- DTV Source
///                                            E_AUDIO_INFO_HDMI_IN -- HDMI Source
///                                            E_AUDIO_INFO_MM_IN -- MM Source
/// @param <OUT>       \b NONE    :
/// @param <RET>       \b  AUDIO_DEC_ID  :
///                                            AUDIO_DEC_ID: AU_DEC_ID1 -- 0
///                                                          AU_DEC_ID2 -- 1
///                                                          AU_DEC_ID3 -- 2
///                                            Error code: -1 -- invalid Decoder index
///                                                        -2 -- invalid source
///                                                        -3 -- No connect
/// @param <GLOBAL>    \b NONE    :
////////////////////////////////////////////////////////////////////////////////
AUDIO_DEC_ID _HAL_AUDIO_Get_SourceDecoderIndex(AUDIO_SOURCE_INFO_TYPE eAudioSource)
{
    MS_U32 u32DecIndex = 0;
    MS_U32 u32CurrDecIndex = AU_DEC_MAX;
    AUDIO_DEC_ID *pDecPriority = NULL;

    switch(eAudioSource)
    {
        case E_AUDIO_INFO_DTV_IN:
        {
            pDecPriority = DTVDecPriority;
            break;
        }

        case E_AUDIO_INFO_HDMI_IN:
        {
            pDecPriority = HDMIDecPriority;
            break;
        }

        case E_AUDIO_INFO_MM_IN:
        {
            pDecPriority = MMDecPriority;
            break;
        }
    ...
    for (u32DecIndex = 0; u32DecIndex < AU_DEC_MAX;u32DecIndex++)
    {
        if(g_AudioVars2->AudioDecStatus[pDecPriority[u32DecIndex]].eSourceType == E_AUDIO_INFO_DTV_IN)
        {
            u32CurrDecIndex = pDecPriority[u32DecIndex];
            break;
        }
    }

    if (u32CurrDecIndex == AU_DEC_MAX)
    {
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "%s() u32CurrDecIndex %d - Invalid u32DecIndex\n",__FUNCTION__, u32CurrDecIndex);
        return AU_DEC_INVALID;
    }

    if (g_AudioVars2->AudioDecStatus[u32CurrDecIndex].bConnect == FALSE)
    {
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "%s() Decoder%d Not Connect\n",__FUNCTION__, u32CurrDecIndex);
        return AU_DEC_INVALID;
    }

    return u32CurrDecIndex;
...
void HAL_AUDIO_SPDIF_SetMode(MS_U8 u8Spdif_mode, MS_U8 u8Input_src)
{
    ...
    MS_U8 u8ChannelMuxId = 0; // decoder1
    ...
    //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "%s: u8Spdif_mode = %d, eAudioSource = %d, u8Dsp1CodeType = %d, u8Dsp2CodeType = %d, u8Input_src = %d\r\n", __FUNCTION__, u8Spdif_mode, eAudioSource, u8Dsp1CodeType, u8Dsp2CodeType, u8Input_src);
        ...
        case E_AUDIO_INFO_GAME_IN:
        {
            ...
            switch(MainDspCodeType)
            {
                ...
                case AU_DVB_STANDARD_MS10_DDT:
                {
                    ...
                    else
                    {
                            ...
                            (u8SpdifMode == SPDIF_OUT_TRANSCODE))
                        {
                            ...
                            else if ((MDrv_AUTH_IPCheck(AU_DVB_AUTHBIT_DOLBY_MS12_B)||
                                      MDrv_AUTH_IPCheck(AU_DVB2_AUTHBIT_DOLBY_MS12_B_WO_AAC)||
                                      MDrv_AUTH_IPCheck(AU_DVB_AUTHBIT_DOLBY_MS12_D)||
                                      MDrv_AUTH_IPCheck(AU_DVB2_AUTHBIT_DOLBY_MS12_D_WO_AAC))&& (Digital_Out_DDP_Support == 1))
                            {
                                if (u32HdmiArcSpecifiedOutputCodec != DIGITAL_OUTPUT_CODEC_AC3)
                                {
                                    HAL_AUR2_WriteMaskByte(REG_SNDR2_MBOX_BYTE_DAP_SEL, 0x20, 0x20);   //enable DDP encoder
                                    HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_DDP_ENCODE_EN, u8MainDecodeId, 1, 0);
                                    ddp_enc_enable = 1;
                                }
                            }
                ...
                case AU_DVB2_ENCODE_MS10_DDE:
                {
                    ...
                    /* 0: default, 1: support, 2: not support */
                    else if (Digital_Out_DDP_Support == 1)
                    {
                        //if(u8SpdifMode != SPDIF_OUT_TRANSCODE)
                        if(u8SpdifMode == SPDIF_OUT_BYPASS)
                        {
                        ...
                        else
                        {
                            if ((MDrv_AUTH_IPCheck(AU_DVB_AUTHBIT_DOLBY_MS12_B)||
                                 MDrv_AUTH_IPCheck(AU_DVB2_AUTHBIT_DOLBY_MS12_B_WO_AAC)||
                                 MDrv_AUTH_IPCheck(AU_DVB_AUTHBIT_DOLBY_MS12_D)||
                                 MDrv_AUTH_IPCheck(AU_DVB2_AUTHBIT_DOLBY_MS12_D_WO_AAC))&& (u8SpdifMode == SPDIF_OUT_NONPCM || u8SpdifMode == SPDIF_OUT_TRANSCODE))
                            {
                                if (u32HdmiArcSpecifiedOutputCodec != DIGITAL_OUTPUT_CODEC_AC3)
                                {
                                    HAL_AUR2_WriteMaskByte(REG_SNDR2_MBOX_BYTE_DAP_SEL, 0x20, 0x20);   //enable DDP encoder
    ...
    if(ddp_enc_enable == 0)
    {
        ...
        HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_DDP_ENCODE_EN, u8MainDecodeId, 0, 0);
    }

    //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "%s: u8MainDspCodeType = %d, u8SpdifMode = %d\r\n", __FUNCTION__, u8MainDspCodeType, u8SpdifMode);

    switch (eAudioSource)
    {
        case E_AUDIO_INFO_HDMI_IN:
        {
            if ((HAL_MAD_GetAC3PInfo(Audio_AC3P_infoType_hdmiAC3inSE) != 0))
            {
                u8ChannelMuxId = 0x2; // decoder3
            }
            break;
        }
        ...
        case E_AUDIO_INFO_DTV_IN:
        {
            u32DecIndex = _HAL_AUDIO_Get_SourceDecoderIndex(E_AUDIO_INFO_DTV_IN);

            if (u32DecIndex == AU_DEC_ID1)
            {
                u8ChannelMuxId = 0x0; // decoder1
            }
            else if (u32DecIndex == AU_DEC_ID3)
            {
                u8ChannelMuxId = 0x2; // decoder1
            }
        ...
        case E_AUDIO_INFO_GAME_IN:
        {
            if ((HAL_MAD_GetDecCmd(DVB_Audio_Decoder1) == AU_DVB_DECCMD_PLAYFILETSP) || (HAL_MAD_GetDecCmd(DVB_Audio_Decoder1) == AU_DVB_DECCMD_PLAYFILE)
                || (HAL_MAD_GetDecCmd(DVB_Audio_Decoder1) == AU_DVB_DECCMD_PLAYFRAME) || (HAL_MAD_GetDecCmd(DVB_Audio_Decoder1) == AU_DVB_DECCMD_PLAYFRAME_STAGE)
                || (HAL_MAD_GetDecCmd(DVB_Audio_Decoder1) == AU_DVB_DECCMD_PLAYFILE2_PTS) || (HAL_MAD_GetDecCmd(DVB_Audio_Decoder1) == AU_DVB_DECCMD_PLAY_AD)
               )
            {
                u8ChannelMuxId = 0x0; // decoder1
            }
    ...
    /* set multi channel input source to current decoder */
    HAL_AUDIO_WriteMaskByte(REG_AUDIO_CH1_CFG, 0x07, u8ChannelMuxId);
    HAL_AUDIO_WriteMaskByte(REG_AUDIO_CH2_CFG, 0x07, u8ChannelMuxId);
    HAL_AUDIO_WriteMaskByte(REG_AUDIO_CH3_CFG, 0x07, u8ChannelMuxId);
    HAL_AUDIO_WriteMaskByte(REG_AUDIO_CH4_CFG, 0x07, u8ChannelMuxId);
    ...
    switch (u8SpdifMode)
    {
        ...
        {
            //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "HAL SPDIF set as Non-PCM\n");
        ...
        default:
        {
            //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "HAL SPDIF set as PCM\n");
...
//=======================================================
   ...
   //========= Set for S/PDIF out ===========
    ...
    else  //====== HDMI pcm mode =======
    {
        ...
        if (HAL_MAD_GetAC3PInfo(Audio_AC3P_infoType_hdmiAC3inSE) == 1)
        {
            HAL_AUR2_WriteByte(REG_R2_DECODE2_CMD, AU_DEC_R2_CMD_STOP);
        }
        else
        {
            HAL_AUR2_WriteByte(REG_R2_DECODE1_CMD, AU_DEC_R2_CMD_STOP);
        }
    }
...
void HAL_AUDIO_BackupMailbox(void)
{
    ...
    MAD2DecCMD = HAL_MAD2_GetDecCmd();
    MADDec1CMD = HAL_MAD_GetDecCmd(DVB_Audio_Decoder1);
    MADDec2CMD = HAL_MAD_GetDecCmd(DVB_Audio_Decoder2);
    MADDec1Type = HAL_AUDIO_AbsReadByte(REG_R2_DECODE1_TYPE) & adec_type_regmask;
    MADDec2Type = HAL_AUDIO_AbsReadByte(REG_R2_DECODE2_TYPE) & adec_type_regmask;

    HAL_MAD2_SetDecCmd(0x100); // CathyNeedRefine
    HAL_MAD_SetDecCmd(AU_DVB_DECCMD_STOP);
    HAL_MAD_SetDSP2DecCmd(AU_DVB_DECCMD_STOP);

    HAL_AUDIO_AbsWriteMaskByte((MS_U32)REG_R2_DECODE1_TYPE, (MS_U8)adec_type_regmask, (MS_U8)adec_type_dummy);
    HAL_AUDIO_AbsWriteMaskByte((MS_U32)REG_R2_DECODE2_TYPE, (MS_U8)adec_type_regmask, (MS_U8)adec_type_dummy);
}
...
void HAL_AUDIO_RestoreMailbox(void)
{
    ...
    HAL_AUDIO_AbsWriteMaskByte((MS_U32)REG_R2_DECODE1_TYPE, (MS_U8)adec_type_regmask, (MS_U8)MADDec1Type);
    HAL_AUDIO_AbsWriteMaskByte((MS_U32)REG_R2_DECODE2_TYPE, (MS_U8)adec_type_regmask, (MS_U8)MADDec2Type);

    HAL_MAD_SetDecCmd(MADDec1CMD);
    HAL_MAD_SetDSP2DecCmd(MADDec2CMD);
    HAL_MAD2_SetDecCmd(((MS_U16)MAD2DecCMD)+0x100);
}
...
MS_BOOL HAL_AUDIO_DmaWriter_Read(void* buffer, MS_U32 bytes)
{
    ...
    //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "D %x\n", DRAM_levelcnt);
...
MS_BOOL HAL_AUDIO_AlgReloadCode2(AUDIO_DSP_ID id, AUDIO_DSP_CODE_TYPE code_type, void * pau_info)
{
    ...
    {
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "  %s DSP Reload Fail !!\r\n", (id==AUDIO_DSP_ID_DEC ? "DEC" : "SND"));
        return FALSE;
    }
...
MS_BOOL HAL_AUDIO_SetDecodeSystem(AUDIO_DEC_ID DecId, AudioDecStatus_t *p_AudioDecStatus)
{
    ...
    else
    {
        ...
        if (MainDecoderId != -1)
        {
            ...
            {
                /*
                 * if it's sub case, then the other decoder is main decoder
                 * sub is dec1, then main is dec2
                 * sub is dec2, then main is dec1
                 */
                MainDecoderId = (MainDecoderId == 0x1) ? 0x0 : 0x1;
            }
            // Inform R2 main decoder, 0:dec 1 , 1:dec2
            HAL_AUR2_WriteMaskByte(REG_SNDR2_MBOX_MAIN_SEL, 0x01, MainDecoderId);
        }
    }
...
void HAL_AUDIO_DumpDspInfo(void)
{
    ...
    if ((g_AudioDumpInfoCtrl & Audio_DumpInfo_Avsync) != 0)
    {
        ...
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "PCM=%04X(%04X,%04X)|", (unsigned int)PCM_Lvl, (unsigned int)tmp_H, (unsigned int)tmp_L);   //need get from DSP
        ...
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "STC=%d,", (unsigned int)result/45);

        result = HAL_DEC_R2_Get_SHM_INFO(R2_SHM_INFO_PTS, ADEC1);
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "PTS=%d,", (unsigned int)result/45);

        result = HAL_DEC_R2_Get_SHM_INFO(R2_SHM_INFO_CURR_PTS, ADEC1);
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "cPTS=%d,", (unsigned int)result/45);

        result = HAL_MAD_GetCommInfo(Audio_Comm_infoType_ADEC1_33bit_STCPTS_DIFF);
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "|Td=%x\n", (unsigned int)result/90);
    }
    ...
    if ((g_AudioDumpInfoCtrl & Audio_DumpInfo_Dec1) != 0)
    {
        ...
        tmp_H = HAL_MAD2_Read_DSP_sram(DSP2DmAddr_r2_pcm1_info+R2_SHM_INFO_ELAPSED_PCM_CNT, DSP_MEM_TYPE_DM)&0xFFFF;
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "PCM=%04X(%04X,%02X)|", (unsigned int)PCM_Lvl, (unsigned int)tmp_H, (unsigned int)tmp_L); //need get from DSP
        ...
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "pcm=%06X,",  (unsigned int)tmp_L);  //need get from DSP

        tmp_L = HAL_MAD2_Read_DSP_sram(DSP2DmAddr_IO_Info2+R2_SHM_INFO_DEC_OUT_R, DSP_MEM_TYPE_DM)&0x00FFFFFF;
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "%06X|",  (unsigned int)tmp_L); //need get from DSP
    ...
    if ((g_AudioDumpInfoCtrl & Audio_DumpInfo_IoInfo) != 0)
    {
        ...
        tmp_L = HAL_MAD2_Read_DSP_sram(DSP2DmAddr_IO_Info2+R2_SHM_INFO_DEC_OUT_L, DSP_MEM_TYPE_DM)&0x00FFFFFF;
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "|DEC1=0x%06X,",  (unsigned int)tmp_L); //need get from DSP

        tmp_L = HAL_MAD2_Read_DSP_sram(DSP2DmAddr_IO_Info2+R2_SHM_INFO_DEC_OUT_L, DSP_MEM_TYPE_DM)&0x00FFFFFF;
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "DEC2=0x%06X",  (unsigned int)tmp_L); //need get from DSP
    ...
    {
        sysTime = MsOS_GetSystemTime();
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "[%08u](%03u):", (unsigned int)sysTime, (unsigned int)(sysTime - preSysTime));
        preSysTime = sysTime;

        mmFile_APTS = HAL_MAD_GetCommInfo(Audio_Comm_infoType_1ms_PTS);
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "APTS:%07u(%03u)|", (unsigned int)mmFile_APTS, (unsigned int)(mmFile_APTS - prv_mmFile_APTS));
        prv_mmFile_APTS = mmFile_APTS;

        tmp_H = HAL_DEC_R2_Get_SHM_INFO(R2_SHM_INFO_MM_FILE_REQ_SIZE, ADEC1)&0xFFFF;
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "MM:%04X|", (unsigned int)tmp_H);
        ...
        tmp_L = HAL_MAD2_Read_DSP_sram(DSP2DmAddr_r2_pcm1_info+R2_SHM_INFO_PCMISR_EMPTY_CNT, DSP_MEM_TYPE_DM)&0xFF;
        tmp_H = HAL_MAD2_Read_DSP_sram(DSP2DmAddr_r2_pcm1_info+R2_SHM_INFO_ELAPSED_PCM_CNT, DSP_MEM_TYPE_DM)&0xFFFF;
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "PCM=%04X(%06X,%02X)|", (unsigned int)PCM_Lvl, (unsigned int)tmp_H, (unsigned int)tmp_L);  //need get from DSP
        ...
        //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "DEC_ID=%02X,", tmp_L);

        //tmp_L = HAL_MAD_Read_DSP_sram(DSP1DmAddr_sys_DecStatus+SYS_DECSTATUS_DEC_TYPE, DSP_MEM_TYPE_DM)&0x00FF;
        //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_INFO, "Type=%02X,", tmp_L);
...
MS_BOOL HAL_AUDIO_DeAllocateTeeInfoShm(void)
{
    ...
    if (g_bAudioTeeInfoShmInitFlag == TRUE)
    {
        ...
        if (pAUDIOShared->g_u32ClientCounter == 0)
        {
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "free Audio TEE Info SHM data ...\n");
#if defined(MSOS_TYPE_LINUX)
...
Audio_id HAL_AUDIO_Convert_DecId_to_ADECId(AUDIO_DEC_ID dec_id)  //temp
{
    ...
    switch(dec_id)
    {
        case  AU_DEC_INVALID:
        case AU_DEC_MAX:
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "[Error] Can't convert...\n");
...
{
    MS_U32 Waittime = 0;
    MS_U32 ip_auth_temp = 0;

    Waittime = MsOS_GetSystemTime();

    while (1) {
        ip_auth_temp = HAL_DEC_R2_Get_SHM_INFO( R2_SHM_INFO_SECURITY_INFO, ADEC1);

        if (ip_auth_temp == ip_auth) {
            return TRUE;
        }
        else {
            if (MsOS_Timer_DiffTimeFromNow(Waittime) > 1000) {
                AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "%s: Error! Hashkey not match over 1s !\n", __FUNCTION__);
                return -A_EINVAL;
            }
        }
    }
