...
*************************************************/
    /* DSP DDR size */
        ...
        /* ASND-DSP DDR */
            ...
            #define DDENC_METADATA_DRAM_SIZE               0xCC0       //48 * (PCM1_DRAM_SIZE/2/10/1536) if PCM1_DRAM_SIZE == PCM2_DRAM_SIZE
            ...
            #define OFFSET_MULTI_CH_INPUT_DLY_DRAM_BASE    0x0138000
            #define MULTI_CH_INPUT_DLY_DRAM_SIZE           0x1B000      // 6ch (128 ms), can be adjusted by request    //108KB, multiple of (MULTI_CH_INPUT_DELAY_DMA_LINESIZE*BYTES_IN_MIU_LINE)
        ...
        /* Common DDR */
            ...
            #define PCM2_DRAM_SIZE                         0xFF000

            #define OFFSET_HW_DMA_READER2_DRAM_BASE        0x0147000
            #define HW_DMA_READER2_DRAM_SIZE               0x10000                                                     //64KB                                                   //1020KB

            #define OFFSET_MP3_ENC_DRAM_BASE               0x0157000                                                   //12KB
            #define MP3_ENC_DRAM_SIZE                      0x3000

            #define OFFSET_PCM_MIXER_ELEMENT_INFO_BASE     0x015A000
            #define PCM_MIXER_ELEMENT_INFO_SIZE            0x1000

            #define OFFSET_PCM_MIXER_ELEMENT_BUFFER_BASE   0x015B000
            #define PCM_MIXER_ELEMENT_BUFFER_SIZE          0x78000

            #define OFFSET_PCM_MIXER1_MIXED_BUFFER_BASE    0x01D3000
            #define OFFSET_PCM_MIXER2_MIXED_BUFFER_BASE    0x01D7000
            #define PCM_MIXER_MIXED_BUFFER_SIZE            0x4000

            #define OFFSET_MCU_R2_DMA1_READER_DRAM_BASE    0x01E0000
            #define MCU_R2_DMA1_READER_DRAM_SIZE           0x50000                                                     //320KB

            #define OFFSET_MCU_R2_DMA2_READER_DRAM_BASE    0x0230000
            #define MCU_R2_DMA2_READER_DRAM_SIZE           0x50000                                                     //320KB

            #define OFFSET_PCM1_DRAM_ADDR                  0x0300000
            #define PCM1_DRAM_SIZE                         0x1FE000                                                     //2040KB

            #define OFFSET_SPDIF_NONPCM_DRAM_BASE          0x0500000                                                   //216KB
            #define SPDIF_NONPCM_DRAM_SIZE                 0x66000

            #define OFFSET_HDMI_NONPCM_DRAM_BASE           0x0568000
