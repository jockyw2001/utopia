...
void  HAL_SOUND_SRS_APOLLO_SetPara(MS_U8 u8mode, MS_U32 u32param, MS_U16 u16value2)
{
    ...
    //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "HAL_SOUND_APOLLO_SetPara: %x %x %x\r\n",(int)u8mode,(int)u32param, (int)u16value2);
    ...
    switch (u8mode)
    {
        ...
        case AU_SRS_THEATER_TSHD_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_TSHD_SURR_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_SURR_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_TSHD_TRUBASS_FRONT_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_TRUBASS_FRONT_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_TSHD_DEFINITION_FRONT_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_DEFINITION_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_TSHD_DIALOG_CLARITY_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_DIALOG_CLARITY_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_CC3D_DEPTH_PROCESS_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_DEPTH_PROCESS_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_CC3D_3D_SURR_BOOST_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_3D_SURR_BOOST_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_CC3D_FADE_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_FADE_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TSHD_MIX_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TSHD_MIX_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_CC3D_INPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_INPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_OUTPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_OUTPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TSHD_MIX_FADE_CTRL:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TSHD_MIX_FADE_CTRL %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TBHDX_INPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TBHDX_INPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TBHDX_BASSLEVEL:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TBHDX_BASSLEVEL %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TBHDX_SPEAKERSIZE:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TBHDX_SPEAKERSIZE %s (%d)\n",st,(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TBHDX_MODE:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TBHDX_MODE %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TBHDX_DYNAMICS:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TBHDX_DYNAMICS %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TBHDX_HP_ORDER:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TBHDX_HP_ORDER %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_TBHDX_CUSTOM_FILTER:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_TBHDX_CUSTOM_FILTER %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_GEQ_INPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_GEQ_INPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_GEQ_BAND0_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_GEQ_BAND0_GAIN index =%d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_GEQ_BAND1_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_GEQ_BAND1_GAIN index =%d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_GEQ_BAND2_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_GEQ_BAND2_GAIN index =%d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_GEQ_BAND3_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_GEQ_BAND3_GAIN index =%d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_GEQ_BAND4_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_GEQ_BAND4_GAIN index =%d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CC3D_PROCESS_PATH:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CC3D_PROCESS_PATH =%d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_SURROUND_LEVEL_CTRL:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_SURR_LEVEL_CTRL %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_INPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_INPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_OUTPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_OUTPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_DEFINITION_FRONT_CTRL:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_DEFINITION_CTRL %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_DIALOG_CLARITY_CTRL:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_DIALOG_CLARITY_CTRL %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_TRUBASS_FRONT_CTRL:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_TRUBASS_FRONT_CTRL %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_TRUBASS_SPEAKER_SIZE:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_TRUBASS_SPEAKER_SIZE %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_TRUBASS_COMPRESSOR_CTRL:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_TRUBASS_COMPRESSOR_CTRL %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_TRUBASS_PROCESS_MODE:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_TRUBASS_PROCESS_MODE %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TSHD_TRUBASS_SPEAKER_AUDIO:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TSHD_TRUBASS_SPEAKER_AUDIO %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_VIQ_INPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "VOLHD_INPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_VIQ_OUTPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "VOLHD_OUTPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_VOLHD_MAXGAIN_CONTROL:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "VOLHD_MAXGAIN_CTRL %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_VOLHD_NORMALIZER_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "VOLHD_NORMALIZER_EN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_VOLHD_NORMTHRESH:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "VOLHD_NORMTHRESH %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CS_PROCESSING_MODE:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CS_PROCESSING_MODE %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CS_LR_OUTPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CS_LR_OUTPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CS_LSRS_OUTPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CS_LSRS_OUTPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_CS_CENTER_OUTPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "CS_CENTER_OUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TRUDIALOG_EN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TRUDIALOG_EN %d\n",bEnable);
            break;
        ...
        case AU_SRS_THEATER_TRUDIALOG_INPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TRUDIALOG_INPUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TRUDIALOG_OUTPUT_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TRUDIALOG_OUT_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TRUDIALOG_BYPASS_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TRUDIALOG_BYPASS_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TRUDIALOG_PROCESS_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TRUDIALOG_PROCESS_GAIN %d\n",(unsigned int)u32param);
            break;
        ...
        case AU_SRS_THEATER_TRUDIALOG_CLARITY_GAIN:
            ...
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "TRUDIALOG_CLARITY_GAIN %d\n",(unsigned int)u32param);
            break;
     ...
     /////////////////////////////////////////////////PureSound Control Start///////////////////////////////////////////////////////////
        ...
        default:
            //AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "-----HAL_SOUND_SRS_APOLLO_SetPara: Unknown command u8mode=%d u16value=0x%lx-----\r\n", u8mode, (MS_U32)u32param);
            break;
...
/// @param <IN>        \b AUDIO_DSP_CODE_TYPE type
/// @param <OUT>       \b NONE    :
/// @param <RET>       \b  NONE    :
/// @param <GLOBAL>    \b NONE
////////////////////////////////////////////////////////////////////////////////
MS_BOOL HAL_ADVSOUND_ProcessEnable(AUDIO_DSP_CODE_TYPE type)
{
    ...
    {
        if(HAL_AUDIO_GetAdvSndEffDspCodeType() != type)
        {
        ret_status = HAL_AUDIO_Alg2ReloadCode(type);
            HAL_AUDIO_SetAdvSndEffDspCodeType(type, ret_status);
        }
    ...
    else if (type == AU_DVB2_ADVSND_NONE)
    {
        ...
        g_AudioVars2->g_DolbyDAPEnable = FALSE;
...
void HAL_AUDIO_COPY_Parameter(ADVSND_PARAM type, void* Parameter_ptr, MS_U32 size)
{
    ...
    else if (ADVSND_PARAM_Compare(type, DOLBY_DAP_SET_PARAMS))
    {
...
int HAL_Copy(MS_U32 *ptr_data, MS_U32 Address, MS_U32 Length)
{
    ...
    {
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "ERROR: DEC DSP IDMA Busy \n");
    ...
    for (i = 0; i<Length; i++)
    {
        ...
        {
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "ERROR: DEC DSP IDMA write data time out1 \n");
            OS_RELEASE_MUTEX(_s32AUDIOMutexIDMA);
            return FALSE;
        }
        ...
        if (HAL_AUDSP_CheckSeIdmaReady(AUD_CHK_DSP_WRITE_RDY)==FALSE)
        {
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "ERROR: DEC DSP IDMA write data time out2 \n");
            OS_RELEASE_MUTEX(_s32AUDIOMutexIDMA);
            return FALSE;
        }
    }
