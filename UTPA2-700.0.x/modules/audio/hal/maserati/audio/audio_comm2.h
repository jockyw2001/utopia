...
*   Version Control
*********************************************************/
#define  system_version_num              0x880D84
#define  dde_version_num                 0xD20059
#define  ms10_dde_version_num            0xD800CC
#define  palsum_version_num              0x54400F
#define  btsc_version_num                0x046C0C
#define  srs_puresound_version_num       0x202019
#define  dbx_version_num                 0x1A01AD
#define  dts_transcoder_version_num      0xDE009A
...
DM      (4.500)kw      10.25kw          1kw         2.250kw
************************************************/
    /* DSP SRAM Segment */
        /* CM */
    ...
    /* SND DSP PM vars */
        /* common */
            ...
            #define DSP2PmAddr_SE_CoeffAddr         (DSP2PmAddr_mainVer +   0x10)
            #define DSP2PmAddr_peq48KCoeffAddr      (DSP2PmAddr_SE_CoeffAddr    )
            ...
            #define DSP2PmAddr_hpfscale48KfAddr     (DSP2PmAddr_hpf48KCoeffAddr     + 5  )
            #define DSP2PmAddr_toneSelectAddr       (DSP2PmAddr_hpfscale48KfAddr    + 1  )
            ...
            #define DSP2PmAddr_AQParameterAddr      (DSP2PmAddr_treblescale48KAddr  + 1  )
            #define DSP2PmAddr_SPK_OutChannel       (DSP2PmAddr_AQParameterAddr     + 200)
            ...
            #define DSP2fetch3Addr_48kAddr          (DSP2_PM_PREFETCH3_DSPADDR        )
            #define DSP2fetch3Addr_96kAddr          (DSP2_PM_PREFETCH3_DSPADDR + 0x100)
            #define DSP2fetch3Addr_192kAddr         (DSP2_PM_PREFETCH3_DSPADDR + 0x200)

            #define MIU_OFFSET_SE_Coeff_48k         (DSP2fetch3Addr_48kAddr*3/BYTES_IN_MIU_LINE )
            #define MIU_OFFSET_SE_Coeff_96k         (DSP2fetch3Addr_96kAddr*3/BYTES_IN_MIU_LINE )
            #define MIU_OFFSET_SE_Coeff_192k        (DSP2fetch3Addr_192kAddr*3/BYTES_IN_MIU_LINE)
            #define DMA_SIZE_SE_Coeff               (144*3/BYTES_IN_MIU_LINE                    )
...
*************************************************/
    ...
    ************************************************/
    ...
    #define S2M_MBOX_SPDIF_RDPTR                MB_2D7A
    #define S2M_MBOX_MM_PTS_ME                  MB_2D7C
    #define S2M_MBOX_HDMI_RDPTR                 MB_2D7C
...
*************************************************/
    ...
    /* Surround */
        ...
        #define SUR_DRAM_ENDADDR                        ((OFFSET_MSTAR_SURROUND_DRAM_ADDR + 0x0003000) / BYTES_IN_MIU_LINE)  // Line Address //32KB (use 12KB)
