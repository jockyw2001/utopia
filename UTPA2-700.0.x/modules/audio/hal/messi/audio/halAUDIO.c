...
//-----------------------------------------------------
    ...
    {0x163E06, 0xFF, 0xFF},     //wd_en_delay setting by Jeff
    {0x163E07, 0xFF, 0xFF},
...
MS_BOOL HAL_AUDIO_ResetDefaultVars(AUDIO_SHARED_VARS2 * pAUDIOShared)
{
    ...
    pAUDIOShared->g_u8DspCodeType = AU_DVB_STANDARD_INVALID;
    pAUDIOShared->g_u8Dsp2CodeType = AU_DVB_STANDARD_INVALID;
    pAUDIOShared->g_u8AdvSndEffDspCodeType = AU_DVB_STANDARD_INVALID;
	        ...
	        if((AudioInitTbl_2[i].u32Addr == 0xFFFFFF))
	        {
                if(AudioInitTbl_2[i].u8Mask == 1)
                {
                    if(AudioInitTbl_2[i].u8Value!=0)
                        MsOS_DelayTask((MS_U32)(AudioInitTbl_2[i].u8Value));
                }
            }
            else
            {
        ...
        if((AudioInitTbl_3[i].u32Addr == 0xFFFFFF))
        {
            if(AudioInitTbl_3[i].u8Mask == 1)
            {
                if(AudioInitTbl_3[i].u8Value!=0)
                    MsOS_DelayTask((MS_U32)(AudioInitTbl_3[i].u8Value));
            }
        }
        else
        {
...
{
    MS_U8 u8SourceDspCodeType = AU_DVB_STANDARD_INVALID;
    MS_U8 u8Dsp1CodeType = AU_DVB_STANDARD_INVALID;
