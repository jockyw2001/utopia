...
{=== 24-bit MailBox DM IO : SE_DSP to SND R2  ======================}
    .const DSP_2_DECR2M_MAILBOX0  = MAIL_IO_BASE + 0x0100;
    .const DSP_2_DECR2M_MAILBOX1  = MAIL_IO_BASE + 0x0101;
    .const DSP_2_DECR2M_MAILBOX2  = MAIL_IO_BASE + 0x0102;
    .const DSP_2_DECR2M_MAILBOX3  = MAIL_IO_BASE + 0x0103;
    .const DSP_2_DECR2M_MAILBOX4  = MAIL_IO_BASE + 0x0104;
    .const DSP_2_DECR2M_MAILBOX5  = MAIL_IO_BASE + 0x0105;
    .const DSP_2_DECR2M_MAILBOX6  = MAIL_IO_BASE + 0x0106;
    .const DSP_2_DECR2M_MAILBOX7  = MAIL_IO_BASE + 0x0107;
    .const DSP_2_DECR2M_MAILBOX8  = MAIL_IO_BASE + 0x0108;
    .const DSP_2_DECR2M_MAILBOX9  = MAIL_IO_BASE + 0x0109;
    .const DSP_2_DECR2M_MAILBOXA  = MAIL_IO_BASE + 0x010A;
    .const DSP_2_DECR2M_MAILBOXB  = MAIL_IO_BASE + 0x010B;
    .const DSP_2_DECR2M_MAILBOXC  = MAIL_IO_BASE + 0x010C;
    .const DSP_2_DECR2M_MAILBOXD  = MAIL_IO_BASE + 0x010D;
    .const DSP_2_DECR2M_MAILBOXE  = MAIL_IO_BASE + 0x010E;
    .const DSP_2_DECR2M_MAILBOXF  = MAIL_IO_BASE + 0x010F;

    .const DECR2M_2_DSP_MAILBOX0  = MAIL_IO_BASE + 0x0110;
    .const DECR2M_2_DSP_MAILBOX1  = MAIL_IO_BASE + 0x0111;
    .const DECR2M_2_DSP_MAILBOX2  = MAIL_IO_BASE + 0x0112;
    .const DECR2M_2_DSP_MAILBOX3  = MAIL_IO_BASE + 0x0113;
    .const DECR2M_2_DSP_MAILBOX4  = MAIL_IO_BASE + 0x0114;
    .const DECR2M_2_DSP_MAILBOX5  = MAIL_IO_BASE + 0x0115;
    .const DECR2M_2_DSP_MAILBOX6  = MAIL_IO_BASE + 0x0116;
    .const DECR2M_2_DSP_MAILBOX7  = MAIL_IO_BASE + 0x0117;
    .const DECR2M_2_DSP_MAILBOX8  = MAIL_IO_BASE + 0x0118;
    .const DECR2M_2_DSP_MAILBOX9  = MAIL_IO_BASE + 0x0119;
    .const DECR2M_2_DSP_MAILBOXA  = MAIL_IO_BASE + 0x011A;
    .const DECR2M_2_DSP_MAILBOXB  = MAIL_IO_BASE + 0x011B;
    .const DECR2M_2_DSP_MAILBOXC  = MAIL_IO_BASE + 0x011C;
    .const DECR2M_2_DSP_MAILBOXD  = MAIL_IO_BASE + 0x011D;
    .const DECR2M_2_DSP_MAILBOXE  = MAIL_IO_BASE + 0x011E;
    .const DECR2M_2_DSP_MAILBOXF  = MAIL_IO_BASE + 0x011F;

{=== 24-bit MailBox DM IO : SE_DSP to DEC R2  ======================}
    !.const DSP_2_SNDR2M_MAILBOX0  = MAIL_IO_BASE + 0x0400;
    !.const DSP_2_SNDR2M_MAILBOX1  = MAIL_IO_BASE + 0x0401;
    !.const DSP_2_SNDR2M_MAILBOX2  = MAIL_IO_BASE + 0x0402;
    !.const DSP_2_SNDR2M_MAILBOX3  = MAIL_IO_BASE + 0x0403;
    !.const DSP_2_SNDR2M_MAILBOX4  = MAIL_IO_BASE + 0x0404;
    !.const DSP_2_SNDR2M_MAILBOX5  = MAIL_IO_BASE + 0x0405;
    !.const DSP_2_SNDR2M_MAILBOX6  = MAIL_IO_BASE + 0x0406;
    !.const DSP_2_SNDR2M_MAILBOX7  = MAIL_IO_BASE + 0x0407;
    !.const DSP_2_SNDR2M_MAILBOX8  = MAIL_IO_BASE + 0x0408;
    !.const DSP_2_SNDR2M_MAILBOX9  = MAIL_IO_BASE + 0x0409;
    !.const DSP_2_SNDR2M_MAILBOXA  = MAIL_IO_BASE + 0x040A;
    !.const DSP_2_SNDR2M_MAILBOXB  = MAIL_IO_BASE + 0x040B;
    !.const DSP_2_SNDR2M_MAILBOXC  = MAIL_IO_BASE + 0x040C;
    !.const DSP_2_SNDR2M_MAILBOXD  = MAIL_IO_BASE + 0x040D;
    !.const DSP_2_SNDR2M_MAILBOXE  = MAIL_IO_BASE + 0x040E;
    !.const DSP_2_SNDR2M_MAILBOXF  = MAIL_IO_BASE + 0x040F;

    !.const SNDR2M_2_DSP_MAILBOX0  = MAIL_IO_BASE + 0x0410;
    !.const SNDR2M_2_DSP_MAILBOX1  = MAIL_IO_BASE + 0x0411;
    !.const SNDR2M_2_DSP_MAILBOX2  = MAIL_IO_BASE + 0x0412;
    !.const SNDR2M_2_DSP_MAILBOX3  = MAIL_IO_BASE + 0x0413;
    !.const SNDR2M_2_DSP_MAILBOX4  = MAIL_IO_BASE + 0x0414;
    !.const SNDR2M_2_DSP_MAILBOX5  = MAIL_IO_BASE + 0x0415;
    !.const SNDR2M_2_DSP_MAILBOX6  = MAIL_IO_BASE + 0x0416;
    !.const SNDR2M_2_DSP_MAILBOX7  = MAIL_IO_BASE + 0x0417;
    !.const SNDR2M_2_DSP_MAILBOX8  = MAIL_IO_BASE + 0x0418;
    !.const SNDR2M_2_DSP_MAILBOX9  = MAIL_IO_BASE + 0x0419;
    !.const SNDR2M_2_DSP_MAILBOXA  = MAIL_IO_BASE + 0x041A;
    !.const SNDR2M_2_DSP_MAILBOXB  = MAIL_IO_BASE + 0x041B;
    !.const SNDR2M_2_DSP_MAILBOXC  = MAIL_IO_BASE + 0x041C;
    !.const SNDR2M_2_DSP_MAILBOXD  = MAIL_IO_BASE + 0x041D;
    !.const SNDR2M_2_DSP_MAILBOXE  = MAIL_IO_BASE + 0x041E;
    !.const SNDR2M_2_DSP_MAILBOXF  = MAIL_IO_BASE + 0x041F;    
