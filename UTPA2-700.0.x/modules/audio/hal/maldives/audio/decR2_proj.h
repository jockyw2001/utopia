...
#define DELAY_UPPER_LIMIT             0x2D000
...
***********************************************************/
...
#else
    #define R2_DECODER1_OUTPUT_BY_DSP           (1)
    #define R2_DECODER2_OUTPUT_BY_DSP           (1)
#endif
    ...
    #define GST_NONPCM_PTR_SYNC_SCHEME      0
...
***********************************************************/
#define DQMEM_SIZE                      32      //unit is kbytes
#define DEC_R2_DQMEM_ADDR               0xFFFF8000
...
***********************************************************/
    ...
    /* D_PREFETCH */
    #define DC_WR_ALLOCATE_EN           0   // R2 D-Cache write-allocate
