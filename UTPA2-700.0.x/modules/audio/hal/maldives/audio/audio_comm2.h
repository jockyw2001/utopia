...
*   Version Control
*********************************************************/
#define  system_version_num              0x880D5B
#define  dde_version_num                 0xD20070
#define  ms10_dde_version_num            0xD800F0
#define  palsum_version_num              0x544010
#define  btsc_version_num                0x046C0B
#define  srs_puresound_version_num       0x202019
#define  dbx_version_num                 0x1A01AE
...
*   system define
*********************************************************/
    #define DSP2R2_DTS_TRANSCODE_EN                 0               // Support DTS Output Nonpcm
    ...
    /* DSP Audio Delay Setting */
        ...
        #define AUDIO_DELAY_LOWER_BOUND             0x20              // main audio delay, 0x20 = 32 ms
        #define SPDIF_DELAY_LOWER_BOUND             0x5               // spdif audio delay, 0x05 =  5 ms
...
************************************************/
    /* DSP SRAM Segment */
        ...
        #define DSP2_CM_MAIN_SIZE                   0x0800
        #define DSP2_CM_CODE1_ADDR                  0x0800
        #define DSP2_CM_CODE1_SIZE                  0x0100
        #define DSP2_CM_CODE2_ADDR                  0x0900
        #define DSP2_CM_CODE2_SIZE                  0x0100

        /* PM */
        #define DSP2_PM_MAIN_ADDR                   0xA00
        #define DSP2_PM_MAIN_SIZE                   0x02FF
        #define DSP2_PM_SEG1_ADDR                   0x0CFF
        #define DSP2_PM_SEG1_SIZE                   0x2721
        #define DSP2_PM_SEG2_ADDR                   0x3420
        #define DSP2_PM_SEG2_SIZE                   0x0BE0

        /* Prefetch */
        #define DSP2_PM_PREFETCH_DSPADDR            0x11000                // check "arch.sys"
        #define DSP2_PM_PREFETCH_DDRADDR            DSP2_PM_PREFETCH_DSPADDR*3/BYTES_IN_MIU_LINE
        #define DSP2_PM_PREFETCH2_DSPADDR           0x15000                // check "arch.sys"
        #define DSP2_PM_PREFETCH2_DDRADDR           DSP2_PM_PREFETCH2_DSPADDR*3/BYTES_IN_MIU_LINE

        /* DM */
        #define DSP2_DM_MAIN_ADDR                   0x3E00
        #define DSP2_DM_MAIN_SIZE                   0x1200
        ...
        #define DSP2_DM_SEG2_SIZE                   0x0F00

    /* SND DSP PM vars */
        /* common */
            #define DSP2PmAddr_mainVer              DSP2_PM_MAIN_ADDR
            #define DSP2PmAddr_alg1Ver              DSP2_PM_SEG1_ADDR      // decoder 2 version
            #define DSP2PmAddr_alg2Ver              DSP2_PM_SEG2_ADDR
    ...
    /* SND DSP DM vars */
        ...
        /* sys_info */
            #define DSP2DmAddr_IO_Info1             (DSP2_DM_MAIN_ADDR+0x20)
            ...
            #define DSP2DmAddr_IO_Info2             (DSP2_DM_MAIN_ADDR+0x80)
        ...
        /* common */
            #define DSP2DmAddr_mips_crisis_flag         (DSP2_DM_MAIN_ADDR+0xA5)

            #define DSP2DmAddr_hdmi_npcm_lock           (DSP2_DM_MAIN_ADDR+0xA6)
            #define DSP2DmAddr_hdmi_unstable_protect    (DSP2_DM_MAIN_ADDR+0xA7)
            #define DSP2DmAddr_hdmi_unstable_threshold  (DSP2DmAddr_hdmi_unstable_protect+1)

            #define DSP2DmAddr_pcmCapture_volume        (DSP2_DM_MAIN_ADDR+0xA9)
            #define DSP2DmAddr_pcmCapture2_volume       (DSP2_DM_MAIN_ADDR+0xAA)

            #define DSP2DmAddr_dec1_signal_energy       (DSP2_DM_MAIN_ADDR+0xAF)

        #ifdef _COMPILE_DSP_
            #define DSP2DmAddr_r2_pcm1_info             (DSP2_DM_MAIN_ADDR+0xB0)
            #define DSP2DmAddr_r2_pcm2_info             (DSP2_DM_MAIN_ADDR+0xB8)
                #define R2_SHM_INFO_ELAPSED_PCM_CNT         0x0004
                #define R2_SHM_INFO_PCMISR_EMPTY_CNT        0x0006
                #define R2_SHM_INFO_MAX                     0x0007
        #endif

            #define DSP2DmAddr_swDmaRdr_ctrlBase        (DSP2_DM_MAIN_ADDR+0x18C)
            #define DSP2DmAddr_swDmaRdr_synthFreq_H     (DSP2_DM_MAIN_ADDR+0x196)
            #define DSP2DmAddr_swDmaRdr_synthFreq_L     (DSP2_DM_MAIN_ADDR+0x197)

            #define DSP2DmAddr_advse_volume             (DSP2_DM_MAIN_ADDR+0x11E0)
        ...
        /* basic sound effect */
            #define DSP2DmAddr_AvcSOffsetAddr                 (DSP2_DM_MAIN_ADDR+0x1C0)
            #define DSP2DmAddr_KTV_XAGain                     (DSP2_DM_MAIN_ADDR+0x1C1)
            #define DSP2DmAddr_KTV_XBGain                     (DSP2DmAddr_KTV_XAGain+1)
            #define DSP2DmAddr_SND_EFFECT_VOL1                (DSP2_DM_MAIN_ADDR+0x1C3)
            #define DSP2DmAddr_SND_EFFECT_VOL2                (DSP2_DM_MAIN_ADDR+0x1C4)
            #define DSP2DmAddr_IIS_Num                        (DSP2_DM_MAIN_ADDR+0x1C5)
            #define DSP2DmAddr_Multi_Channel_VOL              (DSP2_DM_MAIN_ADDR+0x1C6)
        ...
        /* Bongiovi DPS */
            ...
            #define BONGIOVI_DPS_PM_addr                (DSP2_PM_SEG2_ADDR)
            #define BONGIOVI_DPS_COEF_PM_BASE_ADDR      ((((BONGIOVI_DPS_PM_addr+8-5)/8)+2)*8)
        ...
        /* dbx */
            #define DBX_PM_ABS_ADDRESS                 (DSP2_PM_SEG2_ADDR + 0x10)
...
********************************************************************/
    /* SIF DSP PM vars */
            #define SIF_AT_CODE2                      0    // 0: SIF is at code1, 1: code2. Adding this definition is for the purpose to move sif decoder to code2 so that transcode(at code1) and sif(at code2) could execute simutaneously, ex: for project LG_M2.

            #if (SIF_AT_CODE2 == 0)
            #define SIF_PM_SEG_ADDR                   DSP2_PM_SEG1_ADDR
            #else
            #define SIF_PM_SEG_ADDR                   DSP2_PM_SEG2_ADDR
            #endif
        /*  for SIF PAL DSP PM vars */
            #define ADDR_gain_base_2                  (SIF_PM_SEG_ADDR+0x100)
            #define ADDR_thr_base_2                   (SIF_PM_SEG_ADDR+0x180)
            #define ADDR_pfir_base_2                  (SIF_PM_SEG_ADDR+0x200)
            //  for SIF BTSC DSP PM vars //
            #define BTSC_COMPILE_OPTION_Addr_2        (SIF_PM_SEG_ADDR+0x001)   // len 1
            #define BTSC_OUTPUT_GAIN_Addr_2           (SIF_PM_SEG_ADDR+0x002)   // len 2
            #define BTSC_THRESHOLD_Addr_2             (SIF_PM_SEG_ADDR+0x004)   // len 10
            #define MTS_OUTPUT_GAIN_Addr_2            (SIF_PM_SEG_ADDR+0x015)   //len 6
            #define SIF_AGC_THRESHOLD_Addr_2          (SIF_PM_SEG_ADDR+0x040)   //len 3
            ...
            #define ADDR_a2_bg_nicam_fm_nsr_thr_2     (SIF_PM_SEG_ADDR+0x080)     // len = 1
            #define ADDR_a2_dk_nicam_fm_nsr_thr_2     (SIF_PM_SEG_ADDR+0x081)     // len = 1
...
*************************************************/
    ...
    ************************************************/
    ...
    #define M2S_MBOX_DBG_CMD1                   MB_2DDC
        ...
        #define MBOX_DBGCMD_GPA_ISR_DISABLE_AND_SE_DMA_Init    0xD000
        #define MBOX_DBGCMD_GPA_ISR_ENABLE                     0xD001
        #define MBOX_DBGCMD_TONE_TEST_BEGIN                    0xD002
        #define MBOX_DBGCMD_PEQ_TEST_BEGIN                     0xD003
        #define MBOX_DBGCMD_GEQ_TEST_BEGIN                     0xD004
        #define MBOX_DBGCMD_AVC_TEST_BEGIN                     0xD005
        #define MBOX_DBGCMD_SRS_THEATER_SOUND_TEST_BEGIN       0xD006
        #define MBOX_DBGCMD_SONICEMOTION_ABS3D_TEST_BEGIN      0xD007
        #define MBOX_DBGCMD_BONGIOVI_DPS_TEST_BEGIN            0xD008
    ...
    /* CHIP ID */
    #define M2S_MBOX_CHIPID_SETTING             MB_2D90

    /* MISC */
    // SW DMA Reader 1
    #define M2S_MBOX_SW_DMA_READER_DDR_WtPtr            MB_2D34
    #define M2S_MBOX_SW_DMA_READER_DDR_Ctrl             MB_2D36
        #define SW_DMA_CTRL_RESET_BIT                       MBOX_BIT0
        #define SW_DMA_CTRL_START_BIT                       MBOX_BIT1
        #define SW_DMA_CTRL_CIRCL_BIT                       MBOX_BIT2
        #define SW_DMA_CTRL_STOPUPDATE_LEVEL_TO_MBOX_BIT    MBOX_BIT3
        #define SW_DMA_CTRL_MULTI_CH_ENABLE_BIT             MBOX_BIT14

    #define M2S_MBOX_SW_DMA_READER_DDR_SynthFreq_H      MB_2D56
    #define M2S_MBOX_SW_DMA_READER_DDR_SynthFreq_L      0   // plz use DM address "DSP2DmAddr_swDmaRdr_synthFreq_L"

    // PCM Capture 1/2
    #define M2S_MBOX_CAPTURE_CTRL               MB_2D4A   //[7:0] PCM_capture1 Port CTRL  [15:8] PCM_capture2 Port CTRL
    ...
    ************************************************/
    ...
    #define S2M_MBOX_HDMI_NPCM_LOCK             MB_2DEC                 //[ 3:0] Always in LSB Nibble
    ...
    #define SE_R2_FRAME_SIZE                    256        //256 samples for R2_SE
    #define SE_PROCESS_FRAME_SMP_UNIT           64         // 64 samples per frame
...
*************************************************/
    ...
    /* DSP DM Prefetch */
        #define DSP2_DM_PREFETCH_DRAM_BASE              0x00E500
        #define DSP2_DM_PREFETCH_DRAM_SIZE              0xED80          // 64KB

    /* HE-AAC Metadata Buffer on DEC */
        #define DSP2_HEAAC_METADATA_DRAM_BASE           OFFSET_DDENC_METADATA_DRAM_ADDR / BYTES_IN_MIU_LINE
        #define DSP2_HEAAC_METADATA_DRAM_START_OFFSET   0x000000
        #define DSP2_HEAAC_METADATA_DRAM_SIZE           DDENC_METADATA_DRAM_SIZE / BYTES_IN_MIU_LINE
...
*************************************************/
    ...
    /* DMA Mapping */
        ...
        #define CH6_IN_DLY_DMA_CTRL     DSPDMA2_DMA_CTRL
...
*************************************************/
    ...
    /* share buffer in dm mapping */
        ...
        #define DSP2DmAddr_advSnd_staticBuff_base   (SE_PROCESS_BUFFER_MAIN + (SE_PROCESS_BUFFER_MAIN_TMP*2))  // 2 same size data buffer measns : (audio_delay_static_data_buffer + audio_delay_tmp_change_data_buffer)
        #define DSP2DmAddr_advSnd_staticBuff_size   0x000  // DM SHAREMEM BUFFER SIZE between AdvSnd(CV3) and decoder.
    ...
    /* SW DMA Reader */
        #if (SW_DMA_RDR_MULTI_CH_EN)
            .const SW_DMA_WORDSIZE                    = 128;
        #else
...
********************************************************************/
    ...
    #define ISR_PMASK_DEC_R2_CMD        20
...
********************************************************************/
    ...
    /* PCM output port */
        #define DSP_SW_DMA_DMX_L_OUT            DEC3_PCM1_OUT
        #define DSP_SW_DMA_DMX_R_OUT            DEC3_PCM2_OUT
        #define DSP_SW_DMA_MCH_L_OUT            DEC3_PCM3_OUT
        #define DSP_SW_DMA_MCH_C_OUT            DEC3_PCM4_OUT
        #define DSP_SW_DMA_MCH_R_OUT            DEC3_PCM5_OUT
        #define DSP_SW_DMA_MCH_LS_OUT           DEC3_PCM6_OUT
        #define DSP_SW_DMA_MCH_RS_OUT           DEC3_PCM7_OUT
        #define DSP_SW_DMA_MCH_SW_OUT           DEC3_PCM8_OUT

        #define DSP_SW_DMA_RDR_SYNTH_L          DVB3_FIX_SYNTH_NF_L     // SW DMA RDR use DVB3_SYNTH
        #define DSP_SW_DMA_RDR_SYNTH_H          DVB3_FIX_SYNTH_NF_H
        ...
        #define R2_PCM2_DMX__L_OUT              DEC3_PCM1_OUT
        #define R2_PCM2_DMX__R_OUT              DEC3_PCM2_OUT
        #define R2_PCM2_MCH__L_OUT              DEC3_PCM3_OUT
        #define R2_PCM2_MCH__C_OUT              DEC3_PCM4_OUT
        #define R2_PCM2_MCH__R_OUT              DEC3_PCM5_OUT
        #define R2_PCM2_MCH_LS_OUT              DEC3_PCM6_OUT
        #define R2_PCM2_MCH_RS_OUT              DEC3_PCM7_OUT
        #define R2_PCM2_MCH_SW_OUT              DEC3_PCM8_OUT

        #define R2_PCM1_SYNTH_L                 DVB3_FIX_SYNTH_NF_L
        #define R2_PCM1_SYNTH_H                 DVB3_FIX_SYNTH_NF_H
        #define R2_PCM2_SYNTH_L                 DVB3_FIX_SYNTH_NF_L
        #define R2_PCM2_SYNTH_H                 DVB3_FIX_SYNTH_NF_H
...
*************************************************/
        ...
        /* PCM Mixer buffer */
        #define DSP2_PCM_SWMIXER_CLIENT_INFO_BASE    (ASND_DSP_DDR_SIZE + OFFSET_PCM_SWMIXER_CLIENT_INFO_BASE)
        #define DSP2_PCM_SWMIXER_CLIENT_BUFFER_BASE  (ASND_DSP_DDR_SIZE + OFFSET_PCM_SWMIXER_CLIENT_BUFFER_BASE)
        #define DSP2_PCM_SWMIXER_SERVER1_BUFFER_BASE   (ASND_DSP_DDR_SIZE + OFFSET_PCM_SWMIXER_SERVER1_BUFFER_BASE)
        #define DSP2_PCM_SWMIXER_SERVER2_BUFFER_BASE   (ASND_DSP_DDR_SIZE + OFFSET_PCM_SWMIXER_SERVER2_BUFFER_BASE)
        #define DSP2_PCM_SWMIXER_SERVER_BUFFER_SIZE    PCM_SWMIXER_SERVER_BUFFER_SIZE
