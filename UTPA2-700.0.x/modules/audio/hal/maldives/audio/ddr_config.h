...
*************************************************/
    /* DSP DDR size */
        ...
        #define COMMON_DDR_SIZE         0x216000             //2.09 MB  (optional: 48 KB pcm capture)
                                                             // Total = 10.59 MB
        /* ASND-DSP DDR */
        ...
        /* Common DDR */
            ...
            #define OFFSET_PCM_SWMIXER_CLIENT_INFO_BASE     0x0180000
            #define PCM_SWMIXER_CLIENT_INFO_SIZE            0x4000

            #define OFFSET_PCM_SWMIXER_CLIENT_BUFFER_BASE   0x0184000
            #define PCM_SWMIXER_CLIENT_BUFFER_SIZE          0x78000

            #define OFFSET_PCM_SWMIXER_SERVER1_BUFFER_BASE    0x01FC000
            #define OFFSET_PCM_SWMIXER_SERVER2_BUFFER_BASE    0x0200000
