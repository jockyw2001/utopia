...
MS_BOOL HAL_SOUND_SetParam( Sound_SET_Type Type, MS_U32 *p_param )
{
    ...
    MS_U8 param2 = (MS_U8)(p_param[1]>>8);
    MS_U8 param3 = (MS_U8)(p_param[2]>>16);
    MS_U8 param4 = (MS_U8)(p_param[3]>>24);
...
MS_BOOL HAL_SND_SetParam(Sound_SET_PARAM_Type Type, MS_U16 param1, MS_U16 param2)
{
    ...
    switch(Type)
    {
        ...
        case Sound_SET_PARAM_Avc_R_Begin:
        {
            ...
            if(param1 <= 60)
            {
                HAL_MAD2_Write_DSP_sram(DSP2PmAddr_AVCRmodeP1, param1&0xFFFE, DSP_MEM_TYPE_PM); //param1 needs to be even
                status = TRUE;
            }
            break;
        }
        ...
        case Sound_SET_PARAM_Avc_R_End:
        {
            ...
            if(param1 <= 60)
            {
                HAL_MAD2_Write_DSP_sram(DSP2PmAddr_AVCRmodeP2, param1&0xFFFE, DSP_MEM_TYPE_PM); //param1 needs to be even
                status = TRUE;
            }
            break;
        }
        ...
        case Sound_SET_PARAM_Avc_R_Slope:
        {
            ...
            {
                HAL_MAD2_Write_DSP_sram(DSP2PmAddr_AVCRmodeType, param1, DSP_MEM_TYPE_PM);
                status = TRUE;
            }
...
MS_U16 HAL_SND_GetParam( Sound_GET_PARAM_Type Type, MS_U16 param1)
{
    ...
    switch(Type)
    {
        ...
        case Sound_GET_PARAM_Avc_R_Begin: //default: 50 (-50dB)
        {
            tmp = (MS_U16)HAL_MAD2_Read_DSP_sram(DSP2PmAddr_AVCRmodeP1, DSP_MEM_TYPE_PM);
            break;
        }

        case Sound_GET_PARAM_Avc_R_End: //default: 20 (-20dB)
        {
            tmp = (MS_U16)HAL_MAD2_Read_DSP_sram(DSP2PmAddr_AVCRmodeP2, DSP_MEM_TYPE_PM);
            break;
        }

        case Sound_GET_PARAM_Avc_R_Slope: //1: 0.75, 2: 0.5, 3: 0.25, default: 2
        {
            tmp = (MS_U16)HAL_MAD2_Read_DSP_sram(DSP2PmAddr_AVCRmodeType, DSP_MEM_TYPE_PM);
            break;
        }
