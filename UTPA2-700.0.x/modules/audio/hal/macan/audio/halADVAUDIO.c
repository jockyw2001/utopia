...
#define HALADVAUDIO_CHECK_SHM_INIT \
    do { \
        ...
        { \
            printf("%s() : Warning! g_AudioVars2 should not be NULL !!!\n", __FUNCTION__); \
            printf("%s() : Perform SHM Init here !!!\n", __FUNCTION__); \
...
/// @param <IN>        \b ADVSOUND's AUDIO_DSP_CODE_TYPE
/// @param <OUT>       \b NONE        :
/// @param <RET>       \b NONE        :
/// @param <GLOBAL>    \b NONE
////////////////////////////////////////////////////////////////////////////////
MS_BOOL HAL_ADVSOUND_ProcessEnable(AUDIO_DSP_CODE_TYPE type)
{
    ...
    else if((type == AU_DVB2_ADVSND_TSHD) ||(type == AU_DVB2_ADVSND_THEATERSOUND) ||(type == AU_DVB2_ADVSND_STUDIOSOUND_3D))
    {
        ...
        if((type == AU_DVB2_ADVSND_THEATERSOUND) || (type == AU_DVB2_ADVSND_STUDIOSOUND_3D))
        {
