...
MS_BOOL HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_TYPE decParamType, MS_U8 dec_id, MS_U32 param, MS_U32 param2 )
{
    ...
    switch( decParamType )
    {
        ...
        case R2_SHM_PARAM_MULTI_CHANNEL:
            ptr = (volatile MS_U32 *) &p_shm_param->force_mmuni_mch_pcm;    *ptr = param;    MsOS_Dcache_Flush((MS_VIRT)ptr,4);   break;

        case R2_SHM_PARAM_ES_PassThrough_DelaySmp:
            ptr = (volatile unsigned int *) &p_shm->esPassThrough_delaySmp;      *ptr = param;  MsOS_Dcache_Flush((unsigned int)ptr,4);     break;

        case R2_SHM_PARAM_ES_PassThrough_PcmSamRate:
            ptr = (volatile unsigned int *) &p_shm->esPassThrough_pcmSmpRate;       *ptr = param;  MsOS_Dcache_Flush((unsigned int)ptr,4);     break;

        case R2_SHM_PARAM_ES_PassThrough_HdmiSmpRate:
            ptr = (volatile unsigned int *) &p_shm->esPassThrough_hdmiSmpRate;      *ptr = param;  MsOS_Dcache_Flush((unsigned int)ptr,4);     break;
...
MS_U32 HAL_DEC_R2_Get_SHM_PARAM(R2_SHM_PARAM_TYPE decParamType, MS_U8 dec_id, MS_U32 param )
{
    ...
    switch( decParamType )
    {
        ...
        case R2_SHM_PARAM_DDP_ENCODE_EN:
            ptr = (volatile MS_U32 *) &p_shm_param->DDP_encode_enable;            MsOS_Dcache_Flush((MS_VIRT)ptr, 4);  ret_value = *ptr;       break;
