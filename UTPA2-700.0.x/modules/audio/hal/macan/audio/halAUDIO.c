...
const AUDIO_REG_TYPE  AudioPreInitTbl_Clock[] =
{
    ...
    {0x112B47, 0xFF, 0xFF},
    {0x112B56, 0xFF, 0x30}, // Enable ADC1/2
    {0x112B57, 0xFF, 0x00},
    {0x112C6E, 0xFF, 0x88}, // Enable Grp A/B
    {0x112B50, 0xFF, 0x80}, // DC offset value
    {0x112B51, 0xFF, 0x00},
    {0x112B10, 0xFF, 0x80}, // DC offset value for earphone 9LEVEL SDM
    {0x112B60, 0xFF, 0xC0},
    {0x112B61, 0xFF, 0x38},
    {0x112B62, 0xFF, 0x38},
    {0x112B63, 0xFF, 0x38},
    ...
    //-----------------De-POP_1-----------------------------//Item 25
    {0x112CDC, 0xFF, 0xF0}, //0x112cdc 0x3ff0       //PD DAC
    {0x112CDD, 0xFF, 0x3F},
    {0x112CDE, 0xFF, 0x00}, //0x112cde 0x0000       //EN_CK_DAC=0
    {0x112CDF, 0xFF, 0x00},
    {0x112CE6, 0xFF, 0x01}, //0x112ce6 0x0001       //PD_VI=1
    {0x112CE7, 0xFF, 0x00},
    {0x112CE8, 0xFF, 0x00}, //0x112ce8 0x8000       //PD_VREF=1, EN_VREF_SFTDCH=11
    {0x112CE9, 0xFF, 0x80},
    {0x112CE2, 0xFF, 0x07}, //0x112ce2 0x0001       //SEL_CH=0
    {0x112CE3, 0xFF, 0x00},
    {0x112CE0, 0xFF, 0x30}, //0x112ce0 0x1030       //PD_IBIAS_EAR=1,PD_EAR=1
    {0x112CE1, 0xFF, 0x10},
    {0x112CEA, 0xFF, 0x08}, //0x112cea 0x0008       //PD_OPLP_EAR
    {0x112CEB, 0xFF, 0x00},
    {0x112CEE, 0xFF, 0x00}, //0x112cee 0x0000       //MSP=0, EN_EAR=0
    {0x112CEF, 0xFF, 0x00},
    {0x112CEC, 0xFF, 0x00}, //0x112cec 0x0000       //EN_TST_IPRTC_EAR=00
    {0x112CED, 0xFF, 0x00},
    {0x112CDE, 0xFF, 0x00}, //0x112cde 0x7800       //EN_CK_DAC=1
    {0x112CDF, 0xFF, 0x78},
    {0x112CEA, 0xFF, 0x0C}, //0x112cea 0x000c       //PD_OPLP_EAR=1, EN_VMID2GND=1
    {0x112CEB, 0xFF, 0x00},
    {0x112CEE, 0xFF, 0x81}, //0x112cee 0x1081       //MSP=1, EN_MUTE_EAR=1, SEL_DEPOP_EAR[1:0]=01
    {0x112CEF, 0xFF, 0x10},
    {0x112CEC, 0xFF, 0xC0}, //0x112cec 0x00c0       //PD_LDO_ADC=1,EN_QS_LDO_ADC=1,PD_LDO_DAC=0,EN_QS_LDO_DAC=0??
    {0x112CED, 0xFF, 0x00},

    {0x112CDE, 0xFF, 0x00},//0x112cde 0x7800
    {0x112CDF, 0xFF, 0x78},
    {0x112CE0, 0xFF, 0x30},//0x112ce0 0x1030
    {0x112CE1, 0xFF, 0x10},
    {0x112CE2, 0xFF, 0x07},//0x112ce2 0x0000
    {0x112CE3, 0xFF, 0x00},
    {0x112CEC, 0xFF, 0x28},//0x112cec 0x0028
    {0x112CED, 0xFF, 0x00},

    {0xFFFFFF, 0x01, 0x01},// delay 1m sec
    {0x112CDC, 0xFF, 0x00}, //0x112cdc 0x0000       //PD DAC=0
    {0x112CDD, 0xFF, 0x00},
    {0x112CE6, 0xFF, 0x00}, //0x112ce6 0x0000       //PD_VI=0
    {0x112CE7, 0xFF, 0x00},
    {0x112CE8, 0xFF, 0x00}, //0x112ce8 0x3000       //PD_VREF=0, EN_VREF_SFTDCH=11
    {0x112CE9, 0xFF, 0x30},
    {0x112CEA, 0xFF, 0x00}, //0x112cea 0x0000       //PD_OPLP_EAR=0, EN_VMID2GND=0
    {0x112CEB, 0xFF, 0x00},
...
const AUDIO_REG_TYPE  AudioInitTbl[]=
{
    ...
    {0x112CE0, 0xFF, 0x00}, // 0x112ce0 0x0000      //PD_IBIAS_EAR=0,PD_RT/LT_EAR=0
    {0x112CE1, 0xFF, 0x00},
    {0x112CE2, 0xFF, 0x07}, //0x112ce2 0x1000       //SEL_IN_EAR[1:0]=01
    {0x112CE3, 0xFF, 0x10},
    {0x112CE8, 0xFF, 0x00}, //0x112ce2 0x1000       //SEL_IN_EAR[1:0]=01
    {0x112CE9, 0xFF, 0x00},
    {0x112CEC, 0xFF, 0x28}, //0x112cec 0x0828       //EN_STG2_LP_EAR=1
    {0x112CED, 0xFF, 0x08},
    {0x112CEE, 0xFF, 0x01}, //0x112cee 0x1001       //MSP=1, EN_MUTE_EAR=0, SEL_DEPOP_EAR[1:0]=01
    {0x112CEF, 0xFF, 0x10},

    {0xFFFFFF, 0x01, 0x32}, // delay 5m sec

    {0x112CEE, 0xFF, 0x01}, //0x1301        //MSP=1,EN_EAR=1,EN_MUTE_EAR=0, SEL_DEPOP_EAR[1:0]=01
    {0x112CEF, 0xFF, 0x13},
    ...
    {0x112BCF, 0x01, 0x00},  // DVB1 N.F.  is contolled by DSP
    {0x112BCF, 0x02, 0x00},  // DVB2 N.F.  is contolled by DSP
    ...
    {0x112C45, 0xFF, 0x32},
    {0x112C46, 0xFF, 0x00},// HDMI Matrix mapping
    {0x112C47, 0xFF, 0x00},// [0]/[1]/[2]/[3] ch1/ch2/ch3/ch4 switch
    ...
    //-----------------Output: DAC--------------------------//Item 12
    {0xFFFFFF, 0x01, 0x3A},// delay 5m sec
    //{0xFFFFFF, 0x01, 0x32},// delay 5m sec

    {0x112CEE, 0xFF, 0x03}, //0x112cee 0x1303       //MSP=1,EN_EAR=1,EN_MUTE_EAR=0, SEL_DEPOP_EAR[1:0]=11
    {0x112CEF, 0xFF, 0x13},

#if(FULL_DECIMATION_MODE)
    {0x112C58, 0x02, 0x02}, //always decimantionMode
#endif
    ...
    {0x112C5F, 0x02, 0x00},
    {0x112C5F, 0x01, 0x00},
    {0x112C5E, 0x10, 0x00}, //enable channal status
    {0x112C5E, 0x08, 0x00},
    {0x112C5E, 0x04, 0x00},
    {0x112C5E, 0x03, 0x00},
    {0x112C5E, 0x80, 0x80},
    ...
    //-----------------Unsorted-----------------------------//Item 30
    {0x112C94, 0x01, 0x01},  //Enable CH1/5 HW force mute
    {0x112C95, 0x01, 0x01},
    {0x112C96, 0x01, 0x01},  //Enable CH2/6 HW force mute
    {0x112C97, 0x01, 0x01},
    {0x112C98, 0x01, 0x01},  //Enable CH1/5 HW force mute
    {0x112C99, 0x01, 0x01},
    {0x112C9A, 0x01, 0x01},  //Enable CH1/5 HW force mute
    {0x112C9B, 0x01, 0x01},

    //-----------------Interrupt----------------------------//Item 35
    {0x112AA2, 0x40, 0x40}, //[6]       IRQ2n select SPDIF_TX
    {0x112AA2, 0x10, 0x00}, //[4]       IRQ1L select SPDIF_TX2 or HDMI TX
    ...
    {0x112F68, 0xFF, 0xFF},  // dma miu_arb - disable high priority, configure block size to 8 lines
    {0x112F69, 0xFF, 0xFF},
    {0x112F66, 0xFF, 0x00},
    {0x112F67, 0xFF, 0x00},
    {0x112F64, 0xFF, 0x00},
    ...
    {0x112F88, 0xFF, 0xFF},  // cache miu_arb - disable high priority, configure block size to 8 lines
    {0x112F89, 0xFF, 0xFF},
    {0x112F86, 0xFF, 0x00},
    {0x112F87, 0xFF, 0x00},
    {0x112F84, 0xFF, 0x00},
    ...
    {0x163D88, 0xFF, 0x00},  // R2 miu_arb - disable high priority, configure block size to 8 lines (20161215 bernie unmask R2 high priority)
    {0x163D89, 0xFF, 0x00},
    {0x163D86, 0xFF, 0x00},
    {0x163D87, 0xFF, 0x00},
    {0x163D84, 0xFF, 0x00},
    ...
    {0x163DA8, 0xFF, 0xFF},  // R2_1 miu_arb - disable high priority, configure block size to 8 lines
    {0x163DA9, 0xFF, 0xFF},
    {0x163DA6, 0xFF, 0x00},
    {0x163DA7, 0xFF, 0x00},
    {0x163DA4, 0xFF, 0x00},
    ...
    {0x163E28, 0xFF, 0xFF},  // dma_l2 miu_arb - disable high priority, configure block size to 8 lines
    {0x163E29, 0xFF, 0xFF},
    {0x163E26, 0xFF, 0x00},
    {0x163E27, 0xFF, 0x00},
    {0x163E24, 0xFF, 0x00},
    ...
    {0x163E20, 0xFF, 0x15},
    {0x163E21, 0xFF, 0x80},
    {0x1129f7, 0x0c, 0x0c}, //  [11] R2 i-side high priority; [10] R2 d-side high priority. 20161215 bernie unmask R2 high priority
                            //  The R2 should rise high priority itself. The address at 0xb000_41ec[11:10] = 2'b11. 20161215 bernie R2 unmask high priority
...
#if AUDIO_PCM_SWMIXER_SUPPORT
AUDIO_PCM_t Audio_Pcm_SwMixer1 = {
    .u8Name = AUDIO_SW_MIXER1,
    .tPcmOps = {
        .open = HAL_AUDIO_PCM_SwMixer1_Open,
        .close = HAL_AUDIO_PCM_SwMixer1_Close,
        .start = HAL_AUDIO_PCM_SwMixer1_Start,
        .stop = HAL_AUDIO_PCM_SwMixer1_Stop,
        .set = HAL_AUDIO_PCM_SwMixer1_Set,
        .get = HAL_AUDIO_PCM_SwMixer1_Get,
        .read = NULL,
        .write = HAL_AUDIO_PCM_SwMixer1_Write,
        .flush = HAL_AUDIO_PCM_SwMixer1_Flush,
    },
    .tPcmCaps = {
        .u8MultiChFlag = FALSE,
        .u8MixingFlag = TRUE,
...
AUDIO_PCM_t Audio_Pcm_SwMixer2 = {
    .u8Name = AUDIO_SW_MIXER2,
    .tPcmOps = {
        .open = HAL_AUDIO_PCM_SwMixer2_Open,
        .close = HAL_AUDIO_PCM_SwMixer2_Close,
        .start = HAL_AUDIO_PCM_SwMixer2_Start,
        .stop = HAL_AUDIO_PCM_SwMixer2_Stop,
        .set = HAL_AUDIO_PCM_SwMixer2_Set,
        .get = HAL_AUDIO_PCM_SwMixer2_Get,
        .read = NULL,
        .write = HAL_AUDIO_PCM_SwMixer2_Write,
        .flush = HAL_AUDIO_PCM_SwMixer2_Flush,
    },
    .tPcmCaps = {
        .u8MultiChFlag = FALSE,
        .u8MixingFlag = TRUE,
...
AUDIO_PCM_t Audio_Pcm_SwMixer3 = {
    .u8Name = AUDIO_SW_MIXER3,
    .tPcmOps = {
        .open = HAL_AUDIO_PCM_SwMixer3_Open,
        .close = HAL_AUDIO_PCM_SwMixer3_Close,
        .start = HAL_AUDIO_PCM_SwMixer3_Start,
        .stop = HAL_AUDIO_PCM_SwMixer3_Stop,
        .set = HAL_AUDIO_PCM_SwMixer3_Set,
        .get = HAL_AUDIO_PCM_SwMixer3_Get,
        .read = NULL,
        .write = HAL_AUDIO_PCM_SwMixer3_Write,
        .flush = HAL_AUDIO_PCM_SwMixer3_Flush,
    },
    .tPcmCaps = {
        .u8MultiChFlag = FALSE,
        .u8MixingFlag = TRUE,
...
AUDIO_PCM_t Audio_Pcm_SwMixer4 = {
    .u8Name = AUDIO_SW_MIXER4,
    .tPcmOps = {
        .open = HAL_AUDIO_PCM_SwMixer4_Open,
        .close = HAL_AUDIO_PCM_SwMixer4_Close,
        .start = HAL_AUDIO_PCM_SwMixer4_Start,
        .stop = HAL_AUDIO_PCM_SwMixer4_Stop,
        .set = HAL_AUDIO_PCM_SwMixer4_Set,
        .get = HAL_AUDIO_PCM_SwMixer4_Get,
        .read = NULL,
        .write = HAL_AUDIO_PCM_SwMixer4_Write,
        .flush = HAL_AUDIO_PCM_SwMixer4_Flush,
    },
    .tPcmCaps = {
        .u8MultiChFlag = FALSE,
        .u8MixingFlag = TRUE,
...
AUDIO_PCM_t Audio_Pcm_SwMixer5 = {
    .u8Name = AUDIO_SW_MIXER5,
    .tPcmOps = {
        .open = HAL_AUDIO_PCM_SwMixer5_Open,
        .close = HAL_AUDIO_PCM_SwMixer5_Close,
        .start = HAL_AUDIO_PCM_SwMixer5_Start,
        .stop = HAL_AUDIO_PCM_SwMixer5_Stop,
        .set = HAL_AUDIO_PCM_SwMixer5_Set,
        .get = HAL_AUDIO_PCM_SwMixer5_Get,
        .read = NULL,
        .write = HAL_AUDIO_PCM_SwMixer5_Write,
        .flush = HAL_AUDIO_PCM_SwMixer5_Flush,
    },
    .tPcmCaps = {
        .u8MultiChFlag = FALSE,
        .u8MixingFlag = TRUE,
...
AUDIO_PCM_t Audio_Pcm_SwMixer6 = {
    .u8Name = AUDIO_SW_MIXER6,
    .tPcmOps = {
        .open = HAL_AUDIO_PCM_SwMixer6_Open,
        .close = HAL_AUDIO_PCM_SwMixer6_Close,
        .start = HAL_AUDIO_PCM_SwMixer6_Start,
        .stop = HAL_AUDIO_PCM_SwMixer6_Stop,
        .set = HAL_AUDIO_PCM_SwMixer6_Set,
        .get = HAL_AUDIO_PCM_SwMixer6_Get,
        .read = NULL,
        .write = HAL_AUDIO_PCM_SwMixer6_Write,
        .flush = HAL_AUDIO_PCM_SwMixer6_Flush,
    },
    .tPcmCaps = {
        .u8MultiChFlag = FALSE,
        .u8MixingFlag = TRUE,
...
AUDIO_PCM_t Audio_Pcm_SwMixer7 = {
    .u8Name = AUDIO_SW_MIXER7,
    .tPcmOps = {
        .open = HAL_AUDIO_PCM_SwMixer7_Open,
        .close = HAL_AUDIO_PCM_SwMixer7_Close,
        .start = HAL_AUDIO_PCM_SwMixer7_Start,
        .stop = HAL_AUDIO_PCM_SwMixer7_Stop,
        .set = HAL_AUDIO_PCM_SwMixer7_Set,
        .get = HAL_AUDIO_PCM_SwMixer7_Get,
        .read = NULL,
        .write = HAL_AUDIO_PCM_SwMixer7_Write,
        .flush = HAL_AUDIO_PCM_SwMixer7_Flush,
    },
    .tPcmCaps = {
        .u8MultiChFlag = FALSE,
        .u8MixingFlag = TRUE,
...
AUDIO_PCM_t Audio_Pcm_SwMixer8 = {
    .u8Name = AUDIO_SW_MIXER8,
    .tPcmOps = {
        .open = HAL_AUDIO_PCM_SwMixer8_Open,
        .close = HAL_AUDIO_PCM_SwMixer8_Close,
        .start = HAL_AUDIO_PCM_SwMixer8_Start,
        .stop = HAL_AUDIO_PCM_SwMixer8_Stop,
        .set = HAL_AUDIO_PCM_SwMixer8_Set,
        .get = HAL_AUDIO_PCM_SwMixer8_Get,
        .read = NULL,
        .write = HAL_AUDIO_PCM_SwMixer8_Write,
        .flush = HAL_AUDIO_PCM_SwMixer8_Flush,
    },
    .tPcmCaps = {
        .u8MultiChFlag = FALSE,
        .u8MixingFlag = TRUE,
...
AUDIO_PCM_SWMIXER_SERVER_t Audio_Pcm_Mixer_Server[AUDIO_PCM_SWMIXER_SERVER_MAXIMUM];

AUDIO_PCM_t *g_PCM[AUDIO_PCM_MAXIMUM] = {
#if AUDIO_HW_DMA_READER1_SUPPORT
...
MS_BOOL HAL_AUDIO_ResetDefaultVars(AUDIO_SHARED_VARS2 * pAUDIOShared)
{
    ...
    pAUDIOShared->g_AudioOutputDeviceSelection.u32StructSize = sizeof(pAUDIOShared->g_AudioOutputDeviceSelection);
    pAUDIOShared->g_AudioOutputDeviceSelection.u32OutputDeviceSelection = AUDIO_OUTPUT_DEVICE_NONE;
...
void HAL_AUDIO_SPDIF_SetMode(MS_U8 u8Spdif_mode, MS_U8 u8Input_src)
{
                ...
                case AU_DVB2_ENCODE_MS10_DDE:
                {
                    ...
                    else if (Digital_Out_DDP_Support == 1)
                    {
                              ...
                              MDrv_AUTH_IPCheck(AU_DVB2_AUTHBIT_DOLBY_MS12_D_WO_AAC)) )
                        {
                            ...
                            else if((u8SpdifMode == SPDIF_OUT_AUTO) || (u8SpdifMode == SPDIF_OUT_NONPCM) || (u8SpdifMode == SPDIF_OUT_TRANSCODE))
                            {
                        ...
                        else if(u8SpdifMode != SPDIF_OUT_TRANSCODE)
                        {
                            HAL_MAD_SetAC3PInfo(Audio_AC3P_infoType_hdmiTxBypass_enable, 1, u8MainDecodeId);
                        }
                    }
    ...
    HAL_AUR2_WriteMaskByte(REG_R2_HDMI_NONPCM_PATH, 0x01, u8MainDecodeId);
...
void HAL_AUDIO_SetDsp2CodeType(AUDIO_DSP_CODE_TYPE dspCodeType, MS_BOOL bFlag)
{
    ...
    if(bFlag == FALSE)
    {
        DBG_AUDIO_ERROR("  [Audio] DSP2 Load code fail !!! SetDsp2CodeType Fail !!! \r\n");
        return;
    }
...
MS_BOOL HAL_AUDIO_SetSystem(En_DVB_decSystemType enDecSystem)
{
    ...
    switch (enDecSystem)
    {
            ...
            case MSAPI_AUD_DVB_ES_Bypass:
                HAL_AUR2_WriteByte(REG_R2_DECODE1_TYPE, adec_type_dummy);
                g_AudioVars2->AudioDecStatus[AU_DEC_ID1].eAudFormat = enDecSystem;
                HAL_AUDIO_SetDspCodeType(AU_DEC_ES_BYPASS, TRUE);
                break;
...
void HAL_AUDIO_HDMI_TX_SetMode(HDMI_TX_OUTPUT_TYPE outType, AUDIO_SOURCE_INFO_TYPE eSource)
{
    ...
    //HALAUDIO_ERROR("%s: outType_tmp %d, u8NonPcmPath %d\r\n", __FUNCTION__, outType_tmp, u8NonPcmPath);

    switch (outType_tmp)
    {
        case HDMI_OUT_NONPCM:
        case HDMI_OUT_8CH_NONPCM:
        case HDMI_OUT_BYPASS:
        {
            if (outType_tmp == HDMI_OUT_BYPASS)
            {
                AUDIO_DELAY1MS(10);
                /*
                 * TODO
                 * We should call HAL_MAD_SetAC3PInfo(),
                 * but due to Audio_AC3P_infoType_hdmiTxBypass_enable case is not so good for the moment,
                 * just configure settings directly here!
                 */
#if 0
                HAL_MAD_SetAC3PInfo(Audio_AC3P_infoType_hdmiTxBypass_enable, TRUE, ADEC1);
#else
                HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_DOLBY_DDP_HDMI_BYPASS,  ADEC1, TRUE, 0);
    ...
    //do nothing
#else
    HAL_AUDIO_Set_DecimationMode(AUDIO_HDMI_OUTPUT, ADEC1);
#endif
    ...
    MS_BOOL bRet = TRUE;
     ...
     switch (Param)
     {
        ...
        case MSAPI_AUD_DVB_ES_Bypass:
            ...
            if (DecId == AU_DEC_ID3)
            {
                HAL_AUDIO_SetDsp2CodeType(AU_DEC_ES_BYPASS, TRUE);
            }
            else
            {
                HAL_AUDIO_SetDspCodeType(AU_DEC_ES_BYPASS, TRUE);
...
#ifdef ROLLS_ROYCE
    if(p_AudioDecStatus->eAudio_Force_ID > AUDIO_FORCE_INVALID)
    {
...
MS_S32 HAL_AUDIO_PCM_Init(void)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    AUDIO_PCM_BUFFER_INFO_t *pPcmBufferInfo = NULL;
    MS_U32 u32RequestClientInfoSize = 0;
    MS_U32 u32PcmInfoBasePa = 0;
    MS_S32 s32DeviceId = 0;
    MS_S32 s32Ret = 0;

    HALAUDIO_ERROR("%s: invoked\n", __FUNCTION__);

    u32RequestClientInfoSize = (sizeof(AUDIO_PCM_INFO_t) + sizeof(AUDIO_PCM_BUFFER_INFO_t)) * AUDIO_PCM_MAXIMUM;
    if (u32RequestClientInfoSize > PCM_SWMIXER_CLIENT_INFO_SIZE)
    {
        HALAUDIO_ERROR("%s: Error! request %u bytes ((%u + %u) * %u), but there is only %u\n",
            __FUNCTION__,
            u32RequestClientInfoSize,
            sizeof(AUDIO_PCM_INFO_t),
            sizeof(AUDIO_PCM_BUFFER_INFO_t),
            AUDIO_PCM_MAXIMUM,
            PCM_SWMIXER_CLIENT_INFO_SIZE);

        MS_ASSERT(0);
    }

    u32PcmInfoBasePa = HAL_AUDIO_GetDspMadBaseAddr(DSP_SE) + DSP2_PCM_SWMIXER_CLIENT_INFO_BASE;
    pPcmInfo = (AUDIO_PCM_INFO_t *)MS_PA2KSEG1(u32PcmInfoBasePa);
    if (pPcmInfo == NULL)
    {
    ...
    if (HAL_AUDIO_GET_INIT_FLAG() == FALSE)
    {
        memset(pPcmInfo, 0x00, PCM_SWMIXER_CLIENT_INFO_SIZE);
    }

    pPcmBufferInfo = pPcmInfo + AUDIO_PCM_MAXIMUM;

    for (s32DeviceId = 0; s32DeviceId < AUDIO_PCM_MAXIMUM; s32DeviceId++)
    {
        if (g_PCM[s32DeviceId] != NULL)
        {
            if (HAL_AUDIO_GET_INIT_FLAG() == FALSE)
            {
                strncpy((char *)pPcmInfo->u8Name, (char *)g_PCM[s32DeviceId]->u8Name, AUDIO_COMMON_PCM_IO_NAME_LENGTH);
            }
            g_PCM[s32DeviceId]->pPcmInfo = pPcmInfo;
            g_PCM[s32DeviceId]->pPcmBufferInfo = pPcmBufferInfo;
        }
...
MS_S32 HAL_AUDIO_PCM_DeInit(void)
{
    MS_S32 s32DeviceId = 0;
    MS_S32 s32Ret = 0;
    ...
    for (s32DeviceId = 0; s32DeviceId < AUDIO_PCM_MAXIMUM; s32DeviceId++)
    {
        if (g_PCM[s32DeviceId] != NULL)
        {
            ...
            g_PCM[s32DeviceId]->pPcmBufferInfo = NULL;
        }
    }
...
MS_S32 HAL_AUDIO_PCM_HwDma_Reader1_Apply_Setting(void)
{
    ...
    /* calculate buffer high threshold */
    pPCM->pPcmBufferInfo->u32BufferHighThreshold = u32TargetBufferSize - (u32TargetBufferSize >> 4);
    AUDIO_DO_ALIGNMENT(pPCM->pPcmBufferInfo->u32BufferHighThreshold, u32TargetAlignmentSize);
...
MS_S32 HAL_AUDIO_PCM_HwDma_Reader1_Restart(void)
{
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, HW_DMA_RDR1_BUF_SIZE);
    ...
    /* reset write offset */
    pPCM->pPcmBufferInfo->u32WriteOffset = 0;

    /* reset remain size */
    pPCM->pPcmBufferInfo->u32RemainSize = 0;
...
MS_S32 HAL_AUDIO_PCM_HwDma_Reader1_Open(void *pData)
{
    ...
    pPCM->pPcmBufferInfo->pPhyBuffer = u32TargetBufferAddrPa;
    pPCM->pPcmBufferInfo->u32ReadOffset = 0;
    pPCM->pPcmBufferInfo->u32WriteOffset = 0;
...
MS_S32 HAL_AUDIO_PCM_HwDma_Reader1_Get(MS_U32 u32Cmd, void *pData)
{
    ...
    switch(u32Cmd)
    {
        ...
        case AUDIO_PCM_CMD_BUFFER:
        {
             ...
             *
             * *((MS_S8 *)pData) = pPCM->pPcmBufferInfo->pPhyBuffer;
             */
            break;
        }
        ...
        case AUDIO_PCM_CMD_READPTR:
        {
             ...
             * TODO, need better coding
             *
             * *((MS_S8 *)pData) = pPCM->pPcmBufferInfo->u32ReadOffset;
             */
            break;
        }
        ...
        case AUDIO_PCM_CMD_WRITEPTR:
        {
             ...
             * TODO, need better coding
             *
             * *((MS_S8 *)pData) = pPCM->pPcmBufferInfo->u32WriteOffset;
             */
            break;
        }
...
MS_U32 HAL_AUDIO_PCM_HwDma_Reader1_Write(const void *pBuf, MS_U32 u32Size)
{
    ...
    /*
     * A patch here!
     * to ensure channel 8 are configured as HW DMA Reader1
     */
    if (((HAL_AUDIO_ReadByte(0x2CB0) & 0x07) != 0x04) ||
        (HAL_AUDIO_ReadByte(0x2C6B) != 0x8F))
    {
        HAL_AUDIO_WriteMaskByte(0x2CB0, 0x07, 0x04);
        HAL_AUDIO_WriteMaskByte(0x2C6B, 0xFF, 0x8F);
    }
    ...
    pBufTmp = (MS_S8 *)pBuf;
    pBuffer = (MS_S8 *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer);
    if (pBuffer == NULL)
    {
        HALAUDIO_ERROR("%s: Error! pBuffer should not be NULL!\n", __FUNCTION__);
        return 0;
    }
    ...
    {
        HALAUDIO_ERROR("darrenC : %s: Warning! PCM buffer empty!\n", __FUNCTION__);
    ...
    if ((u32PcmLevel + u32RequestSize) <= pPCM->pPcmBufferInfo->u32BufferHighThreshold)
    {
        for (u32Loop = 0; u32Loop < u32RequestSampleCount; u32Loop++)
        {
            *(pBuffer + pPCM->pPcmBufferInfo->u32WriteOffset + 0) = 0;
            *(pBuffer + pPCM->pPcmBufferInfo->u32WriteOffset + 1) = *pBufTmp++; /* L low, R low, L low, R low, ... */
            *(pBuffer + pPCM->pPcmBufferInfo->u32WriteOffset + 2) = *pBufTmp++; /* L high, R high, L high, R high, ... */
            *(pBuffer + pPCM->pPcmBufferInfo->u32WriteOffset + 3) = 0;
            pPCM->pPcmBufferInfo->u32WriteOffset += 4;

            if (pPCM->pPcmBufferInfo->u32WriteOffset >= u32BufferSize)
            {
                if (pPCM->pPcmBufferInfo->u32WriteOffset > u32BufferSize)
                {
                    HALAUDIO_ERROR("%s: Warning! it's an abnormal write!\n", __FUNCTION__);
                }
                pPCM->pPcmBufferInfo->u32WriteOffset = 0;
            }
        }
        ...
        u32RequestSize += pPCM->pPcmBufferInfo->u32RemainSize;
        HAL_AUDIO_WriteMaskReg(REG_AUDIO_DMA_RD_CTRL_1, 0xFFFF, (u32RequestSize/BYTES_IN_MIU_LINE));
        pPCM->pPcmBufferInfo->u32RemainSize = u32RequestSize % BYTES_IN_MIU_LINE;
#ifdef MSOS_TYPE_LINUX_KERNEL
        udelay(50);
#else
        AUDIO_DELAY1US(50);
...
MS_S32 HAL_AUDIO_PCM_HwDma_Reader2_Restart(void)
{
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, HW_DMA_RDR2_BUF_SIZE);
...
MS_U32 HAL_AUDIO_PCM_HwDma_Reader2_Write(const void *pBuf, MS_U32 u32Size)
{
    ...
    {
        do {
            u32SizeToWrite = u32BufferSize - pPCM->pPcmBufferInfo->u32WriteOffset;
            u32SizeToWrite = (u32SizeToWrite > u32RequestSizeTmp) ? u32RequestSizeTmp : u32SizeToWrite;

            memcpy((void *)(pBuffer + pPCM->pPcmBufferInfo->u32WriteOffset), (void *)pBufTmp, u32SizeToWrite);

            pBufTmp += u32SizeToWrite;
            pPCM->pPcmBufferInfo->u32WriteOffset += u32SizeToWrite;
            if (pPCM->pPcmBufferInfo->u32WriteOffset >= u32BufferSize)
            {
                if (pPCM->pPcmBufferInfo->u32WriteOffset > u32BufferSize)
                {
            ...
            u32RequestSizeTmp -= u32SizeToWrite;
...
MS_S32 HAL_AUDIO_PCM_SwDma_Reader1_Restart(void)
{
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, SW_DMA_RDR1_BUF_SIZE);
...
MS_U32 HAL_AUDIO_PCM_SwDma_Reader1_Write(const void *pBuf, MS_U32 u32Size)
{
    ...
    {
        do {
            u32SizeToWrite = SW_DMA_RDR1_BUF_SIZE - pPCM->pPcmBufferInfo->u32WriteOffset;
            u32SizeToWrite = (u32SizeToWrite > u32RequestSizeTmp) ? u32RequestSizeTmp : u32SizeToWrite;
            ...
            pBufTmp += u32SizeToWrite;
            pPCM->pPcmBufferInfo->u32WriteOffset += u32SizeToWrite;
            if (pPCM->pPcmBufferInfo->u32WriteOffset >= SW_DMA_RDR1_BUF_SIZE)
            {
                if (pPCM->pPcmBufferInfo->u32WriteOffset > SW_DMA_RDR1_BUF_SIZE)
                {
                    HALAUDIO_ERROR("%s: Warning! it's an abnormal write!\n", __FUNCTION__);
        ...
        HAL_AUDIO_WriteMaskReg(M2S_MBOX_SW_DMA_READER_DDR_WtPtr, 0xFFFF, (pPCM->pPcmBufferInfo->u32WriteOffset / BYTES_IN_MIU_LINE));
...
MS_S32 HAL_AUDIO_PCM_R2Dma_Reader1_Apply_Setting(void)
{
    ...
    HAL_AUR2_WriteMaskReg(R2_DMARDR_REG_SYNTH_UPDATE, 0x0101, 0x0101); /* SYTH1 bit8 RIU control, bit0 update */
    HAL_AUR2_WriteMaskReg(R2_DMARDR_REG_SYNTH_UPDATE, 0x0101, 0x0100);
...
MS_S32 HAL_AUDIO_PCM_R2Dma_Reader1_Restart(void)
{
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, R2_DMA_RDR1_BUF_SIZE);
...
MS_S32 HAL_AUDIO_PCM_R2Dma_Reader2_Restart(void)
{
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, R2_DMA_RDR2_BUF_SIZE);
...
#if AUDIO_PCM_SWMIXER_SUPPORT
MS_S32 HAL_AUDIO_PCM_SwMixer_Init(void)
{
    AUDIO_PCM_SWMIXER_SERVER_t *pPcmSwMixerServer = NULL;
    AUDIO_PCM_t *pPCM = NULL;
    MS_U32 u32ClientBufferAddrPa = 0;
    MS_S32 s32DeviceId = 0;
    MS_S32 s32MixerServerId = 0;
    MS_S32 s32Ret = 0;

    HALAUDIO_ERROR("%s: invoked\n", __FUNCTION__);

    /* clear all SW Mixer Client's PCM buffer */
    u32ClientBufferAddrPa = HAL_AUDIO_GetDspMadBaseAddr(DSP_SE) + DSP2_PCM_SWMIXER_CLIENT_BUFFER_BASE;
    memset((void *)MS_PA2KSEG1(u32ClientBufferAddrPa), 0x00, PCM_SWMIXER_CLIENT_BUFFER_SIZE);

    /* initiate all PCM SW Mixer Server & Client */
    for (s32MixerServerId = 0; s32MixerServerId < AUDIO_PCM_SWMIXER_SERVER_MAXIMUM; s32MixerServerId++)
    {
        MS_U32 u32BufferAddrPa = 0;

        pPcmSwMixerServer = (AUDIO_PCM_SWMIXER_SERVER_t *)&Audio_Pcm_Mixer_Server[s32MixerServerId];
        memset((void *)pPcmSwMixerServer, 0x00, sizeof(AUDIO_PCM_SWMIXER_SERVER_t));

        switch (s32MixerServerId)
        {
            case 0:
            {
                u32BufferAddrPa = HAL_AUDIO_GetDspMadBaseAddr(DSP_SE) + DSP2_PCM_SWMIXER_SERVER1_BUFFER_BASE;
                break;
            }

            case 1:
            {
                u32BufferAddrPa = HAL_AUDIO_GetDspMadBaseAddr(DSP_SE) + DSP2_PCM_SWMIXER_SERVER2_BUFFER_BASE;
                break;
            }
        ...
        if (u32BufferAddrPa > 0)
        {
            pPcmSwMixerServer->pBuffer = (MS_S8 *)MS_PA2KSEG1(u32BufferAddrPa);
            if (pPcmSwMixerServer->pBuffer == NULL)
            {
                HALAUDIO_ERROR("%s: Error! pPcmSwMixerServer->pBuffer should not be NULL!\n", __FUNCTION__);
                MS_ASSERT(0);
            }

            memset((void *)pPcmSwMixerServer->pBuffer, 0x00, PCM_SWMIXER_SERVER_BUFFER_SIZE);
        }
        ...
        for (s32DeviceId = 0; s32DeviceId < AUDIO_PCM_MAXIMUM; s32DeviceId++)
        {
            ...
            if (pPCM->tPcmCaps.u8MixingFlag == TRUE)
            {
                AUDIO_PCM_SWMIXER_CLIENT_t *pPcmSwMixerClient = &pPcmSwMixerServer->tPcmSwMixerClient[s32DeviceId];

                pPcmSwMixerClient->pInputBuffer = (MS_S8 *)AUDIO_MEM_ALLOC(sizeof(MS_S16) * AUDIO_PCM_SWMIXER_OUTPUT_SIZE_MAXIMUM * AUDIO_PCM_SWMIXER_CHANNEL);
                if (pPcmSwMixerClient->pInputBuffer == NULL)
                {
                    HALAUDIO_ERROR("%s: Error! fail to allocate memory to pInputBuffer!\n", __FUNCTION__);
                    MS_ASSERT(0);
                }
            }
        }
...
MS_S32 HAL_AUDIO_PCM_SwMixer_DeInit(void)
{
    AUDIO_PCM_SWMIXER_SERVER_t *pPcmSwMixerServer = NULL;
    MS_S32 s32DeviceId = 0;
    MS_S32 s32MixerServerId = 0;
    ...
    /* de-initiate all PCM SW Mixer Server & Client */
    for (s32MixerServerId = 0; s32MixerServerId < AUDIO_PCM_SWMIXER_SERVER_MAXIMUM; s32MixerServerId++)
    {
        pPcmSwMixerServer = (AUDIO_PCM_SWMIXER_SERVER_t *)&Audio_Pcm_Mixer_Server[s32MixerServerId];

        pPcmSwMixerServer->u8ThreadRunning = FALSE;

        while (pPcmSwMixerServer->u8ThreadExit != TRUE)
        {
            AUDIO_SLEEP_MS(1);
        }
        pPcmSwMixerServer->u8ThreadExit = FALSE;
        ...
        for (s32DeviceId = 0; s32DeviceId < AUDIO_PCM_MAXIMUM; s32DeviceId++)
        {
            ...
            if (g_PCM[s32DeviceId]->tPcmCaps.u8MixingFlag == TRUE)
            {
                AUDIO_PCM_SWMIXER_CLIENT_t *pPcmSwMixerClient = &pPcmSwMixerServer->tPcmSwMixerClient[s32DeviceId];

                if (pPcmSwMixerClient->pInputBuffer != NULL)
                {
                    AUDIO_MEM_FREE(pPcmSwMixerClient->pInputBuffer);
                }
            }
        }

        if (pPcmSwMixerServer->pHandleRoot != NULL)
        {
            AUDIO_MEM_FREE(pPcmSwMixerServer->pHandleRoot);
        }
...
MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Apply_Setting(AUDIO_PCM_t *pPCM)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_U32 u32TargetBufferSize = 0;
    MS_U32 u32TargetChannel = 0;
    ...
    if (pPCM == NULL)
    {
        HALAUDIO_ERROR("%s: Error! pPCM should not be NULL!\n", __FUNCTION__);
        return -A_EFAULT;
    }

    pPcmInfo = pPCM->pPcmInfo;
    ...
    u32TargetBufferSize = (pPcmInfo->u32BufferDuration * pPcmInfo->u32SampleRate * u32TargetChannel * (u32TargetBitWidth / 8)) / 1000;
    AUDIO_DO_ALIGNMENT(u32TargetBufferSize, u32TargetAlignmentSize);
    if (u32TargetBufferSize > (PCM_SWMIXER_CLIENT_BUFFER_SIZE / AUDIO_PCM_SWMIXER_CLIENT_MAXIMUM))
    {
        HALAUDIO_ERROR("%s: Error! Too large buffer size(%u) is required! Please check the settings: duration %u, sample rate %u\n", __FUNCTION__, u32TargetBufferSize, pPcmInfo->u32BufferDuration, pPcmInfo->u32SampleRate);
        u32TargetBufferSize = (PCM_SWMIXER_CLIENT_BUFFER_SIZE / AUDIO_PCM_SWMIXER_CLIENT_MAXIMUM);
        pPcmInfo->u32BufferDuration = ((u32TargetBufferSize * 1000) / (pPcmInfo->u32SampleRate * u32TargetChannel * (u32TargetBitWidth / 8)));
        HALAUDIO_ERROR("%s: Error! Force duration to %u, which is the maximun value\n", __FUNCTION__, pPcmInfo->u32BufferDuration);
    }
...
MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Restart(AUDIO_PCM_t *pPCM)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_S32 s32Ret = 0;
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, (PCM_SWMIXER_CLIENT_BUFFER_SIZE / AUDIO_PCM_SWMIXER_CLIENT_MAXIMUM));
...
MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Open(MS_U32 u32SwMixerId, AUDIO_PCM_t *pPCM, void *pData)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    AUDIO_PCM_INFO_t *pUserPcmInfo = NULL;
    MS_U32 u32TargetBufferAddrPa = 0;
    ...
    {
        HALAUDIO_ERROR("%s: Error! Only support mixing mode!\n", __FUNCTION__);
        return -A_EINVAL;
    }

    if ((pUserPcmInfo->u32MixingGroup != AUDIO_PCM_SWMIXER_GROUP_ALL) && (pUserPcmInfo->u32MixingGroup > AUDIO_PCM_SWMIXER_GROUP_MAX))
    {
        HALAUDIO_ERROR("%s: Error! Not support mixing group(0x%08X)!\n", __FUNCTION__, pUserPcmInfo->u32MixingGroup);
        return -A_EINVAL;
    }
    ...
    pPcmInfo->u8ConnectFlag = TRUE;
    strncpy((char *)pUserPcmInfo->u8Name, (char *)pPCM->u8Name, AUDIO_COMMON_PCM_IO_NAME_LENGTH);
    HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, AUDIO_PCM_CMD_NONBLOCKING, &pUserPcmInfo->u8NonBlockingFlag);
    pPcmInfo->u8MultiChFlag = pUserPcmInfo->u8MultiChFlag;
    pPcmInfo->u8MixingFlag = pUserPcmInfo->u8MixingFlag;
    pPcmInfo->u32MixingGroup = pUserPcmInfo->u32MixingGroup;
    HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, AUDIO_PCM_CMD_BUFFERDURATION, &pUserPcmInfo->u32BufferDuration);
    HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, AUDIO_PCM_CMD_CHANNEL, &pUserPcmInfo->u32Channel);
    HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, AUDIO_PCM_CMD_SAMPLERATE, &pUserPcmInfo->u32SampleRate);
    HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, AUDIO_PCM_CMD_BITWIDTH, &pUserPcmInfo->u32BitWidth);
    HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, AUDIO_PCM_CMD_BIGENDIAN, &pUserPcmInfo->u32BigEndian);
    HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, AUDIO_PCM_CMD_WEIGHTING, &pUserPcmInfo->u32Weighting);
    HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, AUDIO_PCM_CMD_VOLUME, &pUserPcmInfo->u32Volume);

    /* init PCM buffer address */
    u32TargetBufferAddrPa = HAL_AUDIO_GetDspMadBaseAddr(DSP_SE) + DSP2_PCM_SWMIXER_CLIENT_BUFFER_BASE;
    u32TargetBufferAddrPa += (u32SwMixerId * (PCM_SWMIXER_CLIENT_BUFFER_SIZE / AUDIO_PCM_SWMIXER_CLIENT_MAXIMUM));
    pPCM->pPcmBufferInfo->pPhyBuffer = u32TargetBufferAddrPa;
    pPCM->pPcmBufferInfo->u32ReadOffset = 0;
    pPCM->pPcmBufferInfo->u32WriteOffset = 0;

    /* apply setting */
    HAL_AUDIO_PCM_SwMixer_Client_Apply_Setting(pPCM);

    /* restart */
    HAL_AUDIO_PCM_SwMixer_Client_Restart(pPCM);

    return s32Ret;
}

MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Close(AUDIO_PCM_t *pPCM)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_S32 s32Ret = 0;
    ...
    if (pPcmInfo->u8ConnectFlag != FALSE)
    {
        HAL_AUDIO_PCM_SwMixer_Client_Flush(pPCM);
        memset((void *)pPcmInfo, 0x00, sizeof(AUDIO_PCM_INFO_t));
        strncpy((char *)pPcmInfo->u8Name, (char *)pPCM->u8Name, AUDIO_COMMON_PCM_IO_NAME_LENGTH);
    }
...
MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Start(AUDIO_PCM_t *pPCM)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_S32 s32Ret = 0;
...
MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Stop(AUDIO_PCM_t *pPCM)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_S32 s32Ret = 0;
...
MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Set(AUDIO_PCM_t *pPCM, MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_S32 s32Ret = 0;
    ...
    switch(u32Cmd)
    {
        ...
        case AUDIO_PCM_CMD_VOLUME:
        {
            ...
            /*
             * SW PCM Mixer's volume 100~0 is mapping to 96~996.
             */
            u32Volume = 96 + ((100 - u32Volume) * 9);
...
MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Get(AUDIO_PCM_t *pPCM, MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_S32 s32Ret = 0;
    ...
    switch(u32Cmd)
    {
        ...
        case AUDIO_PCM_CMD_VOLUME:
        {
            MS_U32 u32Volume = pPcmInfo->u32Volume & (~0x80000000);

            /*
             * SW PCM Mixer's volume 100~0 is mapping to 96~996.
             */
            u32Volume = 100 - ((u32Volume - 96) / 9);

            *((MS_U32 *)pData) = u32Volume;
            break;
        }
        ...
        case AUDIO_PCM_CMD_BUFFERLEVEL:
        {
            ...
            MS_U32 u32TargetChannel = 0;
            MS_U32 u32TargetBitWidth = 0;
            MS_S32 s32BufferLevel = 0;

            u32TargetChannel = 2;
            u32TargetBitWidth = 16;
            u32TargetBufferSize = (pPcmInfo->u32BufferDuration * pPcmInfo->u32SampleRate * u32TargetChannel * (u32TargetBitWidth / 8)) / 1000;

            s32BufferLevel = pPCM->pPcmBufferInfo->u32WriteOffset - pPCM->pPcmBufferInfo->u32ReadOffset;
            if (s32BufferLevel < 0)
            {
                s32BufferLevel += u32TargetBufferSize;
            }

            pPcmInfo->u32BufferLevel = (MS_U32)s32BufferLevel;
            *((MS_U32 *)pData) = pPcmInfo->u32BufferLevel;
...
MS_U32 HAL_AUDIO_PCM_SwMixer_Client_Write(AUDIO_PCM_t *pPCM, const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_S8 *pBufTmp = NULL;
    MS_S8 *pBuffer = NULL;
    ...
    HAL_AUDIO_PCM_SwMixer_Client_Get(pPCM, AUDIO_PCM_CMD_BUFFERLEVEL, &u32PcmLevel);
    if (u32PcmLevel == 0)
    {
        //HALAUDIO_ERROR("%s: Warning! PCM buffer empty!\n", __FUNCTION__);
    }
    ...
    HAL_AUDIO_PCM_SwMixer_Client_Get(pPCM, AUDIO_PCM_CMD_BUFFERSIZE, &u32BufferSize);
...
MS_S32 HAL_AUDIO_PCM_SwMixer_Client_Flush(AUDIO_PCM_t *pPCM)
{
    AUDIO_PCM_INFO_t *pPcmInfo = NULL;
    MS_S32 s32Ret = 0;
    ...
    {
        HAL_AUDIO_PCM_SwMixer_Client_Restart(pPCM);
        HAL_AUDIO_PCM_SwMixer_Client_Stop(pPCM);
    }

    return s32Ret;
}

MS_S32 HAL_AUDIO_PCM_SwMixer1_Open(void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer1;
    MS_U32 u32SwMixerId = 0;

    return HAL_AUDIO_PCM_SwMixer_Client_Open(u32SwMixerId, pPCM, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer1_Close(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer1;

    return HAL_AUDIO_PCM_SwMixer_Client_Close(pPCM);
}

MS_S32 HAL_AUDIO_PCM_SwMixer1_Start(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer1;

    return HAL_AUDIO_PCM_SwMixer_Client_Start(pPCM);
}

MS_S32 HAL_AUDIO_PCM_SwMixer1_Stop(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer1;

    return HAL_AUDIO_PCM_SwMixer_Client_Stop(pPCM);
}

MS_S32 HAL_AUDIO_PCM_SwMixer1_Set(MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer1;

    return HAL_AUDIO_PCM_SwMixer_Client_Set(pPCM, u32Cmd, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer1_Get(MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer1;

    return HAL_AUDIO_PCM_SwMixer_Client_Get(pPCM, u32Cmd, pData);
}

MS_U32 HAL_AUDIO_PCM_SwMixer1_Write(const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer1;

    return HAL_AUDIO_PCM_SwMixer_Client_Write(pPCM, pBuf, u32Size);
}

MS_S32 HAL_AUDIO_PCM_SwMixer1_Flush(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer1;

    return HAL_AUDIO_PCM_SwMixer_Client_Flush(pPCM);
}

MS_S32 HAL_AUDIO_PCM_SwMixer2_Open(void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer2;
    MS_U32 u32SwMixerId = 1;

    return HAL_AUDIO_PCM_SwMixer_Client_Open(u32SwMixerId, pPCM, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer2_Close(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer2;
...
MS_S32 HAL_AUDIO_PCM_SwMixer2_Start(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer2;
...
MS_S32 HAL_AUDIO_PCM_SwMixer2_Stop(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer2;
...
MS_S32 HAL_AUDIO_PCM_SwMixer2_Set(MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer2;
...
MS_S32 HAL_AUDIO_PCM_SwMixer2_Get(MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer2;
...
MS_U32 HAL_AUDIO_PCM_SwMixer2_Write(const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer2;
...
MS_S32 HAL_AUDIO_PCM_SwMixer2_Flush(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer2;
...
MS_S32 HAL_AUDIO_PCM_SwMixer3_Open(void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer3;
    MS_U32 u32SwMixerId = 2;

    return HAL_AUDIO_PCM_SwMixer_Client_Open(u32SwMixerId, pPCM, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer3_Close(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer3;
...
MS_S32 HAL_AUDIO_PCM_SwMixer3_Start(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer3;
...
MS_S32 HAL_AUDIO_PCM_SwMixer3_Stop(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer3;
...
MS_S32 HAL_AUDIO_PCM_SwMixer3_Set(MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer3;
...
MS_S32 HAL_AUDIO_PCM_SwMixer3_Get(MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer3;
...
MS_U32 HAL_AUDIO_PCM_SwMixer3_Write(const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer3;
...
MS_S32 HAL_AUDIO_PCM_SwMixer3_Flush(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer3;
...
MS_S32 HAL_AUDIO_PCM_SwMixer4_Open(void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer4;
    MS_U32 u32SwMixerId = 3;

    return HAL_AUDIO_PCM_SwMixer_Client_Open(u32SwMixerId, pPCM, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer4_Close(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer4;
...
MS_S32 HAL_AUDIO_PCM_SwMixer4_Start(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer4;
...
MS_S32 HAL_AUDIO_PCM_SwMixer4_Stop(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer4;
...
MS_S32 HAL_AUDIO_PCM_SwMixer4_Set(MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer4;
...
MS_S32 HAL_AUDIO_PCM_SwMixer4_Get(MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer4;
...
MS_U32 HAL_AUDIO_PCM_SwMixer4_Write(const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer4;
...
MS_S32 HAL_AUDIO_PCM_SwMixer4_Flush(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer4;
...
MS_S32 HAL_AUDIO_PCM_SwMixer5_Open(void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer5;
    MS_U32 u32SwMixerId = 4;

    return HAL_AUDIO_PCM_SwMixer_Client_Open(u32SwMixerId, pPCM, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer5_Close(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer5;
...
MS_S32 HAL_AUDIO_PCM_SwMixer5_Start(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer5;
...
MS_S32 HAL_AUDIO_PCM_SwMixer5_Stop(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer5;
...
MS_S32 HAL_AUDIO_PCM_SwMixer5_Set(MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer5;
...
MS_S32 HAL_AUDIO_PCM_SwMixer5_Get(MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer5;
...
MS_U32 HAL_AUDIO_PCM_SwMixer5_Write(const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer5;
...
MS_S32 HAL_AUDIO_PCM_SwMixer5_Flush(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer5;
...
MS_S32 HAL_AUDIO_PCM_SwMixer6_Open(void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer6;
    MS_U32 u32SwMixerId = 5;

    return HAL_AUDIO_PCM_SwMixer_Client_Open(u32SwMixerId, pPCM, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer6_Close(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer6;
...
MS_S32 HAL_AUDIO_PCM_SwMixer6_Start(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer6;
...
MS_S32 HAL_AUDIO_PCM_SwMixer6_Stop(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer6;
...
MS_S32 HAL_AUDIO_PCM_SwMixer6_Set(MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer6;
...
MS_S32 HAL_AUDIO_PCM_SwMixer6_Get(MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer6;
...
MS_U32 HAL_AUDIO_PCM_SwMixer6_Write(const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer6;
...
MS_S32 HAL_AUDIO_PCM_SwMixer6_Flush(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer6;
...
MS_S32 HAL_AUDIO_PCM_SwMixer7_Open(void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer7;
    MS_U32 u32SwMixerId = 6;

    return HAL_AUDIO_PCM_SwMixer_Client_Open(u32SwMixerId, pPCM, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer7_Close(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer7;
...
MS_S32 HAL_AUDIO_PCM_SwMixer7_Start(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer7;
...
MS_S32 HAL_AUDIO_PCM_SwMixer7_Stop(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer7;
...
MS_S32 HAL_AUDIO_PCM_SwMixer7_Set(MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer7;
...
MS_S32 HAL_AUDIO_PCM_SwMixer7_Get(MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer7;
...
MS_U32 HAL_AUDIO_PCM_SwMixer7_Write(const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer7;
...
MS_S32 HAL_AUDIO_PCM_SwMixer7_Flush(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer7;
...
MS_S32 HAL_AUDIO_PCM_SwMixer8_Open(void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer8;
    MS_U32 u32SwMixerId = 7;

    return HAL_AUDIO_PCM_SwMixer_Client_Open(u32SwMixerId, pPCM, pData);
}

MS_S32 HAL_AUDIO_PCM_SwMixer8_Close(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer8;
...
MS_S32 HAL_AUDIO_PCM_SwMixer8_Start(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer8;
...
MS_S32 HAL_AUDIO_PCM_SwMixer8_Stop(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer8;
...
MS_S32 HAL_AUDIO_PCM_SwMixer8_Set(MS_U32 u32Cmd, const void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer8;
...
MS_S32 HAL_AUDIO_PCM_SwMixer8_Get(MS_U32 u32Cmd, void *pData)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer8;
...
MS_U32 HAL_AUDIO_PCM_SwMixer8_Write(const void *pBuf, MS_U32 u32Size)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer8;
...
MS_S32 HAL_AUDIO_PCM_SwMixer8_Flush(void)
{
    AUDIO_PCM_t *pPCM = &Audio_Pcm_SwMixer8;
...
MS_S32 HAL_AUDIO_PCM_Capture1_Restart(void)
{
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, PCM_CAPTURE1_BUF_SIZE);
...
MS_S32 HAL_AUDIO_PCM_Capture1_Get(MS_U32 u32Cmd, void *pData)
{
    ...
    switch(u32Cmd)
    {
        ...
        case AUDIO_PCM_CMD_BUFFERLEVEL:
        {
            ...
            u32WritePtrOffset = HAL_AUDIO_ReadReg(S2M_MBOX_PCM_CAPTURE_DDR_WrPtr) * BYTES_IN_MIU_LINE;
            pPCM->pPcmBufferInfo->u32WriteOffset = u32WritePtrOffset;

            s32PcmLevel = pPCM->pPcmBufferInfo->u32WriteOffset - pPCM->pPcmBufferInfo->u32ReadOffset;
            if (s32PcmLevel < 0)
            {
                u32BufferSize = (pPcmInfo->u32BufferDuration * pPcmInfo->u32SampleRate * pPcmInfo->u32Channel * 2) / 1000;
...
MS_U32 HAL_AUDIO_PCM_Capture1_Read(void *pBuf, MS_U32 u32Size)
{
    ...
    {
        do {
            u32SizeToRead = u32BufferSize - pPCM->pPcmBufferInfo->u32ReadOffset;
            u32SizeToRead = (u32SizeToRead > u32RequestSizeTmp) ? u32RequestSizeTmp : u32SizeToRead;

            memcpy((void *)pBufTmp, (void *)(pBuffer + pPCM->pPcmBufferInfo->u32ReadOffset), u32SizeToRead);

            pBufTmp += u32SizeToRead;
            pPCM->pPcmBufferInfo->u32ReadOffset += u32SizeToRead;
            if (pPCM->pPcmBufferInfo->u32ReadOffset >= u32BufferSize)
            {
                if (pPCM->pPcmBufferInfo->u32ReadOffset > u32BufferSize)
                {
                    HALAUDIO_ERROR("%s: Warning! it's an abnormal read!\n", __FUNCTION__);
                }
                pPCM->pPcmBufferInfo->u32ReadOffset = 0;
            }

            u32RequestSizeTmp -= u32SizeToRead;
        } while (u32RequestSizeTmp > 0);
        ...
        HAL_AUDIO_WriteReg(M2S_MBOX_PCM_CAPTURE_DDR_RdPtr, (pPCM->pPcmBufferInfo->u32ReadOffset / BYTES_IN_MIU_LINE));
...
MS_S32 HAL_AUDIO_PCM_Capture2_Restart(void)
{
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, PCM_CAPTURE2_BUF_SIZE);
...
MS_U32 HAL_AUDIO_PCM_Capture2_Read(void *pBuf, MS_U32 u32Size)
{
    ...
    if (u32PcmLevel >= u32RequestSize)
    {
        ...
        /* update read pointer to engine */
        HAL_AUDIO_WriteReg(M2S_MBOX_PCM_CAPTURE2_DDR_RdPtr, (pPCM->pPcmBufferInfo->u32ReadOffset / BYTES_IN_MIU_LINE));
...
MS_S32 HAL_AUDIO_PCM_HwDma_Writer1_Restart(void)
{
    ...
    /* clear PCM buffer */
    memset((void *)MS_PA2KSEG1(pPCM->pPcmBufferInfo->pPhyBuffer), 0x00, HW_DMA_WTR1_BUF_SIZE);
