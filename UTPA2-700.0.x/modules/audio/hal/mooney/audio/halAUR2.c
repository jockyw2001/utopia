...
MS_U32 HAL_DEC_R2_Get_SHM_INFO(R2_SHM_INFO_TYPE decInfoType, MS_U8 dec_id )
{
    ...
    MsOS_Dcache_Flush((MS_VIRT)p_shm_chinfo, sizeof(AUR2_ADEC_Ch_INFO_SHM));
    ret_value = *ptr;
...
MS_BOOL HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_TYPE decParamType, MS_U8 dec_id, MS_U32 param, MS_U32 param2 )
{
    ...
    switch( decParamType )
    {
        ...
        case R2_SHM_PARAM_EXT_SMPRATE_CTRL:     ptr = (volatile MS_U32 *) &p_shm_param->extSynthsizer_en;     *ptr = param;  MsOS_Dcache_Flush((MS_VIRT)ptr,4);
                                                ptr = (volatile MS_U32 *) &p_shm_param->extSynthsizer_value;     *ptr = param2;  MsOS_Dcache_Flush((MS_VIRT)ptr,4);     break;
        ...
        case R2_SHM_PARAM_DOLBY_MIXER_BALANCE: break;
