...
static AUDIO_DSP_CODE_TYPE   sifSystemType = AU_SIF_NONE;
...
void HAL_SIF_TriggerSifPLL(void)
{
    ...
    {
        HAL_SIF_AbsWriteMaskByte(0x000E61, 0x01, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x000E13, 0x04, 0x00);
        ...
        HAL_SIF_AbsWriteMaskByte(0x103314, 0xFF, 0x00);
        ...
        HAL_SIF_AbsWriteMaskByte(0x11208E, 0xFF, 0x00);
        HAL_SIF_AbsWriteMaskByte(0x11208F, 0xFF, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x100E13, 0x04, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x112879, 0xF0, 0x00);

	 HAL_SIF_AbsWriteMaskByte(0x1128C0, 0xFF, 0x02); //switch mux
	 HAL_SIF_AbsWriteMaskByte(0x1128C1, 0xFF, 0x00); //switch mux

	 HAL_SIF_AbsWriteMaskByte(0x1128AE, 0x80, 0x00); //enable LDO26
	 HAL_SIF_AbsWriteMaskByte(0x1128AE, 0x18, 0x00); //enable LDO11_CLK &  LDO11_CMP
	 HAL_SIF_AbsWriteMaskByte(0x1128B1, 0x01, 0x00); //enable LDO25

        HAL_SIF_AbsWriteMaskByte(0x112840, 0xFF, 0x00);
        HAL_SIF_AbsWriteMaskByte(0x112841, 0xFF, 0x00);
        HAL_SIF_AbsWriteMaskByte(0x112834, 0x10, 0x10);

        HAL_SIF_AbsWriteMaskByte(0x112802, 0xFF, 0x40); //mux selection
        HAL_SIF_AbsWriteMaskByte(0x112803, 0xFF, 0x04); //mux selection

        HAL_SIF_AbsWriteMaskByte(0x112816, 0xFF, 0x05);
        HAL_SIF_AbsWriteMaskByte(0x112817, 0xFF, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x11281E, 0xFF, 0x80);
        HAL_SIF_AbsWriteMaskByte(0x11281F, 0xFF, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x112860, 0xFF, 0x00);
        HAL_SIF_AbsWriteMaskByte(0x112861, 0xFF, 0x12); //dmpll post divider

        HAL_SIF_AbsWriteMaskByte(0x112864, 0xFF, 0x00); //set MPLL_PDIV = 96MHz
        HAL_SIF_AbsWriteMaskByte(0x112865, 0xFF, 0x09); //set MPLL_PDIV = 96MHz

        HAL_SIF_AbsWriteMaskByte(0x1128aa, 0xFF, 0x00); //change MPLL_DIV8 to MPLL_PDIV(96MHz)
        HAL_SIF_AbsWriteMaskByte(0x1128ab, 0xFF, 0x01); //change MPLL_DIV8 to MPLL_PDIV(96MHz)

        HAL_SIF_AbsWriteMaskByte(0x112866, 0xFF, 0x01);
        HAL_SIF_AbsWriteMaskByte(0x112867, 0xFF, 0x12);

        HAL_SIF_AbsWriteMaskByte(0x11286A, 0xFF, 0x84);
        HAL_SIF_AbsWriteMaskByte(0x11286B, 0xFF, 0x00);
        AUDIO_DELAY1MS(1);
        HAL_SIF_AbsWriteMaskByte(0x11286A, 0xFF, 0x04);
        HAL_SIF_AbsWriteMaskByte(0x11286B, 0xFF, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x11286C, 0xFF, 0x00);
        HAL_SIF_AbsWriteMaskByte(0x11286D, 0xFF, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x11287F, 0xFF, 0x00);
        HAL_SIF_AbsWriteMaskByte(0x11287E, 0xFF, 0x10);

        HAL_SIF_AbsWriteMaskByte(0x112818, 0xFF, 0x02);
        HAL_SIF_AbsWriteMaskByte(0x112819, 0xFF, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x101E39, 0x03, u8MuxSelect);  // Revert MUX setting

        HAL_SIF_AbsWriteMaskByte(0x112c02, 0x04, 0x04);
        HAL_SIF_AbsWriteMaskByte(0x112cb0, 0x80, 0x80); // change clock speed, matain data balance
        HAL_SIF_AbsWriteMaskByte(0x112cb0, 0x60, 0x60); // change clock speed, matain data balance
        HAL_SIF_AbsWriteMaskByte(0x112CC6, 0x01, 0x01); // SIF AGC control by DSP
        HAL_SIF_AbsWriteMaskByte(0x112CC8, 0xFF, 0xe0);
        HAL_SIF_AbsWriteMaskByte(0x112CC9, 0xFF, 0x2e); // switch SIF/VIF gear

        HAL_SIF_AbsWriteMaskByte(0x112CC9, 0xFF, 0x2E); // Enable SIF

        HAL_SIF_AbsWriteMaskByte(0x112834, 0x10, 0x00);
        HAL_SIF_AbsWriteMaskByte(0x11286C, 0x10, 0x00);
        HAL_SIF_AbsWriteMaskByte(0x112876, 0x03, 0x00);

        HAL_SIF_AbsWriteMaskByte(0x112DC2, 0xFF, 0x40);
        HAL_SIF_AbsWriteMaskByte(0x112D5C, 0xFF, 0x80);
...
/// @param <IN>        \b dspCodeType: SIF DSP code type.
/// @param <OUT>       \b NONE    :
/// @param <RET>       \b NONE    :
/// @param <GLOBAL>    \b NONE    :
////////////////////////////////////////////////////////////////////////////////
...
/// @param <IN>        \b NONE    :
/// @param <OUT>       \b NONE    :
/// @param <RET>       \b AUDIO_DSP_CODE_TYPE: SIF DSP code type.
/// @param <GLOBAL>    \b NONE    :
////////////////////////////////////////////////////////////////////////////////
    ...
    switch( u8DecCmd )
    {
        ...
        case AU_SIF_CMD_SET_SIF_SHIFT_CLK:
            if (HAL_SIF_SendCmd(AU_SIF_CMD_GET_ADC_FROM_VIF_PATH, 0, 0) == TRUE) // VIF mode
            {
                ...
                HAL_SIF_SetSystem(sifSystemType);
            }
            break;
...
MS_BOOL HAL_SIF_SetPrescale(AUDIO_SIF_GAIN_TYPE gainType,int db_value)
{
    MS_U8  i, i_min, i_max;
    ...
    MS_U32 gain;
    MS_U8 u8Type = (MS_U8)gainType;

    DspCodeType=HAL_SIF_GetDspCodeType();
    if (db_value == 99)
    {
        if (DspCodeType == AU_SIF_BTSC)
        {
        ...
        else if (DspCodeType == AU_SIF_PALSUM)
        {
...
MS_BOOL HAL_SIF_ReLoadCode(AUDIO_DSP_CODE_TYPE dspCodeType)
{
    ...
    DBG_SIF(printf("MDrv_SIF_ReLoadCode(dspCodeType= SIF(%x))\r\n",dspCodeType));
...
{
    sifSystemType = dspCodeType;
    HAL_SIF_ReLoadCode(sifSystemType);
