...
*   Version Control
*********************************************************/
#define  system_version_num              0x000B6C
#define  dde_version_num                 0xD20051
#define  ms10_dde_version_num            0xD800C1
#define  btscEnc_version_num             0xEF0126
#define  fmTx_version_num                0xED010C
#define  ms12_ddpe_version_num           0xEC3017

#define  AUDIO_DSP2_VERSION    (system_version_num + dde_version_num + ms10_dde_version_num + btscEnc_version_num + fmTx_version_num + ms12_ddpe_version_num)
...
*********************************************************/
    ...
    /* DSP Audio Delay Setting */
        ...
        #define AUDIO_DELAY_LOWER_BOUND             0x30            // min main audio delay , 0x30 = 48 ms
        ...
        #define KTV_DELAY_LOWER_BOUND               0x10            // min ktv audio delay  , 0x14 = 20 ms
        ...
        #define HDMI_DELAY_UPPER_BOUND              ((SE_HDMI_DLY_DRAM_SIZE/HDMI_DELAY_STORE_CHANNELS)/DMA16BIT_BYTES_IN_WORDS/HDMI_DELAY_FS)
...
************************************************/
    /* DSP SRAM Segment */
        ...
        #define DSP2_CM_MAIN_SIZE                   0x1000
        #define DSP2_CM_CODE1_ADDR                  0x1000
        #define DSP2_CM_CODE1_SIZE                  0x0400
        #define DSP2_CM_CODE2_ADDR                  0x1400
        #define DSP2_CM_CODE2_SIZE                  0x0000

        /* PM */
        #define DSP2_PM_MAIN_ADDR                   0x1400
        #define DSP2_PM_MAIN_SIZE                   0x02FF
        #define DSP2_PM_SEG1_ADDR                   0x16FF
        #define DSP2_PM_SEG1_SIZE                   0x3101
        ...
        #define DSP2_PM_PREFETCH2_DSPADDR           0x10000                // check "arch.sys"
        #define DSP2_PM_PREFETCH2_DDRADDR           DSP2_PM_PREFETCH2_DSPADDR*3/BYTES_IN_MIU_LINE

        /* DM */
        #define DSP2_DM_MAIN_ADDR                   0x3300
        #define DSP2_DM_MAIN_SIZE                   0x0D00
        #define DSP2_DM_SEG1A_ADDR                  0x0
        #define DSP2_DM_SEG1A_SIZE                  0x3300
        #define DSP2_DM_SEG1B_ADDR                  0x3300
        #define DSP2_DM_SEG1B_SIZE                  0x0
        #define DSP2_DM_SEG2_ADDR                   0x3300
    ...
    /* SND DSP PM vars */
        /* common */
            ...
            #define DSP2PmAddr_peq48KCoeffAddr      (DSP2PmAddr_mainVer     + 1)
    ...
    /* SND DSP DM vars */
        ...
        /* Extra Box Address */
            ...
            #define DSP2XboxAddr_AVCRmodeP1           (DSP2XboxAddr_mainVer +   0x5D)   // len 1
            #define DSP2XboxAddr_AVCRmodeP2           (DSP2XboxAddr_mainVer +   0x5E)   // len 1
            #define DSP2XboxAddr_AVCRmodeType         (DSP2XboxAddr_mainVer +   0x5F)   // len 1

            #define DSP2XboxAddr_peqUpdateFlag        (DSP2XboxAddr_mainVer +   0x60)   // len 1
            #define DSP2XboxAddr_hpUpdateFlag         (DSP2XboxAddr_mainVer +   0x61)   // len 1
            #define DSP2XboxAddr_bassUpdateFlag       (DSP2XboxAddr_mainVer +   0x62)   // len 1
            #define DSP2XboxAddr_trebleUpdateFlag     (DSP2XboxAddr_mainVer +   0x63)   // len 1
            #define DSP2XboxAddr_toneUpdateFlag       (DSP2XboxAddr_mainVer +   0x64)   // len 1
            #define DSP2XboxAddr_easeAUpdateFlag      (DSP2XboxAddr_mainVer +   0x65)   // len 1
            #define DSP2XboxAddr_easeBUpdateFlag      (DSP2XboxAddr_mainVer +   0x66)   // len 1
            #define DSP2XboxAddr_mSurrUpdateFlag      (DSP2XboxAddr_mainVer +   0x67)   // len 1
            #define DSP2XboxAddr_mSurrReverbLen       (DSP2XboxAddr_mainVer +   0x68)   // len 1
            #define DSP2XboxAddr_avcUpdateFlag        (DSP2XboxAddr_mainVer +   0x69)   // len 1

            #define DSP2XboxAddr_ATVEnc_input_attenuation_ADDR   (DSP2XboxAddr_mainVer +   0x6A)    // len 1
        ...
        /* common */
            ...
            #define DSP2XboxAddr_pcmCapture_overflow             (DSP2XboxAddr_IO_Info2 + 0x0021)   // len 1
            #define DSP2XboxAddr_pcmCapture_underflow            (DSP2XboxAddr_IO_Info2 + 0x0022)   // len 1
            #define DSP2XboxAddr_pcmCapture_volume               (DSP2XboxAddr_IO_Info2 + 0x0023)   // len 1
            #define DSP2XboxAddr_pcmCapture2_overflow            (DSP2XboxAddr_IO_Info2 + 0x0024)   // len 1
            #define DSP2XboxAddr_pcmCapture2_underflow           (DSP2XboxAddr_IO_Info2 + 0x0025)   // len 1
            #define DSP2XboxAddr_pcmCapture2_volume              (DSP2XboxAddr_IO_Info2 + 0x0026)   // len 1
            #define DSP2XboxAddr_pcmCapture3_overflow            (DSP2XboxAddr_IO_Info2 + 0x0027)   // len 1
            #define DSP2XboxAddr_pcmCapture3_underflow           (DSP2XboxAddr_IO_Info2 + 0x0028)   // len 1
            #define DSP2XboxAddr_pcmCapture3_volume              (DSP2XboxAddr_IO_Info2 + 0x0029)   // len 1
            #define DSP2XboxAddr_swDmaRdr_ctrlBase               (DSP2XboxAddr_IO_Info2 + 0x002A)   // len 11
            ...
            #define DSP2XboxAddr_hdmi_decimation_mode_flag       (DSP2XboxAddr_IO_Info2 + 0x0038)   // len 2

            #define DSP2XboxAddr_mips_crisis_flag                (DSP2XboxAddr_IO_Info2 + 0x003A)   // len 1
...
*************************************************/
    ...
    ************************************************/
    ...
    #define M2S_MBOX_HDMI_SETTING                   MB_2D8E
        ...
        #define MBOX_HDMI_SETTING_DDP_BYPASS_BIT        MBOX_BIT14
    ...
    #define M2S_MBOX_AVC_CTRL                   MB_2D24
    ...
    //  MS12 DDPE control
    //************************************************************
    //#define M2S_MBOX_DDP_ENC_SELECT                 MB_2DC0
    #define MBOX_DDP_ENC_SELECT                     ddpe_enc_select
        #define ENC_DDP_MODE_BIT                    0       // 0:DD, 1:DDP
        #define ENC_DDP_ENCODE_FLAG_BIT             1       // 0:Not Encode, 1:Encode.
        #define ENC_LISTEN_MODE_BIT                 4       // 0:
        #define ENC_FORCE_MODE_BIT                  8

    #define D2S_MBOX_DDP_PCM_WRPTR                  DECR2M_2_DSP_MAILBOXD       //³æ¦ì: miu line, range: 0 ~ 0x1200 (SEDSP_DDPENC_MCHOUT_DRAM_SIZE)
    //#define D2S_MBOX_DDP_PCM_WRPTR                  ddpe_pcm_dram_wrPtr         //³æ¦ì: miu line, range: 0 ~ 0x1200 (SEDSP_DDPENC_MCHOUT_DRAM_SIZE)
    #define S2D_MBOX_DDP_PCM_RDPTR                  ddpe_pcm_dram_rdPtr         //³æ¦ì: miu line, range: 0 ~ 0x1200 (SEDSP_DDPENC_MCHOUT_DRAM_SIZE)


    #define S2D_MBOX_DDP_RAW_HDMI_WRPTR             ddpe_hdmi_npcmWrAddr        //³æ¦ì: miu line, range: 0 ~ 0xD800 (HDMI_NONPCM_DRAM_SIZE)
    #define S2D_MBOX_DDP_RAW_SPDIF_WRPTR            ddpe_spdif_npcmWrAddr       //³æ¦ì: miu line, range: 0 ~ 0x3600 (SPDIF_NONPCM_DRAM_SIZE)

    #define M2S_MBOX_DDPE_ENCODE_CTRL           MB_2DC2
        #define MBOX_DSP_DDPE_DISABLE_BIT           MBOX_BIT0

    #define M2S_MBOX_MCU_HDMI_NONPCM_CTRL       MB_2DC4
    ...
    //  DSP clock control
    //************************************************************
    #define M2S_MBOX_DSP_TIMER_CONSTANT             MB_2DC0
...
*************************************************/
    ...
    /* DSP DM Prefetch */
        #define DSP2_DM_PREFETCH_DRAM_BASE              0x00A800
        #define DSP2_DM_PREFETCH_DRAM_SIZE              0x3000          // 192KB
    ...
    /* HE-AAC Metadata Buffer on DEC */
        #define DSP2_HEAAC_METADATA_DRAM_BASE           0x00D800
        #define DSP2_HEAAC_METADATA_DRAM_SIZE           0x00200          // 8KB

    /* Surround */
        #define SUR_DRAM_BASEADDR                       0x00DA00        // Line Address
        #define SUR_DRAM_ENDADDR                        (SUR_DRAM_BASEADDR + 0x00800) //0x00800         // 32KB

    /* KTV */
        #define SUR_DRAM_KTV_BASEADDR                   0x00E200        // Line address, Only in KTV mode, MS surround -> echo
        #define SUR_DARM_KTV_ENDADDR                    (SUR_DRAM_KTV_BASEADDR + 0x002000) //0x002000        // Line address, Overlay with DM prefetch
    ...
    /* Head phone delay */
        #define DSP2_HEAD_PHONE_DLY_DRAM_BASE           0x029000
        #define DSP2_HEAD_PHONE_DLY_DRAM_SIZE           0x17FF
    ...
    /* COMMON DRAM */
       ...
       /* DDPE */
            .const DSP2_DDPE_PCM_DRAM_BASE          =   DSP2_TO_COMMON_DRAM_OFFSET + (OFFSET_SEDSP_DDPENC_MCHOUT_DRAM_ADDR / BYTES_IN_MIU_LINE);
            .const DSP2_DDPE_PCM_DRAM_SIZE          =   (SEDSP_DDPENC_MCHOUT_DRAM_SIZE / BYTES_IN_MIU_LINE) - 1;
            .const DSP2_DDPE_META_DRAM_BASE         =   DSP2_TO_COMMON_DRAM_OFFSET + (OFFSET_DDPENC_METADATA_DRAM_ADDR / BYTES_IN_MIU_LINE);
            .const DSP2_DDPE_META_DRAM_SIZE         =   (DDPENC_METADATA_DRAM_SIZE / BYTES_IN_MIU_LINE) - 1;
            .const DSP2_DDPE_RAW_HDMI_DRAM_BASE     =   (OFFSET_HDMI_NONPCM_DRAM_BASE / BYTES_IN_MIU_LINE);
            .const DSP2_DDPE_RAW_HDMI_DRAM_SIZE     =   (HDMI_NONPCM_DRAM_SIZE / BYTES_IN_MIU_LINE) - 1;
            .const DSP2_DDE_RAW_SPDIF_DRAM_BASE     =   (OFFSET_SPDIF_NONPCM_DRAM_BASE / BYTES_IN_MIU_LINE);
            .const DSP2_DDE_RAW_SPDIF_DRAM_SIZE     =   (SPDIF_NONPCM_DRAM_SIZE/ BYTES_IN_MIU_LINE) - 1;
...
*************************************************/
    ...
    #define General_DSP_IDMA_CMD_Number             15              // just info this chip nubmer of DSP_IDMA can support, (no any purpose) need sync with HW spec
        ...
        #define PCM_CAPTURE2_DMA_CTRL   DSPDMA8_DMA_CTRL
        #define PCM_CAPTURE3_DMA_CTRL   DSPDMA9_DMA_CTRL
        #define SW_DMARDR_DMA_CTRL      DSPDMA7_DMA_CTRL
        #define HP_DLY_DMA_CTRL         DSPDMA2_DMA_CTRL
...
*************************************************/
    ...
    /* Mstar Surround delay buffer */
        ...
        .const SUR_DRAM_BURSRT               =     (SUR_FIFO_UNIT*2)/BYTES_IN_MIU_LINE;
    ...
    /* ISR PCM samples -> DDR unit setting */
        .const SE_BUFF2_FIFO_SIZE                   = (SE_PROCESS_FIFO_SIZE_UNIT * SE_PROCESS_FETCH_CHANNELS);
        .const SE_BUFF2_DMA_WORD_SIZE               = (SE_PROCESS_DMA_WORD_SIZE_UNIT * SE_PROCESS_FETCH_CHANNELS);    // (DMA_WORD_SIZE per channel) * channel number  0x80;
    ...
    /* DDR2 --> output ISR PCM samples */
        ...
        .const SE_BUFF1_DMA_WORD_SIZE               = (SE_PROCESS_DMA_WORD_SIZE_UNIT * SE_PROCESS_STORE_CHANNELS);    // (DMA_WORD_SIZE per channel) * channel number   0x80;
    ...
    /* SE Background process  DDR1 --> DDR2 */
        .const SE_BG_PROCESS_DMA_WORD_SIZE        = 32;
        .const SE_BG_PROCESS_DMA_24BIT_LINE_SIZE  = SE_BG_PROCESS_DMA_WORD_SIZE*3/BYTES_IN_MIU_LINE;
        .const SE_BG_PROCESS_DMA_16BIT_LINE_SIZE  = SE_BG_PROCESS_DMA_WORD_SIZE*2/BYTES_IN_MIU_LINE;
...
********************************************************************/
    ...
    #define ISR_PMASK_DEC_R2_CMD        20              //from R2 IO  0xB000_0860
    #define ISR_PMASK_R2_LOAD_CODE_CMD  21              //from R2 IO  0xB000_0840
...
********************************************************************/
    ...
    /* Mailbox with DEC R2 */
        #define D2S_MBOX_PCMISR_CTRL            DECR2M_2_DSP_MAILBOX1
            #define MBOX_R2_PCM1ISR_PLAY_START_BIT          0           //--> ³o¦U¥Ñ playSmpFlag / stop / pause ¨M©w
        ...
        //#define D2S_MBOX_HDMI_NPCM_WRPTR        hdmi_npcmWrAddr
        ...
        // PRE-SE PCM Read/Write pointer
        // DEC-R2 --> SE-DSP
        #define D2S_R2_PCMOUT_WRPTR             DECR2M_2_DSP_MAILBOXF       // 0xB000087C

        // SE-DSP --> DEC-R2
        #define S2D_R2_PCMIN_WRPTR              DSP_2_DECR2M_MAILBOXC       // 0xB0000830

        #define D2S_DSP_ENCODE_SETTING          DECR2M_2_DSP_MAILBOXE
            #define D2S_CMD_SOUND_MIXER_DISABLE_BIT MBOX_BIT11  // Bit11  //[1] SOUND_MIXER, 0:in DSP (MS11), 1:in DEC_R2 (MS12)
            #define D2S_CMD_DDENC_ENABLE            MBOX_BIT10  // Bit10
             //#define MBOX_NONPCM_DDPE_ENABLE_BIT    MBOX_BIT7                 //Roger Add
      ...
      //#define S2D_MBOX_PCM1_DRAM_RDPTR        DSP_2_DECR2M_MAILBOX5
        ...
        #define S2D_MBOX_PCM2_DRAM_RDPTR        DSP_2_DECR2M_MAILBOX5
...
********************************************************************/
    ...
    /* PCM output port */
        ...
        #define R2_PCM1_DMX__L_OUT              DEC3_PCM1_OUT
...
*************************************************/
    ...
    ************************************************/
    ...
    //// SIF    /* SIF DSP PM vars */        //  for SIF PAL DSP PM vars //
        ...
        #define M2S_MBOX_DRC_CTRL                         MB_2D2E
