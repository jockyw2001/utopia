...
typedef enum
{
    ...
    AUR2_HDMITx_TypeChanged = 0xC000,
...
typedef enum
{
    ...
    R2_SHM_PARAM_DOLBY_DDP_DISABLE_ATMOS,
    ...
    R2_SHM_PARAM_ES2_IsUsedBy_Dual,

    R2_SHM_PARAM_LOW_LATENCY_LIMITER_ES_THRESHOLD,
    R2_SHM_PARAM_LOW_LATENCY_LIMITER_PCM_THRESHOLD,
    R2_SHM_PARAM_LOW_LATENCY_LIMITER_PCM_SKIP_TARGET,
    R2_SHM_PARAM_ES_REPEAT_MODE,

    R2_SHM_PARAM_AUR2_HDMITx_TypeChanged,
} R2_SHM_PARAM_TYPE;
