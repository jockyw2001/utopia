...
void HAL_MAD2_SetMemInfo(void)
{
  ...
  ********************************************************/
    HAL_AUDIO_WriteMaskByte(REG_AUDIO_SYNTH_EXPANDER, REG_R2_1_CTRL_BANK_SW_BIT_MASK, 0x00);        //BANK 1630 control by MCU
...
MS_BOOL HAL_MAD2_ReLoadCode(MS_U8 u8Type)
{
    ...
    if(HAL_AUDIO_GetDsp2CodeType() == u8Type)           // if type is the same, don't reload again
    {
...
////////////////////////////////////////////////////////////////////////////////
void HAL_MAD2_XPCM_setParam (XPCM_TYPE audioType, MS_U8  channels, MS_U32 sampleRate,
                                                    MS_U8  bitsPerSample, MS_U16 blockSize, MS_U16 samplePerBlock)
{
    HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_XPCM_TYPE, AU_DEC_ID3, audioType, 0 );
    HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_XPCM_CHANNELS, AU_DEC_ID3, channels, 0 );
    HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_XPCM_SAMPLERATES, AU_DEC_ID3, sampleRate, 0 );
    HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_XPCM_BITS_PER_SAMPLE, AU_DEC_ID3, bitsPerSample, 0 );
    HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_XPCM_BLOCK_SIZE, AU_DEC_ID3, blockSize, 0 );
    HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_XPCM_SAMPLE_PER_BLOCK, AU_DEC_ID3, samplePerBlock, 0 );
