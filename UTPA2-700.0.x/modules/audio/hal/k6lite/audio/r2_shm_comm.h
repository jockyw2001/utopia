...
typedef struct
{
    ...
    MS_U32  MPEG_Header;
    //MS_U32  gain;
    MS_U32  MPEG_ddenc_enable;
    MS_U32  MPEG_INFO_Reserved[4];    //reserved for new items
} AUR2_MPEG_INFO;
...
typedef struct
{
    ...
    MS_U32 chunk_PTS_L;
    MS_U32 ADEC_INFO_SHM_Reserved[10];    //reserved for new items
...
typedef struct
{
    ...
    MS_U32     TTS_On_flag;	// force_encode_flag for ms12
