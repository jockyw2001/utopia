...
***********************************************************/
    ...
    #define R2_DECODER_EN                           (1)
        #define R2_DECODER1_FORCE_MCH_OUTPUT        (0)
        #define R2_DECODER1_FORCE_2CH_OUTPUT        (1)
        #define R2_DECODER2_FORCE_MCH_OUTPUT        (0)
        #define R2_DECODER2_FORCE_2CH_OUTPUT        (1)
#ifdef __aeon__
        #define R2_DECODER1_OUTPUT_BY_DSP           (0)
        #define R2_DECODER2_OUTPUT_BY_DSP           (1)
#else
        #define R2_DECODER1_OUTPUT_BY_DSP           (0)
...
#define SND_R2_SUPPORT_DDENC            0
#define SND_DSP_SUPPORT_DDENC           1
#define SND_DSP_SUPPORT_DDPENC          1
#define SND_R2_SUPPORT_DDPENC           0
#define SND_DSP_SUPPORT_DPDENC          1
#define SND_R2_SUPPORT_DTSENC           0
#define SND_DSP_SUPPORT_DTSENC          0
...
***********************************************************/
    ...
    /* DECODER DDR */
        ...
        #define PCMR_EVO_BUF             (OFFSET_R2_TO_COMM_DDR + OFFSET_DDPENC_METADATA_DRAM_ADDR)
        #define PCMR_EVO_SIZE            DDPENC_METADATA_DRAM_SIZE
    /* sound effect related DDR */
        #define DEC1_METADATA1_BUF       (OFFSET_R2_TO_COMM_DDR + OFFSET_DEC1_METADATA1_DRAM_ADDR)
        #define DEC1_METADATA2_BUF       (OFFSET_R2_TO_COMM_DDR + OFFSET_DEC1_METADATA2_DRAM_ADDR)
        #define DEC1_METADATA3_BUF       (OFFSET_R2_TO_COMM_DDR + OFFSET_DEC1_METADATA3_DRAM_ADDR)

        #define DEC2_METADATA1_BUF       (OFFSET_R2_TO_COMM_DDR + OFFSET_DEC2_METADATA1_DRAM_ADDR)
        #define DEC2_METADATA2_BUF       (OFFSET_R2_TO_COMM_DDR + OFFSET_DEC2_METADATA2_DRAM_ADDR)
        #define DEC2_METADATA3_BUF       (OFFSET_R2_TO_COMM_DDR + OFFSET_DEC2_METADATA3_DRAM_ADDR)
    ...
    /* MISC */
        #define BUF_DDENC_MCH_ADDR      (OFFSET_R2_TO_COMM_DDR + OFFSET_SEDSP_DDPENC_MCHOUT_DRAM_ADDR)
        #define BUF_DDENC_MCH_SIZE      SEDSP_DDPENC_MCHOUT_DRAM_SIZE
...
***********************************************************/
    ...
    #define SYS_DEC1_FREEPLAY_PCM_LEVEL                 800*48                                     // 800ms (should small than "SYS_DEC_STOP_DECODE_PCM_LEVEL")
...
/******************* MCU <--> DEC-R2 *******************/
    /* MCU -> DEC-R2 */
        ...
        #define MBOX_WORD_R2_CTRL               MBOX_M2D_0388
            #define PCMR_MCU_CTRL_BIT           _BIT_1_
            #define PCMR_MD_INDEX_BIT           2
        ...
        #define MBOX_BYTE_DV258_SEL             MBOX_M2D_0392
    ...
    #define MBPX_D2A_MS12                       ((unsigned int)(&g_d2a_ms12_reg))
...
/* dec R2 <--> snd R2 */
    ...
    /* SND-DSP -> snd R2 */
        ...
        #define MBOX_S2D_PCM2_DRAM_RDPTR            MBOX_S2D_IO_5
	...
	/*SND DSP -> PRE_SOUND_PROCESS*/
        #define MBOX_S2D_DSPWORD_PCMIN_WRPTR	    MBOX_S2D_IO_C
        #define MBOX_S2D_DSPWORD_PCMIN2_WRPTR	    MBOX_S2D_IO_D
...
*/
        ...
        #define MBOX_D2S_DDENC_OUTMCH_WRPTR      MBOX_D2S_IO_D

        #define MBOX_D2S_R2_TO_DSP_ENCODE        MBOX_D2S_IO_E
	        /* MBOX_D2S_DSP_CTRL_BYTE for ms11/12 */
            #define D2S_DDENC_ENABLE                _BIT_10_
            #define D2S_MIXER_DISABLE               _BIT_11_
        ...
        #define MBOX_D2S_DSPWORD_PCMOUT_WRPTR	 MBOX_D2S_IO_F
