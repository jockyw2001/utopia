...
*   Version Control
*********************************************************/
#define  system_version_num              0x000B5E
...
*********************************************************/
    ...
    /* DSP Audio Delay Setting */
        ...
        #define HDMI_DELAY_UPPER_BOUND              ((SE_HDMI_DLY_DRAM_SIZE/HDMI_DELAY_STORE_CHANNELS)/DMA16BIT_BYTES_IN_WORDS/HDMI_DELAY_FS) //unit : ms
...
************************************************/
    ...
    /* SND DSP DM vars */
        ...
        /* common */
            ...
            #define DSP2XboxAddr_sinetone_StartFreq_Addr         (DSP2XboxAddr_IO_Info2 + 0x003F)   // len 1
            #define DSP2XboxAddr_sinetone_EndFreq_Addr           (DSP2XboxAddr_IO_Info2 + 0x0040)   // len 1
            #define DSP2XboxAddr_sinetone_SweepStep_Addr         (DSP2XboxAddr_IO_Info2 + 0x0041)   // len 1
            #define DSP2XboxAddr_sinetone_Duration_Addr          (DSP2XboxAddr_IO_Info2 + 0x0042)   // len 1
...
*************************************************/
    ...
    ************************************************/
    ...
    #define D2S_MBOX_DDP_PCM_WRPTR                  DECR2M_2_DSP_MAILBOXD       //單位: miu line, range: 0 ~ 0x1200 (SEDSP_DDPENC_MCHOUT_DRAM_SIZE)
    //#define D2S_MBOX_DDP_PCM_WRPTR                  ddpe_pcm_dram_wrPtr         //單位: miu line, range: 0 ~ 0x1200 (SEDSP_DDPENC_MCHOUT_DRAM_SIZE)
    #define S2D_MBOX_DDP_PCM_RDPTR                  ddpe_pcm_dram_rdPtr         //單位: miu line, range: 0 ~ 0x1200 (SEDSP_DDPENC_MCHOUT_DRAM_SIZE)


    #define S2D_MBOX_DDP_RAW_HDMI_WRPTR             ddpe_hdmi_npcmWrAddr        //單位: miu line, range: 0 ~ 0xD800 (HDMI_NONPCM_DRAM_SIZE)
    #define S2D_MBOX_DDP_RAW_SPDIF_WRPTR            ddpe_spdif_npcmWrAddr       //單位: miu line, range: 0 ~ 0x3600 (SPDIF_NONPCM_DRAM_SIZE)
...
*************************************************/
    ...
    /* HE-AAC Metadata Buffer on DEC */
        .const DSP2_HEAAC_METADATA_DRAM_BASE        = (OFFSET_HEAAC_METADATA_DRAM_ADDR / BYTES_IN_MIU_LINE);
        .const DSP2_HEAAC_METADATA_DRAM_SIZE        = (HEAAC_METADATA_DRAM_SIZE / BYTES_IN_MIU_LINE);        // 8KB
    ...
    /* DSP DM Prefetch */
        #define DSP2_DM_PREFETCH_DRAM_BASE          (OFFSET_DM_PREFETCH_DRAM_ADDR / BYTES_IN_MIU_LINE) //For MS10-DDE/MS12-DDPE
...
********************************************************************/
    ...
    /* PCM output port */
        ...
        #define R2_PCM2_DMX__L_OUT              DEC3_PCM1_OUT       // channel mapping of PCM buffer, replace R2_DMA_READER2 (R2_DECODER2_OUTPUT_BY_DSP)
