...
void HAL_MAD2_RebootDsp(void)
{
    ...
    R2dec1cmd_status = HAL_MAD_GetDecCmd(DVB_Audio_Decoder1);
    R2dec2cmd_status = HAL_MAD_GetDecCmd(DVB_Audio_Decoder2);
    ...
    HAL_MAD2_SetDecCmd(((MS_U16)dspcmd_status)+0x100);
