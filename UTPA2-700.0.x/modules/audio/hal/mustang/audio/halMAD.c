...
static MS_U32 prv_PTS[MAX_ADEC], accum_ES[MAX_ADEC], prv_accum_ES[MAX_ADEC];
...
MS_BOOL HAL_MAD_MM2_inputAesFinished( AUDIO_DEC_ID dec_id, MS_U32 es_size, MS_BOOL ptsExist, MS_U64 pts )
{
    ...
    {
        printf("==> Error, ADEC%X input AES size(0x%08u) is larger than current Free space(0x%08u)\r\n", adec_id, (unsigned int)es_size, (unsigned int)(p_decEsInfo->aes_freeSpace) );
        return FALSE;
    }
        ...
        case E_AUDIO_INFO_GAME_IN:
        {
            ...
            switch(u8MainDspCodeType)
            {
                ...
                case AU_DVB_STANDARD_AAC:
                {
                    ...
                    HAL_MAD_GetAudioInfo2(MainDecId , Audio_infoType_SPDIF_info_flag, (void *)&u32spdif_info_flag);
...
MS_U32 HAL_MAD_GetAACInfo( Audio_AAC_infoType infoType )
{
    ...
    u8MainDspCodeType = g_AudioVars2->g_u8DecR2Adec1DecType;
...
MS_BOOL HAL_MAD_SetAudioParam2( AUDIO_DEC_ID DecId, Audio_ParamType paramType, MS_U32 Param )
{
    ...
    switch ( paramType )
    {
        ...
        case Audio_ParamType_FreeDecoder:
            ...
            if ( g_AudioVars2->AudioDecStatus[DecId].bConnect == TRUE )
            {
                    ...
                    (g_AudioVars2->AudioDecStatus[DecId].eSourceType == E_AUDIO_INFO_GAME_IN))
                {
                    ...
                    if ( DecId == AU_DEC_ID1 )
                    {
                        g_AudioVars2->g_u8DecR2Adec1DecType = AU_DVB_NONE;
                    }
                    else if ( DecId == AU_DEC_ID3 )
                    {
                        g_AudioVars2->g_u8DecR2Adec2DecType = AU_DVB_NONE;
                    }
                }
                else
                {
        ...
        case Audio_ParamType_SE_Set_I2S_OutNumber:
        {
            if(Param < 5)
            {
        ...
        case Audio_ParamType_SE_Set_HP_Delay:
        {
            HAL_SOUND_SetCH5AudioDelay((MS_U16)Param);
        }
        break;

        case Audio_ParamType_SE_Set_ADEC0_Input_delay:
        {
            HAL_SOUND_SetCH5AudioDelay((MS_U16)Param);
        }
        break;

        case Audio_ParamType_SE_Set_ADEC1_Input_delay:
        {
            HAL_SOUND_SetCH5AudioDelay((MS_U16)Param);
        }
        break;

        case Audio_ParamType_R2_Set_NonPcm_Sel:
        {
...
MS_BOOL HAL_MAD_GetAudioInfo2( AUDIO_DEC_ID DecId, Audio_InfoType infoType, void * pInfo )
{
    ...
    switch ( infoType )
    {
        ...
        case Audio_infoType_Dec_Channel_Mode:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
            if(adec_id == ADEC1)
            {
        ...
        case Audio_infoType_DRA_Channel_Mapping: // This is for DRA use only
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_DOLBY_BS_Mode:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_DOLBY_AAC_type:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_DTS_CD_Mode:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_DTS_PCM_Frame_Size:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_DTS_ES_Type:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_SPDIF_info_flag:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
            *pRet = HAL_DEC_R2_Get_SHM_INFO(R2_SHM_INFO_TRANSCODE_FLAG, adec_id);
        }
        break;

        case Audio_infoType_MPEG_Layer:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_MPEG_Stereo_Mode:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_MPEG_Header:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_SE_Decoder_Delay:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
            if ( DecId == AU_DEC_ID3 )
            {
        ...
        case Audio_infoType_SE_HpOut_Delay:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
        ...
        case Audio_infoType_R2_Dec_Type:
        {
            MS_U32 * pRet = (MS_U32 *) pInfo;
            if ( DecId == AU_DEC_ID3 )
            {
