...
void HAL_DEC_R2_init_SHM_param( void )
{
    ...
    for (dec_id = 0; dec_id < MAX_ADEC; dec_id++ )
    {
        ...
        //MsOS_Dcache_Flush((MS_U32) &(p_shm_param->bootMagicID), sizeof(MS_U32));
        //if (p_shm_param->bootMagicID != SHM_PARAM_BOOT_MAGIC_ID)
        {
            ...
            HALAUR2_ERROR("[======= initialize DEC-R2[%d] SHM =======]\n", (int)dec_id);
        }
    }

    MsOS_Dcache_Flush((MS_U32)p_shm, sizeof(DEC_R2_SHARE_MEM));
...
MS_U32 HAL_DEC_R2_Get_SHM_INFO(R2_SHM_INFO_TYPE decInfoType, MS_U8 dec_id )
{
    ...
    //D-cache Invalidate
    MsOS_Dcache_Flush((MS_U32)p_shm_info, sizeof(AUR2_ADEC_INFO_SHM));
    MsOS_Dcache_Flush((MS_U32)p_shm_esinfo, sizeof(AUR2_ADEC_ES_INFO_SHM));
    ret_value = *ptr;
...
MS_BOOL HAL_DEC_R2_Set_SHM_PARAM(R2_SHM_PARAM_TYPE decParamType, MS_U8 dec_id, MS_U32 param, MS_U32 param2 )
{
    ...
    switch( decParamType )
    {
        ...
        case R2_SHM_PARAM_EXT_SMPRATE_CTRL:
                ptr = (volatile MS_U32 *) &p_shm_param->extSynthsizer_en;      *ptr = param;   MsOS_Dcache_Flush((MS_U32)ptr,4);
                ptr = (volatile MS_U32 *) &p_shm_param->extSynthsizer_value;   *ptr = param2;  MsOS_Dcache_Flush((MS_U32)ptr,4);
                break;

        case R2_SHM_PARAM_MPG_AVOFFSET:     ptr = (volatile MS_U32 *) &p_shm_param->dtv_mpg_avDelay;     *ptr = param;   MsOS_Dcache_Flush((MS_U32)ptr,4);    break;
        case R2_SHM_PARAM_AC3_AVOFFSET:     ptr = (volatile MS_U32 *) &p_shm_param->dtv_ac3_avDelay;     *ptr = param;   MsOS_Dcache_Flush((MS_U32)ptr,4);    break;
        case R2_SHM_PARAM_AAC_AVOFFSET:     ptr = (volatile MS_U32 *) &p_shm_param->dtv_aac_avDelay;     *ptr = param;   MsOS_Dcache_Flush((MS_U32)ptr,4);    break;
        case R2_SHM_PARAM_MM_FILE_REQ_SIZE: ptr = (volatile MS_U32 *) &p_shm_param->mmFileReqSize;       *ptr = param;   MsOS_Dcache_Flush((MS_U32)ptr,4);    break;
        ...
        case R2_SHM_PARAM_UNI_SETUP_DECODE_FRMCNT:  ptr = (volatile MS_U32 *) &p_shm_param->mmUni_needDecodeFrmCnt;   *ptr = param; MsOS_Dcache_Flush((MS_U32)ptr,4);  break;
        ...
        case R2_SHM_PARAM_DOLBY_DMX_MODE:   ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.dmxMode;      *ptr = param;   MsOS_Dcache_Flush((MS_U32)ptr,4);    break;
        case R2_SHM_PARAM_DOLBY_HIGH_CUT:   ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.high_cut;     *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_DOLBY_LOW_BOOST:  ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.low_boost;    *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_DOLBY_GAIN:       ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.gain;         *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_DOLBY_MUL_FRAME_HEADER: ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.mul_frame_header; *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_DOLBY_AAC_BYPASS:       ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.AAC_HDMI_bypass;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_DOLBY_DDP_HDMI_BYPASS:   ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.DDP_HDMI_bypass;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_DOLBY_TB11_ENABLE:      ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.TB11_enable;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        ...
        case R2_SHM_PARAM_MPEG_SOUNDMODE:        ptr = (volatile MS_U32 *) &p_shm_param->mpeg_param.MPEG_soundMode;     *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_MPEG_GAIN:             ptr = (volatile MS_U32 *) &p_shm_param->mpeg_param.gain;               *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_OMX_SPDIF_CTRL:        ptr = (volatile MS_U32 *) &p_shm_param->OMX_SPDIF_Ctrl;                *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_OMX_SPDIF_PCM_LEVEL:   ptr = (volatile MS_U32 *) &p_shm_param->OMX_SPDIF_PCM_Level;           *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;


        case R2_SHM_PARAM_MAIN_VOLUME:           ptr = (volatile MS_U32 *) &p_shm_param->adMix_mainVol;                 *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_MAIN_VOLUME_MUTE:
                ...
                *ptr &= 0x000003FF;
                MsOS_Dcache_Flush((MS_U32)ptr,4);
                break;
        case R2_SHM_PARAM_AD_VOLUME:   ptr = (volatile MS_U32 *) &p_shm_param->adMix_asocVol;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        ...
        case R2_SHM_PARAM_COOK_NUMCODECS:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.mNumCodecs;        *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_COOK_SAMPLES:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.mSamples;          *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_COOK_SAMPLERATES:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.mSampleRate;       *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_COOK_CHANNELS:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.Channels[param2];  *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_COOK_REGIONS:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.Regions[param2];   *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_COOK_CPLSTART:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.cplStart[param2];   *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_COOK_CPLQBITS:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.cplQbits[param2];   *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_COOK_FRAMESIZE:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.FrameSize[param2];  *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_DTS_DMX_LFE_ENABLE:
            ptr = (volatile MS_U32 *) &p_shm_param->dts_param.dmxLfeEnable;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_DTS_DMX_MODE:
            ptr = (volatile MS_U32 *) &p_shm_param->dts_param.dmxMode;           *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_DTS_HD_HDMI_BYPASS:
            ptr = (volatile MS_U32 *) &p_shm_param->dts_param.DTSHD_HDMI_bypass;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_ASF_VERSION:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.asf_version;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_CHANNELS:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.nChannels;        *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_SAMPLERATE:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.smpRate;          *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_BYTERATE:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.byteRate;         *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_BLOCKALIGN:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.blockAlign;       *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_ENCOPT:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.encOpt;           *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_PARSINGBYAPP:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.parsingByApp;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_BITS_PER_SAMPLE:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.bitsPerSmp;        *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_CHANNELMASK:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.channelMask;       *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_DRC_PARAM_EXIST:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.drcParamExist;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_DRC_RMS_AMP_REF:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.drcRmsAmpRef;       *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_DRC_RMS_AMP_TARGET:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.drcRmsAmpTarget;    *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_DRC_PEAK_AMP_REF:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.drcPeakAmpRef;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_DRC_PEAK_AMP_TARGET:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.drcPeakAmpTarget;    *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_ASF_MAX_PACKET_SIZE:
            ptr = (volatile MS_U32 *) &p_shm_param->asf_param.maxPacketSize;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_XPCM_TYPE:
            ptr = (volatile MS_U32 *) &p_shm_param->xpcm_param.xPcmType;         *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_XPCM_CHANNELS:
            ptr = (volatile MS_U32 *) &p_shm_param->xpcm_param.nChannels;        *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_XPCM_SAMPLERATES:
            ptr = (volatile MS_U32 *) &p_shm_param->xpcm_param.smpRate;          *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_XPCM_BITS_PER_SAMPLE:
            ptr = (volatile MS_U32 *) &p_shm_param->xpcm_param.bitsPerSmp;        *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_XPCM_BLOCK_SIZE:
            ptr = (volatile MS_U32 *) &p_shm_param->xpcm_param.blockSize;         *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;
        case R2_SHM_PARAM_XPCM_SAMPLE_PER_BLOCK:
            ptr = (volatile MS_U32 *) &p_shm_param->xpcm_param.samplePerBlock;    *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_SPDIF_TYPE:
            ptr = (volatile MS_U32 *) &p_shm_param->spdif_type;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_RFSIGNAL_TYPE:
            ptr = (volatile MS_U32 *) &p_shm->RfSignalType;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_VORBIS_HEADER_SIZE:
            ptr = (volatile MS_U32 *) &p_shm_param->vorbis_header_size;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_TTS_EN:
            ptr = (volatile MS_U32 *) &p_shm_param->TTS_On_flag;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_DAP_EN:
            ptr = (volatile MS_U32 *) &p_shm_param->DAP_enable;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_SPEAKER_EN:
            ptr = (volatile MS_U32 *) &p_shm_param->speaker_enable;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_DDP_ENCODE_EN:
            ptr = (volatile MS_U32 *) &p_shm_param->DDP_encode_enable;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_ES_Limiter_EN:
            ptr = (volatile MS_U32 *) &p_shm_param->ES_Limiter_EN;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_ES_Limiter_Threshold:
            ptr = (volatile MS_U32 *) &p_shm_param->ES_Limiter_Threshold;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_PCM_Limiter_EN:
            ptr = (volatile MS_U32 *) &p_shm_param->PCM_Limiter_EN;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_PCM_Limiter_Threshold:
            ptr = (volatile MS_U32 *) &p_shm_param->PCM_Limiter_Threshold;      *ptr = param;  MsOS_Dcache_Flush((MS_U32)ptr,4);     break;

        case R2_SHM_PARAM_MULTI_CHANNEL:
            ptr = (volatile MS_U32 *) &p_shm_param->force_mmuni_mch_pcm;    *ptr = param;    MsOS_Dcache_Flush((MS_U32)ptr,4);    break;
...
MS_U32 HAL_DEC_R2_Get_SHM_PARAM(R2_SHM_PARAM_TYPE decParamType, MS_U8 dec_id, MS_U32 param )
{
    ...
    switch( decParamType )
    {
        case R2_SHM_PARAM_ES_WR_PTR:
                if (dec_id == 0)
                    {
                ptr = (volatile MS_U32 *) &p_shm_esparam->ES_wrPtr;    MsOS_Dcache_Flush((MS_U32)ptr, 4);
                ret_value = *ptr;
                    }
                else if (dec_id == 1)
                    {
        ...
        case R2_SHM_PARAM_MPG_AVOFFSET:     ptr = (volatile MS_U32 *) &p_shm_param->dtv_mpg_avDelay;     MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_AC3_AVOFFSET:     ptr = (volatile MS_U32 *) &p_shm_param->dtv_ac3_avDelay;     MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_AAC_AVOFFSET:     ptr = (volatile MS_U32 *) &p_shm_param->dtv_aac_avDelay;     MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_MM_FILE_REQ_SIZE: ptr = (volatile MS_U32 *) &p_shm_param->mmFileReqSize;       MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_MM_INPUT_PTS:     ptr = (volatile MS_U32 *) &p_shm_esparam->MM_inputPTS;       MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        ...
        case R2_SHM_PARAM_DOLBY_DMX_MODE:   ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.dmxMode;      MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_DOLBY_HIGH_CUT:   ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.high_cut;     MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_DOLBY_LOW_BOOST:  ptr = (volatile MS_U32 *) &p_shm_param->dolby_param.low_boost;    MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;

        case R2_SHM_PARAM_UNI_SETUP_DECODE_FRMCNT:  ptr = (volatile MS_U32 *) &p_shm_param->mmUni_needDecodeFrmCnt;      MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;

        case R2_SHM_PARAM_OMX_SPDIF_CTRL:
                ptr = (volatile MS_U32 *) &p_shm_param->OMX_SPDIF_Ctrl;      MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;

        case R2_SHM_PARAM_PARSER_SPEC:       //[8]
                ptr = (volatile MS_U32 *) &p_shm_param->decCtrl; MsOS_Dcache_Flush((MS_U32)ptr, 4);
                ret_value = *ptr;
                if (ret_value&0x100)
                    ret_value = 1;
                else
      ...
      case R2_SHM_PARAM_COOK_NUMCODECS:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.mNumCodecs;        MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_COOK_SAMPLES:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.mSamples;          MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_COOK_SAMPLERATES:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.mSampleRate;       MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_COOK_CHANNELS:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.Channels[param];   MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_COOK_REGIONS:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.Regions[param];    MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_COOK_CPLSTART:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.cplStart[param];   MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_COOK_CPLQBITS:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.cplQbits[param];   MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_COOK_FRAMESIZE:
            ptr = (volatile MS_U32 *) &p_shm_param->cook_param.FrameSize[param];  MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
        case R2_SHM_PARAM_HASH_KEY:
            ptr = (volatile MS_U32 *) &p_shm_param->hashKey;                      MsOS_Dcache_Flush((MS_U32)ptr, 4);  ret_value = *ptr;       break;
