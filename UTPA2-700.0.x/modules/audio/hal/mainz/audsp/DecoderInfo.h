...
//===========================================================================
    ...
    #define    DSP_SUPPORT_BONGIOVIDPS         1
#else //Mboot mode
    ...
    #define    DSP_SUPPORT_DDE                 0
    #define    DSP_SUPPORT_BONGIOVIDPS         0
#endif
...
#endif
#if(DSP_SUPPORT_BONGIOVIDPS)
    #include    "dspcode_s/aucode_dps.c"
#endif
//===========================================================
...
#endif
#ifndef    MST_CODEC_DPS_PM1_ADDR
    #define    MST_CODEC_DPS_PM1_ADDR               0
    #define    MST_CODEC_DPS_PM1_SIZE               0
    #define    mst_codec_dps_pm1                    0
#endif
#ifndef    MST_CODEC_DPS_PM2_ADDR
    #define    MST_CODEC_DPS_PM2_ADDR               0
    #define    MST_CODEC_DPS_PM2_SIZE               0
    #define    mst_codec_dps_pm2                    0
#endif
#ifndef    MST_CODEC_DPS_PM3_ADDR
    #define    MST_CODEC_DPS_PM3_ADDR               0
    #define    MST_CODEC_DPS_PM3_SIZE               0
    #define    mst_codec_dps_pm3                    0
#endif
#ifndef    MST_CODEC_DPS_PM4_ADDR
    #define    MST_CODEC_DPS_PM4_ADDR               0
    #define    MST_CODEC_DPS_PM4_SIZE               0
    #define    mst_codec_dps_pm4                    0
#endif
...
//==============================================
AUDIO_ALG_INFO    BONGIOVIDPS_LoadCodeTable[ ]=
{        {
        MST_CODEC_DPS_PM1_ADDR, MST_CODEC_DPS_PM1_SIZE, mst_codec_dps_pm1,
        MST_CODEC_DPS_PM2_ADDR, MST_CODEC_DPS_PM2_SIZE, mst_codec_dps_pm2,
        MST_CODEC_DPS_PM3_ADDR, MST_CODEC_DPS_PM3_SIZE, mst_codec_dps_pm3,
        MST_CODEC_DPS_PM4_ADDR, MST_CODEC_DPS_PM4_SIZE, mst_codec_dps_pm4,
        "BONGIOVI DPS",},
};
//==============================================
