...
{
//Kano: 100BH	1	0	0	0	0	0	0	0	0	clkgen0	0	clkgen0
    return (0x00B00 * 2);
}

MS_U32 hal_gpd_get_clkoffset()
{
//Kano: h003e	h003e	4	0	reg_ckg_gpd
    return (0x7c << 1);
}

void hal_gpd_reg_base(MS_U32* u32RIUBase, MS_U32* u32XIUBase)
{
//Kano: 110EH	1	0	0	0	0	0	0	0	0	gpd0
//Kano: 110FH	1	0	0	0	0	0	0	0	0	gpd1
...
{
// Kano: group2, bit [b]
// Kano: h007a	h007a	15	0	reg_miu_sel2
    *u8Offset = 0xf4;
    *u16BitMask = 0x800;
}
...
{
    MS_U32 tmp = 0;
// Kano:        GPD i64, Bank 0x101e, Offset 0x42, Bit [11]
...
{
    MS_U32 tmp = 0;
// Kano: h0043	h0043	15	0	reg_rq2_mask
