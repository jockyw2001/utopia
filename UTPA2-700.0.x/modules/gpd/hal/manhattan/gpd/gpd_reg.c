...
{
    // manhattan: h0028	h0028	4	0	reg_ckg_gpd
    return (0x50 << 1);
}

void hal_gpd_reg_base(MS_U32* u32RIUBase, MS_U32* u32XIUBase)
{
    // manhattan: 113Eh, 113Fh
...
{
    // manhattan: group2, bit 6==> //h007a	h007a	15	0	reg_miu_sel2
    // 0x7a << 1 = 0xf4
    *u8Offset = 0xf4;
    *u16BitMask = 0x40;
}
...
{
    MS_U32 tmp = 0;
    // manhattan: group2, bit 6==> //h0022	h0022	15	0	reg_miu_group2_i64
...
{
    MS_U32 tmp = 0;
    // manhattan: h0043	h0043	15	0	reg_rq2_mask
