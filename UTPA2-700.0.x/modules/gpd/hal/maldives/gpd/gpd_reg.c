...
{
    unsigned int tmp = 0;
    tmp = *((volatile U32 *)(BankBaseAddr + 0x1E00*2 + 0x23*2*2));
    tmp |= 0x2000;
    console_printf("set i64 reg to 0x%x\n", tmp);
    *((volatile U32 *)(BankBaseAddr + 0x1E00*2 + 0x23*2*2)) = tmp;
...
{
    unsigned int tmp = 0;
    tmp = *((volatile U32 *)(BankBaseAddr + 0x1200*2 + 0x43*2*2));
    if(bEnable==TRUE)
    {
        tmp |= 0x40;
    }
    ...
    *((volatile U32 *)(BankBaseAddr + 0x1200*2 + 0x43*2*2)) = tmp;

    tmp = *((volatile U32 *)(BankBaseAddr + 0x0600*2 + 0x43*2*2));
    if(bEnable==TRUE)
    {
        tmp |= 0x40;
    }
    ...
    *((volatile U32 *)(BankBaseAddr + 0x0600*2 + 0x43*2*2)) = tmp;
