...
{
//k6lite: 100BH	1	0	0	0	0	0	0	0	0	clkgen0	0	clkgen0
    return (0x00B00 * 2);
}

MS_U32 hal_gpd_get_clkoffset()
{
//k6lite: h003e	h003e	4	0	reg_ckg_gpd
    return (0x7c << 1);
}

void hal_gpd_reg_base(MS_U32* u32RIUBase, MS_U32* u32XIUBase)
{
//k6lite: 110EH	1	0	0	0	0	0	0	0	0	gpd0
//k6lite: 110FH	1	0	0	0	0	0	0	0	0	gpd1
...
{
// k6lite: group2, bit [b]
// k6lite: h007a	h007a	15	0	reg_miu_sel2
    *u8Offset = 0xf4;
    *u16BitMask = 0x800;
}
...
{
    MS_U32 tmp = 0;
// k6lite:        GPD i64, Bank 0x101e, Offset 0x42, Bit [11]
...
// reference to k6lite_register_assignment.xls
//1712H	0	1	1	1	1	0	0	0	0	codec_block	0	codec_gp
// reference to k6lite_block_top_reg.xls
...
#ifdef CONFIG_MSTAR_SRAMPD
// reference to 00_k6lite_register_assignment.xls
//1712H	0	1	1	1	1	0	0	0	0	codec_block	0	codec_gp
// reference to k6lite_block_top_reg.xls
// h11	h10	31	0	reg_codec_sram_sd_en	31	0	32	h00	rw
// bit [5] : gpd
...
{
    MS_U32 tmp = 0;
// k6lite: h0043	h0043	15	0	reg_rq2_mask
