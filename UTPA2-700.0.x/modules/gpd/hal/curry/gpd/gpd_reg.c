...
{
//Curry: 100BH	1	0	0	0	0	0	0	0	0	clkgen0	0	clkgen0
    return (0x00B00 * 2);
}

MS_U32 hal_gpd_get_clkoffset()
{
//Curry: h003e	h003e	4	0	reg_ckg_gpd
    return (0x7c << 1);
}

void hal_gpd_reg_base(MS_U32* u32RIUBase, MS_U32* u32XIUBase)
{
//Curry: 110EH	1	0	0	0	0	0	0	0	0	gpd0
//Curry: 110FH	1	0	0	0	0	0	0	0	0	gpd1
...
{
// Curry: group2, bit [b]
// Curry: h007a	h007a	15	0	reg_miu_sel2
    *u8Offset = 0xf4;
    *u16BitMask = 0x800;
}
...
{
    MS_U32 tmp = 0;
// Curry:        GPD i64, Bank 0x101e, Offset 0x42, Bit [11]
...
// reference to 00_curry_register_assignment.xls
//1712H	0	1	1	1	1	0	0	0	0	codec_block	0	codec_gp
// reference to curry_block_top_reg.xls
...
#if 0       // GPD MCM test code
//    printf("MCM 0x30\n");
//    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x0030;

//    printf("MCM 0x00\n");
//    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x0000;
//    printf("MCM 0xf0\n");
//    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x00f0;

//    printf("MCM 0xf2\n"); // 1/16 fail
//    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x00f2;

//    printf("MCM 0x72\n"); // 1/8 fail
//    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x0072;

//    printf("MCM 0x12\n");   // 1/2 ok
//    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x0012;

//    printf("MCM 0x32\n");   // 1/4 png ok
//    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x0032;

    printf("MCM 0x52\n");   // 1/6 fail
    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x0052;

//    printf("MCM 0x42\n");   // 1/5 ok
//    *((volatile MS_U32 *)(MS_VIRT)(BankBaseAddr + 0x71200*2 + 0x0a*2*2)) = 0x0042;
#endif
...
{
    MS_U32 tmp = 0;
// Curry: h0043	h0043	15	0	reg_rq2_mask
