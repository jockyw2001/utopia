...
{
    // maxim: h0028	h0028	4	0	reg_ckg_gpd
    return (0x50 << 1);
}
...
{
    // maxim: group2, bit 6==> //h007a	h007a	15	0	reg_miu_sel2
    // 0x7a << 1 = 0xf4
    *u8Offset = 0xf4;
    *u16BitMask = 0x40;
}
...
{
    MS_U32 tmp = 0;
    // maxim: group2, bit 6==> //h0022	h0022	15	0	reg_miu_group2_i64
...
{
    MS_U32 tmp = 0;
    // maxim: h0043	h0043	15	0	reg_rq2_mask
