...
typedef struct _CMD_DmaFormat0
{
  ...
  //jamietest  MS_U32          Decrypt:1;
    ...
    MS_U32          Algo:4;
        ...
        #define     CMD_DMA_ALGO_RC4                0x8UL
        #define     CMD_DMA_ALGO_RC4_128            0x9UL
        #define     CMD_DMA_ALGO_SM4                0xAUL
    ...
    MS_U32          KeySel:4; //jamietest KeySel:3
        ...
        // bit [2:0]
        #define     CMD_DMA_KSEL_SK                 0x0UL //key from 64-keyslot sram
        #define     CMD_DMA_KSEL_SCS_AUTH_KEY       0x1UL //SCS_Auth_key
        #define     CMD_DMA_KSEL_SCS_AUX_KEY        0x2UL //SCS_Aux_key
        #define     CMD_DMA_KSEL_SCS_IMG_KEY        0x3UL //SCS_IMG_key
        #define     CMD_DMA_KSEL_MK0                0x4UL //master key0 (OTPC shadow reg)
        #define     CMD_DMA_KSEL_MK1                0x5UL //master key1 (OTPC shadow reg)
        #define     CMD_DMA_KSEL_MK2                0x6UL //master key2 (OTPC shadow reg)
        #define     CMD_DMA_KSEL_STRN               0x7UL //DRAM signature nonce
    ...
    MS_U32          Aes_mode:2;
        #define     CMD_AES_MODE_128                 0x0UL
        #define     CMD_AES_MODE_256                 0x1UL
        #define     CMD_AES_MODE_192                 0x2UL
...
typedef struct _CMD_DmaFormat1
{
    ...
    MS_U32          Dest0:1;     // File output Dest0
    ...
    MS_U32          Dest1:1;     // [NOTE] if Dest1 = 0 ,Write output data to DRAM, Regfile or QMEM by setting; else output to SRAM of KL or internal key bank by Dest0
...
typedef struct _CMD_DmaFormat2
{
    ...
    MS_U32          Key_bank:1; //Set 1, the cipher key is from the internal key bank
...
typedef struct _CMD_DmaFormat3
{
    MS_U32          Aes_mode2:2;
        ...
        #define     CMD_AES_MODE_192                 0x2UL
    MS_U32          TLB_write:1;
        #define     CMD_WRITE_PHY_ADDRESS           0x0UL
        #define     CMD_WRITE_VIR_ADDRESS           0x1UL
    MS_U32          TLB_read:1;
        #define     CMD_READ_PHY_ADDRESS            0x0UL
        #define     CMD_READ_VIR_ADDRESS            0x1UL
    MS_U32          CRS:1;
    MS_U32          MP:1;
    MS_U32          DIV2:1;
    MS_U32          DK2:1;
  ...
  //jamietest  MS_U32          Decrypt:1;
    ...
    MS_U32          KeySel2:4; //jamietest KeySel:3
...
{
    MS_U32          HASH_Key_Index:6; //choose which key in the 64-keyslot sram
    MS_U32          IntM:1;
    ...
    MS_U32          HMAC_KeySel:4;
        ...
        #define     CMD_HMAC_KSEL_MK2                0x4UL
        #define     CMD_HMAC_KSEL_SK                 0x5UL
        #define     CMD_HMAC_KSEL_SCS_AUTH_KEY       0x6UL
        #define     CMD_HMAC_KSEL_SCS_AUX_KEY        0x7UL
        #define     CMD_HMAC_KSEL_SCS_IMG_KEY        0x8UL
        #define     CMD_HMAC_KSEL_INTERNAL_KEY_BANK  0x9UL
...
{
    MS_U32          Rsv:29;
    MS_U32          Hash_TLB_write:1;
        #define     CMD_WRITE_PHY_ADDRESS           0x0UL
        #define     CMD_WRITE_VIR_ADDRESS           0x1UL
    MS_U32          Hash_TLB_read:1;
        #define     CMD_READ_PHY_ADDRESS            0x0UL
        #define     CMD_READ_VIR_ADDRESS            0x1UL
    MS_U32          RR:1;
