...
#define REG_MIPS_OCC_CLK_BASE       0x21840UL //(0x10C00/2 + 0x10) * 4
...
typedef struct _REG_AESDMACtrl
{
    ...
    #define AESDMA_USE_SECRET_KEY               0x00001000UL
    ...
    #define AESDMA_ENG_SPEEDUP                  0x043E0000UL
...
//REG_MIPS_OCC_CLK_BASE
typedef REG_GENERAL_STRUCT REG_MIPSOCCCLKCtrl;                  //BANK: 0x1103
