...
{
    // 1. deal with module
    void* pModuleJPEG_V2 = NULL;
    UtopiaModuleCreate(MODULE_JPEG, 0, &pModuleJPEG_V2);
    UtopiaModuleRegister(pModuleJPEG_V2);
    ...
    UtopiaModuleSetupFunctionPtr(pModuleJPEG_V2,
    ...
    UtopiaModuleAddResourceStart(pModuleJPEG_V2, JPEG_POOL_ID_JPD);
    UtopiaResourceCreate("JPD", sizeof(JPEG_RESOURCE_PRIVATE), &psResource);
    UtopiaResourceRegister(pModuleJPEG_V2, psResource, JPEG_POOL_ID_JPD);
    UtopiaModuleAddResourceEnd(pModuleJPEG_V2, JPEG_POOL_ID_JPD);
...
MS_U32 JPEGOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute)
{
    ...
    void* pModuleJPEG_V2 = NULL;
    UtopiaModuleGetPtr(MODULE_JPEG,&pModuleJPEG_V2);
    // Check there is available decoder to be use
    if(UtopiaResourceObtain(pModuleJPEG_V2, JPEG_POOL_ID_JPD, &pResource) != UTOPIA_STATUS_SUCCESS)
    {
