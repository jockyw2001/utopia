...
#define REG_RTC_MATCH_VAL       (0x000AUL)    //BIT0-BIT31
#define REG_RTC_INT             (0x000EUL)
    #define RTC_RAW_INT_BIT         (0x0001UL)//BIT0
    #define RTC_INT_BIT             (0x0002UL)//BIT1
#define REG_RTC_CNT             (0x0010UL)    //BIT0-BIT31
