...
void HAL_RTC_Set_CW_Frequency(E_MS_RTC eRtc,MS_U32 u32Freq)
{
    HAL_RTC_Write4Byte(HAL_RTC_GET_BASE(eRtc)+REG_RTC_FREQ_CW, u32Freq);
}

void HAL_RTC_Set_Counter(E_MS_RTC eRtc,MS_U32 u32Val)
{
    HAL_RTC_Write4Byte(HAL_RTC_GET_BASE(eRtc)+REG_RTC_LOAD_VAL, u32Val);
    HAL_RTC_Write4Byte(HAL_RTC_GET_BASE(eRtc)+REG_RTC_LOAD_VAL_H32, 0);
}

void HAL_RTC_Match_Counter(E_MS_RTC eRtc,MS_U32 u32Val)
{
    HAL_RTC_Write4Byte(HAL_RTC_GET_BASE(eRtc)+REG_RTC_MATCH_VAL,  u32Val);
    HAL_RTC_Write4Byte(HAL_RTC_GET_BASE(eRtc)+REG_RTC_MATCH_VAL_H32,  0);
}

MS_U32 HAL_RTC_Get_Match_Counter(E_MS_RTC eRtc)
{
    return HAL_RTC_Read4Byte(HAL_RTC_GET_BASE(eRtc)+REG_RTC_MATCH_VAL);
}

void HAL_RTC_ClearCTRL(E_MS_RTC eRtc)
{
    HAL_RTC_Write2Byte(HAL_RTC_GET_BASE(eRtc)+REG_RTC_CTRL_REG,  0x0000);
}
...
void HAL_RTC_SetIOMapBase(MS_U32 u32Base)
{
    _gMIO_MapBase = u32Base;
}

MS_U32 HAL_RTC_GetIOMapBase(void)
{
