...
#define REG_RTC_LOAD_VAL_H32        (0x000A)    //BIT32-BIT63
#define REG_RTC_MATCH_VAL       (0x000E)    //BIT0-BIT31
#define REG_RTC_MATCH_VAL_H32       (0x0012)    //BIT32-BIT63
#define REG_RTC_INT             (0x0000)
    #define RTC_RAW_INT_BIT         (0x0100)//BIT8
    #define RTC_INT_BIT             (0x0200)//BIT9
#define REG_RTC_CNT             (0x0016)    //BIT0-BIT63

//pm sleep bank
#define REG_PMSLEEP_BASE       (0x0e00)
//pm sleep register
#define REG_PM_RTC_CLK             (0x0044)
