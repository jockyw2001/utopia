...
#define PM_REG_BASE                             0x0e00  //(0x0700*2)
#define PM_MSIC_REG_BASE                        0x2e00  //(0x1700*2)
#define PMSLEEP_REG_GPIO                        0x0f00  //(0x0780*2)
#define PMRTC_REG_BASE                          0x1200  //(0x0900*2)
#define PMRTC1_REG_BASE                         0x1300  //(0x0980*2)
...
#define REG_PM_CKG_RTC                          ((PM_REG_BASE + 0x22UL * 2))


#define REG_PM_DUMMY_ACTIVE_STANDBY             ((PM_REG_BASE + 0x38UL * 2))
#define REG_PM_DUMMY_POWERON_MODE               ((PM_REG_BASE + 0x38UL * 2 + 1))
#define REG_PM_DUMMY_WAKEUP_SOURCE              ((PM_REG_BASE + 0x39UL * 2))
...
//-----------------------------------------------------------------------------
//                                              bank, regiter
#define REG_PM_CHIP_CFG_OVERWRITE               ((PM_MSIC_REG_BASE + 0x1FUL * 2))
...
//------------------------------------------------------------------------------
//                                              bank, regiter
#define REG_PMRTC_CTRL                          ((PMRTC_REG_BASE + 0x00UL * 2))//RTC_REG_BASE + 0x00
...
#define REG_PMRTC_FREQ_CW                       ((PMRTC_REG_BASE + 0x01UL * 2))//(RTC_REG_BASE + 0x01 * 2)
#define REG_PMRTC_LOAD_VAL                      ((PMRTC_REG_BASE + 0x03UL * 2))//(RTC_REG_BASE + 0x03 * 2)
#define REG_PMRTC_MATCH_VAL                     ((PMRTC_REG_BASE + 0x07UL * 2))//(RTC_REG_BASE + 0x05 * 2)
#define REG_PMRTC_INTERRUPT                     ((PMRTC_REG_BASE + 0x00UL * 2 + 1))//(RTC_REG_BASE + 0x07 * 2)
    #define PMRTC_INT_RAW_STATUS                (1 << 0)
    #define PMRTC_INT_STATUS                    (1 << 1)

#define REG_PMRTC_CNT                           ((PMRTC_REG_BASE + 0x0bUL * 2))//(PMRTC_REG_BASE + 0x08 * 2)


//------------------------------------------------------------------------------
// PM_SLEEP RTC1 register
//------------------------------------------------------------------------------
//                                              bank, regiter
#define REG_PMRTC1_CTRL                         ((PMRTC1_REG_BASE + 0x00UL * 2))//RTC_REG_BASE + 0x00
...
#define REG_PMRTC1_FREQ_CW                      ((PMRTC1_REG_BASE + 0x01UL * 2))//(RTC_REG_BASE + 0x01 * 2)
#define REG_PMRTC1_LOAD_VAL                     ((PMRTC1_REG_BASE + 0x03UL * 2))//(RTC_REG_BASE + 0x03 * 2)
#define REG_PMRTC1_MATCH_VAL                    ((PMRTC1_REG_BASE + 0x07UL * 2))//(RTC_REG_BASE + 0x05 * 2)
#define REG_PMRTC1_INTERRUPT                    ((PMRTC1_REG_BASE + 0x00UL * 2 + 1))//(RTC_REG_BASE + 0x07 * 2)
    #define PMRTC1_INT_RAW_STATUS               (1 << 0)
    #define PMRTC1_INT_STATUS                   (1 << 1)
#define REG_PMRTC1_CNT                          ((PMRTC1_REG_BASE + 0x0bUL * 2))//(PMRTC_REG_BASE + 0x08 * 2)
