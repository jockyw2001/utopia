...
#define PM_POR_REG_BASE                         0x0600  //(0x0700*2)
...
//-----------------------------------------------------------------------------
//                                              bank, regiter
#define REG_PM_GPIO_PM_LOCK                     ((PM_REG_BASE + 0x12 * 2))
#define REG_PM_CKG_RTC                          ((PM_REG_BASE + 0x22 * 2))


#define REG_PM_DUMMY_ACTIVE_STANDBY             ((PM_POR_REG_BASE + 0x00 * 2 + 0))
#define REG_PM_DUMMY_POWERON_MODE               ((PM_REG_BASE + 0x38 * 2 + 1))
#define REG_PM_DUMMY_WAKEUP_SOURCE              ((PM_REG_BASE + 0x39 * 2 + 0))

#define PM_REG1_ScratchPad                      ((PM_REG_BASE + 0x52 * 2))
#define PM_REG2_ScratchPad                      ((PM_REG_BASE + 0x53 * 2))
#define PM_REG3_ScratchPad                      ((PM_REG_BASE + 0x54 * 2))
#define PM_REG4_ScratchPad                      ((PM_REG_BASE + 0x55 * 2))

//-----------------------------------------------------------------------------
// PM MSIC register
//-----------------------------------------------------------------------------
//                                              bank, regiter
#define REG_PM_CHIP_CFG_OVERWRITE               ((PM_MSIC_REG_BASE + 0x1F * 2))
    #define CHIP_CFG_MIPS_EN                    __BIT2
    #define CHIP_CFG_MIPS_VAL                   __BIT6
#define REG_PM_CPU_SW_RST                       ((PM_MSIC_REG_BASE + 0x29 * 2 + 1))
	#define PM_51_SW_RST				        __BIT4

//-----------------------------------------------------------------------------
// PM GPIO register
//-----------------------------------------------------------------------------
#define REG_PM_GPIO4_OEN                        ((PMSLEEP_REG_GPIO + 0x04 * 2))
#define REG_PM_GPIO4_OUT                        ((PMSLEEP_REG_GPIO + 0x04 * 2))
