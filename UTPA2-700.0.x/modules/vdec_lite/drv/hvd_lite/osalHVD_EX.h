...
MS_BOOL OSAL_HVD_ISR_Attach(MS_U32 u32IsrVector, void* pfnISRCB);
MS_BOOL OSAL_HVD_ISR_Detach(MS_U32 u32IsrVector);
MS_BOOL OSAL_HVD_ISR_Enable(MS_U32 u32IsrVector);
MS_BOOL OSAL_HVD_ISR_Disable(MS_U32 u32IsrVector);
