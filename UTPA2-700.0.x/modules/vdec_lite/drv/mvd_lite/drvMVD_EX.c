...
void MDrv_MVD_REE_GetSHMInformation(MS_VIRT* u32SHMAddr,MS_VIRT* u32VsyncSHMOffset)
{
    *u32SHMAddr = HAL_VPU_EX_GetSHMAddr();
    *u32VsyncSHMOffset = HAL_MVD_GetVsyncAddrOffset();
}

E_MVD_Result MDrv_MVD_REE_GetVsyncExtShm(MS_VIRT* u32SHMAddr, MS_VIRT* u32VsyncExtShmOffset)
{
    *u32SHMAddr = HAL_VPU_EX_GetSHMAddr();
...
MS_U8 MDrv_MVD_CheckFreeStream(void)
{
    return HAL_VPU_EX_CheckFreeStream();
}
