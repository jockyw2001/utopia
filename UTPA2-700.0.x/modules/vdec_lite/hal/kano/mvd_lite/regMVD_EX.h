...
#define MIU0_REG_BASE2                         (0x61500)
#define MIU1_REG_BASE2                         (0x62200)
...
#define MIU0_RQ4_MASK_L                 (MIU0_REG_BASE2+((0x0003)<<1))
#define MIU0_RQ4_MASK_H                 (MIU0_REG_BASE2+((0x0003)<<1)+1)
#define MIU0_RQ5_MASK_L                 (MIU0_REG_BASE2+((0x0013)<<1))
#define MIU0_RQ5_MASK_H                 (MIU0_REG_BASE2+((0x0013)<<1)+1)


#define MIU0_SEL0_L                     (MIU0_REG_BASE + 0xF0)  //0x78<<1
#define MIU0_SEL0_H                     (MIU0_REG_BASE + 0xF1)
#define MIU0_SEL2_L                     (MIU0_REG_BASE + 0xF4)  //0x7A<<1
#define MIU0_SEL2_H                     (MIU0_REG_BASE + 0xF5)
#define MIU0_SEL3_L                     (MIU0_REG_BASE + 0xF6)  //0x7B<<1
#define MIU0_SEL3_H                     (MIU0_REG_BASE + 0xF7)
#define MIU0_SEL4_L                     (MIU0_REG_BASE +(( 0x007C)<<1))
#define MIU0_SEL4_H                     (MIU0_REG_BASE +(( 0x007C)<<1)+1)
#define MIU0_SEL5_L                     (MIU0_REG_BASE +(( 0x007D)<<1))
#define MIU0_SEL5_H                     (MIU0_REG_BASE +(( 0x007D)<<1)+1)
...
#define MIU1_RQ4_MASK_L                 (MIU1_REG_BASE2+((0x0003)<<1))
#define MIU1_RQ4_MASK_H                 (MIU1_REG_BASE2+((0x0003)<<1)+1)
#define MIU1_RQ5_MASK_L                 (MIU1_REG_BASE2+((0x0013)<<1))
#define MIU1_RQ5_MASK_H                 (MIU1_REG_BASE2+((0x0013)<<1)+1)
...
#define REG_CKG_MVD             (REG_CHIPTOP_BASE + 0x39*2)
    ...
    #define CKG_MVD_108MHZ          (2 << 2)
    #define CKG_MVD_86MHZ           (3 << 2)
    #define CKG_MVD_62MHZ           (4 << 2)    //clk_miu_p
    #define CKG_MVD_54MHZ           (5 << 2)
    #define CKG_MVD_43MHZ           (6 << 2)    //mempll_clk_buf_div2
