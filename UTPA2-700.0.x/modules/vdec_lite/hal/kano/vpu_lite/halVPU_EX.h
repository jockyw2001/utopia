...
//=============================================================================
#define ONE_SETTING_FOR_DUAL_VPU

#define MAX_VPU_NUM 2
#define ENABLE_TWO_VPU_STRUCTURE 1  //used to reduce variable size

#define VPU_DISPATCH_POLICY USE_MAIN_EVD_IN_LITE_NDEC_IN_HICODEC

#define USE_FIRST_VPU_ONLY   1  // both on first vpu
#define USE_SECOND_VPU_ONLY  2  // for evd test
#define USE_KANO_RULE        3  // second evd use evd_lite
#define USE_KANO_INV_RULE    4  // second evd use hi_codec
#define USE_MAIN_EVD_IN_LITE 5  // SN PIP patch for STC, main task evd use evd_lite
#ifdef VDEC3
#define USE_MAIN_EVD_IN_LITE_NDEC_IN_HICODEC 6  // main task evd use evd_lite, N-decode task use evd_hicodec
#endif
//=============================================================================
