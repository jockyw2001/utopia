...
#define HVD_HW_MAX_PIXEL            (4096*2160*31000ULL) // 4kx2k@30p
#define HEVC_HW_MAX_PIXEL           (4096*2160*61000ULL) // 4kx2k@60p
#define VP9_HW_MAX_PIXEL            (4096*2304*31000ULL) // 4kx2k@30p

#define EVD_HW_BUFFER   0x200000 //0x800000: support MFcodec, 0x200000: not support MFcodec
...
#define _MaskMiuReq_MVD_RW_RTO( m )     _HVD_WriteRegBit(MIU0_REG_RQ4_MASK+1, m, BIT(1))
...
#define _MaskMiu1Req_MVD_RW_RTO( m )    _HVD_WriteRegBit(MIU1_REG_RQ4_MASK+1, m, BIT(1))
...
#define _MaskMiu2Req_MVD_RW( m )        _HVD_WriteRegBit(MIU2_REG_RQ2_MASK,   m, BIT(6))
#define _MaskMiu2Req_MVD_RW_RTO( m )    _HVD_WriteRegBit(MIU2_REG_RQ4_MASK+1, m, BIT(1))
#define _MaskMiu2Req_MVD_BBU_R( m )     _HVD_WriteRegBit(MIU2_REG_RQ0_MASK+1, m, BIT(2))
#define _MaskMiu2Req_HVD_RW_MIF0( m )   _HVD_WriteRegBit(MIU2_REG_RQ4_MASK,   m, BIT(4))
#define _MaskMiu2Req_HVD_RW_MIF1( m )   _HVD_WriteRegBit(MIU2_REG_RQ4_MASK,   m, BIT(5))
#define _MaskMiu2Req_HVD_BBU_R( m )     _HVD_WriteRegBit(MIU2_REG_RQ4_MASK+1, m, BIT(3))


#define HVD_MVD_RW_ON_MIU0              (((_HVD_Read2Byte(MIU0_REG_SEL2) & BIT(6)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL2) & BIT(6)) == 0))
#define HVD_MVD_RW_RTO_ON_MIU0          (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(9)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(9)) == 0))
#define HVD_MVD_BBU_R_ON_MIU0           (((_HVD_Read2Byte(MIU0_REG_SEL0) & BIT(10)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL0) & BIT(10)) == 0))
#define HVD_HVD_RW_MIF0_ON_MIU0         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(4)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(4)) == 0))
#define HVD_HVD_RW_MIF1_ON_MIU0         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(5)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(5)) == 0))
#define HVD_HVD_BBU_R_ON_MIU0           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(11)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(11)) == 0))

#define HVD_MVD_RW_ON_MIU1              (((_HVD_Read2Byte(MIU0_REG_SEL2) & BIT(6)) == BIT(6))   && ((_HVD_Read2Byte(MIU2_REG_SEL2) & BIT(6)) == 0))
#define HVD_MVD_RW_RTO_ON_MIU1          (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(9)) == BIT(9))   && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(9)) == 0))
#define HVD_MVD_BBU_R_ON_MIU1           (((_HVD_Read2Byte(MIU0_REG_SEL0) & BIT(10)) == BIT(10)) && ((_HVD_Read2Byte(MIU2_REG_SEL0) & BIT(10)) == 0))
#define HVD_HVD_RW_MIF0_ON_MIU1         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(4)) == BIT(4))   && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(4)) == 0))
#define HVD_HVD_RW_MIF1_ON_MIU1         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(5)) == BIT(5))   && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(5)) == 0))
#define HVD_HVD_BBU_R_ON_MIU1           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(11)) == BIT(11)) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(11)) == 0))

#define HVD_MVD_RW_ON_MIU2              (((_HVD_Read2Byte(MIU0_REG_SEL2) & BIT(6)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL2) & BIT(6)) == BIT(6)))
#define HVD_MVD_RW_RTO_ON_MIU2          (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(9)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(9)) == BIT(9)))
#define HVD_MVD_BBU_R_ON_MIU2           (((_HVD_Read2Byte(MIU0_REG_SEL0) & BIT(10)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL0) & BIT(10)) == BIT(10)))
#define HVD_HVD_RW_MIF0_ON_MIU2         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(4)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(4)) == BIT(4)))
#define HVD_HVD_RW_MIF1_ON_MIU2         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(5)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(5)) == BIT(5)))
#define HVD_HVD_BBU_R_ON_MIU2           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(11)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(11)) == BIT(11)))
...
#define _MaskMiuReq_EVD_LITE_RW1( m )    _HVD_WriteRegBit(MIU0_REG_RQ4_MASK,   m, BIT(2))
#define _MaskMiuReq_EVD_LITE_RW2( m )    _HVD_WriteRegBit(MIU0_REG_RQ4_MASK,   m, BIT(3))
#define _MaskMiuReq_EVD_LITE_BBU_R( m )  _HVD_WriteRegBit(MIU0_REG_RQ4_MASK,   m, BIT(6))
...
#define _MaskMiu1Req_EVD_LITE_RW1( m )   _HVD_WriteRegBit(MIU1_REG_RQ4_MASK,   m, BIT(2))
#define _MaskMiu1Req_EVD_LITE_RW2( m )   _HVD_WriteRegBit(MIU1_REG_RQ4_MASK,   m, BIT(3))
#define _MaskMiu1Req_EVD_LITE_BBU_R( m ) _HVD_WriteRegBit(MIU1_REG_RQ4_MASK,   m, BIT(6))

#define _MaskMiu2Req_EVD_RW1( m )        _HVD_WriteRegBit(MIU2_REG_RQ4_MASK,   m, BIT(7))
#define _MaskMiu2Req_EVD_RW2( m )        _HVD_WriteRegBit(MIU2_REG_RQ4_MASK,   m, BIT(1))
#define _MaskMiu2Req_EVD_BBU_R( m )      _HVD_WriteRegBit(MIU2_REG_RQ4_MASK+1, m, BIT(2))
#define _MaskMiu2Req_EVD_LITE_RW1( m )   _HVD_WriteRegBit(MIU2_REG_RQ4_MASK,   m, BIT(2))
#define _MaskMiu2Req_EVD_LITE_RW2( m )   _HVD_WriteRegBit(MIU2_REG_RQ4_MASK,   m, BIT(3))
#define _MaskMiu2Req_EVD_LITE_BBU_R( m ) _HVD_WriteRegBit(MIU2_REG_RQ4_MASK,   m, BIT(6))


#define HVD_EVD_RW1_ON_MIU0              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == 0))
#define HVD_EVD_RW2_ON_MIU0              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(1)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(1)) == 0))
#define HVD_EVD_BBU_R_ON_MIU0            (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(10)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(10)) == 0))
#define HVD_EVD_LITE_RW1_ON_MIU0         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(2)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(2)) == 0))
#define HVD_EVD_LITE_RW2_ON_MIU0         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(3)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(3)) == 0))
#define HVD_EVD_LITE_BBU_R_ON_MIU0       (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(6)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(6)) == 0))

#define HVD_EVD_RW1_ON_MIU1              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == BIT(7))   && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == 0))
#define HVD_EVD_RW2_ON_MIU1              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(1)) == BIT(1))   && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(1)) == 0))
#define HVD_EVD_BBU_R_ON_MIU1            (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(10)) == BIT(10)) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(10)) == 0))
#define HVD_EVD_LITE_RW1_ON_MIU1         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(2)) == BIT(2))   && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(2)) == 0))
#define HVD_EVD_LITE_RW2_ON_MIU1         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(3)) == BIT(3))   && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(3)) == 0))
#define HVD_EVD_LITE_BBU_R_ON_MIU1       (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(6)) == BIT(6))   && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(6)) == 0))

#define HVD_EVD_RW1_ON_MIU2              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(7)) == BIT(7)))
#define HVD_EVD_RW2_ON_MIU2              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(1)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(1)) == BIT(1)))
#define HVD_EVD_BBU_R_ON_MIU2            (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(10)) == 0) && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(10)) == BIT(10)))
#define HVD_EVD_LITE_RW1_ON_MIU2         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(2)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(2)) == BIT(2)))
#define HVD_EVD_LITE_RW2_ON_MIU2         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(3)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(3)) == BIT(3)))
#define HVD_EVD_LITE_BBU_R_ON_MIU2       (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(6)) == 0)  && ((_HVD_Read2Byte(MIU2_REG_SEL4) & BIT(6)) == BIT(6)))
#endif
...
#define _HVD_MIU_SetReqMask(miu_clients, mask)  \
    ...
    {                                           \
        ...
        {                                       \
            ...
            else if (HVD_##miu_clients##_ON_MIU2 == 1)   \
            {                                           \
                _MaskMiu2Req_##miu_clients(mask);   \
            }                                           \
        }                                       \
    } while (0)
...
//static void     _HVD_EX_MBoxClear(MS_U32 u32Id, MS_U8 u8MBox);
static MS_U32       _HVD_EX_GetPC(MS_U32 u32Id);
...
static void         _HVD_EX_SetMIUProtectMask(MS_U32 u32Id, MS_BOOL bEnable);
...
static MS_BOOL HAL_EVD_EX_DeinitHW(MS_U32 u32Id);
#endif
#if SUPPORT_G2VP9 && defined(VDEC3)
static void HAL_VP9_EX_PowerCtrl(MS_U32 u32Id, MS_BOOL bEnable);
...
typedef struct
{
    HVD_Unit_Ctx _stCtx[MAX_HVD_EVD_NUM];
    MS_U8 u8Cidx[HAL_HVD_EX_MAX_SUPPORT_STREAM];
...
//  Debug Functions
//-------------------------------------------------------------------------------------------------
void HVD_EX_SetRstFlag(MS_U32 u32Id, MS_BOOL bRst)
{
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[pHVDHalContext->u8Cidx[u8Idx]];

    pHVDCtx->g_RstFlag = bRst;
}

MS_BOOL HVD_EX_GetRstFlag(MS_U32 u32Id)
{
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[pHVDHalContext->u8Cidx[u8Idx]];

    return pHVDCtx->g_RstFlag;
}
...
{
    MS_U8 i,j;
    HVD_Unit_Ctx *pHVDCtx = NULL;

    for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
    {
        pHVDHalContext->u8Cidx[i] = 0xFF;
    }

    for (j = 0; j < MAX_HVD_EVD_NUM; j++)
    {
        pHVDCtx = &pHVDHalContext->_stCtx[j];

        pHVDCtx->u32HVDCmdTimeout = 100;//same as HVD_FW_CMD_TIMEOUT_DEFAULT
        pHVDCtx->u32VPUClockType = 432;
        pHVDCtx->u32HVDClockType = 384;
        #if SUPPORT_EVD
        pHVDCtx->u32EVDClockType = 576;
        #endif
        #if SUPPORT_G2VP9 && defined(VDEC3)
        pHVDCtx->u32VP9ClockType = 384;
        #endif

        #ifdef VDEC3
        for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
        {
            pHVDCtx->_stHVDStream[i].eStreamId = E_HAL_HVD_N_STREAM0 + i;
            pHVDCtx->_stHVDStream[i].ePpTaskState = E_HAL_HVD_STATE_STOP;
            pHVDCtx->_stHVDStream[i].s32HvdPpTaskId = -1;
        }
        #else
        pHVDCtx->_stHVDStream[0].eStreamId = E_HAL_HVD_MAIN_STREAM0;
        pHVDCtx->_stHVDStream[1].eStreamId = E_HAL_HVD_SUB_STREAM0;
        pHVDCtx->_stHVDStream[2].eStreamId = E_HAL_HVD_SUB_STREAM1;
        #endif
    }
}
...
static MS_U16 _HVD_EX_GetBBUReadptr(MS_U32 u32Id)
{
    ...
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[pHVDHalContext->u8Cidx[u8Idx]];
    MS_U32 u32RB = pHVDCtx->_stHVDStream[u8Idx].u32RegBase;
...
static MS_BOOL _HVD_EX_MBoxSend(MS_U32 u32Id, MS_U8 u8MBox, MS_U32 u32Msg)
{
    ...
    switch (u8MBox)
    {
        ...
        case E_HVD_VPU_HI_0:
        {
            bResult = HAL_VPU_EX_MBoxSend(u32Id, VPU_HI_MBOX0, u32Msg);
            break;
        }
        case E_HVD_VPU_HI_1:
        {
            bResult = HAL_VPU_EX_MBoxSend(u32Id, VPU_HI_MBOX1, u32Msg);
            break;
        }
        default:
        {
...
static MS_BOOL _HVD_EX_MBoxReady(MS_U32 u32Id, MS_U8 u8MBox)
{
    ...
    switch (u8MBox)
    {
        ...
        case E_HVD_RISC_1:
            ...
            break;
        case E_HVD_VPU_HI_0:
            bResult = HAL_VPU_EX_MBoxRdy(u32Id, VPU_HI_MBOX0);
            break;
        case E_HVD_VPU_HI_1:
            bResult = HAL_VPU_EX_MBoxRdy(u32Id, VPU_HI_MBOX1);
            break;
        case E_HVD_VPU_RISC_0:
            bResult = HAL_VPU_EX_MBoxRdy(u32Id, VPU_RISC_MBOX0);
            break;
        case E_HVD_VPU_RISC_1:
            bResult = HAL_VPU_EX_MBoxRdy(u32Id, VPU_RISC_MBOX1);
            break;
        default:
            break;
    }
...
static MS_BOOL _HVD_EX_MBoxRead(MS_U32 u32Id, MS_U8 u8MBox, MS_U32 *u32Msg)
{
    ...
    switch (u8MBox)
    {
        ...
        case E_HVD_VPU_RISC_0:
        {
            bResult = HAL_VPU_EX_MBoxRead(u32Id, VPU_RISC_MBOX0, u32Msg);
            break;
        }
        case E_HVD_VPU_RISC_1:
        {
            bResult = HAL_VPU_EX_MBoxRead(u32Id, VPU_RISC_MBOX1, u32Msg);
            break;
        }
        default:
        {
...
static void _HVD_EX_MBoxClear(MS_U32 u32Id, MS_U8 u8MBox)
{
    switch (u8MBox)
    {
        ...
        case E_HVD_RISC_1:
            ...
            break;
        case E_HVD_VPU_RISC_0:
            HAL_VPU_EX_MBoxClear(u32Id, VPU_RISC_MBOX0);
            break;
        case E_HVD_VPU_RISC_1:
            HAL_VPU_EX_MBoxClear(u32Id, VPU_RISC_MBOX1);
            break;
        default:
            break;
    }
...
static HVD_Return _HVD_EX_SendCmd(MS_U32 u32Id, MS_U32 u32Cmd, MS_U32 u32CmdArg)
{
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[pHVDHalContext->u8Cidx[u8Idx]];
    MS_U32 u32timeout = HVD_GetSysTime_ms() + pHVDCtx->u32HVDCmdTimeout;
#ifdef VDEC3
    ...
    if (!IsSent) {
        IsMailBox = TRUE;
        u32timeout = HVD_GetSysTime_ms() + pHVDCtx->u32HVDCmdTimeout;
...
static void _HVD_EX_SetMIUProtectMask(MS_U32 u32Id, MS_BOOL bEnable)
{
    ...
    _HVD_MIU_SetReqMask(MVD_RW_RTO, bEnable);
    ...
    _HVD_MIU_SetReqMask(EVD_LITE_RW1, bEnable);
    _HVD_MIU_SetReqMask(EVD_LITE_RW2, bEnable);
    _HVD_MIU_SetReqMask(EVD_LITE_BBU_R, bEnable);
#endif
    _HVD_MIU_SetReqMask(HVD_RW_MIF0, bEnable);
    _HVD_MIU_SetReqMask(HVD_RW_MIF1, bEnable);
    _HVD_MIU_SetReqMask(HVD_BBU_R, bEnable);
    HAL_VPU_EX_MIU_RW_Protect(u32Id, bEnable);
    //HVD_Delay_ms(1);
#endif
    return;
}
...
static MS_BOOL _HAL_EX_BBU_EVD_InUsed(MS_U32 u32Id)
{
    if (!pHVDHalContext)
        return FALSE;
    ...
    for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
    {
        if (pHVDCtx->_stHVDStream[i].bUsed &&
            ((pHVDCtx->_stHVDStream[i].u32CodecType == E_HAL_HVD_HEVC)
            #if SUPPORT_MSVP9
            ||(pHVDCtx->_stHVDStream[i].u32CodecType == E_HAL_HVD_VP9)
            #endif
            ))
        {
            bRet = TRUE;
...
static MS_BOOL _HAL_EX_BBU_HVD_InUsed(MS_U32 u32Id) // VP8 isn't included
{
    if (!pHVDHalContext)
        return FALSE;
    ...
    {
        if (pHVDCtx->_stHVDStream[i].bUsed &&
            ((pHVDCtx->_stHVDStream[i].u32CodecType == E_HAL_HVD_AVC) ||
            (pHVDCtx->_stHVDStream[i].u32CodecType == E_HAL_HVD_AVS) ||
            (pHVDCtx->_stHVDStream[i].u32CodecType == E_HAL_HVD_RM)))
        {
            bRet = TRUE;
            break;
        }
...
static MS_BOOL _HAL_EX_BBU_VP8_InUsed(MS_U32 u32Id)
{
    if (!pHVDHalContext)
        return FALSE;
    ...
    for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
    {
        if (pHVDCtx->_stHVDStream[i].bUsed && pHVDCtx->_stHVDStream[i].u32CodecType == E_HAL_HVD_VP8)
        {
            bRet = TRUE;
            break;
        }
...
//    MS_U32 u32TmpStartOffset;
    ...
    {
#ifdef VDEC3
        if (!_HAL_EX_BBU_VP8_InUsed(u32Id))
#endif
        {
            ...
            _HVD_Write2Byte(HVD_REG_NAL_TAB_LEN_BS3, (MS_U16)(pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum - 1));
            ...
            _HVD_Write2Byte(HVD_REG_NAL_TAB_LEN_BS4, (MS_U16)(pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum - 1));
        }
...
#ifdef VDEC3
    if (!pCtrl->bNStreamMode || ((_HAL_EX_IS_EVD(pCtrl->InitParams.u32ModeFlag) && !_HAL_EX_BBU_EVD_InUsed(u32Id)) ||
        (_HAL_EX_IS_HVD(pCtrl->InitParams.u32ModeFlag) && !_HAL_EX_BBU_HVD_InUsed(u32Id)) ||
         (E_HVD_INIT_INPUT_TSP == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_INPUT_MASK))))
    {
        if (pCtrl->u32BBUId == 0)
        {
            ...
            _HVD_Write2Byte(HVD_REG_NAL_TAB_LEN(u32RB), (MS_U16) (pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum - 1));
        }
        else
        {
            ...
            // -1 is for NAL_TAB_LEN counts from zero.
            _HVD_Write2Byte(HVD_REG_NAL_TAB_LEN_BS2(u32RB), (MS_U16) (pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum - 1));
        }
    }
#else
    if (0 == u8TaskId)
         ...
         (E_HVD_INIT_INPUT_TSP == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_INPUT_MASK))))
    {
        ...
        //----------- reg_hk_sel_hi_or_hilite -----------
        u16Reg = (pHVDHalContext->u8Cidx[u8Idx] == HWDEC_EVD_LITE)?(MVD_REG_SEL_HILITE):(0);

        if (pCtrl->u32BBUId == 0)
        {
            _HVD_WriteWordMask(MVD_REG_PAS1_SEL_HI_OR_HILITE, u16Reg, MVD_REG_SEL_HILITE);
        }
        else
        {
            _HVD_WriteWordMask(MVD_REG_PAS2_SEL_HI_OR_HILITE, u16Reg, MVD_REG_SEL_HILITE);
        }
        //----------- reg_hk_sel_hi_or_hilite -----------
    }
#else
    ...
    if ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK) == E_HVD_INIT_HW_MVC)
    {
        ...
        _HVD_Write2Byte(HVD_REG_NAL_TBL_ST_ADDR_H_BS2(u32RB), (MS_U16)(u32StAddr >> 19));
        // -1 is for NAL_TAB_LEN counts from zero.
        _HVD_Write2Byte(HVD_REG_NAL_TAB_LEN_BS2(u32RB), (MS_U16)(pHVDCtx->_stHVDStream[u8Idx+1].u32BBUEntryNum - 1));
...
MS_BOOL HAL_HVD_EX_IQMem_Init(MS_U32 u32Id)
{
    ...
    if (HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_FW_IQMEM_CTRL) == E_HVD_IQMEM_INIT_NONE)
    {
        ...
        HAL_VPU_EX_IQMemSetDAMode(u32Id, TRUE);
        ...
        HAL_VPU_EX_IQMemSetDAMode(u32Id, FALSE);
...
#endif
{
    ...
    HAL_VPU_EX_SetFWReload(u32Id, !pCtrl->bTurboFWMode);
    ...
    if ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK) == E_HVD_INIT_HW_RM) //rm
    {
        vlcCfg.u32DstAddr           = MsOS_PA2KSEG0(pCtrl->MemMap.u32FrameBufAddr + pHVDCtx->u32RV_VLCTableAddr);
        ...
        vlcCfg.u32VLCTableOffset    = pHVDCtx->u32RV_VLCTableAddr;
    ...
    if(TRUE == HVD_EX_GetRstFlag(u32Id))
    {
        //Delete task for Rst
    ...
    if (u32Timeout > 0)
    {
        pHVDCtx->_stHVDStream[u8Idx].bUsed = TRUE;

#ifdef VDEC3
        switch (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK)
        {
            case E_HVD_INIT_HW_AVC:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_AVC;
                break;
            case E_HVD_INIT_HW_AVS:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_AVS;
                break;
            case E_HVD_INIT_HW_RM:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_RM;
                break;
            case E_HVD_INIT_HW_MVC:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_MVC;
                break;
            case E_HVD_INIT_HW_VP8:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_VP8;
                break;
            case E_HVD_INIT_HW_MJPEG:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_MJPEG;
                break;
            case E_HVD_INIT_HW_VP6:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_VP6;
                break;
            case E_HVD_INIT_HW_HEVC:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_HEVC;
                break;
            case E_HVD_INIT_HW_VP9:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_VP9;
                break;
            default:
                pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_NONE;
                break;
        }
#endif
...
static HVD_Return _HVD_EX_UpdatePTSTable(MS_U32 u32Id, HVD_BBU_Info *pInfo)
{
    ...
    u32PTSWptr = pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr + 1;
    ...
    if (u32PTSWptr == u32PTSRptr)
    {
        HVD_EX_MSG_ERR("PTS table full. Read Ptr(%lx) == new Write ptr(%lx) ,Pre Wptr(%lx) \n", (unsigned long)u32PTSRptr,
                    (unsigned long)u32PTSWptr, (unsigned long)pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr);
        return E_HVD_RETURN_FAIL;
    }

    // add one PTS entry
    PTSEntry.u32ByteCnt = pHVDCtx->_stHVDStream[u8Idx].u32PTSByteCnt & HVD_BYTE_COUNT_MASK;
    PTSEntry.u32ID_L = pInfo->u32ID_L;
    PTSEntry.u32ID_H = pInfo->u32ID_H;
    PTSEntry.u32PTS = pInfo->u32TimeStamp;

    u32DestAddr = MsOS_PA2KSEG1(pCtrl->MemMap.u32CodeBufAddr + (MS_PHY)pShm->u32HVD_PTS_TABLE_ST_OFFSET + (pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr * sizeof(HVD_PTS_Entry)));
    ...
    pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr = u32PTSWptr;
...
static HVD_Return _HVD_EX_UpdateESWptr(MS_U32 u32Id, MS_U32 u32NalOffset, MS_U32 u32NalLen)
{
    ...
    if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        u32BBUNewWptr = pHVDCtx->u32VP8BBUWptr;
    }
    else
    {
        u32BBUNewWptr = pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr;
    }
    u32BBUNewWptr++;
    u32BBUNewWptr %= pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum;
    ...
    if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        u32Adr = MsOS_PA2KSEG1(pCtrl->MemMap.u32CodeBufAddr + u32BBU_DRAM_ST_ADDR + (pHVDCtx->u32VP8BBUWptr << 3));
    }
    else
    {
        // add nal entry
        u32Adr = MsOS_PA2KSEG1(pCtrl->MemMap.u32CodeBufAddr + u32BBU_DRAM_ST_ADDR + (pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr << 3));
    }
    ...
    if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        pHVDCtx->u32VP8BBUWptr = u32BBUNewWptr;
    }
    else
    {
        pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr = u32BBUNewWptr;
    }
...
static HVD_Return _HVD_EX_UpdateESWptr_VP8(MS_U32 u32Id, MS_U32 u32NalOffset, MS_U32 u32NalLen, MS_U32 u32NalOffset2, MS_U32 u32NalLen2)
{
    ...
    */
    ...
    if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        u32Adr = MsOS_PA2KSEG1(pCtrl->MemMap.u32CodeBufAddr + u32VP8_BBU_DRAM_ST_ADDR_BS4 + (pHVDCtx->u32VP8BBUWptr << 3));
    }
    else
    {
        u32Adr = MsOS_PA2KSEG1(pCtrl->MemMap.u32CodeBufAddr + u32VP8_BBU_DRAM_ST_ADDR_BS4 + (pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr << 3));
    }
...
static MS_VIRT _HVD_EX_GetVUIDispInfo(MS_U32 u32Id)
{
        ...
        ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK) == E_HVD_INIT_HW_HEVC) )
    {
        MS_U16 i;
        MS_PHY u32VUIAddr;
        MS_U32 *pData = (MS_U32 *) &(pHVDCtx->g_hvd_VUIINFO);
        ...
        for (i = 0; i < sizeof(HVD_AVC_VUI_DISP_INFO); i += 4)
        {
            ...
            {
                //*pData = *((MS_VIRT *) MsOS_PA2KSEG1(u32VUIAddr + i + pCtrl->MemMap.u32CodeBufAddr));
    ...
    {
        memset(&(pHVDCtx->g_hvd_VUIINFO), 0, sizeof(HVD_AVC_VUI_DISP_INFO));
    }

    return (MS_VIRT) &(pHVDCtx->g_hvd_VUIINFO);
}
...
static MS_U32 _HVD_EX_GetBBUQNumb(MS_U32 u32Id)
{
    ...
    if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        u32WritePtr = pHVDCtx->u32VP8BBUWptr;
    }
    else
    {
        u32WritePtr = pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr;
    }
    ...
    {
        eRet = pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum - (u32ReadPtr - u32WritePtr);
    }

#if 0
    if (pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr >= u32ReadPtr)
    {
        eRet = pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr - u32ReadPtr;
    }
    else
    {
        eRet = pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum - (u32ReadPtr - pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr);
    }
...
static MS_U32 _HVD_EX_GetPTSQNumb(MS_U32 u32Id)
{
    ...
    if (pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr >= u32ReadPtr)
    {
        eRet = pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr - u32ReadPtr;
    }
    else
    {
        eRet = MAX_PTS_TABLE_SIZE - (u32ReadPtr - pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr);
    }
...
static HVD_Frm_Information *_HVD_EX_GetNextDispFrame(MS_U32 u32Id)
{
    ...
    if(bMVC)
    {
        if (pHVDCtx->_stHVDStream[u8Idx].bDispOutSide)
        {
            MS_U16 u16RealQPtr = pHVDCtx->_stHVDStream[u8Idx].u32DispQIndex;
            MS_U16 u16UsedFrm = 0;
            ...
            if (u16QNum > u16UsedFrm)
            {
                ...
                {
                    pHVDCtx->_u16DispOutSideQPtr[u8Idx] = u16QPtr;
                    pHvdFrm->u32Status = E_HVD_DISPQ_STATUS_VIEW;

                    if ((u16QPtr%2) == 0)
                    {
                        //ALOGE("G1: %x", pHvdFrm->u32PrivateData);
                        pHVDCtx->_stHVDStream[u8Idx].u32PrivateData = pHvdFrm->u32PrivateData;
                    }
                    else
                    {
                        //ALOGE("G2: %x", (pHvdFrm->u32PrivateData << 16) | pHVDCtx->_stHVDStream[u8Idx].u32PrivateData);
                        //pShm->UpdateQueue[pShm->u16UpdateQWtPtr] = (pHvdFrm->u32PrivateData << 16) | pHVDCtx->_stHVDStream[u8Idx].u32PrivateData;
                        //pShm->u16UpdateQWtPtr = (pShm->u16UpdateQWtPtr + 1) % HVD_DISP_QUEUE_MAX_SIZE;
                        HAL_HVD_EX_SetCmd(u32Id, E_HVD_CMD_UPDATE_DISPQ, (pHvdFrm->u32PrivateData << 16) | pHVDCtx->_stHVDStream[u8Idx].u32PrivateData);
                    }

                    u16QPtr++;
                    if (u16QPtr == pShm->u16DispQSize) u16QPtr = 0;
                    pHVDCtx->_stHVDStream[u8Idx].u32DispQIndex = u16QPtr;
        ...
        while (u16QNum > 0)
        {
            ...
            pHVDCtx->pHvdFrm = (volatile HVD_Frm_Information *) &pShm->DispQueue[u16QPtr];

            //HVD_PRINT("Q2: %ld\n", pHVDShareMem->DispQueue[u16QPtr].u32Status);
            if (pHVDCtx->pHvdFrm->u32Status == E_HVD_DISPQ_STATUS_INIT)
            {
                ...
                //HVD_PRINT("V:%d.\n",u16QPtr);
                pHVDCtx->_u16DispQPtr = u16QPtr;
                pHVDCtx->pHvdFrm->u32Status = E_HVD_DISPQ_STATUS_VIEW;       /////Change its state!!
                HVD_EX_MSG_DBG("FrameDone: %d, pHvdFrm=0x%lx, timestamp=%d\n", u16QPtr,
                           (unsigned long) pHVDCtx->pHvdFrm, pShm->DispQueue[u16QPtr].u32TimeStamp);
                ...
                return (HVD_Frm_Information *)(MS_VIRT) pHVDCtx->pHvdFrm;
            }
...
static HVD_Frm_Information_EXT_Entry *_HVD_EX_GetNextDispFrameExt(MS_U32 u32Id)
{
    ...
    if (pHVDCtx->_stHVDStream[u8Idx].bDispOutSide)
    {
        ...
        {
            pFrmInfoExt = &(pVsyncBridgeExt->stEntry[pHVDCtx->_u16DispOutSideQPtr[u8Idx]]);
        }
    }
    return pFrmInfoExt;
}
...
MS_U8 _HVD_EX_GetStreamIdx(MS_U32 u32Id)
{
    ...
    switch (eSidBase)
    {
        ...
        case E_HAL_HVD_SUB_STREAM_BASE:
        {
            u8OffsetIdx = 1;
            break;
        }
        case E_HAL_HVD_MVC_STREAM_BASE:
        {
            u8OffsetIdx = 0;
            break;
        }
#ifdef VDEC3
        case E_HAL_HVD_N_STREAM_BASE:
        {
...
/*
static MS_BOOL _HAL_HVD_EX_HVDInUsed(MS_U32 u32Id)
{
    MS_U32 i = 0;
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[pHVDHalContext->u8Cidx[u8Idx]];
    ...
    for(i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
    {
        if(TRUE == pHVDCtx->_stHVDStream[i].bUsed)
        {
            return TRUE;
        }
    }
...
#ifdef VDEC3
static MS_U8 _HVD_EX_DecideCidx(MS_U8 u8Idx, MS_BOOL bIsEVD, MS_BOOL bIsNStreamMode)
#else
static MS_U8 _HVD_EX_DecideCidx(MS_U8 u8Idx, MS_BOOL bIsEVD)
#endif
{
    ...
    #elif (VPU_DISPATCH_POLICY == USE_KANO_RULE)
    {
        ...
        {
            MS_U8 i = 0;
            HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[0];
            for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
            {
                if ((E_HAL_HVD_HEVC == pHVDCtx->_stHVDStream[i].u32CodecType) || (E_HAL_HVD_VP9 == pHVDCtx->_stHVDStream[i].u32CodecType))
                {
                    break;
                }
            }

            if (i < HAL_HVD_EX_MAX_SUPPORT_STREAM)
            {
                u8DecideCidx = 1;
            }
            else
    ...
    #elif (VPU_DISPATCH_POLICY == USE_KANO_INV_RULE)
    {
        ...
        {
            MS_U8 i = 0;
            HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[1];
            for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
            {
                if ((E_HAL_HVD_HEVC == pHVDCtx->_stHVDStream[i].u32CodecType) || (E_HAL_HVD_VP9 == pHVDCtx->_stHVDStream[i].u32CodecType))
                {
    ...
    if(HAL_VPU_EX_GetSecurityMode() == TRUE)
    {
        u8DecideCidx = 0;
        HVD_PRINT("[VDEC][%s]Secure mode always use u8DecideCidx=%d\n",__FUNCTION__,u8DecideCidx);
    }

    HVD_PRINT("[%s] policy=%d, u8Id=%d, bIsEVD=%d, u8DecideCidx=%d \n", __FUNCTION__, VPU_DISPATCH_POLICY, u8Idx, bIsEVD, u8DecideCidx);
    return u8DecideCidx;
}

void HAL_HVD_EX_ExchangeCidx(MS_U32 u32Id)
{
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);

    #ifndef MSOS_TYPE_LINUX_KERNEL
    // The structure is too large to put it on the function stack, so we allocate it on the heap
    HVD_Unit_Ctx *p_stCtx = (HVD_Unit_Ctx*) malloc(sizeof(HVD_Unit_Ctx));
    if(p_stCtx == NULL)
    {
        HVD_PRINT("[error][%s] out of memory \n", __FUNCTION__);
        return;
    }
    #else
    HVD_Unit_Ctx stCtx;
    HVD_Unit_Ctx *p_stCtx = &stCtx;
    #endif

    HVD_memcpy((volatile void *)                     p_stCtx , (void *) (&pHVDHalContext->_stCtx[0]), sizeof(HVD_Unit_Ctx));
    HVD_memcpy((volatile void *) (&pHVDHalContext->_stCtx[0]), (void *) (&pHVDHalContext->_stCtx[1]), sizeof(HVD_Unit_Ctx));
    HVD_memcpy((volatile void *) (&pHVDHalContext->_stCtx[1]),                     (void *) p_stCtx,  sizeof(HVD_Unit_Ctx));

    pHVDHalContext->u8Cidx[u8Idx] = 1 - pHVDHalContext->u8Cidx[u8Idx];

    HVD_PRINT("[%s] u8Id=%d, cidx=%d \n", __FUNCTION__, u8Idx, pHVDHalContext->u8Cidx[u8Idx]);
...
#ifdef VDEC3
void HAL_HVD_EX_SetCidx(MS_U32 u32Id, MS_BOOL bIsEVD, MS_BOOL bIsNStreamMode)
{
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    pHVDHalContext->u8Cidx[u8Idx] = _HVD_EX_DecideCidx(u8Idx, bIsEVD, bIsNStreamMode);
    return;
}
#else
void HAL_HVD_EX_SetCidx(MS_U32 u32Id, MS_BOOL bIsEVD)
{
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    pHVDHalContext->u8Cidx[u8Idx] = _HVD_EX_DecideCidx(u8Idx, bIsEVD);
    return;
}
#endif

MS_U8 HAL_HVD_EX_GetCidx(MS_U32 u32Id)
{
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    return pHVDHalContext->u8Cidx[u8Idx];
}
...
void _HVD_MIF_MiuClientSel(MS_U8 u8MiuSel)  //SW select
{
    if (u8MiuSel == E_CHIP_MIU_0)
    {
        _HVD_WriteWordMask(MIU0_CLIENT_SELECT_GP4, 0, MIU0_CLIENT_SELECT_GP4_HVD_MIF0);
        _HVD_WriteWordMask(MIU0_CLIENT_SELECT_GP4, 0, MIU0_CLIENT_SELECT_GP4_HVD_MIF1);
    }
    else if (u8MiuSel == E_CHIP_MIU_1)
    {
        _HVD_WriteWordMask(MIU0_CLIENT_SELECT_GP4, MIU0_CLIENT_SELECT_GP4_HVD_MIF0, MIU0_CLIENT_SELECT_GP4_HVD_MIF0);
...
static MS_BOOL _HAL_HVD_EX_PostProc_Task(MS_U32 u32Id)
{
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[pHVDHalContext->u8Cidx[u8Idx]];
    HVD_EX_Stream *pstHVDStream = pHVDCtx->_stHVDStream + u8Idx;
    HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
...
MS_BOOL HAL_HVD_EX_InitHW(MS_U32 u32Id,VPU_EX_DecoderType DecoderType)
{
    ...
    HVD_EX_Drv_Ctrl *pCtrl = _HVD_EX_GetDrvCtrl(u32Id);
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    MS_U8 u8EVD = pHVDHalContext->u8Cidx[u8Idx];
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[u8EVD];
    ...
    MS_BOOL isHVD = (E_HVD_INIT_HW_AVC == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK)) \
    ...
    if (!HAL_VPU_EX_HVDInUsed(u32Id))
    {
        HVD_PRINT("HVD power on\n");
            ...
            if(isHVD)
            {
                HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_HVD_IDB, TRUE);
            }

            if(E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
            {
                HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_VP8, TRUE);
            }
            else if((E_HVD_INIT_HW_AVS == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK)) ||
                    (E_HVD_INIT_HW_VP9 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK)) )
            {
                HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_HVD_AEC, TRUE);
            }
        #else
    ...
    if (E_HVD_INIT_HW_VP9 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        if (!HAL_VPU_EX_G2VP9InUsed(u32Id))
        {
            HVD_PRINT("G2 VP9 power on\n");
            HAL_VP9_EX_PowerCtrl(u32Id, TRUE);
        }
    }
    #endif

    if (isHVD && (E_HVD_INIT_HW_MJPEG != (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK)))
    {
        _phy_to_miu_offset(u8MiuSel, u32StartOffset, pCtrl->MemMap.u32FrameBufAddr);
        //ALOGD("[HVD FB] addr=0x%x, size=0x%x, miu=%d \n", (MS_U32)(pCtrl->MemMap.u32FrameBufAddr), pCtrl->MemMap.u32FrameBufSize, u8MiuSel);

        _HAL_HVD_Entry();
        _HVD_MIF_MiuClientSel(u8MiuSel);
        _HAL_HVD_Release();
    }

    if ((!HAL_VPU_EX_HVDInUsed(u32Id)) )
    {
        pHVDCtx->_stHVDStream[0].u32BBUWptr = 0; //main
        pHVDCtx->_stHVDStream[1].u32BBUWptr = 0; //sub
        pHVDCtx->u32VP8BBUWptr = 0; //VP8
        ...
        #if 0
        if((pHVDCtx->pHVDPreCtrl_Hal[u8Idx]->stIapGnShBWMode.bEnable) &&
           ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK) == E_HVD_INIT_HW_AVC))
        {
            _phy_to_miu_offset(u8MiuSel, u32StartOffset, pHVDCtx->pHVDPreCtrl_Hal[u8Idx]->stIapGnShBWMode.u32IapGnBufAddr);
    ...
    if (isEVD)
    {
        ...
        if (!HAL_VPU_EX_EVDInUsed(u32Id))
#endif
            _HVD_WriteWordMask(EVD_REG_RESET(u8EVD), EVD_REG_RESET_SWRST, EVD_REG_RESET_SWRST);
    }
    #endif
    ...
    if (isEVD)
    {
        ...
        {
            if (E_HVD_INIT_HW_HEVC == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
                _HVD_WriteWordMask(EVD_REG_RESET(u8EVD), EVD_REG_RESET_HK_HEVC_MODE, EVD_REG_RESET_HK_HEVC_MODE);
        }
...
#endif
            {
                _HVD_WriteWordMask(EVD_REG_RESET(u8EVD), EVD_REG_RESET_HK_TSP2EVD_EN, EVD_REG_RESET_HK_TSP2EVD_EN);
            }
            else
            {
                _HVD_WriteWordMask(EVD_REG_RESET(u8EVD), EVD_REG_RESET_USE_HVD_MIU_EN, EVD_REG_RESET_USE_HVD_MIU_EN);
            }
        }
        goto RESET;
    }
...
RESET:
...
#endif
        {
            HVD_PRINT("EVD miu 256 bits\n");
            _HVD_Write2Byte(EVD_REG_RESET(u8EVD), (_HVD_Read2Byte(EVD_REG_RESET(u8EVD)) & ~EVD_REG_RESET_MIU0_128 & ~EVD_REG_RESET_MIU1_128));
            _HVD_Write2Byte(EVD_REG_RESET(u8EVD), (_HVD_Read2Byte(EVD_REG_RESET(u8EVD)) | EVD_REG_RESET_MIU0_256 | EVD_REG_RESET_MIU1_256));
            // set EVD mif client to IP auto select
            _HVD_Write2Byte(EVD_REG_MIF_SOURCE_GROUP4, _HVD_Read2Byte(EVD_REG_MIF_SOURCE_GROUP4) | 0x0000008E );
        }
    }
#endif
    ...
    if (isEVD)
    {
        ...
        if (!HAL_VPU_EX_EVDInUsed(u32Id))
#endif
            _HVD_WriteWordMask(EVD_REG_RESET(u8EVD), 0, EVD_REG_RESET_SWRST);
    }
#endif
    ...
    if (E_HVD_INIT_HW_VP9 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        ...
        if (pShm->u8FrmPostProcSupport & E_HVD_POST_PROC_DETILE)
            _HVD_EX_PpTask_Create(u32Id, &pHVDCtx->_stHVDStream[u8Idx]);
    }
#endif
...
MS_BOOL HAL_HVD_EX_DeinitHW(MS_U32 u32Id)
{
...
#ifdef CONFIG_MSTAR_CLKM
        HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_HVD, FALSE);
        HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_HVD_IDB, FALSE);
        HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_HVD_AEC, FALSE);
        HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_VP8, FALSE);
#else
    ...
    _HVD_EX_SetMIUProtectMask(u32Id, FALSE);
...
#ifdef VDEC3
HAL_HVD_StreamId HAL_HVD_EX_GetFreeStream(HAL_HVD_StreamType eStreamType, MS_BOOL bIsEVD, MS_BOOL bIsNStreamMode)
#else
HAL_HVD_StreamId HAL_HVD_EX_GetFreeStream(HAL_HVD_StreamType eStreamType, MS_BOOL bIsEVD)
#endif
{
    MS_U32 i = 0;
    MS_U8 idx = 0;
    if (E_HAL_HVD_MVC_STREAM == eStreamType)
    {
        idx = 0;
    }
    else if (E_HAL_HVD_MAIN_STREAM == eStreamType)
    {
        idx = 0;
    }
    else if (E_HAL_HVD_SUB_STREAM == eStreamType)
    {
        idx = 1;
    }
    #ifdef VDEC3
    ...
    {
        idx = eStreamType - E_HAL_HVD_N_STREAM;
    }
    #endif

#ifdef VDEC3
    MS_U8 u8DecideCidx = _HVD_EX_DecideCidx(idx, bIsEVD, bIsNStreamMode);
#else
    MS_U8 u8DecideCidx = _HVD_EX_DecideCidx(idx, bIsEVD);
#endif
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[u8DecideCidx];

    if (eStreamType == E_HAL_HVD_MVC_STREAM)
    {
        if ((FALSE == pHVDCtx->_stHVDStream[0].bUsed) && (FALSE == pHVDCtx->_stHVDStream[1].bUsed))
            return pHVDCtx->_stHVDStream[0].eStreamId;
    }
    else if (eStreamType == E_HAL_HVD_MAIN_STREAM)
    {
        ...
        {
            if ((E_HAL_HVD_MAIN_STREAM_BASE & pHVDCtx->_stHVDStream[i].eStreamId) && (FALSE == pHVDCtx->_stHVDStream[i].bUsed))
            {
                return pHVDCtx->_stHVDStream[i].eStreamId;
            }
        }
    }
    else if (eStreamType == E_HAL_HVD_SUB_STREAM)
    {
        for (i = 0;
             ...
             ((E_HAL_HVD_MAIN_STREAM_MAX - E_HAL_HVD_MAIN_STREAM_BASE) +
              (E_HAL_HVD_SUB_STREAM_MAX - E_HAL_HVD_SUB_STREAM_BASE)); i++)
        {
            if ((E_HAL_HVD_SUB_STREAM_BASE & pHVDCtx->_stHVDStream[i].eStreamId) && (FALSE == pHVDCtx->_stHVDStream[i].bUsed))
            {
                return pHVDCtx->_stHVDStream[i].eStreamId;
            }
        }
...
void HAL_HVD_EX_PowerCtrl(MS_U32 u32Id, MS_BOOL bEnable)
{
    ...
    switch (pHVDCtx->u32HVDClockType)
    {
...
void HAL_HVD_EX_SetPreCtrlVariables(MS_U32 u32Id,MS_VIRT drvprectrl)
{
    ...
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[pHVDHalContext->u8Cidx[u8Idx]];
    pHVDCtx->pHVDPreCtrl_Hal[u8Idx] = pHVDPreCtrl_in;
}
...
HVD_Return HAL_HVD_EX_InitVariables(MS_U32 u32Id)
{
    ...
    pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr   = 0;
    pHVDCtx->_stHVDStream[u8Idx].u32PTSByteCnt   = 0;
    pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum  = 0;
    pHVDCtx->_stHVDStream[u8Idx].u32DispQIndex   = 0;
    pHVDCtx->_stHVDStream[u8Idx].u32FreeData     = 0xFFFF;

    for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
        pHVDCtx->_s32VDEC_BBU_TaskId[i] = -1;

    #if HVD_ENABLE_MVC
    if (bMVC)
    {
        pHVDCtx->_stHVDStream[u8Idx+1].u32PTSPreWptr   = 0;
        pHVDCtx->_stHVDStream[u8Idx+1].u32PTSByteCnt   = 0;
        pHVDCtx->_stHVDStream[u8Idx+1].u32BBUWptr      = 0;
        pHVDCtx->_stHVDStream[u8Idx+1].u32BBUEntryNum  = 0;
    }
    #endif ///HVD_ENABLE_MVC
    ...
    memset((void *) (pHVDCtx->g_hvd_nal_fill_pair), 0, 16);

    // global variables
    pHVDCtx->u32HVDCmdTimeout = pCtrl->u32CmdTimeout;
    //pHVDCtx->u32VPUClockType = (MS_U32) pCtrl->InitParams.u16DecoderClock;
    //pHVDCtx->u32HVDClockType = (MS_U32) pCtrl->InitParams.u16DecoderClock;
    ...
    if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum = VP8_BBU_DRAM_TBL_ENTRY;
        pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNumTH = VP8_BBU_DRAM_TBL_ENTRY_TH;
    }
    else
    #if HVD_ENABLE_RV_FEATURE
    if (((pCtrl->InitParams.u32ModeFlag) & E_HVD_INIT_HW_MASK) == E_HVD_INIT_HW_RM)
    {
        pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum = RVD_BBU_DRAM_TBL_ENTRY;
        pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNumTH = RVD_BBU_DRAM_TBL_ENTRY_TH;
        #ifdef VDEC3_FB
        pHVDCtx->u32RV_VLCTableAddr = 0;
        #else
        if (pCtrl->MemMap.u32FrameBufSize > RV_VLC_TABLE_SIZE)
        {
            pHVDCtx->u32RV_VLCTableAddr = pCtrl->MemMap.u32FrameBufSize - RV_VLC_TABLE_SIZE;
    ...
    #endif
    {
        pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum = HVD_BBU_DRAM_TBL_ENTRY;
        pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNumTH = HVD_BBU_DRAM_TBL_ENTRY_TH;
        #if HVD_ENABLE_MVC
        if (bMVC)
        {
            pHVDCtx->_stHVDStream[u8Idx+1].u32BBUEntryNum = MVC_BBU_DRAM_TBL_ENTRY;
            pHVDCtx->_stHVDStream[u8Idx+1].u32BBUEntryNumTH = MVC_BBU_DRAM_TBL_ENTRY_TH;
        }
        #endif /// HVD_ENABLE_MVC
        pHVDCtx->u32RV_VLCTableAddr = 0;
    }
    ...
    else
    {
        HVD_EX_MSG_ERR("failed: Shm addr=0x%lx, Code addr=0x%lx, Bits addr=0x%lx, FB addr=0x%lx, Miu1base=0x%lx, Miu2base=0x%lx\n",
                    (unsigned long)MS_PA2KSEG1((MS_VIRT) pShm),
                    (unsigned long)pCtrl->MemMap.u32CodeBufAddr,
                    (unsigned long)pCtrl->MemMap.u32FrameBufAddr,
                    (unsigned long)pCtrl->MemMap.u32BitstreamBufAddr,
                    (unsigned long)pCtrl->MemMap.u32MIU1BaseAddr,
...
#endif
{
    ...
    if(pHVDCtx->pHVDPreCtrl_Hal[u8Idx]->eDisplayMode == E_HVD_DISPLAY_MODE_MCU)
    {
        pShm->bEnableDispQueue = TRUE;
        pShm->bEnableDispOutSide = TRUE;
        pHVDCtx->_stHVDStream[u8Idx].bDispOutSide = TRUE;
    }
    else if(pHVDCtx->pHVDPreCtrl_Hal[u8Idx]->eDisplayMode == E_HVD_DISPLAY_MODE_HARDWIRE)
    {
        pShm->bEnableDispQueue = FALSE;
        pShm->bEnableDispOutSide = FALSE;
        pHVDCtx->_stHVDStream[u8Idx].bDispOutSide = FALSE;
    }
        ...
        ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK) == E_HVD_INIT_HW_AVC))
    {
        ...
        _phy_to_miu_offset(u8TmpMiuSel, u32Addr, pHVDCtx->pHVDPreCtrl_Hal[u8Idx]->stIapGnShBWMode.u32IapGnBufAddr);

        pShm->u32IapGnBufAddr = u32Addr;
        pShm->u32IapGnBufSize = pHVDCtx->pHVDPreCtrl_Hal[u8Idx]->stIapGnShBWMode.u32IapGnBufSize;

    }

    pShm->u8CodecFeature &= ~E_VDEC_MFCODEC_MASK;
    switch(pHVDCtx->pHVDPreCtrl_Hal[u8Idx]->eMFCodecMode)
    {
...
//        HVD_EX_MSG_DBG("===== Set pShm->u32RM_VLCTableAddr = 0 in InitShareMem\n");
#else
        u32Addr = pCtrl->MemMap.u32FrameBufAddr + pHVDCtx->u32RV_VLCTableAddr;
    ...
    if (_stHVDPreSet[u8Idx].bColocateBBUMode)
    {
          pShm->u32ColocateBBUWritePtr = pShm->u32ColocateBBUReadPtr =  pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr;
    }
    ...
    // Mailbox
        ...
        case E_HVD_SDATA_DISPQ_STATUS_FREE:
        {
            if (pHVDCtx->_stHVDStream[u8Idx].bDispOutSide)
            {
                if (bMVC)
                {
                    if (pHVDCtx->_stHVDStream[u8Idx].u32FreeData == 0xFFFF)
                    {
                        //ALOGE("R1: %x", u32Data);
                        pHVDCtx->_stHVDStream[u8Idx].u32FreeData = u32Data;
                    }
                    else
                    {
                        //ALOGE("R2: %x", (u32Data << 16) | pHVDCtx->_stHVDStream[u8Idx].u32FreeData);
                        HAL_HVD_EX_SetCmd(u32Id, E_HVD_CMD_RELEASE_DISPQ, (u32Data << 16) | pHVDCtx->_stHVDStream[u8Idx].u32FreeData);
                        //pShm->FreeQueue[pShm->u16FreeQWtPtr] = (u32Data << 16) | pHVDCtx->_stHVDStream[u8Idx].u32FreeData;
...
MS_VIRT HAL_HVD_EX_GetData(MS_U32 u32Id, HVD_GetData eType)
{
    ...
    // share memory
        ...
        case E_HVD_GDATA_U64PTS:
        {
            ...
            pHVDCtx->u64pts_real = (MS_U64)(pShm->DispFrmInfo.u32ID_H);
            pHVDCtx->u64pts_real = (pHVDCtx->u64pts_real<<32)|u64pts_low;
            u32Ret = (MS_VIRT)(&(pHVDCtx->u64pts_real));
            break;
        }
        case E_HVD_GDATA_U64PTS_PRE_PARSE:
        {
            u64pts_low = (MS_U64)(pShm->u32WRPTR_PTS_LOW);
            pHVDCtx->u64pts_real = (MS_U64)(pShm->u32WRPTR_PTS_HIGH);
            pHVDCtx->u64pts_real = (pHVDCtx->u64pts_real<<32)|u64pts_low;
            u32Ret = (MS_VIRT)(&(pHVDCtx->u64pts_real));
            break;
        }
        ...
        {
            u32Ret = (MS_U32) pHVDCtx->_u16DispQPtr;
            break;
        }
    ...
    // Mailbox
        ...
        case E_HVD_GDATA_IS_DISP_INFO_CHANGE:      // HVD RISC MBOX 1 (rdy only)
        {
            ...
            if (pShm->bSpsChange &&
                !(pShm->u8FrmPostProcSupport & E_HVD_POST_PROC_DETILE) &&
                IS_TASK_ALIVE(pHVDCtx->_stHVDStream[u8Idx].s32HvdPpTaskId))
            {
                _HVD_EX_PpTask_Delete(&pHVDCtx->_stHVDStream[u8Idx]);
            }
        ...
        case E_HVD_GDATA_BBU_WRITE_PTR:
        {
            ...
            if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
            {
                u32Ret = pHVDCtx->u32VP8BBUWptr;
            }
            else
            {
                u32Ret = pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr;
            }
            break;
        }
    ...
    // FW def
        ...
        case E_HVD_GDATA_FW_BBU_TOTAL_TBL_ENTRY:
            u32Ret = pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNumTH;
            break;
        case E_HVD_GDATA_FW_BBU_TBL_ENTRY_NUMB:
            u32Ret = pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum;
            break;
...
HVD_Return HAL_HVD_EX_SetCmd(MS_U32 u32Id, HVD_User_Cmd eUsrCmd, MS_U32 u32CmdArg)
{
    ...
    {
        pHVDCtx->_stHVDStream[u8Idx].bDispOutSide = (MS_BOOL)u32CmdArg;
    }
    ...
    if (u32Cmd == E_HVD_CMD_FLUSH &&
        IS_TASK_ALIVE(pHVDCtx->_stHVDStream[u8Idx].s32HvdPpTaskId) &&
        pHVDCtx->_stHVDStream[u8Idx].ePpTaskState == E_HAL_HVD_STATE_RUNNING)
    {
        pHVDCtx->_stHVDStream[u8Idx].ePpTaskState = E_HAL_HVD_STATE_PAUSING;
        while (pHVDCtx->_stHVDStream[u8Idx].ePpTaskState != E_HAL_HVD_STATE_PAUSE_DONE)
        {
            _HAL_HVD_Release();
            HVD_Delay_ms(1);
            _HAL_HVD_Entry();
...
HVD_Return HAL_HVD_EX_DeInit(MS_U32 u32Id)
{
    ...
    pHVDCtx->_stHVDStream[u8Idx].bUsed = FALSE;
    pHVDCtx->_stHVDStream[u8Idx].u32CodecType = E_HAL_HVD_NONE;
    ...
    if ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_INPUT_MASK) == E_HVD_INIT_INPUT_DRV)
    {
        if(TRUE == HAL_VPU_EX_HVDInUsed(u32Id))
        {
            if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))//apple
            {
                ...
                pHVDCtx->u32VP8BBUWptr = _HVD_EX_GetBBUReadptr(u32Id);
            }
            else
            {
                if(!_stHVDPreSet[u8Idx].bColocateBBUMode)
                ...
                pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr = _HVD_EX_GetBBUReadptr(u32Id);
            }
        }
        else
        {
    ...
    if (IS_TASK_ALIVE(pHVDCtx->_stHVDStream[u8Idx].s32HvdPpTaskId))
    {
        _HVD_EX_PpTask_Delete(&pHVDCtx->_stHVDStream[u8Idx]);
    }
    ...
    pHVDCtx->_stHVDStream[u8Idx].u32RegBase = 0;
    pHVDHalContext->u8Cidx[u8Idx] = 0xFF;
...
HVD_Return HAL_HVD_EX_PushPacket(MS_U32 u32Id, HVD_BBU_Info *pInfo)
{
    ...
    pHVDCtx->_stHVDStream[u8Idx].u32PTSByteCnt += pInfo->u32Length;
...
void HAL_HVD_EX_SetClearISR(MS_U32 u32RB)
{
...
MS_BOOL HAL_HVD_EX_RstPTSCtrlVariable(MS_U32 u32Id)
{
    ...
    if ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_INPUT_MASK) == E_HVD_INIT_INPUT_DRV)
    {
        ...
        pHVDCtx->_stHVDStream[u8Idx].u32PTSByteCnt = pShm->u32PTStableByteCnt;
        pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr = _HVD_EX_GetPTSTableWptr(u32Id);

        HVD_EX_MSG_DBG("PTS table: WptrAddr:%x RptrAddr:%x ByteCnt:%x PreWptr:%lx\n",
            pShm->u32PTStableWptrAddr, pShm->u32PTStableRptrAddr, pHVDCtx->_stHVDStream[u8Idx].u32PTSByteCnt, (unsigned long)pHVDCtx->_stHVDStream[u8Idx].u32PTSPreWptr);
    }
...
void HAL_HVD_EX_UartSwitch2FW(MS_U32 u32Id, MS_BOOL bEnable)
{
    if (bEnable)
    {
        if (HAL_VPU_EX_IsEVDR2(u32Id))
        {
            _HVD_WriteWordMask(REG_TOP_UART_SEL0, REG_TOP_UART_SEL_VD_MHEG5, REG_TOP_UART_SEL_0_MASK);
        }
        else
        {
            _HVD_WriteWordMask(REG_TOP_UART_SEL0, REG_TOP_UART_SEL_VD_R2_LITE, REG_TOP_UART_SEL_0_MASK);
        }
    }
    else
    {
...
void HAL_HVD_EX_UpdateESWptr_Fire(MS_U32 u32Id)
{
    ...
    if (u8BitMiuSel != u8CodeMiuSel)
    {
        ...
        u32tabsize = pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum << 3;
    ...
    if (E_HVD_INIT_HW_VP8 == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
        _HVD_EX_SetBBUWriteptr(u32Id, HVD_LWORD(pHVDCtx->u32VP8BBUWptr));
        pCtrl->u32BBUWptr_Fired = pHVDCtx->u32VP8BBUWptr;
    }
    else
    {
        _HVD_EX_SetBBUWriteptr(u32Id, HVD_LWORD(pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr));
        pCtrl->u32BBUWptr_Fired = pHVDCtx->_stHVDStream[u8Idx].u32BBUWptr;
    }
}
...
void HAL_HVD_EX_Dump_FW_Status(MS_U32 u32Id)
{
    ...
    if (u32UartCtrl & E_HVD_UART_CTRL_DBG)
    {
        ...
        HVD_PRINT("\tSystime=%u, FWVersionID=0x%x, FwState=0x%x, ErrCode=0x%x, ProgCnt=0x%x\n",
            HVD_GetSysTime_ms(), pShm->u32FWVersionID, pShm->u32FwState, (MS_U32) pShm->u16ErrCode, HAL_VPU_EX_GetProgCnt(u32Id));
...
void HAL_HVD_EX_GetBBUEntry(MS_U32 u32Id, HVD_EX_Drv_Ctrl *pDrvCtrl, MS_U32 u32Idx, MS_U32 *u32NalOffset, MS_U32 *u32NalSize)
{
    ...
    if (u32Idx >= pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum)
    {
        return;
    }
...
void HAL_HVD_EX_Dump_BBUs(MS_U32 u32Id, HVD_EX_Drv_Ctrl *pDrvCtrl, MS_U32 u32StartIdx, MS_U32 u32EndIdx, MS_BOOL bShowEmptyEntry)
{
    ...
    if ((u32StartIdx >= pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum) || (u32EndIdx >= pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum))
    {
        return;
    }
    ...
    do
    {
        ...
        if (u32CurIdx >= pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum)
        {
            u32CurIdx %= pHVDCtx->_stHVDStream[u8Idx].u32BBUEntryNum;
        }
...
void HAL_HVD_EX_SetHwRegBase(MS_U32 u32Id, MS_U32 u32ModeFlag)
{
    ...
    if (pHVDHalContext->u8Cidx[u8Idx] == HWDEC_EVD_LITE)
    {
        pHVDCtx->_stHVDStream[u8Idx].u32RegBase = REG_EVD_LITE_BASE;

        if (((u32ModeFlag & E_HVD_INIT_HW_MASK) != E_HVD_INIT_HW_HEVC) && ((u32ModeFlag & E_HVD_INIT_HW_MASK) != E_HVD_INIT_HW_VP9))
        {
            HVD_EX_MSG_ERR("Not HEVC nor VP9 using HWDEC_EVD_LITE 0x%x, 0x%x  \033[0m\n", u32Id, u32ModeFlag);
        }
    }
    else
    {
        ...
        {
            pHVDCtx->_stHVDStream[u8Idx].u32RegBase = REG_EVD_BASE;
        }
        else if ((u32ModeFlag & E_HVD_INIT_HW_MASK) == E_HVD_INIT_HW_VP9)
        {
            #if SUPPORT_G2VP9 && defined(VDEC3)
            pHVDCtx->_stHVDStream[u8Idx].u32RegBase = REG_G2VP9_BASE;
...
{
    MS_U8 i,j;
    MS_U8 u8EVDTaskCnt = 0;
    MS_U8 u8Idx = _HVD_EX_GetStreamIdx(u32Id);
    HVD_Unit_Ctx *pHVDCtx = &pHVDHalContext->_stCtx[pHVDHalContext->u8Cidx[u8Idx]];

    for (j = 0; j < MAX_HVD_EVD_NUM; j++)  //may refer to _HAL_EX_BBU_EVD_InUsed
    {
        HVD_Unit_Ctx *pCheckHVDCtx = &pHVDHalContext->_stCtx[j];

        for (i = 0; i < HAL_HVD_EX_MAX_SUPPORT_STREAM; i++)
        {
            if ((pCheckHVDCtx->_stHVDStream[i].bUsed) &&
                ((pCheckHVDCtx->_stHVDStream[i].u32CodecType == E_HAL_HVD_HEVC)
                #if SUPPORT_MSVP9
                ||(pCheckHVDCtx->_stHVDStream[i].u32CodecType == E_HAL_HVD_VP9)
                #endif
                ))
            {
                u8EVDTaskCnt++;
    ...
    HVD_EX_MSG_DBG("EVD clk=%d\n", pHVDCtx->u32EVDClockType);

    if (pHVDHalContext->u8Cidx[u8Idx] == HWDEC_EVD_LITE)
    {
#ifdef CONFIG_MSTAR_CLKM
        HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_EVD_LITE, bEnable);
        HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_EVD_PPU_LITE, bEnable);
        HAL_VPU_EX_SetClkManagement(E_VPU_EX_CLKPORT_HVD_AEC_LITE, bEnable);
#else
        if (bEnable)
        {
            _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, ~TOP_CKG_EVD_PPU_LITE_DIS, TOP_CKG_EVD_PPU_LITE_DIS);
            _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, ~TOP_CKG_EVD_LITE_DIS, TOP_CKG_EVD_LITE_DIS);
            _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, ~TOP_CKG_HVD_AEC_LITE_DIS, TOP_CKG_HVD_AEC_LITE_DIS);
        }
        else
        {
            _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_DIS, TOP_CKG_EVD_PPU_LITE_DIS);
        ...
        switch (pHVDCtx->u32EVDClockType)
        {
            case 576:
            {
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_PLL_BUF, TOP_CKG_EVD_PPU_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, TOP_CKG_EVD_LITE_480MHZ, TOP_CKG_EVD_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, TOP_CKG_HVD_AEC_LITE_288MHZ, TOP_CKG_HVD_AEC_LITE_CLK_MASK);
                break;
            }
            case 532:
            {
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_MIU128PLL, TOP_CKG_EVD_PPU_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, TOP_CKG_EVD_LITE_MIU128PLL, TOP_CKG_EVD_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, TOP_CKG_HVD_AEC_LITE_288MHZ, TOP_CKG_HVD_AEC_LITE_CLK_MASK);
                break;
            }
            case 466:
            {
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_MIU256PLL, TOP_CKG_EVD_PPU_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, TOP_CKG_EVD_LITE_MIU256PLL, TOP_CKG_EVD_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, TOP_CKG_HVD_AEC_LITE_288MHZ, TOP_CKG_HVD_AEC_LITE_CLK_MASK);
                break;
            }
            case 480:
            {
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_480MHZ, TOP_CKG_EVD_PPU_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, TOP_CKG_EVD_LITE_480MHZ, TOP_CKG_EVD_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, TOP_CKG_HVD_AEC_LITE_288MHZ, TOP_CKG_HVD_AEC_LITE_CLK_MASK);
                break;
            }
            case 384:
            {
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_384MHZ, TOP_CKG_EVD_PPU_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, TOP_CKG_EVD_LITE_384MHZ, TOP_CKG_EVD_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, TOP_CKG_HVD_AEC_LITE_288MHZ, TOP_CKG_HVD_AEC_LITE_CLK_MASK);
                break;
            }
            case 320:
            {
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_320MHZ, TOP_CKG_EVD_PPU_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, TOP_CKG_EVD_LITE_320MHZ, TOP_CKG_EVD_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, TOP_CKG_HVD_AEC_LITE_288MHZ, TOP_CKG_HVD_AEC_LITE_CLK_MASK);
                break;
            }
            case 240:
            {
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_240MHZ, TOP_CKG_EVD_PPU_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, TOP_CKG_EVD_LITE_240MHZ, TOP_CKG_EVD_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, TOP_CKG_HVD_AEC_LITE_240MHZ, TOP_CKG_HVD_AEC_LITE_CLK_MASK);
                break;
            }
            case 192:
            {
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU_LITE, TOP_CKG_EVD_PPU_LITE_192MHZ, TOP_CKG_EVD_PPU_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_CKG_EVD_LITE, TOP_CKG_EVD_LITE_192MHZ, TOP_CKG_EVD_LITE_MASK);
                _HVD_WriteWordMask(REG_TOP_HVD_AEC_LITE, TOP_CKG_HVD_AEC_LITE_216MHZ, TOP_CKG_HVD_AEC_LITE_CLK_MASK);
                break;
            }
            default:
            {
        ...
        if (bEnable)
        {
            _HVD_WriteByteMask(REG_HICODEC_LITE_SRAM_SD_EN, HICODEC_LITE_SRAM_HICODEC0, HICODEC_LITE_SRAM_HICODEC0);
            HVD_Delay_ms(1);
        }
        else
        {
...
void HAL_EVD_EX_ClearTSPInput(MS_U32 u32Id)
{
    ...
    #endif
    {
        _HVD_Write2Byte(EVD_REG_RESET(u8EVD), (_HVD_Read2Byte(EVD_REG_RESET(u8EVD)) & ~EVD_REG_RESET_HK_TSP2EVD_EN));  //0: tsp2hvd, coz EVD & HVD use the same MVD parser for main-DTV mode
    }
    else
    {
        _HVD_Write2Byte(EVD_REG_RESET(u8EVD), (_HVD_Read2Byte(EVD_REG_RESET(u8EVD)) & ~EVD_REG_RESET_USE_HVD_MIU_EN));  //0: tsp2hvd, coz EVD & HVD use the same MVD parser for sub-DTV mode
    }
...
static MS_BOOL HAL_EVD_EX_DeinitHW(MS_U32 u32Id)
{
    ...
    while (u16Timeout)
    {
        if ((_HVD_Read2Byte(EVD_REG_RESET(u8EVD)) & (EVD_REG_RESET_SWRST_FIN)) == (EVD_REG_RESET_SWRST_FIN))
        {
            break;
        }
        u16Timeout--;
...
static void HAL_VP9_EX_PowerCtrl(MS_U32 u32Id, MS_BOOL bEnable)
{
    ...
    switch (pHVDCtx->u32VP9ClockType)
    {
        case 432:
        {
...
MS_BOOL HAL_VP9_EX_DeinitHW(MS_U32 u32Id)
{
    MS_U16 u16Timeout = 1000;
...
MS_BOOL HAL_HVD_EX_SetLockDownOpteeRegister(void* param)
{
    MS_PHY u32StAddr;
    ...
    Lock_info = (Lock_Register_Info*)param;

    MDrv_MMIO_GetBASE(&u32HVDRegOSBase, &u32NonPMBankSize, MS_MODULE_HW);

    _phy_to_miu_offset(u8MiuSel, u32StartOffset, Lock_info->BSBufAddr);
    u32StAddr = u32StartOffset;

    if(Lock_info->Decoder== E_Decode_HVD || Lock_info->Decoder == E_Decode_VP8)
    {
        u32RegBase = REG_HVD_BASE;
        printf("[VDEC][OPTEE]Dec=%d,RegBase=%x\n",Lock_info->Decoder,u32RegBase);
    }
    else if(Lock_info->Decoder == E_Decode_EVD)
    {
        //u32RegBase = REG_EVD_LITE_BASE;
        u32RegBase = REG_EVD_BASE;
        printf("[VDEC][OPTEE]Dec=%d,RegBase=%x\n",Lock_info->Decoder,u32RegBase);
    }

    if(Lock_info->stream_ID == 0)
    {
        if(Lock_info->Decoder == E_Decode_HVD || Lock_info->Decoder == E_Decode_EVD)
        {
            printf("[VDEC][OPTEE]%d:set HVD/EVD register\n",Lock_info->stream_ID);
            _HVD_Write2Byte(HVD_REG_ESB_ST_ADDR_L(u32RegBase), HVD_LWORD(u32StAddr >> 3));
            _HVD_Write2Byte(HVD_REG_ESB_ST_ADDR_H(u32RegBase), HVD_HWORD(u32StAddr >> 3));
            _HVD_Write2Byte(HVD_REG_ESB_LENGTH_L(u32RegBase), HVD_LWORD(Lock_info->BSBufSize>>3));
            _HVD_Write2Byte(HVD_REG_ESB_LENGTH_H(u32RegBase), HVD_HWORD(Lock_info->BSBufSize>>3));
        }
        else if(Lock_info->Decoder == E_Decode_VP8)
        {
            printf("[VDEC][OPTEE]%d:set VP8 register\n",Lock_info->stream_ID);
            _HVD_Write2Byte(HVD_REG_ESB_ST_ADR_L_BS34, HVD_LWORD(u32StAddr >> 3));
            _HVD_Write2Byte(HVD_REG_ESB_ST_ADR_H_BS34, HVD_HWORD(u32StAddr >> 3));
            _HVD_Write2Byte(HVD_REG_ESB_LENGTH_L_BS34, HVD_LWORD(Lock_info->BSBufSize>>3));
            _HVD_Write2Byte(HVD_REG_ESB_LENGTH_H_BS34, HVD_HWORD(Lock_info->BSBufSize>>3));
        }
    }
    else if(Lock_info->stream_ID == 1)
    {
        ...
        {
            printf("[VDEC][OPTEE]%d:set HVD/EVD register\n",Lock_info->stream_ID);
            _HVD_Write2Byte(HVD_REG_ESB_ST_ADDR_L_BS2(u32RegBase), HVD_LWORD(u32StAddr >> 3));
            _HVD_Write2Byte(HVD_REG_ESB_ST_ADDR_H_BS2(u32RegBase), HVD_HWORD(u32StAddr >> 3));
            _HVD_Write2Byte(HVD_REG_ESB_LENGTH_L_BS2(u32RegBase), HVD_LWORD(Lock_info->BSBufSize >> 3));
            _HVD_Write2Byte(HVD_REG_ESB_LENGTH_H_BS2(u32RegBase), HVD_HWORD(Lock_info->BSBufSize >> 3));
        }
        else if(Lock_info->Decoder == E_Decode_VP8)
        {
            printf("[VDEC][OPTEE]%d:set VP8 register\n",Lock_info->stream_ID);
