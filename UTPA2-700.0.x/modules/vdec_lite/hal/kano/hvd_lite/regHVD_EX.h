...
#define MVD_REG_PAS1_SEL_HI_OR_HILITE   (REG_MVD_BASE + (0x004c<<1))
#define MVD_REG_PAS2_SEL_HI_OR_HILITE   (REG_MVD_BASE + (0x005c<<1))
    #define MVD_REG_SEL_HILITE          BIT(14)
...
// HVD Reg
//------------------------------------------------------------------------------
// on kano, pHVDHalContext->_stCtx[0] for HWDEC_EVD and pHVDHalContext->_stCtx[1] for HWDEC_EVD_LITE
#define HWDEC_EVD       0
#define HWDEC_EVD_LITE  1

#define REG_HVD_BASE        (0x1B00)
#define REG_EVD_BASE        (0x1C00)
#define REG_EVD_LITE_BASE   (0x1700)
#define REG_MIU_SOURCE_BASE (0x0600)
#define REG_G2VP9_BASE      (0x60E00)

#define EVD_BASE(evd)       ((evd==HWDEC_EVD)?(REG_EVD_BASE):(REG_EVD_LITE_BASE))
...
#define EVD_REG_RESET(evd)            (EVD_BASE(evd) + ((0x0001) << 1))
...
#define EVD_REG_VP9_MODE(evd)          (EVD_BASE(evd) + ((0x001b) << 1))
...
#define REG_TOP_CKG_EVD_LITE            (CLKGEN2_REG_BASE+(0x0017<<1))
    #define TOP_CKG_EVD_LITE_MASK              BMASK(4:2)
    #define TOP_CKG_EVD_LITE_DIS               BIT(0)
    #define TOP_CKG_EVD_LITE_INV               BIT(1)
    #define TOP_CKG_EVD_LITE_PLL_BUF           BITS(4:2, 0)
    #define TOP_CKG_EVD_LITE_MIU128PLL         BITS(4:2, 1)
    #define TOP_CKG_EVD_LITE_MIU256PLL         BITS(4:2, 2)
    #define TOP_CKG_EVD_LITE_480MHZ            BITS(4:2, 3)
    #define TOP_CKG_EVD_LITE_384MHZ            BITS(4:2, 4)
    #define TOP_CKG_EVD_LITE_320MHZ            BITS(4:2, 5)
    #define TOP_CKG_EVD_LITE_240MHZ            BITS(4:2, 6)
    #define TOP_CKG_EVD_LITE_192MHZ            BITS(4:2, 7)

#define REG_TOP_CKG_EVD_PPU_LITE        (CLKGEN2_REG_BASE+(0x0017<<1))
    #define TOP_CKG_EVD_PPU_LITE_MASK          BMASK(12:10)
    #define TOP_CKG_EVD_PPU_LITE_DIS           BIT(8)
    #define TOP_CKG_EVD_PPU_LITE_INV           BIT(9)
    #define TOP_CKG_EVD_PPU_LITE_PLL_BUF       BITS(12:10, 0)
    #define TOP_CKG_EVD_PPU_LITE_MIU128PLL     BITS(12:10, 1)
    #define TOP_CKG_EVD_PPU_LITE_MIU256PLL     BITS(12:10, 2)
    #define TOP_CKG_EVD_PPU_LITE_480MHZ        BITS(12:10, 3)
    #define TOP_CKG_EVD_PPU_LITE_384MHZ        BITS(12:10, 4)
    #define TOP_CKG_EVD_PPU_LITE_320MHZ        BITS(12:10, 5)
    #define TOP_CKG_EVD_PPU_LITE_240MHZ        BITS(12:10, 6)
    #define TOP_CKG_EVD_PPU_LITE_192MHZ        BITS(12:10, 7)
...
#define REG_TOP_VP8                  (CLKGEN2_REG_BASE+(0x001d<<1))
    ...
    #define TOP_CKG_VP8_288MHZ                  BITS(3:2, 0)  // default use this
    #define TOP_CKG_VP8_240MHZ                  BITS(3:2, 1)
    #define TOP_CKG_VP8_216MHZ                  BITS(3:2, 2)
    #define TOP_CKG_VP8_320MHZ                  BITS(3:2, 3)  // for overclocking
