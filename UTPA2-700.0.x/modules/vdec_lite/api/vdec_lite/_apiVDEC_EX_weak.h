...
__vdec_if E_MVD_Result MDrv_MVD_REE_GetVsyncExtShm(MS_VIRT* u32SHMAddr, MS_VIRT* u32VsyncExtShmOffset) __vdec_weak;
...
#ifdef VDEC3
__vdec_if HVD_EX_Result MDrv_HVD_EX_Init(MS_U32 u32Id, HVD_EX_MemCfg *mem, HVD_EX_InitSettings *InitParam, MS_BOOL bFWdecideFB, MS_BOOL bDRVdecideBS) __vdec_weak;
#else
