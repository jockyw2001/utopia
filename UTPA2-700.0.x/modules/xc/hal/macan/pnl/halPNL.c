...
#include "Macan_pnl_lpll_tbl.h"
#include "Macan_pnl_lpll_ext_tbl.h"
...
#define MOD_LVDS_HW_CALI_TIME_OUT  3
...
MS_U8 MHal_MOD_PowerOn(void *pInstance, MS_BOOL bEn, MS_U8 u8LPLL_Type,MS_U8 DualModeType, MS_U16 u16OutputCFG0_7, MS_U16 u16OutputCFG8_15, MS_U16 u16OutputCFG16_21)
{
    ...
    if( bEn )
    {
        ...
        {
            MOD_A_W2BYTE(REG_MOD_A_BK00_58_L, 0x0000);  // [11:8]reg_ckg_dot_mini_pre2_osd
            MOD_A_W2BYTE(REG_MOD_A_BK00_59_L, 0x0000);  // [3:0]reg_ckg_dot_mini_osd
        }
        else
        {
                               ...
                               MS_U16 u16OutputOrder12_13)
{
    ...
    else
    {
            ...
            ||(pPNLResourcePrivate->stdrvPNL._stPnlInitData.eLPLL_Type_Ext == E_PNL_LPLL_VBY1_8BIT_8LANE))
        {
            ...
            {
                MOD_W2BYTE(REG_MOD_BK00_08_L, 0xBA98);
...
///Not Support
                ...
                case E_PNL_LPLL_EPI28_6P:
                    ...
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_28_8BIT_6PAIR_4K_EPI3G_FOR_TRY_150to150MHz;
                    }
                    else if((ldHz >= 1500000000UL) && (ldHz < 1800000000UL))
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_28_8BIT_6PAIR_4K_EPI3G_FOR_TRY_150to180MHz;
                    }
                    else
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_28_8BIT_6PAIR_4K_EPI3G_FOR_TRY_180to300MHz;
                    }
                break;
                ...
                case E_PNL_LPLL_EPI28_8P:
                    if(ldHz < 1500000000UL)
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_28_8BIT_8PAIR_4K_EPI3G_FOR_TRY_150to150MHz;
                    }
                    else if((ldHz >= 1500000000UL) && (ldHz < 2400000000UL))
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_28_8BIT_8PAIR_4K_EPI3G_FOR_TRY_150to240MHz;
                    }
                    else
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_28_8BIT_8PAIR_4K_EPI3G_FOR_TRY_240to300MHz;
                    }
                break;
                ...
                case E_PNL_LPLL_EPI28_12P:
                    if(ldHz < 1500000000UL)
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_28_8BIT_12PAIR_4K_150to150MHz;
                    }
                    else
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_28_8BIT_12PAIR_4K_150to300MHz;
                    }
                break;
                ...
                case E_PNL_LPLL_EPI24_12P:
                    if(ldHz < 1500000000UL)
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_24_10BIT_12PAIR_4K_CASE1_150to150MHz;
                    }
                    else
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_EPI_24_10BIT_12PAIR_4K_CASE1_150to300MHz;
                    }
                break;
                ...
                case E_PNL_LPLL_ISP_8BIT_6P_D:
                    if(ldHz < 1500000000UL)
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_ISP_8BIT_6PAIR_X1_DUAL_150to150MHz;
                    }
                    else
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_ISP_8BIT_6PAIR_X1_DUAL_150to300MHz;
                    }
                break;
                ...
                case E_PNL_LPLL_USI_T_8BIT_12P:
                    if(ldHz < 1500000000UL)
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_USI_T_8BIT_12PAIR_4K_150to150MHz;
                    }
                    else
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_USI_T_8BIT_12PAIR_4K_150to300MHz;
                    }
                break;
                ...
                case E_PNL_LPLL_CMPI24_10BIT_12P:
                    if(ldHz < 1500000000UL)
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_CMPI_24_10BIT_12PAIR_X1_150to150MHz;
                    }
                    else
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_CMPI_24_10BIT_12PAIR_X1_150to300MHz;
                    }
                break;
                ...
                case E_PNL_LPLL_CMPI27_8BIT_12P:
                    if(ldHz < 1500000000UL)
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_CMPI_27_8BIT_12PAIR_X1_150to150MHz;
                    }
                    else
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_CMPI_27_8BIT_12PAIR_X1_150to300MHz;
                    }
                break;
                ...
                case E_PNL_LPLL_VBY1_10BIT_8LANE:
                    ...
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_VBY1_8CH_10BIT_4K_150to300MHz;
                    }
                ...
                case E_PNL_LPLL_VBY1_8BIT_8LANE:
                    ...
                    {
                        u8SupportedLPLLIndex = E_PNL_SUPPORTED_LPLL_VBY1_8CH_8BIT_4K_200to300MHz;
                    }
                break;
        ...
        case E_PNL_LPLL_OSD:
        {
            switch (eLPLL_Type)
            {
                ...
                case E_PNL_LPLL_VBY1_8BIT_2LANE:
                    ...
                    else if((ldHz >= 750000000) && (ldHz < 1000000000))
                    {
                ...
                case E_PNL_LPLL_VBY1_8BIT_1LANE:
                    ...
                    else if((ldHz >= 375000000) && (ldHz < 500000000))
                    {
            ...
            default:
                if(eLPLL_Type == E_PNL_LPLL_VBY1_10BIT_8LANE)
                {
                    ...
                    else
                    {
                        ...
                        MOD_A_W2BYTE(REG_MOD_A_BK00_01_L, 0x0000); //[15:0]reg_output_conf[15:0]
                    }
                }
    ...
    else
    {
        switch(eOutputMode)
        {
            ...
            default:
                ...
                //Should not execute this task while output config is enabled, otherwise it causes clk pull down for 3ms.
                if((MOD_A_R2BYTE(REG_MOD_A_BK00_00_L)==0x0000)&&(MOD_A_R2BYTE(REG_MOD_A_BK00_01_L)==0x0000))
                {
...
void MHal_PNL_Init_XC_Clk(void *pInstance, PNL_InitData *pstPanelInitData)
{
    PNL_INSTANCE_PRIVATE *pPNLInstancePrivate = NULL;
    PNL_RESOURCE_PRIVATE* pPNLResourcePrivate = NULL;
    MS_U16 u16_fifo_odclk_mask = 0;
    MS_U16 u16_fifo_odclk_data = 0;
    ...
    if((pstPanelInitData->eLPLL_Type == E_PNL_TYPE_LVDS)&&(pstPanelInitData->eLPLL_Mode == E_PNL_MODE_SINGLE))
        W2BYTEMSK(L_CLKGEN0(0x53), CKG_ODCLK_CLK_LPLL_DIV_2, CKG_ODCLK_MASK);      // select source tobe LPLL clock
    else
       ...
       (pstPanelInitData->eLPLL_Type <= E_PNL_LPLL_VBY1_8BIT_8LANE))
    {
        ...
        W2BYTE(L_CLKGEN0(0x63), 0x0001);   //[11:8]ckg_tx_mod_osd[4:0]osd2mod
        W2BYTE(REG_RVD_09_L, 0x0100); //[12:8]ckg_vby1_fifo_osd [3:0]clk_vby1_fifo
        W2BYTEMSK(L_CLKGEN0(0x55), 0x00, 0xF00); //[11:8] reg_ckg_osdc

        // merge clk (1)
        // 7A[3:0]:Vby1 LPLL_CLK replace by LPLL_FIFO
        // 1. for vby1 10 bit mode ( 4 bytes mode ), not vby1 3 bytes mode
        // 2. replace process start toggle

        // merge clk (2)
        // 7A[7:4]:CLK_ODCLK_A clock setting
        // separate mod analog clk
        // default follow odclk_mft
        // be used in TTL

        // merge clk (3)
        // 7A[11:8]:reg_ckg_nossc_odclk
        // be used in TCON
        u16_fifo_odclk_mask = (CKG_VBY1_VMODE_MASK | CKG_ODCLK_A_GATED | CKG_NOSSC_ODCLK_GATED);
        if( E_PNL_LPLL_VBY1_10BIT_8LANE == pstPanelInitData->eLPLL_Type)
        {
            u16_fifo_odclk_data = (CKG_VBY1_VMODE_LPLL_FIFO | CKG_ODCLK_A_GATED | CKG_NOSSC_ODCLK_GATED);
            W2BYTEMSK(REG_CKG_VBY1_VMODE, u16_fifo_odclk_data, u16_fifo_odclk_mask);
        }
        else if( E_PNL_LPLL_VBY1_10BIT_4LANE == pstPanelInitData->eLPLL_Type)
        {
            u16_fifo_odclk_data = (CKG_VBY1_VMODE_LPLL_FIFO_DIV2 | CKG_ODCLK_A_GATED | CKG_NOSSC_ODCLK_GATED);
            W2BYTEMSK(REG_CKG_VBY1_VMODE, u16_fifo_odclk_data, u16_fifo_odclk_mask);
        }
        else if( E_PNL_LPLL_VBY1_10BIT_2LANE == pstPanelInitData->eLPLL_Type)
        {
            u16_fifo_odclk_data = (CKG_VBY1_VMODE_LPLL_FIFO_DIV4 | CKG_ODCLK_A_GATED | CKG_NOSSC_ODCLK_GATED);
            W2BYTEMSK(REG_CKG_VBY1_VMODE, u16_fifo_odclk_data, u16_fifo_odclk_mask);
        }
        else
        {
            // 7A[3:0]:Vby1 LPLL_CLK replace by LPLL_FIFO, default clk from scaler
            u16_fifo_odclk_data = (CKG_VBY1_VMODE_LPLL_CLK | CKG_ODCLK_A_GATED | CKG_NOSSC_ODCLK_GATED);
            W2BYTEMSK(REG_CKG_VBY1_VMODE, u16_fifo_odclk_data, u16_fifo_odclk_mask);
        }
    }
    else
    {
        ...
        {
            W2BYTE(REG_CLKGEN0_57_L,0x0008);
            W2BYTE(0x101EA0,0x0010);
            W2BYTE(L_CLKGEN0(0x7A),0x01C0);
        }
        else
        {
        ...
        {
            W2BYTE(L_CLKGEN0(0x63),0x0001); //[11:8]ckg_tx_mod [3:0]ckg_osd2mod
...
void MHal_PNL_Init_MOD(void *pInstance, PNL_InitData *pstPanelInitData)
{
        ...
        (pstPanelInitData->eLPLL_Type_Ext<= E_PNL_LPLL_VBY1_8BIT_8LANE)))
    {
        ...
        MOD_W2BYTEMSK(REG_MOD_BK00_62_L, 0xA000, 0xFD8F); //[15]proc_st[13:12]byte_mode 4 byte mode[6]4ch_vby1[9]swap

        // SC4 reg62[6]reg_vby1_4ch:enable 4ch vx1mode
        ...
        {
            printf("\n[%s][%d]Vx1 1 division\n", __FUNCTION__, __LINE__);
            if((pstPanelInitData->eLPLL_Type_Ext == E_PNL_LPLL_VBY1_10BIT_1LANE)||
                (pstPanelInitData->eLPLL_Type_Ext == E_PNL_LPLL_VBY1_8BIT_1LANE))
            {
                MOD_W2BYTEMSK(REG_MOD_BK00_20_L, 0x0001, 0x0007);
            }
            else
            {
        ...
        {
            MOD_W2BYTEMSK(REG_MOD_BK00_63_L, 0x0000, BIT(12)); // [12] enable 8ch vx1 mode : 0
        }
        ...
        MOD_A_W2BYTEMSK(REG_MOD_A_BK00_3C_L, 0x0FFF, 0x3FFF);   //reg_gcr_test_ch
        ...
        // [0] reg_vby1_8v4o_mode, [3]reg_vby1_ext_ptr_en
        // [4] reg_vby1_8vlo_mode: vby1 8 video + hslvds osd mode
        // [5] reg_vby1_proc_auto_fix: vby1 hw auto gen proc_st trig
        // [6] reg_vby1_ext_fsm_en: config each vby1 set use same FSM state (split video/osd path)
        // [7] reg_vby1_hw_lock: set Vby1 lock sequence by HW mode
        // [8] reg_vby1_fifo_rptr_align: When toggle proc_st, Rptr run to Byte mode boundary, then jump to ini value.
        // [15] reg_vby1_disparity_mode
        MOD_W2BYTEMSK(REG_MOD_BK00_67_L, BIT(3), BIT(0)|BIT(3));
        MOD_W2BYTEMSK(REG_MOD_BK00_67_L, (BIT(5)|BIT(6)|BIT(7)), (BIT(4)|BIT(5)|BIT(6)|BIT(7)) );
        MOD_W2BYTEMSK(REG_MOD_BK00_67_L, 0x0000, BIT(8) );
    ...
    else
    {
        if((pstPanelInitData->eLPLL_Type == E_PNL_TYPE_LVDS)&&(pstPanelInitData->eLPLL_Mode == E_PNL_MODE_SINGLE))
        {
            MOD_W2BYTEMSK(REG_MOD_BK00_20_L, 0x0001, 0x0007);//[2:0]reg_mft_mode, 2p to 1p mode
        }
        else
        {
            MOD_W2BYTEMSK(REG_MOD_BK00_20_L, 0x0000, 0x0007);//[2:0]reg_mft_mode
    ...
    if(((pstPanelInitData->eLPLL_Type_Ext>= E_PNL_LPLL_VBY1_10BIT_4LANE)&&
        (pstPanelInitData->eLPLL_Type_Ext<= E_PNL_LPLL_VBY1_8BIT_8LANE)))
        MOD_A_W2BYTEMSK(REG_MOD_A_BK00_3A_L, 0x0000, 0xF000);       //bank selection for skew clock
    ...
    {
        MOD_A_W2BYTEMSK(REG_MOD_A_BK00_70_L, 0x7, 0x07);
    }
...
MS_U8 msModCurrentCalibration(void *pInstance)
{
    ...
    while(1)
    {
        ...
        if (MOD_R2BYTEMSK(REG_MOD_BK00_3D_L, 0x6000) == 0x4000)
        {
            ...
            u16ICONtempCH0_1   = _Hal_MOD_Refine_ICON( MOD_A_R2BYTEMSK(REG_MOD_A_BK00_08_L, 0xFFFF) );
            u16ICONtempCH2_3   = _Hal_MOD_Refine_ICON( MOD_A_R2BYTEMSK(REG_MOD_A_BK00_09_L, 0xFFFF) );
            u16ICONtempCH4_5   = _Hal_MOD_Refine_ICON( MOD_A_R2BYTEMSK(REG_MOD_A_BK00_0A_L, 0xFFFF) );
            u16ICONtempCH6_7   = _Hal_MOD_Refine_ICON( MOD_A_R2BYTEMSK(REG_MOD_A_BK00_0B_L, 0xFFFF) );
            u16ICONtempCH8_9   = _Hal_MOD_Refine_ICON( MOD_A_R2BYTEMSK(REG_MOD_A_BK00_0C_L, 0xFFFF) );
            u16ICONtempCH10_11 = _Hal_MOD_Refine_ICON( MOD_A_R2BYTEMSK(REG_MOD_A_BK00_0D_L, 0xFFFF) );
            u16ICONtempCH12_13 = _Hal_MOD_Refine_ICON( MOD_A_R2BYTEMSK(REG_MOD_A_BK00_0E_L, 0xFFFF) );

            //close reg_keep_cal_value
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_72_L, 0x0000, BIT(15));

            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_08_L, u16ICONtempCH0_1, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_09_L, u16ICONtempCH2_3, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0A_L, u16ICONtempCH4_5, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0B_L, u16ICONtempCH6_7, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0C_L, u16ICONtempCH8_9, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0D_L, u16ICONtempCH10_11, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0E_L, u16ICONtempCH12_13, 0xFFFF);
        ...
        if (u8CheckTimes > MOD_LVDS_HW_CALI_TIME_OUT)
        {
            ...
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_08_L, u16ICONtempDefault, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_09_L, u16ICONtempDefault, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0A_L, u16ICONtempDefault, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0B_L, u16ICONtempDefault, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0C_L, u16ICONtempDefault, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0D_L, u16ICONtempDefault, 0xFFFF);
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_0E_L, u16ICONtempDefault, 0xFFFF);
    ...
    MOD_A_W2BYTEMSK(REG_MOD_A_BK00_70_L, 0x00, BIT(7));         // Disable calibration function
...
PNL_Result MHal_PNL_MOD_Calibration(void *pInstance)
{
    ...
    if(pPNLResourcePrivate->stdrvPNL._stPnlInitData.eLPLL_Type !=E_PNL_TYPE_MINILVDS)
        MOD_A_W2BYTEMSK(REG_MOD_A_BK00_70_L, u8Cab, 0x07);
                              ...
                              MS_U16 u16OutputOrder12_13)
{
    ...
    else
    {
            ...
            ||(pPNLResourcePrivate->stdrvPNL._stPnlInitData.eLPLL_Type_Ext == E_PNL_LPLL_VBY1_8BIT_8LANE))
        {
            if(pPNLResourcePrivate->stdrvPNL._stPnlInitData.u16MOD_CTRLA & BIT(1))
            {
                MOD_A_W2BYTEMSK(REG_MOD_A_BK00_38_L, 0x1D, 0x1F);
            }
            else
            {
                MOD_A_W2BYTEMSK(REG_MOD_A_BK00_38_L, 0x1D, 0x1F);
        ...
        {//LVDS
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_38_L, 0x1F, 0x1F);
                 ...
                 ||(pPNLResourcePrivate->stdrvPNL._stPnlInitData.eLPLL_Type_Ext == E_PNL_LPLL_VBY1_8BIT_4LANE))
        {
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_38_L, 0x0D, 0x1F);
        }
        else if(   (pPNLResourcePrivate->stdrvPNL._stPnlInitData.eLPLL_Type_Ext == E_PNL_LPLL_VBY1_10BIT_2LANE)
                 ||(pPNLResourcePrivate->stdrvPNL._stPnlInitData.eLPLL_Type_Ext == E_PNL_LPLL_VBY1_8BIT_2LANE))
        {
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_38_L, 0x05, 0x1F);
        }
        else
        {
            MOD_A_W2BYTEMSK(REG_MOD_A_BK00_38_L, 0x1F, 0x1F);
