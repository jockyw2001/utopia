...
#define REG_CLKGEN0_7A_L            (REG_CHIPTOP_BASE + 0xF4)
...
//clk setting be added in macan
//replace process start toggle in 4 bytes mode
#define REG_CKG_VBY1_VMODE                  REG_CLKGEN0_7A_L
    #define CKG_VBY1_VMODE_MASK             (BIT(3) | BIT(2) | BIT(1) | BIT(0))
    #define CKG_VBY1_VMODE_LPLL_CLK         (0 << 3) // clk from scaler
    #define CKG_VBY1_VMODE_LPLL_FIFO        (0x08)
    #define CKG_VBY1_VMODE_LPLL_FIFO_DIV2   (0x09)
    #define CKG_VBY1_VMODE_LPLL_FIFO_DIV4   (0x0A)
    #define CKG_VBY1_VMODE_LPLL_FIFO_DIV8   (0x0B)

//clk setting be added in macan
//separate mod analog clk
#define REG_CKG_ODCLK_A               REG_CLKGEN0_7A_L
    #define CKG_ODCLK_A_GATED         (BIT(4))
    #define CKG_ODCLK_A_INVERT        (BIT(5))
    #define CKG_ODCLK_A_MASK          (BIT(7) | BIT(6))
    #define CKG_ODCLK_A_CLK_DIV2      (1 << 6)
    #define CKG_ODCLK_A_CLK           (3 << 6)

//clk setting be added in macan
//used in tcon
#define REG_CKG_NOSSC_ODCLK               REG_CLKGEN0_7A_L
    #define CKG_NOSSC_ODCLK_GATED         (BIT(8))
    #define CKG_NOSSC_ODCLK_INVERT        (BIT(9))
    #define CKG_NOSSC_ODCLK_MASK          (BIT(11) | BIT(10))
    #define CKG_NOSSC_ODCLK_CLK_DIV2      (1 << 10)
    #define CKG_NOSSC_ODCLK_CLK           (3 << 10)
