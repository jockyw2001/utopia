...
static MS_BOOL abBwsRecord[MAX_WINDOW] = {FALSE};
...
void Hal_ADC_auto_adc_backup(void *pInstance, SCALER_WIN eWindow)
{
    ...
    abBwsRecord[eWindow] = Hal_SC_get_bws_mode(pInstance, eWindow);
    Hal_SC_set_bws_mode(pInstance, FALSE, eWindow);
    //MDrv_WriteByte(BK_SELECT_00, u8Bank);
}
