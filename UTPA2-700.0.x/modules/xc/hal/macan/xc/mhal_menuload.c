...
MS_U16 Hal_XC_MLG_get_status(void *pInstance)
{
    ...
    return ((SC_R2BYTE(psXCInstPri->u32DeviceID, REG_SC_BK67_11_L) & 0x0001));
#else
...
#ifdef USE_PANEL_GAMMA
     SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK67_11_L, bEn?BIT(0):0, BIT(0));
#else
...
void Hal_XC_MLG_set_len(void *pInstance, MS_U16 u16Len)
{
    ...
    u16Len &= 0x7FF;
#ifdef USE_PANEL_GAMMA
     SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK67_1B_L, u16Len, 0x7FF);
#else
...
#ifdef USE_PANEL_GAMMA
     SC_W2BYTE(psXCInstPri->u32DeviceID, REG_SC_BK67_18_L, u16depth);
#else
...
#ifdef USE_PANEL_GAMMA
     SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK67_12_L, (MS_U16) (u32addr & 0x0000FFFF)        , 0xFFFF);
     SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK67_13_L, (MS_U16)((u32addr & 0x07FF0000) >> 16) , 0x07FF);
#else
