...
#define  MS_MLG_REG_LEN         0x100 // how many data in one MIU request

#define  MS_MLG_CMD_LEN         BYTE_PER_WORD
#define  MS_MLG_MEM_BASE_UNIT   BYTE_PER_WORD
#ifdef CONFIG_ROLLS_ROYCE
...
typedef struct
{
    MS_U64 BData0 : 12;     //11:0
    MS_U64 BData1 : 12;     //23:12
    MS_U64 BData2 : 12;     //35:24
    MS_U64 GData0 : 12;     //47:36
    MS_U64 GData1 : 12;     //59:48
    MS_U64 GData2_L : 4;    //63:60
    MS_U64 GData2_H : 8;    //71:64
    MS_U64 RData0 : 12;     //83:72
    MS_U64 RData1 : 12;     //95:84
    MS_U64 RData2 : 12;     //107:96
    MS_U64 BEnable : 1 ;    //108
    MS_U64 GEnable : 1 ;    //109
    MS_U64 REnable : 1 ;    //110
    MS_U64 Dummy0 :17;      //127:111
    MS_U64 Dummy1;
    MS_U64 Dummy2;
} MS_SC_MLG_TBL;
