...
#define FRC_PIPE_DELAY_VCNT_FRC     0x10
#define FRC_PIPE_DELAY_HCNT_FRC     0x140
#define FRC_PIPE_DELAY_VCNT_FSC_FHD     0x1D
#define FRC_PIPE_DELAY_HCNT_FSC_FHD     0x140
#define FRC_PIPE_DELAY_VCNT_FSC_4K      0x0B
...
/* Vtt BK10 not be replaced, CHIP number after U2 */
#define HW_VTT_LIMITATION_CHIPREV           1
/* Macan VE 2Pto1P HW PATCH*/
#define PATCH_HW_VE_2Pto1P                  1
/*Macan PIXSHIFT HW PATCH*/
#define PATCH_HW_PIXSHIFT                   1
/*
...
//#define MLG_1024
#define SUPPORT_GAMMA_AUTODOWNLOAD
...
#define XC_FRC_IPM_L        0x2C4C000   // 4096x2160x1.5x7/2
#define XC_FRC_IPM_R        0x2C4C000   // 4096x2160x1.5x7/2
#define XC_FRC_MEDS_L       0x084E400   // 2048x1080x0.75x7/2x1.5
#define XC_FRC_MEDS_R       0x084E400   // 2048x1080x0.75x7/2x1.5
#define XC_FRC_ME1_X1       0x0061080   // 8x135x32x11.5
#define XC_FRC_ME1_S1       0x0030840   // 8x135x32x23
#define XC_FRC_ME2_X2       0x02D7BC0   // 30x270x32x11.5
#define XC_FRC_ME2_Y2       0x00C2100   // 8x270x32x11.5
#define XC_FRC_ME2_F2       0x01B4A40   // 18x270x32x11.5
#define XC_FRC_ME2_LOGO     0x00C2100   // 8x270x32x11.5
#define XC_FRC_HR           0x01FA400   // 40x270x32x6
#define XC_FRC_HR_BUF23     0x02F7600   // 30x270x32x12
...
//VE BANK
#define REG_VE0_BASE                0x103B00UL
...
#define REG_MVOP_4K2K_60_2P     (REG_MVOP_BASE    + (0x53<<1))
    #define GOP_MVOP_2P_EN_BIT   BIT(1)

//VE 8bit address
#define REG_VE_ENABLE           (REG_VE0_BASE    + 0x00)
    #define VE_EN_BIT           BIT(0)
#define REG_VE_DAMMY_B          (REG_VE0_BASE    + 0x16)
...
#define MIU2_G0_REQUEST_MASK    (REG_MIU2_BASE + 0x46)
#define MIU2_G1_REQUEST_MASK    (REG_MIU2_BASE + 0x66)
#define MIU2_G2_REQUEST_MASK    (REG_MIU2_BASE + 0x86)
#define MIU2_G3_REQUEST_MASK    (REG_MIU2_BASE + 0xA6)
#define MIU2_G4_REQUEST_MASK    (REG_MIU2_EX_BASE + 0x06)
#define MIU2_G5_REQUEST_MASK    (REG_MIU2_EX_BASE + 0x26)
#define MIU2_G6_REQUEST_MASK    (REG_MIU2_ARBB_BASE + 0x06)

#define MIU_SC_G0REQUEST_MASK   (0x0000)
#define MIU_SC_G1REQUEST_MASK   (0x0070)
...
#define MIU_SC_G6REQUEST_MASK   (0xF403)
...
#define SUPPORT_DUAL_MIU               // Manhattan dual_MIU is not work now, RD is checking, disable dual_MIU first
