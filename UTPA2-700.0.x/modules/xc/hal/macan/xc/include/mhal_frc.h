...
typedef enum
{
    E_FRC_MLOAD_TRIG_MODE_FROM_OP1     = 0,  // no FRC case, menuload trig form tgen
    E_FRC_MLOAD_TRIG_MODE_FROM_OP2     = 1,  // with FRC case, menuload trig form stgen
...
#define MHal_FRC_TGEN_SetSubMdeStartEndY(args...)
#define MHal_FRC_TGEN_SetSubMdeStartEndX(args...)
...
#define MHal_FRC_PNLInfo_Transform(args...)
...
#define MHal_FRC_IPM_R_SetBaseAddr(args...)
...
#define MHal_FRC_OPM_R_SetBaseAddr(args...)
...
#define MHal_FRC_Tx_SetTgen(args...)
#define MHal_XC_Is_DSForceIndexEnabled(args...)
...
#define Hal_XC_FRC_R2_Get_SwVersion(args...) 0
#define Hal_XC_FRC_R2_Get_CmdVersion(args...) 0
#define Hal_XC_FRC_R2_Init(args...) 0
#define Hal_XC_FRC_R2_Set_Timing(args...) 0
#define Hal_XC_FRC_R2_Set_InputFrameSize(args...) 0
#define Hal_XC_FRC_R2_Set_OutputFrameSize(args...) 0
#define Hal_XC_FRC_R2_Set_FPLL_Lockdone(args...) 0
#define Hal_XC_FRC_R2_Enable_MEMC(args...) 0
...
#define MHal_FRC_Composer_User_Mode_Enable(args...)
#define MHal_FRC_Set_Composer_User_Mode(args...)

#define MHal_FRC_Set_Pipe_Delay_Mode(args...)
#define MHal_FRC_Set_Pipe_Delay_Value(args...)
#define MHal_FRC_Set_Pipe_Delay_Reset(args...)

#define MHal_FRC_Set_STGEN_ODCLK(args...)
#define MHal_FRC_Set_FSC_DE_Selection(args...)
#define MHal_FRC_IsFHDToFSC(args...) 0
#define MHal_FRC_IsSupportFRC_byEfuse(args...) 0
#define MHal_FRC_AdjustGOPPosition(args...)
#define MHal_FRC_GetGOPOffset(args...)

#define MHal_FRC_Set_Mload_Trig_Mode(args...)

#define MHal_FRC_Mute(args...)
#define MHal_FRC_SetMemFormat(args...)
#define MHal_FRC_Tx_SetTgen(args...)
#define MHal_FRC_IPM_Init(args...)
#define MHal_FRC_UpdateMDE(args...)
