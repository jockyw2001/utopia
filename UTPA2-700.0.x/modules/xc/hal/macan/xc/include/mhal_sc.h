...
#endif
#define Mhal_XC_InterruptDeAttach                MDrv_XC_InterruptDeAttach
#define Mhal_XC_InterruptAttach                  MDrv_XC_InterruptAttach
#define Mhal_XC_InterruptAttachWithoutMutex      MDrv_XC_InterruptAttachWithoutMutex
#define Mhal_XC_InterruptDeAttachWithoutMutex    MDrv_XC_InterruptDeAttachWithoutMutex
#define Mhal_XC_InterruptIsAttached              MDrv_XC_InterruptIsAttached
#define Mhal_XC_Get_Semaphore                    MDrv_XC_Get_Semaphore
#define Mhal_XC_Release_Semaphore                MDrv_XC_Release_Semaphore
#define Mhal_XC_Resource_Mapping                 MDrv_XC_Resource_Mapping
...
INTERFACE MS_BOOL Hal_SC_GetScmiV1Speical4frame(void *pInstance, XC_FRAME_STORE_NUMBER enStoreNum);
INTERFACE MS_U8 Hal_XC_TransFrameNumToFactor(void *pInstance, XC_FRAME_STORE_NUMBER eFrameStoreNumber, MS_BOOL bLinearMode, MS_BOOL bFieldPackingMode);
...
INTERFACE MS_BOOL Hal_SC_get_bws_mode(void *pInstance, SCALER_WIN eWindow);
...
#endif
INTERFACE void Hal_SC_Set_YLock(void *pInstance, MS_BOOL bInterlace, MS_BOOL bFBL, MS_BOOL bR_FBL);
