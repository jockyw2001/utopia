...
{
    if(eWindow == MAIN_WINDOW)
        return SC_R2BYTEMSK(0,REG_SC_BK01_13_L, IP_DE_HSTART_MASK);
    else
        return SC_R2BYTEMSK(0,REG_SC_BK03_13_L, IP_DE_HSTART_MASK);
}
//=========================================================//
...
{
    if(eWindow == MAIN_WINDOW)
        return SC_R2BYTEMSK(0,REG_SC_BK01_15_L, IP_DE_HEND_MASK);
    else
        return SC_R2BYTEMSK(0,REG_SC_BK03_15_L, IP_DE_HEND_MASK);
}
...
{
    if(eWindow == MAIN_WINDOW)
        return SC_R2BYTEMSK(0,REG_SC_BK01_12_L, IP_DE_VSTART_MASK);
    else
        return SC_R2BYTEMSK(0,REG_SC_BK03_12_L, IP_DE_VSTART_MASK);
}
//=========================================================//
...
{
    if(eWindow == MAIN_WINDOW)
        return SC_R2BYTEMSK(0,REG_SC_BK01_14_L, IP_DE_VEND_MASK);
    else
        return SC_R2BYTEMSK(0,REG_SC_BK03_14_L, IP_DE_VEND_MASK);
}
...
MS_BOOL Hal_SC_ip_get_DE_mode_glitch_protect_enabled(void *pInstance,SCALER_WIN eWindow)
{
    if(eWindow == MAIN_WINDOW)
    {
        return (MS_BOOL)(SC_R2BYTEMSK(0,REG_SC_BK01_27_L, BIT(2)) >> 2);
    }
    else
    {
        return (MS_BOOL)(SC_R2BYTEMSK(0,REG_SC_BK03_27_L, BIT(2)) >> 2);
    }
}
...
void Hal_SC_ip_set_de_lock_mode(void *pInstance, MS_BOOL bEnable, SCALER_WIN eWindow )
{
    ...
    if( eWindow == MAIN_WINDOW )
    {
        ...
        if(SC_R2BYTEMSK( 0 , REG_SC_BK01_1D_L, BIT(6) ))
        {
            bLastLockMode = TRUE;
        }
    ...
    {
        if(SC_R2BYTEMSK(0 , REG_SC_BK03_1D_L, BIT(6) ))
        {
            bLastLockMode = TRUE;
        }
...
MS_U16 Hal_SC_get_hsd_pixel_count(void *pInstance, SCALER_WIN eWindow )
{
    if( eWindow == MAIN_WINDOW )
    {
        return SC_R2BYTEMSK(0, REG_SC_BK02_3E_L, BITMASK(11 : 0) );
    }
    else
    {
        return SC_R2BYTEMSK(0, REG_SC_BK04_3E_L, BITMASK(11 : 0) );
    }
}
...
MS_U8 Hal_SC_ip_get_post_glitch_removal(void *pInstance,SCALER_WIN eWindow)
{
    ...
    if( eWindow == MAIN_WINDOW )
    {
        ...
        if (bEnable)
        {
            return (MS_U8)(SC_R2BYTEMSK(0,REG_SC_BK01_26_L, BIT(6)|BIT(5)|BIT(4)) >> 4);
        }
        else
        {
            return 0;
    ...
    else
    {
        ...
        if (bEnable)
        {
            return (MS_U8)(SC_R2BYTEMSK(0,REG_SC_BK03_26_L, BIT(6)|BIT(5)|BIT(4)) >> 4);
        }
        else
        {
            return 0;
...
void Hal_SC_ip_set_IPAutoNoSignal(void *pInstance,MS_BOOL bEnable, SCALER_WIN eWindow )
{
    if (eWindow == MAIN_WINDOW)
    {
        SC_W2BYTEMSK(0,REG_SC_BK01_0B_L, bEnable? BIT(5):0, BIT(4)|BIT(5)); // Set auto no signal to blank video instead of freeze image
        SC_W2BYTEMSK(0,REG_SC_BK01_1D_L, bEnable? BIT(12):0, BIT(12));
    }
    else
    {
        SC_W2BYTEMSK(0,REG_SC_BK03_0B_L, bEnable? BIT(5):0, BIT(4)|BIT(5)); // Set auto no signal to blank video instead of freeze image
...
MS_BOOL Hal_SC_ip_get_IPAutoNoSignal(void *pInstance, SCALER_WIN eWindow )
{
    if (eWindow == MAIN_WINDOW)
    {
        return ( SC_R2BYTEMSK(0,REG_SC_BK01_1D_L, BIT(12) ) )? TRUE:FALSE;
    }
    else
    {
        return ( SC_R2BYTEMSK(0,REG_SC_BK03_1D_L, BIT(12) ) )? TRUE:FALSE;
    }
}
...
MS_BOOL Hal_SC_ip_is_auto_gain_result_ready(void *pInstance,SCALER_WIN eWindow)
{
    if( eWindow == MAIN_WINDOW )
    {
        return ( SC_R2BYTEMSK(0,REG_SC_BK01_0E_L, BIT(1) ) )? TRUE:FALSE;
    }
    else
    {
        return ( SC_R2BYTEMSK(0,REG_SC_BK03_0E_L, BIT(1) ) )? TRUE:FALSE;
    }
}
...
MS_U8 Hal_SC_ip_auto_gain_min_value_status(void *pInstance,SCALER_WIN eWindow)
{
    if( eWindow == MAIN_WINDOW )
    {
        return ( (SC_R2BYTEMSK(0,REG_SC_BK01_0E_L, ( BIT(10) | BIT(9) | BIT(8) ) ) ) >> 8 );
    }
    else
    {
        return ( (SC_R2BYTEMSK(0,REG_SC_BK03_0E_L, ( BIT(10) | BIT(9) | BIT(8) ) ) ) >> 8 );
    }
}
...
MS_U8 Hal_SC_ip_auto_gain_max_value_status(void *pInstance,SCALER_WIN eWindow)
{
    if( eWindow == MAIN_WINDOW )
    {
        return ( (SC_R2BYTEMSK(0,REG_SC_BK01_0E_L, ( BIT(5) | BIT(6) | BIT(7) ) ) ) >> 5 );
    }
    else
    {
        return ( (SC_R2BYTEMSK(0,REG_SC_BK03_0E_L, ( BIT(5) | BIT(6) | BIT(7) ) ) ) >> 5 );
    }
}
...
MS_U32 Hal_SC_ip_get_auto_phase_value(void *pInstance,SCALER_WIN eWindow)
{
    if( eWindow == MAIN_WINDOW )
    {
        return ( SC_R4BYTE(0,REG_SC_BK01_1A_L) );
    }
    else
    {
        return ( SC_R4BYTE(0,REG_SC_BK03_1A_L) );
    }
}
...
MS_BOOL Hal_SC_ip_is_auto_phase_result_ready(void *pInstance,SCALER_WIN eWindow)
{
    if( eWindow == MAIN_WINDOW )
    {
        return ( SC_R2BYTEMSK(0,REG_SC_BK01_19_L, BIT(1) ) )? TRUE:FALSE;
    }
    else
    {
        return ( SC_R2BYTEMSK(0,REG_SC_BK03_19_L, BIT(1) ) )? TRUE:FALSE;
    }
}
...
MS_BOOL Hal_SC_ip_is_auto_position_result_ready(void *pInstance,SCALER_WIN eWindow)
{
    if( eWindow == MAIN_WINDOW )
    {
        return ( SC_R2BYTEMSK(0,REG_SC_BK01_10_L, BIT(1) ) )? TRUE:FALSE;
    }
    else
    {
        return ( SC_R2BYTEMSK(0,REG_SC_BK03_10_L, BIT(1) ) )? TRUE:FALSE;
    }
}
...
{
    if(eWindow == MAIN_WINDOW)
        return (SC_R2BYTE(0,REG_SC_BK01_12_L) & 0xFFF);
    else
        return (SC_R2BYTE(0,REG_SC_BK03_12_L) & 0xFFF);
}

MS_U16 Hal_SC_ip_get_auto_position_h_start(void *pInstance, SCALER_WIN eWindow )
{
    if(eWindow == MAIN_WINDOW)
        return (SC_R2BYTE(0,REG_SC_BK01_13_L) & 0xFFF);
    else
        return (SC_R2BYTE(0,REG_SC_BK03_13_L) & 0xFFF);
}

MS_U16 Hal_SC_ip_get_auto_position_v_end(void *pInstance, SCALER_WIN eWindow )
{
    if(eWindow == MAIN_WINDOW)
        return (SC_R2BYTE(0,REG_SC_BK01_14_L) & 0xFFF);
    else
        return (SC_R2BYTE(0,REG_SC_BK03_14_L) & 0xFFF);
}

MS_U16 Hal_SC_ip_get_auto_position_h_end(void *pInstance, SCALER_WIN eWindow )
{
    if(eWindow == MAIN_WINDOW)
        return (SC_R2BYTE(0,REG_SC_BK01_15_L) & 0xFFF);
    else
        return (SC_R2BYTE(0,REG_SC_BK03_15_L) & 0xFFF);
}
...
{
    if(eWindow == MAIN_WINDOW)
        return (MS_U8)SC_R2BYTEMSK(0,REG_SC_BK12_01_L, BIT(5)|BIT(4));
    else
        return (MS_U8)SC_R2BYTEMSK(0,REG_SC_BK12_41_L, BIT(5)|BIT(4));
}
...
void HAL_SC_ip_detect_mode(void *pInstance,MS_BOOL bEnable, SCALER_WIN eWindow)
{
    ...
    else
    {
        if(bEnable)
        {
            SC_W2BYTEMSK(0,REG_SC_BK03_29_L,BIT(5), BIT(5)|BIT(4));
        }
        else
        {
            SC_W2BYTEMSK(0,REG_SC_BK03_29_L, 0 , BIT(5)|BIT(4));
        }
    }
