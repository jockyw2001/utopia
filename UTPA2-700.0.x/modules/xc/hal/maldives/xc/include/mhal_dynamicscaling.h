...
//-------------------------------------------------------------------------------------------------
INTERFACE MS_BOOL MHAL_SC_Set_DynamicScaling(void *pInstance, MS_U32 u32MemBaseAddr, MS_U8 u8MIU_Select, MS_U8 u8IdxDepth, MS_BOOL bOP_On, MS_BOOL bIPS_On, MS_BOOL bIPM_On, SCALER_WIN eWindow);
...
INTERFACE MS_BOOL Hal_SC_SetSeamlessZapping(void *pInstance, SCALER_WIN eWindow, MS_BOOL bEnable);
INTERFACE MS_BOOL Hal_SC_GetSeamlessZappingStatus(void *pInstance, SCALER_WIN eWindow);
INTERFACE void Hal_SC_PrepareSeamlessZapping(void *pInstance, SCALER_WIN eWindow);
...
INTERFACE void Hal_SC_WriteDSCommand(void *pInstance, SCALER_WIN eWindow, MS_U16 u16CmdRegAddr, MS_U16 u16CmdRegValue);
...
INTERFACE MS_BOOL Hal_XC_Is_SupportSWDS(void *pInstance);
