...
#define L_BK_ADC_ATOPB(x)    BK_REG_L(REG_ADC_ATOPB_BASE, x)
#define H_BK_ADC_ATOPB(x)    BK_REG_H(REG_ADC_ATOPB_BASE, x)

#define L_BK_ADC_CHIPTOP(x)     BK_REG_L(REG_ADC_CHIPTOP_BASE, x)
#define H_BK_ADC_CHIPTOP(x)     BK_REG_H(REG_ADC_CHIPTOP_BASE, x)
...
/* VD:COMB */
#define L_BK_COMB(x)        BK_REG_L(REG_COMB_BASE, x)
#define H_BK_COMB(x)        BK_REG_H(REG_COMB_BASE, x)
