...
#define HDMI_EQ_SETTING_VALUE              14U
...
#define TMDS_HDCP_WINDOW_END_VALUE      0x2U

#define HDMI_PACKET_RECEIVE_COUNT           5 // 10ms
...
enum HDMI_DVI_PORT_TYPE
{
    HDMI_DVI_PORT_A = BIT(0),
    HDMI_DVI_PORT_B = BIT(1),
    HDMI_DVI_PORT_C = BIT(2),
    HDMI_DVI_PORT_D = BIT(3),
};

enum HDMI_PORT_SELECT_TYPE
{
    HDMI_PORT_SELECT0 = 0,
    HDMI_PORT_SELECT1,
    HDMI_PORT_SELECT2,
...
INTERFACE void Hal_HDMI_audio_output( MS_BOOL bEnable );
INTERFACE MS_U32 Hal_HDMI_packet_info(void);
...
INTERFACE void Hal_HDMI_packet_ctrl(MS_U32 u32pkt);
...
INTERFACE MS_BOOL Hal_HDMI_Get_InfoFrame(MS_HDMI_PACKET_STATE_t u8state, void *pData);
