...
void Hal_ACE_SetSharpness(void* pInstance, MS_BOOL bScalerWin, MS_U8 u8Sharpness)
{
    ...
    if((MApi_XC_MLoad_GetStatus_U2(pInstance) == E_MLOAD_ENABLED) && (!Hal_ACE_GetSkipWaitVsync(pInstance, bScalerWin)))
    {
        if(bScalerWin == MAIN_WINDOW)
        {
            MApi_XC_MLoad_WriteCmd_NonXC(pInstance, 0x1430, 0x22, u8Sharpness, 0xFFFF);
        }
        else
        {
    ...
    else
    {
        if(bScalerWin == MAIN_WINDOW)
        {
            MDrv_WriteByteMask(REG_FSC_BK30_11_L, u8Sharpness, 0x7F); // 7 bit sharpness!
        }
        else
        {
...
MS_BOOL Hal_ACE_SetIHC(void* pInstance, MS_BOOL bScalerWin, XC_ACE_IHC_COLOR_TYPE eIHC, MS_U8 u8Val)
{
    ...
    if (bScalerWin == MAIN_WINDOW)
    {
        switch(eIHC)
        {
            case E_ACE_IHC_USER_COLOR1:
                SC_W2BYTEMSK(0, REG_SC_BK1C_25_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR2:
                SC_W2BYTEMSK(0, REG_SC_BK1C_26_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR3:
                SC_W2BYTEMSK(0, REG_SC_BK1C_26_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR4:
                SC_W2BYTEMSK(0, REG_SC_BK1C_27_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR5:
                SC_W2BYTEMSK(0, REG_SC_BK1C_27_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR6:
                SC_W2BYTEMSK(0, REG_SC_BK1C_28_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR7:
                SC_W2BYTEMSK(0, REG_SC_BK1C_28_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR8:
                SC_W2BYTEMSK(0, REG_SC_BK1C_29_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR9:
                SC_W2BYTEMSK(0, REG_SC_BK1C_29_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR10:
                SC_W2BYTEMSK(0, REG_SC_BK1C_2A_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR11:
                SC_W2BYTEMSK(0, REG_SC_BK1C_2A_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR12:
                SC_W2BYTEMSK(0, REG_SC_BK1C_2B_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR13:
                SC_W2BYTEMSK(0, REG_SC_BK1C_2B_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR14:
                SC_W2BYTEMSK(0, REG_SC_BK1C_2C_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR15:
                SC_W2BYTEMSK(0, REG_SC_BK1C_2C_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR0:
                SC_W2BYTEMSK(0, REG_SC_BK1C_25_L, u16Val, BITMASK(6:0));
                break;
            default:
            break;
        }
    ...
    else
    {
        switch(eIHC)
        {
            ...
            case E_ACE_IHC_USER_COLOR7:
                ...
                break;
            case E_ACE_IHC_USER_COLOR8:
                SC_W2BYTEMSK(0, REG_SC_BK1C_31_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR9:
                SC_W2BYTEMSK(0, REG_SC_BK1C_31_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR10:
                SC_W2BYTEMSK(0, REG_SC_BK1C_32_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR11:
                SC_W2BYTEMSK(0, REG_SC_BK1C_32_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR12:
                SC_W2BYTEMSK(0, REG_SC_BK1C_33_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR13:
                SC_W2BYTEMSK(0, REG_SC_BK1C_33_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR14:
                SC_W2BYTEMSK(0, REG_SC_BK1C_34_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR15:
                SC_W2BYTEMSK(0, REG_SC_BK1C_34_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_USER_COLOR0:
                SC_W2BYTEMSK(0, REG_SC_BK1C_2D_L, u16Val, BITMASK(6:0));
                break;
            default:
            break;
        }
    ...
    if (bScalerWin == MAIN_WINDOW)
    {
        switch(eIHC)
        {
            ...
            case E_ACE_IHC_USER_COLOR7:
                ...
                break;
            case E_ACE_IHC_USER_COLOR8:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_29_L, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR9:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_29_L, BITMASK(14:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IHC_USER_COLOR10:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_2A_L, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR11:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_2A_L, BITMASK(14:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IHC_USER_COLOR12:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_2B_L, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR13:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_2B_L, BITMASK(14:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IHC_USER_COLOR14:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_2C_L, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR15:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_2C_L, BITMASK(14:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IHC_USER_COLOR0:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_25_L, BITMASK(6:0));
                break;
            default:
            break;
        }
    ...
    else
    {
        switch(eIHC)
        {
            ...
            case E_ACE_IHC_USER_COLOR7:
                ...
                break;
            case E_ACE_IHC_USER_COLOR8:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_31_L, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR9:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_31_L, BITMASK(14:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IHC_USER_COLOR10:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_32_L, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR11:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_32_L, BITMASK(14:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IHC_USER_COLOR12:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_33_L, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR13:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_33_L, BITMASK(14:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IHC_USER_COLOR14:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_34_L, BITMASK(6:0));
                break;
            case E_ACE_IHC_USER_COLOR15:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_34_L, BITMASK(14:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IHC_USER_COLOR0:
                u16Value = SC_R2BYTEMSK(0, REG_SC_BK1C_2D_L, BITMASK(6:0));
                break;
            default:
            break;
        }
...
MS_BOOL Hal_ACE_SetICC(void* pInstance, MS_BOOL bScalerWin, XC_ACE_ICC_COLOR_TYPE eICC, MS_U8 u8Val)
{
    ...
    if (bScalerWin == MAIN_WINDOW)
    {
        switch(eICC)
        {
            case E_ACE_ICC_USER_COLOR1:
                SC_W2BYTEMSK(0,REG_SC_BK2B_61_L, u16Val<<8, BITMASK(11:8));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<1, BIT(1));
                break;
            case E_ACE_ICC_USER_COLOR2:
                SC_W2BYTEMSK(0,REG_SC_BK2B_62_L, u16Val, BITMASK(3:0));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<2, BIT(2));
                break;
            case E_ACE_ICC_USER_COLOR3:
                SC_W2BYTEMSK(0,REG_SC_BK2B_62_L, u16Val<<8, BITMASK(11:8));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<3, BIT(3));
                break;
            case E_ACE_ICC_USER_COLOR4:
                SC_W2BYTEMSK(0,REG_SC_BK2B_63_L, u16Val, BITMASK(3:0));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<4, BIT(4));
                break;
            case E_ACE_ICC_USER_COLOR5:
                SC_W2BYTEMSK(0,REG_SC_BK2B_63_L, u16Val<<8, BITMASK(11:8));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<5, BIT(5));
                break;
            case E_ACE_ICC_USER_COLOR6:
                SC_W2BYTEMSK(0,REG_SC_BK2B_64_L, u16Val, BITMASK(3:0));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<6, BIT(6));
                break;
            case E_ACE_ICC_USER_COLOR7:
                SC_W2BYTEMSK(0,REG_SC_BK2B_64_L, u16Val<<8, BITMASK(11:8));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<7, BIT(7));
                break;
            case E_ACE_ICC_USER_COLOR8:
                SC_W2BYTEMSK(0,REG_SC_BK2B_65_L, u16Val, BITMASK(3:0));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<8, BIT(8));
                break;
            case E_ACE_ICC_USER_COLOR9:
                SC_W2BYTEMSK(0,REG_SC_BK2B_65_L, u16Val<<8, BITMASK(11:8));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<9, BIT(9));
                break;
            case E_ACE_ICC_USER_COLOR10:
                SC_W2BYTEMSK(0,REG_SC_BK2B_66_L, u16Val, BITMASK(3:0));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<10, BIT(10));
                break;
            case E_ACE_ICC_USER_COLOR11:
                SC_W2BYTEMSK(0,REG_SC_BK2B_66_L, u16Val<<8, BITMASK(11:8));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<11, BIT(11));
                break;
            case E_ACE_ICC_USER_COLOR12:
                SC_W2BYTEMSK(0,REG_SC_BK2B_67_L, u16Val, BITMASK(3:0));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<12, BIT(12));
                break;
            case E_ACE_ICC_USER_COLOR13:
                SC_W2BYTEMSK(0,REG_SC_BK2B_67_L, u16Val<<8, BITMASK(11:8));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<13, BIT(13));
                break;
            case E_ACE_ICC_USER_COLOR14:
                SC_W2BYTEMSK(0,REG_SC_BK2B_68_L, u16Val, BITMASK(3:0));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<14, BIT(14));
                break;
            case E_ACE_ICC_USER_COLOR15:
                SC_W2BYTEMSK(0,REG_SC_BK2B_68_L, u16Val<<8, BITMASK(11:8));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction<<15, BIT(15));
                break;
            case E_ACE_ICC_USER_COLOR0:
                SC_W2BYTEMSK(0,REG_SC_BK2B_61_L, u16Val, BITMASK(3:0));
                SC_W2BYTEMSK(0,REG_SC_BK2B_69_L, u16Direction, BIT(0));
                break;
            default:
            break;
        }
    ...
    else
    {
        switch(eICC)
        {
            ...
            case E_ACE_ICC_USER_COLOR7:
                ...
                break;
             case E_ACE_ICC_USER_COLOR8:
                SC_W2BYTEMSK(0,REG_SC_BK2B_65_L, u16Val<<4, BITMASK(7:4));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction<<8, BIT(8));
                break;
            case E_ACE_ICC_USER_COLOR9:
                SC_W2BYTEMSK(0,REG_SC_BK2B_65_L, u16Val<<12, BITMASK(15:12));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction<<9, BIT(9));
                break;
            case E_ACE_ICC_USER_COLOR10:
                SC_W2BYTEMSK(0,REG_SC_BK2B_66_L, u16Val<<4, BITMASK(7:4));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction<<10, BIT(10));
                break;
            case E_ACE_ICC_USER_COLOR11:
                SC_W2BYTEMSK(0,REG_SC_BK2B_66_L, u16Val<<12, BITMASK(15:12));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction<<11, BIT(11));
                break;
            case E_ACE_ICC_USER_COLOR12:
                SC_W2BYTEMSK(0,REG_SC_BK2B_67_L, u16Val<<4, BITMASK(7:4));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction<<12, BIT(12));
                break;
            case E_ACE_ICC_USER_COLOR13:
                SC_W2BYTEMSK(0,REG_SC_BK2B_67_L, u16Val<<12, BITMASK(15:12));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction<<13, BIT(13));
                break;
            case E_ACE_ICC_USER_COLOR14:
                SC_W2BYTEMSK(0,REG_SC_BK2B_68_L, u16Val<<4, BITMASK(7:4));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction<<14, BIT(14));
                break;
            case E_ACE_ICC_USER_COLOR15:
                SC_W2BYTEMSK(0,REG_SC_BK2B_68_L, u16Val<<12, BITMASK(15:12));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction<<15, BIT(15));
                break;
            case E_ACE_ICC_USER_COLOR0:
                SC_W2BYTEMSK(0,REG_SC_BK2B_61_L, u16Val<<4, BITMASK(7:4));
                SC_W2BYTEMSK(0,REG_SC_BK2B_6A_L, u16Direction, BIT(0));
                break;
            default:
            break;
        }
    ...
    if (bScalerWin == MAIN_WINDOW)
    {
        switch(eICC)
        {
            ...
            case E_ACE_ICC_USER_COLOR7:
                ...
                break;
            case E_ACE_ICC_USER_COLOR8:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_65_L, BITMASK(3:0));
                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(8));
                u16Negative = u16Negative >> 8;
                break;
            case E_ACE_ICC_USER_COLOR9:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_65_L, BITMASK(11:8));
                u16Value = u16Value >> 8;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(9));
                u16Negative = u16Negative >> 9;
                break;
            case E_ACE_ICC_USER_COLOR10:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_66_L, BITMASK(3:0));
                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(10));
                u16Negative = u16Negative >> 10;
                break;
            case E_ACE_ICC_USER_COLOR11:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_66_L, BITMASK(11:8));
                u16Value = u16Value >> 8;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(11));
                u16Negative = u16Negative >> 11;
                break;
            case E_ACE_ICC_USER_COLOR12:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_67_L, BITMASK(3:0));
                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(12));
                u16Negative = u16Negative >> 12;
                break;
            case E_ACE_ICC_USER_COLOR13:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_67_L, BITMASK(11:8));
                u16Value = u16Value >> 8;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(13));
                u16Negative = u16Negative >> 13;
                break;
            case E_ACE_ICC_USER_COLOR14:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_68_L, BITMASK(3:0));
                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(14));
                u16Negative = u16Negative >> 14;
                break;
            case E_ACE_ICC_USER_COLOR15:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_68_L, BITMASK(11:8));
                u16Value = u16Value >> 8;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(15));
                u16Negative = u16Negative >> 15;
                break;
            case E_ACE_ICC_USER_COLOR0:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_61_L, BITMASK(3:0));
                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_69_L, BIT(0));
                u16Negative = u16Negative >> 0;
                break;
            default:
            break;
        }
    ...
    else
    {
        switch(eICC)
        {
            ...
            case E_ACE_ICC_USER_COLOR7:
                ...
                break;
            case E_ACE_ICC_USER_COLOR8:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_65_L, BITMASK(7:4));
                u16Value = u16Value >> 4;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(8));
                u16Negative = u16Negative >> 8;
                break;
            case E_ACE_ICC_USER_COLOR9:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_65_L, BITMASK(15:12));
                u16Value = u16Value >> 12;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(9));
                u16Negative = u16Negative >> 9;
                break;
            case E_ACE_ICC_USER_COLOR10:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_66_L, BITMASK(7:4));
                u16Value = u16Value >> 4;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(10));
                u16Negative = u16Negative >> 10;
                break;
            case E_ACE_ICC_USER_COLOR11:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_66_L, BITMASK(15:12));
                u16Value = u16Value >> 12;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(11));
                u16Negative = u16Negative >> 11;
                break;
            case E_ACE_ICC_USER_COLOR12:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_67_L, BITMASK(7:4));
                u16Value = u16Value >> 4;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(12));
                u16Negative = u16Negative >> 12;
                break;
            case E_ACE_ICC_USER_COLOR13:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_67_L, BITMASK(15:12));
                u16Value = u16Value >> 12;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(13));
                u16Negative = u16Negative >> 13;
                break;
            case E_ACE_ICC_USER_COLOR14:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_68_L, BITMASK(7:4));
                u16Value = u16Value >> 4;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(14));
                u16Negative = u16Negative >> 14;
                break;
            case E_ACE_ICC_USER_COLOR15:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_68_L, BITMASK(15:12));
                u16Value = u16Value >> 12;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(15));
                u16Negative = u16Negative >> 15;
                break;
            case E_ACE_ICC_USER_COLOR0:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK2B_61_L, BITMASK(7:4));
                u16Value = u16Value >> 4;

                u16Negative = SC_R2BYTEMSK(0,REG_SC_BK2B_6A_L, BIT(0));
                u16Negative = u16Negative >> 0;
                break;
            default:
            break;
...
MS_BOOL Hal_ACE_SetIBC(void* pInstance, MS_BOOL bScalerWin, XC_ACE_IBC_COLOR_TYPE eIBC, MS_U8 u8Val)
{
    ...
    if (bScalerWin == MAIN_WINDOW)
    {
        switch(eIBC)
        {
            case E_ACE_IBC_USER_COLOR1:
                SC_W2BYTEMSK(0,REG_SC_BK1C_11_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR2:
                SC_W2BYTEMSK(0,REG_SC_BK1C_12_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR3:
                SC_W2BYTEMSK(0,REG_SC_BK1C_12_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR4:
                SC_W2BYTEMSK(0,REG_SC_BK1C_13_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR5:
                SC_W2BYTEMSK(0,REG_SC_BK1C_13_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR6:
                SC_W2BYTEMSK(0,REG_SC_BK1C_14_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR7:
                SC_W2BYTEMSK(0,REG_SC_BK1C_14_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR8:
                SC_W2BYTEMSK(0,REG_SC_BK1C_15_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR9:
                SC_W2BYTEMSK(0,REG_SC_BK1C_15_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR10:
                SC_W2BYTEMSK(0,REG_SC_BK1C_16_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR11:
                SC_W2BYTEMSK(0,REG_SC_BK1C_16_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR12:
                SC_W2BYTEMSK(0,REG_SC_BK1C_17_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR13:
                SC_W2BYTEMSK(0,REG_SC_BK1C_17_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR14:
                SC_W2BYTEMSK(0,REG_SC_BK1C_18_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR15:
                SC_W2BYTEMSK(0,REG_SC_BK1C_18_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR0:
                SC_W2BYTEMSK(0,REG_SC_BK1C_11_L, u8Val, BITMASK(5:0));
                break;
            default:
            break;
        }
    ...
    else
    {
        switch(eIBC)
        {
            ...
            case E_ACE_IBC_USER_COLOR7:
                ...
                break;
             case E_ACE_IBC_USER_COLOR8:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1D_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR9:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1D_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR10:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1E_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR11:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1E_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR12:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1F_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR13:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1F_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR14:
                SC_W2BYTEMSK(0,REG_SC_BK1C_20_L, u8Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR15:
                SC_W2BYTEMSK(0,REG_SC_BK1C_20_L, u8Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_USER_COLOR0:
                SC_W2BYTEMSK(0,REG_SC_BK1C_19_L, u8Val, BITMASK(5:0));
                break;
            default:
            break;
        }
    ...
    if (bScalerWin == MAIN_WINDOW)
    {
        switch(eIBC)
        {
            ...
            case E_ACE_IBC_USER_COLOR7:
                ...
                break;
            case E_ACE_IBC_USER_COLOR8:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_15_L, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR9:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_15_L, BITMASK(13:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IBC_USER_COLOR10:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_16_L, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR11:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_16_L, BITMASK(13:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IBC_USER_COLOR12:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_17_L, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR13:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_17_L, BITMASK(13:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IBC_USER_COLOR14:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_18_L, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR15:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_18_L, BITMASK(13:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IBC_USER_COLOR0:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_11_L, BITMASK(5:0));
                break;
            default:
            break;
        }
    ...
    else
    {
        switch(eIBC)
        {
            ...
            case E_ACE_IBC_USER_COLOR7:
                ...
                break;
            case E_ACE_IBC_USER_COLOR8:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_1D_L, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR9:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_1D_L, BITMASK(13:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IBC_USER_COLOR10:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_1E_L, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR11:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_1E_L, BITMASK(13:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IBC_USER_COLOR12:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_1F_L, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR13:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_1F_L, BITMASK(13:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IBC_USER_COLOR14:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_20_L, BITMASK(5:0));
                break;
            case E_ACE_IBC_USER_COLOR15:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_10_L, BITMASK(13:8));
                u16Value = u16Value >>8;
                break;
            case E_ACE_IBC_USER_COLOR0:
                u16Value = SC_R2BYTEMSK(0,REG_SC_BK1C_19_L, BITMASK(5:0));
                break;
            default:
            break;
        }
