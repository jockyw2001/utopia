...
// IPM_OPM
    ...
    MDrv_WriteByteMask( REG_FRC_BK134_30  , 0x1C, 0xff); // reg_ipm_vcnt_limit_num_f2
    MDrv_WriteByteMask( REG_FRC_BK134_31  , 0x02, 0xff); // reg_ipm_vcnt_limit_num_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK136_30  , 0x1C, 0xff); // reg_ipm_vcnt_limit_num_f2
    MDrv_WriteByteMask( REG_FRC_BK136_31  , 0x02, 0xff); // reg_ipm_vcnt_limit_num_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK13A_30  , 0x1C, 0xff); // reg_ipm_vcnt_limit_num_f2
    MDrv_WriteByteMask( REG_FRC_BK13A_31  , 0x02, 0xff); // reg_ipm_vcnt_limit_num_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK13B_30  , 0x1C, 0xff); // reg_ipm_vcnt_limit_num_f2
    MDrv_WriteByteMask( REG_FRC_BK13B_31  , 0x02, 0xff); // reg_ipm_vcnt_limit_num_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK13C_30  , 0x1C, 0xff); // reg_ipm_vcnt_limit_num_f2
    MDrv_WriteByteMask( REG_FRC_BK13C_31  , 0x02, 0xff); // reg_ipm_vcnt_limit_num_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK13D_30  , 0x1C, 0xff); // reg_ipm_vcnt_limit_num_f2
    MDrv_WriteByteMask( REG_FRC_BK13D_31  , 0x02, 0xff); // reg_ipm_vcnt_limit_num_f2
// IPM_OPM_vlen
    ...
    MDrv_WriteByteMask( REG_FRC_BK134_62  , 0x1c, 0xff); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK134_63  , 0x02, 0x1f); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK136_62  , 0x1c, 0xff); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK136_63  , 0x02, 0x1f); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK13A_62  , 0x1c, 0xff); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK13A_63  , 0x02, 0x1f); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK13B_62  , 0x1c, 0xff); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK13B_63  , 0x02, 0x1f); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK13C_62  , 0x1c, 0xff); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK13C_63  , 0x02, 0x1f); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK13D_62  , 0x1c, 0xff); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK13D_63  , 0x02, 0x1f); // reg_opm_vlen
    MDrv_WriteByteMask( REG_FRC_BK134_CC  , 0x1c, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK134_CD  , 0x02, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK136_CC  , 0x1c, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK136_CD  , 0x02, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13A_CC  , 0x1c, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13A_CD  , 0x02, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13B_CC  , 0x1c, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13B_CD  , 0x02, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13C_CC  , 0x1c, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13C_CD  , 0x02, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13D_CC  , 0x1c, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13D_CD  , 0x02, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK134_BA  , 0x0e, 0xff); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK134_BB  , 0x01, 0x1f); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK136_BA  , 0x0e, 0xff); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK136_BB  , 0x01, 0x1f); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK13A_BA  , 0x0e, 0xff); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK13A_BB  , 0x01, 0x1f); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK13B_BA  , 0x0e, 0xff); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK13B_BB  , 0x01, 0x1f); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK13C_BA  , 0x0e, 0xff); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK13C_BB  , 0x01, 0x1f); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK13D_BA  , 0x0e, 0xff); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK13D_BB  , 0x01, 0x1f); // reg_opm_meds_vlen
    MDrv_WriteByteMask( REG_FRC_BK134_C8  , 0x0e, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK134_C9  , 0x01, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK136_C8  , 0x0e, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK136_C9  , 0x01, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13A_C8  , 0x0e, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13A_C9  , 0x01, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13B_C8  , 0x0e, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13B_C9  , 0x01, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13C_C8  , 0x0e, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13C_C9  , 0x01, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13D_C8  , 0x0e, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13D_C9  , 0x01, 0x1f); // reg_opm_meds_vlen_new
// IPM_OPM_DSmode
...
// IPM_3D
    MDrv_WriteByteMask( REG_FRC_BK135_1C  , 0x1c, 0xff); // reg_v_toggle_value
    MDrv_WriteByteMask( REG_FRC_BK135_1D  , 0x02, 0x0f); // reg_v_toggle_value
    ...
    MDrv_WriteByteMask( REG_FRC_BK134_26  , 0x0e, 0xff); // reg_ipm_turn_back_line
    MDrv_WriteByteMask( REG_FRC_BK134_27  , 0x01, 0x1f); // reg_ipm_turn_back_line
    MDrv_WriteByteMask( REG_FRC_BK13A_26  , 0x87, 0xff); // reg_ipm_turn_back_line_meds
    MDrv_WriteByteMask( REG_FRC_BK13A_27  , 0x00, 0x1f); // reg_ipm_turn_back_line_meds
// OPM_3D
...
// MFC_pipectrl
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_40  , 0x0e, 0xff); // reg_ppctr_v_line_num_me
    MDrv_WriteByteMask( REG_FRC_BK233_41  , 0x01, 0x1f); // reg_ppctr_v_line_num_me
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_48  , 0x1c, 0xff); // reg_me_v_pixel_num_mi
    MDrv_WriteByteMask( REG_FRC_BK233_49  , 0x02, 0x1f); // reg_me_v_pixel_num_mi
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_FA  , 0x1c, 0xff); // reg_v_pixel_num_mlb
    MDrv_WriteByteMask( REG_FRC_BK233_FB  , 0x02, 0x1f); // reg_v_pixel_num_mlb
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_3C  , 0x86, 0xff); // reg_time_gen_sw_v_width
    MDrv_WriteByteMask( REG_FRC_BK233_3D  , 0x00, 0x1f); // reg_time_gen_sw_v_width
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_A8  , 0x40, 0xff); // reg_gmv_vertical_active_window_height
...
// MFC
    ...
    MDrv_WriteByteMask( REG_FRC_BK226_75  , 0x01, 0x1f); // reg_v_lin_num_3D
    MDrv_WriteByteMask( REG_FRC_BK226_74  , 0x0e, 0xff); // reg_v_lin_num_3D
    ...
    MDrv_WriteByteMask( REG_FRC_BK229_07  , 0x02, 0x0F); // reg_v_lin_num_ME
    MDrv_WriteByteMask( REG_FRC_BK229_06  , 0x20, 0xFF); // reg_v_lin_num_ME
    ...
    MDrv_WriteByteMask( REG_FRC_BK229_93  , 0x02, 0xFF); // reg_v_lin_num_MI
    MDrv_WriteByteMask( REG_FRC_BK229_92  , 0x1C, 0xFF); // reg_v_lin_num_MI
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_31  , 0x10, 0x10); // reg_mlb_mi_half_sr
    MDrv_WriteByteMask( REG_FRC_BK233_31  , 0x20, 0x20); // reg_mlb_me_half_sr
// MFC_Halo
...
// SNR
    ...
    MDrv_WriteByteMask( REG_FRC_BK2E_E8  , 0x1c, 0xff); // reg_snr_line_num_LSB
    MDrv_WriteByteMask( REG_FRC_BK2E_E9  , 0x02, 0x0f); // reg_snr_line_num_MSB
// SNR_3D
