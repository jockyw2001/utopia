...
//#define MOD_TVFRC   //for sub bank register change
//-------------------------------------------------------------------------------------------------
//  Macro and Define
//-------------------------------------------------------------------------------------------------
...
#define REG_MFT_BASE                0x123100UL

#define REG_CHIP_BASE               0x101E00UL

#define REG_SC2_BASE               0x103000UL
...
#define L_CLKGEN2(x)                BK_REG_L(REG_RVD_BASE, x)
#define H_CLKGEN2(x)                BK_REG_H(REG_RVD_BASE, x)
...
#define REG_RVD_43_L                (REG_RVD_BASE + 0x86)
#define REG_RVD_44_L                (REG_RVD_BASE + 0x88)
#define REG_RVD_46_L                (REG_RVD_BASE + 0x8C)
...
#define REG_CHIP_25_L               (REG_CHIP_BASE + 0x4A)
#define REG_CHIP_50_L               (REG_CHIP_BASE + 0xA0)

#define REG_SC2_00_L                (REG_SC2_BASE + 0x00)
#define REG_SC2_03_L                (REG_SC2_BASE + 0x06)
...
#define REG_CKG_ODCLK                 REG_CLKGEN0_53_L
    ...
    #define CKG_ODCLK_SEL_SOURCE      BIT(2)
    #define CKG_ODCLK_SEL_SYNTHETIC   (0 << 2)
    #define CKG_ODCLK_SEL_LPLL        (1 << 2)
    #define CKG_ODCLK_MASK            (BIT(3) | BIT(4))
    #define CKG_ODCLK_CLK_DIV_2       (0 << 3)
    #define CKG_ODCLK_XTAL            (1 << 3)
    #define CKG_ODCLK_CLK_DIV_4       (2 << 3)
    #define CKG_ODCLK_CLK_LPLL        (3 << 3)


#define REG_CKG_ODCLK_MFT             REG_CLKGEN0_53_L
    #define CKG_ODCLK_MFT_GATED         BIT(8)
    #define CKG_ODCLK_MFT_INVERT        BIT(9)
    #define CKG_ODCLK_MFT_SEL_SOURCE    BIT(10)
    #define CKG_ODCLK_MFT_SEL_SYNTHETIC   (0 << 10)
    #define CKG_ODCLK_MFT_SEL_LPLL        (1 << 10)
    #define CKG_ODCLK_MFT_MASK            (BIT(11) | BIT(12))
    #define CKG_ODCLK_MFT_CLK_DIV_2       (0 << 11)
    #define CKG_ODCLK_MFT_XTAL            (1 << 11)
    #define CKG_ODCLK_MFT_CLK_DIV_4       (2 << 11)
    #define CKG_ODCLK_MFT_CLK_LPLL        (3 << 11)
...
//for auto set output config and clk according to pin mapping
#define CONFIG_FOR_VBY1_DATA 0x01
#define CONFIG_FOR_VBY1_DATA_BIT_NUM 2

#define VBY1_CLK_TBL_ROW 4
