...
MS_BOOL MHal_PNL_MOD_Control_Out_Swing(void *pInstance, MS_U16 u16Swing_Level)
{
    ...
    else
    {
        ...
        // LVDS fill ICON
        // ch0+ch1
        MOD_A_W2BYTE(REG_MOD_A_BK00_30_L, (u16ValidSwing << 8 | u16ValidSwing));
        // ch2+ch3
        MOD_A_W2BYTE(REG_MOD_A_BK00_31_L, (u16ValidSwing << 8 | u16ValidSwing));
        // ch4+ch5
        MOD_A_W2BYTE(REG_MOD_A_BK00_32_L, (u16ValidSwing << 8 | u16ValidSwing));
        // ch6+ch7
        MOD_A_W2BYTE(REG_MOD_A_BK00_33_L, (u16ValidSwing << 8 | u16ValidSwing));
        // ch8+ch9
        MOD_A_W2BYTE(REG_MOD_A_BK00_34_L, (u16ValidSwing << 8 | u16ValidSwing));
        // ch10+ch11
        MOD_A_W2BYTE(REG_MOD_A_BK00_35_L, (u16ValidSwing << 8 | u16ValidSwing));
        // ch12+ch13
        MOD_A_W2BYTE(REG_MOD_A_BK00_36_L, (u16ValidSwing << 8 | u16ValidSwing));
        // ch14+ch15
        MOD_A_W2BYTE(REG_MOD_A_BK00_37_L, (u16ValidSwing << 8 | u16ValidSwing));
    }
    bStatus = TRUE;
...
//        MOD_W2BYTE(REG_MOD_BK00_25_L, 0x003f);
        ...
        // [1] reg_vby1gpi_osd_mode   //[0] reg_vby1_gpi_mode
        W2BYTEMSK(REG_CHIP_25_L, 0x0003, 0x0003);
...
void MHal_PNL_Init(void *pInstance)
{
    ...
    //User defined pipedelay mode
    SC_W2BYTEMSK(pPNLInstancePrivate->u32DeviceID, REG_SC_BK68_50_L,BIT(0), BIT(0));

    //Pipe delay
    SC_W2BYTEMSK(pPNLInstancePrivate->u32DeviceID, REG_SC_BK68_51_L, FRC_PIPE_DELAY_VCNT_FSC_FHD, 0x1FFF);
    SC_W2BYTEMSK(pPNLInstancePrivate->u32DeviceID, REG_SC_BK68_52_L, FRC_PIPE_DELAY_HCNT_FSC_FHD, 0x1FFF);

    //FRC_TGEN_Enable_Lock_Source
    ...
    SC_W2BYTEMSK(pPNLInstancePrivate->u32DeviceID, REG_SC_BK68_28_L, (BIT(0)|BIT(1)|BIT(2)), (BIT(0)|BIT(1)|BIT(2)));
    SC_W2BYTEMSK(pPNLInstancePrivate->u32DeviceID, REG_SC_BK68_20_L, BIT(0) | BIT(2), (BIT(0)|BIT(2)));

    //FRC_TGEN_Init
    SC_W2BYTEMSK(pPNLInstancePrivate->u32DeviceID, REG_SC_BK68_20_L, (BIT(0)|BIT(1)|BIT(2)), (BIT(0)|BIT(1)|BIT(2)));
    SC_W2BYTEMSK(pPNLInstancePrivate->u32DeviceID, REG_SC_BK68_2F_L, BIT(0), BIT(0));
...
void MHal_PNL_SetVopVttByBK68(MS_U32 u32DeviceID, MS_U16 u16Vtt)
{
    ...
    SC_W2BYTEMSK(u32DeviceID, REG_SC_BK68_38_L, 0xFA, 0xFFFF);

    SC_W2BYTEMSK(u32DeviceID, REG_SC_BK68_36_L, u16Vtt , 0xFFFF);
    SC_W2BYTEMSK(u32DeviceID, REG_SC_BK68_37_L, u16Vtt , 0xFFFF);

    SC_W2BYTEMSK(u32DeviceID, REG_SC_BK68_33_L, BIT(14) , BIT(14));
    SC_W2BYTEMSK(u32DeviceID, REG_SC_BK68_33_L, 0 , BIT(14));

    SC_W2BYTEMSK(u32DeviceID, REG_SC_BK68_33_L, BIT(3) , BIT(3));
    SC_W2BYTEMSK(u32DeviceID, REG_SC_BK68_33_L, 0 , BIT(3));
