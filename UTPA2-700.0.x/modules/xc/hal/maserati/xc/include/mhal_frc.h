...
#define FRC_Y_TRIGGER_DELAY 70
#define FRC_Y_TRIGGER_DELAY_RGB 10
...
#define FRC_FO_H_4K_SZIE 3840
#define FRC_FO_V_2K_SZIE 2160
#define FRC_FO_H_2K_SZIE 1920
#define FRC_FO_V_1K_SZIE 1080
#define FRC_FO_V_0_5K_SZIE 540
#define FRC_FO_H_1280_SZIE 1280
#define FRC_FO_V_720_SZIE 720
#define FRC_FO_H_720_SZIE 720
#define FRC_FO_V_576_SZIE 576
#define FRC_FO_V_480_SZIE 480
...
typedef enum
{
    ...
    E_FRC_STGEN_ODCLK_N      = 1,  // ODLCK div N
    E_FRC_STGEN_ODCLK_2      = 2,  // ODLCK/2
    E_FRC_STGEN_ODCLK_4      = 3,  // ODCLK/4
} E_FRC_STGEN_ODCLK;

typedef enum
{
    E_FSC_IDCLK_1      = 0,  // ODLCK
    E_FSC_IDCLK_2      = 1,  // ODLCK/2
    E_FSC_IDCLK_4      = 2,  // ODCLK/4
    E_FSC_IDCLK_N      = 3,  // ODCLK/N
} E_FSC_IDCLK;
...
typedef enum
{
    E_FRC_FO_PATH_MODE_120HZ     = 0,  // for maserati mode, 4K2K@120Hz
    E_FRC_FO_PATH_MODE_60HZ      = 1,  // for manhattan mode, 4K2K@60Hz
} E_FRC_FO_PATH_MODE;

typedef enum
{
    E_FRC_SC2_PLL_VS_MODE_OP       = 0,  // for manhattan mode, 4K2K@60Hz, output Sync refernece to OP Vsync
    E_FRC_SC2_PLL_VS_MODE_FRC      = 1,  // for maserati mode, 4K2K@120Hz,  output Sync refernece to FRC Vsync
} E_FRC_SC2_PLL_VS_MODE;

#define PIP_DELAY_COUNTER_RESET    (BIT(3)) // BK68_50_L [3]
//-------------------------------------------------------------------------------------------------
...
INTERFACE MS_BOOL Hal_XC_FRC_R2_Set_Input3DFormat(void *pInstance, MS_U8 u8FrcInput3DType);
...
//----------------- Maserati new API  ---------------------//
INTERFACE void MHal_FRC_Set_FO_Path(void *pInstance, E_FRC_FO_PATH_MODE eMode);
INTERFACE void MHal_FRC_Set_FO_VOP_H_Size(void *pInstance, MS_U16 u16HSize);
INTERFACE void MHal_FRC_Set_FO_SPTP_Setting(void *pInstance, MS_U16 u16HSzie, MS_BOOL bUserMode);
INTERFACE void MHal_FRC_Set_FO_2Line_Setting(void *pInstance, MS_U16 u16HSzie, MS_U16 u16VSzie);
INTERFACE void MHal_FRC_Set_FO_OSDDS_Setting(void *pInstance, MS_BOOL bEnBypass, MS_BOOL bEnBypassUser, MS_BOOL bEnOPM, MS_BOOL bEnOPMUser, MS_BOOL bEnMFC, MS_BOOL bEnMFCUser);

INTERFACE void MHal_FRC_FO_TGEN_SetVTotal(void *pInstance, MS_U16 u16VTotal);
INTERFACE void MHal_FRC_FO_TGEN_SetHTotal(void *pInstance, MS_U16 u16HTotal);
INTERFACE void MHal_FRC_FO_TGEN_SetVTrigY(void *pInstance, MS_U16 u16VTrigY);
INTERFACE void MHal_FRC_FO_TGEN_SetVTrigX(void *pInstance, MS_U16 u16VTrigX);
INTERFACE void MHal_FRC_FO_TGEN_SetVSyncStartEndY(void *pInstance, MS_U16 u16Start, MS_U16 u16End);
INTERFACE void MHal_FRC_FO_TGEN_SetHSyncStartEndX(void *pInstance, MS_U16 u16Start, MS_U16 u16End);
INTERFACE void MHal_FRC_FO_TGEN_SetFdeStartEndY(void *pInstance, MS_U16 u16Start, MS_U16 u16End);
INTERFACE void MHal_FRC_FO_TGEN_SetFdeStartEndX(void *pInstance, MS_U16 u16Start, MS_U16 u16End);
INTERFACE void MHal_FRC_FO_TGEN_SetMdeStartEndY(void *pInstance, MS_U16 u16Start, MS_U16 u16End);
INTERFACE void MHal_FRC_FO_TGEN_SetMdeStartEndX(void *pInstance, MS_U16 u16Start, MS_U16 u16End);
INTERFACE void MHal_FRC_FO_TGEN_SetMdeStartEndX_L(void *pInstance, MS_U16 u16Start, MS_U16 u16End);
INTERFACE void MHal_FRC_FO_TGEN_SetMdeStartEndX_R(void *pInstance, MS_U16 u16Start, MS_U16 u16End);

INTERFACE void MHal_FRC_Set_SC2_PLL_Vsync_Ref(void *pInstance, E_FRC_SC2_PLL_VS_MODE eMode);
