...
#include "Maserati_2D_480.h"

// 2D_FHD
// 2D_FHD_RGB_BYPASS
void MFC_3D_2D_480_2D_480_RGB_BYPASS(void)
{
// FSC_TOP
...
// VSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_0A, 0xE0, 0xff); // vsp_vsize_in0
    MDrv_WriteByteMask( REG_FSC_BK23_0B, 0x01, 0xff); // vsp_vsize_in1
    MDrv_WriteByteMask( REG_FSC_BK23_0C, 0xE0, 0xff); // vsp_vsize_out0
    MDrv_WriteByteMask( REG_FSC_BK23_0D, 0x01, 0xff); // vsp_vsize_out1
// HSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_34, 0x68, 0xff); // hsp_hsize_in0
    MDrv_WriteByteMask( REG_FSC_BK23_35, 0x01, 0xff); // hsp_hsize_in1
    MDrv_WriteByteMask( REG_FSC_BK23_36, 0x68, 0xff); // hsp_hsize_out0
    MDrv_WriteByteMask( REG_FSC_BK23_37, 0x01, 0xff); // hsp_hsize_out1
...
// VIP
    MDrv_WriteByteMask( REG_FSC_BK1B_1C, 0x40, 0xFF); // reg_vip_horizontal_num_lsb
    MDrv_WriteByteMask( REG_FSC_BK1B_1D, 0x04, 0x0F); // reg_vip_horizontal_num_msb
    MDrv_WriteByteMask( REG_FSC_BK1B_1E, 0x38, 0xFF); // reg_vip_vertical_num_lsb
    MDrv_WriteByteMask( REG_FSC_BK1B_1F, 0x04, 0x1F); // reg_vip_vertical_num_msb
...
// SPTF_D2LR
    ...
    MDrv_WriteByteMask( REG_FRC_BK33A_62  , 0xc0, 0xff); // gb_cut_end_l
    MDrv_WriteByteMask( REG_FRC_BK33A_63  , 0x03, 0xff); // gb_cut_end_l
...
// IPM_OPM
    MDrv_WriteByteMask( REG_FRC_BK134_1C  , 0xc0, 0xff); // ipm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK134_1D  , 0x03, 0xff); // ipm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK134_1E  , 0xc0, 0xff); // ipm_fetch_f2
    MDrv_WriteByteMask( REG_FRC_BK134_1F  , 0x03, 0xff); // ipm_fetch_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK134_9C  , 0xc0, 0xff); // ipm_fetch_f1
    MDrv_WriteByteMask( REG_FRC_BK134_9D  , 0x03, 0xff); // ipm_fetch_f1
    MDrv_WriteByteMask( REG_FRC_BK134_9E  , 0xc0, 0xff); // ipm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK134_9F  , 0x03, 0xff); // ipm_offset_f1
    ...
    MDrv_WriteByteMask( REG_FRC_BK134_2C  , 0xc0, 0xff); // opm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK134_2D  , 0x03, 0xff); // opm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK134_2E  , 0xc0, 0xff); // opm_fetch_f2
    MDrv_WriteByteMask( REG_FRC_BK134_2F  , 0x03, 0xff); // opm_fetch_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK136_2C  , 0xc0, 0xff); // opm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK136_2D  , 0x03, 0xff); // opm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK136_2E  , 0xc0, 0xff); // opm_fetch_f1
    MDrv_WriteByteMask( REG_FRC_BK136_2F  , 0x03, 0xff); // opm_fetch_f1
    ...
    MDrv_WriteByteMask( REG_FRC_BK13A_2C  , 0xc0, 0xff); // opm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK13A_2D  , 0x03, 0xff); // opm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK13A_2E  , 0xc0, 0xff); // opm_fetch_f2
    MDrv_WriteByteMask( REG_FRC_BK13A_2F  , 0x03, 0xff); // opm_fetch_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK13B_2C  , 0xc0, 0xff); // opm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK13B_2D  , 0x03, 0xff); // opm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK13B_2E  , 0xc0, 0xff); // opm_fetch_f1
    MDrv_WriteByteMask( REG_FRC_BK13B_2F  , 0x03, 0xff); // opm_fetch_f1
    ...
    MDrv_WriteByteMask( REG_FRC_BK13C_2C  , 0xc0, 0xff); // opm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK13C_2D  , 0x03, 0xff); // opm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK13C_2E  , 0xc0, 0xff); // opm_fetch_f2
    MDrv_WriteByteMask( REG_FRC_BK13C_2F  , 0x03, 0xff); // opm_fetch_f2
    ...
    MDrv_WriteByteMask( REG_FRC_BK13D_2C  , 0xc0, 0xff); // opm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK13D_2D  , 0x03, 0xff); // opm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK13D_2E  , 0xc0, 0xff); // opm_fetch_f1
    MDrv_WriteByteMask( REG_FRC_BK13D_2F  , 0x03, 0xff); // opm_fetch_f1
...
// IPM_OPM_vlen
    ...
    MDrv_WriteByteMask( REG_FRC_BK134_CC  , 0x38, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK134_CD  , 0x04, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK136_CC  , 0x38, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK136_CD  , 0x04, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13A_CC  , 0x38, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13A_CD  , 0x04, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13B_CC  , 0x38, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13B_CD  , 0x04, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13C_CC  , 0x38, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13C_CD  , 0x04, 0x1f); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13D_CC  , 0x38, 0xff); // reg_opm_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13D_CD  , 0x04, 0x1f); // reg_opm_vlen_new
    ...
    MDrv_WriteByteMask( REG_FRC_BK134_C8  , 0x1c, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK134_C9  , 0x02, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK136_C8  , 0x1c, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK136_C9  , 0x02, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13A_C8  , 0x1c, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13A_C9  , 0x02, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13B_C8  , 0x1c, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13B_C9  , 0x02, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13C_C8  , 0x1c, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13C_C9  , 0x02, 0x1f); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13D_C8  , 0x1c, 0xff); // reg_opm_meds_vlen_new
    MDrv_WriteByteMask( REG_FRC_BK13D_C9  , 0x02, 0x1f); // reg_opm_meds_vlen_new
// IPM_OPM_DSmode
    MDrv_WriteByteMask( REG_FRC_BK13A_1C  , 0xe0, 0xff); // reg_ipm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK13A_1D  , 0x01, 0xff); // reg_ipm_offset_f2
    MDrv_WriteByteMask( REG_FRC_BK13A_1E  , 0xe0, 0xff); // reg_ipm_fetch_num_f2
    MDrv_WriteByteMask( REG_FRC_BK13A_1F  , 0x01, 0xff); // reg_ipm_fetch_num_f2
    MDrv_WriteByteMask( REG_FRC_BK13A_9C  , 0xe0, 0xff); // reg_ipm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK13A_9D  , 0x01, 0xff); // reg_ipm_offset_f1
    MDrv_WriteByteMask( REG_FRC_BK13A_9E  , 0xe0, 0xff); // reg_ipm_fetch_num_f1
    MDrv_WriteByteMask( REG_FRC_BK13A_9F  , 0x01, 0xff); // reg_ipm_fetch_num_f1
    MDrv_WriteByteMask( REG_FRC_BK134_BC  , 0xe0, 0xff); // reg_opm_meds_offset
    MDrv_WriteByteMask( REG_FRC_BK134_BD  , 0x01, 0xff); // reg_opm_meds_offset
    MDrv_WriteByteMask( REG_FRC_BK134_BE  , 0xe0, 0xff); // reg_opm_meds_fetch_num
    MDrv_WriteByteMask( REG_FRC_BK134_BF  , 0x01, 0xff); // reg_opm_meds_fetch_num
// IPM_3D
...
// MEMC_FSC
    MDrv_WriteByteMask( REG_FRC_BK320_A4  , 0x80, 0xff); // reg_frc_xxxx
    MDrv_WriteByteMask( REG_FRC_BK320_A5  , 0x07, 0xff); // reg_frc_xxxx
    MDrv_WriteByteMask( REG_FRC_BK320_A6  , 0xC0, 0xff); // reg_frc_xxxx
    MDrv_WriteByteMask( REG_FRC_BK320_A7  , 0x03, 0xff); // reg_frc_xxxx
// MLB
...
// MFC_pipectrl
    MDrv_WriteByteMask( REG_FRC_BK233_3E  , 0x80, 0xff); // reg_ppctr_h_pixl_num_me
    MDrv_WriteByteMask( REG_FRC_BK233_3F  , 0x07, 0x1f); // reg_ppctr_h_pixl_num_me
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_46  , 0x80, 0xff); // reg_me_h_pixel_num_mi
    MDrv_WriteByteMask( REG_FRC_BK233_47  , 0x07, 0x1f); // reg_me_h_pixel_num_mi
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_F8  , 0x80, 0xff); // reg_h_pixel_num_mlb
    MDrv_WriteByteMask( REG_FRC_BK233_F9  , 0x07, 0x1f); // reg_h_pixel_num_mlb
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_3A  , 0x80, 0xff); // reg_time_gen_sw_h_width
    MDrv_WriteByteMask( REG_FRC_BK233_3B  , 0x07, 0x1f); // reg_time_gen_sw_h_width
    ...
    MDrv_WriteByteMask( REG_FRC_BK233_42  , 0xc0, 0xff); // reg_mlb_disp_pixel_latch
    MDrv_WriteByteMask( REG_FRC_BK233_43  , 0x03, 0x1f); // reg_mlb_disp_pixel_latch
...
// MFC
    MDrv_WriteByteMask( REG_FRC_BK226_61  , 0x72, 0xff); // reg_MFC_enable
    MDrv_WriteByteMask( REG_FRC_BK226_70  , 0x00, 0x20); // 
    MDrv_WriteByteMask( REG_FRC_BK226_73  , 0x07, 0x1f); // reg_h_pix_num_3D
    MDrv_WriteByteMask( REG_FRC_BK226_72  , 0x80, 0xff); // reg_h_pix_num_3D
    MDrv_WriteByteMask( REG_FRC_BK226_75  , 0x02, 0x1f); // reg_v_lin_num_3D
    MDrv_WriteByteMask( REG_FRC_BK226_74  , 0x20, 0xff); // reg_v_lin_num_3D
    MDrv_WriteByteMask( REG_FRC_BK22C_80  , 0x08, 0x08); // 
    MDrv_WriteByteMask( REG_FRC_BK229_05  , 0x07, 0xFF); // reg_h_pix_num_ME
    MDrv_WriteByteMask( REG_FRC_BK229_04  , 0x80, 0xFF); // reg_h_pix_num_ME
    ...
    MDrv_WriteByteMask( REG_FRC_BK229_91  , 0x07, 0xFF); // reg_h_pix_num_MI
    MDrv_WriteByteMask( REG_FRC_BK229_90  , 0x80, 0xFF); // reg_h_pix_num_MI
    ...
    MDrv_WriteByteMask( REG_FRC_BK226_67  , 0x00, 0x01); // reg_422to444_en
    MDrv_WriteByteMask( REG_FRC_BK232_D0  , 0x02, 0x02); // reg_rgb_bypass
    MDrv_WriteByteMask( REG_FRC_BK226_60  , 0x00, 0x80); // reg_c_drop
    MDrv_WriteByteMask( REG_FRC_BK229_9C  , 0x00, 0x80); // reg_422_avgmode
    MDrv_WriteByteMask( REG_FRC_BK22C_80  , 0x00, 0x01); // reg_pipectrl_bypass
// MFC_Halo
    MDrv_WriteByteMask( REG_FRC_BK22C_93  , 0x80, 0x80); // reg_halo_buf_frame_end_en
    MDrv_WriteByteMask( REG_FRC_BK22C_A7  , 0x00, 0x02); // reg_halo_buf23_force_ready
// MFC_GMV
    MDrv_WriteByteMask( REG_FRC_BK232_2A  , 0x00, 0x01); // reg_gmv_in_ud_mode
// SNR
    MDrv_WriteByteMask( REG_FRC_BK2E_E0  , 0x00, 0x08); // reg_snr_bypass_en
    MDrv_WriteByteMask( REG_FRC_BK2E_E0  , 0x00, 0x04); // reg_snr_la_en
    MDrv_WriteByteMask( REG_FRC_BK2E_E2  , 0x80, 0xff); // reg_snr_pix_num_LSB
    MDrv_WriteByteMask( REG_FRC_BK2E_E3  , 0x07, 0x1f); // reg_snr_pix_num_MSB
...
// T3D
    ...
    MDrv_WriteByteMask( REG_FRC_BK13B_C2  , 0x80, 0xff); // reg_ln_width
    MDrv_WriteByteMask( REG_FRC_BK13B_C3  , 0x07, 0x3f); // reg_ln_width
    MDrv_WriteByteMask( REG_FRC_BK13B_C4  , 0x38, 0xff); // reg_col_height
    MDrv_WriteByteMask( REG_FRC_BK13B_C5  , 0x04, 0x1f); // reg_col_height
    ...
    MDrv_WriteByteMask( REG_FRC_BK13C_00  , 0x80, 0xff); // reg_h_size
    MDrv_WriteByteMask( REG_FRC_BK13C_01  , 0x07, 0x0f); // reg_h_size
    MDrv_WriteByteMask( REG_FRC_BK13C_02  , 0x80, 0xff); // reg_hsu_size
    MDrv_WriteByteMask( REG_FRC_BK13C_03  , 0x07, 0x0f); // reg_hsu_size
    ...
    MDrv_WriteByteMask( REG_FRC_BK13E_00  , 0x80, 0xff); // reg_h_size
    MDrv_WriteByteMask( REG_FRC_BK13E_01  , 0x07, 0x0f); // reg_h_size
    MDrv_WriteByteMask( REG_FRC_BK13E_02  , 0x80, 0xff); // reg_hsu_size
    MDrv_WriteByteMask( REG_FRC_BK13E_03  , 0x07, 0x0f); // reg_hsu_size
...
// FO_HSU
    ...
    MDrv_WriteByteMask( REG_FRC_BK115_0C  , 0x80, 0xff); // hsp_size_in0
    MDrv_WriteByteMask( REG_FRC_BK115_0D  , 0x07, 0x1f); // hsp_size_in1
    MDrv_WriteByteMask( REG_FRC_BK115_0E  , 0x80, 0xff); // hsp_size_out0
    MDrv_WriteByteMask( REG_FRC_BK115_0F  , 0x07, 0x1f); // hsp_size_out1
// SPTP
    MDrv_WriteByteMask( REG_FRC_BK3E_80  , 0x00, 0xff); // reg_sptp_mfc_dc_m1
    MDrv_WriteByteMask( REG_FRC_BK3E_81  , 0x00, 0x0f); // reg_sptp_mfc_dc_m1
    MDrv_WriteByteMask( REG_FRC_BK3E_82  , 0x00, 0x80); // reg_sptp_fbl_en
    MDrv_WriteByteMask( REG_FRC_BK3E_84  , 0x00, 0x01); // reg_sptp_usr_en
    MDrv_WriteByteMask( REG_FRC_BK3E_88  , 0x00, 0xff); // reg_sptp_f0_st
    MDrv_WriteByteMask( REG_FRC_BK3E_89  , 0x00, 0x01); // reg_sptp_f0_st
    MDrv_WriteByteMask( REG_FRC_BK3E_8A  , 0x00, 0xff); // reg_sptp_f0_end
    MDrv_WriteByteMask( REG_FRC_BK3E_8B  , 0x00, 0x01); // reg_sptp_f0_end
    MDrv_WriteByteMask( REG_FRC_BK3E_8C  , 0x00, 0xff); // reg_sptp_f1_st
    MDrv_WriteByteMask( REG_FRC_BK3E_8D  , 0x00, 0x01); // reg_sptp_f1_st
    MDrv_WriteByteMask( REG_FRC_BK3E_8E  , 0x00, 0xff); // reg_sptp_f1_end
    MDrv_WriteByteMask( REG_FRC_BK3E_8F  , 0x00, 0x01); // reg_sptp_f1_end
    MDrv_WriteByteMask( REG_FRC_BK3E_86  , 0x00, 0xff); // reg_sptp_gb_en
// CSC
}
...
/********************************************/
// 2D_FHD_YUV
void MFC_3D_2D_480_2D_480_YUV(void)
{
// FSC_TOP
    MDrv_WriteByteMask( REG_FSC_BK20_A2, 0x80, 0xff); // reg_splt_gb_in_size_r
    MDrv_WriteByteMask( REG_FSC_BK20_A3, 0x00, 0x01); // reg_splt_gb_in_size_r
