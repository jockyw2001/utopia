...
// VSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_15, 0x02, 0x02); // vsp_shift_mode_en
...
// HSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_11, 0x02, 0x02); // hsp_shift_mode_en
...
// MFC
    ...
    MDrv_WriteByteMask( REG_FRC_BK229_06  , 0x70, 0xFF); // reg_v_lin_num_ME
...
/********************************************/
// 2D_2205_RGB_BYPASS
void MFC_3D_2D_4K2K_2D_2205_RGB_BYPASS(void)
{
// FSC_TOP
    MDrv_WriteByteMask( REG_FSC_BK20_A2, 0x80, 0xff); // reg_splt_gb_in_size_r
    MDrv_WriteByteMask( REG_FSC_BK20_A3, 0x00, 0x01); // reg_splt_gb_in_size_r
...
// VSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_15, 0x01, 0xff); // vsp_scl_en
    MDrv_WriteByteMask( REG_FSC_BK23_15, 0x00, 0x02); // vsp_shift_mode_en
    MDrv_WriteByteMask( REG_FSC_BK23_0A, 0x9D, 0xff); // vsp_vsize_in0
    MDrv_WriteByteMask( REG_FSC_BK23_0B, 0x08, 0xff); // vsp_vsize_in1
    MDrv_WriteByteMask( REG_FSC_BK23_0C, 0x9D, 0xff); // vsp_vsize_out0
    MDrv_WriteByteMask( REG_FSC_BK23_0D, 0x08, 0xff); // vsp_vsize_out1
// HSU
    MDrv_WriteByteMask( REG_FSC_BK23_0E, 0x00, 0xff); // hsp_scl_fac0
    MDrv_WriteByteMask( REG_FSC_BK23_0F, 0x00, 0xff); // hsp_scl_fac1
...
/********************************************/
// 2D_2205_YUV
void MFC_3D_2D_4K2K_2D_2205_YUV(void)
{
// FSC_TOP
    MDrv_WriteByteMask( REG_FSC_BK20_A2, 0x80, 0xff); // reg_splt_gb_in_size_r
    MDrv_WriteByteMask( REG_FSC_BK20_A3, 0x00, 0x01); // reg_splt_gb_in_size_r
