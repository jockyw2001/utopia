...
#include "Maserati_2D_720.h"

// 2D_FHD
// 2D_FHD_RGB_BYPASS
void MFC_3D_2D_720_2D_720_RGB_BYPASS(void)
{
// FSC_TOP
...
// VSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_0A, 0xD0, 0xff); // vsp_vsize_in0
    MDrv_WriteByteMask( REG_FSC_BK23_0B, 0x02, 0xff); // vsp_vsize_in1
    MDrv_WriteByteMask( REG_FSC_BK23_0C, 0xD0, 0xff); // vsp_vsize_out0
...
// HSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_35, 0x02, 0xff); // hsp_hsize_in1
    MDrv_WriteByteMask( REG_FSC_BK23_36, 0x80, 0xff); // hsp_hsize_out0
    MDrv_WriteByteMask( REG_FSC_BK23_37, 0x02, 0xff); // hsp_hsize_out1
...
/********************************************/
// 2D_FHD_YUV
void MFC_3D_2D_720_2D_720_YUV(void)
{
// FSC_TOP
    MDrv_WriteByteMask( REG_FSC_BK20_A2, 0x80, 0xff); // reg_splt_gb_in_size_r
    MDrv_WriteByteMask( REG_FSC_BK20_A3, 0x00, 0x01); // reg_splt_gb_in_size_r
