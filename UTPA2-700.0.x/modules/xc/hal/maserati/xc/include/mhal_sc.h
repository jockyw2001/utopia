...
typedef enum
{
        E_DELAY_TIME_UNKNOWN = 0,
        E_DELAY_TIME_FRC = 1,
}XC_DELAY_TIME_STATUS;
...
INTERFACE MS_BOOL Hal_SC_secure_Check_RBase(void *pInstance);
...
INTERFACE MS_U16 MHal_XC_GetDelayTime(void* pInstance,XC_DELAY_TIME_STATUS enStatus);
