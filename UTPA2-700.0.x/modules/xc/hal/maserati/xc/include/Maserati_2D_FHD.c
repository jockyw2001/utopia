...
#include "Maserati_2D_FHD.h"

// 2D_FHD
// 2D_FHD_RGB_BYPASS
void MFC_3D_2D_FHD_2D_FHD_RGB_BYPASS(void)
{
// FSC_TOP
...
// VSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_0C, 0x38, 0xff); // vsp_vsize_out0
    MDrv_WriteByteMask( REG_FSC_BK23_0D, 0x04, 0xff); // vsp_vsize_out1
// HSU
    ...
    MDrv_WriteByteMask( REG_FSC_BK23_36, 0xc0, 0xff); // hsp_hsize_out0
    MDrv_WriteByteMask( REG_FSC_BK23_37, 0x03, 0xff); // hsp_hsize_out1
...
// T3D
    ...
    MDrv_WriteByteMask( REG_SC_BKC6_C2, 0x80, 0xff); // reg_ln_width
    MDrv_WriteByteMask( REG_SC_BKC6_C3, 0x07, 0x3f); // reg_ln_width
    MDrv_WriteByteMask( REG_SC_BKC6_C4, 0x38, 0xff); // reg_col_height
    MDrv_WriteByteMask( REG_SC_BKC6_C5, 0x04, 0x1f); // reg_col_height
...
/********************************************/
// 2D_FHD_YUV
void MFC_3D_2D_FHD_2D_FHD_YUV(void)
{
// FSC_TOP
    MDrv_WriteByteMask( REG_FSC_BK20_A2, 0x80, 0xff); // reg_splt_gb_in_size_r
    MDrv_WriteByteMask( REG_FSC_BK20_A3, 0x00, 0x01); // reg_splt_gb_in_size_r
