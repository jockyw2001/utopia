...
// VSU
    ...
    MDrv_WriteByteMask( REG_SC_BK4F_56, 0x38, 0xff); // vsp_vsize_out0
    MDrv_WriteByteMask( REG_SC_BK4F_57, 0x04, 0xff); // vsp_vsize_out1
// HSU
    ...
    MDrv_WriteByteMask( REG_SC_BK4F_54, 0x80, 0xff); // hsp_hsize_out0
    MDrv_WriteByteMask( REG_SC_BK4F_55, 0x07, 0xff); // hsp_hsize_out1
// SPTF_D2LR
