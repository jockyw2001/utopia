...
#define PHASE_OFFSET_LIMIT_HDMITX (0x500UL)
...
#define FRC_LINE_BUFFER_MAX  (3840UL)
...
#define SUPPORTED_KERNEL_INT  ((1UL << SC_INT_VSINT)|(1UL << SC_INT_PWM_RP_R_INT)|(1UL << SC_INT_PWM_FP_R_INT))
