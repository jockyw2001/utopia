...
// VSU
    ...
    MDrv_WriteByteMask( REG_SC_BK4F_52, 0x1C, 0xff); // vsp_vsize_in0
    MDrv_WriteByteMask( REG_SC_BK4F_53, 0x02, 0xff); // vsp_vsize_in1
    MDrv_WriteByteMask( REG_SC_BK4F_56, 0x1C, 0xff); // vsp_vsize_out0
    MDrv_WriteByteMask( REG_SC_BK4F_57, 0x02, 0xff); // vsp_vsize_out1
// HSU
