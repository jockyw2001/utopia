...
// Scaling Ratio Macro
#ifdef MSOS_TYPE_LINUX_KERNEL
#define H_PreScalingDownRatio(Input, Output)                { u64_result = ((MS_U64)(Output))    * 2097152ul;do_div(u64_result,(Input));     u64_result +=1;do_div(u64_result,2);}
...
#define V_PostScalingRatio_P2I(Input, Output)               { u64_result = ((MS_U64)(Input))     * 2097152ul;do_div(u64_result,(Output*2));}
#else
...
#define INTERRUPT_DUMMY_REGISTER  REG_SC_BK30_4C_L
...
typedef enum
{
    E_XC_FORCE_MEMORY_REQUEST_OFF_MAIN = 0,
    E_XC_FORCE_MEMORY_REQUEST_OFF_MIAN_DUAL,
    E_XC_FORCE_MEMORY_REQUEST_OFF_SUB,
    E_XC_FORCE_MEMORY_REQUEST_OFF_SUB_DUAL,
    E_XC_FORCE_MEMORY_REQUEST_OFF_SUB_OPW,
    E_XC_FORCE_MEMORY_REQUEST_OFF_ALL,
    E_XC_FORCE_MEMORY_REQUEST_OFF_NUM,
} E_XC_FORCE_MEMORY_REQUEST_OFF;
...
typedef enum {
    EN_XC_PIXEL_SHIFT_INVALID = 0,
    EN_XC_PIXEL_SHIFT_DISABLE,
    EN_XC_PIXEL_SHIFT_ENABLE,
    EN_XC_PIXEL_SHIFT_FORCE_UPDATE,
} XC_PIXEL_SHIFT_STATUS;

typedef struct {
    //BK10
    MS_U16 u16RegTGenDeVstart;
    MS_U16 u16RegTGenDeVend;

    // BK68
    MS_U16 u16RegSTGenDeVstart;
    MS_U16 u16RegSTGenDeVend;
} XC_VSYNC_VSTART;
...
INTERFACE void MHal_CLKGEN_FRC_Init(void *pInstance, MS_U8 u8LPLL_Mode);
...
INTERFACE MS_PHY Hal_SC_get_mcdi_memoryaddressfromreg(void *pInstance, E_XC_MCDI_TYPE eType);
...
//Vtrack
#define MHal_XC_Vtrack_SetPayloadData(args...) E_APIXC_RET_FAIL_FUN_NOT_SUPPORT
#define MHal_XC_Vtrack_SetUserDefindedSetting(args...) E_APIXC_RET_FAIL_FUN_NOT_SUPPORT
#define MHal_XC_Vtrack_Enable(args...) E_APIXC_RET_FAIL_FUN_NOT_SUPPORT
//Bypass mode
...
INTERFACE void Hal_SC_3D_CopyDispWinToSTGEN(void *pInstance, SCALER_WIN eWindow);
...
INTERFACE MS_BOOL Hal_SC_AdjustIpmWriteLimite(void *pInstance, MS_BOOL bIsLeft, MS_BOOL bNeedSwap, SCALER_WIN eWindow);
...
INTERFACE void Hal_SC_Set_T3D_MiuSelectExternal(void *pInstance, MS_U8 u8MIUSel);
INTERFACE MS_BOOL MHal_XC_GetPQPathStatus(void* pInstance, E_XC_PQ_Path_Type ePqPathType, MS_U16 u16Width, MS_U16 u16Height);
INTERFACE void Hal_SC_3D_Enable_FRC_LR_Flag(void *pInstance, MS_BOOL bEnable);

#if FRC_INSIDE
INTERFACE void MHal_XC_FRCR2_IP_Patch(void *pInstance, SCALER_WIN eWindow);
INTERFACE void MHal_XC_FRCR2_IP_PatchClose(void *pInstance, SCALER_WIN eWindow);
INTERFACE void MHal_XC_FRCR2_OP_Patch(void *pInstance, SCALER_WIN eWindow);
INTERFACE void MHal_XC_FRCR2_OP_PatchClose(void *pInstance, SCALER_WIN eWindow);
#endif

#ifdef ENABLE_SPREADMODE
INTERFACE MS_BOOL MHal_XC_IsSupportSpreadMode(void *pInstance);
#endif
...
INTERFACE E_APIXC_ReturnValue MHal_XC_SRAM_PowerDown_Control(void* pInstance, MS_BOOL bEnable);
INTERFACE MS_BOOL MHal_XC_Is_SRAM_PowerDown(void* pInstance);
INTERFACE void MHal_XC_Set_LD_SRAM_Power_Down(void* pInstance, MS_BOOL bIsSRAMPowerDown);
INTERFACE void MHal_XC_Set_ADC_SRAM_Power_Down(void* pInstance, MS_BOOL bIsSRAMPowerDown);
INTERFACE void Hal_SC_Sub_SRAM_PowerDown_Control(void *pInstance, MS_BOOL bPipEnable);
#endif
INTERFACE MS_BOOL Hal_SC_get_pre_align_pixel(void * pInstance, SCALER_WIN eWindow);
INTERFACE MS_BOOL MHal_XC_PixelShiftStatusChange(void* pInstance, XC_PIXEL_SHIFT_STATUS enStatus);
INTERFACE void MHal_XC_SetVopVttByBK68(void* pInstance, MS_U16 u16Vtt, MS_BOOL bMLoadEnable);
...
INTERFACE void Hal_SC_set_Dual_DNRBase0(void *pInstance, MS_PHY u32DNRBase0, SCALER_WIN eWindow);
INTERFACE void Hal_SC_set_Dual_OPMBase0(void *pInstance, MS_PHY u32OPMBase0, SCALER_WIN eWindow);
#if PIP_PATCH_USING_SC1_MAIN_AS_SC0_SUB
INTERFACE MS_BOOL Hal_SC_3D_IsDualViewMode(void *pInstance, SCALER_WIN eWindow);
INTERFACE void Hal_SC_3D_Set_DualView(void *pInstance, MS_BOOL bEnable);
INTERFACE void Hal_SC_set_dualview_clone(void *pInstance, MS_BOOL bEnable);
#endif
