...
#define H2V2_PIXEL_SHIFT_PATCH_USING_IP_DE_BYPASS_MODE             TRUE          // Use IP_DE_BYPASS_MODE as patch
...
//Temp patch, wait to discuss
#define ACE_SKIP_RESET_VARIABLE_WHEN_STR
