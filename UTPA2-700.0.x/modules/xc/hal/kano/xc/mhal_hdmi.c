...
void Hal_HDCP_clearflag(E_MUX_INPUTPORT enInputPortType)
{
    ...
    {
        default:
        case INPUT_PORT_DVI0:  u16bank_offset = 0x0000; break; // BK 0x151C00
        case INPUT_PORT_DVI1:  u16bank_offset = 0x0300;  break; // BK 0x151F00
        case INPUT_PORT_DVI2:  u16bank_offset = 0x0600;  break; // BK 0x152200
        case INPUT_PORT_DVI3:  u16bank_offset = 0x0900;  break; // BK 0x152500
    }
...
void Hal_HDCP_initproductionkey( MS_U8 * pu8HdcpKeyData )
{
    ...
    for(u16loop = INPUT_PORT_DVI0; u16loop <= INPUT_PORT_DVI_END; u16loop++)
    {
        ...
        {
            default:
            case 0: u16bank_offset = 0x0000; break; // BK 0x151C00
            //fix coverity error; logically dead code due to kano only has 1 Rx port;
            //case 1: u16bank_offset = 0x0300; break; // BK 0x151F00
            //case 2: u16bank_offset = 0x0600; break; // BK 0x152200
            //case 3: u16bank_offset = 0x0900; break; // BK 0x152500
        }
...
void Hal_HDMI_init(MS_BOOL bImmeswitchSupport, MS_U8 ucMHLSupportPath)
{
   ...
   // PM_W2BYTE(REG_PM_SLEEP_4A_L, 0xF000, 0xF000); // power off DVI off-line detection clock
    ...
    for(port_index = INPUT_PORT_DVI0; port_index <= INPUT_PORT_DVI_END; port_index++)
    {
		...
		W2BYTE(REG_COMBO_PHY0_P0_10_L + u16bank_offset, 0x0018); // [4]: reg_swap_dcdr_updn_polity; [3]: reg_enable_phase_step
...
void Hal_HDMI_Set_EQ(E_MUX_INPUTPORT enInputPortType, MS_HDMI_EQ enEq, MS_U8 u8EQValue)
{
    ...
    {
        default:
        case INPUT_PORT_DVI0:  u16bank_offset = 0x0000;  break; // BK 0x151000
        case INPUT_PORT_DVI1:  u16bank_offset = 0x0200;  break; // BK 0x151200
        case INPUT_PORT_DVI2:  u16bank_offset = 0x0400;  break; // BK 0x151400
        case INPUT_PORT_DVI3:  u16bank_offset = 0x0600;  break; // BK 0x151600
    }
...
MS_BOOL Hal_DVI_GetDEStableStatus(E_MUX_INPUTPORT enInputPortType)
{
    ...
    {
        default:
        case INPUT_PORT_DVI0:  u16bank_offset = 0x0000;  break; // BK 0x151A00
        case INPUT_PORT_DVI1:  u16bank_offset = 0x0300;  break; // BK 0x151D00
        case INPUT_PORT_DVI2:  u16bank_offset = 0x0600;  break; // BK 0x152000
        case INPUT_PORT_DVI3:  u16bank_offset = 0x0900;  break; // BK 0x152300
    }
