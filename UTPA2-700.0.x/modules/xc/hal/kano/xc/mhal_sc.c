...
void Hal_SC_enable_window(void *pInstance, MS_BOOL bEn,SCALER_WIN eWindow)
{
    ...
    else
    {
        ...
        else
        {
            ...
            if((gSrcInfo[MAIN_WINDOW].stCapWin.height < 2000)
            && (gSrcInfo[MAIN_WINDOW].stCapWin.width < 3200))
                {
...
E_APIXC_ReturnValue Hal_SC_Set_OSDLayer(void *pInstance, E_VOP_OSD_LAYER_SEL  eVOPOSDLayer, SCALER_WIN eWindow)
{
    ...
    if(eWindow == MAIN_WINDOW)
    {
        ...
        MS_U16 GOP_Zorder_Mux_Offset[5] =     {0x3, 0x3, 0x3, 0x3, 0x3};
        MS_BOOL bGOPVscalePipeDelay[6] =      {FALSE, FALSE, FALSE, TRUE, TRUE, FALSE};
        MS_U16 u16GOP_NonVS_PD_Offset =       0x5; //GOP without Vsacle might need add offset on pipedelay
        MS_U16 GOP_ZORDER_LAYER0_MUX_OFFSET = 0x10;
        MS_U16 u16HStart = 0;
        ...
        for (u16MuxIndex = 0; u16MuxIndex < MAX_GOP_MUX; u16MuxIndex++)
        {
            ...
            u32Bank = (REG_GOP_BASE >> 8) + u16BankOffset;
