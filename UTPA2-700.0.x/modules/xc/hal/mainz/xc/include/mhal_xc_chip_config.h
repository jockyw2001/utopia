...
#define SUB_SCALER_LINE_BUFFER_MAX      0
#define SUB_MST_LINE_BFF_MAX            0

#define MS_3D_LINE_BFF_MAX      (960UL)

// MIU Word (Bytes)
#define BYTE_PER_WORD           (16)  // MIU 128: 16Byte/W, MIU 256: 32Byte/W
#define OFFSET_PIXEL_ALIGNMENT  (32)
#define LPLL_LOOPGAIN           (16) //due to bound cale.
...
#define FRC_PIPE_DELAY_VCNT     0x10
#define FRC_PIPE_DELAY_HCNT     0x140
...
#define HW_DESIGN_3D_VER                  (3)// the same as nugget,napoli
...
#define HW_2DTO3D_BLOCK_DR_BUF_SIZE         (0x3000)
#define HW_2DTO3D_DD_BUF_SIZE               (0x10000)
...
#define XC_SUPPORT_2P_MODE                  FALSE

//HW support 2 step scaling
#define XC_SUPPORT_2STEP_SCALING
...
#define SUPPORT_FPLL_REFER_24MXTAL
...
#define HW_SCALING_LIMITATION                               25  //zoom 25%

/// for Chip bringup
#define ENABLE_CHIP_BRINGUP
#define VDEC_4K2K_PATCH_MODIFY_INFO
...
///FRC Area
#define REG_FRC_BANK_BASE           REG_SCALER_BASE
...
#define REG_CKG_DACA2           (REG_CLKGEN0_BASE + 0x4C ) //DAC out
    ...
    #define CKG_DACA2_MASK          BMASK(4:2)
    #define CKG_DACA2_VIF_CLK       (0 << 2)
    #define CKG_DACA2_VD_CLK        (1 << 2)
    #define CKG_DACA2_EXT_TEST_CLK  (2 << 2)
    #define CKG_DACA2_VD_2X_CLK     (3 << 2)
    #define CKG_DACA2_VD_32FSC_CLK  (4 << 2)
    #define CKG_DACA2_VD_ADC_CLK    (5 << 2)
...
#define REG_CKG_EDCLK_F1            (REG_CLKGEN0_BASE + 0x9C ) // EDCLK_F1, CLK_GEN0_4E_L
    ...
    #define CKG_EDCLK_F1_MASK           BMASK(3:2)
    #define CKG_EDCLK_F1_170MHZ         (0 << 2)
...
#define REG_CKG_EDCLK_F2            (REG_CLKGEN0_BASE + 0x9D ) // EDCLK_F2, CLK_GEN0_4E_L
    ...
    #define CKG_EDCLK_F2_MASK           BMASK(3:2)
...
#define REG_CKG_IDCLK0          (REG_CLKGEN0_BASE + 0xA8 ) // off-line detect idclk
    ...
    #define CKG_IDCLK0_CLK_SUB_DC0  (4 << 2)
    #define CKG_IDCLK0_ODCLK        (7 << 2)
    #define CKG_IDCLK0_CLK_SUB_DC02 (8 << 2)
    #define CKG_IDCLK0_CLK_ADC2     (9 << 2)
    #define CKG_IDCLK0_ODCLK2       (10 << 2)
    #define CKG_IDCLK0_CLK_MHL      (13 << 2)
              // same as 5 --> also is 0
...
#define REG_CKG_IDCLK1          (REG_CLKGEN0_BASE + 0xA9 ) // sub main window idclk
    ...
    #define CKG_IDCLK1_CLK_SUB_DC0  (4 << 2)
    #define CKG_IDCLK1_ODCLK        (7 << 2)
    #define CKG_IDCLK1_CLK_SUB_DC02 (8 << 2)
    #define CKG_IDCLK1_CLK_ADC2     (9 << 2)
    #define CKG_IDCLK1_ODCLK2       (10 << 2)
    #define CKG_IDCLK1_CLK_MHL      (13 << 2)
              // same as 5 --> also is 0
...
#define REG_CKG_IDCLK2          (REG_CLKGEN0_BASE + 0xAA ) // main window idclk
    ...
    #define CKG_IDCLK2_ODCLK        (7 << 2)
    #define CKG_IDCLK2_CLK_SUB_DC0  (8 << 2)
    #define CKG_IDCLK2_CLK_ADC2     (9 << 2)
    #define CKG_IDCLK2_ODCLK2       (10 << 2)
    #define CKG_IDCLK2_CLK_MHL      (13 << 2)
    #define CKG_IDCLK2_XTAL         CKG_IDCLK2_ODCLK//(8 << 2)no XTAL select as OD


#define REG_CKG_PRE_IDCLK       (REG_CLKGEN0_BASE + 0xB2 )
    #define CKG_PRE_IDCLK_GATED         BIT(0)
    #define CKG_PRE_IDCLK_INVERT        BIT(1)
    #define CKG_PRE_IDCLK_MASK         BMASK(5:2)
    #define CKG_PRE_IDCLK_CLK_IDCLK0      (0 << 2)
    #define CKG_PRE_IDCLK_CLK_IDCLK1      (1 << 2)
    #define CKG_PRE_IDCLK_CLK_IDCLK2      (2 << 2)
...
//MVOP REG
#define REG_MVOP_FORCE_WR       (REG_MVOP_BASE    + 0x27)
...
#define REG_MVOP_SKIPSIZE     (REG_MVOP_BASE    + 0x44)
#define REG_MVOP_VOFFSET0     (REG_MVOP_BASE    + 0x45)
#define REG_MVOP_VOFFSET1     (REG_MVOP_BASE    + 0x46)
...
#define REG_CKG_S2_FICLK2_F2        (REG_CLKGEN2_BASE + 0xC3 )
    #define CKG_S2_FICLK2_F2_GATED      BIT(4)
    #define CKG_S2_FICLK2_F2_INVERT     BIT(5)
    #define CKG_S2_FICLK2_F2_MASK       BMASK(7:6)
    #define CKG_S2_FICLK2_F2_IDCLK2     (0 << 6)
    #define CKG_S2_FICLK2_F2_FCLK       (1 << 6)
...
#define MIU_SC_G3REQUEST_MASK   (0x3483)
...
#define MIU_FRC_G3REQUEST_MASK   (0xCC00)
