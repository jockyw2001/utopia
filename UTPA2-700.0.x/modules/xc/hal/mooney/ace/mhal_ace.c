...
static MS_BOOL  bNeedStroe3DAutoMode = FALSE;
...
MS_BOOL Hal_ACE_SetICC(void* pInstance, MS_BOOL bScalerWin, XC_ACE_ICC_COLOR_TYPE eICC, MS_U8 u8Val)
{
    ...
    MS_U16 u16Direction = (u8Val > 15?1:0);
...
MS_BOOL Hal_ACE_SetIBC(void* pInstance, MS_BOOL bScalerWin, XC_ACE_IBC_COLOR_TYPE eIBC, MS_U8 u8Val)
{
    ...
    MS_U16 u16Valtmp = (u8Val > 31)?(u8Val - 32):(31 - u8Val);
    MS_U16 u16Direction = (u8Val > 31?1:0) << 5;
	MS_U16 u16Val = u16Direction|u16Valtmp;
    if (bScalerWin > SUB_WINDOW)
    {
        return FALSE;
    ...
    if (bScalerWin == MAIN_WINDOW)
    {
        switch(eIBC)
        {
            case E_ACE_IBC_COLOR_R:
                SC_W2BYTEMSK(0,REG_SC_BK1C_11_L, u16Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_COLOR_G:
                SC_W2BYTEMSK(0,REG_SC_BK1C_12_L, u16Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_COLOR_B:
                SC_W2BYTEMSK(0,REG_SC_BK1C_12_L, u16Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_COLOR_C:
                SC_W2BYTEMSK(0,REG_SC_BK1C_13_L, u16Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_COLOR_M:
                SC_W2BYTEMSK(0,REG_SC_BK1C_13_L, u16Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_COLOR_Y:
                SC_W2BYTEMSK(0,REG_SC_BK1C_14_L, u16Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_COLOR_F:
                SC_W2BYTEMSK(0,REG_SC_BK1C_14_L, u16Val<<8, BITMASK(13:8));
                break;
            default:
            break;
        }
    ...
    else
    {
        ...
        {
            case E_ACE_IBC_COLOR_R:
                SC_W2BYTEMSK(0,REG_SC_BK1C_19_L, u16Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_COLOR_G:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1A_L, u16Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_COLOR_B:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1A_L, u16Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_COLOR_C:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1B_L, u16Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_COLOR_M:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1B_L, u16Val<<8, BITMASK(13:8));
                break;
            case E_ACE_IBC_COLOR_Y:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1C_L, u16Val, BITMASK(5:0));
                break;
            case E_ACE_IBC_COLOR_F:
                SC_W2BYTEMSK(0,REG_SC_BK1C_1C_L, u16Val<<8, BITMASK(13:8));
                break;
            default:
            break;
        }
...
void Hal_ACE_MWEEnable(void *pInstance, MS_BOOL ben, MS_BOOL bLoadFromTable)
{
    ...
    else
    {
        ...
        if(MApi_XC_MLoad_GetStatus_U2(pInstance) == E_MLOAD_ENABLED)
        {
            ...
            if (bNeedStroe3DAutoMode == TRUE)
            {
                bNeedStroe3DAutoMode = FALSE;
