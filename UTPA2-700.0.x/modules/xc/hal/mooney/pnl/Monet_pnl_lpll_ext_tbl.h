...
typedef enum
{
    ...
    E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_10BIT_150to340MHz,          //3

    E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_10BIT_75to150MHz,          //4

    E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_10BIT_37_5to75MHz,          //5

    E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_8BIT_220to340MHz,          //6
    E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_8BIT_150to220MHz,          //7

    E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_8BIT_110to150MHz,          //8
    E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_8BIT_75to110MHz,          //9

    E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_8BIT_55to75MHz,          //10
    E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_8BIT_37_5to55MHz,          //11

    E_PNL_SUPPORTED_LPLL_EXT_MAX,          //12
...
TBLStruct_Ext LPLLSettingTBL_Ext[E_PNL_SUPPORTED_LPLL_EXT_MAX][LPLL_EXT_REG_NUM]=
{
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_10BIT_150to340MHz    NO.3
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_10BIT_75to150MHz    NO.4
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
        {0x40,0x0002,0x0007},//reg_lpll_ext_ictrl
        {0x41,0x0000,0x0003},//reg_lpll_ext_input_div_fst
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_10BIT_37_5to75MHz    NO.5
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
        {0x40,0x0002,0x0007},//reg_lpll_ext_ictrl
        {0x41,0x0000,0x0003},//reg_lpll_ext_input_div_fst
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_8BIT_220to340MHz    NO.6
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
        {0x40,0x0002,0x0007},//reg_lpll_ext_ictrl
        {0x41,0x0000,0x0003},//reg_lpll_ext_input_div_fst
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_8BIT_150to220MHz    NO.7
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
        {0x40,0x0002,0x0007},//reg_lpll_ext_ictrl
        {0x41,0x0000,0x0003},//reg_lpll_ext_input_div_fst
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_8BIT_110to150MHz    NO.8
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
        {0x40,0x0002,0x0007},//reg_lpll_ext_ictrl
        {0x41,0x0000,0x0003},//reg_lpll_ext_input_div_fst
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_8BIT_75to110MHz    NO.9
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
        {0x40,0x0002,0x0007},//reg_lpll_ext_ictrl
        {0x41,0x0000,0x0003},//reg_lpll_ext_input_div_fst
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_8BIT_55to75MHz    NO.10
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
        {0x40,0x0002,0x0007},//reg_lpll_ext_ictrl
        {0x41,0x0000,0x0003},//reg_lpll_ext_input_div_fst
    ...
    { //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_8BIT_37_5to55MHz    NO.11
      //Address,Value,Mask
        {0x40,0x0000,0x8000},//reg_lpll_ext_pd
        {0x40,0x0002,0x0007},//reg_lpll_ext_ictrl
        {0x41,0x0000,0x0003},//reg_lpll_ext_input_div_fst
...
MS_U16 u16EXT_LoopGain[E_PNL_SUPPORTED_LPLL_EXT_MAX]=
{
    ...
    2,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_10BIT_150to340MHz    NO.3
    1,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_10BIT_75to150MHz    NO.4
    1,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_10BIT_37_5to75MHz    NO.5
    8,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_8BIT_220to340MHz    NO.6
    4,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_8BIT_150to220MHz    NO.7
    4,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_8BIT_110to150MHz    NO.8
    2,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_8BIT_75to110MHz    NO.9
    2,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_8BIT_55to75MHz    NO.10
    1,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_8BIT_37_5to55MHz    NO.11
};
MS_U16 u16EXT_LoopDiv[E_PNL_SUPPORTED_LPLL_EXT_MAX]=
{
    ...
    1,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_10BIT_150to340MHz    NO.3
    1,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_10BIT_75to150MHz    NO.4
    2,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_10BIT_37_5to75MHz    NO.5
    3,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_8BIT_220to340MHz    NO.6
    3,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_4CH_8BIT_150to220MHz    NO.7
    3,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_8BIT_110to150MHz    NO.8
    3,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_2CH_8BIT_75to110MHz    NO.9
    3,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_8BIT_55to75MHz    NO.10
    3,           //E_PNL_SUPPORTED_LPLL_EXT_VBY1_1CH_8BIT_37_5to55MHz    NO.11
};
