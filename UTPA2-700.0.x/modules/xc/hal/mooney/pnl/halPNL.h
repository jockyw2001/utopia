...
#define REG_XC_EXT_BASE             0x302F00UL
...
#define REG_CKG_ODCLK_MFT             REG_CLKGEN0_53_L
    #define CKG_ODCLK_MFT_GATED         BIT(4)
    #define CKG_ODCLK_MFT_INVERT        BIT(5)
    #define CKG_ODCLK_MFT_SEL_SOURCE    BIT(6)
    #define CKG_ODCLK_MFT_SEL_SYNTHETIC   (0 << 6)
    #define CKG_ODCLK_MFT_SEL_LPLL        (1 << 6)
    #define CKG_ODCLK_MFT_MASK            (BIT(7) | BIT(8))
    #define CKG_ODCLK_MFT_CLK_DIV_2       (0 << 7)
    #define CKG_ODCLK_MFT_XTAL            (1 << 7)
    #define CKG_ODCLK_MFT_CLK_DIV_4       (2 << 7)
    #define CKG_ODCLK_MFT_CLK_LPLL        (3 << 7)
...
#ifdef REG_XC_EXT_BASE
HAL_PNL_INTERFACE MS_VIRT g_ptr_XCExtendRiuBaseAddr;
#endif
