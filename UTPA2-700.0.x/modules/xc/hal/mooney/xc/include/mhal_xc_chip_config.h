...
#define SUPPORTED_KERNEL_INT  ((1UL << SC_INT_VSINT) | (1UL << SC_INT_F2_IPVS_SB))
...
#define HW_2DTO3D_BLOCK_DR_BUF_SIZE         (0x0000)
#define HW_2DTO3D_DD_BUF_SIZE               (0x00000)
...
#define MIU_SC_G5REQUEST_MASK   (0x3203)
////////////////////////// FRC using ////////////////////////////////
