...
void Hal_SC_ip_software_reset(void *pInstance, MS_U8 u8Reset, SCALER_WIN eWindow)
{
    ...
    // Step 1: before MIU mask, stop the XC W/R request first
        ...
        {
            u16RWRequest = SC_R2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK12_07_L, 0x03);
            u16OPWRequestDisable = SC_R2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK12_27_L, 0x01);
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID,REG_SC_BK12_07_L, 0x03, 0x03);
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID,REG_SC_BK12_27_L, 0x03, 0x03);
        }
    }
    ...
    if(psXCInstPri->u32DeviceID == E_XC_DEVICE0)
    {
        ...
        if(eWindow == MAIN_WINDOW)
        {
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID,REG_SC_BK12_07_L, (u16RWRequest&0x03), 0x03);
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID,REG_SC_BK12_27_L, (u16OPWRequestDisable&0x01), 0x01);
        }
#else
...
#endif
        //btemp = btemp^1;
        //MDrv_Write2ByteMask(0x132020, (btemp<<15), 0x8000);
    }
    else
    {
