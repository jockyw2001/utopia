...
void Hal_XC_MLoad_set_base_addr(void *pInstance,MS_U32 u32addr)
{
    ...
    SC_W2BYTEMSK(0,REG_SC_BK1F_04_L, (MS_U16)((u32addr & 0x07FF0000)>>16), 0x07FF);
}
...
void Hal_XC_MLoad_enable_watch_dog(void *pInstance, MS_BOOL bEn)
{
    if(bEn)
    {
        SC_W2BYTEMSK(0, REG_SC_BK1F_05_L, 0xC000, 0xF000);
    }
    else
    {
        SC_W2BYTEMSK(0, REG_SC_BK1F_05_L, 0x0000, 0xF000);
    }
}

void Hal_XC_MLoad_enable_watch_dog_reset(void *pInstance, MLoad_WD_Timer_Reset_Type enMLWDResetType)
{
    SC_W2BYTEMSK(0, REG_SC_BK1F_06_L, (enMLWDResetType << 8), BIT(8)|BIT(9));
}

void Hal_XC_MLoad_set_watch_dog_time_delay(void *pInstance, MS_U32 u32Value)
{
    SC_W2BYTEMSK(0, REG_SC_BK1F_05_L, u32Value, 0x03FF);
}

void Hal_XC_MLoad_set_watchdog(void *pInstance)
{
    //Reg_wd_rst_timer,Reg_wd_rst_type
    SC_W2BYTEMSK(0,REG_SC_BK1F_06_L, 0x033F, 0x033F);
    //Reg_wd_rst_en,Reg_ds_dma_wd_timer_en
    SC_W2BYTEMSK(0,REG_SC_BK1F_05_L, 0xC000, 0xC000);
}
...
void Hal_XC_MLG_set_base_addr(void *pInstance,MS_U32 u32addr)
{
    ...
    SC_W2BYTEMSK(0,REG_SC_BK1F_24_L, (MS_U16)((u32addr & 0x07FF0000)>>16), 0x07FF);
}
...
void Hal_XC_MLoad_set_opm_arbiter_bypass(void *pInstance, MS_BOOL ben)
{
    if (ben)
    {
        SC_W2BYTEMSK(0, REG_SC_BK12_70_L, BIT(3), BIT(3));
    }
    else
    {
        SC_W2BYTEMSK(0, REG_SC_BK12_70_L, 0, BIT(3));
    }
}
