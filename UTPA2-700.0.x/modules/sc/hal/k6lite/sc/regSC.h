...
#define UART_LSR_CLR                        (0x00000036UL)                  // lsr clear reg
#define UART_RST_TO_IO_0                    (0x00000037UL)                  // rst to io timeout value[7:0]
#define UART_RST_TO_IO_1                    (0x00000038UL)                  // rst to io timeout value[15:8]
#define UART_RST_TO_IO_2                    (0x00000039UL)                  // rst to io timeout value[23:16]
#define UART_RST_TO_IO_3                    (0x0000003aUL)                  // rst to io timeout value[31:24]
#define UART_CTRL15                         (0x0000003bUL)                  // control15 reg
...
// UART_CTRL15 (0x3b)
//
#define UART_CTRL15_RST_TO_IO_EDGE_DET_FAIL_MASK        (0x00000001UL)        // rst to io edge detect int mask
