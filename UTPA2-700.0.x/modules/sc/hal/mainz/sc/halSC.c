...
#if SC_DBG_ENABLE
#define SC_DBG(fmt, args...)        ULOGD(TAG_SC, "[DEV][SMART][%06d] " fmt, __LINE__, ##args)
#define SC_ERR(fmt, args...)        ULOGE(TAG_SC, "[DEV][SMART][%06d] " fmt, __LINE__, ##args)
#else
