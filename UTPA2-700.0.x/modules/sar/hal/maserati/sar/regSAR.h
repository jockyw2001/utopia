...
#define REG_SAR_AISEL                           ((0x00UL*0x10000UL)+ (SAR_REG_BASE + 0x11UL*2))
    #define _SAR_AISEL                          (BIT5|BIT4|BIT3|BIT2|BIT1|BIT0)
    ...
    #define _SAR_AISEL_CH6                      (BIT5)

#define REG_SAR_OEN_GPIO                        ((0x00UL*0x10000UL)+ (SAR_REG_BASE + 0x11UL*2)+ 1)
    #define _SAR_OEN_GPIO_MSK                   (BIT5|BIT4|BIT3|BIT2|BIT1|BIT0)
    ...
    #define _SAR_OEN_GPIO_CH6                   (BIT5)

#define REG_SAR_I_GPIO                          ((0x00UL*0x10000UL)+ (SAR_REG_BASE + 0x12UL*2))
    #define _SAR_I_GPIO_MSK                     (BIT5|BIT4|BIT3|BIT2|BIT1|BIT0)
    ...
    #define _SAR_I_GPIO_CH6                     (BIT5)

#define REG_SAR_C_GPIO                          ((0x00UL*0x10000UL)+ (SAR_REG_BASE + 0x12UL*2)+ 1)
    #define _SAR_C_GPIO_MSK                     (BIT5|BIT4|BIT3|BIT2|BIT1|BIT0)
