...
void HAL_SAR_CfgAanlogInputSelect(MS_U8 u8Channel, MS_BOOL bEnable)
{
    ...
    switch(u8Channel)
    {
        ...
        case HAL_SAR_CH5:
            ...
            break;
        case HAL_SAR_CH6:
            u8CtrlData = (bEnable)? _SAR_AISEL_CH6 : (~_SAR_AISEL_CH6);
            u8Mask=_SAR_AISEL_CH6;
            break;
        default: return;
    }
...
void HAL_SAR_CfgOutputEnable(MS_U8 u8Channel, MS_BOOL bEnable)
{
    ...
    switch(u8Channel)
    {
        ...
        case HAL_SAR_CH5:
            ...
            break;
        case HAL_SAR_CH6:
            u8CtrlData = (bEnable)? ~_SAR_OEN_GPIO_CH6 : _SAR_OEN_GPIO_CH6;
            u8Mask = _SAR_OEN_GPIO_CH6;
            break;
        default: return;
    }
...
void HAL_SAR_SetOutput(MS_U8 u8Channel, MS_BOOL bHighLow)
{
    ...
    switch(u8Channel)
    {
        ...
        case HAL_SAR_CH5:
            ...
            break;
        case HAL_SAR_CH6:
            u8CtrlData = (bHighLow)? _SAR_I_GPIO_CH6 : ~_SAR_I_GPIO_CH6;
            u8Mask = _SAR_I_GPIO_CH6;
            break;
        default: return;
    }
