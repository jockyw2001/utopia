...
{
    MS_U16 u16temp =0;
#ifdef GE_BYTE_WRITE_PATCH
    MS_U16 u16ByteWrite=0;
#endif
...
#ifdef GE_BYTE_WRITE_PATCH
    u16ByteWrite = (GE_REG(REG_GE_CFG) & GE_CFG_NO_BYTE_WRITE_MASK);
#endif
...
#ifdef GE_BYTE_WRITE_PATCH
    GE_WriteReg(pGEHalLocal, REG_GE_CFG, GE_ReadReg(pGEHalLocal, REG_GE_CFG)|u16ByteWrite);
#endif
	//Mask Interrupt
