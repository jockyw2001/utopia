...
#define GE_PITCH_256_ALIGNED_UNDER_4P_MODE 1// For Curry/Kano, pitch must 256 algined under 4P mode
#define GE_BYTE_WRITE_PATCH       1//For Kano 64bit OBF,GE must enable NO_BYTE_WRITE_MODE
//-------------------------------------------------------------------------------------------------
//  Type and Structure
//-------------------------------------------------------------------------------------------------
