...
#define REG_SC_BK00_40_L                        XC_REG(0x00, 0x40)
#define REG_SC_BK01_02_L                        XC_REG(0x01, 0x02)
#define REG_SC_BK02_5F_L                        XC_REG(0x02, 0x5F)
#define REG_SC_BK02_0A_L                        XC_REG(0x02, 0x0A)
...
#define GOP_SC_MOD                              REG_SC_BK00_40_L
...
#define GOP_SC_IP_2PBYPASS                      REG_SC_BK02_0A_L
    #define GOP_SC_IP_2PBYPASS_ENBIT            BIT(15)

//----------------------------------------------------------------------------
// MVOP Reg
//----------------------------------------------------------------------------
#define GOP_MVOP_MIRRORCFG                      (MVOP_REG_BASE+0x76)
#define GOP_MVOP_4K2K_60_2P                     (MVOP_REG_BASE+0x53)
