...
#define MAX_GOP_MIUCOUNT                        1UL
#define MAX_GOP_MIUSEL                          MAX_GOP_MIUCOUNT-1
#define MAX_GOP_SUPPORT                         4UL
...
#define DELTA_PD_FOR_STB_ZORDER             (-16)
#define DELTA_OFFSET_FOR_STB_ZORDER_MUX0    (3)
#define DELTA_OFFSET_FOR_STB_ZORDER_MUX1    (2)
#define DELTA_OFFSET_FOR_STB_ZORDER_MUX2    (1)
#define DELTA_OFFSET_FOR_STB_ZORDER_MUX3    (0)
...
/* XC & GOP interactive feature define */
#define XC_GOP_PATCH_PIPE_FOR_STB_ZORDER
