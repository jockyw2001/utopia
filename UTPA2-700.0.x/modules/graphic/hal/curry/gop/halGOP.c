...
extern MS_U8 bAFBCMIUSelect[MAX_GOP_SUPPORT];
#endif
GOP_CHIP_PROPERTY g_GopChipPro =
{
    ...
    .bInternalMIUSelect=        {TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE}, //{E_GOP0, E_GOP1, E_GOP2, E_GOP3, E_GOP4, E_GOP_Dwin, E_GOP_MIXER, E_GOP5}
    ...
    .bGOPVscalePipeDelay  =     {FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},
    .bGOPAutoClkGating = FALSE,
};
...
void HAL_GOP_Init(GOP_CTX_HAL_LOCAL *pGOPHalLocal, MS_U8 u8GOPNum)
{
    ...
    if(pGOPHalLocal->pGopChipPro->bInternalMIUSelect[u8GOPNum] ==TRUE)
    {
        ...
        HAL_GOP_Write16Reg(pGOPHalLocal, u32bankoff+GOP_4G_MIU_SEL, u8MIUSel<<4, GOP_BIT4|GOP_BIT5 );//GWIN Palette MIU Select
        HAL_GOP_Write16Reg(pGOPHalLocal, GOP_SC_MIU_IP_SEL, 1<<mask_shift, 1<<mask_shift );//Set Control MIU select by GOP itself, XC part
        if(g_GopChipPro.bAFBC_Support[u8GOPNum]==TRUE)
        {
    ...
    HAL_GOP_Write16Reg(pGOPHalLocal, GOP_4G_GOP_INTERNAL_ZORDER_TRIG, GOP_BIT13, GOP_BIT13); // enable double buffe
}
...
GOP_Result HAL_GOP_SetGOPClk(GOP_CTX_HAL_LOCAL *pGOPHalLocal, MS_U8 gopNum, DRV_GOPDstType eDstType)
{
    ...
    ******************/
    ...
    case E_DRV_GOP_DST_IP0_SUB:
        ...
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP2CLK, CKG_GOPG1_IDCLK2, CKG_GOPG2_MASK);
        }
        else if (gopNum==E_GOP3)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP3CLK, CKG_GOPG1_IDCLK2, CKG_GOPG3_MASK);
        }
        else if (gopNum ==E_GOP4)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP4CLK, CKG_GOPG1_IDCLK2, CKG_GOPG4_MASK);
        }
        else if (gopNum==E_GOP0)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG1_IDCLK2, CKG_GOPG0_MASK);
        }
        else
        {
            MS_ASSERT(0);
	...
	case E_DRV_GOP_DST_IP1:
        ...
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP3CLK, CKG_GOPG1_IDCLK1, CKG_GOPG3_MASK);
        }
        else if (gopNum ==E_GOP4)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP4CLK, CKG_GOPG1_IDCLK1, CKG_GOPG4_MASK);
        }
        else if (gopNum==E_GOP0)
        {
    ...
    case E_DRV_GOP_DST_DIP:
        ...
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG2_OCC_FRCCLK, CKG_GOPG2_MASK);
        }
        else if (gopNum==E_GOP3)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG3_OCC_FRCCLK, CKG_GOPG3_MASK);
        }
        else if (gopNum ==E_GOP4)
        {
    ...
    case E_DRV_GOP_DST_VOP:
        if (gopNum==E_GOP1)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG1_MVOP, CKG_GOPG1_MASK);
        }
        else if (gopNum==E_GOP2)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG2_MVOP, CKG_GOPG2_MASK);
        }
        else if (gopNum==E_GOP3)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG3_MVOP, CKG_GOPG3_MASK);
        }
        else if (gopNum ==E_GOP4)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP4CLK, CKG_GOPG4_MVOP, CKG_GOPG4_MASK);
        }
        else if (gopNum==E_GOP0)
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG0_MVOP, CKG_GOPG0_MASK);
        }
        else
        {
            MS_ASSERT(0);
    ...
    case E_DRV_GOP_DST_BYPASS:
         if (gopNum==E_GOP0)
         {
             HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG0_BYPASS_FRCCLK, CKG_GOPG0_MASK);
         }
         else if (gopNum==E_GOP1)
         {
             HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOPCLK, CKG_GOPG1_BYPASS_FRCCLK, CKG_GOPG1_MASK);
         }
         else if (gopNum==E_GOP2)
         {
             HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP2CLK, CKG_GOPG2_BYPASS_FRCCLK, CKG_GOPG2_MASK);
         }
         else if (gopNum==E_GOP3)
         {
             HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP3CLK, CKG_GOPG3_BYPASS_FRCCLK, CKG_GOPG3_MASK);
         }
         else if (gopNum ==E_GOP4)
         {
             HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP4CLK, CKG_GOPG4_BYPASS_FRCCLK, CKG_GOPG4_MASK);
         }
         else
         {
             MS_ASSERT(0);
         ...
         break;
    case E_DRV_GOP_DST_MIXER2OP:
        HAL_GOP_Write16Reg(pGOPHalLocal, CKG_GOPMIXER_CLK, CKG_GOPMIXER_ODCLK, CKG_GOPMIXER_MASK);
        break;
    case E_DRV_GOP_DST_OP1:
        if (gopNum==E_GOP1)
        {
        ...
        {
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_GOP4CLK, CKG_GOPG4_OD1CLK, CKG_GOPG4_MASK);
        }
        else if (gopNum==E_GOP0)
        {
...
GOP_Result HAL_ConvertAPIAddr(GOP_CTX_HAL_LOCAL *pGOPHalLocal, MS_U8 gwinid, MS_PHY* u64Adr)
{
    ...
    if (gwinid<GOP1_GwinIdBase) //gop0
    {
        u8GOP=0;
    }
    else if (gwinid<GOP2_GwinIdBase) //gop1
    {
        u8GOP=1;
    }
    else if (gwinid<GOP3_GwinIdBase) //gop2
    {
        u8GOP=2;
    }
    else if (gwinid<GOP4_GwinIdBase) //gop3
    {
        u8GOP=3;
    }
    else
    ...
    if (u8Miu < MAX_GOP_MIUCOUNT)
    {
        _miu_offset_to_phy(u8Miu, *u64Adr, *u64Adr);
    }
    else
    {
        printf("[%s] ERROR GOP miu client( = %d)\n", __FUNCTION__, u8Miu);
        return GOP_FAIL;
    }
    return GOP_SUCCESS;
}
...
GOP_Result HAL_GOP_VScalingDown(GOP_CTX_HAL_LOCAL *pGOPHalLocal,MS_U8 u8GOP, MS_BOOL bEnable,MS_U16 src, MS_U16 dst)
{
    ...
    if(pGOPHalLocal->pGopChipPro->bScalingDownSupport ==FALSE)
    {
        return GOP_FUN_NOT_SUPPORTED;
    }
...
GOP_Result HAL_GOP_SetGopGwinHVPixel(GOP_CTX_HAL_LOCAL *pGOPHalLocal, MS_U8 u8GOP, MS_U8 u8win, MS_U16 hstart, MS_U16 hend, MS_U16 vstart, MS_U16 vend)
{
    ...
    switch(u8GOP)
    {
        ...
        case E_GOP5:
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_1GS1_HSTR, hstart, GOP_REG_WORD_MASK);
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_1GS1_HEND, hend, GOP_REG_WORD_MASK);
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_1GS1_VSTR, vstart, GOP_REG_WORD_MASK);    // 1 pixel
            HAL_GOP_Write16Reg(pGOPHalLocal, GOP_1GS1_VEND, vend, GOP_REG_WORD_MASK);    // 1 pixel
            break;
