...
#define REG_SC_BK2F_36_L                        XC_REG(0x2F, 0x36)
...
#define GOP_SC_ZORDER                           REG_SC_BK2F_36_L
...
#define GOP_SC_ZORDER_CTRLER                    REG_SC_BK2F_36_L
...
#define CKG_GOPG0_BYPASS_FRCCLK (5 << 2)
#define CKG_GOPG0_FCLK          (8 << 2)
#define CKG_GOPG0_MVOP          (1 << 2)
...
#define CKG_GOPG1_BYPASS_FRCCLK (5 << 10)
#define CKG_GOPG1_FCLK          (8 << 10)
#define CKG_GOPG1_MVOP          (1 << 10)
...
#define CKG_GOPMIXER_CLK        (CKG_REG_BASE+0x82)
...
#define CKG_GOPG3_IDCLK2        (6 << 10)
#define CKG_GOPG3_IDCLK1        (7 << 10)
#define CKG_GOPG3_OCC_FRCCLK    (3 << 10)
#define CKG_GOPG3_MIXERCLK_VE   (4 << 10)
#define CKG_GOPG3_BYPASS_FRCCLK (5 << 10)
#define CKG_GOPG3_FCLK          (8 << 10)
#define CKG_GOPG3_MVOP          (7 << 10)
#define CKG_GOPG3_DISABLE_CLK_MASK    (GOP_BIT8)
#define CKG_GOPG3_MASK          (GOP_BIT13 | GOP_BIT12 | GOP_BIT11 | GOP_BIT10)
...
#define CKG_GOPG4_OD1CLK        (2 << 10)
#define CKG_GOPG4_IDCLK2        (6 << 10)
#define CKG_GOPG4_IDCLK1        (7 << 10)
#define CKG_GOPG4_OCC_FRCCLK    (3 << 10)
#define CKG_GOPG4_MIXERCLK_VE   (4 << 10)
#define CKG_GOPG4_BYPASS_FRCCLK (5 << 10)
#define CKG_GOPG4_FCLK          (8 << 10)
#define CKG_GOPG4_MVOP          (7 << 10)
...
#define GOP_2G_H121                         GOP_REG(GOP_2G_OFST, 0x1B)
...
#define GOP_1G_H121                         GOP_REG(GOP_1G_OFST, 0x1B)
...
#define GOP_1GX_H121                         GOP_REG(GOP_1GX_OFST, 0x1B)
