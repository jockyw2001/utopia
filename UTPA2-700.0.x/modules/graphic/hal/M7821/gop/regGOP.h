...
#define AFBC_REG_BASE                          0x113100
#define MANUAL_CROP_REG_BASE                   0x137000
...
#define REG_SC_BK7F_18_L                        XC_REG(0x7F, 0x18)
#define REG_SC_BKC9_50_L                        XC_REG(0xC9, 0x50)
#define REG_SC_BKC9_51_L                        XC_REG(0xC9, 0x51)
#define REG_SC_BKC9_52_L                        XC_REG(0xC9, 0x52)
#define REG_SC_BKCB_48_L                        XC_REG(0xCB, 0x48)

#define REG_SC_BK80_05_L                        XC_REG(0x80, 0x05)

#define GOP_SC_BANKSEL                          REG_SC_BK00_00_L
#define GOP_SC_CHANNELSYNC                      REG_SC_BK00_05_L
#define GOP_SC1_CHANNELSYNC                      REG_SC_BK80_05_L
...
#define GOP_SC_4K120_EN0                        REG_SC_BKC9_50_L
#define GOP_SC_4K120_EN1                        REG_SC_BKC9_51_L
#define GOP_SC_4K120_EN2                        REG_SC_BKC9_52_L
#define GOP_SC_GOP_HSYNC_START                  REG_SC_BKCB_48_L
//----------------------------------------------------------------------------
// MVOP Reg
//----------------------------------------------------------------------------
...
#define CKG_GOPG0_OCC_FRCCLK    (3 << 2)
#define CKG_GOPG0_MIXERCLK_VE   (4 << 2)
#define CKG_GOPG0_FCLK          (8 << 2)
#define CKG_GOPG0_DISABLE_CLK_MASK    (GOP_BIT0)
#define CKG_GOPG0_MASK          (GOP_BIT5 | GOP_BIT4 | GOP_BIT3 | GOP_BIT2)

#define CKG_GOPG1_DISABLE_CLK   ~(GOP_BIT8)
#define CKG_GOPG1_ODCLK         (0 << 10)
#define CKG_GOPG1_IDCLK2        (1 << 10)
#define CKG_GOPG1_IDCLK1        (2 << 10)
#define CKG_GOPG1_OCC_FRCCLK    (3 << 10)
#define CKG_GOPG1_MIXERCLK_VE   (4 << 10)
#define CKG_GOPG1_FCLK          (8 << 10)
#define CKG_GOPG1_DISABLE_CLK_MASK    (GOP_BIT8)
#define CKG_GOPG1_MASK          (GOP_BIT13 | GOP_BIT12 | GOP_BIT11 | GOP_BIT10)
...
#define CKG_GOPG2_OCC_FRCCLK    (3 << 2)
#define CKG_GOPG2_MIXERCLK_VE   (4 << 2)
#define CKG_GOPG2_FCLK          (8 << 2)
#define CKG_GOPG2_DISABLE_CLK_MASK    (GOP_BIT0)
#define CKG_GOPG2_MASK           (GOP_BIT5 |GOP_BIT4 | GOP_BIT3 | GOP_BIT2)
...
#define CKG_GOPG3_MIXERCLK_VE   (4 << 2)
...
/*AFBC CLK*/
#define GOP_AFBCCLK               (CKG_REG_BASE+(0x46<<1))
...
// MIU Reg
//----------------------------------------------------------------------------
#define GOP_CLIENT_REG          0x7E
#define GOP_MIU_GROUP           (MIU0_REG_BASE+(GOP_CLIENT_REG*2))

#define USE_XCBANK_MIU_SELECT 1
#if USE_XCBANK_MIU_SELECT==1
#define GOP_MIU_GROUP1          REG_SC_BK7F_10_L
#define GOP_MIU_GROUP2          REG_SC_BK7F_18_L
#else
#define GOP_MIU_GROUP1          (MIU_REG_BASE+(GOP_CLIENT_REG*2))
#define GOP_MIU_GROUP2          (MIU2_REG_BASE+(GOP_CLIENT_REG*2))
#endif
...
#define GOP_MIU_CLIENT_GOP4     0x6
...
//4K@120 MUX Setting
#define GOP_4K120_MUX_COUNT                 3
#define GOP_4K120_MUX_SHIFT                 0x2
#define GOP_4K120_REGMUX_MASK               BMASK((GOP_4K120_MUX_SHIFT-1):0)
#define GOP_4K120_MUX0_MASK                 (GOP_4K120_REGMUX_MASK<<(GOP_4K120_MUX_SHIFT*0))
#define GOP_4K120_MUX1_MASK                 (GOP_4K120_REGMUX_MASK<<(GOP_4K120_MUX_SHIFT*1))
#define GOP_4K120_MUX2_MASK                 (GOP_4K120_REGMUX_MASK<<(GOP_4K120_MUX_SHIFT*2))
#define GOP_4K120MUX_MUX0                   0
#define GOP_4K120MUX_MUX1                   1
#define GOP_4K120MUX_MUX2                   2
...
#define GOP_AFBC_OFST                         0x31
#define GOP_CROP_OFST                         0x70
...
#define GOP_4G_CROP_HSTART                  GOP_REG(GOP_4G_OFST, 0x2A)
#define GOP_4G_CROP_HEND                    GOP_REG(GOP_4G_OFST, 0x2B)
#define GOP_4G_CROP_VSTART                  GOP_REG(GOP_4G_OFST, 0x2C)
#define GOP_4G_CROP_VEND                    GOP_REG(GOP_4G_OFST, 0x2D)
...
#define GOP_4G_SPLIT_LRSZ                   GOP_REG(GOP_4G_OFST, 0x3E)
...
#define GOP_4G_MANUAL_CROP1                 GOP_REG(GOP_4G_OFST, 0x6E)
#define GOP_4G_MANUAL_CROP2                 GOP_REG(GOP_4G_OFST, 0x6F)
...
#define GOP_4G_SLPIT_GUARDBAND              GOP_REG(GOP_4G_OFST, 0x6C)
#define GOP_4G_SLPIT_SHIFT_PIPE             GOP_REG(GOP_4G_OFST, 0x6D)
...
#define GOP_MUX4_4K120                      __GOP_REG(0x7A)
...
#define REG_SC_BK70_00(gop_id)                XC_REG(0x70, 0x00 + (0x20 * gop_id))
#define REG_SC_BK70_07(gop_id)                XC_REG(0x70, 0x07 + (0x20 * gop_id))
#define REG_SC_BK70_08(gop_id)                XC_REG(0x70, 0x08 + (0x20 * gop_id))

#define REG_GOP_CROP_PRECALDONE(gop_id)         REG_SC_BK70_00(gop_id)
#define REG_GOP_CROP_ORIHSTART(gop_id)          REG_SC_BK70_07(gop_id)
#define REG_GOP_CROP_ORIHEND(gop_id)            REG_SC_BK70_08(gop_id)
