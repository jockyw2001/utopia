...
#define CHIPID_MUNICH_SERIES  0x96
#define CHIPVER_MUNICH  0
#define CHIPVER_MALDIVES  1
#define MALDIVES_PD_OFFSET    19

#define ENABLE_GOP_T3DPATCH
#ifdef ENABLE_GOP_T3DPATCH
#define GOP_PD_T3D                              0x114UL
#define GOP_PD_NORMAL                           0xA7UL
#endif
