...
GOP_CHIP_PROPERTY g_GopChipPro =
{
    ...
    .GOP_MUX_Delta  =           0x1,
    .GOP_Mux_Offset =           {0x0, 0xF, 0x9, 0xC},
    .GOP_Mux_FRC_offset=        0x0,
    .GOP_MapLayer2Mux =         {E_GOP_MUX0, E_GOP_MUX2, E_GOP_MUX3, E_GOP_MUX1},
...
void HAL_GOP_Init(GOP_CTX_HAL_LOCAL *pGOPHalLocal, MS_U8 u8GOPNum)
{
    ...
    if( ( bAddOffset == FALSE ) && ( chipid == CHIPID_MUNICH_SERIES ) && ( sys_info->Chip.Version == CHIPVER_MALDIVES ) ){
        pGOPHalLocal->pGopChipPro->GOP_PD += MALDIVES_PD_OFFSET;
        bAddOffset = TRUE;
    }
}
...
GOP_Result HAL_GOP_InitMux(GOP_CTX_HAL_LOCAL *pGOPHalLocal)
{
    ...
    */
	...
	HAL_GOP_Write16Reg(pGOPHalLocal, GOP_MUX, ((gop4g<<(GOP_MUX_SHIFT*3))|(gop2g<<(GOP_MUX_SHIFT*2))|(gop1gx<<(GOP_MUX_SHIFT*1))|gop1g), GOP_REG_WORD_MASK);
    return GOP_SUCCESS;
}
