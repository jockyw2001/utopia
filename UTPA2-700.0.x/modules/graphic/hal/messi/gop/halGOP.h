...
#define MAX_GOP_SUPPORT                         3UL
#define MAX_GOP_MUX                             3UL
#define MAX_GOP_MUX_SEL                         3UL
...
#define GOP2_Gwin0Id                            3UL
#define GOP3_Gwin0Id                            4UL
#define GOP4_Gwin0Id                            5UL
...
#define GOP_FIFO_THRESHOLD                      0xF0UL

#ifndef GOP_MIU0_LENGTH
#define GOP_MIU0_LENGTH                         HAL_MIU1_BASE
#endif

#define DWIN_SUPPORT_WINDOWDE_CAPTURE           TRUE //HW issue, Not support it, should use FrameDE to capture video for DWIN
...
#define GOP_BK_DOUBLE_BUF_WRITE
#define GOP_VSTRETCH_OLD_MODE
#ifdef GOP_VSTRETCH_OLD_MODE
#define GOP_VSTRETCH_DEFAULT_SIZE               0x240
#define GOP_VSTRETCH_FULL_SIZE                  0x438
#endif
...
#define GOP_H_INFO(x, args...) if(u32GOPDbgLevel_u >= 5) { ULOGI("GOP HAL", x, ##args); }
// Warning, illegal paramter but can be self fixed in functions
#define GOP_H_WARN(x, args...) if(u32GOPDbgLevel_u >= 4) { ULOGW("GOP HAL", x, ##args); }
//  Need debug, illegal paramter.
#define GOP_H_DBUG(x, args...) if(u32GOPDbgLevel_u >= 3) { ULOGD("GOP HAL", x, ##args); }
// Error, function will be terminated but system not crash
#define GOP_H_ERR(x, args...)  if(u32GOPDbgLevel_u >= 2) { ULOGE("GOP HAL", x, ##args); }
// Critical, system crash. (ex. assert)
#define GOP_H_FATAL(x, args...) if(u32GOPDbgLevel_u >= 1) { ULOGF("GOP HAL", x, ##args); }
...
#ifdef GOP_VSTRETCH_OLD_MODE
    MS_U16 u16GOPSrcHeight[SHARED_GOP_MAX_COUNT];
#endif
}GOP_CTX_HAL_SHARED;
