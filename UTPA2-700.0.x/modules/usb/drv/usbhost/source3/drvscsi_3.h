...
#define TestUnitReady_Fail_Retry  0xff
...
#define CB_LENGTH_MODE_SENSE_5A				0x0A
...
extern BOOLEAN vSCSI_REQUEST_SENSE_Port3(U8);
extern BOOLEAN bSCSI_INQUIRY_Port3(U8);
extern BOOLEAN bSCSI_READ_CAPACITY_Port3(U8);
extern BOOLEAN bSCSI_TEST_UNIT_READY_Port3(U8);

extern BOOLEAN bInit_USB_LUN_Port3(U8);


extern BOOLEAN bSCSI_Initial_Port3(void);
...
extern BOOLEAN bSCSI_Read_Write10_Port3(BOOLEAN DoWrite, U8 lun,  INT32U u32BlockAddr, INT32U u32BlockNum,U32 u8Buffer);
extern BOOLEAN  vSCSI_EJECT_DEVICE_Port3(U8 lun);

extern BOOLEAN bSCSI_MODE_SENSE_Port3(U8);
extern BOOLEAN bSCSI_MODE_SENSE_OperCode5A_Port3(U8);
//=================== 5.Extern Variable Definition =======================================================
//========================================================================================================
extern struct us_data Mass_stor_us1_port3;

//extern struct us_data *Mass_stor_us;
extern struct us_data us_data_Signal;
//extern INT8U u8Drive;
extern struct LUN_Device Mass_stor_device_1_port3;
