...
void USB_Chip_Read_Memory_Port2(void);
void USB_Chip_Flush_Memory_Port2(void);
...
//qHD_Structure xdata Host20_qHD_List_Control0_Port2  _at_ Host20_STRUCTURE_qHD_BASE_ADDRESS  ;
//qHD_Structure xdata Host20_qHD_List_Control1_Port2  _at_ (Host20_STRUCTURE_qHD_BASE_ADDRESS+Host20_qHD_SIZE)  ;
//qHD_Structure xdata Host20_qHD_List_Bulk0_Port2  _at_  (Host20_STRUCTURE_qHD_BASE_ADDRESS+2*Host20_qHD_SIZE);
//qHD_Structure xdata Host20_qHD_List_Bulk1_Port2  _at_  (Host20_STRUCTURE_qHD_BASE_ADDRESS+3*Host20_qHD_SIZE);
qHD_Structure Host20_qHD_List_Control0_Port2  __attribute__ ((aligned (32)));
qHD_Structure  Host20_qHD_List_Control1_Port2  __attribute__ ((aligned (32)));
qHD_Structure  Host20_qHD_List_Bulk0_Port2    __attribute__ ((aligned (32)));
qHD_Structure  Host20_qHD_List_Bulk1_Port2   __attribute__ ((aligned (32)));
...
qHD_Structure *pHost20_qHD_List_Control0_Port2;
qHD_Structure *pHost20_qHD_List_Control1_Port2;
qHD_Structure *pHost20_qHD_List_Bulk0_Port2;
qHD_Structure *pHost20_qHD_List_Bulk1_Port2;
...
Host20_Attach_Device_Structure    sAttachDevice_Port2 __attribute__  ((aligned (8)));
Host20_Attach_Device_Structure  *psAttachDevice_Port2 = (Host20_Attach_Device_Structure*) &sAttachDevice_Port2;
BOOLEAN FirstBulkOutPort2,FirstBulkInPort2;
//Host20_Attach_Device_Structure  xdata *psDevice_AP;

U8 *pUsbCtrlBuf_Port2;
U8 UsbCtrlBuf_Port2[CONTROL_DMA_BUF_LEN] __attribute__ ((aligned (4096)));
UINT8   pUsbData_Port2[CONTROL_BUF_LEN] __attribute__ ((aligned (16))) ;
U8 QtdBuf_Port2[Host20_qTD_SIZE*Host20_qTD_MAX+0x20] __attribute__ ((aligned (32)));
U8 *Host20_STRUCTURE_qTD_BASE_ADDRESS_Port2,*Host20_STRUCTURE_qHD_BASE_ADDRESS_Port2;
U8 *qTD_Base_Buf_Port2;
...
extern U16 MDrv_USBGetChipID_Port2(void);
extern U8 MDrv_USBGetChipVersion_Port2(void);

U8 usb_temp_buf_Port2[Scsi_Max_Transfer_Len] __attribute__ ((aligned (128)));

#define         USB_DMA_SIGNATURE1           0x55661234

void EnterTestMode_Port2(void);
...
{
    return UHC2_READXBYTE((U8) bOffset);
}
void mwHost20Port_wr_Port2(int bOffset,int value)
{
    UHC2_SETXBYTE((U8) bOffset, (U8) value);
}

int  mwHost20Bit_Rd_Port2(int bByte,int wBitNum)
{
    return (mwHost20Port_Port2(bByte)&wBitNum);
}
void  mwHost20Bit_Set_Port2(int bByte,int wBitNum)
{
    U8 temp;
    temp=mwHost20Port_Port2(bByte);
    temp|=wBitNum;
    mwHost20Port_wr_Port2(bByte,temp);
...
UINT8 flib_OTGH_Init_Port2(UINT8 wForDevice_B)
{
  ...
  {
     mwHost20Bit_Set_Port2(0x81,(BIT6|BIT7));
  }
  ...
  mwHost20_CurrentAsynchronousAddr_Set(VirtoPhyAddr((U32)Host20_STRUCTURE_qHD_BASE_ADDRESS_Port2));
...
{
    UHC2_SETXBYTE(addr, (U8) val & 0xFF);
    UHC2_SETXBYTE(addr+1, (U8) (val>>8) & 0xFF);
    UHC2_SETXBYTE(addr+2, (U8) (val>>16) & 0xFF);
    UHC2_SETXBYTE(addr+3, (U8) (val>>24) & 0xFF);
}
...
// * OutPut:
//====================================================================
UINT8 flib_Host20_Close_Port2(void)
{
...
UINT8 flib_Host20_PortBusReset_Port2(void)
{
  ...
  {
    UTMI2_ANDXBYTE(0x2c,0x3E);
    UTMI2_ANDXBYTE(0x2d,~0x03);
    UTMI2_ANDXBYTE(0x2f,~0x4A);
    UTMI2_SETXBYTE(0x2a,0xd0);
  }
  else //for T3 later
  {
      UTMI2_SETXBYTE(0x2c,0x10);
      UTMI2_SETXBYTE(0x2d,0);
      UTMI2_SETXBYTE(0x2e,0);
      UTMI2_SETXBYTE(0x2f,0);
      UTMI2_SETXBYTE(0x2a,0x80);//Chirp K detection level: 0x80 => 400mv, 0x20 => 575mv
  }
  ...
  if ( (MDrv_USBGetChipID_Port2() == CHIPID_EINSTEIN) ||
  	...
  	UTMI2_SETXBYTE(0x2a,0x60); // disconnect level 625 mV for 28 nm process
  else
       ...
       (MDrv_USBGetChipID_Port2() == CHIPID_TITANIA2) )
  {
    ...
    UTMI2_ORXBYTE(0x2d,0x03);
    UTMI2_ORXBYTE(0x2f,0x4a);
  }
  else if ((MDrv_USBGetChipID_Port2() == CHIPID_TITANIA3) ||
  ...
  {
      UTMI2_SETXBYTE(0x2c,0x10);
      UTMI2_SETXBYTE(0x2d,0x02);
      UTMI2_SETXBYTE(0x2f,0x81);
  }
            ...
            (MDrv_USBGetChipID_Port2()==CHIPID_EAGLE))
  {
      ...
      UTMI2_SETXBYTE(0x2c,0x98);
      UTMI2_SETXBYTE(0x2d,0x02);
      UTMI2_SETXBYTE(0x2e,0x10);
      UTMI2_SETXBYTE(0x2f,0x01);
  }
  ...
  if (gSpeed_Port2==2)                //high speed
  {
    UTMI2_ORXBYTE(9,0x80);                                    //HS rx robust enable
    mwHost20_Misc_EOF1Time_Set(3);
    gUsbDeviceState_Port2=USB20_DEVICE;
  }
  else                 //full speed
  {
    UTMI2_ANDXBYTE(9,0x7f);
  ...
  {
    MINI_DEBUG2(printf("Port2 Low speed device\n"));
...
UINT8 flib_Host20_Issue_Control_CBI_Port2(UINT8* pbCmd,UINT16 hwDataSize,UINT8* pbData)
{
...
//   U32       bpDataPage;
 ...
 // U8 i;
    ...
    spTempqTD=flib_Host20_GetStructure_Port2(Host20_MEM_TYPE_qTD);//0=>qTD
    ...
    memcpy(pUsbCtrlBuf_Port2,pbCmd,8);

    spTempqTD->ArrayBufferPointer_Word[0]=VirtoPhyAddr((U32)pUsbCtrlBuf_Port2);
    ...
    memcpy(pUsbCtrlBuf_Port2,pbData,hwDataSize);
...
//           X:>0 => Fail
//====================================================================
U8 flib_Host20_Issue_Control_Port2(U8 bEdNum,U8* pbCmd,U16 hwDataSize,U8* pbData)
{
  qTD_Structure *spTempqTD;
  //U32       bpDataPage;
  U8        bReturnValue;
  ...
  //<0>.Allocate qTD & Data Buffer
  spTempqTD=(qTD_Structure *) flib_Host20_GetStructure_Port2(Host20_MEM_TYPE_qTD);//0=>qTD
  ...
  switch (*(pbCmd+1)) { // by Standard Request codes
    ...
    case 0xfe:     //get Max Lun
	    ...
	    //MAKE THE SIGNATURE
	    dnaptr= (U32*)(U32)pUsbCtrlBuf_Port2;
	    if (hwDataSize>3)
	    {
	        ...
	        *dnaptr=USB_DMA_SIGNATURE1;
            ...
            if (((hwDataSize-TotalBytes_Port2)==hwDataSize) && (hwDataSize>3))
            {
             ...
             memcpy(( U8  *)pbData,pUsbCtrlBuf_Port2,hwDataSize);
    ...
    case 11:       // set interface
             ...
             if (bReturnValue>0)
               goto exit_issue_control;
             //<C>.Copy Result
             //memcpy(pbData,(UINT8*)pUsbCtrlBuf_Port2,hwDataSize);
             break;
...
// * OutPut:
//====================================================================
U8  flib_Host20_Issue_Bulk_Port2 (U8 bArrayListNum,U16 hwSize,U32 pwBuffer,U8 bDirection)
{
    qTD_Structure  *spTempqTD;
    U8 bTemp,i;
    U16 count;
...
//not allow buffer over 16K for my usage
  ...
  if (bDirection==OTGH_Dir_IN)
  {
      if (((hwSize-TotalBytes_Port2)==hwSize) && (hwSize>3))
      {
        dwTimes=MsOS_GetSystemTime();
        while (*dnaptr==USB_DMA_SIGNATURE1)
        {
...
//    UINT8 *pBuf, j;
    ...
    memcpy((U8 *)&(psAttachDevice_Port2->saCD[i]),pbData,HOST20_CONFIGURATION_LENGTH);
    pbData=pbData+HOST20_CONFIGURATION_LENGTH;

#if 0
    printf("Got a Config Descriptor: \n");
    pBuf = (U8 *)&(psAttachDevice_Port2->saCD[i]);
    for (j=0; j<HOST20_CONFIGURATION_LENGTH; j++)
        printf(" %02X", pBuf[j]);
    printf("\n\n");
#endif

    RemainLen = (int)psAttachDevice_Port2->saCD[i].bTotalLengthLowByte +
                    ((int)psAttachDevice_Port2->saCD[i].bTotalLengthHighByte << 8) - HOST20_CONFIGURATION_LENGTH;
...
//            printf("Get a interface descriptor\n");
            memcpy((U8 *)&(psAttachDevice_Port2->saCD[i].sInterface[0]),pbData,HOST20_INTERFACE_LENGTH);
            ept_idx = 0;
            if (psAttachDevice_Port2->saCD[i].sInterface[0].bEP_NUMBER>HOST20_ENDPOINT_NUM_MAX)
            {
...
//            printf("Get a endpoint descriptor\n");
            memcpy((U8 *)&(psAttachDevice_Port2->saCD[i].sInterface[0].sED[ept_idx]),pbData,HOST20_ENDPOINT_LENGTHX);
            ept_idx++;
        }
        ...
        if (ept_idx == psAttachDevice_Port2->saCD[i].sInterface[0].bEP_NUMBER) //All endpoints are collected
        {
            //intf_idx++;
            if ( (psAttachDevice_Port2->saCD[i].sInterface[0].bInterfaceClass == USB_INTERFACE_CLASS_MSD) ||
                (psAttachDevice_Port2->saCD[i].sInterface[0].bInterfaceClass == USB_INTERFACE_CLASS_HUB) ||
                (psAttachDevice_Port2->saCD[i].sInterface[0].bInterfaceClass == USB_INTERFACE_CLASS_IMAGE) ||
                (psAttachDevice_Port2->saCD[i].sInterface[0].bInterfaceClass == USB_INTERFACE_CLASS_HID) )
                break;
        }
    }
...
//    printf("End the config analyzing\n");
  ...
  i=0;
  {
    ...
    {
      memcpy((U8 *)&(psAttachDevice_Port2->saCD[i].sInterface[j]),pbData,HOST20_INTERFACE_LENGTH);
      pbData=pbData+HOST20_INTERFACE_LENGTH;

      //<3>.Copy Class HID
      if (psAttachDevice_Port2->saCD[i].sInterface[j].bInterfaceClass ==3)
      {//Only support 1 class
        memcpy((U8 *)&(psAttachDevice_Port2->saCD[i].sInterface[j].sClass[0]),pbData,*pbData);
      ...
      {
        memcpy((U8 *)&(psAttachDevice_Port2->saCD[i].sInterface[j].sED[k]),pbData,HOST20_ENDPOINT_LENGTHX);
...
BOOLEAN USB_Hub_Handle_Port2(U8 port)
{
  ...
  DEBUG_USB(printf(" Port:%02bx Status=%02bx",port,(*pUsbData_Port2)));
...
void USB_DACHE_FLUSH_Port2(U32 addr, U32 length)
{
...
//  printf("flib_Host20_Enumerate_Port2 \n");
  ...
  MY_HAL_DCACHE_FLUSH((U32)pUsbData_Port2, 128);
  ...
  pHost20_qHD_List_Control0_Port2->bMaxPacketSize=psAttachDevice_Port2->sDD.bEP0MAXPACKETSIZE;
  //psHost20_qHD_List_Control[0]->bMaxPacketSize1=psAttachDevice_Port2->sDD.bEP0MAXPACKETSIZE>>8;

  pHost20_qHD_List_Control1_Port2->bMaxPacketSize=psAttachDevice_Port2->sDD.bEP0MAXPACKETSIZE;
  ...
  //Give it a try
   ...
   if ((psAttachDevice_Port2->sDD.bVIDHighByte==0x1a)&&(psAttachDevice_Port2->sDD.bVIDLowByte==0x0a))
   {
      EnterTestMode_Port2();
   }
#endif
  ...
  if (psAttachDevice_Port2->sDD.bProduct != 0)
  {
      ...
      bCMD[6] = pUsbData_Port2[0]; //real string length
      if(bCMD[6] > 128)
      {//Alan.yu 2010.12.17 : for some bad devices return wrong length larger then 128, which will over-write the memory after pUsbData_Port2[]
        bCMD[6] = 128;
      }
...
UINT8 _flib_Host20_Enumerate_Port2 (UINT8 bNormalEnumerate,UINT8 bAddress)
{
  UINT8 bCMD[8];
  UINT16 wLength;
  UINT16 ii, jj;
...
UINT8 flib_Host20_Enumerate_Port2 (UINT8 bNormalEnumerate,UINT8 bAddress)
{
    ...
    bReturn = _flib_Host20_Enumerate_Port2(bNormalEnumerate, bAddress);
    if (!bReturn)
        return(bReturn);
...
void flib_Host20_InitStructure_Port2(void)
{
  ...
  //for ( i=0 ; i < Host20_qHD_SIZE*Host20_qHD_MAX ; i++)
    //XBYTE[Host20_STRUCTURE_qHD_BASE_ADDRESS_Port2+i]=0x00;
    pUsbCtrlBuf_Port2=(U8*) KSEG02KSEG1(UsbCtrlBuf_Port2);
    MY_HAL_DCACHE_FLUSH((U32)UsbCtrlBuf_Port2, sizeof(UsbCtrlBuf_Port2));


    //printf("QtdBuf size: %d\n", sizeof(QtdBuf));
    qTD_Base_Buf_Port2=(U8*) KSEG02KSEG1(QtdBuf_Port2);
    MY_HAL_DCACHE_FLUSH((U32)QtdBuf_Port2, Host20_qTD_SIZE*Host20_qTD_MAX+0x20);

  //  ASSERT(qTD_Base_Buf != NULL)
    Host20_STRUCTURE_qTD_BASE_ADDRESS_Port2=qTD_Base_Buf_Port2;

    pData=qTD_Base_Buf_Port2;
    for (i=0 ; i < (Host20_qTD_SIZE*Host20_qTD_MAX+0x20) ; i++)
        pData[i]=0;

    if ((U32)Host20_STRUCTURE_qTD_BASE_ADDRESS_Port2& 0x10)
		Host20_STRUCTURE_qTD_BASE_ADDRESS_Port2+=0x10;			//make it aligned with 32
    pHost20_qHD_List_Control0_Port2=(qHD_Structure*)KSEG02KSEG1(&Host20_qHD_List_Control0_Port2);
    pHost20_qHD_List_Control1_Port2=(qHD_Structure*)KSEG02KSEG1(&Host20_qHD_List_Control1_Port2);
    pHost20_qHD_List_Bulk0_Port2=(qHD_Structure*)KSEG02KSEG1(&Host20_qHD_List_Bulk0_Port2);
    pHost20_qHD_List_Bulk1_Port2=(qHD_Structure*)KSEG02KSEG1(&Host20_qHD_List_Bulk1_Port2);
    MY_HAL_DCACHE_FLUSH((U32)&Host20_qHD_List_Control0_Port2, sizeof(qHD_Structure));
    MY_HAL_DCACHE_FLUSH((U32)&Host20_qHD_List_Control1_Port2, sizeof(qHD_Structure));
    MY_HAL_DCACHE_FLUSH((U32)&Host20_qHD_List_Bulk0_Port2, sizeof(qHD_Structure));
    MY_HAL_DCACHE_FLUSH((U32)&Host20_qHD_List_Bulk1_Port2, sizeof(qHD_Structure));

    pData=(U8*)pHost20_qHD_List_Control0_Port2;
    for ( i=0 ; i < sizeof(qHD_Structure); i++)
        pData[i]=0;
    pData=(U8*)pHost20_qHD_List_Control1_Port2;
    for ( i=0 ; i < sizeof(qHD_Structure); i++)
        pData[i]=0;
    pData=(U8*)pHost20_qHD_List_Bulk0_Port2;
    for ( i=0 ; i < sizeof(qHD_Structure); i++)
        pData[i]=0;
    pData=(U8*)pHost20_qHD_List_Bulk1_Port2;
    for ( i=0 ; i < sizeof(qHD_Structure); i++)
        pData[i]=0;

    Host20_STRUCTURE_qHD_BASE_ADDRESS_Port2=(U8*)pHost20_qHD_List_Control0_Port2;
  ...
  #if 1
  pHost20_qHD_List_Control0_Port2->bNextQHDPointer=(VirtoPhyAddr((U32)pHost20_qHD_List_Control1_Port2)>>5);
  pHost20_qHD_List_Control1_Port2->bNextQHDPointer=(VirtoPhyAddr((U32)pHost20_qHD_List_Control0_Port2)>>5);
...
//           ~0:Addrress
//====================================================================
qTD_Structure *flib_Host20_GetStructure_Port2(U8 Type)
{
  U32 i;
  U8 bFound;
  //U16 spTempqTD;
  ...
  switch(Type)
  {
    case Host20_MEM_TYPE_qTD:
         ...
         if (bFound==1)
         {
           ...
           spTempqTD=(qTD_Structure *)((U32)Host20_STRUCTURE_qTD_BASE_ADDRESS_Port2+i*Host20_qTD_SIZE);
...
//           ~0:Addrress
//====================================================================
void flib_Host20_ReleaseStructure_Port2(U8 Type,U32 pwAddress)
{
  //U8 i;
  U16 wReleaseNum;
  U8 *pData;
  ...
  switch(Type)
  {
    case Host20_MEM_TYPE_qTD:
         ...
         if (pwAddress<(U32)Host20_STRUCTURE_qTD_BASE_ADDRESS_Port2)
         {
           HOSTLIB_MSG(printf("??? Memory release area fail...\n"));
           //while(1);
         }

         if ((pwAddress-(U32)Host20_STRUCTURE_qTD_BASE_ADDRESS_Port2)==0)
           wReleaseNum=0;
         else
           wReleaseNum=(pwAddress-(U32)Host20_STRUCTURE_qTD_BASE_ADDRESS_Port2)/Host20_qTD_SIZE;
...
//           ~0:Addrress
//====================================================================
void flib_Host20_Allocate_QHD_Port2(qHD_Structure  *psQHTemp,U8 bNextType,U8 bAddress,U8 bHead,U8 bEndPt, U32 wMaxPacketSize)
{
  qTD_Structure *spTempqTD;
  //UINT32 sp;
  ...
  #if 1
  //<2.1>.Allocate qTD
  spTempqTD=(qTD_Structure *)flib_Host20_GetStructure_Port2(0);//0=>qTD
...
UINT8 flib_Host20_Send_qTD_Port2(qTD_Structure  *spHeadqTD ,qHD_Structure  *spTempqHD,U16 wTimeOutSec)
{
 ...
 while (mbHost20_USBCMD_AsynchronousEnable_Rd())
  ...
  TotalBytes_Port2=  spOldDumyqTD->bTotalBytes;
...
#ifdef ENABLE_HOST_TEST
extern void MDrv_UsbSendSE0_Port2(void);
extern void MDrv_UsbSendTestJ_Port2(void);
extern void MDrv_UsbSendTestK_Port2(void);
extern void MDrv_UsbSendTestPacket_Port2(void);

UINT8 flib_Host20_Issue_Control_Test_Mode_Port2 (UINT8 bEdNum,UINT8* pbCmd,UINT16 hwDataSize,UINT8* pbData)
{
    qTD_Structure *spTempqTD;
    //UINT16       bpDataPage;
    UINT8        bReturnValue;
    ...
    //<C>.Waiting for result
    memcpy(pbData,pUsbCtrlBuf_Port2,hwDataSize);
...
void GetDeviceDescriptor_Port2(void)
{
    UINT8 bCMD[8];

    memcpy(bCMD,OTGH_GETDESCRIPTOR_DEVICE_8_PORT2,8);

    flib_Host20_Issue_Control_Port2(1,bCMD,8,(UINT8*)&(psAttachDevice_Port2->sDD));
}
...
void EnterTestMode_Port2(void)
{
  UINT8 bCMD[8];
...
#endif
    if ((psAttachDevice_Port2->sDD.bPIDHighByte==0x01)&&(psAttachDevice_Port2->sDD.bPIDLowByte==0x01))
        // test_SE0
    {
        MDrv_UsbSendSE0_Port2();
     }
    else  if ((psAttachDevice_Port2->sDD.bPIDHighByte==0x01)&&(psAttachDevice_Port2->sDD.bPIDLowByte==0x02))
        // test_J
    {
        MDrv_UsbSendTestJ_Port2();
     }
    else  if ((psAttachDevice_Port2->sDD.bPIDHighByte==0x01)&&(psAttachDevice_Port2->sDD.bPIDLowByte==0x03))
        // test_J
    {
        MDrv_UsbSendTestK_Port2();
     }
    else  if ((psAttachDevice_Port2->sDD.bPIDHighByte==0x01)&&(psAttachDevice_Port2->sDD.bPIDLowByte==0x04))
        // test_J
    {
        MDrv_UsbSendTestPacket_Port2();
     }
    else  if ((psAttachDevice_Port2->sDD.bPIDHighByte==0x01)&&(psAttachDevice_Port2->sDD.bPIDLowByte==0x07))
     //single step get device descriptor
    {
        ...
        GetDeviceDescriptor_Port2();
    }
    else  if ((psAttachDevice_Port2->sDD.bPIDHighByte==0x01)&&(psAttachDevice_Port2->sDD.bPIDLowByte==0x08))
     //single step get device descriptor
    {
        printf("\r\n Get device descriptor.\n");
        memcpy(bCMD,OTGH_GETDESCRIPTOR_DEVICE_PORT2,8);

        flib_Host20_Issue_Control_Test_Mode_Port2(1,bCMD,0x12,(UINT8*)&(psAttachDevice_Port2->sDD));
    }
