...
#ifndef _HAL_EMMFLT_H_
#define _HAL_EMMFLT_H_
...
#define EMMFLT_EMM_INT                     EMM_ONEPAKCET_INT
#define EMMFLT_EMM_OVERFLOW_INT            EMM_OVERFLOW_INT
#define EMMFLT_STATES_GROUP                (EMMFLT_EMM_INT  | \
                                            EMMFLT_EMM_OVERFLOW_INT  )

#define EMM_TIDMODE_BASIC_MASK             0x101

#define NDS_EMMFLT_BUF_SIZE         (256)
#define U01_NDS_EMMFLT_BUF_SIZE     (256)
#define NDS_EMM_BUF_NUM             (16)
#define MAX_EMMFLT_NUM               10

#define MAX_EMM_LIST_NUM             11  // N for N-1 slots

#define U01_MAX_EMMFLT_NUM           10
#define EMMENG_NUMBER                2
#define EMMFLT_HWBUF_NUM             10

#define EMM_COPY_PACKET_SIZE         188

#define EMMFLT_HWBUF_SIZE            NDS_EMMFLT_BUF_SIZE*MAX_EMMFLT_NUM //4096
#define EMMFLT_BUF_ALIGNMENT         0x100


#define HAL_EMMFLT_OK                   0
#define HAL_EMMFLT_FAIL                 2
#define HAL_EMMFLT_INVALID_REQUEST      3


typedef enum
{
    E_TIDMODE_INGORE = 0x0,
    E_TIDMODE_ACCEPT_ALL = 0x1,
    E_TIDMODE_ACCEPT_ADDRESS = 0x10000,
    E_TIDMODE_RESERVED = 0x10001,
} EMM_TIDMODE_e;


#define EMM_IRD_REG_MASK  0x3
typedef enum
{
    E_IRD_REG_DISABLE = 0,
    E_IRD_REG_COMPARE,
...
#if 0
typedef struct _EMMFLT_Config_
{
    MS_U16  u16EMM_PID;
    MS_U8   u8EMM_TID;
    MS_U16  u16EMM_CTRL_ID;
    MS_U16  u16RingSize_TS0;
    MS_U32  u32GeneralCtrl;
} EMMFLT_Config_t;
#endif
...
#if 0  //removed
MS_U32 HAL_EMMFLT_SetRingConfig(MS_U16 u16RingSize, MS_U32 RingBufStart, MS_U8 u8RingIndex);
#endif

MS_U32 HAL_EMMFLT_HWSimulation(void);
void HAL_EMMFLT_IntStatusTest(void);

#endif  //_HAL_EMMFLT_H_
