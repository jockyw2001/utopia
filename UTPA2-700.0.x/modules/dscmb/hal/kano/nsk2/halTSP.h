...
#define TSP_PIDFLT_REC_NUM              (TSP_PIDFLT_NUM - TSP_PCRFLT_NUM)                           // 0~189 (0 for CA)
                                                                                                    // 193 for Err
                                                                                                    // 192 for REC
                                                                                                    // 191 for PCR1
                                                                                                    // 190 for PCR0
...
#define TSP_CAFLT_END_ID                (TSP_CAFLT_START_ID + TSP_CA_RESERVED_FLT_NUM)

// section FLT ID
#define TSP_SECFLT_START_ID             TSP_CAFLT_END_ID
#define TSP_SECBUF_START_ID             TSP_CAFLT_END_ID
#define TSP_SECFLT_END_ID               (TSP_SECFLT_START_ID + TSP_SECFLT_NUM - TSP_CA_RESERVED_FLT_NUM - TSP_PCRFLT_NUM)
#define TSP_SECBUF_END_ID               (TSP_SECBUF_START_ID + TSP_SECBUF_NUM - TSP_CA_RESERVED_FLT_NUM - TSP_PCRFLT_NUM)

// PID
#define TSP_PIDFLT_START_ID             TSP_CAFLT_END_ID
#define TSP_PIDFLT_END_ID               (TSP_PIDFLT_START_ID + TSP_PIDFLT_NUM - TSP_CA_RESERVED_FLT_NUM - TSP_PCRFLT_NUM)

// PCR
#define TSP_PCRFLT_START_ID             TSP_PIDFLT_END_ID
#define HAL_TSP_PCRFLT_GET_ID(NUM)      (TSP_PCRFLT_START_ID + (NUM))
#define TSP_PCRFLT_END_ID               (TSP_PCRFLT_START_ID + TSP_PCRFLT_NUM)

// REC
#define TSP_RECFLT_IDX                  TSP_PCRFLT_END_ID
...
typedef enum _HAL_TSP_TSIF // for HW TSIF
{
    ...
    E_TSP_HAL_TSIF_RASP0        ,
    E_TSP_HAL_TSIF_RASP1        ,
...
typedef enum
{
    E_TSP_HAL_CAP_VAL_PIDFLT_NUM                    = (TSP_PIDFLT_END_ID - TSP_PIDFLT_START_ID),
    ...
    E_TSP_HAL_CAP_VAL_DEMOD_NUM                     = 2, //internal demod
...
void    HAL_TSP_GetTSIF_Status(MS_U32 u32TsIfId, MS_U16* pu16Pad, MS_U16* pu16Clk, MS_BOOL* pbClkInv, MS_BOOL* pbExtSync, MS_BOOL* pbParl);
...
void HAL_TSP_Filein_Bypass(MS_U32 tsIf, MS_BOOL bEnable);  // for PS mode A/V fifo pull back
