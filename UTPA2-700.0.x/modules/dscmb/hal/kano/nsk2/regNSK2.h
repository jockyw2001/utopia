...
#define REG_RSA_SECRANGE_START(_a_)	    (REG_RSA_BASE + (0x05 + (_a_)* 2) * 4 ) //0~5
#define REG_RSA_SECRANGE_END(_a_)		(REG_RSA_BASE + (0x06 + (_a_)* 2) * 4 ) //0~5
#define REG_RSA_SECRANGE_SET			0x6
#define REG_RSA_SECRANGE_ENABLE		    0xFFFEFFFF
    #define RSA_SECRANGE_MASK			0x0000FFFF
#define REG_RSA_SECRANGE_MASK			(REG_RSA_BASE + (0x13 << 2))
