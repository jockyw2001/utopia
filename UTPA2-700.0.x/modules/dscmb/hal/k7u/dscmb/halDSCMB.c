...
HAL_DSCMB_KL_Dst _HAL_DSCMB_GetKLDst(DSCMB_KLDst eDst)
{
    switch (eDst)
    {
        ...
        case E_DSCMB_KL_DST_CFB:
            return E_HAL_DSCMB_KL_DST_CFB;
...
HAL_DSCMB_KL_DstDma _HAL_DSCMB_GetKLDstDMA(DSCMB_KLDst eDst)
{
    switch (eDst)
    {
        ...
        case E_DSCMB_KL_DST_CFB:
            return E_HAL_DSCMB_KL_DSTDMA_TCF;
        case E_DSCMB_KL_DST_DMA_SPS0:
...
HAL_DSCMB_KL_DstKT _HAL_DSCMB_GetKLDstKT(DSCMB_KLDst eDst)
{
    switch (eDst)
    {
        ...
        case E_DSCMB_KL_DST_CFB:
            return E_HAL_DSCMB_KL_DSTKT_ESA;
        case E_DSCMB_KL_DST_DMA_SK0:
            return E_HAL_DSCMB_KL_DSTKT_DMA_Eng0;
        case E_DSCMB_KL_DST_DMA_SK1:
            return E_HAL_DSCMB_KL_DSTKT_DMA_Eng0;
        case E_DSCMB_KL_DST_DMA_SK2:
            return E_HAL_DSCMB_KL_DSTKT_DMA_Eng0;
...
MS_BOOL HAL_DSCMB_PidIdx_Write(MS_U32 u32fltid , DSCMB_Key_Type type , MS_U32 u32idx , MS_BOOL bEnable)
{
    ...
    return _HAL_DSCMB_PidIdx_MuxWrite( u32fltid , u32wmux , (bEnable<<15)|u32idx );
}
...
MS_BOOL HAL_DSCMB_KTE_GetStatus(MS_U32 u32FltId ,DSCMB_Key_Type eKeyType, MS_U32 *KeyStatus)
{
    ...
    switch (eKeyType)
    {
        case E_DSCMB_KEY_CLEAR:
            ...
            break;
        case E_DSCMB_KEY_EVEN:
            u32KeyIdx = pReadData1->EvenSlotIndex;
            break;
        case E_DSCMB_KEY_ODD:
    ...
    u32Status |= pReadData1->DualSloEn?DSCMB_KTE_DUAL_EN:0;
    u32Status |= pReadData1->PidSlotEn?DSCMB_PIDIDX_EN:0;
...
{
#if 1//defined(CHIP_K7U)
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x00<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x01<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x02<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x03<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x04<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x05<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x06<<2))=0x00;

    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x10<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x11<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x12<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x13<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x14<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x15<<2))=0x00;
    *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x16<<2))=0x00;
                                    ...
                                    HAL_DSCMB_SCBFix eSCBFix  )
{
    ...
    switch (eEngSel)
    {
        ...
        case E_HAL_DSCMB_SCBFIX_DMXU:
            u32SCB_Addr = REG_CIPHER_DMXU_SCB(EngId);
        ...
        case E_HAL_DSCMB_SCBFIX_DMXL:
            if (0 == u32tsid)
            {
                u32SCB_Addr = REG_CIPHER_DMXL_SCB(EngId);
            }
            else
            {
...
void _HAL_DSCMB_PidFlt_Reset(MS_U32 u32FltId)
{
    DSCMB_HW_LOCK(_eHW_SemId);
#if 1//defined (CHIP_K7U)
    MS_U32 pPidCACC     = REG_PIDFLT0(u32FltId);
    MS_U32 pPidCAPair   = REG_PIDFLT1(u32FltId);
    MS_U32 pPidCADes   = REG_PIDFLT2(u32FltId);

    //Set CC to 0xFF
    TSP32_IdrW(pPidCACC, TSP32_IdrR(pPidCACC) | REG_TSP_PIDFLT_CC_MSK);

    //Set   Key_en    to 0
    TSP32_IdrW(pPidCADes, TSP32_IdrR(pPidCADes) & ~REG_TSP_PIDFLT_KEYEN);

    //Set   2ndPid     to 0
    //Set   PP[x]       to 0
    TSP32_IdrW(pPidCAPair, TSP32_IdrR(pPidCAPair) & ~(REG_TSP_PIDFLT_PP_MSK|REG_TSP_PIDFLT_2NDPID));
#else
...
#if 1//defined (CHIP_K7U)
            case 0:
                REG16_MSK_W(REG_TSP_CA_PATH(u32Tsid), REG_TSP_CAVID_MSK , u32CAVid);
                REG16_MSK_W(REG_TSP_CA_PATH(u32Tsid), REG_TSP_CA_CHID_MSK , 0<<8);
                *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x00<<2))=0x00;
                *(volatile MS_U32*)(0xfd000000+(0x1A11<<9)+(0x10<<2))=0x00;
            case 1:
                REG16_MSK_W(REG_TSP_CA_PATH(u32Tsid), REG_TSP_CAVID_MSK , u32CAVid);
...
#if 1//defined (CHIP_K7U)
    MS_U32 u32regValue = *(volatile MS_U32*)(0xfd000000+(0x1610<<9)+(0x07<<2));
    *(volatile MS_U32*)(0xfd000000+(0x1610<<9)+(0x07<<2)) = u32regValue | 0xF00;
    *(volatile MS_U32*)(0xfd000000+(0x1610<<9)+(0x07<<2)) = u32regValue & (~0xF00);
#else
    switch(u32Tsid)
    {
...
{
#if 1//defined (CHIP_K7U)
    MS_U32 Tmp=*(volatile MS_U32*)(0xfd000000+(0x1610<<9)+(0x9<<2));
    Tmp&=~0x2000;
    *(volatile MS_U32*)(0xfd000000+(0x1610<<9)+(0x9<<2))=Tmp;
