...
#define REG_CIPHER_ESA_SCB(_a_)                (REG_DSCMB_CIPHER_BANK(_a_) + 0x0003UL)
    #define REG_CIPHER_SCBFIX_SHT(_a_)         ((_a_) * 3UL)
...
#define REG_CIPHER_DMXU_SCB(_a_)                 (REG_DSCMB_CIPHER_BANK(_a_) + 0x0006UL)
    #define REG_CIPHER_DMXU_SCBFIX_SHT(_a_)     ((_a_) * 3UL)
    #define REG_CIPHER_DMXU_SCBFIX_MSK(_a_)     (0x00000007UL << REG_CIPHER_DMXU_SCBFIX_SHT(_a_))

#define REG_CIPHER_DMXL_SCB(_a_)                 (REG_DSCMB_CIPHER_BANK(_a_) + 0x0005UL)
    #define REG_CIPHER_DMXL_SCBFIX_TSID0_MSK   0x00000070UL
    #define REG_CIPHER_DMXL_SCBFIX_TSID0_SHT   4UL

#define REG_CIPHER_EKEY_INVALID(_a_)            REG_CIPHER_DMXL_SCB(_a_)
    #define REG_CIPHER_DMXL_SCBFIX_SHT(_a_)     ((_a_) * 3UL)
...
#define REG_CIPHER_DMXU_SCB(_a_)                 (REG_DSCMB_CIPHER_BANK(_a_) + 0x0005UL)
    #define REG_CIPHER_DMXU_SCBFIX_SHT(_a_)     ((_a_)?(13UL + ((_a_)* 3UL) ):0UL)
    #define REG_CIPHER_DMXU_SCBFIX_MSK(_a_)     (0x00000007UL << REG_CIPHER_DMXU_SCBFIX_SHT(_a_))

#define REG_CIPHER_DMXL_SCB(_a_)                 REG_CIPHER_DMXU_SCB(_a_)
    #define REG_CIPHER_DMXL_SCBFIX_TSID0_MSK   0x00000070UL
    #define REG_CIPHER_DMXL_SCBFIX_TSID0_SHT   4UL
...
#define REG_PIDIDX_READ_DATA                     (REG_DSCMB_KTE_BANK + 0x0042UL) //new position
    ...
    // write only, read is not allowed
    #define REG_PIDIDX_WDATA_MSK                 0x0000FFFFUL
    // read only, write is not allowed
...
////////////////////////////////////////////////////////////////////////////////////////////////
#if 1//defined (CHIP_K7U)
#define REG_PIDFLT_BASE0                 (0x00244100UL)     //CC
#define REG_PIDFLT_BASE1                 (0x00244000UL)     //Pair
#define REG_PIDFLT_BASE2                 (0x00243000UL)     //Des
...
//PID CA CC
#define REG_TSP_PIDFLT_CC_MSK              0x000000FFUL
...
#define REG_TSP_PIDFLT_2NDPID              0x01000000UL
#define REG_TSP_PIDFLT_PP1                 0x02000000UL
#define REG_TSP_PIDFLT_PP2                 0x04000000UL
#define REG_TSP_PIDFLT_PP3                 0x08000000UL
#define REG_TSP_PIDFLT_PP4                 0x10000000UL
#define REG_TSP_PIDFLT_PP_MSK              0x1E000000UL

//PID CA Destination
#define REG_TSP_PIDFLT_KEYEN               0x00000001UL
...
////////////////////////////////////////////////////////////////////////////////////////////////
#if 1//defined (CHIP_K7U)
#define REG_TSP6_BANK      0x30800UL //0x1610    //
#define REG_TSP_PID_SLOT_MAP_NO             (REG_TSP6_BANK + 0x07UL)
    #define REG_TSP_USE_PID_SLOT_MAP_NO      0x10UL
#define REG_TSP_CA_PATH(_a_)             (REG_TSP6_BANK + 0x09UL + (_a_)*0x10)
    #define REG_TSP_CAVID_MSK      0x001FUL
    #define REG_TSP_CA_CHID_MSK      0x0F00UL

#else
#define REG_TSP_PID_SLOT_MAP_NO             (REG_TSP4_BANK + 0x39UL)
    #define REG_TSP_USE_PID_SLOT_MAP_NO      0x8000UL
#endif
