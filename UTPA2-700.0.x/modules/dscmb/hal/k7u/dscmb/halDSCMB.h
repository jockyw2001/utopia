...
typedef enum
{
    ...
    E_HAL_DSCMB_KL_DSTDMA_TCF    = 0xd ,  //TCF(CA_CWC)
...
typedef enum
{
    ...
    E_HAL_DSCMB_KL_DSTKT_DMA_Eng0    = 0x0 ,  //field for CryptoDMA, M2M&MDEM
    E_HAL_DSCMB_KL_DSTKT_DMA_Eng1    = 0x1 ,  //field for CryptoDMA, M2M&MDEM
    E_HAL_DSCMB_KL_DSTKT_TSDMA_EVEN_KEY    = 0x0 ,  //field for CryptoDMA, TSDMA
    E_HAL_DSCMB_KL_DSTKT_TSDMA_ODD_KEY     = 0x1 ,  //field for CryptoDMA, TSDMA
} HAL_DSCMB_KL_DstKT;
...
{
    //for read:
    MS_U32 ClrSlotIndex : 15; //bit[14:0] clr slot index
    MS_U32 ClrSloEn : 1; //bit[15] clr slot enable
    MS_U32 OddSlotIndex : 15; //bit[30:16] odd slot index
    MS_U32 OddSloEn : 1; //bit[31] odd slot enable
} PidSlotMapRead_t;

typedef struct
{
    //for read:
    MS_U32 EvenSlotIndex : 15; //bit[46:32] even slot index
    MS_U32 EvenSloEn : 1; //bit[47] even slot enable
    MS_U32 DualSloEn : 1; //bit[48] dualpath_en
    MS_U32 PktViewDbgInfo : 1; //bit[49]
    MS_U32 RFU0 : 2; //bit[51:50]
    MS_U32 Privileged : 1; //bit[52] privileged_flag
    MS_U32 SecurePidSlot : 1; //bit[53] secure_flag
    MS_U32 RFU1 : 2; //bit[55:54]
    MS_U32 CA_VID : 5; //bit[60:56] cavid
    MS_U32 RFU2 : 2; //bit[62:61]
    MS_U32 PidSlotEn : 1; //bit[63]
} PidSlotMapRead2_t;
