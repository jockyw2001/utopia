...
typedef enum
{
    E_HAL_DSCMB_TYPE_CSA = 0UL,   // CSA, NSA as ESA
...
typedef enum
{
    E_HAL_DSCMB_NONE=           0x00000000UL,
    E_HAL_DSCMB_TS=             0x00000001UL,
    E_HAL_DSCMB_PES=            0x00000002UL,
...
MS_BOOL HAL_DSCMB_SetFlow(MS_U32 u32EngId, MS_U32 u32Flow);
