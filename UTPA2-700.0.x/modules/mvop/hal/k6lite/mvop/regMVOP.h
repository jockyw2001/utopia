...
#define TSP_REG_BASE                            0x1500  // 0x1400 - 0x14FF
...
#define REG_CLK_MPLL_SYN                 (CHIP_REG_BASE + 0x3A)
#define REG_CLK_MPLL_SYN2                (CHIP_REG_BASE + 0x3B)
...
// TSP
//------------------------------------------------------------------------------
#define REG_TSP_RST                             (TSP_REG_BASE + 0xF4)
