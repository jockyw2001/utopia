...
void HAL_MVOP_ResetReg(MVOP_DevID eDevID, MS_U16 u16ECONumber)
{
    ...
    /*****************************************************/
    // Reset MVOP setting
    HAL_WriteByteMask(VOP_TST_IMG, 0x0, BIT2 | BIT1 | BIT0);//reset test pattern or BG
    ...
    case E_MVOP_DEV_1:
    {
        ...
        /*****************************************************/
        // Reset MVOP setting
        HAL_WriteByteMask(SUB_REG(VOP_TST_IMG), 0x0, BIT2 | BIT1 | BIT0);//reset test pattern or BG
