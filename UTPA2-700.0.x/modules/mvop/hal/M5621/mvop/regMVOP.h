...
#define VOP_REG_MIU_LIMIT                        (MVOP_REG_BASE + 0xE6)
    #define VOP_LIMIT_EN           BIT0
    #define VOP_LIMIT_FORCE_OFF    BIT1
    #define VOP_LIMIT_CLR          BIT2

#define VOP_REG_MIU_LIMIT_SEL                    (MVOP_REG_BASE + 0xE8)
    #define VOP_MIU0_MAX           (BIT0|BIT1)
    #define VOP_MIU0_MIN           (BIT2|BIT3)
    #define VOP_MIU1_MAX           (BIT4|BIT5)
    #define VOP_MIU1_MIN           (BIT6|BIT7)

#define VOP_REG_MIU0_MAX_ADDR_L                  (MVOP_REG_BASE + 0xF0)
#define VOP_REG_MIU0_MAX_ADDR_H                  (MVOP_REG_BASE + 0xF2)
#define VOP_REG_MIU0_MIN_ADDR_L                  (MVOP_REG_BASE + 0xF4)
#define VOP_REG_MIU0_MIN_ADDR_H                  (MVOP_REG_BASE + 0xF6)

#define VOP_REG_MIU1_MAX_ADDR_L                  (MVOP_REG_BASE + 0xF8)
#define VOP_REG_MIU1_MAX_ADDR_H                  (MVOP_REG_BASE + 0xFA)
#define VOP_REG_MIU1_MIN_ADDR_L                  (MVOP_REG_BASE + 0xFC)
#define VOP_REG_MIU1_MIN_ADDR_H                  (MVOP_REG_BASE + 0xFE)
