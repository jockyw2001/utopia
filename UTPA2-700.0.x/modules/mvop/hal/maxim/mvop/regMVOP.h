...
// Base Address
//------------------------------------------------------------------------------
#define MVOP_REG_BASE                           0x00001400  // 0x1400 - 0x14FF
...
#define CHIP_REG_1_BASE                         0x00003300  // CLKGEN1
#define MFDEC_REG_BASE                          0x00023300
...
#define VOP_REG_YC422_EN_H                      (MVOP_REG_BASE + 0x7F)
...
#define VOP_REG_DUMMY_5D_L                         (MVOP_REG_BASE + 0xBA)
    #define XC_RESET_HCOUNT     	BIT0
...
// For check stc cw
#define REG_STC_CW_SLE_L                 (CHIP_REG_BASE + 0x08) //reg_stc0_cw_sel
#define REG_STC_CW_SLE_H                 (CHIP_REG_BASE + 0x09) //reg_stc1_cw_sel
#define REG_STC0_CW_L                    (CHIP_REG_BASE + 0x0A)
#define REG_STC0_CW_H                    (CHIP_REG_BASE + 0x0C)
#define REG_STC1_CW_L                    (CHIP_REG_BASE + 0x0E)
#define REG_STC1_CW_H                    (CHIP_REG_BASE + 0x10)
#define REG_TSP_CLK                      (CHIP_REG_BASE + 0x54) //reg_ckg_tsp
#define REG_CLK_SYN_STC                  (CHIP_REG_BASE + 0x56) //reg_ckg_stc0[0-2] stc1[4-6]
...
// CHIP_REG_1_BASE
//------------------------------------------------------------------------------
#define REG_CKG_FBDEC                     (CHIP_REG_1_BASE + 0x4A)
    #define CKG_FBDEC_GATED            BIT0
    #define CKG_FBDEC_MASK            (BIT3 | BIT2 | BIT1)

#define REG_MFDEC_CFG_H                     (MFDEC_REG_BASE + 0x01)
    #define REG_MFDEC_CFG              BIT0
