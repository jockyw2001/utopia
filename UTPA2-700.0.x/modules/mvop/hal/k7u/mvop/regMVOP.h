...
#define CLKGEN2_REG_BASE                        0x0A00  //chiptop CLKGEN02
#define MFDEC_REG_BASE                          0x00012200
...
#define VOP_LSB_DMA0                            (MVOP_REG_BASE + 0x2C)
#define VOP_LSB_DMA1                            (MVOP_REG_BASE + 0x2D)
    #define VOP_SYNC_2_DC_TIMING    BIT7
...
#define VOP_MIRROR_CFG_HI                       (MVOP_REG_BASE + 0x77)
    #define VOP_DC2MVD_FLD_SEL    (BIT0) //from maxim, able to control field timing.
...
#define VOP_REG_HS_OUTPUT                             (MVOP_REG_BASE + 0x7C)
    #define VOP_HS_MODE           (BIT0) //Handshake interface output
...
#define VOP_REG_4K2K_2P                          (MVOP_REG_BASE + 0xA6)
    ...
    #define VOP_TRIG_REFER_VB_END   BIT3
...
#define VOP_REG_BW_THD_L                           (MVOP_REG_BASE + 0xCC)
#define VOP_REG_BW_THD_H                           (MVOP_REG_BASE + 0xCD)
    #define REG_MVD_FLD_SEL         BIT7

#define VOP_TF_STR_MVD                             (MVOP_REG_BASE + 0xCE)
#define VOP_BF_STR_MVD                             (MVOP_REG_BASE + 0xD0)
...
#define REG_CKG_DC_SRAM2                            (CHIP_REG_BASE + 0xAD)
    #define VOP_SRAM0_CLK_SEL           BIT2
    #define VOP_SRAM1_CLK_SEL           BIT3

#define REG_CKG_DC_SRAM                             (CHIP_REG_BASE + 0xAE)
    #define CKG_DC0_SRAM_MASK            (BIT0 | BIT1 | BIT2 | BIT3)
    #define CKG_DC1_SRAM_MASK            (BIT4 | BIT5 | BIT6 | BIT7)
...
// CLK_GEN2
//-----------------------------------------------------------------------------
#define REG_CKG2_FBDEC_L                        (CLKGEN2_REG_BASE + 0xD6)
    #define CKG_FBDEC_GATED             BIT0
    #define CKG_FBDEC_MASK              (BIT3 | BIT2 | BIT1)
    #define CKG_FBDEC_432MHZ            (0 << 2)
    #define CKG_FBDEC_345MHZ            (1 << 2)

    #define CKG_FBDEC1_GATED             BIT4
    #define CKG_FBDEC1_MASK              (BIT7 | BIT6 | BIT5)
    #define CKG_FBDEC1_432MHZ            (0 << 2)
    #define CKG_FBDEC1_345MHZ            (1 << 2)

#define REG_CKG2_FBDEC_H                        (CLKGEN2_REG_BASE + 0xD6)
    #define CKG_FBDEC2_GATED             BIT0
    #define CKG_FBDEC2_MASK              (BIT3 | BIT2 | BIT1)
    #define CKG_FBDEC2_432MHZ            (0 << 2)
    #define CKG_FBDEC2_345MHZ            (1 << 2)

//------------------------------------------------------------------------------
// CHIP_REG_MFDEC
//------------------------------------------------------------------------------
#define MFDEC_REG_PW_SAVE           (MFDEC_REG_BASE + 0x36)
    #define MFDEC_REG_CKG_MASK     (BIT0 | BIT1 | BIT2)
