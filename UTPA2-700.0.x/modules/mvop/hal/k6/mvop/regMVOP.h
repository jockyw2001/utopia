...
#define MFDEC_REG_BASE                          0x00012200  //mfdec bank
...
#define VOP_REG_MFDEC_5E                       (MVOP_REG_BASE + 0xBC)
    #define VOP_BITLEN_SHT          BIT0
...
#define REG_MF_BASIC_L                             (MFDEC_REG_BASE + 0x00)
    #define MF_MFDEC_EN                 BIT0
    #define MF_UNCOMP_MODE              BIT5

#define REG_MF_BASIC_H                             (MFDEC_REG_BASE + 0x01)
    #define MF_RIU_MODE                 BIT4
    #define MF_RIU1_MODE                BIT5

#define REG_MF_MIU                                 (MFDEC_REG_BASE + 0x02)
    #define MF_LUMA_MIU                 (BIT0 | BIT1)
    #define MF_CHROMA_MIU               (BIT2 | BIT3)
    #define MF_BITLEN_MIU               (BIT4 | BIT5)

#define REG_MF_FB_WIDTH                            (MFDEC_REG_BASE + 0x08)
#define REG_MF_FB_HEIGHT                           (MFDEC_REG_BASE + 0x0A)
#define REG_MF_FB_PITCH                            (MFDEC_REG_BASE + 0x0C)

#define REG_MF_BT_PITCH                            (MFDEC_REG_BASE + 0x0E)

#define REG_MF_BT_ADDR_L                           (MFDEC_REG_BASE + 0x18)
#define REG_MF_BT_ADDR_H                           (MFDEC_REG_BASE + 0x1A)

    //// huffman table ////
#define REG_MF_CW_LEN2(id)     (MFDEC_REG_BASE + ((0x40<<1)*id) + (0x20<<1) )
    #define MF_CW_LEN2_MASK             BMASK(11:0)

#define REG_MF_CW_LEN3(id)     (MFDEC_REG_BASE + ((0x40<<1)*id) + (0x21<<1) )
    #define MF_CW_LEN3_MASK             BMASK(11:0)

#define REG_MF_CW_LEN4(id)     (MFDEC_REG_BASE + ((0x40<<1)*id) + (0x22<<1) )
    #define MF_CW_LEN4_MASK             BMASK(11:0)

#define REG_MF_CW_LEN5(id)     (MFDEC_REG_BASE + ((0x40<<1)*id) + (0x23<<1) )
    #define MF_CW_LEN5_MASK             BMASK(11:0)

#define REG_MF_CW_BASE(id)     (MFDEC_REG_BASE + ((0x40<<1)*id) + (0x24<<1) )
#define MF_CW_BASE             BMASK(11:0)

#define REG_MF_CW_MAX(id)     (MFDEC_REG_BASE + ((0x40<<1)*id) + (0x25<<1) )
#define MF_CW_MAX             BMASK(11:0)

#define REG_MF_SYMB_BASE(id)     (MFDEC_REG_BASE + ((0x40<<1)*id) + (0x26<<1) )
#define MF_SYMB_BASE             BMASK(4:0)
#define MF_SYMB_MAX             BMASK(12:8)

#define REG_MF_HUF_TAB(id)     (MFDEC_REG_BASE + ((0x40<<1)*id) + (0x27<<1) )

#define MFEDC_TABLE_INDEX_NUM 48
