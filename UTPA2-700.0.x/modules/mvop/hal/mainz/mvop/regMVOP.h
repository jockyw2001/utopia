...
#define VOP_MIRROR_CFG                          (MVOP_REG_BASE + 0x76)
    ...
    #define VOP_HW_MIR_BASE       (BIT4) //Hardware calculate mirror jump base address
...
#define VOP_REG_SINGLE_3D_OFFSET           (MVOP_REG_BASE + 0x88)
    #define VOP_FORCE_VOFFSET       BIT1
...
#define VOP_REG_4K2K_2P                          (MVOP_REG_BASE + 0xA6)
    #define VOP_HDS_EN             BIT0
    #define VOP_4K2K_2P             BIT1
#define VOP_REG_4K2K_2P_H                          (MVOP_REG_BASE + 0xA7)
    #define VOP_2P_WB             BIT1
